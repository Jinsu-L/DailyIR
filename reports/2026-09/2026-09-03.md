...
### 1. Incremental Pooled LLM Evaluation for Cost-Effective Retrieval Model Selection

- **LLM Score**: 0
- **Keyword Score**: 14
- **Authors**: Max Nelson, Hanoz Bhathena, Aviral Joshi, Saket Sharma
- **URL**: <http://arxiv.org/abs/2609.02745v1>
- **Submitted**: 2026-09-02 15:47:49
- **Comment**: 10 pages, 1 figure
- **Topic Keywords**: ranking, pairwise, relevance, rag, retrieval, rank
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Pooled LLM Evaluation for Retrieval System Selection
- **Aim**: Enable rapid, cost‑efficient, and repeatable comparison of multiple Retrieval‑Augmented Generation systems by reusing LLM judgments across overlapping retrieval results.
- **Rationale**: Traditional human relevance judgments are expensive, slow, and non‑incremental; pooling unique query‑document pairs and using an LLM to grade them amortizes cost, reduces bias, and preserves ranking stability.
- **Ground**: Empirical validation on 11 retrieval systems across four public datasets (FiQA, NQ, FinRAGBench‑V, TREC‑COVID) and a real‑world financial‑news QA deployment; 65–80% judgment reuse, 4.9× lower cost, high correlation with gold human judgments (ρ≥0.69–0.95), 93–96% intra‑judge agreement, 84–92% cross‑judge agreement.
- **Experiment**: Construct pooled judgment sets per query, prompt LLM for 3‑point relevance, compute standard IR metrics, evaluate incremental addition of systems, analyze ranking stability, bootstrap confidence intervals, compare to human qrels, assess calibration bias across datasets.
- **Takeaway**: Pooled LLM evaluation offers a scalable, accurate, and stable method for system selection, achieving near‑human ranking fidelity while dramatically reducing evaluation cost and enabling real‑time deployment decisions.
...
### 2. Group-Aware Adaptive Retrieval for Evidence Navigation

- **LLM Score**: 0
- **Keyword Score**: 12
- **Authors**: June Park, Jun Kwon, Jonghyo Kim, Jongwuk Lee
- **URL**: <http://arxiv.org/abs/2609.02188v1>
- **Submitted**: 2026-09-02 06:51:06
- **Comment**: Accepted to EMNLP 2026; 20 pages, 11 figures, 13 tables
- **Topic Keywords**: queries, rerank, relevance, retrieval, rank
- **Reason**: LLM scoring failed.
...
- **Submitted**: 2026-09-02 15:40:36
- **Comment**: Accepted by RecSys '26 OARS Workshop
- **Topic Keywords**: ranking, user behavior, retrieval, recommend, rank
- **Reason**: LLM scoring failed.
...
### 4. GeoStore: Finding Small Storefronts in Large Scenes -- A Fine-Grained POI Localization Benchmark with Global-to-Local Asymmetric Matching

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Lu Han, Xiting Sun, Hao Wang, Zhiqiang Cao, Ruihuan Du, Ziquan Zeng, Chunlong Lv
- **URL**: <http://arxiv.org/abs/2609.02012v1>
- **Submitted**: 2026-09-02 02:39:21
...
### 6. ViSAR: Training-Free Adaptive-$k$ Retrieval for Visual Document Question Answering

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Adrien Mialland, Marc Plantevit, Julien Gallois, Céline Robardet
- **URL**: <http://arxiv.org/abs/2609.02486v2>
- **Submitted**: 2026-09-02 11:54:58
...
### 7. Seed-Anchored Budget-Bounded Graph Rendering for Question Answering on Industry-Standard Power-Grid Information and Exchange Models

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Jayakumar Manoharan, Yamini Sehgal
- **URL**: <http://arxiv.org/abs/2609.02011v1>
- **Submitted**: 2026-09-02 02:39:05
...
### 9. text2ql: Multi-Target Natural Language Querying via a Language-Agnostic Intermediate Representation

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Ritesh Kumar
- **URL**: <http://arxiv.org/abs/2609.02115v1>
- **Submitted**: 2026-09-02 05:09:51
...
### 10. Adaptive Test-Time Inference for Text2Cypher with Trace Budgeting and Selective Refinement

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Makbule Gulcin Ozsoy
- **URL**: <http://arxiv.org/abs/2609.02324v1>
- **Submitted**: 2026-09-02 09:07:24
...
### 12. DKL: Decoupled Knowledge Learning for Instruction-Tuned Language Models
...
### 15. Counter-GEO-Bench: Evaluating Defenses Against Information-Distorting Generative Engine Optimization

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Bing Zheng, Zongyao Zhao, Wenming Yang
- **URL**: <http://arxiv.org/abs/2609.02316v1>
- **Submitted**: 2026-09-02 09:01:51
...
### 16. Do Cantonese-Adapted Language Models Better Predict Cantonese Reading? A Cross-Model Eye-Tracking Evaluation

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ziqi Zhang, Emmanuele Chersoni, Mohammad Momenian
- **URL**: <http://arxiv.org/abs/2609.02163v1>
- **Submitted**: 2026-09-02 06:24:34
...
### 17. A Power Law in Logarithm's Clothing: On the Scalability of Graph-Based Vector Search

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Sajad Faghfoor Maghrebi, Navid Eslami, Niv Dayan
- **URL**: <http://arxiv.org/abs/2609.02143v1>
- **Submitted**: 2026-09-02 05:56:14
...
### 18. XMerge: Cross-Axis Selection and Reconstructive Layer Merging for LLM Depth Compression

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Jundong Hu, Shekar Ramachandran
- **URL**: <http://arxiv.org/abs/2609.02083v1>
- **Submitted**: 2026-09-02 04:12:44
...
### 19. SPAR: Enhancing Industrial-Scale Generative POI Recommendation via Real-World Spatial Perception

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Fangye Wang, Yunjin Gu, Haowen Lin, Yifang Yuan, Song Yang, Xiaojiang Zhou, Pengjie Wang
- **URL**: <http://arxiv.org/abs/2609.02062v1>
- **Submitted**: 2026-09-02 03:40:53
...
### 20. HyGRAIL: Cost-Aware and Evidence-Grounded Scientific Hypothesis Discovery over Knowledge Graphs

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Yihang Sun, Zhihan Zhu, Zhiyuan Jiang, Jingyi Ge, Zixuan Li, Jiaxuan You
- **URL**: <http://arxiv.org/abs/2609.02056v1>
- **Submitted**: 2026-09-02 03:34:21
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 22. Post-Training Language Models for Gold-Medal Performance in Coding Competitions
...
### 23. Choosing a PEFT Variant for Per-Patient Dysarthric ASR: A Single-Speaker Case Study on Two ASR Bases

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Bernard Muller, László Tóth, LaVonne Roberts
- **URL**: <http://arxiv.org/abs/2609.02735v1>
- **Submitted**: 2026-09-02 15:42:48
...
### 25. Scalable Kronecker-Fisher Approximation: Efficient Hessian Analysis for Billion-Parameter Language Models Compression

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Viacheslav Yusupov, Daria Cherniuk, Evgeny Frolov
- **URL**: <http://arxiv.org/abs/2609.02451v1>
- **Submitted**: 2026-09-02 11:17:52
...
### 26. DiffIE: Diffusion-based Open Information Extraction

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Konstantin Fedorov, Valentin Malykh
- **URL**: <http://arxiv.org/abs/2609.02315v1>
- **Submitted**: 2026-09-02 09:01:42
- **Topic Keywords**: rag, rank
- **Reason**: LLM scoring failed.
...
### 27. Breadth Beats Depth: Improving GCG-Based Jailbreak Optimization with Breadth-Oriented Suffix Search

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Shiliang Xiao, Jingsong Wei, Yuzhi Liang, Yufan Zheng, Xia Li, Qiliang Lin
- **URL**: <http://arxiv.org/abs/2609.02172v1>
- **Submitted**: 2026-09-02 06:34:29
- **Topic Keywords**: rag, search
- **Reason**: LLM scoring failed.
...
### 28. Beyond Modality Harmony: Orthogonal Purification and Topology-Guided MoE for Conflict-Aware Multimodal Recommendation

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Jialin Liu, Zhaorui Zhang, Ray C. C. Cheung
- **URL**: <http://arxiv.org/abs/2609.02152v1>
- **Submitted**: 2026-09-02 06:06:30
...
### 29. EmoStance: Response-Side Affective-Orientation Control for Empathetic Response Generation via Emoji Weak Supervision

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Ziyuan Jin, Yuxuan Ge, Zheng Tian
- **URL**: <http://arxiv.org/abs/2609.02133v1>
- **Submitted**: 2026-09-02 05:43:14
...
### 30. C$^{3}$T: Counterfactual Causal Reasoning for Sentiment Shifts in Social-Media Conversation Trees

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: S M Rafiuddin, Atriya Sen
- **URL**: <http://arxiv.org/abs/2609.02131v1>
- **Submitted**: 2026-09-02 05:40:06
...
### 31. Beyond Context Windows: Persistent Discovery Context for Data-Centric Agents

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Jalal Mahmud
- **URL**: <http://arxiv.org/abs/2609.02129v1>
- **Submitted**: 2026-09-02 05:37:09
...
### 32. AI agents reshape consensus formation in human groups

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Lin Chen, Ziyi Liu, Xia Hu, Yong Li
- **URL**: <http://arxiv.org/abs/2609.02122v1>
- **Submitted**: 2026-09-02 05:25:22
- **Topic Keywords**: pairwise
- **Reason**: LLM scoring failed.
...
### 33. Predict, Don't Iterate: Efficient Adaptive-Length Infilling for Diffusion Language Models
...
- **URL**: <http://arxiv.org/abs/2609.02082v2>
- **Submitted**: 2026-09-02 04:12:35
...
### 35. A Tri-Agent Framework for Evaluating and Aligning Question Clarification Capabilities of Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Yikai Zhao, Saurabh Pandey, Pradeep Kumar Misra
- **URL**: <http://arxiv.org/abs/2609.02054v1>
- **Submitted**: 2026-09-02 03:33:40
- **Topic Keywords**: queries
- **Reason**: LLM scoring failed.
...
### 37. Train What You Deploy: Closing the MLP Reachability Gap in Low-Rank Clone Distillation
...
### 38. LexIssue: Benchmarking Legal Issue Identification in Chinese Civil Litigation
...
### 39. Verify Before You Distill: Prompt-Level Teacher Gating for On-Policy Distillation
...
### 40. User Feedback Provides a Unique Signal that LLMs Can not Detect

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Shachar Don-Yehiya, Leshem Choshen, Omri Abend
- **URL**: <http://arxiv.org/abs/2609.02859v1>
- **Submitted**: 2026-09-02 17:42:44
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 43. HyperStyler: Low-resource Authorship Style Transfer via Context-aware Style Navigation and Hypernetworks

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Jongkyung Shin, Minguk Jeon, Chanwoo Park, Chiehyeon Lim
- **URL**: <http://arxiv.org/abs/2609.02772v1>
- **Submitted**: 2026-09-02 16:07:42
...
### 44. From Reweighting to Rewriting: Unlocking the Intervention Effects of Influential Samples in Training Data Attribution

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yuzhang Luo, Chenpeng Wang, Jianhui Chen, Liangming Pan
- **URL**: <http://arxiv.org/abs/2609.02771v1>
- **Submitted**: 2026-09-02 16:07:21
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 45. From Tokens to Semantics: Leveraging Complementary Signals for Hallucination Detection in Black-Box LLMs
...
### 46. PolERo: Studying Political Evasion in Romanian

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Gabriel Stefan, Sergiu Nisioi
- **URL**: <http://arxiv.org/abs/2609.02391v1>
- **Submitted**: 2026-09-02 10:02:57
...
### 47. MultiGhostBench: A Multilingual Benchmark for Long-Form LLM-Generated Text Attribution under Distribution Shifts

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Matteo Greco, Anudeex Shetty, Andrea Tagarelli, Jey Han Lau
- **URL**: <http://arxiv.org/abs/2609.02379v1>
- **Submitted**: 2026-09-02 09:52:45
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 48. SonicCaps: Large-Scale Diverse and Fine-Grained Captioning for Improved Audio-Retrieval

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Zineb Lahrichi, Marc Ferras, Gaël Richard, Geoffroy Peeters
- **URL**: <http://arxiv.org/abs/2609.02343v1>
- **Submitted**: 2026-09-02 09:18:27
...
### 49. SALA: Semantic-Aware Logical Alignment for Complex Reasoning in In-Context Learning
...
### 50. Improving Evaluation Realism with Inference-Time Compute and Deployment Scaffolds
