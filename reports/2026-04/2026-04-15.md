...
### 1. Transforming External Knowledge into Triplets for Enhanced Retrieval in RAG of LLMs
...
- **URL**: <http://arxiv.org/abs/2604.12610v1>
- **Submitted**: 2026-04-14 11:36:29
- **Comment**: 12 pages, 5 figures
- **Topic Keywords**: retriever, query, rag, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The proposed Tri-RAG framework addresses challenges in retrieval efficiency and semantic alignment, which are central to your research focus. While the paper's focus on large language models and Retrieval-Augmented Generation is somewhat specific, the underlying concepts and techniques are applicable to your broader interests in IR and NLP.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Tri‑RAG: Structured Retrieval‑Augmented Generation via Condition–Proof–Conclusion Triplets
- **Aim**: Re‑design evidence representation in RAG systems by structuring retrieved content into concise Condition–Proof–Conclusion (C‑P‑R) triplets, enabling efficient, faithful reasoning across diverse generation strategies.
- **Rationale**: Traditional RAG retrieves long passages, leading to noisy, redundant evidence that hampers LM reasoning. By indexing only the Condition field, the search space shrinks dramatically, and the Proof and Conclusion fields provide verifiable, self‑contained evidence that any reasoning strategy can consume without modification.
- **Ground**: Triplet extraction is performed with soft‑prompt tuning on frozen Transformer backbones (BERT, RoBERTa, Llama‑3‑8B, Qwen‑3‑8B, etc.). The extractor produces tagged strings ([C]T_c[P]T_p[R]T_r). Knowledge units are segmented, normalized, deduplicated, and indexed solely on (T_c). Retrieval uses a shared dense encoder to find top‑k Conditions; retrieved triplets are serialized into a token‑budgeted evidence block with field‑aware truncation. The generator remains frozen; only soft prompts are trained.
- **Experiment**: Training on a single RTX 4090 with AdamW (lr = 1e‑4, weight‑decay = 0.01), 10 % warm‑up, linear decay, batch = 6, max = 20 epochs, early stopping (patience = 5). Generators: GPT‑4o‑mini, GPT‑4.1‑nano, Qwen‑Long, Qwen‑Max, Gemma‑2‑27B. Extractors: DeepSeek‑7B, Llama‑3‑8B, Qwen3‑8B (all frozen). Retrieval uses a common encoder, depth k, evidence‑token budget B, field‑aware truncation prioritizing Condition and Conclusion. Generation uses deterministic decoding (temperature = 0.0). Baselines include Direct, ReAct, Self‑Act, Aflow, Semantic RAG, Hybrid RAG, LightRAG, GraphRAG, KG2RAG, and parameter‑efficient adapters (Prefix Tuning, LoRA).
- **Takeaway**: Tri‑RAG demonstrates that structuring evidence into C‑P‑R triplets and anchoring retrieval on Conditions yields cleaner, more relevant evidence, improves factual accuracy and faithfulness, and is compatible with multiple reasoning strategies and LLM backbones while keeping the backbone frozen and training lightweight soft‑prompt adapters.
...
### 2. Deep Situation-Aware Interaction Network for Click-Through Rate Prediction

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Yimin Lv, Shuli Wang, Beihong Jin, Yisong Yu, Yapeng Zhang, Jian Dong, Yongkang Wang, Xingxing Wang, Dong Wang
- **URL**: <http://arxiv.org/abs/2604.12298v1>
- **Submitted**: 2026-04-14 05:14:05
- **Comment**: RecSys'23 Full Paper
- **Topic Keywords**: user behavior, click, ctr, click-through rate, commerce, e-commerce
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of click models and user behavior modeling. The proposed Deep Situation-Aware Interaction Network (DSAIN) model is designed for Click-Through Rate (CTR) prediction, which aligns with your focus on real-time relevance optimization. Although the paper is primarily focused on the e-commerce domain, the techniques and concepts presented can be applied to other areas of IR.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Deep Situation‑Aware Interaction Network (DSAIN) for CTR prediction
- **Aim**: Develop an end‑to‑end CTR model that explicitly models full situational context and cross‑modal interactions while denoising noisy exposed items.
- **Rationale**: Industrial CTR engines typically ignore rich contextual signals and treat noisy exposures in isolation, leading to diluted user intent and poor cross‑modal interaction capture.
- **Ground**: DSAIN architecture includes separate situational and common embeddings, a Gumbel‑Softmax Behavior Denoising Module, a Situational Feature Encoder, a Tri‑Directional Correlation Fusion Module (cross‑behavior, cross‑feature, cross‑channel), lightweight mixers (shifted, channel, feature), a Situation Aggregation Module, and a Mixer Stack, all designed for end‑to‑end differentiability and low inference latency.
- **Experiment**: Offline evaluation on two public e‑commerce datasets and one industrial log achieved state‑of‑the‑art AUC/log‑loss; online A/B tests on Meituan food‑delivery app yielded +2.70% CTR, +2.62% CPM, +2.16% GMV, leading to deployment as the primary CTR engine.
- **Takeaway**: Incorporating rich, multi‑dimensional situational context, noise‑aware denoising, and lightweight tri‑directional correlation modeling yields substantial CTR gains and a production‑ready, low‑latency recommendation system.
...
### 3. Beyond Factual Grounding: The Case for Opinion-Aware Retrieval-Augmented Generation

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Aditya Agrawal, Alwarappan Nakkiran, Darshan Fofadiya, Alex Karlsson, Harsha Aduri
- **URL**: <http://arxiv.org/abs/2604.12138v1>
- **Submitted**: 2026-04-13 23:39:39
- **Comment**: 13 pages, Preprint under review
- **Topic Keywords**: queries, rag, retrieval, commerce, e-commerce
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The paper's focus on opinion-aware retrieval-augmented generation and its implications for real-world scenarios involving subjective content aligns with your interests in deep semantic understanding and real-time relevance optimization.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Comparison of Raw and Enriched Knowledge Bases
- **Aim**: Assess how enrichment transforms KB content and user experience
- **Rationale**: Enriched KBs embed constructive feedback, behavioral explanations, and narrative flow, potentially improving usability and engagement
- **Ground**: Raw KBs list actions without context; Enriched KBs add guidance, motivation, and storytelling
- **Experiment**: A qualitative comparison of two KB formats, examining presence of feedback, motivation, and structure across sample entries
- **Takeaway**: Enriched KBs deliver more actionable, insightful, and engaging information than flat Raw KBs
...
### 4. NaviRAG: Towards Active Knowledge Navigation for Retrieval-Augmented Generation

- **LLM Score**: 8
- **Keyword Score**: 7
- **Authors**: Jihao Dai, Dingjun Wu, Yuxuan Chen, Zheni Zeng, Yukun Yan, Zhenghao Liu, Maosong Sun
- **URL**: <http://arxiv.org/abs/2604.12766v1>
- **Submitted**: 2026-04-14 14:07:01
- **Topic Keywords**: queries, rag, retrieval
- **Reason**: This paper introduces NaviRAG, a novel framework for active knowledge navigation in Retrieval-Augmented Generation (RAG), addressing limitations in current RAG approaches. The framework's focus on hierarchical knowledge representation, multi-granular evidence localization, and dynamic retrieval planning aligns with your interests in query understanding, ranking models, and user behavior modeling. However, the paper's primary focus on RAG and knowledge navigation, while related to IR, is not a central match to your core research themes.
...
### 5. Knowledge Is Not Static: Order-Aware Hypergraph RAG for Language Models

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Keshu Wu, Chenchen Kuai, Zihao Li, Jiwan Jiang, Shiyu Shen, Shian Wang, Chan-Wei Hu, Zhengzhong Tu, Yang Zhou
- **URL**: <http://arxiv.org/abs/2604.12185v1>
- **Submitted**: 2026-04-14 01:31:35
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is highly relevant to information retrieval, particularly in the context of query understanding and ranking models. The focus on order-aware hypergraph RAG for language models aligns with the user's interest in deep semantic understanding and real-time relevance optimization. However, the paper's emphasis on natural language processing and question answering tasks is somewhat outside the user's primary focus on e-commerce and search technologies.
...
### 6. Thought-Retriever: Don't Just Retrieve Raw Data, Retrieve Thoughts for Memory-Augmented Agentic Systems

- **LLM Score**: 6
- **Keyword Score**: 14
- **Authors**: Tao Feng, Pengrui Han, Guanyu Lin, Ge Liu, Jiaxuan You
- **URL**: <http://arxiv.org/abs/2604.12231v1>
- **Submitted**: 2026-04-14 03:11:36
- **Topic Keywords**: retriever, queries, ltr, rag, retrieval, search
- **Reason**: This paper proposes a novel model-agnostic algorithm, Thought-Retriever, to help Large Language Models (LLMs) generate output conditioned on arbitrarily long external data. While it's related to query understanding and ranking models, the focus is on leveraging intermediate responses generated by LLMs, which is somewhat aligned with your research interests in Information Retrieval and NLP.
...
### 7. AdversarialCoT: Single-Document Retrieval Poisoning for LLM Reasoning

- **LLM Score**: 6
- **Keyword Score**: 10
- **Authors**: Hongru Song, Yu-An Liu, Ruqing Zhang, Jiafeng Guo, Maarten de Rijke, Yixing Fan, Xueqi Cheng
- **URL**: <http://arxiv.org/abs/2604.12201v1>
- **Submitted**: 2026-04-14 02:10:23
- **Comment**: 6 pages,accepted by SIGIR 2026 short paper
- **Topic Keywords**: retriever, query, rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the context of Retrieval-augmented generation (RAG) and its potential vulnerabilities. However, the focus on security risks and LLM reasoning pipelines is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 8. UniRec: Bridging the Expressive Gap between Generative and Discriminative Recommendation via Chain-of-Attribute

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Ziliang Wang, Gaoyun Lin, Xuesi Wang, Shaoqiang Liang, Yili Huang, Weijie Bian
- **URL**: <http://arxiv.org/abs/2604.12234v1>
- **Submitted**: 2026-04-14 03:13:50
- **Topic Keywords**: ranking, rag, retrieval, recommend, rank, search
- **Reason**: The paper focuses on recommendation systems, specifically addressing the gap between generative and discriminative models. While it touches on ranking and user behavior modeling, the primary focus is on recommendation systems, which is somewhat related to your interests in information retrieval and search technologies. However, the paper's emphasis on recommendation systems and the e-commerce domain is not a central match for your research themes.
...
### 9. The Effect of Document Selection on Query-focused Text Analysis

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Sandesh S Rangreji, Mian Zhong, Anjalie Field
- **URL**: <http://arxiv.org/abs/2604.12099v1>
- **Submitted**: 2026-04-13 22:19:20
- **Topic Keywords**: query, queries, retrieval, search
- **Reason**: The paper discusses document selection strategies for query-focused text analysis, which is somewhat related to information retrieval. However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The focus on text analysis and selection strategies is more aligned with NLP and data mining, but not a central match for the user's primary research themes.
...
- **URL**: <http://arxiv.org/abs/2604.12928v1>
- **Submitted**: 2026-04-14 16:17:52
- **Topic Keywords**: queries, rag, retrieval
- **Reason**: This paper is somewhat relevant to your research interests in Information Retrieval and Natural Language Processing, as it discusses a knowledge retrieval approach for speech language models. However, the focus is on full-duplex speech models and factuality, which is not directly related to your core areas of query understanding, ranking models, and user behavior modeling.
...
### 11. Coding-Free and Privacy-Preserving MCP Framework for Clinical Agentic Research Intelligence System

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Taehun Kim, Hyeryun Park, Hyeonhoon Lee, Yushin Lee, Kyungsang Kim, Hyung-Chul Lee
- **URL**: <http://arxiv.org/abs/2604.12258v1>
- **Submitted**: 2026-04-14 04:22:44
- **Comment**: 10 pages, 5 figures, 2 tables, Supplementary Appendix
- **Topic Keywords**: ranking, rag, rank, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of integrating Large Language Models with modular tools. However, the focus on Clinical Agentic Research Intelligence System and its application to clinical research workflows is not directly aligned with your primary research themes.
...
### 12. Efficient Retrieval Scaling with Hierarchical Indexing for Large Scale Recommendation
...
- **URL**: <http://arxiv.org/abs/2604.12965v1>
- **Submitted**: 2026-04-14 16:59:03
- **Comment**: 11 pages, 5 figures
- **Topic Keywords**: rag, retrieval, recommend, search
- **Reason**: The paper focuses on efficient retrieval scaling for large-scale recommendation tasks, which is somewhat related to information retrieval. However, it primarily deals with recommender systems and hierarchical indexing, which is not a central match for your research interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on real-world deployment and test-time training is also not directly aligned with your focus on deep semantic understanding and real-time relevance optimization.
...
### 13. CascadeDebate: Multi-Agent Deliberation for Cost-Aware LLM Cascades

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Raeyoung Chang, Dongwook Kwon, Jisoo Lee, Nikhil Verma
- **URL**: <http://arxiv.org/abs/2604.12262v1>
- **Submitted**: 2026-04-14 04:26:39
- **Comment**: 12 pages, 6 figures, 4 tables, 1 algorithm
- **Topic Keywords**: query, queries
- **Reason**: This paper explores a novel approach to cascaded LLM systems, addressing issues with ambiguous queries and under-confidence. While it touches on aspects of query understanding and ranking models, its primary focus is on cost-aware LLM cascades and multi-agent deliberation, which is somewhat related to your research interests in Information Retrieval and NLP. However, the paper's emphasis on cost-awareness and multi-agent deliberation is not directly aligned with your core research themes.
...
### 14. Beyond Majority Voting: Efficient Best-Of-N with Radial Consensus Score

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Manh Nguyen, Sunil Gupta, Hung Le
- **URL**: <http://arxiv.org/abs/2604.12196v1>
- **Submitted**: 2026-04-14 02:02:20
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the context of large language models and answer selection. However, the focus on geometric consensus and radial distance to a semantic center is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 15. KG-Reasoner: A Reinforced Model for End-to-End Multi-Hop Knowledge Graph Reasoning

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Shuai Wang, Yinan Yu
- **URL**: <http://arxiv.org/abs/2604.12487v1>
- **Submitted**: 2026-04-14 09:14:21
- **Comment**: 15 pages, 4 figures
- **Topic Keywords**: queries, rag
- **Reason**: This paper focuses on knowledge graph reasoning and multi-hop reasoning, which is somewhat related to information retrieval, particularly in the context of query understanding and ranking models. However, the paper's primary focus on knowledge graphs and reasoning LLMs is not directly aligned with the user's core research themes in IR and search technologies. The paper's use of reinforcement learning and knowledge graphs may be of interest in the broader context of NLP and data mining, but it does not directly address the user's primary research interests.
...
- **URL**: <http://arxiv.org/abs/2604.12047v1>
- **Submitted**: 2026-04-13 20:39:43
- **Comment**: 12 pages
- **Topic Keywords**: rag, retrieval, search
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval, specifically in the context of PDF parsing and chunking. However, the focus on Retrieval-Augmented Generation (RAG) systems and financial question answering is not a central match to the user's primary research themes. The paper's relevance is also limited by its narrow application domain (financial question answering) and lack of direct connection to query understanding, ranking models, or user behavior modeling.
...
### 17. MultiDocFusion: Hierarchical and Multimodal Chunking Pipeline for Enhanced RAG on Long Industrial Documents

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Joongmin Shin, Chanjun Park, Jeongbae Park, Jaehyung Seo, Heuiseok Lim
- **URL**: <http://arxiv.org/abs/2604.12352v1>
- **Submitted**: 2026-04-14 06:40:22
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper focuses on multimodal chunking and document structure parsing, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the primary application domain is industrial documents and QA, which is not a central match to the user's interests. The paper does not explicitly address query understanding, ranking models, or user behavior modeling.
...
### 18. RPRA: Predicting an LLM-Judge for Efficient but Performant Inference
...
- **URL**: <http://arxiv.org/abs/2604.12634v1>
- **Submitted**: 2026-04-14 12:04:21
...
- **Reason**: This paper explores the Predict-Answer/Act and Reason-Predict-Reason-Answer/Act paradigms for predicting the performance of large language models, which is somewhat related to information retrieval and search technologies. However, the focus on large language models and their performance limitations is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.12452v1>
- **Submitted**: 2026-04-14 08:40:31
- **Comment**: Accepted by ACL 2026
- **Topic Keywords**: query
- **Reason**: This paper focuses on improving the efficiency of long context modeling in large language models, which is somewhat related to information retrieval and search technologies. However, the specific application and techniques discussed are more aligned with natural language processing and deep learning, rather than query understanding, ranking models, or user behavior modeling.
...
### 20. From Myopic Selection to Long-Horizon Awareness: Sequential LLM Routing for Multi-Turn Dialogue

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Jiarui Zhang, Xiangyu Liu, Yong Hu, Chaoyue Niu, Hang Zeng, Shaojie Tang, Fan Wu, Guihai Chen
- **URL**: <http://arxiv.org/abs/2604.12385v1>
- **Submitted**: 2026-04-14 07:18:06
- **Topic Keywords**: retrieval, search
- **Reason**: The paper focuses on multi-turn dialogue routing for large language models, which is somewhat related to information retrieval and search technologies. However, the primary focus is on dialogue routing rather than query understanding or ranking models, limiting its relevance to the user's core research themes.
...
### 21. Is Sliding Window All You Need? An Open Framework for Long-Sequence Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Sayak Chakrabarty, Souradip Pal
- **URL**: <http://arxiv.org/abs/2604.12372v1>
- **Submitted**: 2026-04-14 06:59:40
- **Comment**: 8 pages, 2 figures
- **Topic Keywords**: retrieval, recommend
- **Reason**: The paper is somewhat related to your research interests in Information Retrieval and recommender systems, but it focuses more on long-sequence recommendation and training techniques, which is not a central match to your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 22. ContextLens: Modeling Imperfect Privacy and Safety Context for Legal Compliance

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Haoran Li, Yulin Chen, Huihao Jing, Wenbin Hu, Tsz Ho Li, Chanhou Lou, Hong Ting Tsang, Sirui Han, Yangqiu Song
- **URL**: <http://arxiv.org/abs/2604.12308v1>
- **Submitted**: 2026-04-14 05:35:38
- **Comment**: Accepted by ACL 26
- **Topic Keywords**: rag, search
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, particularly in the context of leveraging large language models for contextualized safety and privacy assessments. However, the focus on legal compliance and data privacy is not directly aligned with your primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 23. Continuous Knowledge Metabolism: Generating Scientific Hypotheses from Evolving Literature

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Jinkai Tao, Yubo Wang, Xiaoyu Liu, Menglin Yang
- **URL**: <http://arxiv.org/abs/2604.12243v1>
- **Submitted**: 2026-04-14 03:41:53
- **Comment**: 32 pages, 6 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper introduces a framework for generating scientific hypotheses from evolving literature, which is somewhat related to information retrieval and deep semantic understanding. However, the focus on scientific literature and hypothesis generation is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.12736v1>
- **Submitted**: 2026-04-14 13:50:31
- **Topic Keywords**: rag
- **Reason**: This paper proposes a novel framework, TEPO, for optimizing large language models' token-level sparse-rewards in chain-of-thought reasoning. While it touches on aspects of query understanding and ranking models, its primary focus is on improving language model performance, which is somewhat related to your interests in Information Retrieval and NLP. However, the specific application and methodology are not directly aligned with your core research themes.
...
### 25. Learning Chain Of Thoughts Prompts for Predicting Entities, Relations, and even Literals on Knowledge Graphs

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Alkid Baci, Luke Friedrichs, Caglar Demir, N'Dah Jean Kouagou, Axel-Cyrille Ngonga Ngomo
- **URL**: <http://arxiv.org/abs/2604.12651v1>
- **Submitted**: 2026-04-14 12:21:15
- **Topic Keywords**: retrieval
- **Reason**: This paper explores knowledge graph embedding and large language models for link prediction, which is somewhat related to information retrieval, but the focus on knowledge graph embedding and natural language processing is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.12518v1>
- **Submitted**: 2026-04-14 09:52:53
- **Comment**: Accepted by CVPR 2026
- **Topic Keywords**: rag
- **Reason**: The paper focuses on multimodal sentiment analysis, which involves integrating multiple sources of information, a topic somewhat related to information retrieval and query understanding. However, the specific application and techniques used are not directly aligned with the user's core research themes, such as ranking models and user behavior modeling.
...
### 27. Topology-Aware Reasoning over Incomplete Knowledge Graph with Graph-Based Soft Prompting

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Shuai Wang, Xixi Wang, Yinan Yu
- **URL**: <http://arxiv.org/abs/2604.12503v1>
- **Submitted**: 2026-04-14 09:27:52
- **Comment**: 12 pages, 2 figures
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Knowledge Graphs, but it primarily focuses on a specific application (Knowledge Base Question Answering) and does not directly address your core areas of interest in Information Retrieval, query understanding, or ranking models.
...
### 28. Agentic Insight Generation in VSM Simulations

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Micha Selak, Dirk Krechel, Adrian Ulges, Sven Spieckermann, Niklas Stoehr, Andreas Loehr
- **URL**: <http://arxiv.org/abs/2604.12421v1>
- **Submitted**: 2026-04-14 08:11:53
- **Topic Keywords**: rag
- **Reason**: The paper discusses a novel architecture for extracting insights from complex data, leveraging large language models. While it touches on data analysis and reasoning, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of interest. The connection to NLP is present, but the focus on value stream map simulations and domain expert knowledge makes it somewhat relevant but not a central match.
...
### 29. Long-Horizon Plan Execution in Large Tool Spaces through Entropy-Guided Branching

- **LLM Score**: 3
- **Keyword Score**: 3
- **Authors**: Rongzhe Wei, Ge Shi, Min Cheng, Na Zhang, Pan Li, Sarthak Ghosh, Vaibhav Gorde, Leman Akoglu
- **URL**: <http://arxiv.org/abs/2604.12126v1>
- **Submitted**: 2026-04-13 23:14:32
- **Comment**: This work was completed during an internship at Amazon
- **Topic Keywords**: commerce, e-commerce, search
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval and Search technologies, but it primarily focuses on tool-augmented agents and large language models, which is not a central match. The paper does touch on search efficiency and uncertainty-aware search, but it's more related to planning and execution in tool-rich environments rather than query understanding or ranking models.
...
### 30. UCS: Estimating Unseen Coverage for Improved In-Context Learning

- **LLM Score**: 2
- **Keyword Score**: 10
- **Authors**: Jiayi Xin, Xiang Li, Evan Qiang, Weiqing He, Tianqi Shang, Weijie J. Su, Qi Long
- **URL**: <http://arxiv.org/abs/2604.12015v1>
- **Submitted**: 2026-04-13 20:00:41
- **Comment**: ACL 2026 Findings; 17 pages, 3 figures
- **Topic Keywords**: query, relevance, rag, ctr
- **Reason**: This paper focuses on in-context learning and demonstration set selection, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves Large Language Models, the context and application are quite different from your areas of focus.
...
### 31. Sparse Contrastive Learning for Content-Based Cold Item Recommendation

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Gregor Meehan, Johan Pauwels
- **URL**: <http://arxiv.org/abs/2604.12990v1>
- **Submitted**: 2026-04-14 17:24:25
- **Comment**: Accepted at SIGIR 2026
- **Topic Keywords**: ranking, relevance, recommend, rank
- **Reason**: This paper focuses on recommender systems, specifically addressing the cold-start problem, which is not a core area of interest for you. While it involves content-based modeling and ranking accuracy, it does not align with your primary focus on information retrieval, query understanding, and deep semantic understanding.
...
### 32. When Self-Reference Fails to Close: Matrix-Level Dynamics in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Ji Ho Bae
- **URL**: <http://arxiv.org/abs/2604.12128v1>
- **Submitted**: 2026-04-13 23:23:02
- **Comment**: 14 pages, 4 figures, 11 tables
- **Topic Keywords**: relevance, ctr, rank
- **Reason**: This paper appears to be primarily focused on the internal dynamics of large language models, specifically the effects of self-referential inputs. While it touches on the concept of instability, it does not directly relate to the user's core research interests in Information Retrieval, Search technologies, or Natural Language Processing, particularly in areas requiring deep semantic understanding and real-time relevance optimization.
...
### 33. One Token Away from Collapse: The Fragility of Instruction-Tuned Helpfulness

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Erfan Baghaei Potraghloo, Seyedarmin Azizi, Souvik Kundu, Massoud Pedram
- **URL**: <http://arxiv.org/abs/2604.13006v1>
- **Submitted**: 2026-04-14 17:40:01
- **Topic Keywords**: pairwise, rag
- **Reason**: This paper is primarily focused on the fragility of instruction-tuned large language models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the topic of language models, the context and methodology are more aligned with NLP and model evaluation, rather than query understanding, ranking models, or user behavior modeling.
...
### 34. GlotOCR Bench: OCR Models Still Struggle Beyond a Handful of Unicode Scripts

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Amir Hossein Kargaran, Nafiseh Nikeghbal, Jana Diesner, François Yvon, Hinrich Schütze
- **URL**: <http://arxiv.org/abs/2604.12978v1>
- **Submitted**: 2026-04-14 17:12:41
- **Topic Keywords**: ltr, rag
- **Reason**: This paper is not relevant to your research interests as it focuses on Optical Character Recognition (OCR) and evaluation of OCR models, which is outside your primary focus on Information Retrieval and Search technologies. Although it involves vision-language models, the context is different from your interests in query understanding, ranking models, and user behavior modeling.
...
### 35. Multilingual Multi-Label Emotion Classification at Scale with Synthetic Data

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Vadim Borisov
- **URL**: <http://arxiv.org/abs/2604.12633v1>
- **Submitted**: 2026-04-14 12:04:17
- **Topic Keywords**: ranking, rank, korea
- **Reason**: This paper focuses on multilingual emotion classification, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves transformer encoders and multilingual settings, the topic is more aligned with NLP and emotion classification, rather than query understanding, ranking models, or user behavior modeling.
...
### 36. GeoAlign: Geometric Feature Realignment for MLLM Spatial Reasoning

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Zhaochen Liu, Limeng Qiao, Guanglu Wan, Tingting Jiang
- **URL**: <http://arxiv.org/abs/2604.12630v1>
- **Submitted**: 2026-04-14 11:58:02
- **Topic Keywords**: queries, rag
- **Reason**: This paper appears to be primarily focused on multimodal large language models and spatial reasoning, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves some form of 'relevance optimization', it's more related to visual tasks and geometric feature realignment rather than query understanding, ranking models, or user behavior modeling.
...
### 37. LoSA: Locality Aware Sparse Attention for Block-Wise Diffusion Language Models
...
- **URL**: <http://arxiv.org/abs/2604.12056v1>
- **Submitted**: 2026-04-13 20:53:51
- **Comment**: 16 pages, 11 figures, 6 tables
- **Topic Keywords**: queries, rag
- **Reason**: This paper focuses on improving the efficiency of block-wise diffusion language models, specifically addressing memory-bound attention issues. While it touches on attention mechanisms, which are related to ranking models, the context is primarily within NLP and language models, which is somewhat tangential to your core research interests in Information Retrieval and Search technologies.
...
### 38. Growing Pains: Extensible and Efficient LLM Benchmarking Via Fixed Parameter Calibration
...
- **URL**: <http://arxiv.org/abs/2604.12843v2>
- **Submitted**: 2026-04-14 15:01:29
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on benchmarking large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on evaluation and comparison of models, it doesn't address query understanding, ranking models, or user behavior modeling, making it somewhat tangential to your research.
...
### 39. GoodPoint: Learning Constructive Scientific Paper Feedback from Author Responses

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jimin Mun, Chani Jung, Xuhui Zhou, Hyunwoo Kim, Maarten Sap
- **URL**: <http://arxiv.org/abs/2604.11924v1>
- **Submitted**: 2026-04-13 18:12:57
- **Comment**: 22 pages, 6 figures
- **Topic Keywords**: rag, search, iclr
- **Reason**: This paper focuses on generating constructive feedback for scientific research using LLMs, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is more focused on augmenting research rather than improving search or retrieval systems.
...
### 40. GLeMM: A large-scale multilingual dataset for morphological research

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Hathout Nabil, Basilio Calderone, Fiammetta Namer, Franck Sajous
- **URL**: <http://arxiv.org/abs/2604.12442v1>
- **Submitted**: 2026-04-14 08:29:42
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on derivational morphology and the creation of a multilingual dataset, which is outside your primary areas of interest.
...
### 41. Cooperative Memory Paging with Keyword Bookmarks for Long-Horizon LLM Conversations

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ziyang Liu
- **URL**: <http://arxiv.org/abs/2604.12376v1>
- **Submitted**: 2026-04-14 07:06:35
- **Comment**: 16 pages, 10 figures, 16 tables
- **Topic Keywords**: retrieval, search
- **Reason**: This paper appears to be focused on optimizing long-horizon LLM conversations through cooperative memory paging and keyword bookmarks, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP concepts, the primary focus is on LLM conversations and memory management, making it somewhat tangential to your research areas.
...
### 42. PolicyLLM: Towards Excellent Comprehension of Public Policy for Large Language Models
...
- **URL**: <http://arxiv.org/abs/2604.12995v1>
- **Submitted**: 2026-04-14 17:27:50
- **Comment**: Accepted by ACL 2026 findings
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on evaluating the comprehension of public policy for Large Language Models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves NLP, the specific domain of public policy and the evaluation of policy comprehension are not central to your research themes.
...
### 43. InsightFlow: LLM-Driven Synthesis of Patient Narratives for Mental Health into Causal Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Shreya Gupta, Prottay Kumar Adhikary, Bhavyaa Dave, Salam Michael Singh, Aniket Deroy, Tanmoy Chakraborty
- **URL**: <http://arxiv.org/abs/2604.12721v1>
- **Submitted**: 2026-04-14 13:36:18
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on applying LLMs to mental health and clinical workflows. While it involves NLP techniques, the context and application are quite different from your areas of focus.
...
### 44. Do VLMs Truly "Read" Candlesticks? A Multi-Scale Benchmark for Visual Stock Price Forecasting

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Kaiqi Hu, Linda Xiao, Shiyue Xu, Ziyi Tang, Mingwen Liu
- **URL**: <http://arxiv.org/abs/2604.12659v1>
- **Submitted**: 2026-04-14 12:26:34
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The paper focuses on Visual Stock Price Forecasting, which is outside your primary area of focus, and does not involve query understanding, ranking models, or user behavior modeling.
...
### 45. Adaptive Test-Time Scaling for Zero-Shot Respiratory Audio Classification

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Tsai-Ning Wang, Herman Teun den Dekker, Lin-Lin Chen, Neil Zeghidour, Aaqib Saeed
- **URL**: <http://arxiv.org/abs/2604.12647v1>
- **Submitted**: 2026-04-14 12:17:50
- **Comment**: Accepted at AHLI CHIL 2026
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on zero-shot respiratory audio classification, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some form of retrieval-augmented large language model reasoning, the context is specific to medical audio classification and does not align with the user's interests in e-commerce or real-time relevance optimization.
...
### 46. Beyond Transcription: Unified Audio Schema for Perception-Aware AudioLLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Linhao Zhang, Yuhan Song, Aiwei Liu, Chuhan Wu, Sijun Zhang, Wei Jia, Yuan Liu, Houfeng Wang, Xiao Zhou
- **URL**: <http://arxiv.org/abs/2604.12506v1>
- **Submitted**: 2026-04-14 09:30:12
- **Comment**: Accepted to ACL 2026 Findings
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are the core areas of your research interests. While it involves Natural Language Processing (NLP) and deep semantic understanding, the focus is on audio schema and perception-aware AudioLLMs, which is a niche area outside your primary focus.
...
### 47. Beyond Single-Dimension Novelty: How Combinations of Theory, Method, and Results-based Novelty Shape Scientific Impact

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yi Zhao, Yang Chenggang, Yuzhuo Wang, Tong Bao, Zhang Heng, Chengzhi Zhang
- **URL**: <http://arxiv.org/abs/2604.12471v1>
- **Submitted**: 2026-04-14 08:56:59
- **Comment**: AII-EEKE 2026
- **Topic Keywords**: rank, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on the concept of novelty and impact, its focus on scientific impact and citation counts is more aligned with bibliometrics and scientometrics, which are not central to your research themes.
...
### 48. Decoding by Perturbation: Mitigating MLLM Hallucinations via Dynamic Textual Perturbation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sihang Jia, Shuliang Liu, Songbo Yang, Yibo Yan, Xin Zou, Xuming Hu
- **URL**: <http://arxiv.org/abs/2604.12424v1>
- **Submitted**: 2026-04-14 08:15:44
- **Topic Keywords**: rag
- **Reason**: This paper focuses on mitigating hallucinations in multimodal large language models, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing, the context is not aligned with the user's primary research interests in deep semantic understanding and real-time relevance optimization.
...
### 49. MolMem: Memory-Augmented Agentic Reinforcement Learning for Sample-Efficient Molecular Optimization

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ziqing Wang, Yibo Wen, Abhishek Pandy, Han Liu, Kaize Ding
- **URL**: <http://arxiv.org/abs/2604.12237v1>
- **Submitted**: 2026-04-14 03:24:26
- **Topic Keywords**: rag, acl
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on molecular optimization in drug discovery, which is outside your primary areas of interest.
...
- **URL**: <http://arxiv.org/abs/2604.13018v1>
- **Submitted**: 2026-04-14 17:55:16
- **Comment**: Repo: https://github.com/AweAI-Team/AiScientist
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be focused on autonomous long-horizon engineering for ML research, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing.
