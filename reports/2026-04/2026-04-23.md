...
### 1. Coverage, Not Averages: Semantic Stratification for Trustworthy Retrieval Evaluation
...
- **Submitted**: 2026-04-22 16:49:30
- **Topic Keywords**: query, queries, rag, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, specifically addressing evaluation methods and their limitations. The focus on semantic stratification and its application to retrieval-augmented generation aligns with your interests in query understanding and ranking models. However, the paper's primary focus on evaluation methods rather than ranking models or user behavior modeling prevents a higher score.
...
### 2. Self-Aware Vector Embeddings for Retrieval-Augmented Generation: A Neuroscience-Inspired Framework for Temporal, Confidence-Weighted, and Relational Knowledge

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Naizhong Xu
- **URL**: <http://arxiv.org/abs/2604.20598v1>
- **Submitted**: 2026-04-22 14:13:50
- **Comment**: 17 pages, 4 tables
- **Topic Keywords**: queries, relevance, rag, retrieval
- **Reason**: This paper proposes a novel framework, SmartVector, for retrieval-augmented generation that incorporates temporal awareness, confidence decay, and relational awareness. While its focus is on knowledge graph embeddings and temporal knowledge, it shares some connections with query understanding and ranking models in the context of information retrieval. The paper's emphasis on real-time relevance optimization and its use of graph-neural-network-style messages also aligns with some of your research interests.
...
### 3. Semantic Recall for Vector Search

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Leonardo Kuffo, Ioanna Tsakalidou, Roberta De Viti, Albert Angel, Jiří Iša, Rastislav Lenhardt
- **URL**: <http://arxiv.org/abs/2604.20417v1>
- **Submitted**: 2026-04-22 10:34:56
...
- **Reason**: This paper is highly relevant to Information Retrieval, specifically addressing the quality of approximate nearest neighbor search algorithms. The focus on semantic relevance and the introduction of new metrics aligns with your interests in query understanding and ranking models. The application to vector search is a related area, but not directly within your core e-commerce domain focus.
...
- **URL**: <http://arxiv.org/abs/2604.20021v1>
- **Submitted**: 2026-04-21 21:56:43
- **Topic Keywords**: query, queries, acl
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of Large Language Models (LLMs) and query understanding. The focus on semantic caching and continuous query space aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific application to LLMs and caching may not be directly related to your primary focus on search technologies and user behavior modeling.
...
### 5. AFMRL: Attribute-Enhanced Fine-Grained Multi-Modal Representation Learning in E-commerce

- **LLM Score**: 7
- **Keyword Score**: 6
- **Authors**: Biao Zhang, Lixin Chen, Bin Zhang, Zongwei Wang, Tong Liu, Bo Zheng
- **URL**: <http://arxiv.org/abs/2604.20135v1>
- **Submitted**: 2026-04-22 03:02:21
- **Comment**: Accepted by ACL 2026
- **Topic Keywords**: rag, retrieval, commerce, e-commerce
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of multimodal representation learning and fine-grained semantic understanding. Although it focuses on the e-commerce domain, the proposed method and its applications are relevant to your interests in query understanding and ranking models. However, the specific context of e-commerce and the emphasis on attribute generation and reinforcement learning limit its alignment with your broader research themes.
...
### 6. Knowledge Capsules: Structured Nonparametric Memory Units for LLMs

- **LLM Score**: 7
- **Keyword Score**: 4
- **Authors**: Bin Ju, Shenfeng Weng, Danying Zhou, Rongkai Xu, Kunkai Su
- **URL**: <http://arxiv.org/abs/2604.20487v2>
- **Submitted**: 2026-04-22 12:21:00
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper proposes a novel approach to integrating external knowledge into large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. While it primarily focuses on NLP and knowledge representation, it touches on aspects of deep semantic understanding and real-time relevance optimization. However, its relevance to user behavior modeling and recommender systems is limited.
...
### 7. COMPASS: COntinual Multilingual PEFT with Adaptive Semantic Sampling

- **LLM Score**: 6
- **Keyword Score**: 2
- **Authors**: Noah Flynn
- **URL**: <http://arxiv.org/abs/2604.20720v1>
- **Submitted**: 2026-04-22 16:07:10
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it primarily focuses on adapting large language models to target languages, which is not directly related to your core interests in Information Retrieval (IR) and Search technologies. However, the paper's use of distribution-aware sampling and continual learning frameworks may be of interest to you as a related topic.
...
### 8. Text-to-Distribution Prediction with Quantile Tokens and Neighbor Context
...
- **URL**: <http://arxiv.org/abs/2604.20216v1>
- **Submitted**: 2026-04-22 06:05:22
- **Comment**: Accepted to ACL 2026 main conference
- **Topic Keywords**: retrieval
- **Reason**: This paper explores distributional regression with LLMs, introducing Quantile Token Regression and neighbor context. While it touches on aspects of query understanding and ranking models, its primary focus is on distributional regression, which is somewhat related to the user's interests in IR and ranking models. However, the connection is not central to the user's core research themes.
...
### 9. A Reproducibility Study of Metacognitive Retrieval-Augmented Generation

- **LLM Score**: 4
- **Keyword Score**: 20
- **Authors**: Gabriel Iturra-Bocaz, Petra Galuscakova
- **URL**: <http://arxiv.org/abs/2604.19899v1>
- **Submitted**: 2026-04-21 18:22:15
- **Comment**: Paper accepted at ACM SIGIR Conference 2026
- **Topic Keywords**: ranking, rerank, listwise, pointwise, rag, retrieval augmented generation, retrieval, rank, search
- **Reason**: The paper is somewhat related to information retrieval, specifically focusing on Retrieval Augmented Generation (RAG) and its variants. However, the primary focus on reproducibility and the specific application to multi-hop question answering does not align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 10. All Languages Matter: Understanding and Mitigating Language Bias in Multilingual RAG
...
- **URL**: <http://arxiv.org/abs/2604.20199v1>
- **Submitted**: 2026-04-22 05:33:06
- **Comment**: ACL 2026 main conference
- **Topic Keywords**: query, ranking, rerank, rag, retrieval, rank, acl
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of multilingual retrieval and reranking. However, the focus on mitigating language bias in multilingual Retrieval-Augmented Generation (RAG) systems is not directly aligned with the user's primary focus on query understanding, ranking models, and user behavior modeling. While the paper touches on reranking, it is more focused on language bias and multilingual evidence ranking.
...
### 11. HaS: Accelerating RAG through Homology-Aware Speculative Retrieval

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Peng Peng, Weiwei Lin, Wentai Wu, Xinyang Wang, Yongheng Liu
- **URL**: <http://arxiv.org/abs/2604.20452v1>
- **Submitted**: 2026-04-22 11:15:54
- **Comment**: Accepted by ICDE 2026
- **Topic Keywords**: query, queries, rag, retrieval
- **Reason**: This paper is somewhat related to information retrieval, but its focus on accelerating Retrieval-Augmented Generation (RAG) through speculative retrieval is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. While it touches on efficiency gains and real-time relevance optimization, the context is more geared towards large language models and knowledge databases, which is not a central match for the user's interests.
...
### 12. Multi-Perspective Evidence Synthesis and Reasoning for Unsupervised Multimodal Entity Linking

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Mo Zhou, Jianwei Wang, Kai Wang, Helen Paik, Ying Zhang, Wenjie Zhang
- **URL**: <http://arxiv.org/abs/2604.20283v1>
- **Submitted**: 2026-04-22 07:30:16
- **Topic Keywords**: ranking, rag, rank
- **Reason**: The paper explores Multimodal Entity Linking, which is related to information retrieval, but its focus on multimodal entity linking and evidence synthesis is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling. However, the use of Large Language Models and graph neural networks may be of interest to the user's NLP and data mining background.
...
### 13. Effects of Cross-lingual Evidence in Multilingual Medical Question Answering

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Anar Yeginbergen, Maite Oronoz, Rodrigo Agerri
- **URL**: <http://arxiv.org/abs/2604.20531v1>
- **Submitted**: 2026-04-22 13:09:41
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of multilingual question answering and the use of external evidence sources. However, the focus on medical question answering and the specific languages investigated (e.g., Basque, Kazakh) limits its relevance to your core areas of interest in e-commerce and deep semantic understanding.
...
### 14. From Hidden Profiles to Governable Personalization: Recommender Systems in the Age of LLM Agents

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Jiahao Liu, Mingzhe Han, Guanming Liu, Weihang Wang, Dongsheng Li, Hansu Gu, Peng Zhang, Tun Lu, Ning Gu
- **URL**: <http://arxiv.org/abs/2604.20065v1>
- **Submitted**: 2026-04-22 00:04:47
- **Comment**: 6 pages, under review
- **Topic Keywords**: recommend, personalization, shopping, search
- **Reason**: The paper explores recommender systems in the context of LLM agents, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on personalization and user representation is not directly aligned with your core research themes, particularly query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.20564v1>
- **Submitted**: 2026-04-22 13:45:27
- **Topic Keywords**: rag, search
- **Reason**: This paper explores the limitations of Large Language Models (LLMs) in multi-step logical deduction, specifically focusing on logical connectives. While it touches on aspects of deep semantic understanding, the primary focus is on improving LLMs' reasoning capabilities rather than information retrieval. The paper's relevance to IR and search technologies is limited, but it may have indirect implications for query understanding and ranking models.
...
### 16. Toward Cross-Lingual Quality Classifiers for Multilingual Pretraining Data Selection

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Yassine Turki, Vinko Sabolčec, Bettina Messmer, Martin Jaggi
- **URL**: <http://arxiv.org/abs/2604.20549v1>
- **Submitted**: 2026-04-22 13:31:28
...
- **Reason**: The paper focuses on data quality filtering for Large Language Models, which is somewhat related to information retrieval and search technologies. However, the specific context of multilingual pretraining data selection and quality classifiers is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.20146v1>
- **Submitted**: 2026-04-22 03:17:36
- **Comment**: 23 pages, 12 figures
- **Topic Keywords**: retrieval, search
- **Reason**: The paper explores Grounded Multimodal Named Entity Recognition (GMNER), which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on multimodal named entity recognition and knowledge exploitation-exploration is not directly aligned with the user's core research themes.
...
- **URL**: <http://arxiv.org/abs/2604.20090v1>
- **Submitted**: 2026-04-22 01:17:19
- **Comment**: Accepted by ACL2026 Main
- **Topic Keywords**: query
- **Reason**: This paper introduces a unified logic cross-lingual reasoning framework, UL-XCoT, which aims to improve multilingual reasoning efficiency. While it touches on aspects of query understanding and ranking models indirectly through its focus on efficient reasoning, it primarily deals with NLP and deep learning techniques. The paper's relevance to information retrieval and search technologies is limited, but it may be of interest to researchers exploring the intersection of NLP and IR.
...
### 19. From Recall to Forgetting: Benchmarking Long-Term Memory for Personalized Agents

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Md Nayem Uddin, Kumar Shubham, Eduardo Blanco, Chitta Baral, Gengyu Wang
- **URL**: <http://arxiv.org/abs/2604.20006v1>
- **Submitted**: 2026-04-21 21:31:01
- **Comment**: Accepted to ACL 2026 Findings
- **Topic Keywords**: retrieval, recommend
- **Reason**: This paper is somewhat related to your interests in Information Retrieval, particularly in the context of personalized agents and memory-grounded tasks. However, it focuses more on long-term memory and knowledge updates, which is not a central match to your primary research themes in query understanding, ranking models, and user behavior modeling. The connection to NLP is also present, but it's not a direct application of your expertise.
...
### 20. ORPHEAS: A Cross-Lingual Greek-English Embedding Model for Retrieval-Augmented Generation
...
- **URL**: <http://arxiv.org/abs/2604.20666v1>
- **Submitted**: 2026-04-22 15:15:45
...
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, specifically in the area of retrieval-augmented generation. However, the focus on cross-lingual Greek-English embedding models and bilingual applications is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's relevance to the user's interests in NLP and data mining is also limited.
...
- **URL**: <http://arxiv.org/abs/2604.20244v1>
- **Submitted**: 2026-04-22 06:46:22
- **Comment**: WIP
- **Topic Keywords**: rag
- **Reason**: This paper focuses on knowledge distillation for large language models, which is somewhat related to information retrieval, but primarily deals with model compression and optimization. While it touches on deep semantic understanding, its main contribution is not directly applicable to real-time relevance optimization in IR. The paper's emphasis on NLP and model families is relevant, but not central to the user's research interests.
...
- **Submitted**: 2026-04-22 04:55:31
- **Topic Keywords**: rag
- **Reason**: This paper proposes a novel approach to optimization problem solving using a Dual-Cluster Memory Agent, which leverages historical solutions to enhance performance. While it involves complex modeling and knowledge representation, it is not directly related to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 23. Whose Story Gets Told? Positionality and Bias in LLM Summaries of Life Narratives

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Melanie Subbiah, Haaris Mian, Nicholas Deas, Ananya Mayukha, Dan P. McAdams, Kathleen McKeown
- **URL**: <http://arxiv.org/abs/2604.20131v1>
- **Submitted**: 2026-04-22 02:58:51
- **Topic Keywords**: rag
- **Reason**: This paper explores the use of Large Language Models (LLMs) in qualitative analysis, specifically in abstractive methods like inductive thematic analysis. While it touches on aspects of natural language processing and data analysis, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 24. Statistics, Not Scale: Modular Medical Dialogue with Bayesian Belief Engine
...
- **URL**: <http://arxiv.org/abs/2604.20022v1>
- **Submitted**: 2026-04-21 21:59:57
- **Comment**: 12 figures, 17 tables
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on a specific application in medical dialogue and diagnostic reasoning, which is not a central match to your primary research focus on Information Retrieval and Search technologies.
...
### 25. Bias in the Tails: How Name-conditioned Evaluative Framing in Resume Summaries Destabilizes LLM-based Hiring

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Huy Nghiem, Phuong-Anh Nguyen-Le, Sy-Tuyen Ho, Hal Daume
- **URL**: <http://arxiv.org/abs/2604.19984v1>
- **Submitted**: 2026-04-21 20:47:21
- **Comment**: First version, 43 pages
- **Topic Keywords**: recommend, search
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval and Natural Language Processing, as it involves LLM-based text generation and analysis. However, the focus on bias in hiring and LLM automation bias is not directly related to your core areas of query understanding, ranking models, and user behavior modeling.
...
### 26. CHASM: Unveiling Covert Advertisements on Chinese Social Media

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Jingyi Zheng, Tianyi Hu, Yule Liu, Zhen Sun, Zongmin Zhang, Zifan Peng, Wenhan Dong, Xinlei He
- **URL**: <http://arxiv.org/abs/2604.20511v1>
- **Submitted**: 2026-04-22 12:53:36
- **Comment**: NeuIPS 2025 (Datasets and Benchmarks Track)
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, as it involves the evaluation of large language models for social media moderation. However, the focus on covert advertisements and multimodal large language models is not directly aligned with your primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 27. Break the Optimization Barrier of LLM-Enhanced Recommenders: A Theoretical Analysis and Practical Framework

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Zhangchi Zhu, Wei Zhang
- **URL**: <http://arxiv.org/abs/2604.20490v1>
- **Submitted**: 2026-04-22 12:22:47
- **Topic Keywords**: recommend
- **Reason**: This paper explores the optimization of LLM-enhanced recommenders, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on recommender systems and the specific problem of LLM-enhanced models limits its relevance to the user's primary research themes. The paper's emphasis on theoretical analysis and practical framework also diverges from the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 28. SpeechParaling-Bench: A Comprehensive Benchmark for Paralinguistic-Aware Speech Generation
...
- **Submitted**: 2026-04-22 17:59:58
- **Comment**: Project page: https://speechparaling-bench.github.io/
- **Topic Keywords**: queries, pairwise, rag
- **Reason**: This paper focuses on speech generation and paralinguistic-aware speech generation, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve language models, the context is speech generation rather than text-based search or retrieval, and the emphasis is on paralinguistic features rather than query understanding or ranking models.
...
### 29. Ask Only When Needed: Proactive Retrieval from Memory and Skills for Experience-Driven Lifelong Agents

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Yuxuan Cai, Jie Zhou, Qin Chen, Liang He
- **URL**: <http://arxiv.org/abs/2604.20572v1>
- **Submitted**: 2026-04-22 13:50:55
- **Topic Keywords**: rag, ctr, retrieval
- **Reason**: The paper's focus on lifelong learning and proactive retrieval from memory and skills is somewhat related to information retrieval, but it does not directly align with the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's application to experience-driven lifelong agents is also outside the user's typical domain of e-commerce.
...
### 30. The GaoYao Benchmark: A Comprehensive Framework for Evaluating Multilingual and Multicultural Abilities of Large Language Models
...
- **URL**: <http://arxiv.org/abs/2604.20225v1>
- **Submitted**: 2026-04-22 06:19:46
- **Comment**: Accepted by ACL 2026 main
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper focuses on evaluating the multilingual and multicultural capabilities of Large Language Models, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, the context is more on model evaluation rather than query understanding, ranking models, or user behavior modeling.
...
### 31. To Know is to Construct: Schema-Constrained Generation for Agent Memory

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Lei Zheng, Weinan Song, Daili Li, Yanming Yang
- **URL**: <http://arxiv.org/abs/2604.20117v1>
- **Submitted**: 2026-04-22 02:27:50
- **Topic Keywords**: dense retrieval, retrieval
- **Reason**: This paper focuses on schema-constrained generation for agent memory, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing and deep semantic understanding, the context is more aligned with cognitive architectures and knowledge representation, making it less relevant to your core research interests.
...
### 32. ActuBench: A Multi-Agent LLM Pipeline for Generation and Evaluation of Actuarial Reasoning Tasks

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jan-Philipp Schmidt
- **URL**: <http://arxiv.org/abs/2604.20273v1>
- **Submitted**: 2026-04-22 07:20:03
- **Comment**: 19 pages, 4 figures, 4 tables
- **Topic Keywords**: ranking, rank
- **Reason**: The paper focuses on actuarial reasoning tasks and multi-agent LLM pipelines, which is unrelated to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves LLMs, the context and application are distinct from the user's areas of focus.
...
### 33. SignDATA: Data Pipeline for Sign Language Translation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Kuanwei Chen, Tingyi Lin
- **URL**: <http://arxiv.org/abs/2604.20357v1>
- **Submitted**: 2026-04-22 08:58:22
- **Comment**: 7 pages, 1 figure
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on sign language translation and preprocessing, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves data processing, the context and techniques described do not align with the user's areas of expertise.
...
- **URL**: <http://arxiv.org/abs/2604.20200v1>
- **Submitted**: 2026-04-22 05:36:01
- **Comment**: 25 pages
- **Topic Keywords**: rag, rank
- **Reason**: This paper appears to be off-topic as it focuses on user behavior in coding agent workflows, exploiting public scores, and developing a benchmark for coding agents. While it involves machine learning and user interaction, it is not directly related to information retrieval, query understanding, ranking models, or user behavior modeling in search technologies, which are the core areas of your research interests.
...
### 35. Aligning Human-AI-Interaction Trust for Mental Health Support: Survey and Position for Multi-Stakeholders
...
- **URL**: <http://arxiv.org/abs/2604.20166v1>
- **Submitted**: 2026-04-22 04:11:01
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on trustworthy AI systems for mental health support, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it mentions NLP, it is in the context of mental health support, which is not a primary area of interest for the user. The paper's focus on trustworthiness and socio-technical alignment is also not a central match for the user's research interests.
...
### 36. Meta-Tool: Efficient Few-Shot Tool Adaptation for Small Language Models

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Sachin Kumar
- **URL**: <http://arxiv.org/abs/2604.20148v1>
- **Submitted**: 2026-04-22 03:25:17
- **Comment**: Accepted to Findings of ACL 2026
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on adapting small language models for tool-use performance. While it involves Natural Language Processing, the context is not aligned with the user's core research themes.
...
### 37. EmbodiedMidtrain: Bridging the Gap between Vision-Language Models and Vision-Language-Action Models via Mid-training

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yiyang Du, Zhanqiu Guo, Xin Ye, Liu Ren, Chenyan Xiong
- **URL**: <http://arxiv.org/abs/2604.20012v1>
- **Submitted**: 2026-04-21 21:40:58
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on Vision-Language-Action Models and robot manipulation benchmarks suggests a strong connection to Computer Vision and Robotics, which is outside your primary areas of interest.
...
- **URL**: <http://arxiv.org/abs/2604.20732v1>
- **Submitted**: 2026-04-22 16:17:07
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on freight negotiation and dynamic pricing, which is outside the user's primary areas of interest.
...
### 39. MOMO: A framework for seamless physical, verbal, and graphical robot skill learning and adaptation
...
- **URL**: <http://arxiv.org/abs/2604.20468v2>
- **Submitted**: 2026-04-22 11:54:54
- **Comment**: 15 pages, 13 figures, 3 tables
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on robot skill learning and adaptation, which is outside your areas of expertise in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 40. DialToM: A Theory of Mind Benchmark for Forecasting State-Driven Dialogue Trajectories

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Neemesh Yadav, Palakorn Achananuparp, Jing Jiang, Ee-Peng Lim
- **URL**: <http://arxiv.org/abs/2604.20443v1>
- **Submitted**: 2026-04-22 11:07:46
- **Comment**: Submitted to KDD 2026 Datasets and Benchmarks Track
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models and dialogue, the focus is on Theory of Mind and forecasting dialogue trajectories, which is more aligned with NLP and AI research in general, but not specifically with your core themes.
...
### 41. The Path Not Taken: Duality in Reasoning about Program Execution

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Eshgin Hasanov, Md Mahadi Hassan Sibat, Santu Karmaker, Aashish Yadavally
- **URL**: <http://arxiv.org/abs/2604.20917v1>
- **Submitted**: 2026-04-22 03:20:53
- **Comment**: Accepted to ACL 2026 Main Conference
- **Topic Keywords**: rag
- **Reason**: This paper focuses on large language models and their understanding of program execution, which is not directly related to the user's interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves a form of 'query understanding' in the context of code execution, it does not align with the user's core research themes.
...
### 42. SkillLearnBench: Benchmarking Continual Learning Methods for Agent Skill Generation on Real-World Tasks
...
- **URL**: <http://arxiv.org/abs/2604.20087v1>
- **Submitted**: 2026-04-22 01:07:37
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus on Continual Learning Methods for Agent Skill Generation is more aligned with Artificial Intelligence and Machine Learning, which is a tangential area of interest for the user.
...
### 43. TriEx: A Game-based Tri-View Framework for Explaining Internal Reasoning in Multi-Agent LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Ziyi Wang, Chen Zhang, Wenjun Peng, Qi Wu, Xinyu Wang
- **URL**: <http://arxiv.org/abs/2604.20043v1>
- **Submitted**: 2026-04-21 22:55:57
- **Comment**: ACL2026 Main
- **Topic Keywords**: acl
- **Reason**: This paper focuses on explainability in Large Language Models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on aspects of language understanding, the context is multi-agent systems and game-based scenarios, which is not a primary area of focus for you.
...
- **URL**: <http://arxiv.org/abs/2604.19974v1>
- **Submitted**: 2026-04-21 20:34:14
- **Topic Keywords**: rag
- **Reason**: This paper focuses on understanding the internal mechanisms of Large Language Models (LLMs), specifically the relationship between uncertainty and correctness. While it touches on the concept of model predictions, it does not directly relate to query understanding, ranking models, or user behavior modeling in the context of Information Retrieval or Search technologies, which are core areas of your research interests.
...
### 45. LayerTracer: A Joint Task-Particle and Vulnerable-Layer Analysis framework for Arbitrary Large Language Model Architectures

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yuhang Wu, Qinyuan Liu, Qiuyang Zhao, Qingwei Chong
- **URL**: <http://arxiv.org/abs/2604.20556v1>
- **Submitted**: 2026-04-22 13:38:15
- **Comment**: 5 pages, 3 figures
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on Large Language Models (LLMs) and their architectures, which is outside your primary focus on Information Retrieval and Search technologies. Although it involves some form of analysis and optimization, the context and techniques used are not directly applicable to your areas of interest.
...
### 46. Enhancing Research Idea Generation through Combinatorial Innovation and Multi-Agent Iterative Search Strategies

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Shuai Chen, Chengzhi Zhang
- **URL**: <http://arxiv.org/abs/2604.20548v1>
- **Submitted**: 2026-04-22 13:31:12
- **Comment**: Scientometrics
- **Topic Keywords**: search
- **Reason**: This paper focuses on research idea generation and combinatorial innovation, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the context is different and the paper's goals and methods do not align with the user's core themes.
...
### 47. Discrete Preference Learning for Personalized Multimodal Generation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yuting Zhang, Ying Sun, Dazhong Shen, Ziwei Xie, Feng Liu, Changwang Zhang, Xiang Liu, Jun Wang, Hui Xiong
- **URL**: <http://arxiv.org/abs/2604.20434v1>
- **Submitted**: 2026-04-22 10:53:28
- **Comment**: be accepted to SIGIR 2026
- **Topic Keywords**: personalization
- **Reason**: This paper focuses on personalized multimodal generation, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves deep semantic understanding and multimodal interactions, the primary goal is content generation rather than information retrieval or search optimization.
...
### 48. Construction of a Battery Research Knowledge Graph using a Global Open Catalog

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Luca Foppiano, Sae Dieb, Malik Zain, Kazuki Kasama, Keitaro Sodeyama, Mikiko Tanifuji
- **URL**: <http://arxiv.org/abs/2604.20241v1>
- **Submitted**: 2026-04-22 06:45:42
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves text analysis using KeyBERT and ChatGPT, the focus is on constructing a knowledge graph for battery research, which is outside your primary areas of interest.
...
### 49. AVISE: Framework for Evaluating the Security of AI Systems

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Mikko Lempinen, Joni Kemppainen, Niklas Raesalmi
- **URL**: <http://arxiv.org/abs/2604.20833v1>
- **Submitted**: 2026-04-22 17:58:17
- **Topic Keywords**: search
- **Reason**: This paper focuses on AI security evaluation, which is unrelated to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 50. Aligning Stuttered-Speech Research with End-User Needs: Scoping Review, Survey, and Guidelines
...
- **URL**: <http://arxiv.org/abs/2604.20535v1>
- **Submitted**: 2026-04-22 13:16:23
- **Comment**: Submitted to Interspeech 2026
- **Topic Keywords**: search
- **Reason**: This paper focuses on stuttered-speech research in speech technology, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
