...
- **URL**: <http://arxiv.org/abs/2606.23911v1>
- **Submitted**: 2026-06-22 20:19:41
- **Comment**: Accepted at E-Commerce Workshop, SIGIR 2026
- **Topic Keywords**: dense retrieval, query, queries, relevance, click, ctr, conversion rate, retrieval, commerce, e-commerce, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of e-commerce sponsored search. The authors propose a novel approach to generating high-quality training data for dense retrieval models, which aligns with your focus on query understanding and ranking models. The paper's emphasis on scalable and structured training signals also resonates with your interests in real-time relevance optimization.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Walmart Sponsored‑Search Retrieval: From Click‑Based Supervision to LLM‑Generated Graded Relevance – A Unified Synthesis
- **Aim**: Replace noisy click signals with scalable, high‑quality LLM‑generated graded relevance labels to train a two‑tower BERT retrieval model that improves ad relevance and business metrics for Walmart’s sponsored search.
- **Rationale**: Click signals suffer from position bias and sparse tail queries, making them unreliable; manual annotation is prohibitively expensive; disagreement among three production retrieval engines (dictionary, BM25, ANN) offers a rich source of supervision; an automated LLM cascade can generate graded relevance cheaply while maintaining quality.
- **Ground**: Data: >240M query‑item pairs mined from 4M real queries across ANN, BM25, and dictionary channels. Annotation: 5‑class graded relevance (0=Embarrassing to 4=Excellent). Hard‑negative mining via multi‑channel disagreement. Losses: BCE → Multi‑Negative Ranking → Triplet. Model: standard two‑tower BERT retrieval. Evaluation metrics: NDCG@10, precision@10, recall, MAP, MRR, business metrics (CTR, eCPM, ad spend).
- **Experiment**: Pipeline: multi‑channel extraction → disagreement mining → annotation cascade (cross‑encoder, 2B LoRA LLM, 8B LoRA LLM) with per‑class isotonic calibration. Curriculum training: BCE → MNR → Triplet. Offline results: NDCG@10 rose from 0.878 to 0.923 (+5.1% avg relevance), embarrassing cases dropped from 8.7% to 3.5%. Online A/B (10M+ requests per arm, 2 weeks): +2.80% ad spend, +1.4% CTR, +2.8% eCPM, +2.9% click‑conversion rate.
- **Takeaway**: Automated LLM‑generated graded relevance combined with curriculum training and multi‑channel disagreement mining can replace click‑based supervision, delivering significant relevance and business gains while keeping compute costs manageable; the approach scales to Walmart’s >100M daily ad requests.
...
- **URL**: <http://arxiv.org/abs/2606.23889v1>
- **Submitted**: 2026-06-22 19:39:26
- **Comment**: Accepted to ACM SIGIR E-commerce Workshop, 2026
- **Topic Keywords**: dense retrieval, query, queries, rag, retrieval, commerce, e-commerce, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models, as it proposes an intent-aware retrieval framework for sponsored search. The focus on intent-awareness and the use of structured intent signals aligns with your interests in deep semantic understanding and real-time relevance optimization. Although the paper is specific to the e-commerce domain, its relevance to IR and NLP makes it a useful contribution to your field of study.
...
### 3. DREAM: Dense Retrieval Embeddings via Autoregressive Modeling

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Yixuan Tang, Yi Yang
- **URL**: <http://arxiv.org/abs/2606.24667v1>
- **Submitted**: 2026-06-23 15:00:30
- **Topic Keywords**: retriever, dense retrieval, query, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, specifically dense retrieval embedding models, which aligns with your research interests. The proposed DREAM approach leverages autoregressive modeling to improve dense retriever training, showcasing a novel application of deep semantic understanding in IR. While the focus is on retrieval-based AI systems, the paper's emphasis on real-time relevance optimization is also consistent with your interests.
...
### 4. Unified Multi-Task Relevance Modeling for E-Commerce: Comparing Task Routing Architectures Across LLMs and Cross-Encoders

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Md Omar Faruk Rokon, Jhalak Nilesh Acharya, Shasvat Desai, Hong Yao, Kuang-chih Lee
- **URL**: <http://arxiv.org/abs/2606.23919v1>
- **Submitted**: 2026-06-22 20:32:47
- **Comment**: Accepted at E-commerce workshop, SIGIR 2026
- **Topic Keywords**: query, relevance, commerce, e-commerce
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The focus on unified multi-task relevance modeling and task routing architectures aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the e-commerce domain is a specific application area, which might limit its generalizability to other domains.
...
### 5. Dialogue to Discovery: Attribute-Aware Preference Elicitation for Conversational Product Search Assistants

- **LLM Score**: 7
- **Keyword Score**: 7
- **Authors**: Sarthak Harne, Natwar Modani, Debabrata Mahapatra, Shubham Agarwal
- **URL**: <http://arxiv.org/abs/2606.24194v1>
- **Submitted**: 2026-06-23 06:30:31
- **Topic Keywords**: queries, rag, recommend, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of conversational search and product search assistants. While it doesn't directly focus on query understanding, ranking models, or user behavior modeling, it explores preference elicitation and attribute-aware dialogue systems, which are relevant to your broader interests in IR and NLP.
...
- **URL**: <http://arxiv.org/abs/2606.23881v1>
- **Submitted**: 2026-06-22 19:27:00
- **Comment**: Accepted by ACL 2026 Findings. Project page https://github.com/VAN-QIAN/ACL26-IBA/
- **Topic Keywords**: queries, ranking, rag, retrieval augmented generation, retrieval, rank
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the context of query understanding and ranking models. However, the focus on Visual Question Answering and entity identification is not a central match for the user's primary research themes. The paper's emphasis on deep semantic understanding and real-time relevance optimization is also not directly addressed.
...
- **URL**: <http://arxiv.org/abs/2606.24286v1>
- **Submitted**: 2026-06-23 08:06:58
- **Topic Keywords**: information retrieval, query, relevance, rag, retrieval
- **Reason**: The paper, AVOC, is somewhat related to the user's research interests in Information Retrieval and Search technologies, particularly in the context of multimodal understanding and retrieval-inspired token compression. However, the focus on audio-video understanding and long-form comprehension in Large Language Models is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The connection to Information Retrieval is evident, but the application domain is distinct.
...
### 8. MMed-Bench-IR: A Heterogeneous Benchmark for Multilingual Medical Information Retrieval

- **LLM Score**: 4
- **Keyword Score**: 13
- **Authors**: Junhyeok Lee, Han Jang, Hyeonjin Goh, Kyu Sung Choi
- **URL**: <http://arxiv.org/abs/2606.24200v1>
- **Submitted**: 2026-06-23 06:41:13
- **Comment**: Under review. 15 pages, 3 figures
- **Topic Keywords**: information retrieval, query, queries, rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of multilingual medical information retrieval. However, the focus on clinical settings and biomedical expertise is not directly aligned with your primary interests in e-commerce and deep semantic understanding. The paper's emphasis on benchmarking and evaluation is relevant, but not central to your research themes.
...
### 9. ChartWalker: Benchmarking the Cross-Chart RAG Task with Hierarchical Knowledge Graphs

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Ning Tang, Chenghan Xie, Hanyang Yuan, Yi Li, Renhong Huang, Qian Kou, Xiaofeng Shi, Hua Zhou, Jiarong Xu
- **URL**: <http://arxiv.org/abs/2606.23997v1>
- **Submitted**: 2026-06-22 23:07:38
- **Topic Keywords**: query, queries, rag, retrieval
- **Reason**: The paper explores a novel framework for constructing challenging cross-chart Retrieval-Augmented Generation (RAG) tasks, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus is on multi-modal analytical tasks and knowledge graphs, which is not a central match to the user's core research themes. The paper's relevance is also limited by its specific domain (scientific, business, and political) and the use of hierarchical knowledge graphs, which is not directly related to the user's interests in e-commerce or real-time relevance optimization.
...
### 10. Paying to Know: Micro-Transaction Markets for Verified Product Information in Agentic E-Commerce

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Filippos Ventirozos, Matthew Shardlow
- **URL**: <http://arxiv.org/abs/2606.24783v1>
- **Submitted**: 2026-06-23 16:42:21
- **Comment**: 8 pages, 1 figure. Vision paper, under review
- **Topic Keywords**: ranking, recommend, shopping, commerce, e-commerce, rank
- **Reason**: The paper discusses a novel e-commerce paradigm where buyer agents acquire trustworthy information about products through micro-transactions. While it touches upon NLP problems such as entity resolution and persona modeling, its primary focus is on the e-commerce domain and information acquisition, which is somewhat related to the user's interests in Information Retrieval and Search technologies.
...
### 11. Do LLM Attribution Metrics Transfer? Auditing Retrieval-Augmented Generation Evaluation Across Datasets and Constructs

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Tianyu Ding, Aditya Nannapaneni, Juan Pablo De la Cruz Weinstein
- **URL**: <http://arxiv.org/abs/2606.23915v1>
- **Submitted**: 2026-06-22 20:25:36
- **Topic Keywords**: ranking, rag, retrieval, rank
- **Reason**: This paper explores the transferability of attribution metrics for Large Language Models (LLMs) in retrieval-augmented generation, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and evaluation metrics is not directly aligned with the user's primary research interests in IR and search technologies.
...
- **Submitted**: 2026-06-23 14:48:37
- **Topic Keywords**: rag, commerce, e-commerce, search
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and data mining, but it focuses on Product Attribute Value Extraction (PAVE) in the e-commerce domain, which is not the user's primary area of interest. The use of Large Language Models (LLMs) and the creation of a Golden Set dataset are relevant to the user's background in e-commerce, but the paper's scope is more specialized and does not directly address the user's core research themes in Information Retrieval and Search technologies.
...
### 13. On the Stability of Prompt Ranking in Large Language Model Evaluation

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Shaoshuai Du, Penghao Liang, Yixian Shen, Chuanqi Shi, Hang Zhang, Lun Wang
- **URL**: <http://arxiv.org/abs/2606.24381v1>
- **Submitted**: 2026-06-23 10:13:47
- **Topic Keywords**: ranking, rank
- **Reason**: The paper explores prompt ranking stability in large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language models and prompt-based interaction is not directly aligned with the user's core research themes in IR and Search technologies. The connection to NLP is relevant, but the paper's primary contribution is in the context of LLMs, which is not a central match for the user's interests.
...
### 14. MEMPROBE: Probing Long-Term Agent Memory via Hidden User-State Recovery
...
- **Submitted**: 2026-06-23 13:52:46
- **Topic Keywords**: retrieval, personalization
- **Reason**: This paper is somewhat related to information retrieval, but its focus on long-term memory in language models and user-state recovery is not directly aligned with your core research themes. While it touches on the idea of understanding user behavior, it's more focused on memory systems and their evaluation, which is not a central area of interest for you.
...
- **URL**: <http://arxiv.org/abs/2606.24331v1>
- **Submitted**: 2026-06-23 09:09:55
- **Topic Keywords**: retrieval, search
- **Reason**: The paper discusses transformer-based language models, which is related to the user's interest in NLP. However, the focus on architectures, applications, and critical assessment across various domains is not directly aligned with the user's primary focus on IR, query understanding, and ranking models. While the paper touches on some relevant topics, it does not seem to be a central match for the user's research interests.
...
### 16. Emergent Capabilities Arise Randomly from Learning Sparse Attention Patterns

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Vatsal Baherwani, Zixi Chen, Shikai Qiu, Andrew Gordon Wilson, Pavel Izmailov
- **URL**: <http://arxiv.org/abs/2606.25010v1>
- **Submitted**: 2026-06-23 17:51:10
- **Comment**: 18 pages, 13 figures
- **Topic Keywords**: rag
- **Reason**: This paper explores the emergence of capabilities in transformer models, specifically focusing on attention patterns. While it touches on aspects of deep semantic understanding, it does not directly relate to information retrieval, query understanding, or ranking models. The paper's focus on neural scaling laws and attention mechanisms is somewhat relevant to NLP, but it does not align with the user's core research themes in IR and search technologies.
...
- **Submitted**: 2026-06-23 17:21:03
- **Topic Keywords**: retrieval
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and related topics. However, it focuses on pre-trained language models and fine-tuning/prompt-tuning strategies, which is not directly aligned with the user's primary focus on Information Retrieval and deep semantic understanding. While the paper's emphasis on task-specific model customization is relevant, it does not strongly resonate with the user's core research themes.
...
### 18. Cross-Lingual Exploration for Parametric Knowledge

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Elisha Diskind, Itamar Trainin, Uri Shaham, Leshem Choshen, Idan Szpektor, Omri Abend
- **URL**: <http://arxiv.org/abs/2606.24579v1>
- **Submitted**: 2026-06-23 13:42:40
- **Comment**: 29 pages, 5 figures, preprint
- **Topic Keywords**: retrieval
- **Reason**: The paper explores cross-lingual prompting strategies for accessing parametric knowledge in Large Language Models, which is somewhat related to the user's interests in Information Retrieval and Natural Language Processing. However, the focus on multilingual factual benchmarks and cross-lingual knowledge transfer is not directly aligned with the user's primary focus on query understanding, ranking models, and user behavior modeling. The paper's relevance is also limited by its lack of emphasis on real-time relevance optimization and e-commerce domain.
...
### 19. Beyond Logprobs: A Multi-Signal Confidence Engine for LLM-Based Document Field Extraction

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Nitesh Kumar
- **URL**: <http://arxiv.org/abs/2606.24420v1>
- **Submitted**: 2026-06-23 10:58:08
...
- **Topic Keywords**: rag
- **Reason**: This paper presents a confidence engine for LLM-based document field extraction, focusing on reliable confidence estimation. While it touches on aspects of query understanding and ranking models, its primary focus is on document processing and extraction accuracy, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the specific domain and application of the paper are not directly aligned with your core research themes.
...
### 20. UOL@IDEM at BEA 2026 Shared Task 1: Neural Fusion and Feature-Rich Modeling for L1-Aware Vocabulary Difficulty Prediction

- **LLM Score**: 3
- **Keyword Score**: 6
- **Authors**: Nouran Khallaf, Serge Sharoff
- **URL**: <http://arxiv.org/abs/2606.24501v1>
- **Submitted**: 2026-06-23 12:30:48
...
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and data mining, but it focuses on vocabulary difficulty prediction, which is not a central match for the user's primary focus on information retrieval and query understanding. The use of neural fusion and feature-rich modeling is relevant, but the specific application is not directly related to the user's research areas.
...
### 21. PETRA: Transforming Web Text for Petroleum-Engineering Domain Adaptation
...
- **URL**: <http://arxiv.org/abs/2606.24346v1>
- **Submitted**: 2026-06-23 09:37:44
- **Topic Keywords**: retriever, dense retrieval, query, ranking, rerank, relevance, retrieval, rank, search
- **Reason**: The paper focuses on a specific domain (petroleum engineering) and proposes a dataset and pipeline for domain adaptation, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 22. Unified Dominance Graph for Interval-Predicate Approximate Nearest Neighbor Search

- **LLM Score**: 2
- **Keyword Score**: 11
- **Authors**: Kwun Hang Lau, Ruiyuan Zhang, Elton Chun-Chai Li, Wun Yu Chan, Xiaojun Cheng, Xiaofang Zhou
- **URL**: <http://arxiv.org/abs/2606.24204v1>
- **Submitted**: 2026-06-23 06:46:28
- **Topic Keywords**: query, queries, rag, retrieval, search
- **Reason**: This paper focuses on Approximate Nearest Neighbor Search (ANNS) for unstructured data retrieval, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves data retrieval, the specific application and techniques used are not aligned with your areas of focus.
...
### 23. AdversaBench: Automated LLM Red-Teaming with Multi-Judge Confirmation and Cross-Model Transferability

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Khanak Khandelwal
- **URL**: <http://arxiv.org/abs/2606.24589v1>
- **Submitted**: 2026-06-23 13:50:51
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on adversarial evaluation and red-teaming, which is more relevant to the security and robustness of AI models rather than your core areas of interest.
...
### 24. Why Do Accumulated Transformations Extrapolate?

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Mahesh Godavarti
- **URL**: <http://arxiv.org/abs/2606.24975v1>
- **Submitted**: 2026-06-23 12:08:30
- **Comment**: 33 pages, submitted to TMLR
- **Topic Keywords**: query, queries
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and attention mechanisms, but its focus on accumulated transformations and their impact on context lengths does not align with your primary research interests in Information Retrieval, query understanding, and ranking models. The paper's emphasis on attention mechanisms and orthogonal transformations does not directly relate to your areas of focus.
...
### 25. When Retrieval Metrics Mislead: Measuring Policy Signal in Long-Horizon Tool-Use Agents

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Tianyu Ding, Juan Pablo De la Cruz Weinstein
- **URL**: <http://arxiv.org/abs/2606.23937v1>
- **Submitted**: 2026-06-22 20:57:11
- **Topic Keywords**: retriever, retrieval, rank
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or Natural Language Processing, which are your primary research interests. The paper focuses on policy signal in long-horizon tool-use agents, which is a specific application in the field of artificial intelligence and robotics. While it touches on retrieval metrics, it does not explore query understanding, ranking models, or user behavior modeling, making it less relevant to your core research themes.
...
### 26. L3Cube-MahaPOS: A Marathi Part-of-Speech Tagging Dataset and BERT Models

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Hariom Ingle, Ronit Ghode, Ishwari Gondkar, Jidnyasa Harad, Raviraj Joshi
- **URL**: <http://arxiv.org/abs/2606.24825v1>
- **Submitted**: 2026-06-23 17:10:46
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper is primarily focused on Marathi Part-of-Speech Tagging, which is a specific NLP task. While it does involve some machine learning and deep learning models, it does not align with the user's core research themes in Information Retrieval, Search technologies, or query understanding. The paper's relevance to the user's interests in IR and NLP is limited.
...
### 27. ParaPairAudioBench: Paralinguistic Pairwise Audio Benchmark for LALM-as-a-Judge

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Jisu Jeon, Seungyeon Jwa, Joosung Lee, Jinhyeon Kim, Woojin Chung, Hwiyeol Jo, Jeonghoon Kim, Jonghyun Choi, Soyoon Kim
- **URL**: <http://arxiv.org/abs/2606.24648v1>
- **Submitted**: 2026-06-23 14:43:43
- **Comment**: Accepted to Interspeech 2026
- **Topic Keywords**: pairwise, rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves Audio-Language Models, the focus is on speech evaluation and paralinguistic distinctions, which is not a central match to your research themes.
...
### 28. Age of LLM: A Strategic 1v1 Benchmark for Reasoning, Diplomacy and Reliability of Large Language Models under Fog of War

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Arnaud Ricci
- **URL**: <http://arxiv.org/abs/2606.24391v1>
- **Submitted**: 2026-06-23 10:25:31
...
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper is not relevant to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on Large Language Models and their reasoning capabilities under adversarial uncertainty is outside your primary areas of focus.
...
### 29. SHERLOC: Structured Diagnostic Localization for Code Repair Agents

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Hovhannes Tamoyan, Sean Narenthiran, Erik Arakelyan, Mira Mezini, Boris Ginsburg
- **URL**: <http://arxiv.org/abs/2606.24820v1>
- **Submitted**: 2026-06-23 17:05:50
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper appears to be focused on code repair agents and localization, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve some form of retrieval, it is specifically in the context of code repair and does not seem to involve query understanding, ranking models, or user behavior modeling.
...
### 30. Are We Ready For An Agent-Native Memory System?
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding. While it touches on data management and retrieval, its focus is on memory systems for large language model agents, which is a topic outside of the user's core research themes.
...
### 31. Privacy-Preserving RAG via Multi-Agent Semantic Rewriting: Achieving Confidentiality Without Compromising Contextual Fidelity

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Yuanhe Zhao, Tianyu Zhang, Huafei Xing, Derek F. Wong, Jianbin Li, Tao Fang
- **URL**: <http://arxiv.org/abs/2606.24623v1>
- **Submitted**: 2026-06-23 14:21:41
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on privacy-preserving techniques for Retrieval-Augmented Generation, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves semantic analysis, the primary goal is to address privacy concerns rather than improving query understanding, ranking models, or user behavior modeling.
...
### 32. Diagnosing and Mitigating Compounding Failures in Agentic Persuasion via Taxonomic Strategy Retrieval

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Pradyumna Narayana, Sana Ayromlou, Purvi Sehgal
- **URL**: <http://arxiv.org/abs/2606.24976v1>
- **Submitted**: 2026-06-23 12:16:27
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper appears to be off-topic as it focuses on 'Agentic Persuasion' and 'Taxonomic Strategy Retrieval' in the context of multi-agent debate, which does not align with your primary research interests in Information Retrieval and Search technologies. While it involves some form of retrieval, the abstract suggests a strong emphasis on NLP and multi-agent systems, which is not a central match to your research focus.
...
### 33. To Compare, or Not to Compare: On Methodological Practices in Evaluating Social Bias

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Federico Marcuzzi, Xuefei Ning, Roy Schwartz, Iryna Gurevych
- **URL**: <http://arxiv.org/abs/2606.24596v1>
- **Submitted**: 2026-06-23 13:53:50
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on evaluating social biases in Large Language Models and does not address query understanding, ranking models, or user behavior modeling.
...
### 34. NatureBench: Can Coding Agents Match the Published SOTA of Nature-Family Papers?
...
- **URL**: <http://arxiv.org/abs/2606.24530v1>
- **Submitted**: 2026-06-23 12:58:23
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves AI and benchmarking, the focus is on evaluating AI coding agents in scientific discovery, which is not a central theme in your research.
...
### 35. Prague Dependency Treebank -- Consolidated 2.0: Enriching a Complex Annotation Scheme

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Marie Mikulová, Jiří Mírovský, Milan Straka, Pavlína Synková, Jan Štěpánek, Barbora Štěpánková, Jan Hajič
- **URL**: <http://arxiv.org/abs/2606.24324v1>
- **Submitted**: 2026-06-23 08:59:38
- **Comment**: Accepted to LREC 2026
- **Topic Keywords**: rag, search
- **Reason**: This paper is about the Prague Dependency Treebank, a linguistic resource for the Czech language, which is not directly related to Information Retrieval, Search technologies, or Natural Language Processing in the context of query understanding, ranking models, or user behavior modeling. While it does involve NLP, the focus is on linguistic annotation and corpus development, which is not a central match for the user's research interests.
...
### 36. A Pāninian Foundation for Indic Language Processing

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ritwik Banerjee, Lav R. Varshney
- **URL**: <http://arxiv.org/abs/2606.24172v1>
- **Submitted**: 2026-06-23 05:53:37
- **Comment**: 16 pages, 0 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on Indic language processing, which is not a core area of your research interests. While it touches on natural language processing, the specific context and goals of the paper do not align with your primary focus on information retrieval, query understanding, and ranking models.
...
### 37. Is Higher Team Gender Diversity Correlated with Better Scientific Impact?

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Chengzhi Zhang, Jiaqi Zeng, Yi Zhao
- **URL**: <http://arxiv.org/abs/2606.24098v1>
- **Submitted**: 2026-06-23 03:25:42
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The study focuses on the correlation between team gender diversity and scientific impact in specific domains, which does not align with your core research themes.
...
### 38. Does My Embedding Reflect That $A = B$? Evaluating Mathematical Equivalence in Embedding Models
...
- **Submitted**: 2026-06-22 21:37:58
- **Comment**: 18 pages, comments welcome
- **Topic Keywords**: retrieval, search
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves text and embedding models, its focus on mathematical equivalence and formalization is not aligned with your areas of interest.
...
### 39. Neuro-Symbolic Drive: Rule-Grounded Faithful Reasoning for Driving VLAs
...
- **Submitted**: 2026-06-22 20:57:59
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be primarily focused on driving and autonomous vehicles, using techniques from neuro-symbolic planning and Chain-of-Thought reasoning. While it involves natural language and structured reasoning, it does not seem to be directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 40. Neural Scaling Universality: If Exponents Are Fixed, Time to Understand Coefficients

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yizhou Liu, Jeff Gore
- **URL**: <http://arxiv.org/abs/2606.25008v1>
- **Submitted**: 2026-06-23 17:46:30
- **Comment**: 17 pages, 6 figures
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are the core areas of your research interests. While it touches on deep learning and model optimization, its focus on neural scaling laws and universality classes is more relevant to the broader field of Artificial Intelligence and Machine Learning, rather than your specific areas of expertise.
...
### 41. Posterior Refinement: Fast Language Generation via Any-Order Flow Maps
...
- **URL**: <http://arxiv.org/abs/2606.24773v1>
- **Submitted**: 2026-06-23 16:33:13
- **Comment**: 24 pages, 23 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on language generation and non-autoregressive models, which is somewhat related to your interests in Natural Language Processing (NLP). However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of your research.
...
- **URL**: <http://arxiv.org/abs/2606.24644v1>
- **Submitted**: 2026-06-23 14:40:36
- **Comment**: ACL2026
- **Topic Keywords**: user behavior
- **Reason**: This paper focuses on machine translation and human-AI collaboration, which is not a central match to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific context and goals of the study are quite different from your areas of focus.
...
### 43. Qwen-AgentWorld: Language World Models for General Agents
...
- **Submitted**: 2026-06-23 13:53:55
- **Topic Keywords**: rag
- **Reason**: This paper focuses on developing a world model for general agents using language models, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, the context is different from the user's primary research interests in IR and NLP for deep semantic understanding and real-time relevance optimization.
...
### 44. AGORA: An Archive-Grounded Benchmark for Agentic Workplace Document Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Honglin Guo, Qi Zhang, Yu Zhang, Weijie Li, Rui Zheng, Zhikai Lei, Qiyuan Peng, Zhiheng Xi, Tao Gui, Qi Zhang
- **URL**: <http://arxiv.org/abs/2606.24526v1>
- **Submitted**: 2026-06-23 12:57:18
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on a benchmark for large language models to reason over documents, which is outside the scope of information retrieval and search technologies. While it touches on the idea of document reasoning, it doesn't seem to address query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 45. An LLM-based Two-Stage Transformer Framework for Cross-Domain Bearing Fault Diagnosis with Limited Data

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jinghan Wang, Feng Cheng, Wentao Wu, Hang Li, Gaoliang Peng, Tianchen Liu
- **URL**: <http://arxiv.org/abs/2606.24459v1>
- **Submitted**: 2026-06-23 11:46:07
- **Comment**: Accepted as a conference article of AIM 2026
- **Topic Keywords**: rag
- **Reason**: This paper focuses on a specific application of deep learning in bearing fault diagnosis, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it employs a transformer framework, the context and methodology are not aligned with the user's interests in query understanding, ranking models, user behavior modeling, or real-time relevance optimization.
...
### 46. Escaping the Self-Confirmation Trap: An Execute-Distill-Verify Paradigm for Agentic Experience Learning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Shiding Zhu, Yudi Qi, Yajie Wang, Jiaze Li, Chao Song, Yaorui Shi, Yibo Miao, Hanqi Gao, Kai Zhang
- **URL**: <http://arxiv.org/abs/2606.24428v1>
- **Submitted**: 2026-06-23 11:05:05
- **Comment**: 28 pages, 11 figures
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on experience learning for large language model agents, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve deep semantic understanding, the context is agent self-evolution rather than search or retrieval.
...
### 47. AutoSpecNER: A Fine-Grained Named Entity Recognition Dataset for Vehicle Specification Extraction

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jordan Lee, Filippos Ventirozos, Abdirahman Abdullahm, Ioanna Nteka, Peter Appleby, Matthew Shardlow
- **URL**: <http://arxiv.org/abs/2606.24387v1>
- **Submitted**: 2026-06-23 10:19:58
- **Comment**: 13 pages, 2 figures, 7 tables, Pre-print
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Named Entity Recognition (NER) for vehicle specifications, which is a specific application within NLP. While it involves deep semantic understanding, it is not directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 48. MorfFlex: Handling Rich Morphology

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jaroslava Hlaváčová, Marie Mikulová, Barbora Štěpánková, Milan Straka, Jan Hajič
- **URL**: <http://arxiv.org/abs/2606.24366v1>
- **Submitted**: 2026-06-23 09:56:58
- **Comment**: Accepted to LREC 2026
- **Topic Keywords**: rag
- **Reason**: This paper focuses on morphological dictionary architecture for Czech, which is not directly related to Information Retrieval, Search technologies, or query understanding. While it does touch on Natural Language Processing, it's more focused on language resources and annotation consistency, which doesn't align with the user's primary research interests.
...
### 49. RoPE-Aware Bit Allocation for KV-Cache Quantization

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Fengfeng Liang, Yuechen Zhang, Jiaya Jia
- **URL**: <http://arxiv.org/abs/2606.24033v1>
- **Submitted**: 2026-06-23 00:17:48
- **Comment**: Preprint. Code available at https://github.com/JIA-Lab-research/blockgtq
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: This paper appears to be focused on RoPE-aware bit allocation for KV-cache quantization, which is a topic in the field of computer science related to deep learning and caching. However, it does not seem to be directly related to information retrieval, search technologies, query understanding, ranking models, or user behavior modeling, which are the core research themes of your interests.
...
### 50. Meet UD_Czech-PDTC: A Large and Genre-Rich Treebank in Universal Dependencies

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Marie Mikulová, Barbora Štěpánková, Daniel Zeman, Jan Štěpánek, Milan Straka, Jan Hajič
- **URL**: <http://arxiv.org/abs/2606.24337v1>
- **Submitted**: 2026-06-23 09:22:42
- **Comment**: Accepted to LREC 2026
- **Topic Keywords**: rag
- **Reason**: This paper is about converting a Czech treebank to Universal Dependencies, which is a topic in Natural Language Processing (NLP). However, it does not relate to Information Retrieval (IR), Search technologies, or any of the user's specific interests.
