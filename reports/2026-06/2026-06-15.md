...
- **Reason**: This paper aligns closely with your research interests in Information Retrieval, particularly in query understanding and ranking models. The use of reinforcement learning for retrieval index reasoning and the emphasis on real-time relevance optimization also resonate with your focus on deep semantic understanding. The application of this approach to external knowledge retrieval and question-answering tasks further demonstrates its relevance to your work.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of Retrieval-Augmented Generation (RAG) and query understanding. The proposed SCAR algorithm addresses a specific challenge in RAG, improving recall and reducing token overhead, which aligns with your focus on deep semantic understanding and real-time relevance optimization.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically in entity-aware document retrieval and ranking models. The authors propose a framework for observable relevance in document re-ranking, which aligns with your focus on real-time relevance optimization and deep semantic understanding. The paper's emphasis on the distinction between conceptual and observable entity relevance is also closely related to your interests in query understanding and ranking models.
...
### 5. Beyond Monolingual Deep Research: Evaluating Agents and Retrievers with Cross-Lingual BrowseComp-Plus

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Yuheng Lu, Qingcheng Zeng, Heli Qi, Puxuan Yu, Fuheng Zhao, Rui Yang, Hitomi Yanaka, Naoto Yokoya, Weihao Xuan
- **URL**: <http://arxiv.org/abs/2606.15345v1>
- **Submitted**: 2026-06-13 15:11:52
- **Comment**: Preprint
- **Topic Keywords**: retriever, query, retrieval, search, acl
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in areas that require deep semantic understanding and real-time relevance optimization. The focus on cross-lingual search and evaluation of deep research agents aligns with your interests in query understanding and ranking models. However, the specific domain of multilingual search may not be a central match to your e-commerce background.
...
### 6. S1-DeepResearch: Beyond Search, Toward Real-World Long-Horizon Research Agents

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Yao Dong, Xinglin Xiao, Liwei Dong, Xinlong Jin, Zhengbo Li, Heng Zhang, Duyun Wang, Nan Xu
- **URL**: <http://arxiv.org/abs/2606.15367v1>
- **Submitted**: 2026-06-13 16:04:42
- **Topic Keywords**: information retrieval, rag, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The paper's focus on deep research agents, knowledge synthesis, and planning-oriented agent behaviors aligns with your interests in real-time relevance optimization and deep semantic understanding. However, the paper's primary focus is on a broader scope of research capabilities beyond traditional search, which is a slight deviation from your core research themes.
...
### 7. Beyond Positive Signals: Unlocking Implicit Negative Behaviors for Enhanced Sequential User Modeling

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Zexuan Cheng, Yue Liu, Jun Zhang, Jie Jiang
- **URL**: <http://arxiv.org/abs/2606.15252v1>
- **Submitted**: 2026-06-13 11:18:38
- **Topic Keywords**: user behavior, click, ctr, click-through rate
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of user behavior modeling and click models. The focus on sequential user modeling and the introduction of mixed-polarity behavior sequences aligns with your interests in deep semantic understanding and real-time relevance optimization.
...
### 8. Retrieval-as-a-Service:A System-Oriented Analysis of Industrial Retrieval Pipelines in Web Systems

- **LLM Score**: 8
- **Keyword Score**: 7
- **Authors**: Fang Liu, Yuan Yuan, Yifan Dang, Xuncheng Zhang, Cuiqianhe Du
- **URL**: <http://arxiv.org/abs/2606.14932v1>
- **Submitted**: 2026-06-12 20:10:02
- **Topic Keywords**: ranking, retrieval, recommend, rank
- **Reason**: This paper aligns well with your interests in Information Retrieval, particularly in the context of industrial retrieval pipelines and system design. The focus on scalability, latency, and resource limitations is relevant to your background in e-commerce and interest in real-time relevance optimization. However, the emphasis on system-oriented analysis and infrastructure design may not be as directly related to your core research themes in query understanding and ranking models.
...
### 9. PIANO: Personalized Reranking via Information Aggregation Node for Music Search Optimization
...
- **Reason**: The paper PIANO is somewhat related to the user's research interests in Information Retrieval, particularly in query understanding and ranking models. Although it focuses on music search optimization, it addresses limitations in existing methods and proposes a personalized listwise re-ranking framework, which is relevant to the user's interests in real-time relevance optimization. However, the specific domain of music search and the use of historical queries for intent alignment are not central to the user's core research themes.
...
### 10. OneBar: An End-to-End Content-Grounded Generative Query Recommendation Framework for E-Commerce Video Feeds

- **LLM Score**: 7
- **Keyword Score**: 11
- **Authors**: Yao Tang, Ying Yang, Ben Chen, Yufei Ma, Zihan Liang, Chenyi Lei, Wenwu Ou, Jian Liu
- **URL**: <http://arxiv.org/abs/2606.15330v1>
- **Submitted**: 2026-06-13 14:48:58
- **Comment**: Any questions feel free to contact: benchen4395@gmail.com
- **Topic Keywords**: query, click, ctr, recommend, commerce, e-commerce, search
- **Reason**: The paper explores query recommendation for e-commerce video feeds, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on e-commerce and video content is not a central match to your broader interests in query understanding, ranking models, and user behavior modeling, but the generative query recommendation framework and collaborative-multimodal intent grounding module show some relevance to your NLP and data mining interests.
...
### 11. Risk-Aware LLM Agents for Geospatial Data Retrieval: Design and Preliminary Adversarial Evaluation

- **LLM Score**: 7
- **Keyword Score**: 6
- **Authors**: Kyle Gao, Joel Cumming, Jonathan Li, Linlin Xu, David A. Clausi
- **URL**: <http://arxiv.org/abs/2606.15077v1>
- **Submitted**: 2026-06-13 03:15:53
- **Comment**: Accepted for publication in the International Archives of the Photogrammetry, Remote Sensing and Spatial Information Sciences (ISPRS Archives), ISPRS Congress 2026
- **Topic Keywords**: queries, retrieval, recommend
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of query understanding and real-time relevance optimization. The use of LLM agents and natural language queries aligns with the user's focus on deep semantic understanding. However, the specific application to geospatial data retrieval and environmental monitoring diverges from the user's primary focus on e-commerce and general IR.
...
### 12. OneRank: Unified Transformer-Native Ranking Architecture for Multi-Task Recommendation
...
- **Reason**: This paper proposes a unified Transformer-native ranking architecture for multi-task recommendation, which aligns with your interests in Information Retrieval and Search technologies, particularly in ranking models. However, the focus on recommender systems and multi-task learning is somewhat related to your interests, but not a central match. The use of Transformers and deep semantic understanding is relevant, but the application to recommender systems is not your primary focus.
...
### 13. A Theoretical Framework for Risk Analysis of Stochastic Rankers
...
- **Reason**: The paper is somewhat related to the user's research interests in Information Retrieval, specifically in the area of ranking models. However, the focus on stochastic rankers and reranking risk analysis is not a central match to the user's primary interests in query understanding, user behavior modeling, and deep semantic understanding. The connection to Learning to Rank is indirect, but the paper's theoretical analysis and experimental results may still be of interest to the user.
...
### 14. EventConnector: Mining Social Event Relations through Temporal Graphs

- **LLM Score**: 6
- **Keyword Score**: 9
- **Authors**: Zijie Lei, Haofei Yu, Ge Liu, Jiaxuan You
- **URL**: <http://arxiv.org/abs/2606.15448v1>
- **Submitted**: 2026-06-13 19:44:57
- **Topic Keywords**: information retrieval, rag, retrieval, acl
- **Reason**: The paper explores event relations through temporal graphs, which is somewhat related to information retrieval, particularly in the context of real-time relevance optimization. However, the focus on event relations and temporal dynamics is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's emphasis on causal-signal fusion and graph-quality-aware mixing weights is also not a central match for the user's interests in NLP and data mining.
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, its focus on graph retrieval-augmented generation and agentic graph retrieval is not a central match for the user's research themes. The paper's use of reinforcement learning and path-aware training framework is an interesting aspect, but it does not directly align with the user's primary focus on deep semantic understanding and real-time relevance optimization.
...
### 16. Context-Aware RL for Agentic and Multimodal LLMs
...
- **Reason**: This paper explores a reinforcement learning method for improving long-horizon reasoning and multimodal performance in large language models. While it touches on query understanding and context-awareness, its primary focus is on multimodal reasoning and visual question answering, which is somewhat related to your interests in Information Retrieval and Natural Language Processing, but not a central match.
...
### 17. Intelligent Multimodal Retrieval and Reasoning for Geospatial Knowledge Discovery on the I-GUIDE Platform
...
- **Submitted**: 2026-06-14 14:39:29
- **Topic Keywords**: query, queries, relevance, rag, retrieval, recommend, search
- **Reason**: This paper presents a multimodal geospatial retrieval system, I-GUIDE Smart Search, which combines OpenSearch indexes with a Neo4j knowledge graph and a RAG pipeline. While it shares some similarities with query understanding and ranking models in Information Retrieval, its focus on geospatial knowledge discovery and multimodal retrieval is somewhat related but not a central match to your research interests.
...
### 18. SAG: SQL-Retrieval Augmented Generation with Query-Time Dynamic Hyperedges
...
- **Reason**: This paper introduces a novel architecture for retrieval and agent systems, leveraging SQL join queries to dynamically link events into local hyperedges. While it touches on query understanding and knowledge graph-based retrieval, its primary focus is on structured data and multi-hop reasoning, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the paper's emphasis on database infrastructure and scalability may not directly align with your core research themes.
...
- **URL**: <http://arxiv.org/abs/2606.14885v1>
- **Submitted**: 2026-06-12 18:46:18
- **Comment**: 25 pages, 4 figures, 22 tables
- **Topic Keywords**: retriever, ranking, rag, retrieval, rank, search
- **Reason**: The paper discusses a framework for Direct Corpus Interaction (DCI) that addresses limitations in retriever-mediated interfaces. While it touches on search technologies and scalability, it doesn't directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on DCI and workspace expansion is somewhat relevant to information retrieval, but it doesn't demonstrate a deep semantic understanding or real-time relevance optimization, which are key aspects of your research interests.
...
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of multimodal retrieval-augmented question answering. However, its focus on visual question answering and the 'Lost at the End' effect does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling. While it touches on the importance of reader-side position dependence, it does not explore the user's areas of interest in deep semantic understanding and real-time relevance optimization.
...
### 21. Transfer Learning for FHIR Questionnaire Terminology Binding

- **LLM Score**: 4
- **Keyword Score**: 11
- **Authors**: Maxim Gorshkov
- **URL**: <http://arxiv.org/abs/2606.15449v1>
- **Submitted**: 2026-06-13 19:46:44
- **Topic Keywords**: query, rerank, ctr, retrieval, rank
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it involves a retrieval problem and the use of various NLP methods (e.g., BioBERT, BioLORD) for finding the correct LOINC code. However, the specific domain and application (FHIR Questionnaire Terminology Binding) are not directly related to the user's core research themes in e-commerce or real-time relevance optimization.
...
- **Submitted**: 2026-06-13 17:14:53
- **Topic Keywords**: query, queries, relevance
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of conversational agents and long-term memory. However, the focus on conversational memory and episodic future thinking is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 23. Benchmarking LLM Agents on Meta-Analysis Articles from Nature Portfolio
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, specifically in the context of meta-analysis articles and evidence synthesis. However, the focus on Large Language Models (LLMs) and their limitations in separating eligible studies from distractors is not directly aligned with the user's primary focus on query understanding, ranking models, and user behavior modeling. The paper's relevance to the e-commerce domain is also unclear.
...
### 24. Can LLM Agents Infer World Models? Evidence from Agentic Automata Learning
...
- **Reason**: This paper explores the capabilities of Large Language Models (LLMs) in discovering hidden environments through interaction, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on LLMs and their limitations in automata learning is not directly aligned with the user's core research themes in IR and Search technologies. The connection to NLP is also present, but it's not a central match.
...
### 25. MAGE-RAG: Multigranular Adaptive Graph Evidence for Agentic Multimodal RAG in Long-Document QA

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Yilong Zuo, Xunkai Li, Jing Yuan, Qiangqiang Dai, Hongchao Qin, Ronghua Li
- **URL**: <http://arxiv.org/abs/2606.15906v1>
- **Submitted**: 2026-06-14 16:34:15
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: This paper proposes a novel framework for long-document multimodal question answering, which involves graph-based evidence construction and retrieval. While it touches on aspects of information retrieval, its primary focus is on multimodal question answering and evidence construction, which is somewhat related to the user's interests in query understanding and ranking models, but not a central match.
...
### 26. Leveraging Code-Mixed Product Metadata and User Feedback for Personalized Recommendation on Daraz Bangladesh
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and recommender systems, but it focuses on code-mixed product metadata and user feedback in e-commerce, which is a specific application area. While it touches on aspects of user behavior modeling and data mining, the primary focus is on recommendation systems rather than information retrieval. The paper's emphasis on code-mixed reviews and low-resource e-commerce settings is not a central match for the user's research themes.
...
### 27. A Self Consistency Based Reranking for Narrative Question Answering

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Molham Mohamed, Ali Hamdi
- **URL**: <http://arxiv.org/abs/2606.15741v1>
- **Submitted**: 2026-06-14 10:52:05
- **Topic Keywords**: ranking, rerank, rank
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and query understanding, but it focuses on narrative question answering, which is a specific task within NLP. The paper's use of self-consistency-based reranking and multi-answer inference is not directly related to your primary focus on information retrieval and search technologies.
...
### 28. Retrievable Gradients: Continual Post-Training Without Cumulative Weight Drift
...
- **URL**: <http://arxiv.org/abs/2606.15734v1>
- **Submitted**: 2026-06-14 10:31:36
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper proposes a new paradigm for continual post-training of models, focusing on gradient retrieval and adaptation. While it touches on aspects of knowledge integration and adaptation, which are related to query understanding and ranking models, its primary focus is on model training and adaptation rather than information retrieval or search technologies. The paper's relevance to the user's interests is somewhat limited.
...
### 29. Long-Context Modeling via GSS-Transformer Hybrid Architecture with Learnable Mixing
...
### 30. DEEPRUBRIC: Evidence-Tree Rubric Supervision for Efficient Reinforcement Learning of Deep Research Agents
...
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of deep research agents and query understanding. However, its focus on reinforcement learning and rubric supervision for report synthesis is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling.
...
### 31. The Value Axis: Language Models Encode Whether They're on the Right Track
...
- **Reason**: This paper explores the internal workings of language models, specifically their ability to estimate the value of their current trajectory. While it touches on topics related to NLP, it does not directly address information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 32. Can LLM Coding Agents Reason About Time Series?
...
- **Topic Keywords**: queries
- **Reason**: This paper explores the application of Large Language Models (LLMs) in analyzing time series data, which is somewhat related to information retrieval and search technologies. However, the focus on time series analysis and coding agents is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. While the paper touches on the use of LLMs, it is more relevant to the broader field of artificial intelligence and data analysis.
...
### 33. daVinci-kernel: Co-Evolving Skill Selection, Summarization, and Utilization via RL for GPU Kernel Optimization
...
- **Topic Keywords**: ranking, rerank, rank
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on GPU kernel optimization and reinforcement learning does not align with your primary areas of focus.
...
### 34. DYNA : Dynamic Episodic Memory Networks for Augmenting Large Language Models with Temporal Knowledge Graphs in Continuous Learning

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Ali Sarabadani, Mahtab Tajvidiyan
- **URL**: <http://arxiv.org/abs/2606.15778v1>
- **Submitted**: 2026-06-14 12:27:26
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper focuses on augmenting Large Language Models with a temporal knowledge graph, which is not directly related to Information Retrieval, Search technologies, or query understanding. While it touches on the concept of retrieval, the primary focus is on continuous learning and knowledge graph augmentation, making it only loosely relevant to the user's research interests.
...
### 35. QK-Normed MLA: QK normalization without full key caching
...
- **Reason**: This paper focuses on query-key normalization in the context of Multi-head Latent Attention (MLA) models, which is not directly related to your core research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. While it involves attention mechanisms, the specific topic and technical details are not aligned with your primary focus on deep semantic understanding and real-time relevance optimization in IR.
...
### 36. Towards Pareto-Optimal Tool-Integrated Agents with Pareto Ranking Policy Optimization
...
- **Reason**: This paper focuses on tool-integrated language agents and Pareto ranking policy optimization, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the primary focus is on multi-objective optimization and tool-use efficiency, rather than query understanding, ranking models, or user behavior modeling.
...
### 37. Your "Pro" LLM Subscription May Actually Be "Free": Exposing Fingerprint Spoofing Risks in LLM Inference Services
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models, the focus is on security risks and fingerprint spoofing, which is not a central theme in your research areas.
...
### 38. ttda704 at SemEval-2026 Task 6: Structured Chain-of-Thought Prompting for Political Evasion Detection

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Tai Tran Tan, An Dinh Thien
- **URL**: <http://arxiv.org/abs/2606.15770v1>
- **Submitted**: 2026-06-14 12:09:23
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves NLP tasks like question-answer pairs and model fine-tuning, the focus is on political evasion detection, which is not a central theme in your research.
...
### 39. Focus When Necessary: Adaptive Routing and Collaborative Grounding for Training-Free Visual Grounding
...
- **Reason**: This paper focuses on visual grounding and multimodal large language models, which is somewhat related to information retrieval and search technologies. However, the topic is more aligned with computer vision and NLP, and the abstract does not mention query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 40. Edu-Theater: A Data-Efficient Agent Framework for Scalable Learner Behavior Simulation through Staging Roll-Call
...
- **Submitted**: 2026-06-13 09:48:25
- **Comment**: LLM Agent, Educational Data Mining, Data Synthesis, Human Simulation
- **Topic Keywords**: queries, rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves data and simulation, its focus on educational systems and learner behavior simulation is outside your primary areas of interest.
...
### 41. Selection Without Signal, Recovery Through Expression: A Measurement Study of Post-Hoc Falsification Operators for Frozen Small Code Models
...
### 42. LectūraAgents: A Multi-Agent Framework for Adaptive Personalized AI-Assisted Learning and Embodied Teaching
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves AI and adaptive systems, its focus on educational agents and personalized learning is outside your primary areas of interest.
...
### 43. VibeThinker-3B: Exploring the Frontier of Verifiable Reasoning in Small Language Models
...
- **Reason**: This paper appears to be focused on verifiable reasoning in small language models, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on model development and evaluation, the context and objectives are distinct from the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 44. Control-Plane Placement Shapes Forgetting: An Architectural Study of Agent Memory Across Thirteen System Configurations

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Dongxu Yang
- **URL**: <http://arxiv.org/abs/2606.15903v1>
- **Submitted**: 2026-06-14 16:32:15
- **Comment**: 23 pages including appendices. Code, benchmark, and adapters released under MIT at https://github.com/deeplethe/lethe
- **Topic Keywords**: rag, acl
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on agent memory, forgetting failure modes, and system configurations in the context of Large Language Models (LLMs) does not align with your areas of expertise.
...
### 45. BALTO: Balanced Token-Level Policy Optimization for Hallucination Mitigation

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Ning Li, Zixuan Guo, Yan Xu, Wenbo Fei, Yifan Niu, Chang Luo, Yasheng Wang, Weiwen Liu, Yong Yu, Weinan Zhang
- **URL**: <http://arxiv.org/abs/2606.15893v1>
- **Submitted**: 2026-06-14 16:25:59
- **Topic Keywords**: rag, acl
- **Reason**: This paper focuses on hallucination mitigation in large language models, which is a topic related to NLP. However, it does not directly align with the user's primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. The paper's emphasis on fine-grained feedback and credit assignment mechanisms also does not directly relate to the user's interests in real-time relevance optimization and deep semantic understanding.
...
### 46. Agentic Retrieval and Reinforcement Learned Equation Chains: A Controlled Generation Framework for Complex and Novel Physics Word Problems

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Tirthankar Mittra
- **URL**: <http://arxiv.org/abs/2606.15591v1>
- **Submitted**: 2026-06-14 04:22:36
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper appears to be primarily focused on educational content generation for physics word problems, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve retrieval and a Large Language Model, the context and application are quite different from your areas of focus.
...
### 47. Evaluative Judgement in Teaching AI-based Translation: A Class-room Case Study of AI-Mediated Translation and Post-Editing

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Gokhan Dogru
- **URL**: <http://arxiv.org/abs/2606.15483v1>
- **Submitted**: 2026-06-13 21:34:50
- **Comment**: Workshop on Teaching AI-based Translation and Technologies (TAITT 2026) - EAMT 2026
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is not relevant to your research interests as it focuses on AI-based translation and post-editing in a classroom setting, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 48. TokenPilot: Cache-Efficient Context Management for LLM Agents
...
- **Reason**: This paper focuses on context management for Large Language Model (LLM) agents, which is not directly related to Information Retrieval or Search technologies. While it involves ranking models and user behavior modeling, the context is specific to LLMs and does not align with the user's core research themes.
...
### 49. OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models
...
- **Reason**: This paper focuses on Large Language Model (LLM) skills and collective intelligence, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on model training and generalization, the context and application are quite different from your areas of focus.
...
### 50. Islamic Large Language Models: From Knowledge Acquisition to Trustworthy and Hallucination-Resistant AI
...
- **Reason**: This paper focuses on Islamic Large Language Models, which, while related to NLP, does not directly align with the user's core research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. Although it touches on Arabic NLP, the primary focus is on the development of trustworthy AI systems for Islamic knowledge, which is not a central theme in the user's research.
