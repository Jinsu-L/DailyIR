...
- **Reason**: This paper is highly relevant to your interests in Information Retrieval, particularly in the context of short-video search. The proposed CroPS system addresses issues related to query understanding and ranking models, leveraging diverse positive examples and hierarchical label assignment. While the focus is on a specific application domain, the techniques and ideas presented can be applied more broadly in IR and NLP.
...
- **Topic Keywords**: rag
- **Reason**: This paper aligns well with your interests in Information Retrieval, particularly in areas requiring deep semantic understanding. The focus on Large Language Models and text clustering is relevant to your work in query understanding and ranking models. However, the specific application to clustering rather than search or ranking might limit its direct relevance.
...
### 4. ProRAC: A Neuro-symbolic Method for Reasoning about Actions with LLM-based Progression
...
- **Reason**: The paper explores a neuro-symbolic framework for reasoning about actions and change, leveraging Large Language Models (LLMs). While it touches on query understanding and evaluation, its primary focus is on reasoning and progression, which is somewhat related to information retrieval but not a central match for your research interests.
...
### 5. MAPROC at AHaSIS Shared Task: Few-Shot and Sentence Transformer for Sentiment Analysis of Arabic Hotel Reviews
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), specifically in the area of sentiment analysis and text classification. However, it focuses on Arabic dialects and sentiment analysis in the hospitality domain, which is not a primary area of interest for you. While it touches on few-shot learning, a technique that could be relevant to IR, the connection is not strong enough to warrant a higher score.
...
- **Reason**: This paper introduces a novel framework for automatic feature extraction using large language models, which is somewhat related to information retrieval and NLP. However, the focus on tabular data and machine learning models limits its direct relevance to search technologies and query understanding. The paper's emphasis on knowledge-informed feature extraction and semantic understanding is a positive match, but its application in a different domain makes it only loosely relevant to the user's core research themes.
...
### 7. Unveiling Inference Scaling for Difference-Aware User Modeling in LLM Personalization
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, as it involves Large Language Models (LLMs) and personalization. However, it does not directly focus on Information Retrieval (IR) or query understanding, which are your core research themes. The paper's emphasis on user modeling and inference scaling is also somewhat tangential to your interests in user behavior modeling and click models.
...
### 8. Opinion Dynamics Models for Sentiment Evolution in Weibo Blogs
...
- **Topic Keywords**: rag
- **Reason**: The paper explores sentiment dynamics in social media, which is related to information retrieval and natural language processing. However, the focus on opinion dynamics and sentiment evolution in social media platforms is somewhat tangential to the user's core research themes in query understanding, ranking models, and user behavior modeling. While there are some connections to user behavior modeling, the paper's emphasis on social media and opinion dynamics makes it only loosely relevant to the user's primary research interests.
...
### 10. MoDES: Accelerating Mixture-of-Experts Multimodal Large Language Models via Dynamic Expert Skipping
...
- **Reason**: This paper proposes a framework for efficient inference in Multimodal Large Language Models, leveraging a novel gating mechanism and thresholding method. While it touches on aspects of model optimization and efficiency, it does not directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to Information Retrieval is indirect, as the work primarily focuses on improving the performance of Large Language Models.
...
### 11. When to Think and When to Look: Uncertainty-Guided Lookback
...
- **Topic Keywords**: search
- **Reason**: This paper explores the concept of 'thinking' in large vision language models, specifically analyzing the effects of explicit intermediate reasoning chains on visual reasoning. While it touches on aspects of query understanding and ranking models, its primary focus is on multimodal reasoning and visual grounding, which is somewhat related to information retrieval but not directly aligned with your core research themes.
...
### 12. Standardising the NLP Workflow: A Framework for Reproducible Linguistic Analysis
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on standardizing NLP workflows and proposes a framework for reproducible linguistic analysis. While it touches on NLP, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of interest. The paper's emphasis on reproducibility and standardization is somewhat relevant to data mining, but it's not a central match for your research interests.
...
### 13. Unveiling Intrinsic Dimension of Texts: from Academic Abstract to Creative Story
...
- **Reason**: This paper explores the intrinsic dimension of texts, which is related to my interests in Natural Language Processing (NLP) and deep semantic understanding. However, the focus on LLM analysis and its applications in understanding text complexity is somewhat tangential to my core research themes in Information Retrieval and Search technologies.
...
### 14. A Compliance-Preserving Retrieval System for Aircraft MRO Task Search
...
- **Reason**: This paper is not relevant to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves retrieval and ranking, the context is specific to aviation MRO and does not align with your e-commerce background or focus on deep semantic understanding and real-time relevance optimization.
...
### 15. HV-Attack: Hierarchical Visual Attack for Multimodal Retrieval Augmented Generation
...
- **Reason**: This paper focuses on visual attacks for multimodal retrieval systems, which is not directly related to your core research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. While it touches on the robustness of retrievers, it does not address the specific areas of deep semantic understanding and real-time relevance optimization that are central to your work.
...
### 16. SilverTorch: A Unified Model-based System to Democratize Large-Scale Recommendation on GPUs
...
- **Reason**: This paper focuses on recommendation systems, proposing a unified model-based system for serving recommendation models on GPUs. While it involves some aspects of information retrieval, such as nearest neighbor search, the primary focus is on recommendation systems and not directly related to the user's core research themes in information retrieval and search technologies.
...
### 17. OEMA: Ontology-Enhanced Multi-Agent Collaboration Framework for Zero-Shot Clinical Named Entity Recognition
...
- **Reason**: This paper is primarily focused on clinical named entity recognition using a novel multi-agent collaboration framework, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and techniques used are quite different from the user's areas of focus.
...
### 18. The Empowerment of Science of Science by Large Language Models: New Tools and Methods
...
- **Reason**: The paper appears to be primarily focused on the applications of Large Language Models (LLMs) in the broader context of Artificial General Intelligence (AGI) and Science of Science, rather than Information Retrieval or Search technologies. While it touches on natural language understanding and generation, it does not seem to address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 19. Beyond GeneGPT: A Multi-Agent Architecture with Open-Source LLMs for Enhanced Genomic Question Answering
...
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on genomic question answering and multi-agent architectures, which is unrelated to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the context and application are distinct from the user's areas of focus.
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on debiasing question selection in Computerized Adaptive Testing, which is a specific application in education, and does not directly relate to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
- **Reason**: This paper focuses on language acquisition modeling in large language models, specifically for Chinese second language acquisition. While it involves fine-tuning and benchmarking, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval and Search technologies, nor does it involve query understanding, ranking models, or user behavior modeling. While it does involve Natural Language Processing (NLP) and deep semantic understanding, the focus is on biomedical reasoning and model improvement, which is not a central match for the user's interests.
...
- **Reason**: This paper focuses on Grammatical Error Correction in Indian languages, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models, the context is specific to error correction and not query understanding, ranking models, or user behavior modeling.
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the synergy between vision and language for abstract reasoning, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it explores the use of visual abstraction, the context is not in the e-commerce domain or related to query understanding, ranking models, or user behavior modeling.
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Vision-Language-Action models and Reinforcement Learning, which is unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves optimization and learning, the context and application are significantly different from your areas of expertise.
...
### 26. Generating Natural-Language Surgical Feedback: From Structured Representation to Domain-Grounded Evaluation
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves text analysis and generation, the focus is on surgical feedback and medical applications, which is outside your primary areas of interest.
...
### 27. CASTELLA: Long Audio Dataset with Captions and Temporal Boundaries
...
- **Topic Keywords**: retrieval
- **Reason**: This paper is about audio moment retrieval and presents a new dataset, CASTELLA, which is not related to Information Retrieval, Search technologies, or Natural Language Processing. Although it involves a benchmark and evaluation, the focus is on audio data and not on query understanding, ranking models, or user behavior modeling.
...
### 28. Mathematical Analysis of Hallucination Dynamics in Large Language Models: Uncertainty Quantification, Advanced Decoding, and Principled Mitigation
...
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on Large Language Models and hallucinations, which is outside your primary research interests in Information Retrieval and Search technologies. While it touches on topics like retrieval and calibration, the context is not directly related to your core areas of query understanding, ranking models, or user behavior modeling.
...
### 29. Skin-R1: Toward Trustworthy Clinical Reasoning for Dermatological Diagnosis
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves vision-language models, the focus is on clinical reasoning and dermatological diagnosis, which is outside the user's primary areas of interest.
...
### 30. Empowering Multi-Turn Tool-Integrated Reasoning with Group Turn Policy Optimization
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on training Large Language Models for multi-turn reasoning tasks, which is not directly related to Information Retrieval or Search technologies. Although it involves optimization and reinforcement learning, the context is more aligned with Natural Language Processing and AI reasoning, rather than query understanding, ranking models, or user behavior modeling.
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on the computational complexity of tokenization over bounded alphabets, which is a topic in theoretical computer science rather than information retrieval or natural language processing.
...
### 32. Multimodal Evaluation of Russian-language Architectures
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on multimodal evaluation frameworks for Russian-language architectures, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves large language models and multimodal abilities, the context and scope are not aligned with the user's primary focus on deep semantic understanding and real-time relevance optimization in the e-commerce domain and beyond.
...
### 33. Context Cascade Compression: Exploring the Upper Limits of Text Compression
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on text compression for Large Language Models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the topic of text processing, it does not involve query understanding, ranking models, or user behavior modeling, making it somewhat tangential to your research areas.
...
### 34. Multi-Aspect Cross-modal Quantization for Generative Recommendation
...
- **Reason**: This paper focuses on generative recommendation and cross-modal quantization, which is not directly related to your core research interests in Information Retrieval and Search technologies. While it touches on recommender systems, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to your research.
...
### 35. Evaluating Multimodal Large Language Models on Vertically Written Japanese Text
...
- **Topic Keywords**: search
- **Reason**: This paper evaluates the performance of Multimodal Large Language Models on vertically written Japanese text, which is not directly related to Information Retrieval, Search technologies, or user behavior modeling. While it touches on NLP, the focus is on visual document understanding and OCR, which is not a core area of interest.
...
### 36. SkyEgg: Joint Implementation Selection and Scheduling for Hardware Synthesis using E-graphs
...
- **Reason**: This paper is about hardware synthesis and FPGA optimization, which is unrelated to the user's research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on adversarial attacks on Large Language Models, which is outside your primary areas of interest.
...
### 38. HinTel-AlignBench: A Framework and Benchmark for Hindi-Telugu with English-Aligned Samples
