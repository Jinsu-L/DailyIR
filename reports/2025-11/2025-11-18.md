...
- **Reason**: This paper is highly relevant to your interests in Information Retrieval, particularly in the context of query understanding and ranking models. The focus on retrieval-augmented generation (RAG) systems and multi-stage retrieval with reranking aligns with your research themes. However, the specific application to policy documents and governance-related contexts is somewhat outside your primary focus on e-commerce and deep semantic understanding.
...
- **Reason**: This paper aligns well with your interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed Cog-RAG framework leverages a theme-aligned dual-hypergraph to capture high-order semantic relations, which is a relevant application of deep semantic understanding. However, the focus on Natural Language Processing and Generation might not be a central match to your primary research interests in IR and Search technologies.
...
### 3. PragWorld: A Benchmark Evaluating LLMs' Local World Model under Minimal Linguistic Alterations and Conversational Dynamics
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and query understanding, as it evaluates the ability of language models to encode and update their internal world model in conversations. However, it focuses more on the interpretability and fine-tuning of language models rather than ranking models or user behavior modeling, which are your primary areas of interest.
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of visual document retrieval. However, it focuses on visual content and multimodal models, which is a different aspect of IR compared to your primary focus on text-based IR and query understanding. The use of attention and cross-modal attention is relevant to your interests in ranking models and deep semantic understanding.
...
### 5. Exploring Multi-Table Retrieval Through Iterative Search
...
- **Reason**: The paper explores multi-table retrieval, which is related to information retrieval and query understanding. However, the focus on open-domain question answering and NL2SQL benchmarks is somewhat specific and not directly aligned with the user's core research themes in e-commerce and general search technologies.
...
### 6. Dimension vs. Precision: A Comparative Analysis of Autoencoders and Quantization for Efficient Vector Retrieval on BEIR SciFact
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of efficient vector retrieval and real-time relevance optimization. However, the focus on vector compression and quantization is more specific and doesn't directly align with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 7. Tokenize Once, Recommend Anywhere: Unified Item Tokenization for Multi-domain LLM-based Recommendation
...
- **Reason**: The paper explores a unified item tokenization framework for multi-domain LLM-based recommendation, which is somewhat related to information retrieval and search technologies. However, the focus on recommender systems and item tokenization is not a central match to the user's primary interests in query understanding, ranking models, and user behavior modeling. The connection to deep semantic understanding and real-time relevance optimization is also not explicitly mentioned.
...
### 8. BioMedJImpact: A Comprehensive Dataset and LLM Pipeline for AI Engagement and Scientific Impact Analysis of Biomedical Journals
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it involves a Large Language Model (LLM) pipeline for AI engagement and semantic analysis. However, the focus on biomedical journals and scientometric analysis is not directly aligned with the user's primary research themes in e-commerce and real-time relevance optimization.
...
### 9. AIF: Asynchronous Inference Framework for Cost-Effective Pre-Ranking
...
- **Reason**: The paper focuses on improving the efficiency of pre-ranking models in recommendation systems, which is somewhat related to information retrieval. However, the emphasis on cost-effectiveness and computational efficiency, rather than query understanding or ranking models, limits its relevance to your core research interests.
...
### 10. Auditing Google's AI Overviews and Featured Snippets: A Case Study on Baby Care and Pregnancy
...
- **Reason**: This paper is somewhat related to Information Retrieval, as it involves evaluating the quality and consistency of Google's AI-generated content features. However, the focus is more on the quality and safety of health information rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest for you.
...
### 11. Can We Predict the Next Question? A Collaborative Filtering Approach to Modeling User Behavior
...
- **Reason**: The paper explores user behavior modeling, specifically question prediction, which is somewhat related to your interests in query understanding and user behavior modeling. However, the focus on collaborative filtering and dialogue systems is not a central match for your primary research themes in information retrieval and search technologies.
...
### 12. Quantifying consistency and accuracy of Latent Dirichlet Allocation
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), but it focuses on topic modeling and stability measures, which is a specific area within NLP. While it touches on IR, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are your core research themes.
...
### 13. Large Language Models Meet Extreme Multi-label Classification: Scaling and Multi-modal Framework
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it deals with Extreme Multi-label Classification and the use of large language models. However, the focus on visual information and multi-modal capabilities makes it less relevant to the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 14. O-Mem: Omni Memory System for Personalized, Long Horizon, Self-Evolving Agents
...
- **Reason**: The paper discusses a novel memory framework for personalized AI assistants, which is somewhat related to information retrieval and user behavior modeling. However, the focus is on memory systems and agent interactions, rather than search technologies or query understanding. The connection to NLP is also present, but it's not the primary focus of the paper.
...
### 15. Why is "Chicago" Predictive of Deceptive Reviews? Using LLMs to Discover Language Phenomena from Lexical Cues
...
- **Topic Keywords**: rag
- **Reason**: This paper explores the use of large language models to identify language phenomena indicative of deceptive reviews, which is somewhat related to information retrieval and query understanding. However, the focus on deception detection and review credibility assessment is not directly aligned with the user's primary research themes in IR and search technologies. The connection to NLP is relevant, but the application domain is more specific to review analysis rather than general IR or search.
...
### 16. Beyond SELECT: A Comprehensive Taxonomy-Guided Benchmark for Real-World Text-to-SQL Translation
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), as it deals with text-to-SQL translation and Large Language Models (LLMs). However, the focus on text-to-SQL translation and its applications in real-world scenarios is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 17. AA-Omniscience: Evaluating Cross-Domain Knowledge Reliability in Large Language Models
...
- **Reason**: The paper focuses on evaluating the reliability of large language models across various domains, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the primary focus on factual accuracy and knowledge gaps in language models is not directly aligned with the user's core research themes in IR and Search technologies. The paper's emphasis on NLP and knowledge reliability is somewhat relevant, but it does not strongly overlap with the user's interests in IR, query understanding, and user behavior modeling.
...
### 18. A Plug-and-Play Spatially-Constrained Representation Enhancement Framework for Local-Life Recommendation
...
- **Topic Keywords**: recommend
- **Reason**: The paper focuses on local-life recommendation, which is somewhat related to information retrieval, but it lacks direct connection to query understanding, ranking models, or user behavior modeling. The use of spatially-constrained representation enhancement is an interesting aspect, but it's more aligned with recommender systems than information retrieval.
...
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding, but it does not directly align with the user's primary focus on Information Retrieval (IR) and Search technologies. The paper's focus on multimodal large language models and chain-of-thought reasoning is interesting, but it does not appear to be directly applicable to the user's areas of expertise.
...
- **Reason**: This paper is somewhat relevant to your research interests in Information Retrieval and Search technologies, but it primarily focuses on recommender systems, which is a related but secondary area of interest for you. The paper's emphasis on representation learning and debiasing recommendation is not directly aligned with your core research themes in query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper focuses on trajectory similarity learning, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of data mining, the context and methodology are quite different from your areas of expertise.
...
### 22. Translation Entropy: A Statistical Framework for Evaluating Translation Systems
...
- **Reason**: This paper focuses on translation systems and proposes a statistical framework for evaluating their performance, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves deep architectures and ranking, the context is translation systems rather than search or IR.
...
### 23. Local Collaborative Filtering: A Collaborative Filtering Method that Utilizes Local Similarities among Users
...
- **Topic Keywords**: rag, user behavior, recommend
- **Reason**: This paper focuses on recommender systems and collaborative filtering, which are somewhat related to your interests in Information Retrieval and Search technologies. However, it does not address query understanding, ranking models, or user behavior modeling, which are core areas of your research. The paper's emphasis on leveraging user behavior data is also somewhat tangential to your focus on deep semantic understanding and real-time relevance optimization.
...
### 24. Extracting Events Like Code: A Multi-Agent Programming Framework for Zero-Shot Event Extraction
...
- **Reason**: This paper focuses on event extraction and zero-shot learning for large language models, but it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 25. FGNet: Leveraging Feature-Guided Attention to Refine SAM2 for 3D EM Neuron Segmentation
...
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on developing a domain-specific language model for EEG report understanding and generation, which is outside the scope of information retrieval and search technologies. While it involves natural language processing, the application domain and goals are distinct from the user's research interests.
...
### 27. Compact Multimodal Language Models as Robust OCR Alternatives for Noisy Textual Clinical Reports
...
- **Topic Keywords**: ltr
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves OCR and language models, the focus is on medical records and digitization, which is not a primary area of interest for you.
...
### 28. Applying Large Language Models to Characterize Public Narratives
...
- **Reason**: This paper focuses on applying large language models to characterize public narratives, which is a topic in Natural Language Processing (NLP). However, it does not directly relate to the user's core research interests in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, making it only loosely relevant.
...
### 29. Mem-PAL: Towards Memory-based Personalized Dialogue Assistants for Long-term User-Agent Interaction
...
### 30. AutoMalDesc: Large-Scale Script Analysis for Cyber Threat Research
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves NLP in the form of language model-based judges, the primary focus is on cybersecurity and malware detection, which is not a central match to the user's interests.
...
### 31. Computational Measurement of Political Positions: A Review of Text-Based Ideal Point Estimation Algorithms
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests as it focuses on computational text-based ideal point estimation algorithms in political science, which does not align with your core areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 32. ForgeDAN: An Evolutionary Framework for Jailbreaking Aligned Large Language Models
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your core research themes in Information Retrieval and Search technologies. Although it involves Natural Language Processing, its focus on adversarial attacks against large language models is not aligned with your interests in query understanding, ranking models, and user behavior modeling.
...
### 33. AHaSIS: Shared Task on Sentiment Analysis for Arabic Dialects
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on sentiment analysis for Arabic dialects, which is a specific topic within NLP. While it involves text analysis and potentially some aspects of user behavior modeling, it does not directly relate to query understanding, ranking models, or real-time relevance optimization in the context of information retrieval, which are the primary areas of interest.
...
### 34. Souper-Model: How Simple Arithmetic Unlocks State-of-the-Art LLM Performance
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models (LLMs) and model souping techniques, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on performance optimization, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's research interests.
...
### 35. Seeing isn't Hearing: Benchmarking Vision Language Models at Interpreting Spectrograms
...
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on vision language models' ability to interpret spectrograms, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, the specific task of interpreting spectrograms is not a core area of interest for you.
...
### 36. Zero-Shot Grammar Competency Estimation Using Large Language Model Generated Pseudo Labels
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on grammar competency estimation using large language models, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, it does not align with the user's primary research interests in deep semantic understanding and real-time relevance optimization.
...
### 37. Evaluating the Ability of Large Language Models to Identify Adherence to CONSORT Reporting Guidelines in Randomized Controlled Trials: A Methodological Evaluation Study
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the application of Large Language Models (LLMs) in identifying adherence to CONSORT reporting guidelines in randomized controlled trials, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is specific to medical research and not aligned with your broader interests in e-commerce, query understanding, ranking models, and user behavior modeling.
...
### 38. Personalized Federated Recommendation With Knowledge Guidance
...
- **Reason**: This paper is primarily focused on recommender systems, which is a related but secondary interest of yours. While it involves some aspects of knowledge guidance, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of your research.
...
### 39. Evidence of Phase Transitions in Small Transformer-Based Language Models
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The study focuses on phase transitions in language models, which is a topic more aligned with NLP and machine learning, but does not seem to address query understanding, ranking models, or user behavior modeling.
...
### 40. Toward Conversational Hungarian Speech Recognition: Introducing the BEA-Large and BEA-Dialogue Datasets
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on speech recognition and conversational ASR, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve language processing, the specific domain and application are quite different from your areas of focus.
...
### 41. RegionMarker: A Region-Triggered Semantic Watermarking Framework for Embedding-as-a-Service Copyright Protection
...
- **Comment**: AAAI 2026
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves NLP tasks, its focus on copyright protection and watermarking is not aligned with your interests in query understanding, ranking models, or user behavior modeling.
...
### 42. Examining the Usage of Generative AI Models in Student Learning Activities for Software Programming
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on AI models, the focus is on their application in education, which is not within your primary areas of interest.
...
### 43. Rethinking the filter bubble? Developing a research agenda for the protective filter bubble
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on the concept of filter bubbles and their potential protective benefits, particularly for marginalized communities. While it touches on digital spaces, it doesn't directly relate to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 44. LLM Reinforcement in Context
...
### 45. P1: Mastering Physics Olympiads with Reinforcement Learning
...
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on developing large language models for physics reasoning using reinforcement learning, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 46. TCM-5CEval: Extended Deep Evaluation Benchmark for LLM's Comprehensive Clinical Research Competence in Traditional Chinese Medicine
...
### 47. Crossing Borders: A Multimodal Challenge for Indian Poetry Translation and Image Generation
...
### 48. WebCoach: Self-Evolving Web Agents with Cross-Session Memory Guidance
...
### 49. Live-SWE-agent: Can Software Engineering Agents Self-Evolve on the Fly?
...
### 50. Spark-Prover-X1: Formal Theorem Proving Through Diverse Data Training
