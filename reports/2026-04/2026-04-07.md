...
### 1. Retrieval Augmented Conversational Recommendation with Reinforcement Learning
...
- **Reason**: This paper explores query understanding and decision-aware query resolution in question answering, which aligns with your interests in Information Retrieval and query understanding. The focus on epistemic awareness and finetuning for improved performance is also relevant to your work on ranking models and user behavior modeling.
...
### 3. Beyond Hard Negatives: The Importance of Score Distribution in Knowledge Distillation for Dense Retrieval
...
- **Reason**: This paper is highly relevant to Information Retrieval, specifically focusing on knowledge distillation for dense retrieval, which is a key area of interest. The use of stratified sampling to preserve the teacher's score distribution is also an important contribution. While not directly related to query understanding or user behavior modeling, the work has implications for improving retrieval models, making it a useful read for the field.
...
### 4. SLSREC: Self-Supervised Contrastive Learning for Adaptive Fusion of Long- and Short-Term User Interests
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and user behavior modeling. The proposed SLSRec model effectively captures the temporal dynamics of user interests, which is a key aspect of your research focus. However, the paper's primary focus on recommender systems and user behavior modeling, while related to your interests, is not a central match with your core research themes in IR and Search technologies.
...
### 5. High-Stakes Personalization: Rethinking LLM Customization for Individual Investor Decision-Making

- **LLM Score**: 6
- **Keyword Score**: 2
- **Authors**: Yash Ganpat Sawant
- **URL**: <http://arxiv.org/abs/2604.04300v1>
- **Submitted**: 2026-04-05 22:45:33
- **Comment**: 4 pages + 1 page references. Submitted to CustomNLP4U Workshop @ ACL 2026
- **Topic Keywords**: personalization, search
- **Reason**: The paper explores personalized LLM systems in the context of individual investor decision-making, which shares some similarities with query understanding and user behavior modeling in IR. However, the focus on portfolio management and investment philosophy is somewhat tangential to the user's core research themes in IR and NLP, but still relevant to the broader field of NLP and personalization.
...
### 6. Ruling Out to Rule In: Contrastive Hypothesis Retrieval for Medical Question Answering
...
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of medical question answering. However, its focus on contrastive hypothesis retrieval and clinical differential diagnosis is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. While it does involve retrieval-augmented generation, the application to medical question answering and the use of clinical reasoning is not a central match for the user's interests.
...
- **Reason**: This paper explores the effectiveness of agent skills in realistic settings, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on Large Language Models (LLMs) and skill refinement strategies is not directly aligned with the user's primary research interests in IR and Search technologies.
...
### 8. GROUNDEDKG-RAG: Grounded Knowledge Graph Index for Long-document Question Answering
...
- **Reason**: This paper focuses on Retrieval-augmented generation (RAG) systems for long-document question answering, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the primary focus on question answering and knowledge graph construction is not directly aligned with your core research themes, such as query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper focuses on improving the efficiency of large language models by proposing a new attention mechanism called TriAttention. While it touches on aspects of query understanding and ranking models, its primary contribution is in the area of NLP, specifically in the optimization of long reasoning processes. Although it has some relevance to information retrieval, it does not directly address the user's core research themes.
...
### 10. Cog-DRIFT: Exploration on Adaptively Reformulated Instances Enables Learning from Hard Reasoning Problems
...
- **Reason**: The paper explores task reformulation and curriculum learning to improve the reasoning abilities of Large Language Models (LLMs), which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and post-training learning is not directly aligned with the user's primary research interests in IR and search technologies.
...
### 11. Plausibility as Commonsense Reasoning: Humans Succeed, Large Language Models Do not
...
- **Topic Keywords**: rag
- **Reason**: This paper explores the integration of world knowledge with syntactic structure in large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language models and linguistic phenomena, such as relative-clause attachment ambiguities, is not directly aligned with the user's core research themes. The paper's relevance to the user's interests in e-commerce, recommender systems, or real-time relevance optimization is minimal.
...
### 12. One Model for All: Multi-Objective Controllable Language Models

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Qiang He, Yucheng Yang, Tianyi Zhou, Meng Fang, Mykola Pechenizkiy, Setareh Maghsudi
- **URL**: <http://arxiv.org/abs/2604.04497v1>
- **Submitted**: 2026-04-06 07:48:32
- **Comment**: Published in Transactions on Machine Learning Research (03/2026): https://openreview.net/forum?id=qAM5PmvFYY
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it primarily focuses on training language models for personalized outputs based on user preferences. While it touches on the idea of controllability and adaptability, which are relevant to information retrieval, the paper's main contributions and applications are in the realm of NLP and recommender systems, rather than information retrieval or search technologies.
...
- **Submitted**: 2026-04-06 15:57:57
- **Comment**: 15 pages
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and its applications in LegalTech. However, it is not directly related to the user's core research themes in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling. The paper's focus on a specific domain (Turkish law) and its use of a domain-specific language model also limits its relevance to the user's broader interests in e-commerce and real-time relevance optimization.
...
- **URL**: <http://arxiv.org/abs/2604.04692v1>
- **Submitted**: 2026-04-06 14:01:38
- **Comment**: preprint, 18 pages
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to Information Retrieval, specifically in the context of fact-checking and multimodal evidence, but it does not directly align with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's focus on fact-checking and visual evidence is more closely related to Natural Language Processing and recommender systems, but the connection to the user's interests is not strong enough to warrant a higher score.
...
### 15. Conversational Control with Ontologies for Large Language Models: A Lightweight Framework for Constrained Generation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Barbara Gendron, Gaël Guibon, Mathieu d'Aquin
- **URL**: <http://arxiv.org/abs/2604.04450v1>
- **Submitted**: 2026-04-06 05:54:21
- **Comment**: Accepted at KG & LLM: Knowledge Graphs and Large Language Models LREC 2026 Workshop
- **Topic Keywords**: personalization
- **Reason**: The paper explores conversational control with ontologies for Large Language Models, which is related to NLP and deep semantic understanding. However, it does not directly address information retrieval, query understanding, or ranking models, which are core areas of interest. The paper's focus on conversational systems and controlled generation is somewhat relevant to user behavior modeling, but it is not a central match.
...
### 16. Benchmarking Multi-turn Medical Diagnosis: Hold, Lure, and Self-Correction
...
- **URL**: <http://arxiv.org/abs/2604.04325v1>
- **Submitted**: 2026-04-06 00:23:10
- **Topic Keywords**: recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of query understanding and deep semantic understanding. However, the focus on medical diagnosis and multi-turn evidence accumulation is not directly aligned with your primary research themes in e-commerce and real-time relevance optimization.
...
### 17. A Logical-Rule Autoencoder for Interpretable Recommendations

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Jinhao Pan, Bowen Wei, Ziwei Zhu
- **URL**: <http://arxiv.org/abs/2604.04270v1>
- **Submitted**: 2026-04-05 21:21:37
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on interpretable recommender systems, which is a related topic to information retrieval. However, it primarily deals with collaborative filtering and recommendation models, which is not the core focus of the user's research interests. The use of logical rules and interpretability is somewhat relevant to the user's interest in deep semantic understanding, but the paper's primary contribution is in the recommender systems domain.
...
### 18. CAWN: Continuous Acoustic Wave Networks for Autoregressive Language Modeling
...
- **Reason**: This paper focuses on a novel architecture for autoregressive language modeling, using continuous acoustic wave networks. While it touches on sequence-mixing and contextual understanding, it does not directly relate to information retrieval, query understanding, or ranking models, which are core areas of interest for you.
...
### 19. Multilingual Prompt Localization for Agent-as-a-Judge: Language and Backbone Sensitivity in Requirement-Level Evaluation
...
- **Reason**: This paper is not relevant to your research interests as it focuses on multilingual prompt localization for agent-as-a-judge, which is outside the scope of information retrieval, search technologies, and natural language processing. The paper's emphasis on language and backbone sensitivity in requirement-level evaluation also does not align with your interests in query understanding, ranking models, and user behavior modeling.
...
### 20. Full-Duplex-Bench-v3: Benchmarking Tool Use for Full-Duplex Voice Agents Under Real-World Disfluency
...
- **Topic Keywords**: ltr
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on spoken language models, voice agents, and disfluency in human speech does not align with your areas of expertise.
...
- **Reason**: This paper focuses on the safety analysis of a personal AI agent, which is not directly related to Information Retrieval or Search technologies. While it involves AI and real-world applications, the context and methodology are quite different from the user's core research themes.
...
### 22. BiST: A Gold Standard Bangla-English Bilingual Corpus for Sentence Structure and Tense Classification with Inter-Annotator Agreement
...
- **Reason**: This paper focuses on creating a Bangla-English bilingual corpus for sentence-level grammatical classification, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific task and language are not aligned with the user's primary focus on deep semantic understanding and real-time relevance optimization.
...
### 23. FAVE: Flow-based Average Velocity Establishment for Sequential Recommendation
...
- **Reason**: This paper focuses on sequential recommendation and generative methods, but it does not align with the user's primary research interests in Information Retrieval, particularly query understanding, ranking models, and user behavior modeling. While it touches on related topics, the paper's emphasis on recommender systems and sequential recommendation makes it somewhat tangential to the user's core research themes.
...
### 24. DARE: Diffusion Large Language Models Alignment and Reinforcement Executor
...
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The paper focuses on diffusion large language models and their alignment and reinforcement executor, which is outside the scope of your core research themes.
...
### 25. Early Stopping for Large Reasoning Models via Confidence Dynamics
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on large reasoning models and proposes an early stopping method, which is not directly related to information retrieval, search technologies, or query understanding. While it involves modeling and analysis, the context is more aligned with NLP and deep learning, but lacks a clear connection to the user's core research themes.
...
### 26. Vero: An Open RL Recipe for General Visual Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Gabriel Sarch, Linrong Cai, Qunzhong Wang, Haoyang Wu, Danqi Chen, Zhuang Liu
- **URL**: <http://arxiv.org/abs/2604.04917v2>
- **Submitted**: 2026-04-06 17:56:25
- **Comment**: Project page: https://vero-reasoning.github.io/
- **Topic Keywords**: rag
- **Reason**: This paper focuses on visual reasoning and reinforcement learning in the context of vision-language models, which is somewhat related to information retrieval and search technologies. However, the primary focus on visual reasoning and the lack of direct connection to query understanding, ranking models, or user behavior modeling make it less relevant to your core research interests.
...
### 27. Do No Harm: Exposing Hidden Vulnerabilities of LLMs via Persona-based Client Simulation Attack in Psychological Counseling
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on the safety of large language models in mental healthcare, which is outside your primary areas of interest in Information Retrieval and Search technologies, and Natural Language Processing.
...
### 28. SkillX: Automatically Constructing Skill Knowledge Bases for Agents
...
- **Submitted**: 2026-04-06 16:09:33
- **Comment**: Work in progress
- **Topic Keywords**: rag
- **Reason**: This paper focuses on constructing skill knowledge bases for agents, which is not directly related to information retrieval, search technologies, or query understanding. While it involves learning and optimization, the context is in the realm of artificial intelligence and agent learning, rather than information retrieval or natural language processing.
...
### 29. MinerU2.5-Pro: Pushing the Limits of Data-Centric Document Parsing at Scale
...
- **Submitted**: 2026-04-06 15:44:18
- **Comment**: Technical Report
- **Topic Keywords**: rag
- **Reason**: This paper focuses on document parsing and data engineering, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves data and training strategies, the context is specific to document parsing and does not align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 30. Darkness Visible: Reading the Exception Handler of a Language Model

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Peter Balogh
- **URL**: <http://arxiv.org/abs/2604.04756v2>
- **Submitted**: 2026-04-06 15:24:05
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on the internal workings of a language model, specifically the exception handler of GPT-2 Small. While it involves neural networks and deep learning, it does not seem to be directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 31. Metaphors We Compute By: A Computational Audit of Cultural Translation vs. Thinking in LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yuan Chang, Jiaming Qu, Zhu Li
- **URL**: <http://arxiv.org/abs/2604.04732v1>
- **Submitted**: 2026-04-06 15:00:05
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on the cultural implications of Large Language Models (LLMs), which is somewhat related to your interests in NLP and deep semantic understanding. However, the paper's focus on cultural translation and reasoning does not directly align with your core research themes in Information Retrieval, query understanding, and ranking models.
...
### 32. Mapping the Exploitation Surface: A 10,000-Trial Taxonomy of What Makes LLM Agents Exploit Vulnerabilities

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Charafeddine Mouzouni
- **URL**: <http://arxiv.org/abs/2604.04561v1>
- **Submitted**: 2026-04-06 09:44:34
- **Comment**: 18 pages, 8 tables, code and data at https://github.com/Cmouzouni/exploitation-surface
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on the security vulnerabilities of Large Language Models (LLMs) and their exploitation, which is outside the scope of your work in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 33. SuperLocalMemory V3.3: The Living Brain -- Biologically-Inspired Forgetting, Cognitive Quantization, and Multi-Channel Retrieval for Zero-LLM Agent Memory Systems

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Varun Pratap Bhardwaj
- **URL**: <http://arxiv.org/abs/2604.04514v1>
- **Submitted**: 2026-04-06 08:27:26
...
- **Reason**: This paper focuses on developing a biologically-inspired memory system for AI agents, which is not directly related to information retrieval, search technologies, or natural language processing. While it does involve retrieval mechanisms, they are primarily for memory recall rather than information retrieval or search.
...
### 34. DP-OPD: Differentially Private On-Policy Distillation for Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Fatemeh Khadem, Sajad Mousavi, Yi Fang, Yuhong Liu
- **URL**: <http://arxiv.org/abs/2604.04461v1>
- **Submitted**: 2026-04-06 06:18:03
- **Topic Keywords**: rag
- **Reason**: This paper focuses on differential privacy for language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on model compression and optimization, the context is specific to language models and differential privacy, making it less relevant to your broader interests.
...
### 35. Structured Causal Video Reasoning via Multi-Objective Alignment
...
- **URL**: <http://arxiv.org/abs/2604.04415v1>
- **Submitted**: 2026-04-06 04:49:30
- **Topic Keywords**: rag
- **Reason**: This paper focuses on video reasoning and causal inference, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multi-objective reinforcement learning, the context and application are quite different from the user's areas of expertise.
...
### 36. Combee: Scaling Prompt Learning for Self-Improving Language Model Agents
...
- **URL**: <http://arxiv.org/abs/2604.04247v1>
- **Submitted**: 2026-04-05 20:07:48
- **Topic Keywords**: rag
- **Reason**: This paper focuses on scaling prompt learning for self-improving language model agents, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models, the context is more aligned with NLP and AI agents rather than IR and search technologies.
...
### 37. Synthetic Sandbox for Training Machine Learning Engineering Agents

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yuhang Zhou, Lizhu Zhang, Yifan Wu, Jiayi Liu, Xiangjun Fan, Zhuokai Zhao, Hong Yan
- **URL**: <http://arxiv.org/abs/2604.04872v1>
- **Submitted**: 2026-04-06 17:19:29
- **Comment**: 28 pages, 9 tables, 8 figures
- **Topic Keywords**: rank
- **Reason**: This paper focuses on machine learning engineering and reinforcement learning, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some technical complexity, the context and methodology are quite different from the user's core research themes.
...
### 38. Benchmarking Multilingual Speech Models on Pashto: Zero-Shot ASR, Script Failure, and Cross-Domain Evaluation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Hanif Rahman
- **URL**: <http://arxiv.org/abs/2604.04598v1>
- **Submitted**: 2026-04-06 11:23:42
- **Topic Keywords**: search
- **Reason**: This paper focuses on multilingual speech models and automatic speech recognition (ASR) for Pashto, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and techniques used are quite different from your areas of focus.
...
### 39. Formal Constraints on Dependency Syntax

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Gómez-Rodríguez, Carlos, Alemany-Puig, Lluís
- **URL**: <http://arxiv.org/abs/2604.04542v1>
- **Submitted**: 2026-04-06 09:09:35
- **Topic Keywords**: search
- **Reason**: This paper focuses on dependency syntax and linguistic constraints, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on aspects of language structure, it does not address query understanding, ranking models, user behavior modeling, or real-time relevance optimization, making it an off-topic paper for the user's research interests.
...
### 40. Talk2AI: A Longitudinal Dataset of Human--AI Persuasive Conversations

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Alexis Carrillo, Enrique Taietta, Ali Aghazadeh Ardebili, Giuseppe Alessandro Veltri, Massimo Stella
- **URL**: <http://arxiv.org/abs/2604.04354v1>
- **Submitted**: 2026-04-06 02:03:48
- **Comment**: 17 pages, 2 figures, 7 tables
- **Topic Keywords**: search
- **Reason**: This paper appears to be primarily focused on human-AI interaction and persuasion, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves conversational dialogue, the context is centered on persuasion and opinion change rather than query understanding, ranking models, or user behavior modeling.
...
### 41. Adaptive Cost-Efficient Evaluation for Reliable Patent Claim Validation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yongmin Yoo, Qiongkai Xu, Longbing Cao
- **URL**: <http://arxiv.org/abs/2604.04295v1>
- **Submitted**: 2026-04-05 22:25:36
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models, the context is patent claim validation, which is not a primary focus of your research interests.
...
### 42. Commercial Persuasion in AI-Mediated Conversations

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Francesco Salvi, Alejandro Cuevas, Manoel Horta Ribeiro
- **URL**: <http://arxiv.org/abs/2604.04263v1>
- **Submitted**: 2026-04-05 20:51:55
- **Topic Keywords**: search
- **Reason**: This paper focuses on commercial persuasion in AI-mediated conversations, which is somewhat related to information retrieval and search technologies, but it does not directly address query understanding, ranking models, or user behavior modeling. The paper's emphasis on conversational AI and persuasion is more aligned with recommender systems, but it's not a central match for your primary research interests in information retrieval and deep semantic understanding.
...
### 43. Compressible Softmax-Attended Language under Incompressible Attention
...
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and transformer language models, but it focuses on the attention mechanism's compressibility and interaction patterns, which does not directly align with your primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling.
...
### 44. ANX: Protocol-First Design for AI Agent Interaction with a Supporting 3EX Decoupled Architecture

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Xu Mingze
- **URL**: <http://arxiv.org/abs/2604.04820v1>
- **Submitted**: 2026-04-06 16:24:07
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, Natural Language Processing, or data mining. The paper focuses on AI agent interaction protocols and architectures, which is outside your primary areas of interest.
...
### 45. On Ambiguity: The case of fraction, its meanings and roles

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Jan A Bergstra, John V Tucker
- **URL**: <http://arxiv.org/abs/2604.04647v1>
- **Submitted**: 2026-04-06 12:56:22
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The topic of ambiguity in mathematical discourse, specifically fractions, is unrelated to your areas of focus.
...
### 46. QED-Nano: Teaching a Tiny Model to Prove Hard Theorems
...
- **Submitted**: 2026-04-06 17:44:25
- **Topic Keywords**: search
- **Reason**: This paper is about developing a model for mathematical reasoning, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
