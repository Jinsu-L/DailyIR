...
### 1. Risk-Aware Reranking for Agentic Tool Retrieval

- **LLM Score**: 0
- **Keyword Score**: 21
- **Authors**: Qinfei Li, Xiaoxuan Dong, Jin Zhang, Dexu Yu, Wenhao Deng, Junchen Fu, Youhua Li, Hanwen Du, Chunxiao Li
- **URL**: <http://arxiv.org/abs/2608.22751v1>
- **Submitted**: 2026-08-24 03:20:54
- **Comment**: Accepted by CIKM 2026
- **Topic Keywords**: retriever, query, ranking, rerank, ltr, relevance, retrieval, rank
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Risk‑Aware Reranking for Tool Retrieval
- **Aim**: Jointly optimise semantic relevance and operational risk in tool selection for LLM agents, enabling a tunable safety‑utility trade‑off.
- **Rationale**: Existing retrieval pipelines return high‑risk tools when they are semantically relevant, exposing users to unnecessary hazards. A lightweight reranker that incorporates risk estimates can mitigate this without sacrificing relevance.
- **Ground**: Problem is formalised as a retrieval‑time relevance–safety optimisation over a tool corpus (T). Tools are annotated with an ordinal risk rubric (L1–L5) on two datasets (UltraTool, Seal‑Tools) using LLM annotators and human review, achieving Krippendorff’s α of 0.523 and 0.856 respectively. The architecture consists of a frozen first‑stage retriever (ToolRet‑BGE), a relevance MLP head (f_{	ext{rel}}), a risk MLP head (f_{	ext{risk}}), graph‑based smoothing over a ToolGraph with co‑occurrence, semantic, permission, and risk‑co‑occurrence edges, and a risk‑aware reranker scoring (s(q,t)=f_{	ext{rel}}(q,t)-lambda f_{	ext{risk}}(t)). Training uses a joint loss (mathcal{L}=mathcal{L}_{	ext{rel}}+mumathcal{L}_{	ext{risk}}) with (mu=0.5), pairwise relevance margin (m=0.1), and MSE risk loss on normalised labels. Inference allows any (lambda) to adjust the safety‑utility curve; a rule‑filter can enforce hard caps on high‑risk tools.
- **Experiment**: The reranker was trained on the annotated datasets, evaluated on held‑out queries, and compared against risk‑blind baselines. Metrics included precision@k for relevance and the proportion of high‑risk tools in the top‑k. Results showed a significant reduction in risk‑heavy tool retrieval (up to 40% fewer L4/L5 tools) with negligible loss in relevance (≤1% drop in precision). Graph smoothing and the optional rule‑filter further tightened safety constraints without affecting latency.
- **Takeaway**: A lightweight, end‑to‑end reranker can effectively balance relevance and safety in tool retrieval for LLM agents. The tunable (lambda) parameter and optional rule‑filter provide deployment flexibility, enabling systems to meet diverse safety‑utility requirements while keeping inference cost low.
...
### 2. Robustness of IR Models to Collection Growth

- **LLM Score**: 0
- **Keyword Score**: 18
- **Authors**: Emmanouil Georgios Lionis, Debasis Ganguly, Sean MacAvaney
- **URL**: <http://arxiv.org/abs/2608.23419v1>
- **Submitted**: 2026-08-24 16:00:20
- **Comment**: CIKM 2026 Short Paper track
- **Topic Keywords**: information retrieval, retriever, ranking, rerank, listwise, retrieval, rank
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Robustness to Collection Growth in Retrieval Pipelines
- **Aim**: Define a principled, axiom‑based notion of robustness to the addition of heterogeneous, non‑relevant documents and provide an interpretable metric (Collection Precision) to evaluate it across retrieval models.
- **Rationale**: In real deployments, new data streams are merged into legacy corpora, potentially degrading performance. A formal definition and metric are needed to assess and guide system design.
- **Ground**: - CG Axiom: relative change in any metric M must be ≤ε when only non‑relevant docs are added.  - Collection Precision (CP): fraction of top‑k results from the original collection.  - Model taxonomy: Multi‑Document‑Agnostic (MDA) vs Multi‑Document‑Dependent (MDD) along scope and interaction axes, with representative dense, sparse, and cross‑encoder models.
- **Experiment**: - Benchmark: MS MARCO (98.1 %) + TREC‑COVID (1.9 %) with preserved relevance judgments.  - Queries: DL‑2019 only.  - Settings: Homogeneous (MS MARCO) vs Heterogeneous (merged).  - Retrieval stages: first‑stage (MDA: RetroMAE, SPLADE; MDD: BM25, CDE), PRF (lexical RM3, VectorPRF), re‑ranking (MDA: monoELECTRA; MDD: Set‑Encoder).  - Metrics: nDCG@10, Recall@100, Precision@100, CP@10, ΔM relative change.
- **Takeaway**: MDA retrievers consistently outperform MDD models under collection growth, showing higher CP and smaller ΔnDCG.  Current PRF techniques often worsen performance and CP, especially on the smaller TREC‑COVID collection.  Re‑ranking mitigates noise, yielding comparable effectiveness across families.  No model satisfies the CG Axiom for TREC‑COVID, highlighting the challenge of robustness when a dominant collection is present.  CP provides a lightweight, interpretable diagnostic, and future work should focus on PRF methods that preserve robustness.
...
### 3. Which Histories Matter for Time Series Forecasting? Learning Predictive Relevance with Future Supervision

- **LLM Score**: 0
- **Keyword Score**: 18
- **Authors**: Yong-Hoon Choi, Youngjin Cho
- **URL**: <http://arxiv.org/abs/2608.23221v1>
- **Submitted**: 2026-08-24 13:15:29
- **Topic Keywords**: retriever, query, rerank, listwise, relevance, retrieval, rank
- **Reason**: LLM scoring failed.
...
### 4. FashionKG-RAG: Knowledge Graph-Enhanced Retrieval-Augmented Generation for Fashion Question Answering

- **LLM Score**: 0
- **Keyword Score**: 17
- **Authors**: Yujuan Ding, Linyin Luo, Shijie Wang, Xu Yuan, Yunshan Ma, Yi Bin, Wenqi Fan, Qing Li
- **URL**: <http://arxiv.org/abs/2608.22688v1>
- **Submitted**: 2026-08-24 01:01:06
...
### 6. Cascading Relevance-driven Recommendation Network for CTR Prediction in Trigger-Introduced Recommendation

- **LLM Score**: 0
- **Keyword Score**: 15
- **Authors**: Kaixuan Chen, Wenwen Wang, Xing Fang, Yang Huang, Jing Wang
- **URL**: <http://arxiv.org/abs/2608.22973v1>
- **Submitted**: 2026-08-24 08:33:14
- **Topic Keywords**: pairwise, relevance, click, ctr, recommend, shopping, commerce, e-commerce, search
- **Reason**: LLM scoring failed.
...
- **Submitted**: 2026-08-24 06:59:34
- **Comment**: Accepted to EMNLP 2026 (Main Conference)
- **Topic Keywords**: dense retrieval, query, queries, rag, retrieval, acl
- **Reason**: LLM scoring failed.
...
- **URL**: <http://arxiv.org/abs/2608.22859v1>
- **Submitted**: 2026-08-24 06:41:23
- **Comment**: Pre-print
...
### 9. The Emergence of Relevance Through Axiomatic Attention Patterns During LoRA Fine-Tuning

- **LLM Score**: 0
- **Keyword Score**: 13
- **Authors**: Matthew Perlman, Atharva Nijasure, James Allan
- **URL**: <http://arxiv.org/abs/2608.23338v1>
- **Submitted**: 2026-08-24 14:48:31
...
### 10. Hypergraph Embedding Indexing for Efficient Dense Vector Retrieval

- **LLM Score**: 0
- **Keyword Score**: 12
- **Authors**: Kishore Konda
- **URL**: <http://arxiv.org/abs/2608.22980v1>
- **Submitted**: 2026-08-24 08:40:17
...
### 11. GRAFT: Graph-Distilled Generative Retrieval for Facet-Aware Scientific Literature Exploration

- **LLM Score**: 0
- **Keyword Score**: 12
- **Authors**: Italo Luis da Silva, Hanqi Yan, Yujing Wang, Jiangnan Ye, Lin Gui, Yulan He
- **URL**: <http://arxiv.org/abs/2608.22381v1>
- **Submitted**: 2026-08-23 12:07:00
- **Topic Keywords**: retriever, query, rag, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
- **URL**: <http://arxiv.org/abs/2608.22022v1>
- **Submitted**: 2026-08-22 15:56:14
- **Topic Keywords**: ranking, user behavior, click model, click, recommend, rank, search
- **Reason**: LLM scoring failed.
...
### 13. Training-Free Pseudo-Fusion for Composed Image Retrieval with Diffusion Models and Multimodal Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 11
- **Authors**: Fan Xu, Luis A. Leiva
- **URL**: <http://arxiv.org/abs/2608.23102v1>
- **Submitted**: 2026-08-24 11:08:28
...
### 14. GeoRisk-RAG: A Hierarchy-Aware Risk Framework for Improving RAG Reliability through Selective Answering

- **LLM Score**: 0
- **Keyword Score**: 11
- **Authors**: Meenu Ravi, Shailik Sarkar, Lulwah AlKulaib, Yordanos Tessema, Chang-Tien Lu
- **URL**: <http://arxiv.org/abs/2608.22634v1>
- **Submitted**: 2026-08-23 22:39:21
...
### 15. Enrich-Retrieve-Rank: Scaling Capability Discovery Beyond In-Context Routing

- **LLM Score**: 0
- **Keyword Score**: 10
- **Authors**: Nazib Sorathiya, Daniel Zhang, Bardiya Akhbari
- **URL**: <http://arxiv.org/abs/2608.22695v1>
- **Submitted**: 2026-08-24 01:21:05
- **Comment**: 11 pages, 4 figures, and 12 tables
- **Topic Keywords**: retriever, rerank, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
### 16. Rank Reversal in Multilingual LLM Judges: A Label-Free Double-Centering Calibrator

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Alhasan Mahmood, Samir Abdaljalil, Hasan Kurban
- **URL**: <http://arxiv.org/abs/2608.22432v1>
- **Submitted**: 2026-08-23 14:18:25
- **Topic Keywords**: ranking, pairwise, rank, acl
- **Reason**: LLM scoring failed.
...
### 17. SARCLIP: A Scalable CLIP-Based Retrieval System for Seventeenth-Century Spanish American Notary Records

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Chandrasekhar Syamala, Parshad Suthar, Hulayyil Alshammari, Viviana Grieco, Praveen Rao
- **URL**: <http://arxiv.org/abs/2608.22036v1>
- **Submitted**: 2026-08-22 16:45:55
- **Comment**: 4 pages, 2 figures. To appear
- **Topic Keywords**: relevance, relevance feedback, retrieval, search
- **Reason**: LLM scoring failed.
...
### 19. Future Querying: Can LLMs Serve as Implicit Medical World Models?
...
### 20. What Proves You Wrong: Benchmarking Language Models on Falsifiable Research Ideation
...
### 21. The Compaction Cliff in Long-Running AI Agent Memory

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Saber Zerhoudi, Jelena Mitrovic, Michael Granitzer
- **URL**: <http://arxiv.org/abs/2608.22752v1>
- **Submitted**: 2026-08-24 03:21:56
- **Topic Keywords**: retriever, relevance, rag
- **Reason**: LLM scoring failed.
...
### 22. GTA-RAG: Graph-Trajectory-Augmented Reinforcement Learning for Multi-Turn Retrieval-Augmented Reasoning
...
### 23. W-RAG: Source-Aware Retrieval for Enterprise Document Generation from Heterogeneous Knowledge Bases

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Hridya Dhulipala, Rajesh Ombase, Michael Wang, Tien N. Nguyen
- **URL**: <http://arxiv.org/abs/2608.22081v1>
- **Submitted**: 2026-08-22 19:01:59
- **Comment**: 18 pages
...
### 24. EvoWiki: Incremental State Overwriting and Traceable Question Answering for Cross-Meeting Knowledge Evolution

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Dongsheng Chen, Tianyu Wang, Wenhui Que
- **URL**: <http://arxiv.org/abs/2608.23265v1>
- **Submitted**: 2026-08-24 13:52:17
...
### 25. Signal or Noise? A Benchmark Study of Agent Skills in Web Development

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Ziyue Yang, Fan Ding
- **URL**: <http://arxiv.org/abs/2608.23067v1>
- **Submitted**: 2026-08-24 10:13:07
...
### 26. Your AI, On a Dial: Controlling Investment Bias in LLMs with a Single Neuron
...
### 27. FCPRAG: Fusion-Controller Parametric Retrieval-Augmented Generation for Stable Multi-Passage LoRA Injection

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Jinchang Zhu, Jindong Li, Yi Ding, Xiaojian Nie, Rong Fu, Shuangyong Song, Haowei He, Menglin Yang
- **URL**: <http://arxiv.org/abs/2608.21750v1>
- **Submitted**: 2026-08-22 03:13:50
...
### 28. Beyond the Stability-Exploration Dilemma: Environmental Regularization for LLM Policy Optimization
...
### 29. Language Chain in Alignment: Cross-Lingual Ranking Preference Optimization

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Seungyoon Lee, Minhyuk Kim, Jungseob Lee, Heuiseok Lim
- **URL**: <http://arxiv.org/abs/2608.23149v1>
- **Submitted**: 2026-08-24 11:54:36
...
### 30. Proxy reliance in large language model decisions is uncalibrated to predictive evidence

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Zengqing Wu, Chuan Xiao
- **URL**: <http://arxiv.org/abs/2608.22887v1>
- **Submitted**: 2026-08-24 07:20:29
- **Topic Keywords**: ranking, rag, rank
- **Reason**: LLM scoring failed.
...
### 31. SPOC-SQL: Stage-wise Preference Optimization for Controllable Text-to-SQL

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Yingnan Chen, Chun Ding, Tianshi Xu, Xu Yang, Si Wu
- **URL**: <http://arxiv.org/abs/2608.22772v1>
- **Submitted**: 2026-08-24 03:48:05
- **Topic Keywords**: query, queries
- **Reason**: LLM scoring failed.
...
### 32. WnW: Waxing-and-Waning KV Cache for Long-Form Speech LLMs
...
### 33. Clarify User Expertise: Towards Proactive Conversational Agents Tailoring Responses to User Proficiency

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Zhihong Cao, Chen Huang
- **URL**: <http://arxiv.org/abs/2608.22266v1>
- **Submitted**: 2026-08-23 07:54:31
...
### 34. Revisiting N2DCG: An Empirically Grounded Reformulation of Carousel Recommendation Evaluation

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Jingwei Kang, Santiago de Leon-Martinez, Maarten de Rijke, Harrie Oosterhuis
- **URL**: <http://arxiv.org/abs/2608.21877v1>
- **Submitted**: 2026-08-22 09:40:10
...
### 35. Convergence in Science, Divergence in Religion: Calibrated Framing Differences Across Wikipedia's Language Editions

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Hung-Hsuan Chen
- **URL**: <http://arxiv.org/abs/2608.21821v1>
- **Submitted**: 2026-08-22 07:42:11
- **Topic Keywords**: ranking, rag, rank
- **Reason**: LLM scoring failed.
...
### 36. More Computational Resources Do Not Ensure Higher Scholarly Impact: Evidence from Leading NLP Conference Papers

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Shuai Chen, Tong Bao, Jitong Peng, Chengzhi Zhang
- **URL**: <http://arxiv.org/abs/2608.21806v1>
- **Submitted**: 2026-08-22 07:00:31
- **Comment**: EMNLP 2026, Main
- **Topic Keywords**: search, acl, naacl, emnlp
- **Reason**: LLM scoring failed.
...
### 37. Lexical Coupling in GUI Element Grounding: Sentence Embeddings Track Labels across Mobile and Web

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Qijia Chen, Giulio Jacucci
- **URL**: <http://arxiv.org/abs/2608.21794v1>
- **Submitted**: 2026-08-22 06:30:03
...
### 39. Expectations and Practices around AI Disclosure in CS Research

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Arati Mohapatra, Danish Pruthi
- **URL**: <http://arxiv.org/abs/2608.23271v1>
- **Submitted**: 2026-08-24 13:58:16
- **Comment**: Accepted to EMNLP 2026 (Findings)
- **Topic Keywords**: recommend, search, iclr, emnlp
- **Reason**: LLM scoring failed.
...
### 40. Beyond Surface Cues: Disentangling Sociocultural Signals in Multilingual LLMs

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Yuanjun Feng, Tanzhou Liu, Stefan Feuerriegel, Yash Raj Shrestha
- **URL**: <http://arxiv.org/abs/2608.23026v1>
- **Submitted**: 2026-08-24 09:32:16
...
### 41. Industrial-Instruction: An End-to-End Framework for Building Instruction-Tuning and Benchmark Datasets from Industrial Technical Reports
...
### 42. DelistBench: Evaluating Search-Enabled LLMs for Auditable Corporate-Event Database Completion

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Xuan Yao, Li Shuping, Dai Yang, Zhou Yi, Ke-Wei Huang
- **URL**: <http://arxiv.org/abs/2608.22770v1>
- **Submitted**: 2026-08-24 03:46:20
...
### 43. Beyond Factual Knowledge: Benchmarking and Learning Step-Level Procedural Rule Reasoning in Large Language Models
...
### 44. Teaching LLMs How ICU Physicians Approach Clinical Reasoning Through OMOP-Aligned Retrieval Improves Reasoning Across Clinical Domains
...
### 45. Improving Few-Step Language Flows with Untied Self-Conditioning

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Bocheng Li, Linli Xu
- **URL**: <http://arxiv.org/abs/2608.22244v1>
- **Submitted**: 2026-08-23 06:46:17
...
### 46. VERDICT: Agreement Beats Pixel-Space Verification in Real-Document OCSR
...
### 47. TANGO: Token-Aggregated Nonlinear Gating Operators for Natural and Formal Language Modeling

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Joshua Nunley
- **URL**: <http://arxiv.org/abs/2608.22117v1>
- **Submitted**: 2026-08-22 22:04:39
...
### 48. MCite-RL: Towards Reliable Multimodal RAG via Citation-enhanced Agentic Reinforcement Learning

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Suifeng Zhao, Zida Liu, Xinyu Lei, Lei Sun, Jun Gao, Sujian Li
- **URL**: <http://arxiv.org/abs/2608.21808v1>
- **Submitted**: 2026-08-22 07:04:18
- **Topic Keywords**: rag, retrieval, search
- **Reason**: LLM scoring failed.
...
### 49. HIRA: A Human-in-the-Loop Retrieval-Augmented Cascade for Document Classification in Regulated Industries

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Shangxuan Tian, Yanhui Chen, Carlos Queiroz
- **URL**: <http://arxiv.org/abs/2608.21792v1>
- **Submitted**: 2026-08-22 06:19:19
- **Comment**: CIKM 2026
...
### 50. Learning to Look Again: Loss-Gap Supervision for Free-form Crop Routing in Vision-Language Models

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Jinchang Zhu, Rong Fu, Yi Ding, Chenghao Wu, Ying Liu, Menglin Yang
- **URL**: <http://arxiv.org/abs/2608.21762v1>
- **Submitted**: 2026-08-22 04:10:28
- **Topic Keywords**: query, rag
- **Reason**: LLM scoring failed.
