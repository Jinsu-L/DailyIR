# Daily Papers Report - 2026-01-11

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. Revisiting Human-vs-LLM judgments using the TREC Podcast Track

- **LLM Score**: 8
- **Keyword Score**: 18
- **Authors**: Watheq Mansour, J. Shane Culpepper, Joel Mackenzie, Andrew Yates
- **URL**: <http://arxiv.org/abs/2601.05603v1>
- **Submitted**: 2026-01-09 07:45:18
- **Comment**: The paper has been accepted to appear at ECIR 2026
- **Topic Keywords**: information retrieval, query, ranking, relevance, retrieval, rank, search, trec
- **Reason**: This paper is highly relevant to the field of Information Retrieval, specifically focusing on the use of large language models for relevance annotation. The study's exploration of user agreement between LLMs and human experts aligns with the user's interest in query understanding and ranking models. While the paper's focus on the TREC Podcast Track is somewhat specific, the broader implications for IR and NLP make it a useful read.
...
### 2. LEAPS: An LLM-Empowered Adaptive Plugin for Taobao AI Search

- **LLM Score**: 8
- **Keyword Score**: 16
- **Authors**: Lei Wang, Jinhang Wu, Zhibin Wang, Biye Li, Haiping Hou
- **URL**: <http://arxiv.org/abs/2601.05513v1>
- **Submitted**: 2026-01-09 03:41:27
- **Topic Keywords**: query, queries, relevance, rag, retrieval, commerce, e-commerce, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed LEAPS system, which utilizes a 'Broaden-and-Refine' paradigm, is a novel approach to adapting traditional search systems to conversational interactions, aligning with your focus on deep semantic understanding and real-time relevance optimization.
...
### 3. Autoregressive Ranking: Bridging the Gap Between Dual and Cross Encoders
...
- **Submitted**: 2026-01-09 07:16:28
- **Comment**: 22 pages, 5 figures
- **Topic Keywords**: information retrieval, ranking, pointwise, rag, retrieval, rank, search
- **Reason**: This paper explores novel approaches to ranking models, specifically leveraging Large Language Models (LLMs) for information retrieval. The focus on ranking expressivity and the introduction of a new loss function (SToICaL) aligns with your interests in query understanding and ranking models. The paper's emphasis on real-time relevance optimization also resonates with your research goals.
...
### 4. Statistical Foundations of DIME: Risk Estimation for Practical Index Selection

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Giulio D'Erasmo, Cesare Campagnano, Antonio Mallia, Pierpaolo Brutti, Nicola Tonellotto, Fabrizio Silvestri
- **URL**: <http://arxiv.org/abs/2601.05649v1>
- **Submitted**: 2026-01-09 09:11:05
- **Comment**: Accepted to EACL 2026 (Main Conference)
- **Topic Keywords**: information retrieval, query, rag, retrieval, search
- **Reason**: This paper is highly relevant to Information Retrieval, specifically addressing dimensionality reduction in high-dimensional dense embeddings. The focus on query-dependent scores and optimal dimension selection aligns with your interests in query understanding and ranking models. However, the paper's emphasis on statistical foundations and practical index selection may not directly relate to your core research themes in user behavior modeling and deep semantic understanding.
...
- **Submitted**: 2026-01-09 18:57:53
- **Topic Keywords**: rag, search
- **Reason**: This paper aligns well with your research interests in Information Retrieval, particularly in query understanding and ranking models. The use of reinforcement learning and citation-aware rewards for deep search agents is relevant to your focus on real-time relevance optimization and deep semantic understanding.
...
### 6. RECOR: Reasoning-focused Multi-turn Conversational Retrieval Benchmark
...
- **Submitted**: 2026-01-09 01:25:46
- **Topic Keywords**: information retrieval, queries, retrieval
- **Reason**: This paper presents a benchmark for conversational information retrieval, focusing on reasoning-intensive queries. While it touches on aspects of query understanding and ranking models, its primary focus is on conversational retrieval and reasoning, which aligns somewhat with your interests in Information Retrieval and NLP. However, the specific domain of conversational retrieval and the emphasis on reasoning may not be a central match for your research themes.
...
### 7. Efficient Temporal-aware Matryoshka Adaptation for Temporal Information Retrieval
...
- **Submitted**: 2026-01-09 06:01:01
- **Comment**: 18 pages
- **Topic Keywords**: information retrieval, retriever, rag, retrieval
- **Reason**: The paper focuses on Temporal Information Retrieval, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the specific domain of Temporal Information Retrieval and the use of Matryoshka embeddings are not directly aligned with the user's core research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 8. A Framework for Personalized Persuasiveness Prediction via Context-Aware User Profiling

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Sejun Park, Yoonah Park, Jongwon Lim, Yohan Jo
- **URL**: <http://arxiv.org/abs/2601.05654v1>
- **Submitted**: 2026-01-09 09:22:31
- **Topic Keywords**: query, queries, rag, recommend
- **Reason**: The paper explores personalized persuasiveness prediction, which is somewhat related to information retrieval, particularly in the context of recommender systems. However, the focus on persuasiveness prediction and user profiling is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's emphasis on context-aware user profiling and its application to persuasiveness prediction is an interesting area, but it does not strongly overlap with the user's primary research interests.
...
### 9. The Persona Paradox: Medical Personas as Behavioral Priors in Clinical Language Models
...
- **Submitted**: 2026-01-08 21:01:11
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper explores the concept of 'personas' in clinical language models, which is somewhat related to user behavior modeling in search technologies. However, the focus on clinical decision-making and language models is not directly aligned with the user's primary research interests in information retrieval and search technologies.
...
### 10. FACTUM: Mechanistic Detection of Citation Hallucination in Long-Form RAG
...
- **Submitted**: 2026-01-09 15:41:08
- **Comment**: Accepted at ECIR 2026. 18 pages, 2 figures
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is somewhat related to your interests in Natural Language Processing (NLP) and related topics, particularly in the context of Retrieval-Augmented Generation (RAG) models. However, it focuses on a specific issue of citation hallucination, which is not directly related to your core research themes of query understanding, ranking models, and user behavior modeling. The paper's findings on the complex interplay between internal mechanisms in RAG models may have some indirect implications for your work, but it is not a central match.
...
### 11. WildSci: Advancing Scientific Reasoning from In-the-Wild Literature

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Tengxiao Liu, Deepak Nathani, Zekun Li, Kevin Yang, William Yang Wang
- **URL**: <http://arxiv.org/abs/2601.05567v1>
- **Submitted**: 2026-01-09 06:35:23
- **Topic Keywords**: rag, search
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, particularly in the context of query understanding and deep semantic understanding. However, its focus on scientific reasoning and large language models in scientific domains is not a central match to your core research themes. The paper's emphasis on dataset creation and reinforcement learning may be of interest, but it does not directly address your primary areas of focus.
...
### 12. The Facade of Truth: Uncovering and Mitigating LLM Susceptibility to Deceptive Evidence

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Herun Wan, Jiaying Wu, Minnan Luo, Fanxiao Li, Zhi Zeng, Min-Yen Kan
- **URL**: <http://arxiv.org/abs/2601.05478v1>
- **Submitted**: 2026-01-09 02:28:00
- **Topic Keywords**: rag, recommend
- **Reason**: This paper explores the vulnerability of Large Language Models (LLMs) to deceptive evidence, which is somewhat related to my research interests in Information Retrieval and Natural Language Processing. However, the focus on LLMs and their susceptibility to misinformation is not directly aligned with my primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance to recommender systems is also a secondary connection.
...
### 13. AdaFuse: Adaptive Ensemble Decoding with Test-Time Scaling for LLMs
...
- **Submitted**: 2026-01-09 18:58:22
- **Topic Keywords**: rag
- **Reason**: The paper discusses an adaptive ensemble decoding framework for Large Language Models (LLMs), which is related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and decoding behaviors is somewhat tangential to the user's primary interests in IR and Search technologies, and the paper does not explicitly address user behavior modeling or click models.
...
### 14. Don't Break the Cache: An Evaluation of Prompt Caching for Long-Horizon Agentic Tasks
...
- **Submitted**: 2026-01-09 18:41:57
- **Comment**: 15 pages, 8 figures
- **Topic Keywords**: web search, search
- **Reason**: The paper explores prompt caching for Large Language Model (LLM) agents, which is related to information retrieval and search technologies. However, the focus is on LLMs and agentic tasks, which is somewhat tangential to the user's core research themes in IR and search technologies. The paper's relevance is somewhat enhanced by its evaluation on a multi-turn agentic benchmark involving web search tool calls, but it does not directly address query understanding, ranking models, or user behavior modeling.
...
### 16. MemBuilder: Reinforcing LLMs for Long-Term Memory Construction via Attributed Dense Rewards

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Zhiyu Shen, Ziming Wu, Fuming Lai, Shaobing Lian, Yanghui Rao
- **URL**: <http://arxiv.org/abs/2601.05488v1>
- **Submitted**: 2026-01-09 02:44:37
- **Comment**: 19 pages (9 main + 10 appendix), 7 figures, 3 tables
- **Topic Keywords**: retrieval
- **Reason**: This paper introduces a reinforcement learning framework for long-term memory construction in LLMs, which is somewhat related to information retrieval and search technologies, but more specifically focused on NLP and dialogue systems. While it involves training models and rewards, it doesn't directly address query understanding, ranking models, or user behavior modeling. The paper's focus on long-term memory construction and dialogue systems makes it loosely relevant to the user's research interests.
...
### 17. HAPS: Hierarchical LLM Routing with Joint Architecture and Parameter Search

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Zihang Tian, Rui Li, Jingsen Zhang, Xiaohe Bo, Wei Huo, Xu Chen
- **URL**: <http://arxiv.org/abs/2601.05903v1>
- **Submitted**: 2026-01-09 16:22:25
- **Topic Keywords**: search
- **Reason**: This paper focuses on Large Language Model (LLM) routing, which is related to Information Retrieval, but its primary focus on LLMs and parameter search does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling. While it involves a hierarchical routing framework, the paper's emphasis on LLMs and their parameters is not a central match for the user's interests in IR and Search technologies.
...
### 18. Visualising Information Flow in Word Embeddings with Diffusion Tensor Imaging

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Thomas Fabian
- **URL**: <http://arxiv.org/abs/2601.05713v1>
- **Submitted**: 2026-01-09 10:58:17
- **Topic Keywords**: search
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on visualizing information flow in word embeddings, which is a specific aspect of NLP. While it touches on the interpretability of NLP models, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 19. RISE: Rule-Driven SQL Dialect Translation via Query Reduction
...
- **Submitted**: 2026-01-09 07:00:44
- **Comment**: Accepted by ICSE 2026
- **Topic Keywords**: query, queries, rag
- **Reason**: This paper focuses on SQL dialect translation, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves a novel approach using large language models, the context and application domain are quite different from the user's interests.
...
### 20. MaxCode: A Max-Reward Reinforcement Learning Framework for Automated Code Optimization
...
- **Submitted**: 2026-01-09 02:21:28
- **Topic Keywords**: ranking, rerank, rank, search
- **Reason**: This paper focuses on code optimization using reinforcement learning and large language models, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 21. MMViR: A Multi-Modal and Multi-Granularity Representation for Long-range Video Understanding

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Zizhong Li, Haopeng Zhang, Jiawei Zhang
- **URL**: <http://arxiv.org/abs/2601.05495v1>
- **Submitted**: 2026-01-09 02:59:05
- **Comment**: 13 pages, 11 figures
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves multi-modal and multi-granularity representations, its focus on video understanding and long-range dependencies is not aligned with your core research themes.
...
### 22. RingSQL: Generating Synthetic Data with Schema-Independent Templates for Text-to-SQL Reasoning Models

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Marko Sterbentz, Kevin Cushing, Cameron Barrie, Kristian J. Hammond
- **URL**: <http://arxiv.org/abs/2601.05451v1>
- **Submitted**: 2026-01-09 00:46:53
- **Topic Keywords**: query, rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are the core areas of your research interests. While it touches on Natural Language Processing (NLP) through text-to-SQL systems, the focus is on data generation for training models rather than query understanding, ranking models, or deep semantic understanding.
...
### 23. Multi-task Cross-modal Learning for Chest X-ray Image Retrieval

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Zhaohui Liang, Sivaramakrishnan Rajaraman, Niccolo Marini, Zhiyun Xue, Sameer Antani
- **URL**: <http://arxiv.org/abs/2601.05399v1>
- **Submitted**: 2026-01-08 21:44:00
- **Topic Keywords**: queries, retrieval
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multi-modal learning and retrieval, the focus is on medical imaging and radiology reports, which is not a primary area of interest for you.
...
### 24. Semantic NLP Pipelines for Interoperable Patient Digital Twins from Unstructured EHRs

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Rafael Brens, Yuqiao Meng, Luoxi Tang, Zhaohan Xi
- **URL**: <http://arxiv.org/abs/2601.05847v1>
- **Submitted**: 2026-01-09 15:20:11
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on Natural Language Processing (NLP) for healthcare, specifically extracting clinical concepts from unstructured EHRs. While it involves information retrieval and semantic understanding, it is primarily centered on NLP and healthcare, which is not a core area of interest for you. The paper's relevance to your research on query understanding, ranking models, and user behavior modeling is limited.
...
### 25. Open World Knowledge Aided Single-Cell Foundation Model with Robust Cross-Modal Cell-Language Pre-training
...
- **Submitted**: 2026-01-09 09:10:14
- **Comment**: 41 pages
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on single-cell biology, multi-omics, and language models in a specific domain (cellular heterogeneity and gene regulation) does not align with your core research themes.
...
### 26. The Table of Media Bias Elements: A sentence-level taxonomy of media bias types and propaganda techniques

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Tim Menzner, Jochen L. Leidner
- **URL**: <http://arxiv.org/abs/2601.05358v1>
- **Submitted**: 2026-01-08 20:18:55
- **Topic Keywords**: rag, ctr
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are core areas of your research interests. While it touches on Natural Language Processing (NLP), its focus on media bias and propaganda techniques is not aligned with your primary research themes.
...
- **Submitted**: 2026-01-09 16:44:17
- **Comment**: Work in progress
- **Topic Keywords**: pairwise
- **Reason**: This paper appears to be unrelated to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. The focus on machine learning agents, predictive reasoning, and data-centric solution preference does not align with your interests in query understanding, ranking models, and user behavior modeling.
...
### 28. Analysing Differences in Persuasive Language in LLM-Generated Text: Uncovering Stereotypical Gender Patterns
...
- **Submitted**: 2026-01-09 12:07:38
- **Topic Keywords**: pairwise
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on analyzing persuasive language in LLM-generated text and uncovering stereotypical gender patterns, which is a topic in social psychology and communication science.
...
### 29. PII-VisBench: Evaluating Personally Identifiable Information Safety in Vision Language Models Along a Continuum of Visibility

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: G M Shahariar, Zabir Al Nazi, Md Olid Hasan Bhuiyan, Zhouxing Shi
- **URL**: <http://arxiv.org/abs/2601.05739v1>
- **Submitted**: 2026-01-09 11:40:56
- **Topic Keywords**: queries
- **Reason**: This paper focuses on evaluating the safety of Vision Language Models in terms of personally identifiable information leakage, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of online presence, it does not explore query understanding, ranking models, or user behavior modeling, making it somewhat tangential to your research areas.
...
### 30. Hi-ZFO: Hierarchical Zeroth- and First-Order LLM Fine-Tuning via Importance-Guided Tensor Selection

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Feihu Jin, Ying Tan
- **URL**: <http://arxiv.org/abs/2601.05501v1>
- **Submitted**: 2026-01-09 03:20:54
- **Comment**: 13 pages, 4 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on large language model fine-tuning, proposing a hybrid framework to address challenges in zeroth-order optimization. While it touches on optimization techniques, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 31. Thinking with Map: Reinforced Parallel Map-Augmented Agent for Geolocalization
...
- **Submitted**: 2026-01-08 23:47:30
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves a vision-language model, the focus is on geolocalization and image processing, which is not a central match to your primary research themes.
...
### 32. CLewR: Curriculum Learning with Restarts for Machine Translation Preference Learning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Alexandra Dragomir, Florin Brad, Radu Tudor Ionescu
- **URL**: <http://arxiv.org/abs/2601.05858v1>
- **Submitted**: 2026-01-09 15:34:31
- **Topic Keywords**: rag
- **Reason**: This paper focuses on machine translation, which is not a primary area of interest for you. While it involves preference optimization, a related topic, the context is not information retrieval or search technologies, and the methods are not directly applicable to your areas of expertise.
...
### 33. Multimodal In-context Learning for ASR of Low-resource Languages

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhaolin Li, Jan Niehues
- **URL**: <http://arxiv.org/abs/2601.05707v1>
- **Submitted**: 2026-01-09 10:52:23
- **Comment**: Under review
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Automatic Speech Recognition (ASR) for low-resource languages using multimodal in-context learning, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 34. Multilingual Amnesia: On the Transferability of Unlearning in Multilingual LLMs
...
- **Submitted**: 2026-01-09 08:59:42
- **Topic Keywords**: search, korea
- **Reason**: This paper is primarily focused on multilingual large language models and their safety and fairness across diverse linguistic contexts, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of 'unlearning', it's more relevant to the NLP domain, but lacks direct connections to query understanding, ranking models, or user behavior modeling.
...
### 35. Continual Pretraining on Encrypted Synthetic Data for Privacy-Preserving LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Honghao Liu, Xuhui Jiang, Chengjin Xu, Cehao Yang, Yiran Cheng, Lionel Ni, Jian Guo
- **URL**: <http://arxiv.org/abs/2601.05635v1>
- **Submitted**: 2026-01-09 08:44:07
- **Topic Keywords**: rag
- **Reason**: This paper focuses on privacy-preserving pretraining of large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, the context is privacy preservation, which is not a central theme in your research.
...
### 36. GIFT: Games as Informal Training for Generalizable LLMs
...
- **Submitted**: 2026-01-09 08:42:44
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models and their training using games, which is not directly related to Information Retrieval or Search technologies. While it involves reinforcement learning, the context is not aligned with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 37. Text Detoxification in isiXhosa and Yorùbá: A Cross-Lingual Machine Learning Approach for Low-Resource African Languages

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Abayomi O. Agbeyangi
- **URL**: <http://arxiv.org/abs/2601.05624v1>
- **Submitted**: 2026-01-09 08:28:58
- **Comment**: 26 pages, 9 figures and 1 algorithm
- **Topic Keywords**: rag
- **Reason**: This paper focuses on text detoxification in low-resource African languages, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve machine learning and text analysis, the specific application and goals of the study are quite different from your areas of focus.
...
### 38. SceneAlign: Aligning Multimodal Reasoning to Scene Graphs in Complex Visual Scenes

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Chuhan Wang, Xintong Li, Jennifer Yuntong Zhang, Junda Wu, Chengkai Huang, Lina Yao, Julian McAuley, Jingbo Shang
- **URL**: <http://arxiv.org/abs/2601.05600v1>
- **Submitted**: 2026-01-09 07:40:39
- **Comment**: Preprint
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multimodal reasoning in visual scenes, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is visual scene understanding, which is not a core area of your research.
...
### 39. Double: Breaking the Acceleration Limit via Double Retrieval Speculative Parallelism

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yuhao Shen, Tianyu Liu, Junyi Shen, Jinyang Wu, Quan Kong, Li Huan, Cong Wang
- **URL**: <http://arxiv.org/abs/2601.05524v1>
- **Submitted**: 2026-01-09 04:35:21
- **Topic Keywords**: retrieval
- **Reason**: This paper is not relevant to your research interests as it focuses on accelerating decoding in natural language processing, which is not a primary area of interest for you. While it involves retrieval, it's more related to speculative decoding and parallelism rather than query understanding, ranking models, or user behavior modeling.
...
### 40. CHisAgent: A Multi-Agent Framework for Event Taxonomy Construction in Ancient Chinese Cultural Systems

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Xuemei Tang, Chengxi Yan, Jinghang Gu, Chu-Ren Huang
- **URL**: <http://arxiv.org/abs/2601.05520v1>
- **Submitted**: 2026-01-09 04:28:45
- **Comment**: 22 pages, 13 figures, 7 tables
- **Topic Keywords**: rag
- **Reason**: This paper focuses on historical and cultural taxonomy construction using large language models, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context and application are quite different from the user's areas of focus.
...
### 41. FlashMem: Distilling Intrinsic Latent Memory via Computation Reuse

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yubo Hou, Zhisheng Chen, Tao Wan, Zengchang Qin
- **URL**: <http://arxiv.org/abs/2601.05505v1>
- **Submitted**: 2026-01-09 03:27:43
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on improving the efficiency of Large Language Models by distilling intrinsic memory from transient reasoning states. While it touches on the concept of 'memory', it's more related to the internal workings of LLMs rather than information retrieval or search technologies. The paper's abstract doesn't indicate any direct connection to the user's research interests in IR, NLP, or data mining.
...
### 42. LLMs as Science Journalists: Supporting Early-stage Researchers in Communicating Their Science to the Public
...
- **Submitted**: 2026-01-09 14:51:20
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models, the focus is on science communication and public outreach, which is not a central match to your interests.
...
### 43. Weights to Code: Extracting Interpretable Algorithms from the Discrete Transformer

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yifan Zhang, Wei Bi, Kechi Zhang, Dongming Jin, Jie Fu, Zhi Jin
- **URL**: <http://arxiv.org/abs/2601.05770v1>
- **Submitted**: 2026-01-09 12:49:41
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on algorithm extraction and Transformer interpretability. While it involves deep learning architectures, the topic is more aligned with NLP and algorithmic tasks, which are secondary interests. The paper's focus on discrete symbolic logic and algorithm discovery is not a central match for the user's primary research themes.
...
### 44. Afri-MCQA: Multimodal Cultural Question Answering for African Languages
...
- **Submitted**: 2026-01-09 10:40:09
- **Topic Keywords**: search
- **Reason**: This paper focuses on Multimodal Cultural Question Answering for African languages, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific context and application are quite different from your areas of focus.
...
### 45. Do LLMs Need Inherent Reasoning Before Reinforcement Learning? A Study in Korean Self-Correction

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Hongjin Kim, Jaewook Lee, Kiyoung Lee, Jong-hun Shin, Soojong Lim, Oh-Woog Kwon
- **URL**: <http://arxiv.org/abs/2601.05459v1>
- **Submitted**: 2026-01-09 01:17:31
- **Comment**: IJCNLP-AACL 2025 (Main), Outstanding Paper Award
- **Topic Keywords**: korea
- **Reason**: This paper focuses on the application of Large Language Models (LLMs) in low-resource languages, specifically Korean, and explores the use of reinforcement learning to enhance reasoning abilities. While it touches on the concept of 'reasoning' which is related to query understanding in IR, the paper's primary focus is on NLP and LLMs, which is somewhat tangential to the user's core research themes in IR and Search technologies.
...
### 46. Same Claim, Different Judgment: Benchmarking Scenario-Induced Bias in Multilingual Financial Misinformation Detection
...
- **Submitted**: 2026-01-08 22:00:32
- **Comment**: Work in progress
- **Topic Keywords**: search
- **Reason**: This paper focuses on evaluating biases in large language models for financial misinformation detection, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it touches on NLP, the specific context and application (financial misinformation detection) are not aligned with your primary focus.
