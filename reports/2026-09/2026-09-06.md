# Daily Papers Report - 2026-09-06
...
- **Submitted**: 2026-09-04 13:06:26
- **Comment**: Accepted at the 35th ACM International Conference on Information and Knowledge Management (CIKM 2026)
- **Topic Keywords**: semantic search, dense retrieval, query, queries, ranking, retrieval, recommend, rank, search, trec
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Embedding Surgery for Dense Retrieval – a Unified, End‑to‑End View
- **Aim**: Provide a lightweight, query‑time post‑hoc optimisation that perturbs only the top‑k passage embeddings, eliminating the need for costly re‑encoding or re‑indexing in dense‑retrieval pipelines.
- **Rationale**: Dense‑retrieval engines pre‑compute static embeddings; any shift in intent or feedback forces expensive rebuilds. Embedding surgery applies tiny, convex‑optimised updates to the vectors that appear in the current top‑k list, leaving the global embedding manifold untouched and enabling rapid adaptation without re‑encoding.
- **Ground**: 1) Surgical strategies (symmetric, promotion, demotion) and their empirical trends; 2) Sources of supervision (editorial, click‑based counter‑factual models, LLM‑derived rerankings) and how they generate pairwise preferences; 3) Formal optimisation as a convex quadratic program with margin constraints; 4) Implementation details (in‑place index updates, CVXPY solver, negligible overhead, tested ANN structures).
- **Experiment**: Benchmarks across TREC DL ’19/20 Hard, TREC DL ’19/20, TREC Robust ’04, MS MARCO Dev using models DPR, Contriever, TAS‑B, E5, Snowflake. Metrics: nDCG@10. Results show symmetric surgery yields +60–75 % relative gains; click‑based feedback (perfect, noisy, near‑random) and LLM‑based rerankings (BGE, Qwen) all improve performance. Generalisation across models and datasets confirmed; combination with query‑side adaptation further boosts gains.
- **Takeaway**: Embedding surgery is a zero‑cost, query‑time post‑hoc optimisation applicable to any bi‑encoder dense‑retrieval pipeline. The symmetric variant delivers the strongest gains, works with diverse supervision signals, and achieves substantial relative improvements (up to +75 % on MS MARCO) while keeping runtime overhead minimal.
...
### 2. CAGE: Coherence-Aware Graph Encoding for Retrieval-Augmented Generation

- **LLM Score**: 0
- **Keyword Score**: 17
- **Authors**: Tong Qi, Jingyu Wu, Youbing Yin, Spencer Hong, Daben Liu, Erin Babinsky
- **URL**: <http://arxiv.org/abs/2609.04647v1>
- **Submitted**: 2026-09-04 02:27:34
...
### 3. BIT.UA at BioASQ 14B: Modular Retrieval with pg_textsearch and Qdrant, and Agent-Based Answer Generation
...
- **Submitted**: 2026-09-04 11:10:07
- **Comment**: 1 figure, 15 tables, 25 pages
- **Topic Keywords**: dense retrieval, query, rerank, rag, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
### 4. SAM-D2Q: Aligning Multimodal Doc2Query with Search Demand and Conversion for E-commerce

- **LLM Score**: 0
- **Keyword Score**: 13
- **Authors**: Hui Zhou, Jian Hui Ji, Lei Ma, Rong Xiao, Xiaoyi Zeng
- **URL**: <http://arxiv.org/abs/2609.04961v1>
- **Submitted**: 2026-09-04 10:09:04
- **Comment**: Accepted by CIKM2026 Oral Full Paper
- **Topic Keywords**: query, queries, rag, retrieval, commerce, e-commerce, search
- **Reason**: LLM scoring failed.
...
### 5. Self-Supervised Lexical Representation Learning for Fast, Large-Scale Phylogenetic Inference

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Tim Wientzek
- **URL**: <http://arxiv.org/abs/2609.05262v1>
- **Submitted**: 2026-09-04 15:23:12
...
### 6. Beyond Maintenance Manual Multimodal RAG: Suggesting What Tool

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Seongjun Ha, Md Rashedul Islam
- **URL**: <http://arxiv.org/abs/2609.05116v1>
- **Submitted**: 2026-09-04 13:09:16
...
### 7. Does the Selected Object Reach the Reader? Auditing Identity Handoffs in Grounded Language-Model Pipelines

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Siddharth Vohra, Runmin Jiang, Xiaomo Li, Min Xu
- **URL**: <http://arxiv.org/abs/2609.04579v1>
- **Submitted**: 2026-09-04 00:20:12
...
### 8. Repeated Queries Exhaust an LLM's Brand Recommendations but Not Its Sources

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Dmitrij Żatuchin
- **URL**: <http://arxiv.org/abs/2609.05059v1>
- **Submitted**: 2026-09-04 12:22:03
...
- **Topic Keywords**: queries, retrieval, recommend, web search, search
- **Reason**: LLM scoring failed.
...
### 9. Personalized Task Dependency Graphs for Mitigating Signal Erosion in Multi-Task Recommendation
...
- **URL**: <http://arxiv.org/abs/2609.04862v1>
- **Submitted**: 2026-09-04 08:23:12
- **Comment**: Accepted at CIKM 2026
- **Topic Keywords**: click, cvr, conversion rate, recommend, rank
- **Reason**: LLM scoring failed.
...
### 10. Inventory-Grounded Policy-Level Optimization for Training-Free AI Search

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Wei Zhou, Tiandeng Wu, Jiandong Ding, Zhufeng Fan, Yi Cao
- **URL**: <http://arxiv.org/abs/2609.04813v1>
- **Submitted**: 2026-09-04 07:10:41
- **Comment**: Accepted at the EMNLP 2026 Industry Track
- **Topic Keywords**: query, ctr, retrieval, search
- **Reason**: LLM scoring failed.
...
- **Submitted**: 2026-09-04 00:54:04
- **Comment**: EMNLP 2026
- **Topic Keywords**: queries, rag, retrieval, korea
- **Reason**: LLM scoring failed.
...
### 12. Compression Beyond the Uncompressed: A Two-Stage Training Recipe for Soft Context Compression in RAG

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Shuyu Guo, Shuo Zhang, Zhaochun Ren
- **URL**: <http://arxiv.org/abs/2609.05152v1>
- **Submitted**: 2026-09-04 13:53:43
...
### 13. NS-ST-GraphRAG: Neuro-Symbolic Spatio-Temporal GraphRAG for Literary Knowledge Processing

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Zheng Kui Lin
- **URL**: <http://arxiv.org/abs/2609.05139v1>
- **Submitted**: 2026-09-04 13:39:07
...
### 17. MURAL: Multimodal Uncertainty-aware Recommendation via Adaptive edge Learning

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Ahmad Mousavi, Majid Alikhani, Yeon-Chang Lee, Roberto Corizzo, Yeganeh Abdollahinejad
- **URL**: <http://arxiv.org/abs/2609.04574v1>
- **Submitted**: 2026-09-04 00:06:53
...
### 19. Does Your Agent's Memory Survive a Model Upgrade? A Controlled Study of Memory Portability

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ankit Goyal, Jaideep Ray
- **URL**: <http://arxiv.org/abs/2609.05339v1>
- **Submitted**: 2026-09-04 16:44:17
...
### 21. A Tree-based RAG Framework for Evidence-Intensive QA via Adaptive Planning and Topology-Aware Evidence Gathering

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Songeun Lee, Kyungjin Min, Injae Na, Suyeong Lee, Chiyoung Kim, Woohwan Jung
- **URL**: <http://arxiv.org/abs/2609.04981v1>
- **Submitted**: 2026-09-04 10:34:14
...
### 22. When Do Internal Probes Beat Reading the Answer? Miscalibrated Readouts and Behavior-Concealed Knowledge in Language Models

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Gnaneswar Villuri, Hashmath Shaik, Alex Doboli
- **URL**: <http://arxiv.org/abs/2609.04582v1>
- **Submitted**: 2026-09-04 00:26:45
...
### 23. LentEx: Generalizable Latent Entity Extraction via Synthetic Data and Instruction-Tuned LLMs
...
### 24. Uncertainty Signals for Network Intent Translation: Risk Ranking and Ambiguity Localization

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ala' A. Alsamarneh, Omar Alhussein
- **URL**: <http://arxiv.org/abs/2609.04486v1>
- **Submitted**: 2026-09-03 21:12:23
- **Topic Keywords**: ranking, rank
- **Reason**: LLM scoring failed.
...
### 27. Large Language Models for HVAC Operations in Building Energy Systems: A Critical Review of Methods, Applications, and Deployment Readiness
...
### 28. Beyond Co-purchase Relation: Evolution of Complementary Recommendations at Allegro
...
### 30. Refuse without Refusal: A Structural Analysis of Safety-Tuning Responses for Reducing False Refusals in Language Models

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Minji Kim, Hyounghun Kim
- **URL**: <http://arxiv.org/abs/2609.04714v1>
- **Submitted**: 2026-09-04 04:37:10
...
### 31. Rhythms of Work: Multi-Scale Interpretation of Human Behavioral Traces for Workplace Agents

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Lin Ai, Scott Counts
- **URL**: <http://arxiv.org/abs/2609.04556v1>
- **Submitted**: 2026-09-03 23:22:27
...
### 32. Evaluation of Phonetic Encoding Algorithms on Transcription Datasets

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Can Özbey, Emre Kaplan, Berkin Deniz Kahya
- **URL**: <http://arxiv.org/abs/2609.04391v1>
- **Submitted**: 2026-09-03 18:57:32
...
### 33. Knowing When Not to Answer: Pseudo-Ensembles for Abstention in Music Audio-Language Models

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Aanya Maheshwari, Vatsal Raina
- **URL**: <http://arxiv.org/abs/2609.04362v1>
- **Submitted**: 2026-09-03 18:21:25
...
### 34. Same Trajectory, Contradictory Rewards (ROBORMBENCH): Paraphrase Fragility in Vision Language Reward Models
...
### 35. Can Large Language Models Anticipate Behavioral Responses to Social Policies? A Case of Pension Enrollment Prediction among China's Flexible Workers

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yumiao Li, Peixin Liu, Donglin Di, Chen Li, Runhuan Feng
- **URL**: <http://arxiv.org/abs/2609.05189v1>
- **Submitted**: 2026-09-04 14:24:27
...
### 36. Large Language Models with At Most One Spike per Neuron

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Zhuoya Zhao, Parsa Omidi, Aref Jafari, Richard Naud
- **URL**: <http://arxiv.org/abs/2609.05151v1>
- **Submitted**: 2026-09-04 13:53:28
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 37. From Vision to Language: Investigating Causal Information Flow in Multimodal Decision-Making

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Davide Testa, Hugh Mee Wong, Alessandro Lenci, Bernardo Magnini, Albert Gatt
- **URL**: <http://arxiv.org/abs/2609.05149v1>
- **Submitted**: 2026-09-04 13:52:27
...
### 38. Leveraging Low-Level Symbolic Competences for Unsupervised Grounding in Hallucination Detection
...
### 39. RefactorPlatform: An Open-Source Harness for Controlled Evaluation of Repository-Scale Refactoring Agents

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Aziz Ben Amor, Drish Mali, Mann Acharya, Vijayasri Iyer, Sébastien Bratières
- **URL**: <http://arxiv.org/abs/2609.04898v1>
- **Submitted**: 2026-09-04 08:58:10
...
### 40. Cache-Aware Joint Router Adaptation for Memory-Efficient MoE Inference
...
### 41. Vectorizing Classical Tamil: Representation Learning for Verse-Commentary Pairs

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Amrit Gopinath, Sangeetha Sivanesan
- **URL**: <http://arxiv.org/abs/2609.04755v1>
- **Submitted**: 2026-09-04 05:38:31
...
### 42. VizIt: A multi-view framework for exploring single-cell, spatial, and genetic data online
...
### 43. ConsensusBench: Benchmark of Consensus Nodes for LLM Reasoning via Outcome Reward Densifying

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Shi-Qi Yan, Chao-Hong Tan, Qian Chen, Wen Wang, Xiangang Li, Zhen-Hua Ling
- **URL**: <http://arxiv.org/abs/2609.04648v1>
- **Submitted**: 2026-09-04 02:29:10
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 44. Scale-QLoRA: Code-Invariant Adapter Merging for Native 4-bit Microscaling LLMs

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Tung-Ling Li, Jiale Huang, Lee-Chi Wang, Janaki Ram Gotei
- **URL**: <http://arxiv.org/abs/2609.04526v1>
- **Submitted**: 2026-09-03 22:29:37
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 46. When Load-Balancing Goes Too Far: Expert Pruning in Over-Dispersed Mixture-of-Experts Models
...
### 47. TRILOGUE: A Trilingual Spoken Dialogue Fact-Checking Benchmark with Evidence and Paired Audio

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Chaewan Chun, Meruyert Aristombayeva, Jiyoung Choi, Mahjabin Nahar, Delvin Ce Zhang, Dongwon Lee
- **URL**: <http://arxiv.org/abs/2609.04452v1>
- **Submitted**: 2026-09-03 20:14:48
...
### 48. Conformity Breaks Conformal Prediction

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yibo Hu, Hanyu Su
- **URL**: <http://arxiv.org/abs/2609.04445v1>
- **Submitted**: 2026-09-03 20:05:47
...
### 50. A Systematic Evaluation of Cross-Lingual Consistency Enhancement Methods in Multilingual Language Models

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Jirui Qi, Mingyang Wang, Hinrich Schütze, Raquel Fernández, Arianna Bisazza
- **URL**: <http://arxiv.org/abs/2609.04409v1>
- **Submitted**: 2026-09-03 19:18:44
