# Daily Papers Report - 2026-01-29

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. Taxonomy of the Retrieval System Framework: Pitfalls and Paradigms
...
- **Topic Keywords**: ranking, rerank, relevance, retrieval, rank, search
...
- **Topic**: Hierarchical framework for embedding-based retrieval systems
- **Aim**: Provide a structured approach to balance efficiency and effectiveness in neural search designs
- **Rationale**: Retrieval systems face multiple, interacting limitations; a layered taxonomy clarifies trade-offs and guides design choices
- **Ground**: Four layers: Representation (losses, encoders), Granularity (chunking), Orchestration (multi-stage pipelines, hierarchical retrieval), Robustness (domain generalization, lexical blind spots, temporal drift)
- **Experiment**: Empirical evaluation of each layer’s techniques on benchmark retrieval tasks, measuring latency, recall, and robustness to domain shifts
- **Takeaway**: The framework enables practitioners to systematically select and combine design components, improving both performance and efficiency while mitigating common failure modes
...
### 2. When Vision Meets Texts in Listwise Reranking
...
- **Topic Keywords**: information retrieval, ranking, rerank, listwise, rag, retrieval, rank, trec
...
### 3. One Word is Enough: Minimal Adversarial Perturbations for Neural Text Ranking
...
- **Topic Keywords**: query, ranking, rag, retrieval, rank, trec
...
### 4. Harnessing Large Language Models for Precision Querying and Retrieval-Augmented Knowledge Extraction in Clinical Data Science
...
### 5. CE-RM: A Pointwise Generative Reward Model Optimized via Two-Stage Rollout and Unified Criteria
...
- **Topic Keywords**: query, pointwise, pairwise
...
### 7. Beyond the Needle's Illusion: Decoupled Evaluation of Evidence Access and Use under Semantic Interference at 326M-Token Scale
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of long-context models and evidence access. However, the focus on natural language processing and large-scale memory access may not directly align with your primary interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on semantic interference and discrimination also diverges from your core research themes.
...
### 8. MedViz: An Agent-based, Visual-guided Research Assistant for Navigating Biomedical Literature
...
### 9. Scaling Medical Reasoning Verification via Tool-Integrated Reinforcement Learning
...
### 10. A Dialectic Pipeline for Improving LLM Robustness
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on improving the robustness of Language Models (LLMs) rather than query understanding, ranking models, or user behavior modeling. The paper's emphasis on LLMs and their applications is not directly aligned with your primary focus on Information Retrieval, but it may still be of interest to you as a related topic.
...
### 11. LLM-AutoDP: Automatic Data Processing via LLM Agents for Model Fine-tuning
...
### 12. P2S: Probabilistic Process Supervision for General-Domain Reasoning Question Answering
...
### 13. Post-Training Fairness Control: A Single-Train Framework for Dynamic Fairness in Recommendation
...
### 14. Linear representations in language models can change dramatically over a conversation
...
### 15. Online Density-Based Clustering for Real-Time Narrative Evolution Monitorin
...
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to information retrieval, but its focus on clustering and narrative intelligence systems for social media monitoring is not directly aligned with your core research themes in query understanding, ranking models, and user behavior modeling. While it touches on real-time relevance optimization, the context is different from your typical e-commerce domain, and the paper's emphasis on clustering and narrative metrics is not central to your interests.
...
### 16. Less is More: Benchmarking LLM Based Recommendation Agents
...
### 17. Truthfulness Despite Weak Supervision: Evaluating and Training LLMs Using Peer Prediction
...
### 18. MERGE: Next-Generation Item Indexing Paradigm for Large-Scale Streaming Recommendation
...
### 19. Me-Agent: A Personalized Mobile Agent with Two-Level User Habit Learning for Enhanced Interaction
...
### 20. $\mathbb{R}^{2k}$ is Theoretically Large Enough for Embedding-based Top-$k$ Retrieval
...
- **Reason**: This paper focuses on the theoretical aspects of embedding-based retrieval, specifically the minimal dimension required for subset memberships. While it touches on retrieval limitations, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to information retrieval is indirect, making it only loosely relevant to the user's research interests.
...
### 21. Overview of the TREC 2025 Tip-of-the-Tongue track
...
### 22. PsychePass: Calibrating LLM Therapeutic Competence via Trajectory-Anchored Tournaments
...
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on evaluating the therapeutic competence of Large Language Models in mental healthcare. While it involves NLP, the context is quite different from the user's core research themes.
...
### 23. Efficient Multimodal Planning Agent for Visual Question-Answering
...
### 24. AgentLongBench: A Controllable Long Benchmark For Long-Contexts Agents via Environment Rollouts
...
### 25. Eliminating Hallucination in Diffusion-Augmented Interactive Text-to-Image Retrieval
...
### 26. CtrlCoT: Dual-Granularity Chain-of-Thought Compression for Controllable Reasoning
...
### 27. SoftHateBench: Evaluating Moderation Models Against Reasoning-Driven, Policy-Compliant Hostility
...
### 28. TGSBM: Transformer-Guided Stochastic Block Model for Link Prediction
...
- **Reason**: This paper focuses on link prediction in large-scale networks, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve some aspects of graph neural networks and transformers, the specific application and methodology are not aligned with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 29. MALLOC: Benchmarking the Memory-aware Long Sequence Compression for Large Sequential Recommendation
...
### 30. Evolutionary Strategies lead to Catastrophic Forgetting in LLMs
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it touches on deep learning models, its focus on catastrophic forgetting in LLMs and gradient-free algorithms is more aligned with broader AI and machine learning topics, rather than your specific areas of interest.
...
### 31. Jurisdiction as Structural Barrier: How Privacy Policy Organization May Reduce Visibility of Substantive Disclosures
...
### 32. ShieldedCode: Learning Robust Representations for Virtual Machine Protected Code
...
- **Reason**: This paper focuses on software protection and virtual machine protection, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves code generation and semantic understanding, the context is software security and protection, rather than search or retrieval.
...
### 33. GDCNet: Generative Discrepancy Comparison Network for Multimodal Sarcasm Detection
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on multimodal sarcasm detection and does not address query understanding, ranking models, or user behavior modeling.
...
### 34. TABED: Test-Time Adaptive Ensemble Drafting for Robust Speculative Decoding in LVLMs
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speculative decoding in Large Vision-Language Models (LVLMs), which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some form of model optimization, the context is primarily in computer vision and multimodal processing, making it less relevant to the user's interests.
...
### 35. Spark: Strategic Policy-Aware Exploration via Dynamic Branching for Long-Horizon Agentic Learning
...
### 36. SERA: Soft-Verified Efficient Repository Agents
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are the core areas of your research interests. While it touches on NLP and data mining, the focus is on open-source coding agents and their applications, which does not align closely with your primary research themes.
...
### 37. AgentIF-OneDay: A Task-level Instruction-Following Benchmark for General AI Agents in Daily Scenarios
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves AI agents and natural language instructions, the focus is on task-level instruction-following and general AI capabilities, which is not a central match to your core research themes.
...
### 38. PathWise: Planning through World Model for Automated Heuristic Design via Self-Evolving LLMs
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models (LLMs), the focus is on automated heuristic design for combinatorial optimization problems, which is outside your primary areas of interest.
...
### 39. MuVaC: AVariational Causal Framework for Multimodal Sarcasm Understanding in Dialogues
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on multimodal sarcasm understanding in dialogues, which is a topic outside of the user's primary research interests in Information Retrieval and Search technologies. While it involves some aspects of Natural Language Processing, the paper's emphasis on multimodal feature learning and variational causal inference does not align with the user's core research themes.
...
### 40. Hopes and Fears -- Emotion Distribution in the Topic Landscape of Finnish Parliamentary Speech 2000-2020
...
- **Topic Keywords**: search
- **Reason**: This paper appears to be focused on analyzing emotions in parliamentary speeches, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve text analysis, the specific topic and methodology seem to be outside your primary areas of focus.
...
### 41. Improving Diffusion Language Model Decoding through Joint Search in Generation Order and Token Space
...
### 42. Beyond Speedup -- Utilizing KV Cache for Sampling and Reasoning
...
### 43. MiLorE-SSL: Scaling Multilingual Capabilities in Self-Supervised Models without Forgetting
...
### 44. RusLICA: A Russian-Language Platform for Automated Linguistic Inquiry and Category Analysis
...
- **Topic Keywords**: search
- **Reason**: This paper appears to be focused on linguistic analysis and category adaptation for the Russian language, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves text analysis, it does not seem to address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's interests.
...
### 45. Unit-Based Agent for Semi-Cascaded Full-Duplex Dialogue Systems
...
- **Topic Keywords**: rank
- **Reason**: This paper focuses on dialogue systems and multimodal large language models, which is somewhat related to Natural Language Processing (NLP), but it does not directly align with the user's core research themes in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling.
...
### 46. High-Resolution Mapping of Port Dynamics from Open-Access AIS Data in Tokyo Bay
