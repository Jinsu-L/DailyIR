...
### 2. Static Pruning Across Sparse Retrieval Regimes: What Transfers, What Breaks, and What Still Helps
...
### 3. LENS: In-Context Search via Latent Evidence Exploration over Dynamic Raw Documents

- **LLM Score**: 0
- **Keyword Score**: 14
- **Authors**: Xingjun Wang, Gongsheng Li, Qi Fan, Yunlin Mao, Luyan Su, Yingda Chen
- **URL**: <http://arxiv.org/abs/2608.16185v2>
...
### 4. Efficient Privacy-Preserving Range Filtered Approximate Nearest Neighbor Search
...
- **Topic**: Privacy‑Preserving Range‑Filtered Approximate Nearest Neighbor Search (PP‑RFANNS)
- **Aim**: Enable efficient retrieval of approximate nearest neighbors that satisfy a numeric range predicate from an encrypted vector database outsourced to an honest‑but‑curious cloud, while revealing only explicitly characterized leakage.
- **Rationale**: Traditional secure distance comparison and range checking are computationally expensive and cause selectivity‑sensitive bottlenecks; plaintext RFANNS methods violate privacy and existing privacy‑preserving ANNS methods ignore efficient range handling.
- **Ground**: Hybrid index combining a locally maintained N‑ary tree that partitions attribute domains with HNSW sub‑indices stored per tree node; query mapping to tree nodes locally; filtering via DCPE ciphertexts to obtain coarse candidate sets; refinement via DCE exact distance comparison on reduced candidates, avoiding online encrypted range checks.
- **Experiment**: Detailed analytical evaluation of computation, communication, storage overhead, and security leakage under the honest‑but‑curious model, demonstrating that the scheme decouples range localization from encrypted vector search and achieves high search accuracy.
- **Takeaway**: PP‑RFANNS decouples range filtering from vector search, achieves high accuracy with reduced cryptographic overhead, and mitigates typical secure RFANNS bottlenecks by using a hybrid N‑ary tree–HNSW index and a filter‑and‑refine strategy.
...
### 5. Skill2Query: Exploiting Skill Structure to Generate Pseudo-Queries for Agent Skill Retrieval
...
### 6. Think Inside the Chunk: RegulaRAG for Regulation-Compliant Scenario Generation using LLMs: A Case Study of UN Regulation No. 152
...
### 7. Unbiased Recommender Systems with Implicit Feedback
...
### 8. HyperSkill: Self-Evolving LLM Agents via Hypergraph-Structured Skill Memory
...
### 9. When Tool-Backed Skill Retrieval Fails: Source-Style Collapse in Executable Capability Retrieval
...
### 10. Coverage Is Not Containment: A Fundamental Limit of Admission-Time Defenses Against Coordinated Poisoning of Vector Retrieval
...
### 11. Coverage Is Not Redundancy: Maintenance Cost and Exposure of Query-Aware Admission Indexes in Vector Databases Under Workload Drift
...
### 12. SEER: Long-Context Reasoning via Selective Visual-Text Compression
...
### 13. GEO-Flag: Detecting and Measuring GEO-Optimized Web Content
...
### 14. UniDot: A Unified Network for Sequence Modeling and Feature Interaction in Large-scale Recommendation
...
### 15. Margin-Regularized Structured Semantic Alignment for Brain-Language Correspondence

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Jiaqi Wang, Huawen Hu, Shu Zhang
- **URL**: <http://arxiv.org/abs/2608.16975v1>
- **Submitted**: 2026-08-17 14:47:15
- **Topic Keywords**: ranking, listwise, retrieval, rank
- **Reason**: LLM scoring failed.
...
### 16. When Is Complex Chunking Worth It? A Multi-Objective Evaluation of Chunking Methods at Scale
...
### 18. The Commercial Tax: Rent-vs-Own Blind Spots in Multi-Hop Retrieval Benchmarks
...
### 19. LLMs Get Smarter from Targeted Synthetic Multilingual Data
...
### 20. Toward Better Assessment of LLMs' Performance in Clinical Error Detection
...
### 21. D2-ScaleAgent: Dual-Dimensional Scaling for Long Document Understanding
...
### 22. Executable Code Knowledge: Code as a Native, Validation-Carrying Knowledge Representation for AI Coding Agents
...
### 23. Clause Encounters of the Third Kind: Can LLMs Replace Language Teachers?
...
### 24. LineageRAG: Harnessing GraphRAG by Constructing Evidence Lineages with Source Grounding
...
### 26. Cost Scales with Change, Not Corpus Size: Incrementally Maintaining an Evolving Semantic Substrate
...
### 27. When Search Eats the Web: A Model of Corpus Erosion under Generative Extraction
...
### 30. Domain-Specific Text Embedding Models for Entity Resolution
...
### 31. Large language model-assisted discovery of cohorts from scientific literature
...
### 32. When Less Is Enough: Context Selection and Prompting Strategies for Bengali News Headline Generation
...
### 33. When Context Misleads: Intent-Guided Decoding for Robust Retrieval-Augmented Generation
...
### 34. FROG: Efficient Range-Filtering Approximate Nearest Neighbor Search on GPUs
...
### 35. Noesis: Bidirectional Graph-RAG with Adaptive Parallelism and Cross-Knowledge-Base Semantic Discovery
...
### 36. Proteus: Incremental Memory Activation for Long-Context Sequence Modeling

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Reza Bayat, Ali Behrouz, Vahab Mirrokni, Aaron Courville
- **URL**: <http://arxiv.org/abs/2608.16844v1>
- **Submitted**: 2026-08-17 17:30:43
...
### 37. Policy Iteration with Human Feedback: Bringing Post-Training RL to In-context Learning

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Minh-Ha Nguyen, Cathy Shyr
- **URL**: <http://arxiv.org/abs/2608.16831v1>
- **Submitted**: 2026-08-17 17:16:43
...
### 39. Ask, Condition or Abstain: Reinforcement Learning for Missing-Premise Reasoning
...
- **Keyword Score**: 3
- **Authors**: Kasumi Ban
- **URL**: <http://arxiv.org/abs/2608.16467v1>
- **Submitted**: 2026-08-17 12:04:18
...
### 41. Counting Documents Is Not Counting Text: Unit Bias in Web-PDF Corpus Statistics

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Luca Foppiano
- **URL**: <http://arxiv.org/abs/2608.16390v1>
- **Submitted**: 2026-08-17 10:41:07
...
### 42. Architecture-Dependent Causal Transfer of Activation States Across Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Fernando Cardenas Piepereit
- **URL**: <http://arxiv.org/abs/2608.16347v1>
- **Submitted**: 2026-08-17 09:53:27
...
### 43. Step-Level On-Policy Distillation: Interpolating Between On-Policy Distillation and Supervised Fine-Tuning
...
### 45. Structured Prediction for Scalable Spreadsheet Table Understanding: From Cell Types to Table Ranges (Extended Version)

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Antoine Gauquier, Ioana Manolescu, Pierre Senellart
- **URL**: <http://arxiv.org/abs/2608.16050v1>
- **Submitted**: 2026-08-17 03:25:10
...
### 46. PCA-guided Activation Scaling for Monotonic Bidirectional Control over LLM Sycophancy

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Zheng Chen, Zhaoxin Feng, Yip Tin Po, Jianfei Ma, Emmanuele Chersoni, Bo Li
- **URL**: <http://arxiv.org/abs/2608.16650v1>
- **Submitted**: 2026-08-17 14:48:49
...
### 47. Reconstruction: A Blind Benchmark for Recovering Research Ideas from Pre-Publication Bibliographies
...
### 48. When Do Explanations Help In-Context Learning? A Comparative Study of Natural Language Explanation Types and Faithfulness
...
### 49. STAGE: Controlled Objective Admission for Multi-Preference LLM Alignment
...
### 50. Listen, Reason, and Segment: Aligning LALMs with Editorial Judgment for Media Chapterization
