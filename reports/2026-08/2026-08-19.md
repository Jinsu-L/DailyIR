...
- **URL**: <http://arxiv.org/abs/2608.17889v1>
- **Submitted**: 2026-08-18 15:23:06
...
### 2. Preference Is Not Intervention: The Structure and Stability Boundaries of Reader-Specific Evidence Utility

- **LLM Score**: 0
- **Keyword Score**: 16
- **Authors**: Shi Zhou
- **URL**: <http://arxiv.org/abs/2608.17781v1>
- **Submitted**: 2026-08-18 13:45:17
- **Comment**: 16 pages, 6 figures, 11 tables
- **Topic Keywords**: query, queries, ranking, rag, retrieval, rank, acl
- **Reason**: LLM scoring failed.
...
### 3. Overview of the TREC 2025 Product Search and Recommendation Track

- **LLM Score**: 0
- **Keyword Score**: 12
- **Authors**: Dean E. Alvarez, Surya Kallumadi, Daniel Campos, ChengXiang Zhai, Alessandro Magnani, Rikiya Takehi, Michael D. Ekstrand
- **URL**: <http://arxiv.org/abs/2608.17138v1>
- **Submitted**: 2026-08-17 21:13:52
- **Topic Keywords**: query, retrieval, recommend, shopping, commerce, e-commerce, search, trec
- **Reason**: LLM scoring failed.
...
### 4. DEPT: Document Embedding Preservation Tuning for Unified Query Expansion and Retrieval

- **LLM Score**: 0
- **Keyword Score**: 10
- **Authors**: Jingyuan Wang, Richong Zhang, Zhijie Nie, Mingxin Li, Yanzhao Zhang
- **URL**: <http://arxiv.org/abs/2608.17632v1>
- **Submitted**: 2026-08-18 10:52:08
...
### 5. Polaris: Learning to Generate Table Descriptions from Retrieval Feedback

- **LLM Score**: 0
- **Keyword Score**: 10
- **Authors**: Ting Cai, Tuan Minh Phan, AnHai Doan
- **URL**: <http://arxiv.org/abs/2608.17171v1>
- **Submitted**: 2026-08-17 22:13:01
...
### 6. CABLE: Extending the Reach of Memory Retrieval via Complementary Antecedent-Based Linking and Expansion

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Zheling Tan, Jin Gao, Dequan Wang
- **URL**: <http://arxiv.org/abs/2608.17911v1>
- **Submitted**: 2026-08-18 15:40:29
- **Comment**: Accepted by COLM 2026
- **Topic Keywords**: retriever, queries, retrieval
- **Reason**: LLM scoring failed.
...
### 7. TraceSQL: Traceable Answerability Estimation for Reference-Free Text-to-SQL Verification
...
### 8. What Aggregate Scores Miss: Measuring Item-Level Regressions in Commercial LLM API Migrations

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Xiaonan Xu, Wenjing Wu
- **URL**: <http://arxiv.org/abs/2608.17719v1>
- **Submitted**: 2026-08-18 12:44:54
...
### 9. Efficient INT8 Inference of Small NLP Models on Server CPUs with PyTorch Native Stack

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Weiwen Xia, Yuxin Cui, E Cao
- **URL**: <http://arxiv.org/abs/2608.18182v1>
- **Submitted**: 2026-08-18 06:58:29
- **Comment**: 13 pages
...
### 10. Once Generated, Ranked: End-to-End Generative Slate Recommendation with Unified Semantic-Collaborative IDs
...
### 11. ArborMem: Navigating Interaction States with Memory Forests
...
### 12. Empowering Compact LLMs with Fusion of Layer-wise Exits for Recommendation
...
### 13. AISA: AI Safety Assistant Framework for Continuous Improvement of Highway Construction

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Mason Smetana, Trevor Neece, Lev Khazanovich
- **URL**: <http://arxiv.org/abs/2608.17184v1>
- **Submitted**: 2026-08-17 22:48:01
...
### 14. Foundation Agents Meet Agentic Deep Research: Evidence-Grounded Clinical Code Forecasting
...
- **Submitted**: 2026-08-17 19:24:57
- **Topic Keywords**: rag, web search, rank, search
- **Reason**: LLM scoring failed.
...
### 15. Judge, Retrieve, or Abstain: Uncertainty-Guarded LLM Judging with Provable Risk Guarantees

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Sher Badshah, Ali Emami, Hassan Sajjad
- **URL**: <http://arxiv.org/abs/2608.17994v1>
- **Submitted**: 2026-08-18 16:42:02
...
### 16. Do Large Language Models Play Six Degrees of Separation? Measuring Topological Compression in Long-Context Manifolds

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Md. Faiyaz Abdullah Sayeedi
- **URL**: <http://arxiv.org/abs/2608.17950v1>
- **Submitted**: 2026-08-18 16:05:25
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 17. From Global Benchmarks to Local Evaluations: Benchmarking LLMs for the German Public Sector

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Camilla Dalerci, Thilo Michael, Robin Schaefer, Daniel Weinland
- **URL**: <http://arxiv.org/abs/2608.17827v1>
- **Submitted**: 2026-08-18 14:28:33
...
### 18. CoAL-RAG: A Complexity-Aware Legal Retrieval-Augmented Generation Method

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Jin Su, Zhuofeng Zhao, Huanhuan Wang, Hao Chen
- **URL**: <http://arxiv.org/abs/2608.17536v1>
- **Submitted**: 2026-08-18 08:58:11
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 19. Effects of Answer Format Variation on Gender Bias in Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ksenia Merzlyakova, Sebastian Padó, Franziska Weeber
- **URL**: <http://arxiv.org/abs/2608.17516v1>
- **Submitted**: 2026-08-18 08:41:05
...
### 20. Token Optimization and Context Window Management in Multi-Agent AI Workflows

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Dvir Shamay
- **URL**: <http://arxiv.org/abs/2608.17188v1>
- **Submitted**: 2026-08-17 22:56:50
...
### 21. Towards Safer RAG: Only Agents Capable of System 2 Thinking may Access Untrusted Documents

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Mehrdad Ghassabi
- **URL**: <http://arxiv.org/abs/2608.17153v1>
- **Submitted**: 2026-08-17 21:37:20
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 22. KnowSim: Evaluating Information Calibration in LLM Assistants with User Simulators that Learn
...
### 23. Uncertainty-Aware Decision Making in Multimodal Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Abderrahmene Boudiaf, Irfan Hussain, Sajid Javed
- **URL**: <http://arxiv.org/abs/2608.17084v1>
- **Submitted**: 2026-08-17 19:43:21
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 24. Institution-Specific LLM Prompting Recovers PHI That De-identification Systems and Their Gold Standards Both Miss
...
### 25. Cross-Model Memory Transfer via Target-Side Reader Adaptation

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Mingyuan Li, Guangsheng Yu, Xu Wang, Shaoxiong Ji
- **URL**: <http://arxiv.org/abs/2608.17050v2>
- **Submitted**: 2026-08-17 18:54:42
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 26. Encoded but Not Actionable: Auditing the Decode-Generate-Steer Gap in Frozen LLMs for Geometric Constraints

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Man Liang, Xinzhao Cheng, Faizan Wajid
- **URL**: <http://arxiv.org/abs/2608.17843v1>
- **Submitted**: 2026-08-18 14:40:28
...
### 27. LLM-Derived Preference Judgments Are Not Self-Consistent
...
### 28. From Student Risk Prediction to SC2R: Semantics-Constrained Counterfactual Recourse for Educational Decision Support

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Ngoc Luyen Le, Marie-Hélène Abel, Bertrand Laforge
- **URL**: <http://arxiv.org/abs/2608.17618v1>
- **Submitted**: 2026-08-18 10:33:21
...
### 29. MoNe: Modular Neural Memory for Efficient Long Context Inference
...
### 30. An Investigation of Translationese in the Generations of Multilingual Large Language Models
...
### 32. On the Fragility of Self-Improving Agents: Variance, Task Order, and Underspecification

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Qinyuan Ye, Yu Li, Yada Pruksachatkun, Jiaxin Zhang, Chien-Sheng Wu
- **URL**: <http://arxiv.org/abs/2608.18066v1>
- **Submitted**: 2026-08-18 17:55:07
...
### 33. Language Has Two Parameters: Narrative-Induced Semantic Plasticity and Phase-Sensitive Interpretation

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Hollis Robbins
- **URL**: <http://arxiv.org/abs/2608.18041v1>
- **Submitted**: 2026-08-18 17:34:25
...
### 35. Efficient RLVR Scheduling via Graph-Structured Online Difficulty Estimation
...
### 36. Write, Execute, Refine: From Skill Followers to Skill Optimizers via Reinforcement Learning from Execution Feedback
...
### 37. From Entity Mentions to Tone: An LLM-Based Pipeline for Media Bias Analysis

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Klesti Hoxha, Olti Qirici
- **URL**: <http://arxiv.org/abs/2608.17454v1>
- **Submitted**: 2026-08-18 07:33:37
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 38. PTXBench: Benchmark and Adapt LLMs for GPU Kernel Optimization with Architecture-specific PTX
...
### 39. ArguLens: An Open-Source System for Automated Essay Scoring and Label-Aware Feedback Generation

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Weiran Wang, Hongxiang Shi, Huitao Tang, Wenjuan Qin
- **URL**: <http://arxiv.org/abs/2608.17356v1>
- **Submitted**: 2026-08-18 04:23:50
- **Topic Keywords**: acl
- **Reason**: LLM scoring failed.
...
### 40. There is No Theoretical Curse of Multilinguality For Embedding Space Structure

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Niyati Bafna, Neha Verma, Vilém Zouhar, Philipp Koehn, David Yarowsky
- **URL**: <http://arxiv.org/abs/2608.17088v1>
- **Submitted**: 2026-08-17 19:50:44
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 41. The IOL-AI Challenge: An Open Challenge towards Advancing Linguistic Reasoning
...
### 42. Against Political Polarization: A Unified Framework for Tracing Evolving Political Ideologies on Social Media

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Yijie Xu, Chao Wang, Hui Xiong
- **URL**: <http://arxiv.org/abs/2608.17987v1>
- **Submitted**: 2026-08-18 16:33:32
...
### 43. When Writing Style Drifts: Benchmarking Authorship Verification under Distribution Shifts in Genre, Time and the AI-Era
...
### 44. SpeechSense: A Paralinguistic-Focused Dataset for Fine-Grained Speech Sentiment Analysis

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Shicheng Ma, Wenqian Cui, Irwin King
- **URL**: <http://arxiv.org/abs/2608.17931v1>
- **Submitted**: 2026-08-18 15:51:27
...
### 45. BayesPrompt: human readable prompts that make sense
...
### 46. Multi-turn Conversational AI from Text to Multimodal Interaction: Data, Models, Evaluation, and Open Challenges
...
### 47. Auditing Exposure to Harmful Content on TikTok using Multimodal Language Models: A Cross-National, Age-Stratified Study

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Hamidreza Saffari, Francesco Pierri
- **URL**: <http://arxiv.org/abs/2608.17583v1>
- **Submitted**: 2026-08-18 09:49:02
...
### 48. Domain-Adapted Molecular Language Models for Efficient Search of Make-on-Demand Libraries

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Henrik Wille, Luis-Finley Schütz, Felix Strieth-Kalthoff
- **URL**: <http://arxiv.org/abs/2608.17567v1>
- **Submitted**: 2026-08-18 09:27:56
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 49. Code as Representation: A Compilable Parsing Paradigm for Academic Documents
