...
### 1. ReFeed: Retrieval Feedback-Guided Dataset Construction for Style-Aware Query Rewriting
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly query rewriting and query understanding. The focus on style-aware query rewriting and the use of retrieval feedback-driven dataset generation aligns with your interests in deep semantic understanding and real-time relevance optimization. The paper's emphasis on adapting to real-world data distributions also resonates with your e-commerce background.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: ReFeed: Retrieval‑Feedback‑Guided Dataset Generation for Style‑Aware Query Rewriting
- **Aim**: Construct a high‑precision, style‑aware query‑rewriting corpus by iteratively using retrieval outcomes as weak supervision to generate and validate rewrites that preserve intent and match target domain phrasing.
- **Rationale**: Conventional IR systems falter when user queries stylistically or semantically mismatch the target corpus; existing rewriters preserve meaning but ignore document style. Retrieval‑feedback has been used for fine‑tuning but not for curating training data that encodes both retrieval success and style.
- **Ground**: Four‑stage pipeline: 1) Initial Retrieval – identify miss cases where the ground‑truth document is not in top‑k; 2) LLM‑Guided Rewriting – GPT‑5 rewrites miss queries using retrieved negatives and a concise positive summary, forbidding copying; 3) Verification via Re‑Retrieval – only retain rewrites that retrieve the target document in top‑k; 4) Dataset Assembly – compile verified (q_i, q'_i) pairs with metadata into D_rewrite.
- **Experiment**: Applied to SQuAD v1.1: 18.7% of 87 k queries were miss cases; 67.5% of these yielded valid rewrites (~11 k pairs). Rewritten queries improved recall and RAG response accuracy, especially for ambiguous or stylistically divergent queries; benefit modest on already well‑structured datasets.
- **Takeaway**: Retrieval‑feedback can generate domain‑specific, style‑aware rewriting data that empirically boosts retrieval performance. The data‑centric ReFeed framework yields a high‑precision corpus that can be used to fine‑tune rewriters or enhance RAG systems.
...
- **Submitted**: 2026-03-02 17:03:43
- **Topic Keywords**: query, queries, click, search
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of query processing and optimization. The use of Large Language Models (LLMs) to synthesize execution code for queries aligns with the user's interest in deep semantic understanding and real-time relevance optimization. However, the focus on query processing and OLAP workloads is somewhat narrower than the user's broader interests in IR and NLP.
...
### 3. OmniRet: Efficient and High-Fidelity Omni Modality Retrieval

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Chuong Huynh, Manh Luong, Abhinav Shrivastava
- **URL**: <http://arxiv.org/abs/2603.02098v1>
- **Submitted**: 2026-03-02 17:19:55
- **Comment**: CVPR 2026. Project link: https://github.com/hmchuong/omniret
- **Topic Keywords**: query, queries, retrieval
- **Reason**: This paper presents a novel retrieval model, OmniRet, that handles complex queries across three modalities: text, vision, and audio. While not directly focused on e-commerce, the work aligns with your interests in Information Retrieval, query understanding, and multimodal retrieval, making it a relevant and useful contribution to the field.
...
### 4. LaSER: Internalizing Explicit Reasoning into Latent Space for Dense Retrieval
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed LaSER framework internalizes explicit reasoning into latent space, which aligns with your focus on deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on dense retrieval and LLMs is somewhat narrower than your broader interests in IR and NLP.
...
### 5. Legal RAG Bench: an end-to-end benchmark for legal RAG
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of deep semantic understanding and real-time relevance optimization. The focus on retrieval models and their impact on performance is closely aligned with your work on ranking models and query understanding. However, the specific domain of legal RAG systems is somewhat niche, which prevents a perfect match with your broader interests.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of personalized and intent-driven photo retrieval. The focus on multi-source reasoning, intent-driven queries, and robust agentic reasoning systems aligns with your interests in query understanding and ranking models. However, the specific domain of photo retrieval is somewhat niche compared to your broader interests in e-commerce and general IR.
...
### 7. Scaling Retrieval Augmented Generation with RAG Fusion: Lessons from an Industry Deployment

- **LLM Score**: 7
- **Keyword Score**: 13
- **Authors**: Luigi Medrano, Arush Verma, Mukul Chhabra
- **URL**: <http://arxiv.org/abs/2603.02153v1>
- **Submitted**: 2026-03-02 18:15:09
- **Topic Keywords**: query, ranking, rag, retrieval augmented generation, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the context of Retrieval-Augmented Generation (RAG) systems and retrieval fusion techniques. However, the focus on production-style deployment and latency constraints is somewhat specific to the e-commerce domain, which is not your primary area of interest.
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of click-through rate (CTR) prediction and ranking models. Although it focuses on advertising and recommendation systems, the use of multimodal large language models and proxy embeddings aligns with your interests in query understanding and real-time relevance optimization. However, the specific application domain (e-commerce) and focus on CTR prediction for new items without usage data are not central to your core research themes.
...
### 9. PleaSQLarify: Visual Pragmatic Repair for Natural Language Database Querying

- **LLM Score**: 5
- **Keyword Score**: 5
- **Authors**: Robin Shing Moon Chan, Rita Sevastjanova, Mennatallah El-Assady
- **URL**: <http://arxiv.org/abs/2603.01795v1>
- **Submitted**: 2026-03-02 12:24:29
- **Comment**: Accepted at CHI'26, main track
- **Topic Keywords**: query, rag
- **Reason**: The paper explores natural language database interfaces and pragmatic inference, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on natural language interfaces and database querying is not a central match for your core research themes, and the paper does not explicitly address ranking models or click models.
...
### 10. According to Me: Long-Term Personalized Referential Memory QA

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Jingbiao Mei, Jinghong Chen, Guangyu Yang, Xinyu Hou, Margaret Li, Bill Byrne
- **URL**: <http://arxiv.org/abs/2603.01990v1>
- **Submitted**: 2026-03-02 15:42:29
- **Comment**: Preprint
- **Topic Keywords**: queries, rag, retrieval
- **Reason**: This paper introduces a new benchmark for multimodal, multi-source personalized referential memory QA, which is somewhat related to information retrieval and NLP. However, the focus on long-term user memory and multimodal data sources does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's emphasis on memory representation and retrieval is more relevant to recommender systems than information retrieval.
...
### 11. FLANS at SemEval-2026 Task 7: RAG with Open-Sourced Smaller LLMs for Everyday Knowledge Across Diverse Languages and Cultures

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Liliia Bogdanova, Shiran Sun, Lifeng Han, Natalia Amat Lefort, Flor Miriam Plaza-del-Arco
- **URL**: <http://arxiv.org/abs/2603.01910v1>
- **Submitted**: 2026-03-02 14:27:14
- **Topic Keywords**: rag, retrieval augmented generation, retrieval, search
- **Reason**: This paper is somewhat related to Information Retrieval, specifically in the context of retrieval augmented generation (RAGs) and knowledge base construction. However, it focuses more on the application of these techniques in a specific task (Everyday Knowledge Across Diverse Languages and Cultures) and does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 12. AnnoABSA: A Web-Based Annotation Tool for Aspect-Based Sentiment Analysis with Retrieval-Augmented Suggestions

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Nils Constantin Hellwig, Jakob Fehle, Udo Kruschwitz, Christian Wolff
- **URL**: <http://arxiv.org/abs/2603.01773v1>
- **Submitted**: 2026-03-02 11:56:47
...
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval, specifically in the context of retrieval-augmented suggestions. However, it primarily focuses on Aspect-Based Sentiment Analysis and Natural Language Processing, which, while related, are not the user's core research themes.
...
### 13. Spectral Attention Steering for Prompt Highlighting
...
- **Reason**: The paper discusses attention steering and prompt highlighting, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on spectral attention steering and its applications in NLP does not directly align with the user's primary research interests in IR and real-time relevance optimization.
...
### 14. TARSE: Test-Time Adaptation via Retrieval of Skills and Experience for Reasoning Agents
...
- **Reason**: This paper explores test-time adaptation in clinical decision making, leveraging skills and experience retrieval for reasoning agents. While it touches on retrieval and adaptation, the focus is on clinical decision making and reasoning agents, which is somewhat related to information retrieval but not directly aligned with your core research themes.
...
### 15. NextAds: Towards Next-generation Personalized Video Advertising

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Yiyan Xu, Ruoxuan Xia, Wuqiang Zheng, Fengbin Zhu, Wenjie Wang, Fuli Feng
- **URL**: <http://arxiv.org/abs/2603.02137v1>
- **Submitted**: 2026-03-02 17:58:07
- **Topic Keywords**: rag, retrieval, personalization, search
- **Reason**: The paper discusses personalized video advertising, which is related to information retrieval and search technologies. However, the focus is on video advertising and creative generation, rather than query understanding or ranking models, making it somewhat relevant but not a central match.
...
### 16. nchellwig at SemEval-2026 Task 3: Self-Consistent Structured Generation (SCSG) for Dimensional Aspect-Based Sentiment Analysis using Large Language Models

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Nils Constantin Hellwig, Jakob Fehle, Udo Kruschwitz, Christian Wolff
- **URL**: <http://arxiv.org/abs/2603.01788v1>
- **Submitted**: 2026-03-02 12:13:03
- **Topic Keywords**: ranking, rag, rank
- **Reason**: The paper explores a Natural Language Processing (NLP) task, Dimensional Aspect-Based Sentiment Analysis, using Large Language Models. While it involves a form of ranking (achieving a majority consensus), it is not directly related to Information Retrieval or Search technologies. The paper's focus on NLP and sentiment analysis is somewhat tangential to the user's core research interests.
...
### 17. Efficient Extractive Summarization with MAMBA-Transformer Hybrids for Low-Resource Scenarios
...
- **Reason**: This paper focuses on extractive summarization, leveraging transformer and state space models to improve summarization quality in low-resource scenarios. While it involves NLP and deep semantic understanding, it is not directly related to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 18. CyclicJudge: Mitigating Judge Bias Efficiently in LLM-based Evaluation

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Ziyi Zhu, Olivier Tieleman, Alexey Bukhtiyarov, Jinghong Chen
- **URL**: <http://arxiv.org/abs/2603.01865v1>
- **Submitted**: 2026-03-02 13:46:32
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of model evaluation and bias mitigation. However, the focus on LLM-based evaluation and bias in judges is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance is limited to the broader NLP and IR domains.
...
### 19. Beyond the Grid: Layout-Informed Multi-Vector Retrieval with Parsed Visual Document Representations
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, but its focus on visual document retrieval and layout-informed multi-vector retrieval is not directly aligned with your primary areas of interest in query understanding, ranking models, and user behavior modeling. While it touches on the topic of retrieval systems, it does not appear to require deep semantic understanding or real-time relevance optimization, which are key aspects of your research.
...
### 20. Reconstructing Content via Collaborative Attention to Improve Multimodal Embedding Quality
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores multimodal embedding models, which is a related topic to Information Retrieval, but it focuses more on the architectural and training paradigms of large language models rather than query understanding, ranking models, or user behavior modeling. While it touches on the idea of compact and informative representations, it doesn't directly address the core themes of Information Retrieval and Search technologies.
...
- **Reason**: The paper explores a novel multimodal memory architecture for long-horizon video understanding, which is somewhat related to information retrieval and search technologies. However, the focus is on video understanding and memory organization, rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to NLP is also indirect, as the paper primarily deals with multimodal large language models and video understanding.
...
### 22. Individual Turing Test: A Case Study of LLM-based Simulation Using Longitudinal Personal Data
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores the capabilities of Large Language Models (LLMs) in simulating individual behavior, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on LLMs and individual simulation is not directly aligned with the user's primary research themes, and the paper's context is more aligned with Natural Language Processing than Information Retrieval.
...
- **Submitted**: 2026-03-02 15:15:11
- **Comment**: Accepted to ICLR 2026
- **Topic Keywords**: rag, personalization
- **Reason**: The paper focuses on memory management in long-horizon conversations, which is somewhat related to information retrieval and search technologies. However, the primary focus on conversational agents and memory management strategies does not directly align with the user's core research themes in IR and search technologies. The use of NLP and related topics is relevant, but the paper's emphasis on memory management and conversational agents is not a central match for the user's interests.
...
### 24. Recursive Think-Answer Process for LLMs and VLMs

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Byung-Kwan Lee, Youngchae Chee, Yong Man Ro
- **URL**: <http://arxiv.org/abs/2603.02099v2>
- **Submitted**: 2026-03-02 17:20:10
- **Comment**: CVPR 2026 Findings, Project page: https://litcoderr.github.io/rtap_page/
- **Topic Keywords**: rag
- **Reason**: The paper discusses a recursive reasoning process for large language models and vision-language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on reasoning processes and confidence generation is more aligned with Natural Language Processing and AI development, rather than the user's core research themes in IR and search technologies.
...
### 25. Efficient RLVR Training via Weighted Mutual Information Data Selection

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Xinyu Zhou, Boyu Zhu, Haotian Zhang, Huiming Wang, Zhijiang Guo
- **URL**: <http://arxiv.org/abs/2603.01907v1>
- **Submitted**: 2026-03-02 14:25:07
- **Comment**: 15 Pages
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves reinforcement learning and large language models. However, the focus on RL training data selection and efficiency does not directly align with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 26. Semantic Novelty Trajectories in 80,000 Books: A Cross-Corpus Embedding Analysis

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Fred Zimmerman
- **URL**: <http://arxiv.org/abs/2603.01791v1>
- **Submitted**: 2026-03-02 12:20:24
- **Comment**: 12 pages, 4 figures, 5 tables
- **Topic Keywords**: rag
- **Reason**: The paper explores semantic novelty in books, using embeddings and novelty measures, which is somewhat related to information retrieval and NLP. However, the focus on literary analysis and the use of Schmidhuber's compression progress theory of interestingness is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 27. LLM-as-an-Annotator: Training Lightweight Models with LLM-Annotated Examples for Aspect Sentiment Tuple Prediction

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Nils Constantin Hellwig, Jakob Fehle, Udo Kruschwitz, Christian Wolff
- **URL**: <http://arxiv.org/abs/2603.01778v1>
- **Submitted**: 2026-03-02 12:03:32
- **Comment**: Accepted for publication at LREC 2026. Final version will appear in the ACL Anthology
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and data mining, but it does not directly align with their primary focus on Information Retrieval (IR), especially in areas that require deep semantic understanding and real-time relevance optimization. The paper's focus on Aspect-Based Sentiment Analysis (ABSA) and Large Language Model (LLM)-generated annotations is not a central match to the user's research themes. However, it may be of interest to the user due to its overlap with NLP and data mining.
...
### 28. QIME: Constructing Interpretable Medical Text Embeddings via Ontology-Grounded Questions
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it deals with text embeddings and biomedical text analysis. However, the focus on medical text embeddings and clinical decision-making is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on interpretability and ontology-grounded questions is also not a central match to your research themes.
...
### 29. Beyond the Resumé: A Rubric-Aware Automatic Interview System for Information Elicitation

- **LLM Score**: 3
- **Keyword Score**: 2
- **Authors**: Harry Stuart, Masahiro Kaneko, Timothy Baldwin
- **URL**: <http://arxiv.org/abs/2603.01775v1>
- **Submitted**: 2026-03-02 12:00:10
- **Topic Keywords**: rag
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval, particularly in the context of e-commerce, but it primarily focuses on an automated interview system for hiring, which is not a central match to your core themes of query understanding, ranking models, and user behavior modeling.
...
### 30. PanCanBench: A Comprehensive Benchmark for Evaluating Large Language Models in Pancreatic Oncology
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on their evaluation in a specific domain (pancreatic oncology) and does not address query understanding, ranking models, or user behavior modeling.
...
### 31. Organizing, Orchestrating, and Benchmarking Agent Skills at Ecosystem Scale
...
- **Submitted**: 2026-03-02 18:46:47
- **Topic Keywords**: pairwise, rag, retrieval, acl
- **Reason**: This paper appears to be focused on agent skills and ecosystem management, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some form of retrieval and orchestration, the context and scope are significantly different from the user's areas of expertise.
...
### 32. Surgical Post-Training: Cutting Errors, Keeping Knowledge
...
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval and Search technologies, as it focuses on post-training techniques for Large Language Models, specifically addressing catastrophic forgetting and improving reasoning capabilities. While it involves optimization and data rectification, the context is distinct from your areas of expertise.
...
### 33. Let the Agent Search: Autonomous Exploration Beats Rigid Workflows in Temporal Question Answering

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Xufei Lv, Jiahui Yang, Yifu Gao, Linbo Qiao, Houde Liu
- **URL**: <http://arxiv.org/abs/2603.01853v1>
- **Submitted**: 2026-03-02 13:33:39
- **Topic Keywords**: queries, retrieval, search
- **Reason**: This paper focuses on Temporal Knowledge Graph Question Answering, which, while related to Information Retrieval, does not directly align with the user's core research themes of query understanding, ranking models, and user behavior modeling. The use of large language models and search tools is somewhat relevant to the user's interests in NLP and data mining, but the specific application and methodology do not strongly resonate with the user's primary focus on information retrieval and real-time relevance optimization.
...
### 34. ProtRLSearch: A Multi-Round Multimodal Protein Search Agent with Large Language Models Trained via Reinforcement Learning
...
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval and Search technologies, as it focuses on a specific domain (protein analysis in healthcare) and uses a multimodal search agent with large language models trained via reinforcement learning. While it involves search and ranking, the context and application are quite different from your primary interests.
...
### 35. A Study on Building Efficient Zero-Shot Relation Extraction Models
...
- **Reason**: This paper focuses on zero-shot relation extraction models, which is a topic related to NLP, but it does not directly align with the user's primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. The paper's focus on relation extraction and its application in a retrieval scenario is somewhat relevant, but it does not address the user's core research themes.
...
### 36. FreeAct: Freeing Activations for LLM Quantization

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Xiaohao Liu, Xiaobo Xia, Manyi Zhang, Ji-Fu Li, Xianzhi Yu, Fei Shen, Xiu Su, See-Kiong Ng, Tat-Seng Chua
- **URL**: <http://arxiv.org/abs/2603.01776v1>
- **Submitted**: 2026-03-02 12:02:17
- **Comment**: 26 pages, 18 figures, 2 tables
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on Large Language Model (LLM) quantization, which is not a core area of interest for you. While it involves some NLP aspects, the primary focus is on model optimization and quantization, which is not directly related to your research themes in Information Retrieval, Search technologies, and user behavior modeling.
...
### 37. Power Echoes: Investigating Moderation Biases in Online Power-Asymmetric Conflicts
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on moderation biases in online power-asymmetric conflicts, which is outside your primary areas of interest.
...
### 38. Enhancing Persona Following at Decoding Time via Dynamic Importance Estimation for Role-Playing Agents
...
- **Comment**: ICLR 2026
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on Role-Playing Language Agents and persona management in sociological research, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models and decoding, the context and application are quite different from the user's areas of focus.
...
### 39. SWE-Adept: An LLM-Based Agentic Framework for Deep Codebase Analysis and Structured Issue Resolution
...
- **Reason**: This paper focuses on software engineering and codebase analysis, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves a large language model, the context is specific to codebase analysis and issue resolution, and does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 40. Catalyst-Agent: Autonomous heterogeneous catalyst screening and optimization with an LLM Agent
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on catalyst screening and optimization using a Large Language Model (LLM) Agent. While it involves AI and deep learning, the application domain is distinct from the user's core research interests.
...
### 41. Modeling Grammatical Hypothesis Testing in Young Learners: A Sequence-Based Learning Analytics Study of Morphosyntactic Reasoning in an Interactive Game

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Thierry Geoffre, Trystan Geoffre
- **URL**: <http://arxiv.org/abs/2603.02084v1>
- **Submitted**: 2026-03-02 17:04:52
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves sequence-based learning analytics and real-time analysis, the focus is on linguistic reasoning in young learners, which is not directly related to your areas of expertise.
...
- **Submitted**: 2026-03-02 16:10:17
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on vision-language pretraining for 3D CT, which is not directly related to your core research themes in Information Retrieval and Search technologies. While it involves text-image retrieval, the context is medical imaging and disease classification, which is not a primary area of interest for you.
...
### 43. AdaPonderLM: Gated Pondering Language Models with Token-Wise Adaptive Depth
...
- **Submitted**: 2026-03-02 14:28:16
- **Topic Keywords**: rag
- **Reason**: This paper focuses on optimizing large language models for efficient inference, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on aspects of model optimization, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to your research.
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on low-resource languages and embedding models in NLP, which is somewhat related to your interests in NLP and data mining. However, it does not directly address your core research themes in Information Retrieval, query understanding, ranking models, or user behavior modeling.
...
- **Comment**: Under Review
- **Topic Keywords**: rag
- **Reason**: This paper focuses on training tool-use agents, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some machine learning concepts, the context and application are not aligned with the user's background in e-commerce or interests in deep semantic understanding and real-time relevance optimization.
...
### 46. Learning to Draft: Adaptive Speculative Decoding with Reinforcement Learning
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on optimizing the efficiency of large language model inference through reinforcement learning, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the primary goal is to improve the performance of language models, which is not a central match to your research themes.
...
### 47. Understanding the Physics of Key-Value Cache Compression for LLMs through Attention Dynamics
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on the physics of key-value cache compression for Large Language Models (LLMs), which is a specific topic in the broader field of Natural Language Processing (NLP). While it touches on attention dynamics, it does not seem to be directly related to query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 48. I Can't Believe It's Not Robust: Catastrophic Collapse of Safety Classifiers under Embedding Drift
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on the robustness of safety classifiers in AI systems, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of model updates, it does not seem to involve query understanding, ranking models, or user behavior modeling, making it somewhat off-topic for your research.
...
### 49. What Exactly do Children Receive in Language Acquisition? A Case Study on CHILDES with Automated Detection of Filler-Gap Dependencies

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Zhenghao Herbert Zhou, William Dai, Maya Viswanathan, Simon Charlow, R. Thomas McCoy, Robert Frank
- **URL**: <http://arxiv.org/abs/2603.02082v1>
- **Submitted**: 2026-03-02 17:03:51
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on language acquisition in children and the development of a system for identifying filler-gap dependencies in spoken English corpora.
...
### 50. End-to-End Simultaneous Dysarthric Speech Reconstruction with Frame-Level Adaptor and Multiple Wait-k Knowledge Distillation
...
- **Topic Keywords**: rag
- **Reason**: This paper is unrelated to Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. It focuses on speech reconstruction and text-to-speech systems, which falls under Natural Language Processing, but is not aligned with the user's core research themes.
