...
### 1. How Far Are We from Genuinely Useful Deep Research Agents?
...
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of deep semantic understanding and real-time relevance optimization. The focus on report synthesis and deep research agents aligns with the user's interest in query understanding and ranking models. However, the paper's emphasis on NLP and report generation is not a central match to the user's primary focus on IR and search technologies.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Deep Research Agents (DRAs) and their evaluation
- **Aim**: Introduce FINDER, a fine‑grained benchmark, and DEFT, a systematic failure taxonomy, to enable objective assessment of DRA report‑generation capabilities
- **Rationale**: Existing DRA benchmarks focus on QA, lack structured evaluation, and rely on subjective metrics that misalign with user needs
- **Ground**: FINDER comprises 100 human‑curated research tasks and 419 structured checklist items covering report structure, analytical depth, and factual grounding; DEFT identifies 14 fine‑grained failure modes (reasoning, retrieval, generation) derived via grounded theory and annotated with human‑LLM co‑annotation
- **Experiment**: Empirical evaluation of current DRAs shows that task comprehension is not the primary issue; instead, challenges arise in evidence integration, verification, and reasoning‑resilient planning
- **Takeaway**: Objective, structured benchmarks and a detailed failure taxonomy are essential for advancing DRA performance, with a particular focus on improving evidence handling and reasoning strategies
...
### 2. TempPerturb-Eval: On the Joint Effects of Internal Temperature and External Perturbations in RAG Robustness
...
- **Reason**: This paper is highly relevant to Information Retrieval, specifically in the context of Retrieval-Augmented Generation (RAG) systems. The focus on perturbation-temperature interactions and robustness assessment aligns with query understanding and ranking models, which are core research themes in your area of interest.
...
- **Reason**: This paper is somewhat related to information retrieval, specifically evaluating the robustness of Retrieval-Augmented Generation (RAG) systems to symbolic perturbations. However, its focus on the vulnerability of RAG systems to emoticon tokens and its proposed defenses are not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper introduces a framework for organizing memory in Large Language Models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on conversational agents and memory-rich language models is not directly aligned with the user's primary research interests in IR and Search technologies. The paper's emphasis on cognitive psychology and human communication also diverges from the user's focus on real-time relevance optimization and deep semantic understanding.
...
### 5. HalluGraph: Auditable Hallucination Detection for Legal RAG Systems via Knowledge Graph Alignment
...
- **Reason**: The paper discusses a framework for detecting hallucinations in legal AI systems, which is related to information retrieval and NLP. However, the focus on legal RAG systems and knowledge graph alignment is somewhat off-topic from the user's core research themes in IR and search technologies, particularly in the e-commerce domain. The paper's emphasis on auditable guarantees and transparency in high-stakes legal applications also diverges from the user's interests in real-time relevance optimization and deep semantic understanding.
...
### 6. Conversion rate prediction in online advertising: modeling techniques, performance evaluation and future directions
...
- **Reason**: The paper is somewhat related to information retrieval, but its focus on conversion rate prediction in online advertising is more aligned with recommender systems and advertising technologies. While it touches on modeling techniques, the emphasis is on prediction rather than query understanding or ranking models, making it less central to your core research themes.
...
### 7. Kardia-R1: Unleashing LLMs to Reason toward Understanding and Empathy for Emotional Support via Rubric-as-Judge Reinforcement Learning
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and conversational agents, but it focuses on emotional support and empathy, which is not a central match to your primary focus on Information Retrieval (IR) and query understanding. The paper's use of reinforcement learning and explainable rewards is also relevant, but it's not directly applicable to your areas of interest.
...
### 8. Structured Spectral Reasoning for Frequency-Adaptive Multimodal Recommendation
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves multimodal recommendation and spectral reasoning. However, the focus on recommendation systems and the frequency domain is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on robustness and diagnostics is also somewhat tangential to your core research themes.
...
### 9. Exploring Human Perceptions of AI Responses: Insights from a Mixed-Methods Study on Risk Mitigation in Generative Models
...
- **Reason**: This paper explores human perceptions of AI responses, particularly in the context of generative models, which is somewhat related to the user's interests in Information Retrieval and Natural Language Processing. However, the focus on human perceptions and risk mitigation strategies is not directly aligned with the user's core research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 10. MARSAD: A Multi-Functional Tool for Real-Time Social Media Analysis
...
- **Reason**: The paper MARSAD is somewhat related to the user's research interests in Natural Language Processing (NLP) and data mining. However, it focuses on social media analysis and Arabic language processing, which is not a central match to the user's interests in Information Retrieval, query understanding, and ranking models. While it involves real-time analysis, it is more focused on data analysis and visualization rather than relevance optimization.
...
### 11. Toward a benchmark for CTR prediction in online advertising: datasets, evaluation protocols and perspectives
...
- **Reason**: The paper is somewhat related to information retrieval, specifically focusing on click-through rate (CTR) prediction in online advertising. However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on CTR prediction in advertising is somewhat tangential to the broader IR and NLP themes.
...
### 12. Agentic Policy Optimization via Instruction-Policy Co-Evolution
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves multi-turn retrieval and reasoning tasks. However, the focus on instruction-policy co-evolution and reinforcement learning with verifiable rewards is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 13. Reasoning About the Unsaid: Misinformation Detection with Omission-Aware Graph Inference
...
- **Comment**: AAAI 2026
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to Information Retrieval, specifically in the context of misinformation detection and omission-aware graph inference. However, it does not directly align with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's focus on NLP and data mining is also relevant, but not a central match for the user's interests.
...
### 14. LEC: Linear Expectation Constraints for False-Discovery Control in Selective Prediction and Routing Systems
...
- **Topic Keywords**: rag
- **Reason**: The paper discusses false discovery rate control in selective prediction and routing systems, which is related to information retrieval and search technologies. However, the focus on language models and uncertainty methods is more aligned with NLP, and the application to question-answering datasets is somewhat relevant to my interests. The connection to real-time relevance optimization is not explicitly mentioned, which is a key aspect of my research.
...
### 15. Enhancing BERT Fine-Tuning for Sentiment Analysis in Lower-Resourced Languages
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on fine-tuning BERT for sentiment analysis in low-resource languages, using active learning and data clustering methods. While it touches on NLP and deep semantic understanding, it doesn't directly relate to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 16. The Necessity of Imperfection:Reversing Model Collapse via Simulating Cognitive Boundedness
...
- **Topic Keywords**: acl
- **Reason**: This paper proposes a novel framework for simulating human cognitive processes to generate synthetic data, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on cognitive boundedness and its application in generating synthetic data for AI models is not directly aligned with the user's core research themes.
...
### 17. When Safety Blocks Sense: Measuring Semantic Confusion in LLM Refusals
...
- **Topic Keywords**: rag
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval and Natural Language Processing, as it deals with language models and their ability to understand and respond to user prompts. However, the focus on safety-aligned language models and their refusal mechanisms is not directly related to your core areas of interest in query understanding, ranking models, and user behavior modeling. The paper's emphasis on measuring semantic confusion in LLM refusals is an interesting aspect, but it does not align closely with your primary research themes.
...
### 18. Agreement-Constrained Probabilistic Minimum Bayes Risk Decoding
...
- **Reason**: This paper focuses on machine translation and decoding methods, which is not directly related to your core research interests in Information Retrieval and Search technologies. While it involves probabilistic modeling, the context is specific to translation quality and matrix completion, and does not align with your interests in query understanding, ranking models, or user behavior modeling.
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The study focuses on the altruistic tendencies of Large Language Models, which is outside your primary areas of focus.
...
### 20. StreamGaze: Gaze-Guided Temporal Reasoning and Proactive Understanding in Streaming Videos
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests as it focuses on streaming video understanding, gaze signals, and proactive reasoning in AR glasses, which is outside the scope of information retrieval, search technologies, and natural language processing.
...
### 21. MCAT: Scaling Many-to-Many Speech-to-Text Translation with MLLMs to 70 Languages
...
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on Speech-to-Text Translation, which is not directly related to Information Retrieval or Search technologies. While it involves Large Language Models, the context is not aligned with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 22. Securing Large Language Models (LLMs) from Prompt Injection Attacks
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models, its focus on security and prompt injection attacks is outside your area of expertise.
...
### 23. Pay Attention Later: From Vector Space Diffusion to Linearithmic Spectral Phase-Locking
...
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on improving the performance of Transformers by introducing a new model architecture (PRISM) that uses harmonic representations. While it touches on the concept of 'plasticity-stability' in real-time knowledge adaptation, it does not directly relate to information retrieval, query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 24. DrawingBench: Evaluating Spatial Reasoning and UI Interaction Capabilities of Large Language Models through Mouse-Based Drawing Tasks
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on evaluating the trustworthiness of large language models through spatial reasoning tasks, which is not directly related to information retrieval, search technologies, or query understanding. While it involves AI systems, the context is more aligned with trustworthy AI and model evaluation rather than IR or NLP.
...
### 25. LLM CHESS: Benchmarking Reasoning and Instruction-Following in LLMs through Chess
...
- **Topic Keywords**: rank
- **Reason**: This paper focuses on evaluating the reasoning and instruction-following abilities of large language models (LLMs) through a chess-based framework. While it touches on the generalization of reasoning, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 26. OPOR-Bench: Evaluating Large Language Models on Online Public Opinion Report Generation
...
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval and Search technologies, particularly query understanding, ranking models, and user behavior modeling. While it involves Natural Language Processing, the focus is on a specific task (Automated Online Public Opinion Report Generation) and does not align with your interests in deep semantic understanding and real-time relevance optimization.
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language models, it focuses on hallucination detection and assessment in multiple Indian languages, which is not a core area of your research.
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on borrowing detection in multilingual wordlists, which is a topic in Natural Language Processing (NLP), but does not align with your primary focus on Information Retrieval, especially in areas requiring deep semantic understanding and real-time relevance optimization.
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on software development, patch backporting, and automated backporting techniques, which are outside your primary areas of interest.
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on reinforcement learning with large language models, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on optimization techniques, the context is reinforcement learning rather than query understanding, ranking models, or user behavior modeling.
...
- **Topic Keywords**: search
- **Reason**: This paper appears to be related to deep learning and scaling, but it does not directly align with the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. The paper's focus on test-time scaling and mode-conditioning in reasoning tasks seems to be more relevant to the broader field of Artificial Intelligence, but it does not demonstrate a clear connection to the user's areas of interest.
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or query understanding. Although it touches on Natural Language Processing, its focus on text anonymization and privacy metrics is quite distant from your primary interests.
...
- **Reason**: This paper is unrelated to Information Retrieval, Search technologies, or Natural Language Processing, and instead focuses on speech and phoneme classification using Magnetoencephalography (MEG) signals, which is outside the scope of the user's research interests.
...
### 34. Large Language Models Cannot Reliably Detect Vulnerabilities in JavaScript: The First Systematic Benchmark and Evaluation
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on Large Language Models in vulnerability detection, which is outside your primary areas of interest.
...
### 35. Associative Syntax and Maximal Repetitions reveal context-dependent complexity in fruit bat communication
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on fruit bat communication and vocalization patterns.
...
### 36. ZIP-RC: Zero-overhead Inference-time Prediction of Reward and Cost for Adaptive and Interpretable Generation
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on abstract visual composition generation, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
