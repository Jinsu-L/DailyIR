...
### 1. Caraman at SemEval-2026 Task 8: Three-Stage Multi-Turn Retrieval with Query Rewriting, Hybrid Search, and Cross-Encoder Reranking

- **LLM Score**: 8
- **Keyword Score**: 21
- **Authors**: David-Maximilian Caraman, Gheorghe Cosmin Silaghi
- **URL**: <http://arxiv.org/abs/2605.12028v1>
- **Submitted**: 2026-05-12 12:13:45
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The use of query rewriting, hybrid search, and cross-encoder reranking aligns with your focus on deep semantic understanding and real-time relevance optimization. The application of these techniques in a real-world setting, such as SemEval-2026 Task 8, further increases the paper's relevance.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: SemEval-2026 Task 8 – MTRAGEval Retrieval
- **Aim**: Return a ranked list of 10 passages per conversational query from four English corpora (ClapNQ, Cloud, FiQA, Govt).
- **Rationale**: Enable robust conversational retrieval in a mixed‑domain setting where many queries are unanswerable or under‑specified, requiring a system that can rewrite, retrieve, and rerank effectively.
- **Ground**: Three‑stage, domain‑aware pipeline: 1) Query rewriting with Qwen 2.5 7B LoRA‑fine‑tuned model (domain‑specific temperature, deterministic for technical domains, controlled randomness for informal ones); 2) Hybrid retrieval fusing BM25S (50 lexical candidates) and BGE‑base‑en‑v1.5 dense embeddings (50 semantic candidates) via Reciprocal Rank Fusion (k=60); 3) Cross‑encoder reranker BGE‑reranker‑v2‑m3 (568 M) scoring the fused list.
- **Experiment**: Rewriting alone boosts nDCG@5 from 0.371 to 0.422; domain‑aware prompting or multi‑query expansion degrades to ~0.350. Hybrid retrieval with 50 candidates yields best reranking; expanding beyond 50 reduces quality. Reranker achieves nDCG@5 = 0.416, outperforming Granite R2 (0.391) and others. Skipping rewriting on first‑turn queries keeps nDCG@5 at 0.381 while cutting inference time by 29 %.
- **Takeaway**: Simplicity wins: a well‑tuned rewriting model outperforms elaborate prompting or expansion. Domain‑specific temperature is critical. Candidate pool size of ~50 is optimal. First‑turn queries can bypass rewriting without loss.
...
### 2. Very Efficient Listwise Multimodal Reranking for Long Documents

- **LLM Score**: 8
- **Keyword Score**: 17
- **Authors**: Yiqun Sun, Pengfei Wei, Lawrence B. Hsieh
- **URL**: <http://arxiv.org/abs/2605.11864v1>
- **Submitted**: 2026-05-12 09:45:59
- **Comment**: To appear in ICML 2026
- **Topic Keywords**: query, ranking, rerank, listwise, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of multimodal retrieval-augmented generation and reranking. The proposed ZipRerank model addresses key challenges in vision-centric retrieval and long document processing, which aligns with your focus on deep semantic understanding and real-time relevance optimization. However, the paper's specific focus on visual tokens and multimodal reranking may not be a central match to your primary interests in query understanding and ranking models.
...
### 3. Task-Adaptive Embedding Refinement via Test-time LLM Guidance

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Ariel Gera, Shir Ashury-Tahan, Gal Bloch, Ohad Eytan, Assaf Toledo
- **URL**: <http://arxiv.org/abs/2605.12487v1>
- **Submitted**: 2026-05-12 17:58:27
- **Topic Keywords**: query, queries, ranking, rank, search
- **Reason**: This paper explores query refinement using LLM guidance, which aligns with your interests in query understanding and ranking models. The focus on extending embedding models to challenging search tasks and real-time relevance optimization also resonates with your research themes. However, the paper's primary focus on zero-shot search and classification tasks, while related to IR, is not a central match to your core research interests.
...
### 4. ORCE: Order-Aware Alignment of Verbalized Confidence in Large Language Models

- **LLM Score**: 8
- **Keyword Score**: 3
- **Authors**: Chen Li, Xiaoling Hu, Songzhu Zheng, Jiawei Zhou, Chao Chen
- **URL**: <http://arxiv.org/abs/2605.12446v1>
- **Submitted**: 2026-05-12 17:39:43
- **Comment**: 18 pages, 2 figures
- **Topic Keywords**: rag, rank
- **Reason**: This paper is highly relevant to your interests in Natural Language Processing (NLP) and query understanding, as it focuses on verbalized confidence estimation in large language models. The use of rank-based reinforcement learning objectives also aligns with your research in ranking models. However, the paper's primary focus on confidence estimation and calibration, rather than query understanding or user behavior modeling, prevents it from being a perfect match.
...
- **URL**: <http://arxiv.org/abs/2605.12370v1>
- **Submitted**: 2026-05-12 16:39:05
- **Comment**: Accepted at SIGIR 2026
- **Topic Keywords**: relevance
- **Reason**: This paper explores the ability of Large Language Models to handle inferential questions, which is somewhat related to query understanding and ranking models in Information Retrieval. The focus on passage construction and convergence as a measure of relevance is also relevant to my interests in deep semantic understanding and real-time relevance optimization. However, the specific domain of open-domain Question Answering and the use of Large Language Models limits its direct applicability to my core research themes.
...
- **URL**: <http://arxiv.org/abs/2605.12138v1>
- **Submitted**: 2026-05-12 13:58:06
- **Comment**: 22 pages, 19 figures, CVPR 2026
- **Topic Keywords**: rag, click, ctr, commerce, e-commerce
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of e-commerce and user behavior modeling. However, the focus on personalized advertising generation and image-text models is not a central match to your primary interests in query understanding, ranking models, and deep semantic understanding.
...
- **Submitted**: 2026-05-12 15:44:33
- **Topic Keywords**: pairwise
- **Reason**: This paper introduces a novel approach to token-level preference optimization in language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language generation and preference optimization is not directly aligned with the user's primary research interests in search technologies and user behavior modeling. The connection to NLP and data mining is relevant, but the paper's scope is more narrow than the user's interests.
...
### 8. Question Difficulty Estimation for Large Language Models via Answer Plausibility Scoring

- **LLM Score**: 6
- **Keyword Score**: 2
- **Authors**: Jamshid Mozafari, Bhawna Piryani, Adam Jatowt
- **URL**: <http://arxiv.org/abs/2605.12398v1>
- **Submitted**: 2026-05-12 17:00:02
- **Comment**: Accepted at ACL 2026
- **Topic Keywords**: retrieval
- **Reason**: This paper explores question difficulty estimation for large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on question answering and plausibility scoring is not directly aligned with the user's primary research interests in search technologies and user behavior modeling.
...
- **Submitted**: 2026-05-12 16:17:03
- **Comment**: Retrieval Augmented EHR Foundation Model
- **Topic Keywords**: relevance, rag, ctr, retrieval
- **Reason**: The paper focuses on leveraging historical data in Electronic Health Records (EHR) using a retrieval-augmented foundation model. While it involves information retrieval and ranking, the domain and application are quite different from the user's primary interests in e-commerce and general search technologies. The paper does touch on relevance optimization, but it's in the context of clinical prediction tasks, which is not directly related to the user's core research themes.
...
### 10. PRISM: Pareto-Efficient Retrieval over Intent-Aware Structured Memory for Long-Horizon Agents

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Jingyi Peng, Zhongwei Wan, Weiting Liu, Qiuzhuang Sun
- **URL**: <http://arxiv.org/abs/2605.12260v1>
- **Submitted**: 2026-05-12 15:28:30
- **Comment**: Preprint
- **Topic Keywords**: query, queries, retrieval, search
- **Reason**: The paper PRISM focuses on memory management for long-horizon language agents, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on memory management and retrieval efficiency for language agents does not directly align with the user's core research themes in IR and Search technologies. The paper does involve some NLP aspects, but they are not central to the user's interests.
...
### 11. RecRM-Bench: Benchmarking Multidimensional Reward Modeling for Agentic Recommender Systems
...
- **URL**: <http://arxiv.org/abs/2605.11874v1>
- **Submitted**: 2026-05-12 09:52:21
- **Topic Keywords**: query, relevance, user behavior, recommend
- **Reason**: The paper focuses on recommender systems, which is a related topic to information retrieval, but it's not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's emphasis on multidimensional reward modeling and agentic recommender systems is somewhat relevant, but it doesn't directly address the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 12. Overview of the MedHopQA track at BioCreative IX: track description, participation and evaluation of systems for multi-hop medical question answering
...
- **URL**: <http://arxiv.org/abs/2605.12313v1>
- **Submitted**: 2026-05-12 15:59:28
- **Topic Keywords**: rag, retrieval, rank, search, www
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, specifically in the context of multi-hop question answering and retrieval-augmented generation. However, the focus on the biomedical domain and the use of Wikipedia pages as information sources limits its relevance to the user's core research themes in e-commerce and general search technologies.
...
### 13. Correcting Selection Bias in Sparse User Feedback for Large Language Model Quality Estimation: A Multi-Agent Hierarchical Bayesian Approach

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Andrea Morandi, Mahesh Viswanathan
- **URL**: <http://arxiv.org/abs/2605.12177v1>
- **Submitted**: 2026-05-12 14:22:06
- **Topic Keywords**: ltr, rag
- **Reason**: This paper is somewhat related to the user's research interests in Information Retrieval, particularly in the context of user behavior modeling and click models. However, the focus on Large Language Model Quality Estimation and selection bias correction in sparse user feedback is not directly aligned with the user's primary research themes. The use of Bayesian approaches and hierarchical modeling is relevant to the user's background in data mining and NLP, but the application is specific to a particular problem in NLP.
...
### 14. Geometric Factual Recall in Transformers

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Shauli Ravfogel, Gilad Yehudai, Joan Bruna, Alberto Bietti
- **URL**: <http://arxiv.org/abs/2605.12426v1>
- **Submitted**: 2026-05-12 17:22:22
- **Comment**: Preprint
- **Topic Keywords**: queries
- **Reason**: This paper explores the geometric form of memorization in transformer language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on theoretical and empirical accounts of memorization in transformers does not directly align with the user's primary interests in IR, query understanding, and ranking models. The paper's relevance to the user's broader interests in NLP and data mining is also limited.
...
### 15. HSUGA: LLM-Enhanced Recommendation with Hierarchical Semantic Understanding and Group-Aware Alignment

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Guorui Li, Dugang Liu, Lei Li, Xing Tang, Zhong Ming
- **URL**: <http://arxiv.org/abs/2605.11662v1>
- **Submitted**: 2026-05-12 07:22:42
- **Comment**: Accepted by ACL 2026 Findings
- **Topic Keywords**: rag, recommend
- **Reason**: This paper focuses on recommendation systems, leveraging large language models for sequential recommendations. While it touches on semantic understanding, it's more aligned with recommender systems than information retrieval. The use of hierarchical understanding and group-aware alignment is an interesting approach, but it doesn't directly address query understanding, ranking models, or user behavior modeling in the context of search technologies.
...
### 16. Latent Causal Void: Explicit Missing-Context Reconstruction for Misinformation Detection

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Hui Li, Zhongquan Jian, Jinsong Su, Junfeng Yao
- **URL**: <http://arxiv.org/abs/2605.12156v1>
- **Submitted**: 2026-05-12 14:09:05
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to information retrieval, but its focus on misinformation detection and context reconstruction is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. While it involves retrieval and NLP, the application domain is quite different from the user's e-commerce background and interests in real-time relevance optimization.
...
- **Submitted**: 2026-05-12 11:33:49
- **Comment**: Under Review
- **Topic Keywords**: rag
- **Reason**: This paper focuses on predicting the potential of pre-trained LLMs, which is somewhat related to information retrieval and ranking models. However, the topic is more aligned with NLP and model evaluation, and the paper's emphasis on pre-trained models and post-training performance does not directly relate to the user's core research themes.
...
- **URL**: <http://arxiv.org/abs/2605.11959v1>
- **Submitted**: 2026-05-12 11:11:36
- **Comment**: Accepted to ICPR 2026
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multimodal video summarization using vision-language models, which is somewhat related to information retrieval, particularly in the context of deep semantic understanding. However, the primary focus on video summarization and language generation diverges from the user's core research themes in IR and search technologies. The use of CLIP features for semantic alignment is an interesting aspect, but it does not directly align with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 19. PreScam: A Benchmark for Predicting Scam Progression from Early Conversations

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Weixiang Sun, Shang Ma, Yiyang Li, Tianyi Ma, Zehong Wang, Colby Nelson, Xusheng Xiao, Yanfang Ye
- **URL**: <http://arxiv.org/abs/2605.12243v1>
- **Submitted**: 2026-05-12 15:11:41
- **Topic Keywords**: search
- **Reason**: This paper introduces a benchmark for modeling scam progression from early conversations, which is somewhat related to information retrieval and natural language processing. However, the focus on scam detection and progression modeling is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's emphasis on language models and conversational analysis is somewhat tangential to the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 20. Self-Distilled Trajectory-Aware Boltzmann Modeling: Bridging the Training-Inference Discrepancy in Diffusion Language Models
...
- **URL**: <http://arxiv.org/abs/2605.11854v1>
- **Submitted**: 2026-05-12 09:39:06
- **Comment**: Under review
- **Topic Keywords**: ranking, pairwise, rank
- **Reason**: This paper focuses on improving diffusion language models through self-distilled trajectory-aware optimization, but it doesn't appear to be directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 21. Pretraining Exposure Explains Popularity Judgments in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Jamshid Mozafari, Bhawna Piryani, Adam Jatowt
- **URL**: <http://arxiv.org/abs/2605.12382v1>
- **Submitted**: 2026-05-12 16:45:38
- **Comment**: Accepted at SIGIR 2026
- **Topic Keywords**: pairwise, rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, query understanding, ranking models, or user behavior modeling. While it touches on the concept of popularity bias, which is somewhat relevant to recommender systems, the focus on large language models and their pretraining data makes it more aligned with NLP and data mining, but not a central match for your core research themes.
...
### 22. AgentDisCo: Towards Disentanglement and Collaboration in Open-ended Deep Research Agents

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Jiarui Jin, Zexuan Yan, Shijian Wang, Wenxiang Jiao, Yuan Lu
- **URL**: <http://arxiv.org/abs/2605.11732v1>
- **Submitted**: 2026-05-12 08:14:15
- **Topic Keywords**: queries, recommend, search
- **Reason**: Although the paper touches on search and information retrieval, its primary focus is on developing a framework for deep research agents, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. The paper's emphasis on code-generation agents, rendering agents, and personalized research recommendations also diverges from the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 23. MEME: Multi-entity & Evolving Memory Evaluation

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Seokwon Jung, Alexander Rubinstein, Arnas Uselis, Sangdoo Yun, Seong Joon Oh
- **URL**: <http://arxiv.org/abs/2605.12477v1>
- **Submitted**: 2026-05-12 17:55:10
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper appears to be primarily focused on evaluating memory systems for large language models, which is not directly related to information retrieval or search technologies. While it touches on the topic of retrieval performance, it is more concerned with memory evaluation and optimization, which is not a central match for your research interests.
...
### 24. ORBIT: Preserving Foundational Language Capabilities in GenRetrieval via Origin-Regulated Merging
...
- **Submitted**: 2026-05-12 17:14:04
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on Generative Retrieval and large language model fine-tuning, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of model performance and optimization, the context and goals are distinct from the user's interests.
...
### 25. BatchBench: Toward a Workload-Aware Benchmark for Autoscaling Policies in Big Data Batch Processing -- A Proposed Framework

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Venkata Krishna Prasanth Budigi, Siri Chandana Sirigiri
- **URL**: <http://arxiv.org/abs/2605.12272v1>
- **Submitted**: 2026-05-12 15:36:20
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on autoscaling policies in big data batch processing, which is outside your primary areas of interest.
...
### 26. Robust LLM Unlearning Against Relearning Attacks: The Minor Components in Representations Matter

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Zeguan Xiao, Xuanzhe Xu, Yun Chen, Yong Wang, Jian Yang, Yanqing Hu, Guanhua Chen
- **URL**: <http://arxiv.org/abs/2605.11685v1>
- **Submitted**: 2026-05-12 07:43:46
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on Large Language Model (LLM) unlearning and relearning attacks, which is not directly related to Information Retrieval (IR) or Search technologies. While it involves NLP, the topic is more specific to model security and privacy, and does not align with the user's primary research interests in query understanding, ranking models, and user behavior modeling.
...
### 27. PRISM: A Geometric Risk Bound that Decomposes Drift into Scale, Shape, and Head

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Chieh-Yen Lin, Shao-Hua Sun
- **URL**: <http://arxiv.org/abs/2605.11608v1>
- **Submitted**: 2026-05-12 06:40:34
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on evaluating and comparing post-training variants of Large Language Models (LLMs) using a geometric risk bound. While it involves some aspects of model understanding and analysis, it is primarily concerned with model evaluation and optimization, which is not directly related to your core research themes in Information Retrieval and Search technologies.
...
### 28. A categorical error sensitivity index (ISEC): A preventive ordinal decision-support measure for irrecoverable errors in manual data entry systems

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ricardo Raúl Palma, Mauro Anibal Benetti, Fabricio Orlando Sanchez Varretti
- **URL**: <http://arxiv.org/abs/2605.12328v1>
- **Submitted**: 2026-05-12 16:11:02
- **Comment**: 15 pages, 4 figures
- **Topic Keywords**: rag, rank
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves data entry systems and data governance, the focus is on preventing errors in manual data entry systems, which is not a primary area of interest for the user.
...
- **Submitted**: 2026-05-12 13:10:52
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be focused on Embodied AI, specifically World Action Models, which is outside your primary research interests in Information Retrieval and Search technologies. While it touches on aspects of modeling and understanding, the context is not related to your core areas of query understanding, ranking models, or user behavior modeling.
...
### 30. Qwen-Scope: Turning Sparse Features into Development Tools for Large Language Models
...
- **Submitted**: 2026-05-12 10:01:06
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on mechanistic interpretability of large language models using sparse autoencoders, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, the specific application and methodology are not aligned with your areas of focus.
...
### 31. Learning to Foresee: Unveiling the Unlocking Efficiency of On-Policy Distillation
...
- **URL**: <http://arxiv.org/abs/2605.11739v2>
- **Submitted**: 2026-05-12 08:19:15
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on the efficiency of on-policy distillation for large language models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on optimization and model efficiency, it doesn't address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to your interests.
...
### 32. LongMemEval-V2: Evaluating Long-Term Agent Memory Toward Experienced Colleagues
...
- **Submitted**: 2026-05-12 17:59:34
- **Comment**: Work in Progress
- **Topic Keywords**: rag
- **Reason**: This paper appears to be off-topic as it focuses on evaluating long-term memory systems for web agents, which is unrelated to information retrieval, search technologies, and query understanding. The paper's emphasis on memory systems for web agents and its evaluation metrics do not align with the user's research interests in IR and NLP.
...
### 33. Routers Learn the Geometry of Their Experts: Geometric Coupling in Sparse Mixture-of-Experts

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sagi Ahrac, Noya Hochwald, Mor Geva
- **URL**: <http://arxiv.org/abs/2605.12476v1>
- **Submitted**: 2026-05-12 17:55:02
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on the geometric coupling between routers and experts in Sparse Mixture-of-Experts models, which is a topic in Natural Language Processing. While it touches on routing decisions, it does not seem to be directly related to query understanding, ranking models, or user behavior modeling, which are core areas of interest for your research.
...
### 34. KV-Fold: One-Step KV-Cache Recurrence for Long-Context Inference

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Alireza Nadali, Patrick Cooper, Ashutosh Trivedi, Alvaro Velasquez
- **URL**: <http://arxiv.org/abs/2605.12471v1>
- **Submitted**: 2026-05-12 17:53:47
- **Comment**: 12 pages, 3 figures, 6 tables
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on long-context inference using a KV-cache recurrence, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves sequence processing, the context is more aligned with deep learning and model stability rather than query understanding, ranking models, or user behavior modeling.
...
### 35. Output Composability of QLoRA PEFT Modules for Plug-and-Play Attribute-Controlled Text Generation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Michela Lorandi, Anya Belz
- **URL**: <http://arxiv.org/abs/2605.12345v1>
- **Submitted**: 2026-05-12 16:21:43
- **Topic Keywords**: rag
- **Reason**: This paper focuses on parameter-efficient fine-tuning and output composition for text generation, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves LLMs and text generation, the context is more aligned with NLP and deep learning, rather than query understanding, ranking models, or user behavior modeling.
...
### 36. Mind the Pause: Disfluency-Aware Objective Tuning for Multilingual Speech Correction with LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Deepak Kumar, Baban Gain, Asif Ekbal
- **URL**: <http://arxiv.org/abs/2605.12242v1>
- **Submitted**: 2026-05-12 15:11:36
- **Comment**: Accepted to ACL 2026 (Main)
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech correction using large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and techniques used are not aligned with your areas of focus.
...
### 37. Sign Language Recognition and Translation for Low-Resource Languages: Challenges and Pathways Forward

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Nigar Alishzade, Gulchin Abdullayeva
- **URL**: <http://arxiv.org/abs/2605.12096v1>
- **Submitted**: 2026-05-12 13:13:56
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on Sign Language Recognition and Translation, which is outside your primary areas of expertise.
...
### 38. Towards Visually-Guided Movie Subtitle Translation for Indic Languages

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Tarun Chintada, Kshetrimayum Boynao Singh, Asif Ekbal
- **URL**: <http://arxiv.org/abs/2605.11993v1>
- **Submitted**: 2026-05-12 11:43:57
- **Topic Keywords**: acl
- **Reason**: This paper focuses on visually-guided movie subtitle translation for Indic languages, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multimodal processing, the context is specific to movie subtitles and low-resource languages, making it an off-topic paper for your research interests.
...
### 39. From Trajectories to Phenotypes: Disease Progression as Structural Priors for Multi-organ Imaging Representation Learning
...
- **URL**: <http://arxiv.org/abs/2605.11958v1>
- **Submitted**: 2026-05-12 11:10:26
- **Topic Keywords**: ctr
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. It focuses on disease progression modeling using imaging data and electronic health records, which is outside your areas of expertise.
...
### 40. UniVLR: Unifying Text and Vision in Visual Latent Reasoning for Multimodal LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Houcheng Jiang, Jiajun Fu, Junfeng Fang, Chen Gao, Xiang Wang, Xiangnan He, Yong Li
- **URL**: <http://arxiv.org/abs/2605.11856v1>
- **Submitted**: 2026-05-12 09:40:03
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multimodal large language models, specifically visual latent reasoning, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some form of reasoning, it is primarily centered around visual reasoning and multimodal large language models, making it only loosely relevant to the user's research interests.
...
### 41. From Token to Token Pair: Efficient Prompt Compression for Large Language Models in Clinical Prediction

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mingcheng Zhu, Zhiyao Luo, Yu Liu, Tingting Zhu
- **URL**: <http://arxiv.org/abs/2605.11774v1>
- **Submitted**: 2026-05-12 08:46:40
- **Comment**: 21 pages, 6 figures, 13 tables
- **Topic Keywords**: ctr
- **Reason**: This paper is primarily focused on developing a method for efficient compression of large language models in clinical prediction tasks. While it involves natural language processing, it is not directly related to information retrieval, search technologies, or query understanding, which are the core areas of your research interests.
...
### 42. Hide to See: Reasoning-prefix Masking for Visual-anchored Thinking in VLM Distillation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Seonghoon Yu, Dongjun Nam, Byung-Kwan Lee, Jeany Son
- **URL**: <http://arxiv.org/abs/2605.11651v2>
- **Submitted**: 2026-05-12 07:14:04
- **Comment**: Pre-print
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on Visual Language Models (VLMs) and multimodal reasoning benchmarks seems to be outside your primary areas of interest.
...
### 43. Enhancing Multilingual Counterfactual Generation through Alignment-as-Preference Optimization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yilong Wang, Qianli Wang, Bohao Chu, Yihong Liu, Jing Yang, Simon Ostermann
- **URL**: <http://arxiv.org/abs/2605.11632v1>
- **Submitted**: 2026-05-12 06:56:18
- **Comment**: In submission
- **Topic Keywords**: rag
- **Reason**: This paper focuses on counterfactual explanations for large language models, primarily in the context of multilingual settings. While it involves NLP, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 44. Mechanistic Interpretability of ASR models using Sparse Autoencoders

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Dan Pluth, Zachary Nicholas Houghton, Yu Zhou, Vijay K. Gurbani
- **URL**: <http://arxiv.org/abs/2605.12225v1>
- **Submitted**: 2026-05-12 15:02:20
- **Comment**: 10 pages + references and appendix
- **Topic Keywords**: search
- **Reason**: This paper focuses on interpretability of ASR models using Sparse Autoencoders, which is a topic in NLP. However, it does not relate to the user's core research interests in Information Retrieval, query understanding, ranking models, or user behavior modeling.
...
### 45. Not How Many, But Which: Parameter Placement in Low-Rank Adaptation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Arijit Sehanobish, Charles Lovering
- **URL**: <http://arxiv.org/abs/2605.12207v1>
- **Submitted**: 2026-05-12 14:46:00
- **Comment**: Preprint. Comments welcome
- **Topic Keywords**: rank
- **Reason**: This paper is not relevant to your research interests as it focuses on parameter placement in low-rank adaptation, which is a topic in machine learning and deep learning, but does not relate to information retrieval, search technologies, or natural language processing.
...
- **Submitted**: 2026-05-12 12:21:49
- **Comment**: Under Review
- **Topic Keywords**: search
- **Reason**: This paper focuses on skill libraries for large language model agents, which is somewhat related to information retrieval and search technologies. However, the primary focus is on reinforcement learning and skill graphs, which is not a central match to the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 47. Learning Agentic Policy from Action Guidance

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yuxiang Ji, Zengbin Wang, Yong Wang, Shidong Yang, Ziyu Ma, Guanhua Chen, Zonghua Sun, Liaoni Wu, Xiangxiang Chu
- **URL**: <http://arxiv.org/abs/2605.12004v1>
- **Submitted**: 2026-05-12 11:54:23
- **Comment**: Work in progress
- **Topic Keywords**: search
- **Reason**: This paper focuses on reinforcement learning for Large Language Models, which is not directly related to your core research interests in Information Retrieval and Search technologies. While it touches on the concept of guidance, it's more aligned with NLP and RL, but lacks direct relevance to your primary focus areas.
...
### 48. Quality-Aware Collaborative Multi-Positive Contrastive Learning for Sequential Recommendation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Wei Wang
- **URL**: <http://arxiv.org/abs/2605.11707v1>
- **Submitted**: 2026-05-12 08:00:01
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on sequential recommendation using contrastive learning, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The paper's emphasis on recommender systems and sequential data also diverges from the author's primary focus on information retrieval and deep semantic understanding.
...
### 49. Anti-Self-Distillation for Reasoning RL via Pointwise Mutual Information
...
- **Submitted**: 2026-05-12 06:40:43
- **Topic Keywords**: pointwise, search
- **Reason**: This paper appears to be focused on a specific area of Reinforcement Learning (RL) and self-distillation, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve language models, the context and application are quite different from your areas of interest.
...
### 50. On the LSH Distortion of Ulam and Cayley Similarities

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Flavio Chierichetti, Mirko Giacchini, Ravi Kumar, Erasmo Tani
- **URL**: <http://arxiv.org/abs/2605.11921v1>
- **Submitted**: 2026-05-12 10:36:46
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on the theoretical aspects of Locality-Sensitive Hashing (LSH) and its distortion, which is a topic in the field of algorithms and data structures. It does not relate to Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling, which are your core research themes.
