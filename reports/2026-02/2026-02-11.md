# Daily Papers Report - 2026-02-11

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. SARM: LLM-Augmented Semantic Anchor for End-to-End Live-Streaming Ranking
...
- **Submitted**: 2026-02-10 04:15:53
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of ranking models and real-time relevance optimization. The proposed SARM architecture integrates semantic anchors into ranking optimization, which aligns with your focus on deep semantic understanding. The application to live-streaming recommendation also falls within your broader interest in e-commerce and related domains.
...
### 2. Query-Mixed Interest Extraction and Heterogeneous Interaction: A Scalable CTR Model for Industrial Recommender Systems

- **LLM Score**: 8
- **Keyword Score**: 20
- **Authors**: Fangye Wang, Guowei Yang, Xiaojiang Zhou, Song Yang, Pengjie Wang
- **URL**: <http://arxiv.org/abs/2602.09387v1>
- **Submitted**: 2026-02-10 03:56:14
- **Topic Keywords**: query, queries, ranking, ltr, user behavior, ctr, cvr, recommend, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed HeMix model addresses challenges in industrial recommender systems, which aligns with your background in e-commerce. However, the focus on recommender systems is somewhat secondary to your primary interest in information retrieval.
...
### 3. The Wisdom of Many Queries: Complexity-Diversity Principle for Dense Retriever Training

- **LLM Score**: 8
- **Keyword Score**: 14
- **Authors**: Xincan Feng, Noriki Nishida, Yusuke Sakai, Yuji Matsumoto
- **URL**: <http://arxiv.org/abs/2602.09448v1>
- **Submitted**: 2026-02-10 06:33:10
- **Comment**: Under review
- **Topic Keywords**: retriever, dense retrieval, query, queries, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The study focuses on dense retrieval and query diversity, which are key aspects of query understanding. The proposed Complexity-Diversity Principle (CDP) and its application to multi-hop retrieval tasks align with your interests in real-time relevance optimization and deep semantic understanding.
...
- **URL**: <http://arxiv.org/abs/2602.09901v1>
- **Submitted**: 2026-02-10 15:38:17
- **Topic Keywords**: query, ranking, relevance, retrieval, rank, search
- **Reason**: This paper presents a unified generative LLM for multi-task query understanding in the SNS domain, which aligns with your interests in query understanding and ranking models. The use of a unified sequence generation paradigm and multi-reward Reinforcement Learning is particularly relevant to your focus on deep semantic understanding and real-time relevance optimization.
...
### 5. Comprehensive Comparison of RAG Methods Across Multi-Domain Conversational QA

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Klejda Alushi, Jan Strich, Chris Biemann, Martin Semmann
- **URL**: <http://arxiv.org/abs/2602.09552v1>
- **Submitted**: 2026-02-10 08:59:23
- **Comment**: Accepted to EACL SRW 26
- **Topic Keywords**: ranking, rerank, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of conversational question answering and retrieval-augmented generation (RAG) methods. The study's focus on evaluating RAG methods for multi-turn conversational QA and its use of various metrics aligns with your interests in query understanding and ranking models. However, the paper's primary focus on conversational QA and NLP might not be a central match to your core research themes.
...
### 6. Decoupled Reasoning with Implicit Fact Tokens (DRIFT): A Dual-Model Framework for Efficient Long-Context Inference

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Wenxuan Xie, Yujia Wang, Xin Tan, Chaochao Lu, Xia Hu, Xuhong Wang
- **URL**: <http://arxiv.org/abs/2602.10021v1>
- **Submitted**: 2026-02-10 17:42:31
- **Topic Keywords**: retriever, query, rag, retrieval
- **Reason**: This paper proposes a novel dual-model architecture for efficient long-context inference, which aligns with your interests in query understanding and ranking models. Although it focuses on Large Language Models and knowledge extraction, it touches on the theme of deep semantic understanding and real-time relevance optimization, making it somewhat relevant to your research.
...
### 7. With Argus Eyes: Assessing Retrieval Gaps via Uncertainty Scoring to Detect and Remedy Retrieval Blind Spots

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Zeinab Sadat Taghavi, Ali Modarressi, Hinrich Schutze, Andreas Marfurt
- **URL**: <http://arxiv.org/abs/2602.09616v1>
- **Submitted**: 2026-02-10 10:04:55
- **Comment**: 8 pages
- **Topic Keywords**: retriever, query, rag, retrieval
- **Reason**: This paper is highly relevant to your interests in Information Retrieval, specifically query understanding and ranking models. The authors propose a method to detect and remedy retrieval blind spots, which is a critical aspect of building robust and trustworthy retrieval-augmented generation systems. The paper's focus on entity embedding geometry and targeted document augmentation aligns with your research themes.
...
### 8. Steer2Edit: From Activation Steering to Component-Level Editing

- **LLM Score**: 8
- **Keyword Score**: 3
- **Authors**: Chung-En Sun, Ge Yan, Zimo Wang, Tsui-Wei Weng
- **URL**: <http://arxiv.org/abs/2602.09870v1>
- **Submitted**: 2026-02-10 15:15:15
- **Topic Keywords**: rag, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The proposed Steer2Edit framework is a novel approach to influencing Large Language Model behavior, which is a key aspect of query understanding and ranking models. However, the paper's focus on NLP and deep semantic understanding is not directly related to your e-commerce background, which is why the score is not a perfect 10.
...
### 9. Efficient Learning of Sparse Representations from Interactions

- **LLM Score**: 6
- **Keyword Score**: 3
- **Authors**: Vojtěch Vančura, Martin Spišák, Rodrigo Alves, Ladislav Peška
- **URL**: <http://arxiv.org/abs/2602.09935v1>
- **Submitted**: 2026-02-10 16:09:58
- **Comment**: In the proceedings of the Web Conference (WWW) 2026 (4 pages)
- **Topic Keywords**: retrieval, recommend
- **Reason**: The paper explores efficient learning of sparse representations from interactions, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on recommender systems and collaborative filtering autoencoders is not a central match to the user's primary research interests in IR and NLP. The paper's emphasis on interpretability and real-time relevance optimization is somewhat aligned with the user's interests, but not enough to justify a higher score.
...
### 10. AmharicIR+Instr: A Two-Dataset Resource for Neural Retrieval and Instruction Tuning

- **LLM Score**: 4
- **Keyword Score**: 19
- **Authors**: Tilahun Yeshambel, Moncef Garouani, Josiane Mothe
- **URL**: <http://arxiv.org/abs/2602.09914v1>
- **Submitted**: 2026-02-10 15:45:20
- **Comment**: 7 pages, Submitted to resource track
- **Topic Keywords**: retriever, query, queries, ranking, relevance, retrieval, rank, search
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the context of low-resource languages and neural retrieval models. However, the focus on Amharic language and instruction-following text generation is not a central match to the user's core research themes.
...
### 11. CAPID: Context-Aware PII Detection for Question-Answering Systems
...
- **Submitted**: 2026-02-10 18:41:31
- **Comment**: Accepted to the Student Research Workshop at EACL 2026
- **Topic Keywords**: queries, relevance, rag
- **Reason**: The paper focuses on context-aware PII detection for question-answering systems, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the primary focus is on privacy-preserving PII detection, which is not a central match to the user's core research themes. The paper does involve NLP and language models, but the context is more specific to PII detection rather than general IR or search technologies.
...
### 12. SCORE: Specificity, Context Utilization, Robustness, and Relevance for Reference-Free LLM Evaluation

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Homaira Huda Shomee, Rochana Chaturvedi, Yangxinyu Xie, Tanwi Mallick
- **URL**: <http://arxiv.org/abs/2602.10017v1>
- **Submitted**: 2026-02-10 17:39:17
- **Topic Keywords**: relevance, rag, retrieval
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, as it deals with evaluation frameworks for large language models. However, its focus on reference-free evaluation of LLMs for question answering and decision-making in specific domains is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.
...
### 13. AnalyticsGPT: An LLM Workflow for Scientometric Question Answering

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Khang Ly, Georgios Cheirmpos, Adrian Raudaschl, Christopher James, Seyed Amin Tabatabaei
- **URL**: <http://arxiv.org/abs/2602.09817v1>
- **Submitted**: 2026-02-10 14:23:55
- **Topic Keywords**: rag, retrieval, search, acl
- **Reason**: The paper introduces AnalyticsGPT, an LLM-powered workflow for scientometric question answering, which is related to information retrieval and NLP. However, the focus on scientometric question answering and meta-scientific questions is somewhat niche and not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 14. Beyond the Unit Hypersphere: Embedding Magnitude in Contrastive Learning

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Xincan Feng, Taro Watanabe
- **URL**: <http://arxiv.org/abs/2602.09229v1>
- **Submitted**: 2026-02-09 21:53:23
- **Comment**: Preliminary work. Under review
- **Topic Keywords**: relevance, rag, retrieval
- **Reason**: This paper explores contrastive learning and embedding magnitude, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on text retrieval and the task symmetry principle does not directly align with the user's core research themes, such as deep semantic understanding and real-time relevance optimization.
...
### 15. FlyAOC: Evaluating Agentic Ontology Curation of Drosophila Scientific Knowledge Bases

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Xingjian Zhang, Sophia Moylan, Ziyang Xiong, Qiaozhu Mei, Yichen Luo, Jiaqi W. Ma
- **URL**: <http://arxiv.org/abs/2602.09163v1>
- **Submitted**: 2026-02-09 20:12:38
- **Topic Keywords**: query, retrieval, search
- **Reason**: The paper FlyAOC discusses the evaluation of AI agents on ontology curation from scientific literature, which is somewhat related to information retrieval and NLP. However, the focus on ontology curation and scientific knowledge bases is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling.
...
### 16. Anagent For Enhancing Scientific Table & Figure Analysis

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Xuehang Guo, Zhiyong Lu, Tom Hope, Qingyun Wang
- **URL**: <http://arxiv.org/abs/2602.10081v1>
- **Submitted**: 2026-02-10 18:46:28
- **Topic Keywords**: rag, search, acl
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves analysis and interpretation of complex multimodal knowledge. However, the focus on scientific table and figure analysis is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. The paper's use of multi-agent framework and reinforcement learning is an interesting aspect, but it is not a central match for your research themes.
...
### 17. LLMs Encode Their Failures: Predicting Success from Pre-Generation Activations

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: William Lugoloobi, Thomas Foster, William Bankes, Chris Russell
- **URL**: <http://arxiv.org/abs/2602.09924v1>
- **Submitted**: 2026-02-10 15:57:00
- **Topic Keywords**: queries, rag
- **Reason**: This paper explores the internal representations of Large Language Models (LLMs) to predict their success on specific tasks, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and their internal workings is not a central match to the user's research interests, which are more focused on search technologies and user behavior modeling.
...
### 18. DiffuReason: Bridging Latent Reasoning and Generative Refinement for Sequential Recommendation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Jie Jiang, Yang Wu, Qian Li, Yuling Xiong, Yihang Su, Junbang Huo, Longfei Lu, Jun Zhang, Huan Yu
- **URL**: <http://arxiv.org/abs/2602.09744v1>
- **Submitted**: 2026-02-10 12:55:30
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: The paper focuses on sequential recommendation, which is somewhat related to information retrieval, but it primarily deals with recommender systems. While it involves deep semantic understanding and probabilistic modeling, the context is not directly aligned with the user's core research themes in IR and search technologies.
...
### 19. Self-Supervised Learning as Discrete Communication

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Kawtar Zaher, Ilyass Moummad, Olivier Buisson, Alexis Joly
- **URL**: <http://arxiv.org/abs/2602.09764v1>
- **Submitted**: 2026-02-10 13:24:06
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores self-supervised learning as a discrete communication process, which is somewhat related to information retrieval and ranking models, but it primarily focuses on visual representation learning and not directly on query understanding or user behavior modeling. The use of discrete communication and binary codes is an interesting approach, but it doesn't seem to be a central match with the user's core research themes.
...
- **URL**: <http://arxiv.org/abs/2602.09574v1>
- **Submitted**: 2026-02-10 09:23:26
- **Topic Keywords**: query, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of large language models (LLMs) and test-time scaling. However, the focus on tree-search decoding and token budgets in real-world deployment settings is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 21. Evaluating Social Bias in RAG Systems: When External Context Helps and Reasoning Hurts

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Shweta Parihar, Lu Cheng
- **URL**: <http://arxiv.org/abs/2602.09442v1>
- **Submitted**: 2026-02-10 06:27:56
...
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores social bias in Retrieval-Augmented Generation (RAG) systems, which is related to query understanding and ranking models in Information Retrieval. However, the focus on bias in NLP and the use of external context and Chain-of-Thought prompting does not directly align with the user's primary interests in search technologies and user behavior modeling.
...
### 22. Internalizing Multi-Agent Reasoning for Accurate and Efficient LLM-based Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Yang Wu, Haoze Wang, Qian Li, Jun Zhang, Huan Yu, Jie Jiang
- **URL**: <http://arxiv.org/abs/2602.09829v1>
- **Submitted**: 2026-02-10 14:36:59
- **Topic Keywords**: rag, recommend
- **Reason**: The paper explores recommender systems, leveraging large language models for semantic reasoning, which is somewhat related to the user's interests in information retrieval and NLP. However, the focus on recommender systems and the specific application of large language models in this context limits its relevance to the user's core research themes. The paper's emphasis on real-time optimization and efficiency is also somewhat aligned with the user's interests in search technologies and user behavior modeling.
...
### 23. Personalized Parameter-Efficient Fine-Tuning of Foundation Models for Multimodal Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Sunwoo Kim, Hyunjin Hwang, Kijung Shin
- **URL**: <http://arxiv.org/abs/2602.09445v1>
- **Submitted**: 2026-02-10 06:30:03
- **Comment**: To be published at The Web Conference 2026 (WWW 2026)
- **Topic Keywords**: recommend, personalization, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it focuses more on recommendation systems and multimodal data. While it involves fine-tuning and parameter-efficient methods, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are your primary areas of interest.
...
### 24. MEVER: Multi-Modal and Explainable Claim Verification with Graph-based Evidence Retrieval

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Delvin Ce Zhang, Suhan Cui, Zhelin Chu, Xianren Zhang, Dongwon Lee
- **URL**: <http://arxiv.org/abs/2602.10023v1>
- **Submitted**: 2026-02-10 17:44:57
- **Comment**: Accepted to EACL-26
- **Topic Keywords**: retrieval
- **Reason**: The paper focuses on claim verification, which involves multi-modal reasoning and evidence retrieval, but it does not directly relate to information retrieval, query understanding, or ranking models. While it touches on the idea of fusion and explanation generation, it is more aligned with NLP and data mining, but not specifically with real-time relevance optimization or deep semantic understanding in the context of search technologies.
...
### 25. ATTNPO: Attention-Guided Process Supervision for Efficient Reasoning

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Shuaiyi Nie, Siyu Ding, Wenyuan Zhang, Linhao Yu, Tianmeng Yang, Yao Chen, Tingwen Liu, Weichong Yin, Yu Sun, Hua Wu
- **URL**: <http://arxiv.org/abs/2602.09953v1>
- **Submitted**: 2026-02-10 16:40:22
- **Comment**: Work in process
- **Topic Keywords**: rag
- **Reason**: The paper focuses on improving reasoning models, specifically addressing overthinking and redundant steps, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on reasoning and process supervision does not directly align with the user's core research themes in IR and Search technologies. The use of attention mechanisms is a relevant aspect, but it is not the primary focus of the paper.
...
### 26. Unsupervised Layer-Wise Dynamic Test Time Adaptation for LLMs

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Longhuan Xu, Cunjian Chen, Feng Yin
- **URL**: <http://arxiv.org/abs/2602.09719v1>
- **Submitted**: 2026-02-10 12:22:14
- **Topic Keywords**: rag
- **Reason**: This paper focuses on test-time adaptation for large language models, which is somewhat related to information retrieval, particularly in the context of query understanding and ranking models. However, the specific topic of TTA for LLMs is not directly aligned with the user's core research themes in IR and search technologies. The paper's emphasis on NLP and deep semantic understanding is relevant, but the connection to the user's interests is not strong enough to warrant a higher score.
...
### 27. MATA: Multi-Agent Framework for Reliable and Flexible Table Question Answering

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Sieun Hyeon, Jusang Oh, Sunghwan Steve Cho, Jaeyoung Do
- **URL**: <http://arxiv.org/abs/2602.09642v1>
- **Submitted**: 2026-02-10 10:43:02
- **Topic Keywords**: rag
- **Reason**: While this paper explores a related topic in Natural Language Processing (NLP), specifically Table Question Answering, it does not directly align with the user's core research themes in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling. The paper's focus on leveraging multiple reasoning paths and small language models is somewhat relevant to the user's interests in deep semantic understanding and real-time relevance optimization, but it is not a central match.
...
### 28. MILE-RefHumEval: A Reference-Free, Multi-Independent LLM Framework for Human-Aligned Evaluation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Nalin Srun, Parisa Rastin, Guénaël Cabanes, Lydia Boudjeloud Assala
- **URL**: <http://arxiv.org/abs/2602.09624v1>
- **Submitted**: 2026-02-10 10:10:41
- **Topic Keywords**: rag
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and Large Language Models (LLMs), but it does not directly address query understanding, ranking models, or user behavior modeling in the context of Information Retrieval. The framework presented in the paper is primarily focused on evaluating LLMs, which is a related but distinct area of research.
...
- **Submitted**: 2026-02-10 09:20:24
- **Comment**: Accepted at EACL SRW 26
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of multilingual legal settings. However, it focuses on the creation of a corpus for fine-tuning multilingual law embedding models, which is not directly aligned with the user's primary focus on query understanding, ranking models, and user behavior modeling. The paper's use of large language models and semantic retrieval is somewhat relevant, but it is not a central match for the user's research interests.
...
### 30. The CLEF-2026 CheckThat! Lab: Advancing Multilingual Fact-Checking
...
- **Submitted**: 2026-02-10 08:20:18
- **Comment**: misinformation, disinformation, fact-checking, claim source retrieval, generating fact-checking articles
- **Topic Keywords**: retrieval
- **Reason**: The paper is loosely relevant to the user's interests in Information Retrieval, particularly in the context of fact-checking and disinformation detection. However, it focuses more on the verification pipeline and fact-checking tasks, which, while related to query understanding and ranking models, are not a central match to the user's core research themes. The paper's emphasis on multilingual settings and generation challenges also aligns with the user's interests in NLP, but the connection is not strong enough to warrant a higher score.
...
### 31. Listen to the Layers: Mitigating Hallucinations with Inter-Layer Disagreement
...
- **Submitted**: 2026-02-10 07:32:37
- **Comment**: Preprint, 23 pages, 13 tables, 12 figures
- **Topic Keywords**: rag
- **Reason**: The paper explores a problem in Natural Language Processing (NLP), specifically hallucinations in Large Language Models (LLMs), which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and their internal workings is not directly aligned with the user's primary research interests in IR and search technologies. The paper's relevance is further limited by its focus on NLP applications rather than IR or search technologies.
...
### 32. Conceptual Cultural Index: A Metric for Cultural Specificity via Relative Generality

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Takumi Ohashi, Hitoshi Iyatomi
- **URL**: <http://arxiv.org/abs/2602.09444v1>
- **Submitted**: 2026-02-10 06:29:33
- **Comment**: 9 pages, 2 figures, 8 tables. Accepted at the First Workshop on Multilingual Multicultural Evaluation (MME) @ EACL 2026
- **Topic Keywords**: rag
- **Reason**: This paper proposes a metric for cultural specificity in language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on cultural specificity and generality estimates is not directly aligned with the user's core research themes in IR and NLP. The paper's relevance is limited to the broader context of language understanding and model evaluation.
...
### 33. Overview of the TREC 2025 RAGTIME Track
...
- **Submitted**: 2026-02-10 17:47:20
- **Comment**: 10 pages, 3 figures, notebook version of the RAGTIME 2025 overview paper
- **Topic Keywords**: information retrieval, rag, retrieval, trec
- **Reason**: This paper appears to be related to information retrieval, but its focus on report generation and multilingual evaluation does not align with the user's primary interests in query understanding, ranking models, and user behavior modeling. The mention of multilingual information retrieval (MLIR) is somewhat relevant, but the overall context is not directly related to the user's core research themes.
...
### 34. Learning from the Irrecoverable: Error-Localized Policy Optimization for Tool-Integrated LLM Reasoning

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Qiao Liang, Yuke Zhu, Chao Ge, Lei Yang, Ying Shen, Bo Zheng, Sheng Guo
- **URL**: <http://arxiv.org/abs/2602.09598v1>
- **Submitted**: 2026-02-10 09:50:24
- **Comment**: 20 pages, 11 figures
- **Topic Keywords**: ranking, rag, rank, search
- **Reason**: This paper focuses on tool-integrated reasoning and reinforcement learning, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves LLM agents, the context is more aligned with AI planning and tool use rather than query understanding, ranking models, or user behavior modeling.
...
### 35. SMES: Towards Scalable Multi-Task Recommendation via Expert Sparsity
...
- **URL**: <http://arxiv.org/abs/2602.09386v1>
- **Submitted**: 2026-02-10 03:56:12
- **Topic Keywords**: ranking, recommend, rank, acl
- **Reason**: This paper focuses on recommender systems and multi-task learning, which is somewhat related to your interests in Information Retrieval and Search technologies. However, it does not directly address query understanding, ranking models, or user behavior modeling, and its primary focus is on recommender systems rather than IR.
...
### 36. An Interactive Metrics Dashboard for the Keck Observatory Archive

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: G. Bruce Berriman, Min Phone Myat Zaw
- **URL**: <http://arxiv.org/abs/2602.09126v1>
- **Submitted**: 2026-02-09 19:16:55
- **Comment**: 4 pages, 2 figures, Submitted to Proc. ADASS 2025
- **Topic Keywords**: query, queries
- **Reason**: This paper is not relevant to your research interests as it focuses on developing a metrics dashboard for an astronomical archive, which is unrelated to information retrieval, search technologies, or natural language processing.
...
### 37. AlignTune: Modular Toolkit for Post-Training Alignment of Large Language Models
...
- **URL**: <http://arxiv.org/abs/2602.09621v2>
- **Submitted**: 2026-02-10 10:08:51
- **Comment**: Library opensource and available at https://github.com/Lexsi-Labs/aligntune
- **Topic Keywords**: rag, search, acl
- **Reason**: This paper focuses on post-training alignment of large language models, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves NLP, the context is more aligned with model fine-tuning and optimization rather than query understanding, ranking models, or recommender systems.
...
### 38. Where-to-Unmask: Ground-Truth-Guided Unmasking Order Learning for Masked Diffusion Language Models

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Hikaru Asano, Tadashi Kozuno, Kuniaki Saito, Yukino Baba
- **URL**: <http://arxiv.org/abs/2602.09501v1>
- **Submitted**: 2026-02-10 07:56:46
- **Comment**: 15 pages, 6 figures
- **Topic Keywords**: rag, rank, acl
- **Reason**: This paper focuses on masked diffusion language models and introduces a method to improve generation quality by optimizing unmasking order. While it touches on learning-to-rank, which is related to your interests in ranking models, the primary topic is NLP and language model optimization, which is not a central match for your research interests.
...
### 39. Decomposing Reasoning Efficiency in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Daniel Kaiser, Arnoldo Frigessi, Ali Ramezani-Kebrya, Benjamin Ricaud
- **URL**: <http://arxiv.org/abs/2602.09805v1>
- **Submitted**: 2026-02-10 14:09:18
- **Comment**: Preprint (under review). 29 pages, 4 figures
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on the efficiency of large language models in reasoning tasks, introducing a framework to decompose token efficiency into interpretable factors. While it touches on the idea of optimizing model performance, it doesn't directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 40. SWE-AGI: Benchmarking Specification-Driven Software Construction with MoonBit in the Era of Autonomous Agents
...
- **Submitted**: 2026-02-10 06:31:47
- **Comment**: 20 pages, 3 figures
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on software construction and autonomous agents, which is outside your primary areas of interest.
...
### 41. Are Language Models Sensitive to Morally Irrelevant Distractors?
...
- **Submitted**: 2026-02-10 05:18:05
- **Topic Keywords**: relevance, search
- **Reason**: This paper focuses on the sensitivity of language models to morally irrelevant distractors, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on language models, it's more aligned with the NLP and cognitive modeling aspects, but lacks a clear connection to your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 42. Quantum-Audit: Evaluating the Reasoning Limits of LLMs on Quantum Computing
...
- **Submitted**: 2026-02-10 18:56:04
- **Comment**: 18 pages
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests as it focuses on evaluating the reasoning limits of Large Language Models (LLMs) on quantum computing, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
- **URL**: <http://arxiv.org/abs/2602.09590v1>
- **Submitted**: 2026-02-10 09:45:21
- **Topic Keywords**: relevance
- **Reason**: The paper primarily focuses on mitigating social bias in language models, which is not a central match to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve language models, the context and application are quite different from your areas of focus.
...
### 44. AfriNLLB: Efficient Translation Models for African Languages

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yasmin Moslem, Aman Kassahun Wassie, Amanuel Gizachew Abebe
- **URL**: <http://arxiv.org/abs/2602.09373v1>
- **Submitted**: 2026-02-10 03:23:59
- **Comment**: Accepted at AfricaNLP 2026 (oral)
- **Topic Keywords**: ctr, search
- **Reason**: This paper focuses on developing efficient translation models for African languages, which is outside the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and goal of the paper do not align with the user's core research themes.
...
### 45. AgentSkiller: Scaling Generalist Agent Intelligence through Semantically Integrated Cross-Domain Data Synthesis

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Zexu Sun, Bokai Ji, Hengyi Cai, Shuaiqiang Wang, Lei Wang, Guangxia Li, Xu Chen
- **URL**: <http://arxiv.org/abs/2602.09372v1>
- **Submitted**: 2026-02-10 03:21:42
- **Comment**: 33 pages, 9 figures
- **Topic Keywords**: queries
- **Reason**: This paper focuses on generalist agent intelligence and data synthesis, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models and data generation, the context and goals are distinct from your areas of focus.
...
### 46. Agent World Model: Infinity Synthetic Environments for Agentic Reinforcement Learning
...
- **Submitted**: 2026-02-10 18:55:41
- **Comment**: 41 pages
- **Topic Keywords**: rag
- **Reason**: This paper appears to be off-topic as it focuses on reinforcement learning and synthetic environment generation for autonomous agents, which does not align with your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 47. Kunlun: Establishing Scaling Laws for Massive-Scale Recommendation Systems through Unified Architecture Design
...
- **URL**: <http://arxiv.org/abs/2602.10016v1>
- **Submitted**: 2026-02-10 17:37:55
- **Comment**: 10 pages, 4 figures
- **Topic Keywords**: recommend, personalization
- **Reason**: This paper focuses on recommendation systems and scalable architecture design, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the specific domain and focus on recommender systems, rather than IR, limits its relevance to your core research themes.
...
- **URL**: <http://arxiv.org/abs/2602.09823v1>
- **Submitted**: 2026-02-10 14:31:11
- **Comment**: Technical Report
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on a large-scale audio model, Covo-Audio, which is primarily related to Natural Language Processing (NLP) and speech understanding. While it involves deep semantic understanding, it is not directly related to Information Retrieval (IR) or Search technologies, which are the core of your research interests.
...
### 49. Flexible Entropy Control in RLVR with Gradient-Preserving Perspective

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Kun Chen, Peng Shi, Fanfan Liu, Haibo Qiu, Zhixiong Zeng, Siqi Yang, Wenji Mao
- **URL**: <http://arxiv.org/abs/2602.09782v1>
- **Submitted**: 2026-02-10 13:42:12
- **Comment**: https://github.com/Kwen-Chen/Flexible-Entropy-Control
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Reinforcement Learning with Verifiable Rewards (RLVR) and Large Language Models (LLMs), which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on gradient clipping and entropy control, the context is specific to RLVR and LLMs, making it less relevant to your primary areas of focus.
...
### 50. NOWJ @BioCreative IX ToxHabits: An Ensemble Deep Learning Approach for Detecting Substance Use and Contextual Information in Clinical Texts

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Huu-Huy-Hoang Tran, Gia-Bao Duong, Quoc-Viet-Anh Tran, Thi-Hai-Yen Vuong, Hoang-Quynh Le
- **URL**: <http://arxiv.org/abs/2602.09469v1>
- **Submitted**: 2026-02-10 07:04:44
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on clinical Natural Language Processing, specifically on extracting drug use information from Electronic Health Records, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves NLP, the context and application are quite different from the user's interests in query understanding, ranking models, and user behavior modeling.
