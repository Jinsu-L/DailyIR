...
### 1. Transforming OPACs into Intelligent Discovery Systems: An AI-Powered, Knowledge Graph-Driven Smart OPAC for Digital Libraries

- **LLM Score**: 8
- **Keyword Score**: 13
- **Authors**: M. S. Rajeevan, B. Mini Devi
- **URL**: <http://arxiv.org/abs/2604.01262v1>
- **Submitted**: 2026-04-01 12:48:36
- **Comment**: 8 pages, 4 tables, 6 figures presented at Intellib 2026 International Conference
- **Topic Keywords**: semantic search, queries, relevance, retrieval, personalization, search
- **Reason**: This paper aligns with your interests in Information Retrieval, particularly in the context of digital libraries and knowledge graph-driven search. The focus on semantic search, thematic filtering, and knowledge graph-based visualization is relevant to your work on query understanding and ranking models. However, the e-commerce domain is not explicitly mentioned, which is why the score is not higher.
...
### 2. AfrIFact: Cultural Information Retrieval, Evidence Extraction and Fact Checking for African Languages
...
- **URL**: <http://arxiv.org/abs/2604.00706v1>
- **Submitted**: 2026-04-01 10:08:37
- **Topic Keywords**: information retrieval, rag, retrieval
- **Reason**: The paper is highly relevant to Information Retrieval, particularly in the context of low-resource languages and cross-lingual retrieval. The focus on fact-checking, evidence extraction, and the use of Learning to Rank (LLMs) models aligns with the user's interests in query understanding and ranking models. However, the specific domain of African languages and cultures is somewhat of a departure from the user's background in e-commerce.
...
### 3. Evidence Units: Ontology-Grounded Document Organization for Parser-Independent Retrieval

- **LLM Score**: 8
- **Keyword Score**: 7
- **Authors**: Yeonjee Han
- **URL**: <http://arxiv.org/abs/2604.00500v1>
- **Submitted**: 2026-04-01 05:32:16
- **Comment**: 16 pages, 4 figures
- **Topic Keywords**: queries, rag, retrieval
- **Reason**: This paper presents a novel approach to document organization and retrieval, focusing on parser-independent Evidence Units that group visual assets with contextual text. The method involves ontology-grounded role normalization, semantic global assignment, and graph-based decision layers, which aligns with the user's interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on improving retrieval performance and recall@1 also resonates with the user's focus on information retrieval and real-time relevance optimization.
...
- **URL**: <http://arxiv.org/abs/2604.00242v1>
- **Submitted**: 2026-03-31 21:09:03
- **Topic Keywords**: relevance, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically query understanding and ranking models. The proposed FGR-ColBERT model integrates fine-grained relevance signals, which is a key aspect of deep semantic understanding in IR. The paper's focus on retrieval effectiveness and efficiency also aligns with your interests.
...
- **URL**: <http://arxiv.org/abs/2604.00715v1>
- **Submitted**: 2026-04-01 10:26:03
- **Comment**: Code and data at https://github.com/DegenAI-Labs/RAG-scaling-laws
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of language models and retrieval-augmented generation. The study of scaling laws for RAG-considerate pretraining is closely related to your focus on query understanding, ranking models, and user behavior modeling. However, the paper's primary focus on language models and pretraining might not be a central match to your interests, which is why we scored it an 8.
...
### 6. ORBIT: Scalable and Verifiable Data Generation for Search Agents on a Tight Budget

- **LLM Score**: 6
- **Keyword Score**: 7
- **Authors**: Nandan Thakur, Zijian Chen, Xueguang Ma, Jimmy Lin
- **URL**: <http://arxiv.org/abs/2604.01195v2>
- **Submitted**: 2026-04-01 17:42:41
- **Comment**: Preprint
- **Topic Keywords**: queries, retrieval, web search, search
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of search agents and language models. However, the focus on data generation and synthetic datasets for training search agents is not a central match for the user's primary research themes of query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.00513v2>
- **Submitted**: 2026-04-01 05:55:25
- **Comment**: 10 pages, 6 figures
- **Topic Keywords**: rag, commerce, e-commerce
- **Reason**: The paper focuses on multimodal representation learning for e-commerce product understanding, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the specific application domain (e-commerce) and the emphasis on product representation learning are not central to the user's core research themes. The use of multimodal large language models and reasoning capabilities is somewhat relevant to the user's interests in NLP and deep semantic understanding.
...
### 8. Revisiting Human-in-the-Loop Object Retrieval with Pre-Trained Vision Transformers

- **LLM Score**: 4
- **Keyword Score**: 13
- **Authors**: Kawtar Zaher, Olivier Buisson, Alexis Joly
- **URL**: <http://arxiv.org/abs/2604.00809v1>
- **Submitted**: 2026-04-01 12:18:17
- **Topic Keywords**: query, relevance, relevance feedback, rag, retrieval
- **Reason**: The paper explores Human-in-the-Loop Object Retrieval, which is related to Information Retrieval and query understanding. However, the focus on computer vision and object recognition, while interesting, is not a central match to your primary research interests in IR, ranking models, and user behavior modeling.
...
### 9. STCALIR: Semi-Synthetic Test Collection for Algerian Legal Information Retrieval

- **LLM Score**: 4
- **Keyword Score**: 12
- **Authors**: M'hamed Amine Hatem, Sofiane Batata, Amine Mammasse, Faiçal Azouaou
- **URL**: <http://arxiv.org/abs/2604.00731v1>
- **Submitted**: 2026-04-01 10:50:28
- **Topic Keywords**: information retrieval, ranking, relevance, retrieval, rank
- **Reason**: The paper focuses on test collection construction for legal information retrieval, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the specific domain (Algerian legal texts) and the approach (semi-synthetic test collection) are not directly aligned with the user's core research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 10. Screening Is Enough

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Ken M. Nakanishi
- **URL**: <http://arxiv.org/abs/2604.01178v1>
- **Submitted**: 2026-04-01 17:29:08
- **Comment**: 21 pages, 13 figures
- **Topic Keywords**: query, relevance, retrieval
- **Reason**: The paper discusses a novel attention mechanism called Multiscreen, which enables absolute query-key relevance. While it is related to query understanding and ranking models, the focus is on improving language model architecture rather than information retrieval or search technologies. The paper's emphasis on reducing inference latency and improving model stability is also relevant to the broader field of NLP.
...
### 11. Doctor-RAG: Failure-Aware Repair for Agentic Retrieval-Augmented Generation

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Shuguang Jiao, Chengkai Huang, Shuhan Qi, Xuan Wang, Yifan Li, Lina Yao
- **URL**: <http://arxiv.org/abs/2604.00865v1>
- **Submitted**: 2026-04-01 13:13:27
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of multi-hop question answering and complex knowledge reasoning. However, the focus on Retrieval-Augmented Generation and failure-aware repair is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 12. True (VIS) Lies: Analyzing How Generative AI Recognizes Intentionality, Rhetoric, and Misleadingness in Visualization Lies

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Graziano Blasilli, Marco Angelini
- **URL**: <http://arxiv.org/abs/2604.01181v1>
- **Submitted**: 2026-04-01 17:33:10
- **Topic Keywords**: rag, search
- **Reason**: The paper explores the capabilities of Large Language Models (LLMs) in recognizing misleading visualizations, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on visualization and multimodal analysis is not directly aligned with the user's core research themes. The connection to Natural Language Processing (NLP) and data mining is also present, but the paper's scope is more specialized.
...
- **URL**: <http://arxiv.org/abs/2604.01029v1>
- **Submitted**: 2026-04-01 15:39:40
- **Topic Keywords**: queries
- **Reason**: This paper explores the effectiveness of multi-LLM revision pipelines, which is somewhat related to information retrieval and search technologies. However, the focus on multi-LLM pipelines and their decomposition into different components is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. While the paper touches on the idea of task structure and draft quality, which could be relevant to information retrieval, the connection is not strong enough to warrant a higher score.
...
### 14. Do Language Models Know When They'll Refuse? Probing Introspective Awareness of Safety Boundaries

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Tanay Gondil
- **URL**: <http://arxiv.org/abs/2604.00228v1>
- **Submitted**: 2026-03-31 20:49:34
- **Comment**: 11 pages, 5 figures
- **Topic Keywords**: queries
- **Reason**: This paper explores the introspective awareness of safety boundaries in large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language model safety and refusal behavior is not directly aligned with the user's primary research interests in IR and NLP. The paper's findings on confidence scores providing actionable signal may be of interest, but it is not a central match for the user's research themes.
...
### 15. Speech LLMs are Contextual Reasoning Transcribers

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Keqi Deng, Ruchao Fan, Bo Ren, Yiming Wang, Jinyu Li
- **URL**: <http://arxiv.org/abs/2604.00610v1>
- **Submitted**: 2026-04-01 08:13:50
- **Topic Keywords**: rag
- **Reason**: This paper explores the application of large language models in automatic speech recognition, proposing a novel approach called CoT-ASR. While it leverages contextual reasoning and user-guided transcription, the focus is on speech recognition rather than information retrieval or search technologies, which are the primary areas of interest. The paper's relevance to IR and NLP is somewhat tangential, but it does involve deep semantic understanding and real-time optimization.
...
### 16. Ontology-Constrained Neural Reasoning in Enterprise Agentic Systems: A Neurosymbolic Architecture for Domain-Grounded AI Agents

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Thanh Luong Tuan
- **URL**: <http://arxiv.org/abs/2604.00555v1>
- **Submitted**: 2026-04-01 06:59:15
...
- **Topic Keywords**: rag
- **Reason**: The paper discusses ontology-constrained neural reasoning in enterprise systems, which is somewhat related to information retrieval and search technologies, particularly in the context of deep semantic understanding and real-time relevance optimization. However, the focus on enterprise agentic systems and regulatory compliance is not a central match to the user's research interests in query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.00304v1>
- **Submitted**: 2026-03-31 22:56:21
- **Comment**: 19 pages
- **Topic Keywords**: rag
- **Reason**: The paper explores conversational agents and multi-turn interactions, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on large language models and conversational agents is not directly aligned with the user's primary research interests in IR and Search technologies. The connection to NLP is relevant, but the paper's emphasis on reliability and task success in conversational environments is not a central match for the user's interests.
...
### 18. Hierarchical Chain-of-Thought Prompting: Enhancing LLM Reasoning Performance and Efficiency

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Xingshuai Huang, Derek Li, Bahareh Nikpour, Parsa Omidi
- **URL**: <http://arxiv.org/abs/2604.00130v1>
- **Submitted**: 2026-03-31 18:35:22
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, as it explores a new method for improving the reasoning capabilities of large language models. However, it does not directly address your core focus on Information Retrieval (IR) and Search technologies. The paper's emphasis on hierarchical reasoning structures and efficiency may be of interest to you, but it is not a central match for your research themes.
...
### 19. The Overlooked Repetitive Lengthening Form in Sentiment Analysis

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Lei Wang, Eduard Dragut
- **URL**: <http://arxiv.org/abs/2604.01268v1>
- **Submitted**: 2026-04-01 16:55:17
- **Comment**: Findings of EMNLP 2024
- **Topic Keywords**: search
- **Reason**: This paper explores the Repetitive Lengthening Form in sentiment analysis, which is related to natural language processing and deep semantic understanding. However, it does not directly align with the user's primary focus on information retrieval, ranking models, and user behavior modeling. The paper's focus on language models and sentiment analysis is somewhat relevant, but it does not strongly connect to the user's core research themes.
...
### 20. Aligning Recommendations with User Popularity Preferences

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Mona Schirmer, Anton Thielmann, Pola Schwöbel, Thomas Martynec, Giuseppe Di Benedetto, Ben London, Yannik Stein
- **URL**: <http://arxiv.org/abs/2604.01036v1>
- **Submitted**: 2026-04-01 15:45:24
- **Comment**: Accepted at FAccT 2026
- **Topic Keywords**: recommend
- **Reason**: The paper explores recommender systems and popularity bias, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on recommender systems and user behavior modeling is not the primary area of interest for the user, who is more focused on query understanding, ranking models, and deep semantic understanding in IR. The connection to NLP and data mining is also limited.
...
### 21. Uncertainty-Aware Variational Reward Factorization via Probabilistic Preference Bases for LLM Personalization

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Gyuseok Lee, Wonbin Kweon, Zhenrui Yue, SeongKu Kang, Jiawei Han, Dong Wang
- **URL**: <http://arxiv.org/abs/2604.00997v1>
- **Submitted**: 2026-04-01 14:58:51
- **Topic Keywords**: personalization
- **Reason**: The paper focuses on personalizing large language models, which is somewhat related to information retrieval, particularly in the context of search technologies. However, the primary focus on NLP and personalization does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's emphasis on uncertainty-aware variational reward factorization is also not directly related to the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 22. Positional Cognitive Specialization: Where Do LLMs Learn To Comprehend and Speak Your Language?

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Luis Frentzen Salim, Lun-Wei Ku, Hsing-Kuo Kenneth Pao
- **URL**: <http://arxiv.org/abs/2604.00923v1>
- **Submitted**: 2026-04-01 14:03:51
- **Comment**: Accepted to AAAI26 Main
- **Topic Keywords**: search
- **Reason**: This paper focuses on understanding how large language models adapt to new languages, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on language model adaptation and multilingual abilities does not directly align with the user's core research themes in IR and Search technologies. The paper's relevance to the user's interests in NLP and data mining is moderate, but the connection to information retrieval is not strong.
...
### 23. Large Language Models in the Abuse Detection Pipeline

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Suraj Kath, Sanket Badhe, Preet Shah, Ashwin Sampathkumar, Shivani Gupta
- **URL**: <http://arxiv.org/abs/2604.00323v1>
- **Submitted**: 2026-03-31 23:42:06
- **Topic Keywords**: search
- **Reason**: The paper focuses on the application of Large Language Models in abuse detection, which is somewhat related to information retrieval and NLP. However, the primary focus on abuse detection and safety systems does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's relevance is limited to the intersection of NLP and IR, but it does not explore the user's areas of interest in depth.
...
### 24. Agentic Tool Use in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Jinchao Hu, Meizhi Zhong, Kehai Chen, Xuefeng Bai, Min Zhang
- **URL**: <http://arxiv.org/abs/2604.00835v1>
- **Submitted**: 2026-04-01 12:46:51
- **Topic Keywords**: information retrieval, rag, retrieval
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on 'agentic tool use' in Large Language Models and the evaluation of tool-use methods seems to be more aligned with AI and machine learning, rather than your core areas of interest.
...
### 25. TR-ICRL: Test-Time Rethinking for In-Context Reinforcement Learning
...
- **URL**: <http://arxiv.org/abs/2604.00438v1>
- **Submitted**: 2026-04-01 03:34:05
- **Comment**: 14 pages, 7 figures
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on In-Context Reinforcement Learning for Large Language Models, which is not directly related to Information Retrieval or Search technologies. While it involves query understanding and ranking models, the context is more aligned with NLP and deep learning, but the specific application and methodology do not match the user's core research themes.
...
- **URL**: <http://arxiv.org/abs/2604.00131v1>
- **Submitted**: 2026-03-31 18:37:35
- **Comment**: 7 pages, 2 figures, and 4 tables
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper focuses on memory control in Large Language Model (LLM) agents, which is not directly related to Information Retrieval or Search technologies. While it touches on the concept of memory and accessibility, it does not address query understanding, ranking models, or user behavior modeling, making it less relevant to your research interests.
...
### 27. A novel three-step approach to forecast firm-specific technology convergence opportunity via multi-dimensional feature fusion

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Fu Gu, Ao Chen, Yingwen Wu
- **URL**: <http://arxiv.org/abs/2604.00803v1>
- **Submitted**: 2026-04-01 12:10:14
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper appears to be primarily focused on technology convergence forecasting, which is not a core area of interest. While it involves some aspects of information retrieval (e.g., retrieval-augmented generation), the context and application are quite different from the user's main research themes.
...
### 28. Paper Reconstruction Evaluation: Evaluating Presentation and Hallucination in AI-written Papers

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Atsuyuki Miyai, Mashiro Toyooka, Zaiying Zhao, Kenta Watanabe, Toshihiko Yamasaki, Kiyoharu Aizawa
- **URL**: <http://arxiv.org/abs/2604.01128v1>
- **Submitted**: 2026-04-01 16:48:04
- **Comment**: Project Page: https://agent4science-utokyo.github.io/PaperRecon_HP/
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or your core research themes. While it touches on AI-driven writing, the focus is on evaluation frameworks for AI-written papers, which is a distinct area of research.
...
### 29. Multimodal Analysis of State-Funded News Coverage of the Israel-Hamas War on YouTube Shorts

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Daniel Miehling, Sandra Kuebler
- **URL**: <http://arxiv.org/abs/2604.00994v1>
- **Submitted**: 2026-04-01 14:55:58
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests as it focuses on multimodal analysis of news coverage on YouTube Shorts, which is outside the scope of information retrieval, search technologies, and natural language processing. Although it mentions sentiment analysis and semantic scene classification, the context is not related to query understanding, ranking models, or user behavior modeling.
...
### 30. TRIMS: Trajectory-Ranked Instruction Masked Supervision for Diffusion Language Models

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Lingjie Chen, Ruizhong Qiu, Yuyu Fan, Yanjun Zhao, Hanghang Tong
- **URL**: <http://arxiv.org/abs/2604.00666v1>
- **Submitted**: 2026-04-01 09:13:31
- **Comment**: 10 pages, 7 figures, 1 algorithm
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on diffusion language models and proposes a new training framework, TRIMS, to improve decoding behavior. While it involves masked supervision, which is related to NLP, it doesn't directly address query understanding, ranking models, or user behavior modeling, making it less relevant to your core research interests.
...
### 31. $\texttt{YC-Bench}$: Benchmarking AI Agents for Long-Term Planning and Consistent Execution
...
- **Submitted**: 2026-04-01 17:52:19
- **Comment**: 16 pages, 10 figures
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on AI Agents for Long-Term Planning and Consistent Execution, while interesting, does not align with your core themes.
...
### 32. CARE: Privacy-Compliant Agentic Reasoning with Evidence Discordance

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Haochen Liu, Weien Li, Rui Song, Zeyu Li, Chun Jason Xue, Xiao-Yang Liu, Sam Nallaperuma, Xue Liu, Ye Yuan
- **URL**: <http://arxiv.org/abs/2604.01113v1>
- **Submitted**: 2026-04-01 16:37:01
- **Comment**: Preprint
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on a privacy-compliant agentic reasoning framework for handling conflicting clinical evidence in healthcare settings, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 33. Temporal Dependencies in In-Context Learning: The Role of Induction Heads

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Anooshka Bajaj, Deven Mahesh Mistry, Sahaj Singh Maini, Yash Aggarwal, Billy Dickson, Zoran Tiganj
- **URL**: <http://arxiv.org/abs/2604.01094v1>
- **Submitted**: 2026-04-01 16:21:38
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on the behavior of large language models in in-context learning, specifically the role of induction heads in tracking temporal dependencies. While it touches on the idea of retrieval and processing of information, it doesn't directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of interest. The paper's focus on NLP and deep learning mechanisms makes it somewhat tangential to the user's primary research themes.
...
- **URL**: <http://arxiv.org/abs/2604.00890v1>
- **Submitted**: 2026-04-01 13:37:06
- **Comment**: Under review, 4 figures, 7 tables
- **Topic Keywords**: rank, search
- **Reason**: This paper focuses on geometric problem solving and large language models, which is outside the user's primary research interests in Information Retrieval and Search technologies. While it involves some form of reasoning and problem-solving, it does not directly relate to query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's research.
...
- **URL**: <http://arxiv.org/abs/2604.00799v1>
- **Submitted**: 2026-04-01 12:06:54
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on multimodal language models and their understanding of 3D geometry, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 36. Stochastic Attention: Connectome-Inspired Randomized Routing for Expressive Linear-Time Attention

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zehao Jin, Yanan Sui
- **URL**: <http://arxiv.org/abs/2604.00754v1>
- **Submitted**: 2026-04-01 11:18:40
- **Topic Keywords**: rag
- **Reason**: This paper focuses on a novel attention mechanism inspired by the brain's connectome, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it does involve attention and language models, the context and application are quite different from the user's core research themes.
...
### 37. OmniVoice: Towards Omnilingual Zero-Shot Text-to-Speech with Diffusion Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Han Zhu, Lingxuan Ye, Wei Kang, Zengwei Yao, Liyong Guo, Fangjun Kuang, Zhifeng Han, Weiji Zhuang, Long Lin, Daniel Povey
- **URL**: <http://arxiv.org/abs/2604.00688v2>
- **Submitted**: 2026-04-01 09:45:51
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on text-to-speech models and diffusion language models, which are outside your primary areas of interest in Information Retrieval and Search technologies, particularly query understanding, ranking models, and user behavior modeling.
...
### 38. A Survey of On-Policy Distillation for Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mingyang Song, Mao Zheng
- **URL**: <http://arxiv.org/abs/2604.00626v1>
- **Submitted**: 2026-04-01 08:32:34
- **Topic Keywords**: rag
- **Reason**: This paper is primarily focused on knowledge distillation and large language models, which is outside your core research themes of Information Retrieval, Search technologies, and Natural Language Processing. While it touches on some related concepts, such as modeling and optimization, the paper's focus on language models and distillation makes it less relevant to your interests.
...
### 39. Logarithmic Scores, Power-Law Discoveries: Disentangling Measurement from Coverage in Agent-Based Evaluation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: HyunJoon Jung, William Na
- **URL**: <http://arxiv.org/abs/2604.00477v1>
- **Submitted**: 2026-04-01 04:44:21
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on evaluating conversational AI using agent-based evaluation methods, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the primary focus is on conversational AI evaluation, making it somewhat tangential to your research areas.
...
### 40. Agent Q-Mix: Selecting the Right Action for LLM Multi-Agent Systems through Reinforcement Learning
...
- **URL**: <http://arxiv.org/abs/2604.00344v1>
- **Submitted**: 2026-04-01 00:38:24
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multi-agent systems and reinforcement learning, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves deep learning and optimization, the context and application are quite different from the user's interests.
...
### 41. REM-CTX: Automated Peer Review via Reinforcement Learning with Auxiliary Context

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Pawin Taechoyotin, Daniel E. Acuna
- **URL**: <http://arxiv.org/abs/2604.00248v1>
- **Submitted**: 2026-03-31 21:19:05
- **Comment**: 12 pages, 6 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on automated peer review and reinforcement learning, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves a large language model, the context is specific to peer review and does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 42. Do LLMs Know What Is Private Internally? Probing and Steering Contextual Privacy Norms in Large Language Model Representations

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Haoran Wang, Li Xiong, Kai Shu
- **URL**: <http://arxiv.org/abs/2604.00209v1>
- **Submitted**: 2026-03-31 20:23:41
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on contextual privacy norms and control, which is not a central match to your core themes.
...
### 43. From Validity to Inter-Subjectivity: An Argument for Reliability Signals in Search Environments

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Frans van der Sluis
- **URL**: <http://arxiv.org/abs/2604.01186v1>
- **Submitted**: 2026-04-01 17:34:45
- **Comment**: 4 pages. Extended abstract / conference paper for SEASON 2025 (September 24-25, 2025, Hamburg, Germany). Peer reviewed
- **Topic Keywords**: search
- **Reason**: This paper appears to focus on the broader societal implications of search engines, specifically the spread of misinformation, rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The abstract does not mention any specific techniques or methods related to IR or NLP, and the focus on epistemic challenges seems to be more philosophical than technical.
...
### 44. UniMixer: A Unified Architecture for Scaling Laws in Recommendation Systems
...
- **URL**: <http://arxiv.org/abs/2604.00590v2>
- **Submitted**: 2026-04-01 07:57:40
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on scaling laws and architectures for recommendation systems, which is somewhat related to your interests in information retrieval and search technologies. However, the specific context of recommendation systems and scaling efficiency is not a central match for your core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 45. Adapting Text LLMs to Speech via Multimodal Depth Up-Scaling

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Kazuki Yano, Jun Suzuki, Shinji Watanabe
- **URL**: <http://arxiv.org/abs/2604.00489v1>
- **Submitted**: 2026-04-01 05:16:06
- **Topic Keywords**: rank
- **Reason**: This paper focuses on adapting pre-trained text Large Language Models to Speech Language Models, which is not directly related to Information Retrieval or Search technologies. While it involves deep learning and model adaptation, the context is speech recognition rather than query understanding or ranking models, making it less relevant to the user's core research interests.
