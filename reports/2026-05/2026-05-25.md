...
### 1. RAG-Match: Retrieval-Augmented Knowledge Injection and Hierarchical Reasoning for Calibrated Semantic Relevance

- **LLM Score**: 9
- **Keyword Score**: 15
- **Authors**: Hengjun Jiang, Liansheng Sun, Yan Jiang, Xiaojie Ke, Yongjin Wang, Xiangkun Liu, Cunxin Gu, Jian Xu, Guanjun Jiang
- **URL**: <http://arxiv.org/abs/2605.25486v1>
- **Submitted**: 2026-05-25 06:42:39
- **Comment**: 17 pages, 1 figure, 5 tables
- **Topic Keywords**: query, ranking, relevance, rag, retrieval, rank, search
- **Reason**: This paper is extremely relevant to your research interests in Information Retrieval, particularly in query understanding, ranking models, and user behavior modeling. The focus on semantic relevance, knowledge-augmented pretraining, and hierarchical reasoning alignment aligns well with your interests in deep semantic understanding and real-time relevance optimization. The experimental results on a real-world search relevance benchmark also demonstrate the effectiveness of the proposed approach.
...
- **URL**: <http://arxiv.org/abs/2605.25480v1>
- **Submitted**: 2026-05-25 06:36:14
- **Comment**: 15 pages, 3 figures, 10 tables, 1 algorithm
- **Topic Keywords**: queries, rag, retrieval, search
- **Reason**: This paper aligns closely with your research interests in Information Retrieval, particularly in query understanding and ranking models, as it proposes a novel retrieval system that enables reasoning and decision-making capabilities. The use of Large Language Models (LLMs) and Wiki-based knowledge organization also relates to your interests in Natural Language Processing and deep semantic understanding. The evaluation on various benchmark datasets further supports the paper's relevance to your research focus.
...
- **URL**: <http://arxiv.org/abs/2605.25514v1>
- **Submitted**: 2026-05-25 07:18:51
- **Comment**: 11 pages, 5 figures, 9 tables
- **Topic Keywords**: query, queries, ranking, click, ctr, recommend, rank, search
- **Reason**: The paper presents Query-Conditioned Generative Search (QGS), a novel approach to search ranking that addresses query-driven behavior and semantic discontinuity. Although primarily focused on recommendation, the method's application to search ranking and its deployment in a commercial search engine aligns with your interests in Information Retrieval and Search technologies. The use of query-conditioned next-item objectives and linear recurrence in the encoder also relates to your focus on ranking models and user behavior modeling.
...
### 4. Spectral Retrieval: Multi-Scale Sinc Convolution over Token Embeddings for Localized Retrieval in LLM Multi-Agent Systems

- **LLM Score**: 8
- **Keyword Score**: 16
- **Authors**: Andrea Morandi
- **URL**: <http://arxiv.org/abs/2605.24764v1>
- **Submitted**: 2026-05-23 22:50:58
- **Topic Keywords**: dense retrieval, ranking, relevance, rag, ctr, retrieval, rank
- **Reason**: This paper presents a novel re-ranking stage for localized retrieval in LLM multi-agent systems, leveraging multi-scale sinc convolution over token embeddings. While not directly focused on query understanding or ranking models, it explores a deep semantic understanding approach, which aligns with your research interests in Information Retrieval and NLP. The paper's emphasis on real-time relevance optimization and localized retrieval also resonates with your focus on real-time relevance optimization.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the areas of query understanding, ranking models, and user behavior modeling. The focus on multi-modal lifelong user interest modeling and the proposed SIREN framework aligns with your interests in deep semantic understanding and real-time relevance optimization.
...
### 6. The Multilingual Curse at the Retrieval Layer: Evidence from Amharic

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Yosef Worku Alemneh, Kidist Amde Mekonnen, Maarten de Rijke
- **URL**: <http://arxiv.org/abs/2605.24556v1>
- **Submitted**: 2026-05-23 12:44:30
- **Comment**: 10 pages, 4 tables. Accepted to the 1st Workshop on Multilinguality in the Era of Large Language Models (MeLLM) at ACL 2026
- **Topic Keywords**: retriever, passage retrieval, retrieval, search
- **Reason**: This paper is highly relevant to Information Retrieval, specifically exploring multilingual retrieval and its limitations in underrepresented languages. The focus on retrieval paradigms and evaluation metrics aligns with your interests in query understanding and ranking models. However, the paper's primary focus on multilingual retrieval and language-specific challenges is somewhat tangential to your core research themes in query understanding and user behavior modeling.
...
### 7. Your Embedding Model is SMARTer Than You Think

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Jianrui Zhang, Hyun Jung Lee, Sukanta Ganguly, Tae-Eui Kam, Donghyun Kim, Yong Jae Lee
- **URL**: <http://arxiv.org/abs/2605.24938v1>
- **Submitted**: 2026-05-24 08:36:34
- **Topic Keywords**: retriever, dense retrieval, retrieval
- **Reason**: This paper explores a novel approach to multimodal retrieval, introducing SMART, a framework that unlocks the latent multi-vector capabilities of standard single-vector models. While not directly focused on query understanding, ranking models, or user behavior modeling, the work is relevant to information retrieval and NLP, with potential applications in search technologies. The paper's emphasis on efficient inference and finetuning techniques aligns with the user's interests in real-time relevance optimization.
...
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of legal search and agentic search capabilities. The use of reinforcement learning to enhance temporal consistency is an interesting application of Learning to Rank and user behavior modeling, although it's not directly focused on e-commerce. The paper's focus on deep semantic understanding and real-time relevance optimization also aligns with your interests in Information Retrieval.
...
### 9. Efficient Benchmarking Is Just Feature Selection and Multiple Regression
...
- **Reason**: This paper is highly relevant to the field of Information Retrieval, specifically in the area of query understanding and ranking models. The use of kernel ridge regression and feature selection algorithms, such as mRMR, to improve efficient benchmarking techniques aligns with the user's interests in Learning to Rank and real-time relevance optimization. While the paper's focus is on LLMs, the techniques and methods discussed can be applied to other areas of IR, making it a useful contribution to the field.
...
### 10. Knowing but Not Showing: LLMs Recognize Ambiguity but Rarely Ask Clarifying Questions

- **LLM Score**: 8
- **Keyword Score**: 6
- **Authors**: Jinyan Su, Claire Cardie
- **URL**: <http://arxiv.org/abs/2605.25284v1>
- **Submitted**: 2026-05-24 22:36:58
- **Topic Keywords**: query, queries
- **Reason**: This paper explores the ability of Large Language Models (LLMs) to recognize ambiguity in user queries, which is a key aspect of query understanding in Information Retrieval. The study evaluates models on ambiguous and unambiguous questions, and the results highlight a gap between recognition and behavior, which is relevant to my research interests in query understanding and ranking models. However, the focus on LLMs and question answering is somewhat narrower than my broader interests in IR and NLP.
...
- **Submitted**: 2026-05-24 10:27:31
- **Comment**: 12 pages, 5 figures, 4 tables
- **Topic Keywords**: click, ctr, click-through rate
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of click-through rate prediction and user behavior modeling. The proposed method, HeteGenCTR, addresses a fundamental limitation in existing generative CTR methods by incorporating heterogeneity-aware feature generation, which is a key aspect of deep semantic understanding and real-time relevance optimization.
...
### 12. Meta-Modal Agent: Sequential Evidence Routing for Missing-Modality Candidate Reranking
...
- **Submitted**: 2026-05-24 11:22:03
- **Topic Keywords**: retriever, ranking, rerank, retrieval, recommend, rank, acl
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and multimodal recommender systems, but it focuses more on sequential evidence routing and multimodal reranking, which is a specific application of IR. While it involves ranking models and user behavior modeling, it's not directly related to query understanding or real-time relevance optimization.
...
### 13. H$^{2}$MT: Semantic Hierarchy-Aware Hierarchical Memory Transformer

- **LLM Score**: 6
- **Keyword Score**: 10
- **Authors**: Maryam Haghifam, Zifan He, Jason Cong, Yizhou Sun
- **URL**: <http://arxiv.org/abs/2605.24930v1>
- **Submitted**: 2026-05-24 08:22:05
- **Topic Keywords**: query, queries, rag, retrieval
- **Reason**: This paper introduces a novel architecture, H$^{2}$MT, which addresses long-context inference challenges in transformer-based LLMs. While it's not directly focused on query understanding, ranking models, or user behavior modeling, it does involve semantic hierarchy-aware processing and real-time relevance optimization, which aligns with your interests in Information Retrieval and NLP. However, the specific application domain and technical focus are somewhat different from your core research themes.
...
- **Submitted**: 2026-05-24 10:29:10
- **Comment**: 12 pages, 4 Figures, 3 Tables
- **Topic Keywords**: rag, click, ctr, click-through rate
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically click models and ranking models. However, the focus on Click-Through Rate prediction and uncertainty-triggered feature path exploration is more aligned with a specific application in e-commerce, which is a related but not central aspect of your research. The paper's use of deep semantic understanding and real-time relevance optimization is also relevant, but the context is more narrow than your broader interests in IR and NLP.
...
### 15. SemBridge: Language Transfer in Sparse Encoders via Multilingual Semantic Bridges
...
- **Reason**: This paper explores sparse encoders for information retrieval, proposing a novel method for cross-lingual adaptation. While it touches on query understanding and ranking models, its primary focus is on language transfer and sparse encoder optimization, which is somewhat related to your interests in information retrieval and NLP.
...
### 16. Iterate Until Retrieved: Factual Nugget Optimization for Discoverable Continual Corrections in Agentic RAG
...
- **Reason**: This paper explores the optimization of factual nuggets in retrieval-augmented generation systems, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on agentic RAG systems and factual corrections in B2B settings is not directly aligned with the user's primary research interests in e-commerce and deep semantic understanding.
...
### 17. Multilingual Humour-Aware Retrieval with Dense and Re-Ranking Models

- **LLM Score**: 4
- **Keyword Score**: 18
- **Authors**: Georgios Arampatzis, Avi Arampatzis
- **URL**: <http://arxiv.org/abs/2605.25165v1>
- **Submitted**: 2026-05-24 16:50:15
- **Comment**: 8 pages
- **Topic Keywords**: information retrieval, dense retrieval, query, ranking, relevance, retrieval, rank
- **Reason**: The paper focuses on humour-aware retrieval, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the specific context of humour retrieval and the use of multilingual models and re-ranking techniques are not central to the user's core research themes.
...
### 18. DeGRe: Dense-supervised Generative Reranking for Recommendation
...
- **Reason**: The paper focuses on recommendation systems, which is related to your interests in Information Retrieval and Search technologies. However, it specifically deals with recommender systems, which is not your primary focus. The paper's emphasis on deep semantic understanding and real-time relevance optimization is somewhat relevant to your interests in query understanding and ranking models, but the context is different.
...
### 19. Retrieval-Augmented Detection of Potentially Abusive Clauses in Chilean Terms of Service
...
- **Reason**: This paper is somewhat related to Information Retrieval, as it involves a retrieval-augmented generation framework for detecting potentially abusive clauses. However, its focus on legal contracts and consumer protection is not a central match to the user's interests in query understanding, ranking models, and user behavior modeling in the e-commerce domain or other areas. The paper's use of NLP and data mining techniques is also relevant, but not a primary focus of the user's research.
...
### 20. How Many Tools Should an LLM Agent See? A Chance-Corrected Answer

- **LLM Score**: 4
- **Keyword Score**: 12
- **Authors**: Vyzantinos Repantis, Ameya Gawde, Harshvardhan Singh, Joey Blackwell
- **URL**: <http://arxiv.org/abs/2605.24660v1>
- **Submitted**: 2026-05-23 17:02:56
- **Comment**: 13 pages, 2 figures
- **Topic Keywords**: query, queries, rag, retrieval, rank, search
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, specifically in the context of tool selection and retrieval systems. However, the focus on Large Language Model (LLM) agents and tool shortlisting is not a central match to the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 21. EfficientGraph-RAG: Structured Retrieval-State Management for Cross-Task Retrieval-Augmented Generation

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Miaohe Niu, Lianlei Shan, Zhengtao Yu, Jingbo Zhu, Tong Xiao
- **URL**: <http://arxiv.org/abs/2605.25379v1>
- **Submitted**: 2026-05-25 03:08:53
- **Comment**: 19 pages, 5 figures, 14 tables
- **Topic Keywords**: query, rag, retrieval, rank, search
- **Reason**: This paper explores Retrieval-Augmented Generation (RAG), a technique that combines large language models with external knowledge. While it touches on retrieval and structured state management, its primary focus is on generation and knowledge grounding, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the paper's emphasis on generation and knowledge grounding makes it less central to your core research themes.
...
### 22. Large Language Model Selection with Limited Annotations
...
- **Submitted**: 2026-05-24 10:18:51
- **Comment**: 33 pages, 5 figures, 4 tables
- **Topic Keywords**: query, queries, pairwise
- **Reason**: The paper discusses Large Language Model selection, which is somewhat related to Information Retrieval, particularly in the context of query understanding and ranking models. However, the focus on model selection and evaluation metrics is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The connection to NLP is relevant, but the paper's scope is more focused on model evaluation rather than deep semantic understanding or real-time relevance optimization.
...
### 23. Generating Legal Commentaries from Case Databases via Retrieval, Clustering, and Generation

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Max Prior, Niklas Wais, Matthias Grabmair
- **URL**: <http://arxiv.org/abs/2605.24534v1>
- **Submitted**: 2026-05-23 12:07:29
- **Topic Keywords**: relevance, rag, ctr, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves text summarization and clustering. However, the focus on legal commentaries and case databases is not a central match to your core research themes in e-commerce, query understanding, and ranking models.
...
### 24. Decompose-and-Refine: Structured Legal Question Answering with Parametric Retrieval

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Jihyung lee, Hyounghun Kim, Gary Lee
- **URL**: <http://arxiv.org/abs/2605.24454v1>
- **Submitted**: 2026-05-23 08:03:31
- **Topic Keywords**: query, queries, retrieval, korea
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, the focus on Legal Question Answering and statutory provisions is not a central match to the user's core research themes, which are more geared towards general search technologies and e-commerce. The use of parametric retrieval and knowledge-based query refinement is an interesting aspect, but it does not directly align with the user's primary focus on deep semantic understanding and real-time relevance optimization.
...
### 25. First, do no harm: Breaking suicidogenic echo chambers in media recommendation
...
- **Submitted**: 2026-05-24 21:21:02
- **Comment**: 10 pages, 5 figures. Research on safety-aware recommender systems and algorithmic ethics
- **Topic Keywords**: ranking, relevance, recommend, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in the context of recommender systems. However, its focus on clinical safety and mental health contexts diverges from your primary interests in e-commerce and deep semantic understanding. The use of re-ranking methods and large language models is relevant, but the application is more specific to mental health than your general research areas.
...
### 26. AgentIR: A Workload-Adaptive Cascade Retrieval Substrate for Long-Term Conversational Memory

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Aojie Yuan, Haiyue Zhang, Shahin Nazarian
- **URL**: <http://arxiv.org/abs/2605.25092v1>
- **Submitted**: 2026-05-24 14:14:13
- **Comment**: 29 pages, 9 figures, 12 tables. Main paper 9 pages + comprehensive appendix (proof, GPU kernels, full per-dataset BEIR/LongMemEval/LoCoMo tables, cascade router C++ API, 6 robustness experiments, FAQ, failure-case catalog)
- **Topic Keywords**: query, queries, retrieval
- **Reason**: This paper proposes a workload-adaptive retrieval substrate for long-term conversational memory, which is somewhat related to information retrieval and search technologies. However, the focus on conversational memory and the use of a cascade retrieval substrate with a time-partitioned index is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 27. LENS: A Staged Design for Interaction Granularityin Sequential CTR Prediction

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Yuan Wang, Yue Liu, Jun Zhang, Jie Jiang
- **URL**: <http://arxiv.org/abs/2605.25583v1>
- **Submitted**: 2026-05-25 08:33:11
- **Comment**: 15 pages, 9 figures, 9 tables
- **Topic Keywords**: query, ctr, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in sequential CTR prediction and user behavior modeling. However, it focuses on a specific aspect of sequential modeling and does not directly address query understanding, ranking models, or deep semantic understanding, which are core areas of your research.
...
### 28. Peak-Then-Collapse and the Four Interface Channels of Knowledge-Graph Tool Use
...
- **Reason**: This paper explores the performance of a knowledge-graph tool API, specifically focusing on the 'peak-then-collapse' pattern in a retrieval reward setting. While it touches on aspects of query understanding and ranking models, its primary focus is on the tool API's interface feedback and degradation regime, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the paper's emphasis on knowledge-graph tool use and interface feedback does not directly align with the user's core research themes.
...
### 29. AutoSG: LLM-Driven Solver Generation Solely from Task Prompts for Expensive Optimization
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the area of query understanding and ranking models, due to its use of retrieval-augmented solver generation. However, the focus on expensive optimization tasks and solver generation is not directly aligned with your primary interests in search technologies and user behavior modeling. The paper's use of LLMs and NLP is relevant, but not a central match to your research themes.
...
### 30. The Tokenizer Tax Across 25 European Languages: Domain Invariance, Cross-Lingual Few-Shot Effects, and the Ukrainian Penalty

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Volodymyr Ovcharov
- **URL**: <http://arxiv.org/abs/2605.24718v1>
- **Submitted**: 2026-05-23 20:13:44
- **Comment**: 16 pages, 3 figures, 8 tables. Dataset: https://huggingface.co/datasets/overthelex/tokenizer-fertility-map
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval, but it focuses on tokenizer fertility and its effects across European languages, which is not directly aligned with your primary focus on query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper introduces a proactive agent architecture that leverages idle-time compute to anticipate user needs, which is somewhat related to information retrieval and user behavior modeling. However, the focus is on proactive agents and dialogue history analysis, which is not directly aligned with the user's core research themes in IR and search technologies.
...
### 32. TIAR: Trajectory-Informed Advantage Reweighting for LLM Abstention Learning
...
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on abstention learning in large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on hallucination reduction and abstention learning in LLMs is not directly aligned with the user's core research themes. The paper's methodological innovation and empirical results are interesting, but the connection to the user's research interests is not strong enough to warrant a higher score.
...
### 33. GCIB: Graph Contrastive Information Bottleneck for Multi-Behavior Recommendation
...
- **Reason**: This paper focuses on multi-behavior recommendation, which is somewhat related to your interests in information retrieval and user behavior modeling. However, the specific context of recommender systems and the emphasis on graph-based methods and contrastive learning diverge from your primary focus on query understanding, ranking models, and deep semantic understanding in IR.
...
### 34. Towards a Universal Causal Reasoner

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Qirun Dai, Xiao Liu, Jiawei Zhang, Dylan Zhang, Hao Peng, Chenhao Tan
- **URL**: <http://arxiv.org/abs/2605.24873v1>
- **Submitted**: 2026-05-24 05:28:39
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on causal reasoning in LLMs, which is related to query understanding and ranking models in Information Retrieval. However, the primary focus is on causal reasoning, which is not a central match to your core research themes. The paper does involve deep semantic understanding, but the context is different from your typical e-commerce domain.
...
### 35. Know You Before You Speak: User-State Modeling for LLM Personalization in Multi-Turn Conversation
...
- **Submitted**: 2026-05-23 16:28:40
- **Comment**: 30pages, 3 figures
- **Topic Keywords**: rag, retrieval, personalization
- **Reason**: This paper focuses on user-state modeling for LLM personalization in multi-turn conversation, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the context is primarily in dialogue systems and NLP, rather than search technologies or e-commerce. The connection to ranking models is not explicitly mentioned, limiting its relevance to your core research themes.
...
### 36. MAGIC: Multimodal Alignment & Grounding-aware Instruction Coreset for Vision-Language Models
...
- **Reason**: This paper is primarily focused on multimodal instruction tuning for vision-language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of data mining, the context is quite different from your e-commerce background and deep semantic understanding in IR.
...
### 37. Adaptive Graph Refinement and Label Propagation with LLMs for Cost-Effective Entity Resolution
...
- **Topic Keywords**: query, queries, pairwise
- **Reason**: This paper focuses on entity resolution and graph refinement, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves data mining and graph-based techniques, the context and application are distinct from the user's core areas of focus.
...
### 38. What Makes a Medical Checker Trainable? Diagnosing Signal Collapse and Reward Hacking in Checker-Guided RAG for Biomedical QA
...
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves a claim-level NLI checker and retrieval-augmented RL, the context is biomedical QA and the focus is on diagnosing signal collapse and reward hacking in a specific system, which is not a central match for the user's interests.
...
### 39. An Effective-Rank Audit of Alignment-Induced Activation Shifts: Confound Control, Constructive Calibration, and Limits

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Yuki Nakamura
- **URL**: <http://arxiv.org/abs/2605.24583v1>
- **Submitted**: 2026-05-23 13:47:17
- **Comment**: 18 pages, 1 figure, 21 tables. Code, data, and an immutable Zenodo archive are available at https://github.com/Nakammura/effective-rank-audit (DOI: 10.5281/zenodo.20341445)
- **Topic Keywords**: ranking, rag, ctr, rank
- **Reason**: This paper appears to be focused on the analysis of Large Language Models (LLMs) and their alignment, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on aspects of model behavior, the context is not aligned with your specific areas of focus.
...
### 40. Automated Benchmark Auditing for AI Agents and Large Language Models
...
- **Reason**: This paper focuses on benchmark auditing for AI agents and large language models, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it touches on the evaluation of AI models, it does not address query understanding, ranking models, or real-time relevance optimization, making it only loosely relevant to your research interests.
...
### 41. MinerU-Popo: Universal Post-Processing Model for Structured Document Parsing
...
- **URL**: <http://arxiv.org/abs/2605.24973v1>
- **Submitted**: 2026-05-24 10:00:28
- **Comment**: The code is available at https://github.com/opendatalab/MinerU-Popo
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves processing and analysis of documents, its focus on post-processing OCR outputs and document-level structure reconstruction does not align with your core research themes.
...
### 42. When Do LLM Agents Treat Surface Noise Differently from Semantic Noise? A 68-Cell Measurement Study with a Held-Out Trace-Level Validation

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Liyun Zhang, Jiayi Guo
- **URL**: <http://arxiv.org/abs/2605.25981v1>
- **Submitted**: 2026-05-25 15:57:11
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper appears to be primarily focused on the behavior of large language models, specifically examining how they respond to different types of perturbations. While it touches on aspects of natural language processing and model behavior, it does not seem to be directly related to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 43. Overview of the PsyDefDetect Shared Task at BioNLP 2026: Detecting Levels of Psychological Defense Mechanisms in Supportive Conversations
...
- **URL**: <http://arxiv.org/abs/2605.24907v1>
- **Submitted**: 2026-05-24 07:17:54
- **Topic Keywords**: ranking, rank, acl
- **Reason**: This paper is not relevant to your research interests as it focuses on detecting psychological defense mechanisms in emotional support dialogues, which is outside the scope of Information Retrieval, Search technologies, and Natural Language Processing areas you're interested in.
...
### 44. When Self-Belief Misleads: Active Label Acquisition for Reinforcement Learning with Verifiable Rewards
...
- **Reason**: This paper focuses on Reinforcement Learning with Verifiable Rewards, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves deep learning and potentially real-time optimization, the context and application domains are quite different from the user's interests.
...
### 45. PennySynth: RAG-Driven Data Synthesis for Automated Quantum Code Generation

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Minghao Shao, Nouhaila Innan, Hariharan Janardhanan, Muhammad Kashif, Alberto Marchisio, Muhammad Shafique
- **URL**: <http://arxiv.org/abs/2605.25572v1>
- **Submitted**: 2026-05-25 08:26:43
- **Comment**: 11 pages, 3 figures
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on quantum code generation and retrieval-augmented generation for a specific domain (quantum programming) does not align with your core research themes.
...
### 46. AuthTrace: Diagnosing Evidence Construction in Thematically Dense Single-Author Corpora

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Xiaoqing Wu, Feifei Li, Haoliang Ming, Wenhui Que
- **URL**: <http://arxiv.org/abs/2605.25382v1>
- **Submitted**: 2026-05-25 03:10:52
- **Topic Keywords**: query, retrieval
- **Reason**: This paper appears to be focused on evidence construction systems in the context of question answering, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on some related concepts, the paper's primary focus on evidence construction and its specific application to single-author corpora does not align with your research interests.
...
### 47. How Reliable Are Semantic-ID Tokenizer Comparisons in Generative Recommendation?

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Qian Zhang, Lech Szymanski, Haibo Zhang, Jeremiah D. Deng
- **URL**: <http://arxiv.org/abs/2605.25330v1>
- **Submitted**: 2026-05-25 01:22:45
- **Comment**: 12 pages, 5 figures
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper focuses on recommender systems and tokenizer evaluation, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the specific context of generative recommendation and tokenizer comparisons is not directly aligned with your core research themes.
...
### 48. JudgmentBench: Comparing Rubric and Preference Evaluation for Quality Assessment
...
- **URL**: <http://arxiv.org/abs/2605.25240v1>
- **Submitted**: 2026-05-24 19:52:39
- **Comment**: 37 pages, 9 figures
- **Topic Keywords**: pairwise, rank, search
- **Reason**: This paper appears to be focused on benchmarking and quality assessment in a legal domain, using rubric-based scoring and comparative judgment. While it involves some aspects of human judgment and annotation, it does not directly relate to information retrieval, search technologies, or natural language processing, which are the primary areas of interest.
...
### 49. Better, Faster: Harnessing Self-Improvement in Large Reasoning Models

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Qihuang Zhong, Liang Ding, Juhua Liu, Bo Du, Leszek Rutkowski, Dacheng Tao
- **URL**: <http://arxiv.org/abs/2605.24998v1>
- **Submitted**: 2026-05-24 10:54:46
- **Comment**: Accepted by ICML2026
- **Topic Keywords**: queries, rag
- **Reason**: This paper focuses on improving large reasoning models through self-improvement training, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves optimization and efficiency, the context is more aligned with NLP and deep learning, but lacks the specific focus on query understanding, ranking models, or real-time relevance optimization.
...
### 50. What Are We Actually Decoding? Source Attribution for Non-Invasive Brain-to-Language Retrieval

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Xinyu Zhang, Sichao Liu, Runhao Lu, Alexandra Woolgar, Lihui Wang
- **URL**: <http://arxiv.org/abs/2605.24524v1>
- **Submitted**: 2026-05-23 11:23:39
- **Comment**: 35 pages, 7 figures, 25 tables
- **Topic Keywords**: retrieval, rank, acl
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The paper focuses on non-invasive brain-to-language retrieval and neural language decoding, which is outside your areas of expertise.
