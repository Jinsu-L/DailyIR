...
### 1. GroundedGEO: Auditing the Evidence Gap in Generative Search Rankings

- **LLM Score**: 0
- **Keyword Score**: 26
- **Authors**: Yihan Xia, Huiling Fan, Kangrong Zhong, Taotao Wang
- **URL**: <http://arxiv.org/abs/2609.25189v1>
- **Submitted**: 2026-09-21 17:07:10
- **Comment**: 14 pages, 6 figures, 12 tables
- **Topic Keywords**: query, queries, ranking, rerank, listwise, pointwise, rag, commerce, e-commerce, rank, search, acl
...
### 2. Graded-Relevance Composed Multimodal Retrieval for E-commerce Visual Search at Scale
...
### 4. Efficient LLM Distillation for Bangladesh Legal Context: A Smartphone-Compatible Retrieval-Augmented Generation Model
...
### 5. FinFIRST: Benchmarking Search Agents for Financial Information Retrieval, Sourcing and Traceability
...
- **URL**: <http://arxiv.org/abs/2609.25192v1>
- **Submitted**: 2026-09-21 17:28:08
- **Comment**: 20 pages, 3 figures, and 7 tables. Dataset available at https://huggingface.co/datasets/inclusionAI/FinFIRST
- **Topic Keywords**: information retrieval, rag, ctr, retrieval, search
- **Reason**: LLM scoring failed.
...
### 6. UK-PRBENCH: A Paragraph-Level Precedent Retrieval Benchmark for United Kingdom Case Law
...
### 7. Re:CAP - Auditing Retrieval Coverage in Production RAG Pipelines

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Aviral Joshi, Hanoz Bhathena, Max Nelson, Saket Sharma
- **URL**: <http://arxiv.org/abs/2609.24122v2>
...
### 8. Auditing Source Exposure in Baidu and Google AI Search
...
### 9. URA-NER: A Unified Retrieval-Augmented Framework with Retrieval Alignment and Uncertainty Reduction for Low-Resource NER
...
### 10. When Residualization Helps an Audit: Format Effects, Slice Gains, and Their Limits
...
### 11. FLARE: A Full-Lifecycle Dense Supervision Paradigm for Long-Horizon Coding Agents via Generative Reward Model
...
### 12. When More Evidence Hurts: Publication-Bias Drift and Principled Stopping for Biomedical Causal Search
...
### 15. A Redundancy Reduction Approach for Controllable Sequential Recommendations
...
### 16. The Copy Ceiling: An Input-Exposure Control for Ontology-Grounded Generation over Curated Corpora
...
### 17. Taramandal-GPT: Enhancing Astrodynamics Problem-Solving with Knowledge Retrieval and Structured Thinking
...
### 18. Vimarsha: Faithful ASR Evaluation for Indian Languages with Demographic Diversity, In-the-Wild Audio and Spelling Variations
...
### 19. UniK: Universal Knowledge Perception for Digital and Physical AI
...
### 20. RRSI: Regularized Recursive Self-Improvement of Agent Harnesses
...
- **URL**: <http://arxiv.org/abs/2609.24678v1>
- **Submitted**: 2026-09-21 14:39:58
...
- **URL**: <http://arxiv.org/abs/2609.24657v1>
- **Submitted**: 2026-09-21 14:25:04
...
### 23. You Can Tell Who's Asking: What the Web's Questions Are Made Of, and Where They Come From

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Calvin Zhou, Vincent McCloskey, Krishna Srinivasan
- **URL**: <http://arxiv.org/abs/2609.24106v1>
- **Submitted**: 2026-09-21 04:46:59
...
- **Topic Keywords**: retrieval, commerce
- **Reason**: LLM scoring failed.
...
### 24. Representation-guided in-context learning for medical image interpretation with multimodal large language models
...
- **URL**: <http://arxiv.org/abs/2609.24057v1>
- **Submitted**: 2026-09-21 03:34:38
...
- **URL**: <http://arxiv.org/abs/2609.23979v1>
- **Submitted**: 2026-09-21 01:21:01
...
### 26. Time-Incremental Continued Pretraining of LLMs: Knowledge Updates Without Catastrophic Forgetting

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Fırat Öncel, Salman Hussain Ali, Mirco Ravanelli, Cem Subakan, Çağatay Yıldız
- **URL**: <http://arxiv.org/abs/2609.23916v1>
- **Submitted**: 2026-09-20 22:44:54
- **Comment**: Preprint
- **Topic Keywords**: rag, rank
- **Reason**: LLM scoring failed.
...
### 28. From Pattern Recognizers to Personalized Companions: A Survey of Large Language Models in Mental Health
...
- **URL**: <http://arxiv.org/abs/2609.25186v1>
- **Submitted**: 2026-09-21 16:58:17
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 29. OSWorld-Pro: Process-based Evaluation for Computer Use Agents
...
### 30. Adapting Tree-Structured Speculative Decoding to DeepSeek-V4 for Efficient Inference

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Changxu Liu, Zhaogeng Li
- **URL**: <http://arxiv.org/abs/2609.24698v1>
- **Submitted**: 2026-09-21 14:47:06
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 31. Custom Named Entity Recognition and Topic Classification for Global Health Publications

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Genis Skura, Antoine Geissbühler, Jean-Luc Falcone
- **URL**: <http://arxiv.org/abs/2609.24625v1>
- **Submitted**: 2026-09-21 14:09:53
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 32. Ascent: An Agentic System over the Model Context Protocol for Real-World Clinical Data Analysis

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Angelo Ziletti, Leonardo D'Ambrosi, Melanie Tuchardt, Tim Kondziella
- **URL**: <http://arxiv.org/abs/2609.24620v1>
- **Submitted**: 2026-09-21 14:06:32
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 33. What Makes a Good Semantic ID for Generative Recommendation? A Reproducibility Study

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yufei Chen, Junchen Fu, Jujia Zhao, Yukun Zhao, Zhaochun Ren
- **URL**: <http://arxiv.org/abs/2609.24430v1>
- **Submitted**: 2026-09-21 11:26:49
...
### 34. Mitigating Entity Type Confusion in Cross-Domain NER via Multidimensional Quantification and Reasoning Enhancement

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Jingyu Wang, Shijie Wu, Fusheng Jin
- **URL**: <http://arxiv.org/abs/2609.24357v1>
- **Submitted**: 2026-09-21 09:46:59
...
### 35. Calibrated Decisions at Scale: Converting Police Crash Narratives into Probabilistic Crash Variables with a System One Model (Jev)

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Amir Rafe, Subasish Das
- **URL**: <http://arxiv.org/abs/2609.24052v1>
- **Submitted**: 2026-09-21 03:24:47
- **Topic Keywords**: acl
- **Reason**: LLM scoring failed.
...
### 36. From Tables to Quantified Statements: Evaluating LLM Inference Generation through Executable Verification

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Mai Mohamed Eida, Gunjan Anand, Ayush Singh, Aleksandre Maskharashvili
- **URL**: <http://arxiv.org/abs/2609.23966v1>
- **Submitted**: 2026-09-21 00:36:36
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 38. this-that-model-1.0: A typed decision model that decides in 30 ms, for a millionth of a cent

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Zehua Cheng, Wei Dai, Jiahao Sun
- **URL**: <http://arxiv.org/abs/2609.23886v1>
- **Submitted**: 2026-09-20 21:43:03
- **Topic Keywords**: ctr
- **Reason**: LLM scoring failed.
...
- **Keyword Score**: 2
- **Authors**: Atul Anand
- **URL**: <http://arxiv.org/abs/2609.25130v1>
- **Submitted**: 2026-09-20 19:33:47
...
### 40. SocioVerse2: A Longitudinal Dynamic Social Simulation Framework under a Human-AI Co-evolutionary Paradigm
...
- **URL**: <http://arxiv.org/abs/2609.24911v1>
- **Submitted**: 2026-09-21 17:14:09
...
### 41. Human-LLM Deliberation as Interactive Proof: Conditions for Verifiability Without Transparency

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Baotong Zhang, Dean Foster, João Sedoc
- **URL**: <http://arxiv.org/abs/2609.24895v1>
- **Submitted**: 2026-09-21 17:00:15
...
### 42. Extracting Arguments, Not Just Classifying Them: Instruction-Tuned LLMs for Generative Component Detection

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Sofiane Elguendouze, Erwan Hain, Elena Cabrio, Serena Villata
- **URL**: <http://arxiv.org/abs/2609.24855v1>
- **Submitted**: 2026-09-21 16:30:38
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 43. QLoRA Fine-Tuning of Ministral LLM for Sequence-to-Function Protein Annotation

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Demian Pavlyshenko, Bohdan Pavlyshenko
- **URL**: <http://arxiv.org/abs/2609.24538v1>
- **Submitted**: 2026-09-21 13:09:59
- **Topic Keywords**: rank
- **Reason**: LLM scoring failed.
...
### 44. LLJ Cards: Best practices for the Use of LLMs as Judges

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Khaoula Chehbouni, Melina Medjdoub, Florian Carichon, Golnoosh Farnadi, Jackie Chi Kit Cheung
- **URL**: <http://arxiv.org/abs/2609.24516v1>
- **Submitted**: 2026-09-21 12:54:07
...
### 45. End-to-end Jordanian dialect speech-to-text self-supervised learning framework

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Ali A. Safieh, Ibrahim Abu Alhaol, Rawan Ghnemat
- **URL**: <http://arxiv.org/abs/2609.24410v1>
- **Submitted**: 2026-09-21 11:01:00
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 47. Efficient Reasoning Exploration via State-Conditioned Latent Steering with Progress Guidance
...
- **URL**: <http://arxiv.org/abs/2609.24066v1>
- **Submitted**: 2026-09-21 03:41:40
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 48. Explainable Recommendations at Scale: LLM Rationales for YouTube Music Artist Discovery
...
- **URL**: <http://arxiv.org/abs/2609.23877v1>
- **Submitted**: 2026-09-20 21:25:25
...
### 49. From UNDRR Reports to Event Records: Schema-Constrained LLM Extraction of Georeferenced Disasters

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Camilla Andreozzi, Phuong-Anh Nguyen-Le, Zhijing Jin, Revati Mani
- **URL**: <http://arxiv.org/abs/2609.23853v1>
- **Submitted**: 2026-09-20 20:14:51
