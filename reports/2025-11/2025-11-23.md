...
### 1. SMILE: A Composite Lexical-Semantic Metric for Question-Answering Evaluation
...
- **Reason**: This paper is highly relevant to your interests in Information Retrieval, particularly in query understanding and ranking models, as it focuses on evaluating question-answering systems using a novel composite metric. The paper's emphasis on semantic understanding and lexical similarity aligns with your research themes. However, the specific application to question-answering evaluation is somewhat narrow compared to your broader interests in IR and NLP.
...
### 2. A Little More Like This: Text-to-Image Retrieval with Vision-Language Models Using Relevance Feedback
...
- **Reason**: The paper focuses on relevance feedback for vision‑language image retrieval, which aligns with query understanding and iterative ranking—core IR themes. However, it does not address learning‑to‑rank, click models, or e‑commerce specific user behavior, so it is somewhat related but not a central match.
...
### 3. Parametric Retrieval-Augmented Generation using Latent Routing of LoRA Adapters
...
- **Reason**: This paper explores a novel approach to Retrieval-Augmented Generation (RAG) using Latent Routing of LoRA Adapters, which is related to your interests in Information Retrieval and Search technologies. However, the focus on Large Language Models and knowledge-intensive NLP tasks is somewhat tangential to your primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 4. OmniScientist: Toward a Co-evolving Ecosystem of Human and AI Scientists
...
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, particularly in the context of Large Language Models. However, its focus on AI Scientists and scientific collaboration mechanisms is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: OmniScientist: An AI Framework for Collaborative Scientific Research
- **Aim**: To address the limitations of current AI Scientist systems by integrating human-like collaborative mechanisms into AI-driven scientific workflows.
- **Rationale**: Existing AI systems focus on isolated search/optimization tasks, neglecting the social, iterative, and collaborative nature of human scientific research.
- **Ground**: ['Structured knowledge system leveraging citation networks and conceptual correlations', 'Collaborative research protocol (OSP) enabling multi-agent and human-AI co-evolution', 'Open evaluation platform (ScienceArena) using blind pairwise voting and Elo rankings for human-centric assessment']
- **Experiment**: End-to-end automation across scientific workflow stages: data foundation, literature review, research ideation, experiment automation, scientific writing, and peer review.
- **Takeaway**: OmniScientist establishes a sustainable innovation ecosystem by simulating human scientific collaboration, enabling scalable, human-AI co-creation in research.
...
### 5. Social-Media Based Personas Challenge: Hybrid Prediction of Common and Rare User Actions on Bluesky
...
- **Reason**: The paper explores social media user behavior prediction, which is somewhat related to information retrieval and user behavior modeling. However, the focus on social media and rare user actions is not directly aligned with the user's core research themes in e-commerce and deep semantic understanding.
...
### 6. CLLMRec: LLM-powered Cognitive-Aware Concept Recommendation via Semantic Alignment and Prerequisite Knowledge Distillation
...
- **Reason**: The paper explores concept recommendation in the context of Massive Open Online Courses (MOOCs), leveraging Large Language Models for semantic alignment and prerequisite knowledge distillation. While it touches on aspects of user behavior modeling and real-time relevance optimization, the primary focus is on recommender systems rather than information retrieval. The connection to NLP is also evident, but the paper's emphasis on educational scenarios and cognitive-aware recommendations limits its direct relevance to the user's core research themes.
...
### 7. Lost in Translation and Noise: A Deep Dive into the Failure Modes of VLMs on Real-World Tables
...
- **Reason**: The paper appears to be related to Natural Language Processing (NLP) and specifically focuses on the evaluation of Visual Language Models (VLMs) on tabular data. However, it does not directly align with the user's primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. The paper's focus on table reasoning and multilingual benchmarks is somewhat relevant but does not strongly overlap with the user's core research themes.
...
### 8. ARQUSUMM: Argument-aware Quantitative Summarization of Online Conversations
...
- **Topic Keywords**: rag, search
- **Reason**: The paper focuses on argument-aware quantitative summarization of online conversations, which is somewhat related to information retrieval and natural language processing. However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on argument structure and summarization is more aligned with NLP and data mining, but it does not seem to be a central match for the user's research themes.
...
### 9. RASTP: Representation-Aware Semantic Token Pruning for Generative Recommendation with Semantic Identifiers
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, but it focuses on generative recommendation systems and token pruning, which is not a central match. The paper's emphasis on semantic understanding and optimization is relevant, but its application to recommendation systems rather than search technologies limits its relevance.
...
### 10. Don't Learn, Ground: A Case for Natural Language Inference with Visual Grounding
...
- **Topic Keywords**: rag
- **Reason**: The paper explores Natural Language Inference with visual grounding, which is related to NLP, but not directly focused on Information Retrieval or Search technologies. While it touches on deep semantic understanding, the primary focus is on multimodal representations and visual grounding, which is not a central match for your research interests.
...
### 11. Large Language Models for Sentiment Analysis to Detect Social Challenges: A Use Case with South African Languages
...
- **Topic Keywords**: rag
- **Reason**: The paper explores the application of large language models for sentiment analysis in South African languages, which is somewhat related to information retrieval and NLP. However, the focus on sentiment analysis and social media posts is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 12. Learning to Compress: Unlocking the Potential of Large Language Models for Text Representation
...
- **Reason**: This paper explores the potential of large language models for text representation, which is somewhat related to information retrieval and NLP. However, the focus on text representation and language models is not directly aligned with the user's core research themes, particularly query understanding, ranking models, and user behavior modeling.
...
### 13. Improving Latent Reasoning in LLMs via Soft Concept Mixing
...
- **Topic Keywords**: rag
- **Reason**: This paper explores improving latent reasoning in Large Language Models (LLMs) via Soft Concept Mixing, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and NLP concepts is not directly aligned with the user's primary research interests in IR and search technologies. The paper's relevance is limited by its lack of direct connection to the user's core themes.
...
### 14. ConCISE: A Reference-Free Conciseness Evaluation Metric for LLM-Generated Answers
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on evaluating the conciseness of LLM-generated answers, which is not a central match with your primary focus on information retrieval and query understanding.
...
### 15. Supervised Fine Tuning of Large Language Models for Domain Specific Knowledge Graph Construction:A Case Study on Hunan's Historical Celebrities
...
- **Reason**: This paper explores the application of large language models in knowledge graph construction, specifically for a domain-specific case study. While it touches on information extraction and structured output generation, it doesn't directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to Natural Language Processing is relevant, but not strong enough to elevate the score.
...
### 16. δ-EMG: A Monotonic Graph Index for Approximate Nearest Neighbor Search
...
- **Reason**: This paper focuses on position embeddings in transformers, which is a topic in Natural Language Processing (NLP). However, it does not directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of interest for your research.
...
### 18. A Simple Yet Strong Baseline for Long-Term Conversational Memory of LLM Agents
...
- **Reason**: This paper focuses on conversational memory for LLM agents, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing, the context is specific to conversational systems and does not align with the user's primary research interests.
...
### 19. AutoLink: Autonomous Schema Exploration and Expansion for Scalable Schema Linking in Text-to-SQL at Scale
...
- **Reason**: This paper focuses on schema linking in text-to-SQL systems, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, the context is specific to database schema linking, making it somewhat tangential to your core research interests.
...
### 20. MusicAIR: A Multimodal AI Music Generation Framework Powered by an Algorithm-Driven Core
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves AI and deep learning, the focus is on music generation, which is outside your primary areas of interest.
...
### 21. Hallucinate Less by Thinking More: Aspect-Based Causal Abstention for Large Language Models
...
- **Reason**: This paper focuses on Large Language Models and their ability to abstain from providing factually incorrect responses. While it touches on the concept of knowledge reliability, it does not directly relate to Information Retrieval, query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 22. Principled Design of Interpretable Automated Scoring for Large-Scale Educational Assessments
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is primarily focused on automated scoring for educational assessments, which is outside your core research themes of Information Retrieval, Search technologies, and Natural Language Processing. While it involves the use of LLMs, the context and application are not aligned with your interests.
...
### 23. Masked-and-Reordered Self-Supervision for Reinforcement Learning from Verifiable Rewards
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Reinforcement Learning from Verifiable Rewards for mathematical reasoning, which is outside the primary scope of Information Retrieval and Search technologies. While it involves self-supervised tasks, the context is not related to query understanding, ranking models, or user behavior modeling, making it less relevant to the user's core research interests.
...
### 24. Beyond Multiple Choice: A Hybrid Framework for Unifying Robust Evaluation and Verifiable Reasoning Training
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on question answering and multimodal language models, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The paper's emphasis on question rewriting and verification is more aligned with NLP and data mining, but it doesn't seem to be a central match for your research interests.
...
### 25. PUCP-Metrix: A Comprehensive Open-Source Repository of Linguistic Metrics for Spanish
...
- **Topic Keywords**: rag
- **Reason**: This paper is primarily focused on linguistic metrics for Spanish, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and domain (Spanish linguistic metrics) are not aligned with your expertise in e-commerce and deep semantic understanding.
...
### 26. Robot Confirmation Generation and Action Planning Using Long-context Q-Former Integrated with Multimodal LLM
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves multimodal scene understanding and text-conditioning, its focus on human-robot interaction and action planning is not a central match for your core research themes.
...
### 27. Parrot: Persuasion and Agreement Robustness Rating of Output Truth -- A Sycophancy Robustness Benchmark for LLMs
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the robustness of large language models (LLMs) under social pressure, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, the specific context of persuasion and agreement robustness is not aligned with your primary focus on query understanding, ranking models, and user behavior modeling.
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves NLP and machine translation, its focus on automatic post-editing and dataset development does not align with the user's primary interests in query understanding, ranking models, and user behavior modeling.
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on AI benchmark revision and quality control, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on statistical analysis and model performance, the context is not aligned with the user's areas of focus.
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on model compression for large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is more about model optimization and compression rather than query understanding, ranking models, or user behavior modeling.
...
- **Topic Keywords**: rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, Natural Language Processing, or data mining. The paper focuses on video generation, physics-aware planning, and motion planning, which are unrelated to your core research themes.
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on discrete fuzzy numbers and their computational framework, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing.
