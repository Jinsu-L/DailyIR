...
- **Submitted**: 2026-07-28 04:13:47
- **Topic Keywords**: ranking, listwise, pairwise, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in ranking models and listwise ranking. The proposed framework, SRPO, addresses a limitation in existing RL-based ranking methods by incorporating structure-aware optimization, which is closely related to your interests in query understanding and ranking models. The experimental results and focus on listwise ranking make this paper a valuable contribution to your field.
...
- **Submitted**: 2026-07-28 01:23:04
- **Comment**: 8 pages, 3 figures
- **Topic Keywords**: information retrieval, retriever, passage retrieval, dense retrieval, ranking, rerank, retrieval, rank
- **Reason**: This paper presents a framework for training reasoning rerankers for tabular retrieval, which is a specific application of information retrieval. While it's not directly related to query understanding or ranking models in the traditional sense, it leverages large language models and chain-of-thought reasoning, which are relevant to my interests in NLP and deep semantic understanding.
...
### 3. The Case Against Generation for Retrieval: Discriminative Language Models as Effective Retrievers
...
- **Submitted**: 2026-07-28 06:47:53
- **Topic Keywords**: retriever, retrieval, recommend, rank
- **Reason**: This paper explores the application of Large Language Models (LLMs) in information retrieval, specifically adapting them as semantic representation backbones for a two-tower retrieval architecture. While not directly focused on query understanding or ranking models, the work is relevant to search technologies and user behavior modeling, particularly in the context of recommender systems and real-time relevance optimization.
...
### 4. HiEviDR-Bench: A Benchmark for Hierarchical Evidence Aggregation in Deep Research

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Yubo Sun, Chunyi Peng, Yukun Yan, Zhenghao Liu, Sen Mei, Bangrui Xu, Xuanhe Zhou, Chi Chen, Maosong Sun
- **URL**: <http://arxiv.org/abs/2607.25151v1>
- **Submitted**: 2026-07-27 23:50:46
- **Comment**: Code and data are available at https://ai9stars.github.io/HiEviDR-Bench.github.io
- **Topic Keywords**: queries, search
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of deep semantic understanding and real-time relevance optimization. The focus on hierarchical evidence aggregation and traceability-oriented evaluation framework aligns with query understanding and ranking models. However, the specific domain of deep research and academic settings limits its direct applicability to e-commerce, but the underlying concepts are transferable.
...
- **Submitted**: 2026-07-27 20:59:14
- **Comment**: 10 pages, 2 figures. Accepted at CLEF 2026 CheckThat!. To appear in CEUR Workshop Proceedings
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The use of large language models (LLMs) for ranking reasoning traces and predicting final verdicts aligns with your focus on deep semantic understanding and real-time relevance optimization. While the paper's focus is on numerical claim verification, it shares similarities with your work in query understanding and ranking models.
...
### 6. Beyond Self-Knowledge: Propagating Uncertainty Across Reasoning and Retrieval in LLMs

- **LLM Score**: 7
- **Keyword Score**: 4
- **Authors**: Chandan Kumar Sah, Li Zhang, Xiaoli Lian
- **URL**: <http://arxiv.org/abs/2607.25600v2>
- **Submitted**: 2026-07-28 11:30:25
- **Comment**: 9 pages, 6 figures, 6 tables
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores the use of uncertainty estimation in language models for retrieval-augmented generation, which aligns with your interests in query understanding and ranking models. The focus on leveraging verbalized confidence from black-box language models for retrieval routing is somewhat related to your work in information retrieval, particularly in areas requiring deep semantic understanding. However, the specific application to question answering and knowledge-intensive tasks is somewhat outside your primary focus on e-commerce and general information retrieval.
...
### 7. ScoreShield: Differentially Private Release of Similarity Scores

- **LLM Score**: 6
- **Keyword Score**: 12
- **Authors**: Behrooz Razeghi, Parsa Rahimi
- **URL**: <http://arxiv.org/abs/2607.25041v1>
- **Submitted**: 2026-07-27 20:02:28
- **Topic Keywords**: ranking, pairwise, rag, retrieval, recommend, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. However, the focus on differential privacy and similarity scores is not a central match to your primary interests in deep semantic understanding and real-time relevance optimization.
...
- **Submitted**: 2026-07-28 13:45:08
- **Comment**: 9 pages, 2 figures, 3 tables
- **Topic Keywords**: retriever, query, retrieval
- **Reason**: This paper explores tool retrieval for Large Language Model (LLM) agents, which is somewhat related to information retrieval and search technologies. However, the focus is on tool co-invocation and hyperedge prediction, which is not a central match to the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's relevance to the user's interests is somewhat diminished by its focus on a specific application domain (LLM agents) and a particular problem (tool retrieval).
...
### 9. The User Asks, Platforms Compete: How Agentic Recommendation Markets Take Shape

- **LLM Score**: 6
- **Keyword Score**: 8
- **Authors**: Deyao Hong, Kehan Zheng, Qian Li, Jun Zhang, Jie Jiang, Hongning Wang
- **URL**: <http://arxiv.org/abs/2607.25253v2>
- **Submitted**: 2026-07-28 03:54:38
- **Topic Keywords**: query, ranking, recommend, rank
- **Reason**: This paper explores a new paradigm in recommendation systems, where users specify needs before choosing a platform, and platforms compete for user attention. While it touches on ranking and user behavior modeling, the focus is more on the strategic play between platforms rather than deep semantic understanding or real-time relevance optimization. The paper's emphasis on agentic recommendation markets and joint mechanism design is somewhat related to IR and NLP, but not a central match for your core research themes.
...
### 10. Detecting Knowledge Inconsistencies Across Text, Tables, and Knowledge Graphs

- **LLM Score**: 6
- **Keyword Score**: 2
- **Authors**: Fanfu Wei, Thibault Ehrhart, Raphaël Troncy
- **URL**: <http://arxiv.org/abs/2607.25959v2>
- **Submitted**: 2026-07-28 16:43:56
- **Topic Keywords**: retrieval
- **Reason**: This paper explores the detection of inconsistencies across different modalities (text, tables, and knowledge graphs), which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on knowledge consistency and auditing is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling.
...
### 11. A Human-in-the-Loop Corpus for LLM-Based Simplification of Scientific Summaries

- **LLM Score**: 6
- **Keyword Score**: 1
- **Authors**: Kyuri Im, Michael Färber
- **URL**: <http://arxiv.org/abs/2607.25630v1>
- **Submitted**: 2026-07-28 12:12:39
- **Comment**: Accepted at FGWM@KI2026
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. However, its focus on simplification of scientific summaries and large language models is not a central match to your primary interests in IR and NLP. The paper's relevance to your work lies in its potential applications in improving the accessibility of scientific information, which may be of interest to you.
...
### 12. Reward Guided Decoding for Generative Recommendation
...
- **URL**: <http://arxiv.org/abs/2607.25344v1>
- **Submitted**: 2026-07-28 06:46:30
- **Topic Keywords**: ranking, rerank, recommend, personalization, rank, search
- **Reason**: The paper focuses on generative recommendation and decoding, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. While it involves personalization and real-world business objectives, the context is more aligned with recommender systems than information retrieval.
...
### 13. TopoGR: Revealing and Preserving Latent Structure of Semantic ID in Generative Recommendation
...
- **Submitted**: 2026-07-28 02:45:33
- **Comment**: under review
- **Topic Keywords**: ranking, rerank, recommend, rank
- **Reason**: This paper explores a novel approach to generative recommendation, leveraging topology in semantic ID spaces. While it touches on aspects of information retrieval, such as item relatedness and ranking, its primary focus is on recommendation systems, which is a related but distinct area of interest. The paper's emphasis on deep semantic understanding and real-time relevance optimization is somewhat relevant to your interests, but the context is different.
...
### 14. MARS: Multi-Agent Re-ranking for Repeat-Order Food Delivery Recommendation

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Jiahao Tian, Zhenkai Wang
- **URL**: <http://arxiv.org/abs/2607.25420v1>
- **Submitted**: 2026-07-28 08:18:08
- **Topic Keywords**: ranking, retrieval, recommend, rank
- **Reason**: The paper presents a multi-agent re-ranking framework for food delivery recommendation, which is somewhat related to information retrieval and recommender systems. However, it focuses on the e-commerce domain and uses large language models, which is not a central match to the user's interests in deep semantic understanding and real-time relevance optimization in IR. The paper also explores a specific application area, repeat-order food delivery recommendation, which is not a primary focus of the user's research.
...
### 15. FunnelAL: Retrieve-then-Rank Active Learning for Single-Class Discovery

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Reihaneh Rostami, Brian Goodwin
- **URL**: <http://arxiv.org/abs/2607.25276v1>
- **Submitted**: 2026-07-28 04:26:26
- **Comment**: 15 pages, 6 figures, 3 tables
- **Topic Keywords**: ranking, retrieval, recommend, rank
- **Reason**: The paper discusses active learning for single-class discovery, which is somewhat related to information retrieval and ranking models. However, the focus on image classification and recommender systems is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling in the e-commerce domain.
...
### 16. Memory Layer: Train the In-Model Cache for Recommendation Models
...
- **Submitted**: 2026-07-27 22:15:13
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, specifically in the context of recommendation systems and real-time relevance optimization. However, the focus on recommendation models and in-model caching is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 17. LLM-as-a-Judge for Evaluating System Responses in Conversational Music Recommendation

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Seungheon Doh, Bruno Sguerra, Sergio Oramas, Elena V. Epure, Juhan Nam
- **URL**: <http://arxiv.org/abs/2607.25640v1>
- **Submitted**: 2026-07-28 12:26:55
...
- **Reason**: The paper explores the use of LLM-as-a-judge for evaluating conversational music recommendation responses, which is somewhat related to information retrieval and search technologies. However, the focus on conversational systems and response generation is not a central match to the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 18. Grevo: A Unified Generative Recommendation Framework with Evolutionary Item Indexing

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Huanjie Wang, Liwei Guan, Zekai Sun, Hongwei Zhang, Honghui Bao
- **URL**: <http://arxiv.org/abs/2607.25329v1>
- **Submitted**: 2026-07-28 06:27:33
- **Topic Keywords**: user behavior, retrieval, recommend, search
- **Reason**: The paper discusses a unified Generative recommendation framework, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on recommender systems and item indexing is not a central match for the user's primary research themes, which are query understanding, ranking models, and user behavior modeling.
...
### 19. Bekko Embedding: Parameter-Efficient Multilingual Retrieval with Ultra-Compact Encoders

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Yuichi Tateno
- **URL**: <http://arxiv.org/abs/2607.25180v1>
- **Submitted**: 2026-07-28 01:13:37
- **Comment**: 45 pages, 9 figures. Model weights and training data: https://huggingface.co/hotchpotch
- **Topic Keywords**: ltr, retrieval, search
- **Reason**: This paper focuses on multilingual retrieval models, specifically the Bekko Embedding, which is a compact encoder for efficient retrieval. While it touches on aspects of search technologies and ranking models, its primary contribution is in the area of multilingual retrieval, which is somewhat related to the user's interests in information retrieval. However, the paper does not delve into query understanding, user behavior modeling, or deep semantic understanding, making it only loosely relevant to the user's core research themes.
...
### 20. MemSFT: Mitigating Alignment Tax with an External Parametric Memory
...
- **Submitted**: 2026-07-28 11:45:34
- **Comment**: 33 pages, 11 figures, 13 tables
- **Topic Keywords**: retriever, retrieval
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Large Language Models (LLMs), but it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of focus for you. The paper's focus on mitigating the alignment tax in LLMs is an interesting aspect, but it does not seem to be directly applicable to your primary research interests in Information Retrieval and Search technologies.
...
### 21. Phase Structure in Rotary Attention: A Spectral Framework for Semantic Continuity and Execution-Boundary Governance

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Abraham Chachamovits
- **URL**: <http://arxiv.org/abs/2607.25507v1>
- **Submitted**: 2026-07-28 09:41:05
- **Comment**: 14 pages; theoretical framework and proposed experimental program
- **Topic Keywords**: query, ctr
- **Reason**: The paper explores the phase structure in rotary attention, which is related to query understanding and ranking models in Information Retrieval. However, the focus is on the theoretical and methodological aspects of rotary position embedding, rather than practical applications or user behavior modeling. While it touches on semantic understanding, the connection to real-time relevance optimization and e-commerce is not explicitly mentioned.
...
### 22. Hypothesis-Driven Shelf Generation for Personalised Recommendation
...
- **Submitted**: 2026-07-28 15:05:42
- **Comment**: Accepted at ACM RecSys '26 (Industry Track)
- **Topic Keywords**: retrieval, recommend
- **Reason**: This paper focuses on recommendation systems, specifically shelf generation for personalized recommendations. While it touches on retrieval logic and generative models, it is not directly related to the user's core research themes in Information Retrieval, particularly query understanding, ranking models, and user behavior modeling. The paper's emphasis on natural-language hypotheses and generative retrieval is somewhat relevant, but it does not align with the user's primary focus on deep semantic understanding and real-time relevance optimization.
...
### 23. Sharpness-aware Model Merging with Salience Recovery for LLM-based Cross-Domain Sequential Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Huwei Ji, Jiajie Su, Yuyuan Li, Xiaohua Feng, Chaochao Chen
- **URL**: <http://arxiv.org/abs/2607.25366v1>
- **Submitted**: 2026-07-28 07:17:44
...
- **Reason**: The paper focuses on recommender systems, specifically LLM-based Cross-Domain Sequential Recommendation, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the emphasis on recommender systems and deep semantic understanding in a specific domain (recommendation) is not a central match for the user's primary focus on IR and Search technologies. The paper does touch on some relevant concepts like model merging and knowledge integration, but it is not directly applicable to the user's core research themes.
...
### 24. A Cost-Effective Multimodal LLM Reasoning Framework for Question Answering over Irregular Clinical Time Series

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Frank Nie, Ethan B Liu, Yuan Zhu, Wei Fan, Jindong Han
- **URL**: <http://arxiv.org/abs/2607.25947v1>
- **Submitted**: 2026-07-28 16:33:41
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), particularly in the context of question answering and multimodal reasoning frameworks. However, the focus on clinical time series and healthcare applications is not directly aligned with your primary interests in e-commerce and real-time relevance optimization. The paper's use of large language models and multimodal reasoning is somewhat relevant to your work in IR and NLP, but the specific application and methodology are not central to your research themes.
...
### 25. VaLiDRec: Variable-Length LLM-Aligned Semantic IDs for Generative Recommendation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Shutong Qiao, Wei Yuan, Tong Chen, Hao Wang, Quoc Viet Hung Nguyen, Hongzhi Yin
- **URL**: <http://arxiv.org/abs/2607.25209v1>
- **Submitted**: 2026-07-28 02:29:10
- **Comment**: 10 pages, 4 figures, 5 tables
- **Topic Keywords**: recommend, search
- **Reason**: The paper explores a new approach to generative recommendation using variable-length, LLM-aligned semantic identifiers. While it touches on aspects of query understanding and ranking models, its primary focus is on recommender systems, which is a related but secondary area of interest. The paper's emphasis on LLM-native variable-length semantic identifiers and its results on real-world datasets make it somewhat relevant to the user's research interests.
...
### 26. RecoReward: Recommender-Guided Multimodal Description Generation for Recommendation
...
- **URL**: <http://arxiv.org/abs/2607.25901v1>
- **Submitted**: 2026-07-28 15:59:00
- **Comment**: 16 pages, 4 figures
- **Topic Keywords**: recommend
- **Reason**: The paper focuses on recommender systems and multimodal description generation, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the primary focus on recommendation and user behavior modeling through rewards and reinforcement learning is not a central match for the user's core research themes, which include query understanding, ranking models, and deep semantic understanding.
...
### 27. AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology I: Literature Review
...
- **Submitted**: 2026-07-28 12:51:35
- **Comment**: 12 pages, 3 figures
- **Topic Keywords**: search
- **Reason**: The paper explores the application of large language models in assisting literature reviews, which is somewhat related to information retrieval and NLP. However, the focus on scientific research in physics, astrophysics, and cosmology is quite specific and does not align with the user's primary interests in e-commerce and real-time relevance optimization. While the paper touches on the potential of AI to complement human search, it does not delve into query understanding, ranking models, or user behavior modeling.
...
### 28. TWICE: Two-Clock, Two-Window Learning for Long-Horizon Conversion Prediction in Online Advertising

- **LLM Score**: 3
- **Keyword Score**: 6
- **Authors**: Kaiyuan Li, Kun Wang, Zhongbo Wang, Teng Sha, Ming Yan, Yanhua Cheng, Xialong Liu
- **URL**: <http://arxiv.org/abs/2607.25404v1>
- **Submitted**: 2026-07-28 08:02:41
- **Topic Keywords**: click, cvr, conversion rate
- **Reason**: This paper focuses on long-horizon conversion prediction in online advertising, which is somewhat related to information retrieval, but it primarily deals with conversion prediction rather than query understanding, ranking models, or user behavior modeling. The paper's use of two clocks and a framework for predicting post-click conversion rate is not directly applicable to the user's core research themes.
...
### 29. WorkSurface-Bench: Benchmarking Enterprise Agents on Multi-Surface Knowledge Routing

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Hao Liang, Meiyi Qiang, Sizhe Qiu, Linzhuang Sun, Wentao Zhang
- **URL**: <http://arxiv.org/abs/2607.25765v1>
- **Submitted**: 2026-07-28 14:19:59
- **Topic Keywords**: queries, retrieval
- **Reason**: This paper focuses on benchmarking enterprise agents for multi-surface knowledge routing, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves knowledge retrieval and routing, the context and scope are quite different from your areas of expertise.
...
### 30. Learning Dynamics of Strategic Publishers in Generative AI Ecosystems

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Sagie Dekel, Omer Madmon, Moshe Tennenholtz, Oren Kurland
- **URL**: <http://arxiv.org/abs/2607.25514v1>
- **Submitted**: 2026-07-28 09:53:10
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper focuses on Generative AI ecosystems and game-theoretic models of content creators, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on user behavior and welfare, the context is quite different from your e-commerce background and interests.
...
- **Submitted**: 2026-07-28 07:34:53
- **Comment**: 20 pages, 4 figures
- **Topic Keywords**: rag, ctr, search
- **Reason**: This paper appears to be focused on large language models, specifically their memory architectures. While it touches on some aspects of deep semantic understanding, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of interest. The paper's focus on NLP and language modeling is somewhat tangential to the user's research interests.
...
### 32. On the Convergent Validity of Offline Evaluation Designs for Recommender Systems

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Sushobhan Parajuli, Samira Vaez Barenji, Michael D. Ekstrand
- **URL**: <http://arxiv.org/abs/2607.25097v1>
- **Submitted**: 2026-07-27 21:54:19
- **Comment**: 9 pages, Accepted at ACM RecSys 2026 Main Track
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper is primarily focused on recommender systems, which is a related but secondary interest of yours. While it touches on evaluation methodologies, it doesn't directly address your core research themes in Information Retrieval, Search technologies, or Natural Language Processing.
...
### 33. UniMem: Complementary Episodic-to-Parametric Memory for Boundary-Agnostic Task Streams
...
- **Submitted**: 2026-07-28 17:28:21
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on memory management for large language models, proposing a framework called UniMem. While it does involve some aspects of task execution and adaptation, it is primarily concerned with memory stability and plasticity, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 34. Addressable Recall Compaction for Long Context-Window Control in AI Agents

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Thang Dang, Yuma Ichikawa, Sakina Fatima, Koichi Shirahata
- **URL**: <http://arxiv.org/abs/2607.25066v1>
- **Submitted**: 2026-07-27 20:51:05
- **Comment**: 20 pages, 2 figures
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on context management and compaction in AI agents, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on information retention and serving efficiency, the context is specific to AI agents and large language models, making it less relevant to your core areas of focus.
...
### 35. AIriskEval-edu Demo: Auditing of Pedagogical Risks in Educational Explanations
...
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on auditing pedagogical risks in educational explanations and explainable audit results does not align with your core themes of query understanding, ranking models, and user behavior modeling.
...
### 36. Data Quality Profiling at Scale with Progressive Sampling: A Benchmark for Data-Centric AI Pipelines

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Laure Berti-Equille
- **URL**: <http://arxiv.org/abs/2607.25356v1>
- **Submitted**: 2026-07-28 07:03:50
- **Comment**: 29 pages, 8 figures
- **Topic Keywords**: ltr
- **Reason**: This paper focuses on data quality profiling and sampling strategies, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on scalability and efficiency, the context is data-centric AI pipelines, which is not a primary area of interest for the user.
...
### 37. AngelSpec: Towards Real-World High Performance Inference with Speculative Decoding
...
- **URL**: <http://arxiv.org/abs/2607.25852v2>
- **Submitted**: 2026-07-28 15:25:05
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speculative decoding for large language model inference, which is not directly related to information retrieval or search technologies. While it involves deep semantic understanding, the context is not aligned with the user's primary research interests in IR and search technologies.
...
### 38. Evaluation of Adversarial Robustness in Arabic Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Anwar Alajmi, Ayed Salman, Imtiaz Ahmad
- **URL**: <http://arxiv.org/abs/2607.25814v1>
- **Submitted**: 2026-07-28 14:58:28
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Arabic Language Models and adversarial attacks, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, it's more focused on model security and safety concerns rather than deep semantic understanding or real-time relevance optimization.
...
### 39. CAST: Game Solvers as Turn-Level Teachers for LLM Agents
...
- **Submitted**: 2026-07-28 05:39:01
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on Reinforcement Learning and Game Solvers. While it involves large language models, the context is not relevant to query understanding, ranking models, or user behavior modeling.
...
### 40. Interpretable Column Annotation with LLM-Symbolized Decision Process Materialization
...
- **Submitted**: 2026-07-28 03:02:05
- **Comment**: 13 pages, 7 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on column annotation and uses LLMs for semantic skeleton induction, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP elements, the context and application are quite different from the user's primary interests.
...
### 41. Evaluating Communicative Belief Updates in Large Language Models via Implicature Recognition and Cancellation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Cesare Spinoso-Di Piano, Verna Dankers, Marius Mosbach, Jackie Chi Kit Cheung
- **URL**: <http://arxiv.org/abs/2607.25094v2>
- **Submitted**: 2026-07-27 21:35:22
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are the core areas of your research interests. While it involves Natural Language Processing, the focus is on large language models' ability to understand unspoken beliefs and belief updates, which is not a central match to your research themes.
...
### 42. RSIBench-Data: Benchmarking Data-Centric Research for Recursive Self-Improvement
...
- **Submitted**: 2026-07-28 15:46:41
- **Topic Keywords**: search
- **Reason**: This paper appears to be focused on benchmarking data-centric research for recursive self-improvement, which is a topic outside of the user's primary research interests in Information Retrieval and Search technologies. While it touches on the idea of agents learning from feedback, it does not directly relate to query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's research.
...
### 43. AI's Capability in Assisting Scientific Research in Physics, Astrophysics, and Cosmology II: Project Planning and Proposal Evaluation
...
- **URL**: <http://arxiv.org/abs/2607.25881v1>
- **Submitted**: 2026-07-28 15:43:01
- **Comment**: 16 pages, 4 figures
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves large language models, the focus is on their application in scientific project planning and proposal evaluation, which is outside your primary areas of interest.
...
### 44. Instruction-based Image Editing: A Survey on Data, Models, Evaluation, and Applications
...
- **URL**: <http://arxiv.org/abs/2607.25642v1>
- **Submitted**: 2026-07-28 12:27:59
- **Comment**: 33 pages, 7 figures, Vicinagearth
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves models and evaluation metrics, its focus on Image Editing and Vision-Language Models makes it an off-topic area for the user's interests.
...
### 45. HANDBOOK.md: A Benchmark for Long-Context Agentic Instruction Following
...
- **Reason**: This paper appears to be focused on benchmarking language model agents in a specific deployment pattern, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, the context and scope of the work seem to be more aligned with AI development and testing rather than the user's core research themes.
...
### 46. MyoCardBench: A Real-World Data Benchmark for Evaluating Large Language Models in Clinically Authentic Cardiovascular Care Scenarios

- **LLM Score**: 1
- **Keyword Score**: 3
- **Authors**: Xiao Li, Mouxiao Bian, Zhaodi Wu, Sijie Ren, Juechen Chen, Lu Lu, Jingru Ding, Yun Zhong, Jie Xu, Yixiu Liang, Junbo Ge
- **URL**: <http://arxiv.org/abs/2607.25186v1>
- **Submitted**: 2026-07-28 01:39:52
- **Topic Keywords**: rag, rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on evaluating Large Language Models in a medical domain, which is outside your primary areas of interest.
...
### 47. Forensic Reproducibility Audit of a Radiology Vision-Language Model Benchmark: From Intended Protocol to Released Artifact

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Mateusz Kozłowski
- **URL**: <http://arxiv.org/abs/2607.25589v1>
- **Submitted**: 2026-07-28 11:19:38
...
- **Topic Keywords**: ranking, rank
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, Natural Language Processing, and data mining. The paper focuses on a forensic reproducibility audit of a radiology vision-language model benchmark, which is outside the scope of your research areas.
...
### 48. Temporal-Distance JEPA: Plan-Aware Representation Learning for Latent World Model Predictive Control

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Jiaxin Bai, Jiaxuan Xiong
- **URL**: <http://arxiv.org/abs/2607.25337v2>
- **Submitted**: 2026-07-28 06:38:16
- **Topic Keywords**: ranking, rank
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The paper focuses on Latent World Model Predictive Control, which is a topic in the field of robotics and control systems, and does not seem to have any connection to your areas of expertise.
...
### 49. Pass the Baton: Trajectory-Relayed On-Policy Distillation
...
- **Submitted**: 2026-07-28 17:59:46
- **Comment**: Project Page: https://zju-real.github.io/Relay-OPD Code: https://github.com/zju-real/Relay-OPD
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on on-policy distillation in the context of natural language processing, specifically addressing prefix failure in token-level supervision. While it involves optimization and trajectory analysis, it does not seem to be directly related to information retrieval, search technologies, or user behavior modeling, which are the primary areas of interest.
...
### 50. Grounded in Consensus, In Step With Emerging Science: A Consensus-Anchored Multi-Corpus Clinical Chatbot for Long COVID

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yining Wu, Philip DiGiacomo, Ying Ding, William Brode
- **URL**: <http://arxiv.org/abs/2607.25038v1>
- **Submitted**: 2026-07-27 19:57:23
- **Topic Keywords**: retrieval
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The focus is on clinical decision support, chatbots, and medical literature, which is outside your primary areas of interest.
