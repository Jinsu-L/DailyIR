# Daily Papers Report - 2026-04-19
...
- **Submitted**: 2026-04-17 02:00:52
- **Comment**: 7pages, 2figures
- **Topic Keywords**: ranking, rerank, listwise, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The proposed AdaRankLLM framework and its evaluation through adaptive listwise reranking and progressive distillation align with your focus on real-time relevance optimization and deep semantic understanding. However, the paper's primary focus on Large Language Models and their robustness to noise is somewhat tangential to your e-commerce background, which prevents a perfect match.
...
### 2. UsefulBench: Towards Decision-Useful Information as a Target for Information Retrieval

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Tobias Schimanski, Stefanie Lewandowski, Christian Woerle, Nicola Reichenau, Yauheni Huryn, Markus Leippold
- **URL**: <http://arxiv.org/abs/2604.15827v1>
- **Submitted**: 2026-04-17 08:29:44
- **Topic Keywords**: information retrieval, query, relevance, retrieval
- **Reason**: This paper aligns well with your interests in Information Retrieval, particularly in query understanding and ranking models. The concept of 'usefulness' as a target for IR is a novel and relevant direction, and the discussion of LLM-based systems is also relevant to your interests in deep semantic understanding and real-time relevance optimization.
...
### 3. Skill-RAG: Failure-State-Aware Retrieval Augmentation via Hidden-State Probing and Skill Routing

- **LLM Score**: 8
- **Keyword Score**: 7
- **Authors**: Kai Wei, Raymond Li, Xi Zhu, Zhaoqian Xue, Jiaojiao Han, Jingcheng Niu, Fan Yang
- **URL**: <http://arxiv.org/abs/2604.15771v1>
- **Submitted**: 2026-04-17 07:25:43
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed Skill-RAG framework addresses query-evidence misalignment, a key challenge in IR, and demonstrates strong gains on out-of-distribution datasets. While the focus is on Retrieval-Augmented Generation, the techniques and insights can be applied to other areas of IR.
...
### 4. CHOP: Chunkwise Context-Preserving Framework for RAG on Multi Documents

- **LLM Score**: 7
- **Keyword Score**: 17
- **Authors**: Hyunseok Park, Jihyeon Kim, Jongeun Kim, Dongsik Yoon
- **URL**: <http://arxiv.org/abs/2604.15802v1>
- **Submitted**: 2026-04-17 08:05:17
- **Topic Keywords**: retriever, query, ranking, relevance, rag, retrieval, rank
- **Reason**: This paper proposes a framework (CHOP) to address retrieval accuracy issues in Retrieval-Augmented Generation systems, particularly when dealing with similar documents. While it's not directly focused on query understanding, ranking models, or user behavior modeling, it does involve information retrieval and deep semantic understanding. The paper's relevance to information retrieval and its use of Large Language Models make it somewhat related to your research interests.
...
### 5. Learning Behaviorally Grounded Item Embeddings via Personalized Temporal Contexts

- **LLM Score**: 7
- **Keyword Score**: 3
- **Authors**: Rafael T. Sereicikas, Pedro R. Pires, Gregorio F. Azevedo, Tiago A. Almeida
- **URL**: <http://arxiv.org/abs/2604.15581v1>
- **Submitted**: 2026-04-16 23:28:27
- **Comment**: Accepted to be published in UMAP'26, 9 pages, 7 figures
- **Topic Keywords**: user behavior, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of recommender systems and user behavior modeling. However, it focuses more on item embeddings and temporal contexts, which, while relevant, is not a central match to your primary focus on query understanding, ranking models, and deep semantic understanding in IR.
...
### 6. vstash: Local-First Hybrid Retrieval with Adaptive Fusion for LLM Agents

- **LLM Score**: 6
- **Keyword Score**: 19
- **Authors**: Jayson Steffens
- **URL**: <http://arxiv.org/abs/2604.15484v1>
- **Submitted**: 2026-04-16 19:22:58
- **Topic Keywords**: query, queries, ranking, rerank, relevance, retrieval, rank, search
- **Reason**: The paper presents a novel hybrid retrieval system that combines vector similarity search with full-text keyword matching. While it touches on aspects of search technologies and ranking models, its primary focus is on improving retrieval efficiency and adaptability, which is somewhat related to the user's interests in Information Retrieval and ranking models. However, the paper's emphasis on local-first document memory systems and adaptive fusion for LLM agents is not a central match for the user's core research themes.
...
### 7. BioHiCL: Hierarchical Multi-Label Contrastive Learning for Biomedical Retrieval with MeSH Labels

- **LLM Score**: 6
- **Keyword Score**: 13
- **Authors**: Mengfei Lan, Lecheng Zheng, Halil Kilicoglu
- **URL**: <http://arxiv.org/abs/2604.15591v1>
- **Submitted**: 2026-04-17 00:09:01
- **Comment**: Accepted by ACL 2026 Main Conference
- **Topic Keywords**: information retrieval, retriever, relevance, rag, retrieval
- **Reason**: The paper focuses on biomedical information retrieval, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the specific domain (biomedical) and application (MeSH labels) are not directly aligned with the user's core research themes. The use of contrastive learning and hierarchical relationships is an interesting aspect, but it does not directly relate to the user's primary focus on query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.15882v1>
- **Submitted**: 2026-04-17 09:30:24
- **Comment**: 5 pages. Accepted at SIGIR 2026 Resource Track
- **Topic Keywords**: queries, rag, retrieval, search
- **Reason**: The paper introduces a benchmark for Japanese financial text embeddings, which is related to information retrieval and NLP. However, it is not directly focused on query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on a specific domain (Japanese financial text) and task (embedding benchmark) makes it somewhat relevant but not a central match for the user's research interests.
...
- **URL**: <http://arxiv.org/abs/2604.15945v1>
- **Submitted**: 2026-04-17 11:07:32
- **Comment**: accepted at IJCNN 2026
- **Topic Keywords**: relevance, rag, retrieval
- **Reason**: The paper focuses on Retrieval-Augmented Generation (RAG) and hallucination detection in Large Language Models (LLMs), which is somewhat related to query understanding and ranking models in Information Retrieval. However, the primary focus is on NLP and LLMs, rather than traditional IR or search technologies.
...
### 10. Target-Oriented Pretraining Data Selection via Neuron-Activated Graph
...
- **URL**: <http://arxiv.org/abs/2604.15706v1>
- **Submitted**: 2026-04-17 05:27:03
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper introduces a novel approach to target-oriented language model pretraining, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on pretraining data selection and neuron-activated graphs is not directly aligned with the user's core research themes, but shows some potential for application in deep semantic understanding and real-time relevance optimization.
...
### 11. FD-NL2SQL: Feedback-Driven Clinical NL2SQL that Improves with Use
...
- **URL**: <http://arxiv.org/abs/2604.15646v1>
- **Submitted**: 2026-04-17 02:45:57
- **Topic Keywords**: queries, retrieval
- **Reason**: This paper explores a natural language to SQL (NL2SQL) system for clinical oncology databases, which is somewhat related to information retrieval and query understanding. However, the focus on clinical databases and SQL generation is not directly aligned with the user's core research themes in e-commerce and deep semantic understanding. The paper's use of LLMs and sentence embeddings is relevant to NLP, but the application is specific to clinical databases.
...
### 12. CIG: Measuring Conversational Information Gain in Deliberative Dialogues with Semantic Memory Dynamics

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Ming-Bin Chen, Jey Han Lau, Lea Frermann
- **URL**: <http://arxiv.org/abs/2604.15647v1>
- **Submitted**: 2026-04-17 02:46:27
- **Comment**: 24 pages, 5 figures
- **Topic Keywords**: relevance
- **Reason**: The paper explores conversational information gain and semantic memory dynamics, which relates to deep semantic understanding in information retrieval. However, the focus on deliberative dialogues and conversation quality analysis is somewhat distant from the user's primary interests in search technologies and user behavior modeling.
...
### 13. "Excuse me, may I say something..." CoLabScience, A Proactive AI Assistant for Biomedical Discovery and LLM-Expert Collaborations

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Yang Wu, Jinhong Yu, Jingwei Xiong, Zhimin Tao, Xiaozhong Liu
- **URL**: <http://arxiv.org/abs/2604.15588v1>
- **Submitted**: 2026-04-16 23:46:22
- **Comment**: ACL 2026 Main Conference
- **Topic Keywords**: rag, search
- **Reason**: The paper explores the integration of Large Language Models (LLMs) in a biomedical context, which is somewhat related to the user's interests in NLP and related topics. However, the focus on proactive AI assistants and biomedical discovery is not directly aligned with the user's core research themes in Information Retrieval and Search technologies. The paper's use of reinforcement learning and intervention in scientific discussions is an interesting aspect, but it does not strongly connect to the user's research interests.
...
### 14. AtManRL: Towards Faithful Reasoning via Differentiable Attention Saliency

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Max Henning Höth, Kristian Kersting, Björn Deiseroth, Letitia Parcalabescu
- **URL**: <http://arxiv.org/abs/2604.16158v1>
- **Submitted**: 2026-04-17 15:27:35
- **Comment**: 14 pages, 8 figures, 1 table
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving the interpretability of large language models through reinforcement learning and attention manipulation. While it touches on aspects of query understanding and ranking models, its primary focus is on NLP and model interpretability, which is somewhat related to the user's interests in IR and search technologies. However, the connection is not direct, and the paper's emphasis on LLMs and reasoning traces makes it more relevant to NLP and AI interpretability than to the user's core research themes.
...
### 15. Polarization by Default: Auditing Recommendation Bias in LLM-Based Content Curation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Nicolò Pagan, Christopher Barrie, Chris Andrew Bail, Petter Törnberg
- **URL**: <http://arxiv.org/abs/2604.15937v1>
- **Submitted**: 2026-04-17 10:55:21
- **Topic Keywords**: recommend, rank
- **Reason**: This paper explores biases in Large Language Models (LLMs) used for content curation, which is somewhat related to information retrieval and search technologies. However, the focus on recommendation bias and content curation is not a central match to the user's core research themes, which are primarily centered around query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.15840v1>
- **Submitted**: 2026-04-17 08:41:26
- **Comment**: Accepted to ACL 2026
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, specifically in the area of Learning to Rank and user behavior modeling. However, the focus on reinforcement learning for LLM agents and task synthesis is not directly aligned with your primary interests in query understanding, ranking models, and click models. The connection to NLP is present, but the application to recommender systems is not a central match.
...
### 17. Scattered Hypothesis Generation for Open-Ended Event Forecasting

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: He Chang, Zhulin Tao, Lifang Yang, Xianglin Huang, Yunshan Ma
- **URL**: <http://arxiv.org/abs/2604.15788v1>
- **Submitted**: 2026-04-17 07:48:38
- **Topic Keywords**: rag
- **Reason**: The paper focuses on open-ended event forecasting, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. However, it does involve the use of reinforcement learning and NLP, which are tangentially related to the user's interests. The paper's emphasis on semantic alignment and diversity rewards may be of some interest to the user, but it is not a central match for their research focus.
...
### 18. PIIBench: A Unified Multi-Source Benchmark Corpus for Personally Identifiable Information Detection

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Pritesh Jha
- **URL**: <http://arxiv.org/abs/2604.15776v1>
- **Submitted**: 2026-04-17 07:32:46
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and data mining, but it focuses on Personally Identifiable Information (PII) detection, which is not a central match to your primary focus on information retrieval and query understanding. The paper's relevance to recommender systems is also limited, but it does involve NLP and data mining, making it loosely relevant to your broader interests.
...
### 19. Improving Reasoning Capabilities in Small Models through Mixture-of-Layers Distillation with Stepwise Attention on Key Information

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yao Chen, Jiawei Sheng, Wenyuan Zhang, Tingwen Liu
- **URL**: <http://arxiv.org/abs/2604.15701v1>
- **Submitted**: 2026-04-17 05:08:44
- **Comment**: Accepted at EMNLP 2025
- **Topic Keywords**: rag
- **Reason**: The paper's focus on distillation and attention mechanisms in language models is somewhat related to query understanding and ranking models in Information Retrieval. However, the specific application to small models and reasoning capabilities is not directly aligned with the user's primary research interests in IR and Search technologies. The connection to NLP is more relevant, but the paper's scope is narrower than the user's broader interests in NLP and related topics.
...
### 20. Preference Estimation via Opponent Modeling in Multi-Agent Negotiation
...
- **URL**: <http://arxiv.org/abs/2604.15687v1>
- **Submitted**: 2026-04-17 04:20:43
- **Comment**: This paper is accepted as a Findings of ACL 2026
- **Topic Keywords**: rag
- **Reason**: The paper explores opponent modeling in multi-agent negotiation, leveraging Large Language Models for natural language understanding. While it touches on aspects of semantic understanding, its primary focus is on negotiation and preference estimation, which is somewhat related to information retrieval but not a central match to the user's core research themes.
...
### 21. SIMMER: Cross-Modal Food Image--Recipe Retrieval via MLLM-Based Embedding

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Keisuke Gomi, Keiji Yanai
- **URL**: <http://arxiv.org/abs/2604.15628v1>
- **Submitted**: 2026-04-17 02:09:26
- **Comment**: 20 pages, 6 figures
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves cross-modal retrieval and multimodal large language models. However, the specific application domain (food images and recipe texts) and task (cross-modal food image-recipe retrieval) are not directly aligned with your core research themes.
...
### 22. GroupDPO: Memory efficient Group-wise Direct Preference Optimization

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Jixuan Leng, Si Si, Hsiang-Fu Yu, Vinod Raman, Inderjit S. Dhillon
- **URL**: <http://arxiv.org/abs/2604.15602v1>
- **Submitted**: 2026-04-17 00:56:59
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it deals with optimizing Large Language Models using preference feedback. However, the focus on preference optimization and group-wise direct preference optimization is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 23. LLMs Corrupt Your Documents When You Delegate

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Philippe Laban, Tobias Schnabel, Jennifer Neville
- **URL**: <http://arxiv.org/abs/2604.15597v1>
- **Submitted**: 2026-04-17 00:33:32
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves Large Language Models (LLMs) and their potential to corrupt documents. However, the focus on delegated workflows and AI system reliability in professional domains is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.
...
### 24. PolicyBank: Evolving Policy Understanding for LLM Agents

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Jihye Choi, Jinsung Yoon, Long T. Le, Somesh Jha, Tomas Pfister
- **URL**: <http://arxiv.org/abs/2604.15505v1>
- **Submitted**: 2026-04-16 20:29:30
- **Topic Keywords**: acl
- **Reason**: This paper explores a memory mechanism for LLM agents to refine their policy understanding through interaction and corrective feedback. While it touches on the theme of query understanding and semantic understanding, it is primarily focused on organizational policies and policy compliance, which is somewhat related to your research interests in Information Retrieval and NLP, but not a central match.
...
### 25. Collaborative Filtering Through Weighted Similarities of User and Item Embeddings

- **LLM Score**: 3
- **Keyword Score**: 2
- **Authors**: Pedro R. Pires, Rafael T. Sereicikas, Gregorio F. Azevedo, Tiago A. Almeida
- **URL**: <http://arxiv.org/abs/2604.15573v1>
- **Submitted**: 2026-04-16 23:07:12
- **Comment**: Published in SAC'25, 8 pages, 4 figures
- **Topic Keywords**: recommend, search
- **Reason**: This paper is somewhat relevant to your research interests in Information Retrieval and recommender systems, but it focuses more on collaborative filtering and matrix factorization, which is not your primary area of focus. While it does involve user and item embeddings, the context is more related to recommender systems rather than deep semantic understanding and real-time relevance optimization.
...
### 26. FineSteer: A Unified Framework for Fine-Grained Inference-Time Steering in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Zixuan Weng, Jinghuai Zhang, Kunlin Cai, Ying Li, Peiran Wang, Yuan Tian
- **URL**: <http://arxiv.org/abs/2604.15488v1>
- **Submitted**: 2026-04-16 19:41:41
- **Comment**: Accepted by ACL 2026 (Main)
- **Topic Keywords**: query, queries
- **Reason**: This paper focuses on fine-grained inference-time steering in Large Language Models, which is not directly related to Information Retrieval or Search technologies. While it touches on deep semantic understanding, the context is different from the user's primary interests in IR and NLP.
...
- **URL**: <http://arxiv.org/abs/2604.15715v1>
- **Submitted**: 2026-04-17 05:36:00
- **Topic Keywords**: queries, rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or your other areas of interest. It focuses on developing general-purpose agents for productivity workflows, which is more aligned with AI and robotics research. While it involves tool-use and workflow completion, the context is quite different from your core research themes.
...
### 28. Can LLMs Understand the Impact of Trauma? Costs and Benefits of LLMs Coding the Interviews of Firearm Violence Survivors

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jessica H. Zhu, Shayla Stringfield, Vahe Zaprosyan, Michael Wagner, Michel Cukier, Joseph B. Richardson
- **URL**: <http://arxiv.org/abs/2604.16132v1>
- **Submitted**: 2026-04-17 15:07:27
- **Comment**: Accepted to Findings of the Association for Computational Linguistics (2026)
- **Topic Keywords**: relevance, search
- **Reason**: This paper is not relevant to your research interests as it focuses on the application of Large Language Models (LLMs) in qualitative research, specifically in the context of firearm violence survivors' interviews. The paper does not relate to Information Retrieval, Search technologies, or other areas of interest mentioned in your background.
...
### 29. A Case Study on the Impact of Anonymization Along the RAG Pipeline

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Andreea-Elena Bodea, Stephen Meisenbacher, Florian Matthes
- **URL**: <http://arxiv.org/abs/2604.15958v1>
- **Submitted**: 2026-04-17 11:23:59
- **Comment**: 7 pages, 1 figure, 6 tables. Accepted to IWSPA 2026
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on Retrieval-Augmented Generation (RAG), a subfield of IR, its primary focus is on anonymization and privacy concerns, which is not a central match to your interests.
...
### 30. Experience Compression Spectrum: Unifying Memory, Skills, and Rules in LLM Agents

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Xing Zhang, Guanghui Wang, Yanwei Cui, Wei Qiu, Ziyuan Li, Bing Zhu, Peiyang He
- **URL**: <http://arxiv.org/abs/2604.15877v1>
- **Submitted**: 2026-04-17 09:26:25
- **Topic Keywords**: ctr, retrieval
- **Reason**: This paper focuses on Large Language Model (LLM) agents and experience compression, which is not directly related to Information Retrieval (IR) or Search technologies. While it touches on knowledge management, it's more aligned with NLP and AI systems, but lacks the specific focus on query understanding, ranking models, or user behavior modeling that are central to your research interests.
...
### 31. Cut Your Losses! Learning to Prune Paths Early for Efficient Parallel Reasoning

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Jiaxi Bi, Tongxu Luo, Wenyu Du, Zhengyang Tang, Benyou Wang
- **URL**: <http://arxiv.org/abs/2604.16029v1>
- **Submitted**: 2026-04-17 13:00:22
- **Comment**: 9 pages, 7 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on parallel reasoning and path pruning for Large Reasoning Models, which is outside the scope of Information Retrieval and Search technologies. Although it involves machine learning and optimization, the context and application are not aligned with the user's core research themes.
...
### 32. Weak-Link Optimization for Multi-Agent Reasoning and Collaboration

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Haoyu Bian, Chaoning Zhang, Jiaquan Zhang, Xingyao Li, Yuanfang Guo, Wei Dong, Yang Yang
- **URL**: <http://arxiv.org/abs/2604.15972v1>
- **Submitted**: 2026-04-17 11:36:20
- **Comment**: 13 pages, 4 figures. Submitted to CAAI Transactions on Intelligence Technology
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on multi-agent reasoning and collaboration, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of optimization and machine learning, the context and application are quite different from your areas of expertise.
...
### 33. DiZiNER: Disagreement-guided Instruction Refinement via Pilot Annotation Simulation for Zero-shot Named Entity Recognition

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Siun Kim, Hyung-Jin Yoon
- **URL**: <http://arxiv.org/abs/2604.15866v1>
- **Submitted**: 2026-04-17 09:16:30
- **Comment**: 9 pages, 3 figures; Accepted to the ACL 2026 Main Conference
- **Topic Keywords**: pairwise
- **Reason**: This paper focuses on zero-shot Named Entity Recognition using large language models, which is a specific topic within Natural Language Processing. While it involves information extraction, it is not directly related to information retrieval, query understanding, or ranking models, which are the core areas of your research interests.
...
### 34. DALM: A Domain-Algebraic Language Model via Three-Phase Structured Generation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Chao Li
- **URL**: <http://arxiv.org/abs/2604.15593v1>
- **Submitted**: 2026-04-17 00:25:32
- **Topic Keywords**: query
- **Reason**: This paper appears to be primarily focused on language models and knowledge representation, which is somewhat related to your interests in Natural Language Processing (NLP) and data mining. However, the specific topic of domain-algebraic language models and structured denoising does not seem to align closely with your core research themes in Information Retrieval (IR) and Search technologies.
...
### 35. No Universal Courtesy: A Cross-Linguistic, Multi-Model Study of Politeness Effects on LLMs Using the PLUM Corpus

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Hitesh Mehta, Arjit Saxena, Garima Chhikara, Rohit Kumar
- **URL**: <http://arxiv.org/abs/2604.16275v1>
- **Submitted**: 2026-04-17 17:33:48
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the impact of politeness on Large Language Models (LLMs), which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific topic of politeness and its effects on LLMs is not a central match for your research themes.
...
### 36. Detecting and Suppressing Reward Hacking with Gradient Fingerprints

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Songtao Wang, Quang Hieu Pham, Fangcong Yin, Xinpeng Wang, Jocelyn Qiaochu Chen, Greg Durrett, Xi Ye
- **URL**: <http://arxiv.org/abs/2604.16242v1>
- **Submitted**: 2026-04-17 17:01:24
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. While it touches on the concept of 'reward hacking' which could be seen as a form of 'exploitation' in a model, the paper's focus on reinforcement learning and gradient fingerprints is not a central match for your research themes.
...
### 37. BAGEL: Benchmarking Animal Knowledge Expertise in Language Models
...
- **URL**: <http://arxiv.org/abs/2604.16241v1>
- **Submitted**: 2026-04-17 17:00:37
- **Comment**: 28 pages, 3 figures
- **Topic Keywords**: retrieval
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval and Search technologies. Although it involves language models, the focus is on evaluating animal knowledge expertise, which is not a central theme in your research. The paper's emphasis on closed-book evaluation and biodiversity-related applications does not align with your interests in query understanding, ranking models, and user behavior modeling.
...
### 38. Sentiment Analysis of German Sign Language Fairy Tales

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Fabrizio Nunnari, Siddhant Jain, Patrick Gebhard
- **URL**: <http://arxiv.org/abs/2604.16138v1>
- **Submitted**: 2026-04-17 15:10:59
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on sentiment analysis of German sign language fairy tales, which is outside the scope of information retrieval, search technologies, and natural language processing. Although it involves NLP, the specific application and methodology do not align with your areas of interest.
...
### 39. Beyond One-Size-Fits-All: Adaptive Test-Time Augmentation for Sequential Recommendation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Xibo Li, Liang Zhang
- **URL**: <http://arxiv.org/abs/2604.16121v1>
- **Submitted**: 2026-04-17 14:56:29
- **Comment**: 10 pages. arXiv admin note: text overlap with arXiv:2504.04843 by other authors
- **Topic Keywords**: recommend, rank
- **Reason**: This paper focuses on sequential recommendation and adaptive test-time augmentation, which is somewhat related to information retrieval, but primarily deals with recommender systems. While it involves reinforcement learning and Markov Decision Processes, the context is not aligned with the user's core research themes in IR and NLP.
...
### 40. How Hypocritical Is Your LLM judge? Listener-Speaker Asymmetries in the Pragmatic Competence of Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Judith Sieker, Sina Zarrieß
- **URL**: <http://arxiv.org/abs/2604.15873v1>
- **Submitted**: 2026-04-17 09:22:16
- **Comment**: Accepted at ACL 2026 (findings)
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and related topics. The focus is on the pragmatic competence of Large Language Models, which is a topic in Natural Language Processing, but it does not align with your primary focus on deep semantic understanding and real-time relevance optimization in IR.
...
- **Keyword Score**: 2
- **Authors**: Qwen Team
- **URL**: <http://arxiv.org/abs/2604.15804v1>
- **Submitted**: 2026-04-17 08:05:46
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on multimodal models and their applications in audio-visual understanding and interaction, which is somewhat related to your interests in Natural Language Processing and related topics. However, it does not seem to directly address your core research themes in Information Retrieval, query understanding, ranking models, or user behavior modeling.
...
### 42. Self-Distillation as a Performance Recovery Mechanism for LLMs: Counteracting Compression and Catastrophic Forgetting

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Chi Liu, Xin Chen, Xu Zhou, Fangbo Tu, Srinivasan Manoharan
- **URL**: <http://arxiv.org/abs/2604.15794v1>
- **Submitted**: 2026-04-17 07:55:38
- **Comment**: 14 pages, 8 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models (LLMs) and their performance degradation due to factors such as catastrophic forgetting and compression. While it involves a ranking model (LLMs) and deep semantic understanding, the context is not directly related to information retrieval, search technologies, or user behavior modeling, which are the primary areas of interest.
...
### 43. Pruning Unsafe Tickets: A Resource-Efficient Framework for Safer and More Robust LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Wai Man Si, Mingjie Li, Michael Backes, Yang Zhang
- **URL**: <http://arxiv.org/abs/2604.15780v1>
- **Submitted**: 2026-04-17 07:37:41
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models (LLMs) and their alignment, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the primary topic is model safety and pruning, which is not a central match for the user's research themes.
...
### 44. Learning Uncertainty from Sequential Internal Dispersion in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Ponhvoan Srey, Xiaobao Wu, Cong-Duy Nguyen, Anh Tuan Luu
- **URL**: <http://arxiv.org/abs/2604.15741v1>
- **Submitted**: 2026-04-17 06:31:29
- **Comment**: Accepted at ACL 2026 (Main Conference)
- **Topic Keywords**: rag
- **Reason**: This paper focuses on uncertainty estimation in large language models, which is a topic in NLP. However, it does not directly relate to information retrieval, query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 45. On the Equivalence Between Auto-Regressive Next Token Prediction and Full-Item-Vocabulary Maximum Likelihood Estimation in Generative Recommendation--A Short Note

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yusheng Huang, Shuang Yang, Zhaojie Liu, Han Li
- **URL**: <http://arxiv.org/abs/2604.15739v1>
- **Submitted**: 2026-04-17 06:27:42
- **Comment**: Work in progress
- **Topic Keywords**: recommend, search
- **Reason**: This paper appears to be focused on generative recommendation, which is related to recommender systems, but it lacks direct relevance to information retrieval, query understanding, ranking models, and user behavior modeling, which are core areas of interest.
...
### 46. C-Mining: Unsupervised Discovery of Seeds for Cultural Data Synthesis via Geometric Misalignment
...
- **URL**: <http://arxiv.org/abs/2604.15675v1>
- **Submitted**: 2026-04-17 03:54:12
- **Topic Keywords**: rag
- **Reason**: This paper focuses on cultural data synthesis and seed curation for Large Language Models, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP and data mining, the specific application and methodology are not aligned with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 47. LLM attribution analysis across different fine-tuning strategies and model scales for automated code compliance

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jack Wei Lun Shi, Minghao Dang, Wawan Solihin, Justin K. W. Yeoh
- **URL**: <http://arxiv.org/abs/2604.15589v1>
- **Submitted**: 2026-04-16 23:54:26
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on automated code compliance and interpretability, which is not a central theme in your research.
...
### 48. Why Fine-Tuning Encourages Hallucinations and How to Fix It

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Guy Kaplan, Zorik Gekhman, Zhen Zhu, Lotem Rozner, Yuval Reif, Swabha Swayamdipta, Derek Hoiem, Roy Schwartz
- **URL**: <http://arxiv.org/abs/2604.15574v1>
- **Submitted**: 2026-04-16 23:08:18
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on deep semantic understanding, the focus is on mitigating hallucinations in large language models, which is a topic more closely aligned with NLP and AI safety rather than your core areas of interest.
...
### 49. Optimizing Korean-Centric LLMs via Token Pruning

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Hoyeol Kim, Hyeonwoo Kim
- **URL**: <http://arxiv.org/abs/2604.16235v1>
- **Submitted**: 2026-04-17 16:53:14
- **Comment**: 5 pages
- **Topic Keywords**: korea
- **Reason**: This paper focuses on optimizing large language models for Korean-centric tasks through token pruning, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing, the specific application and techniques used are not aligned with the user's core research themes.
...
### 50. JumpLoRA: Sparse Adapters for Continual Learning in Large Language Models
...
- **URL**: <http://arxiv.org/abs/2604.16171v1>
- **Submitted**: 2026-04-17 15:38:37
- **Topic Keywords**: rank
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on Continual Learning in Large Language Models. While it involves adapters and Low-Rank Adaptation, the context is not aligned with the user's core research themes.
