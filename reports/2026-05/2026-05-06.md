...
### 1. Reproducing Complex Set-Compositional Information Retrieval

- **LLM Score**: 8
- **Keyword Score**: 15
- **Authors**: Vincent Degenhart, Dewi Timman, Arjen P. de Vries, Faegheh Hasibi, Mohanna Hoveyda
- **URL**: <http://arxiv.org/abs/2605.03824v1>
- **Submitted**: 2026-05-05 14:51:40
- **Comment**: Accepted to SIGIR 2026, Reproducibility Track
- **Topic Keywords**: information retrieval, retriever, queries, relevance, retrieval, search
- **Reason**: This paper is highly relevant to Information Retrieval, specifically focusing on complex set-compositional queries and the evaluation of different retrieval paradigms. The study's emphasis on reproducibility and controlled evaluation aligns with the user's interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on retrieval effectiveness and methods may not be as central to the user's research themes as query understanding and ranking models.
...
- **Submitted**: 2026-05-05 17:42:50
- **Comment**: ACL 2026
- **Topic Keywords**: retriever, query, relevance, retrieval, search
- **Reason**: This paper is highly relevant to your interests in Information Retrieval, particularly in the context of agentic search systems and reasoning-intensive retrieval. The focus on evaluating and advancing retrievers aligns with your expertise in query understanding and ranking models. The use of novel benchmarks and evaluation protocols also resonates with your interests in deep semantic understanding and real-time relevance optimization.
...
### 3. Revisiting General Map Search via Generative Point-of-Interest Retrieval

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Dong Chen, Shuai Zheng, Haoyang Shao, Hongsheng Wu, Muhao Xu, Yeyu Yan, Ruifang Li, Zhenfeng Zhu
- **URL**: <http://arxiv.org/abs/2605.03397v1>
- **Submitted**: 2026-05-05 06:19:06
- **Comment**: 11 pages, 5 figures, 5 table
- **Topic Keywords**: queries, relevance, rag, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The proposed generative framework, GenPOI, leverages Large Language Models for spatial-aware candidate generation, which aligns with your focus on deep semantic understanding and real-time relevance optimization. However, the specific application to map search scenarios is somewhat outside your e-commerce domain background.
...
### 4. SURE-RAG: Sufficiency and Uncertainty-Aware Evidence Verification for Selective Retrieval-Augmented Generation

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Jingxi Qiu, Zeyu Han, Cheng Huang
- **URL**: <http://arxiv.org/abs/2605.03534v1>
- **Submitted**: 2026-05-05 09:05:40
- **Comment**: 8 pages, 2 figures, 8 tables. Submitted to IEEE PRAI 2026
- **Topic Keywords**: ranking, rag, retrieval, rank, acl
- **Reason**: This paper presents a novel approach to retrieval-augmented generation, focusing on evidence sufficiency verification. While not directly related to query understanding or ranking models, it explores the intersection of information retrieval and natural language processing, which aligns with your interests. The paper's emphasis on controlled sufficiency verification and auditable selective scoring also resonates with your focus on real-time relevance optimization.
...
### 5. SERE: Structural Example Retrieval for Enhancing LLMs in Event Causality Identification

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Zhifeng Hao, Zhongjie Chen, Junhao Lu, Shengyin Yu, Guimin Hu, Keli Zhang, Ruichu Cai, Boyan Xu
- **URL**: <http://arxiv.org/abs/2605.03701v1>
- **Submitted**: 2026-05-05 12:50:19
- **Comment**: Accepted to Findings of ACL 2026
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is highly relevant to the field of Information Retrieval, particularly in the context of query understanding and ranking models. Although it focuses on Large Language Models and Event Causality Identification, the proposed SERE framework's use of structural example retrieval and few-shot learning capabilities aligns with the user's interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on NLP tasks and event causality identification limits its direct relevance to the user's core research themes.
...
### 7. Retrieving Floods without Floodlights: Topic Models as Binary Classifiers for Extreme Climate Events in German News

- **LLM Score**: 7
- **Keyword Score**: 7
- **Authors**: Brielen Madureira, Mariana Madruga de Brito, Andreas Niekler
- **URL**: <http://arxiv.org/abs/2605.03450v1>
- **Submitted**: 2026-05-05 07:32:22
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, specifically in the application of topic models for refining the retrieval of relevant news about extreme climate events. Although it does not directly focus on query understanding, ranking models, or user behavior modeling, it explores the use of NLP methods for identifying relevant texts in large news databases, which is relevant to the user's interests in IR and NLP.
...
### 8. Domain-Adaptive Dense Retrieval for Brazilian Legal Search

- **LLM Score**: 6
- **Keyword Score**: 11
- **Authors**: Jayr Pereira, Roberto Lotufo, Luiz Bonifacio
- **URL**: <http://arxiv.org/abs/2605.04005v1>
- **Submitted**: 2026-05-05 17:25:11
- **Topic Keywords**: retriever, dense retrieval, rag, retrieval, search
- **Reason**: This paper explores domain-adaptive dense retrieval for Brazilian legal search, which is somewhat related to information retrieval and search technologies. However, the focus on legal search and domain adaptation is not a central match to the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 9. Natural Language Processing: A Comprehensive Practical Guide from Tokenisation to RLHF

- **LLM Score**: 6
- **Keyword Score**: 3
- **Authors**: Mullosharaf K. Arabov
- **URL**: <http://arxiv.org/abs/2605.03799v1>
- **Submitted**: 2026-05-05 14:25:48
- **Comment**: Preprint
- **Topic Keywords**: retrieval, search
- **Reason**: The paper is somewhat related to the user's research interests in Natural Language Processing (NLP) and its applications. However, it focuses more on a comprehensive guide for NLP practitioners rather than specific topics like query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 10. Beyond Similarity Search: A Unified Data Layer for Production RAG Systems

- **LLM Score**: 4
- **Keyword Score**: 12
- **Authors**: Venkata Krishna Prasanth Budigi, Siri Chandana Sirigiri
- **URL**: <http://arxiv.org/abs/2605.03275v1>
- **Submitted**: 2026-05-05 02:04:10
- **Comment**: 8 pages, 1 figure, 4 tables
- **Topic Keywords**: query, queries, rag, retrieval, recommend, search
- **Reason**: This paper proposes a unified data layer for RAG systems, addressing issues like data staleness and query composition explosion. While it touches on search technologies, its primary focus is on database architecture and performance optimization, which is somewhat related to your interests in Information Retrieval and Search technologies. However, it doesn't directly address query understanding, ranking models, or user behavior modeling, making it only loosely relevant.
...
### 11. OCRR: A Benchmark for Online Correction Recovery under Distribution Shift

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Adrian Grassi
- **URL**: <http://arxiv.org/abs/2605.03153v1>
- **Submitted**: 2026-05-04 20:51:07
...
- **Reason**: This paper introduces a benchmark for online correction recovery under distribution shift, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus is on classification systems and continual learning, which is not a central match to the user's research interests in search technologies and user behavior modeling.
...
### 12. Aspect-Aware Content-Based Recommendations for Mathematical Research Papers

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Ankit Satpute, André Greiner-Petter, Noah Gießing, Olaf Teschke, Moritz Schubotz, Akiko Aizawa, Bela Gipp
- **URL**: <http://arxiv.org/abs/2605.03861v1>
- **Submitted**: 2026-05-05 15:23:37
...
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it deals with content-based recommendations and aspect-aware modeling. However, the focus on mathematical research papers and the specific application domain limits its relevance to the user's core research themes.
...
### 13. Transformers with Selective Access to Early Representations

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Skye Gunasekaran, Téa Wright, Rui-Jie Zhu, Jason Eshraghian
- **URL**: <http://arxiv.org/abs/2605.03953v2>
- **Submitted**: 2026-05-05 16:38:29
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper introduces a new Transformer architecture called SATFormer, which selectively accesses early representations in the model. While it is related to deep learning and NLP, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on improving Transformer performance through selective access to early representations is somewhat relevant to IR, but it is not a central match.
...
- **URL**: <http://arxiv.org/abs/2605.03514v1>
- **Submitted**: 2026-05-05 08:50:28
- **Topic Keywords**: query, search
- **Reason**: This paper explores the understanding of graph tokens by large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on graph token understanding and its limitations does not directly align with the user's core research themes, and the connection to real-time relevance optimization is not clear.
...
### 15. From prompting to evidence-based translation: A RAG+prompt system for Japanese-Chinese translation and its pedagogical potential

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Wenshi Gu
- **URL**: <http://arxiv.org/abs/2605.03387v1>
- **Submitted**: 2026-05-05 05:48:08
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it primarily focuses on machine translation and linguistic analysis, which is not a central match for your core research themes in Information Retrieval (IR) and Search technologies.
...
### 16. Correct Is Not Enough: Training Reasoning Planners with Executor-Grounded Rewards

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Tianyang Han, Hengyu Shi, Junjie Hu, Xu Yang, Zhiling Wang, Junhao Su
- **URL**: <http://arxiv.org/abs/2605.03862v2>
- **Submitted**: 2026-05-05 15:24:40
- **Comment**: 36 pages
- **Topic Keywords**: relevance
- **Reason**: This paper explores the realm of reasoning and planning in large language models, but its focus on reasoning quality and usefulness is somewhat tangential to information retrieval and search technologies. While it touches on the idea of evaluating intermediate states, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 17. A Comparison of Traditional Machine Learning Algorithms and LSTM-Based Deep Learning Models for Email Sentiment Analysis

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Virdio Samuel Saragih, Baruna Abirawa, Kartini Lovian Simbolon, Luluk Muthoharoh, Ardika Satria, Martin C. T. Manullang
- **URL**: <http://arxiv.org/abs/2605.03440v1>
- **Submitted**: 2026-05-05 07:20:52
- **Comment**: 9 pages, 3 figures, 6 tables
- **Topic Keywords**: ctr, search
- **Reason**: The paper focuses on email sentiment analysis, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves machine learning and deep learning models, the context is specific to email classification and sentiment detection, and does not explore query understanding, ranking models, or user behavior modeling.
...
### 18. Benchmarking Logistic Regression, SVM, Naive Bayes, and IndoBERT Fine-Tuning for Sentiment Analysis on Indonesian Product Reviews
...
- **URL**: <http://arxiv.org/abs/2605.03439v1>
- **Submitted**: 2026-05-05 07:20:42
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of sentiment analysis and deep semantic understanding. However, the focus on traditional Machine Learning approaches and sentiment analysis in e-commerce product reviews is not a central match to your primary research themes.
...
### 19. Geometric Deviation as an Unsupervised Pre-Generation Reliability Signal: Probing LLM Representations for Answerability

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Yucheng Du
- **URL**: <http://arxiv.org/abs/2605.03196v1>
- **Submitted**: 2026-05-04 22:24:34
- **Comment**: Accepted to TrustNLP 2026 (ACL Workshop). 11 pages, 3 figures, 3 tables
- **Topic Keywords**: query
- **Reason**: This paper explores the use of geometric deviation as a pre-generation signal for answerability in language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language models and answerability is not directly aligned with the user's primary research themes, and the connection to real-time relevance optimization is not clear.
...
### 20. Evaluating Reasoning Models for Queries with Presuppositions

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Rose Sathyanathan, Kinshuk Vasisht, Danish Pruthi
- **URL**: <http://arxiv.org/abs/2605.03050v1>
- **Submitted**: 2026-05-04 18:15:28
- **Comment**: Accepted to ACL 2026 (Findings)
- **Topic Keywords**: queries
- **Reason**: This paper explores the ability of reasoning models to handle presuppositions in user queries, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on large language models and their reasoning capabilities, rather than traditional IR techniques, limits its relevance to your core research themes. The paper's emphasis on NLP aspects makes it more relevant to your broader interests in NLP and related topics.
...
### 21. Logical Consistency as a Bridge: Improving LLM Hallucination Detection via Label Constraint Modeling between Responses and Self-Judgments

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Hao Mi, Qiang Sheng, Shaofei Wang, Beizhe Hu, Yifan Sun, Zhengjia Wang, Hengqi Zeng, Yang Li, Danding Wang, Juan Cao
- **URL**: <http://arxiv.org/abs/2605.03971v1>
- **Submitted**: 2026-05-05 16:53:20
- **Comment**: ACL 2026 Main Conference
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Large Language Models (LLMs), but it does not directly address query understanding, ranking models, or user behavior modeling. The paper's focus on hallucination detection and logical consistency is an interesting application of NLP, but it is not a central match for your core research themes.
...
### 22. Task Vector Geometry Underlies Dual Modes of Task Inference in Transformers

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Hao Yan, Haolin Yang, Yiqiao Zhong
- **URL**: <http://arxiv.org/abs/2605.03780v1>
- **Submitted**: 2026-05-05 14:07:55
- **Topic Keywords**: retrieval
- **Reason**: This paper explores the internal representations of Transformers, specifically task vectors, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on task inference and generalization in Transformers is not directly aligned with the user's core research themes in IR and Search technologies. The connection to NLP is more relevant, but still not a central match.
...
### 23. SAM-NER: Semantic Archetype Mediation for Zero-Shot Named Entity Recognition

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Ruichu Cai, Juntao Gan, Miao Mai, Zhifeng Hao, Boyan Xu
- **URL**: <http://arxiv.org/abs/2605.03706v1>
- **Submitted**: 2026-05-05 12:54:17
- **Comment**: Accepted to Findings of ACL 2026
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Named Entity Recognition (NER), but it does not directly align with your primary focus on Information Retrieval (IR), query understanding, and ranking models. The paper's emphasis on zero-shot learning and semantic archetypes is an interesting aspect, but it does not seem to be a central match for your research themes.
...
### 24. Semantically Enriching Investor Micro-blogs for Opinion-Aware Emotion Analysis: A Practical Approach

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Gaurav Negi, Paul Buitelaar
- **URL**: <http://arxiv.org/abs/2605.03092v1>
- **Submitted**: 2026-05-04 19:11:36
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on sentiment analysis and opinion-aware emotion analysis in the financial domain, leveraging semantically structured opinion graphs and Graph Neural Networks. While it touches on NLP and data mining, it is not directly related to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 25. OpenSeeker-v2: Pushing the Limits of Search Agents with Informative and High-Difficulty Trajectories

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Yuwen Du, Rui Ye, Shuo Tang, Keduan Huang, Xinyu Zhu, Yuzhu Cai, Siheng Chen
- **URL**: <http://arxiv.org/abs/2605.04036v1>
- **Submitted**: 2026-05-05 17:55:25
- **Comment**: 7 pages
- **Topic Keywords**: search
- **Reason**: The paper focuses on search agent development using Large Language Models, which is somewhat related to information retrieval. However, the emphasis on deep learning and model training methods, while relevant to search technologies, does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 26. Annotation Quality in Aspect-Based Sentiment Analysis: A Case Study Comparing Experts, Students, Crowdworkers, and Large Language Model

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Niklas Donhauser, Jakob Fehle, Nils Constantin Hellwig, Markus Weinberger, Udo Kruschwitz, Christian Wolff
- **URL**: <http://arxiv.org/abs/2605.03624v1>
- **Submitted**: 2026-05-05 10:54:05
- **Topic Keywords**: search
- **Reason**: This paper primarily focuses on Aspect-Based Sentiment Analysis, which is related to Natural Language Processing (NLP), but it does not directly align with your core research interests in Information Retrieval (IR), Search technologies, or query understanding. While it touches on annotation quality and dataset construction, which might be tangentially relevant to your work on user behavior modeling and click models, the paper's main contributions are not directly applicable to your research areas.
...
### 27. The Right Answer, the Wrong Direction: Why Transformers Fail at Counting and How to Fix It

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Gabriel Garcia
- **URL**: <http://arxiv.org/abs/2605.03258v1>
- **Submitted**: 2026-05-05 01:13:06
- **Comment**: 26 pages, 3 figures; Code and reproduction materials: https://github.com/Gpgabriel25/GeometricReadoutBottleneck
- **Topic Keywords**: rank
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on a specific issue with transformer models and counting tasks, which is not a central match for the user's research themes. While it involves understanding and representation, the context is more on the model's architecture and optimization rather than user behavior modeling or query understanding.
...
### 28. CuraView: A Multi-Agent Framework for Medical Hallucination Detection with GraphRAG-Enhanced Knowledge Verification

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Severin Ye, Xiao Kong, Xiaopeng He, Guangsu Yan, Dongsuk Oh
- **URL**: <http://arxiv.org/abs/2605.03476v1>
- **Submitted**: 2026-05-05 08:05:31
- **Comment**: 44 pages, 8 figures, 13 tables
- **Topic Keywords**: rag, ctr, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves text analysis and knowledge verification, its focus on medical hallucination detection and clinical documentation is outside your primary areas of interest.
...
### 29. PIIGuard: Mitigating PII Harvesting under Adversarial Sanitization

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Mingshuo Liu, Yiwei Zha, Min Chen
- **URL**: <http://arxiv.org/abs/2605.03129v1>
- **Submitted**: 2026-05-04 20:13:22
- **Topic Keywords**: queries, rag, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves web pages and models, the focus is on protecting personally identifiable information (PII) from being scraped by LLM assistants, which is not a central theme in your research.
...
### 30. PatRe: A Full-Stage Office Action and Rebuttal Generation Benchmark for Patent Examination

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Qiyao Wang, Xinyi Chen, Longze Chen, Hongbo Wang, Hamid Alinejad-Rokny, Yuan Lin, Min Yang
- **URL**: <http://arxiv.org/abs/2605.03571v1>
- **Submitted**: 2026-05-05 09:42:38
- **Comment**: 24 pages, 11 figures, 16 tables
- **Topic Keywords**: retrieval, search, acl
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves the use of Large Language Models (LLMs), the focus is on patent examination, which is outside the user's primary domain of interest in e-commerce and general IR/NLP applications.
...
### 31. TeamUp: Semantic Project Matching and Team Formation for Learning at Scale

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Dhruv Gulwani, Basem Suleiman, Aditya Joshi, Sonit Singh
- **URL**: <http://arxiv.org/abs/2605.03237v1>
- **Submitted**: 2026-05-05 00:07:59
- **Comment**: 8 pages
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves semantic embeddings and ranking algorithms, the focus is on team formation and project matching for learning at scale, which is not a central theme in your research.
...
### 32. Safety and accuracy follow different scaling laws in clinical large language models
...
- **Submitted**: 2026-05-05 17:57:19
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on the safety and accuracy of clinical large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of NLP, the context and application are quite different from your areas of focus.
...
### 33. Workspace-Bench 1.0: Benchmarking AI Agents on Workspace Tasks with Large-Scale File Dependencies
...
- **URL**: <http://arxiv.org/abs/2605.03596v1>
- **Submitted**: 2026-05-05 10:17:06
- **Comment**: 30 pages, 17 figures
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on evaluating AI agents on workspace learning tasks with large-scale file dependencies, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of retrieval and reasoning, the context and scope are quite different from your core areas of focus.
...
### 34. SHIELD: A Diverse Clinical Note Dataset and Distilled Small Language Models for Enterprise-Scale De-identification

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jose D. Posada, David Love, Somalee Datta, Priya Desai
- **URL**: <http://arxiv.org/abs/2605.03301v1>
- **Submitted**: 2026-05-05 02:43:55
- **Topic Keywords**: rag, ctr
- **Reason**: This paper is primarily focused on de-identification of clinical text and the development of a dataset and models for this task. While it involves natural language processing and uses a language model, it is not directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 35. TriBench-Ko: Evaluating LLM Risks in Judicial Workflows

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Haesung Lee, Gyubin Choi, Eun-Ju Lee, So-Min Lee, Youkang Ko, Dogyoon Lim, Sung-Kyoung Jang, Yohan Jo
- **URL**: <http://arxiv.org/abs/2605.03792v1>
- **Submitted**: 2026-05-05 14:20:28
- **Comment**: 10 pages
- **Topic Keywords**: retrieval, korea
- **Reason**: This paper focuses on evaluating the risks of Large Language Models (LLMs) in judicial workflows, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the context and application are quite different from your areas of focus.
...
### 36. Rational Communication Shapes Morphological Composition

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Fengyuan Yang, Yongqian Peng, Yuxi Ma, Chenheng Xu, Yixin Zhu
- **URL**: <http://arxiv.org/abs/2605.03510v1>
- **Submitted**: 2026-05-05 08:44:23
- **Topic Keywords**: rag, rank
- **Reason**: This paper appears to be primarily focused on morphological composition in language, using the Rational Speech Act framework to model communicative efficiency. While it involves some aspects of semantic understanding, it does not seem to be directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 37. MAGE: Safeguarding LLM Agents against Long-Horizon Threats via Shadow Memory

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yuhui Wang, Tanqiu Jiang, Jiacheng Liang, Charles Fleming, Ting Wang
- **URL**: <http://arxiv.org/abs/2605.03228v1>
- **Submitted**: 2026-05-04 23:46:19
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on large language model (LLM) agents and long-horizon threats, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of memory, it's more focused on security and safety aspects rather than query understanding, ranking models, or user behavior modeling.
...
### 38. Benchmarking Parameter-Efficient Fine-Tuning of Large Language Models for Low-Resource Tajik Text Generation with the Tajik Web Corpus

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mullosharaf K. Arabov
- **URL**: <http://arxiv.org/abs/2605.03742v1>
- **Submitted**: 2026-05-05 13:28:31
- **Comment**: Preprint
- **Topic Keywords**: recommend, rank
- **Reason**: This paper focuses on low-resource language text generation using large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves fine-tuning and ranking models, the context is specific to language generation and Tajik text, making it less relevant to your research areas.
...
### 39. Segmenting Human-LLM Co-authored Text via Change Point Detection

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mengchu Li, Jin Zhu, Jinglai Li, Chengchun Shi
- **URL**: <http://arxiv.org/abs/2605.03723v1>
- **Submitted**: 2026-05-05 13:08:55
- **Topic Keywords**: rag
- **Reason**: This paper focuses on detecting LLM-generated text, which is not directly related to information retrieval, query understanding, or ranking models. While it involves text analysis, the primary goal is not to improve search or recommendation systems, but rather to ensure authenticity and trust in text generated by LLMs.
...
### 40. Rose-SQL: Role-State Evolution Guided Structured Reasoning for Multi-Turn Text-to-SQL

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Le Zhou, Feng Yao, Fengcai Qiao, Bo Xu, Fangyuan Wang, Boyan Xu
- **URL**: <http://arxiv.org/abs/2605.03720v1>
- **Submitted**: 2026-05-05 13:06:51
- **Topic Keywords**: rag
- **Reason**: This paper focuses on a Text-to-SQL task, which is a specific application of Natural Language Processing (NLP). While it involves some form of query understanding, it is not directly related to the user's core research themes in Information Retrieval (IR) and Search technologies, particularly query understanding, ranking models, and user behavior modeling.
...
### 41. Exposing LLM Safety Gaps Through Mathematical Encoding:New Attacks and Systematic Analysis

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Haoyu Zhang, Mohammad Zandsalimy, Shanu Sushmita
- **URL**: <http://arxiv.org/abs/2605.03441v1>
- **Submitted**: 2026-05-05 07:25:33
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models (LLMs) and their safety mechanisms, which is outside the primary scope of Information Retrieval and Search technologies. While it touches on semantic understanding, the context is not relevant to query understanding, ranking models, or user behavior modeling in the e-commerce domain or other areas of interest.
...
### 42. S^2tory: Story Spine Distillation for Movie Script Summarization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mingzhe Lu, Yanbing Liu, Qihao Wang, Jiarui Zhang, Jiayue Wu, Yue Hu, Yunpeng Li, Yangyan Xu
- **URL**: <http://arxiv.org/abs/2605.03244v1>
- **Submitted**: 2026-05-05 00:25:09
- **Topic Keywords**: rag
- **Reason**: This paper focuses on movie script summarization using narratology-grounded framework, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, the context is limited to summarization and not aligned with the user's core research themes.
...
### 43. The TTS-STT Flywheel: Synthetic Entity-Dense Audio Closes the Indic ASR Gap Where Commercial and Open-Source Systems Fail

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Venkata Pushpak Teja Menta
- **URL**: <http://arxiv.org/abs/2605.03073v1>
- **Submitted**: 2026-05-04 18:43:30
- **Comment**: 8 pages, 2 figures. Companion to arXiv:2604.25441 (Praxy Voice TTS), arXiv:2604.25476 (PSP), arXiv:2605.00777 (LASE)
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech-to-text (STT) and text-to-speech (TTS) technologies for Indic languages, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the primary focus on speech recognition and synthesis does not align with the user's primary research themes.
...
- **Submitted**: 2026-05-05 16:12:30
- **Comment**: 28 pages, 5 figures, 2 tables, supplement will be made available upon original publication
- **Topic Keywords**: recommend
- **Reason**: This paper appears to be primarily focused on the application of Natural Language Processing (NLP) and Large Language Models in a clinical setting, with a focus on clinician trust and decision support. While it touches on the concept of 'recommendations,' it does not seem to be directly related to Information Retrieval, Search technologies, or query understanding, which are core areas of your research interests.
...
### 45. Agentic-imodels: Evolving agentic interpretability tools via autoresearch
...
- **Submitted**: 2026-05-05 14:35:47
- **Topic Keywords**: search
- **Reason**: This paper focuses on agentic data science and interpretability tools for agents, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve machine learning and data analysis, the context and application are quite different from your areas of focus.
...
### 46. Geolocating News about Extreme Climate Events: A Comparative Analysis of Off-the-Shelf Tools for Toponym Identification in German

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Brielen Madureira, Mariana Madruga de Brito, Andreas Niekler
- **URL**: <http://arxiv.org/abs/2605.03414v1>
- **Submitted**: 2026-05-05 06:40:26
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Named-entity recognition (NER) and toponym identification, which are related to query understanding, the focus on geolocation of climate events and the use of off-the-shelf NER tools for German news articles do not align with the user's primary interests.
...
### 47. Benchmarking Local Language Models for Social Robots using Edge Devices

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Dorian Lamouille, Matevž B. Zorec, Farnaz Baksh, Karl Kruusamäe
- **URL**: <http://arxiv.org/abs/2605.03111v1>
- **Submitted**: 2026-05-04 19:49:22
...
- **Topic Keywords**: rank
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language models, the focus is on edge devices for social robots, which is not a central theme in your research. The paper's emphasis on benchmarking and inference efficiency also diverges from your interests in query understanding, ranking models, and user behavior modeling.
...
### 48. Physics-Grounded Multi-Agent Architecture for Traceable, Risk-Aware Human-AI Decision Support in Manufacturing
...
- **URL**: <http://arxiv.org/abs/2605.04003v1>
- **Submitted**: 2026-05-05 17:24:53
- **Topic Keywords**: retrieval, recommend
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The paper focuses on a multi-agent architecture for decision support in manufacturing, which is outside your areas of expertise.
...
### 49. An ERP Study of Recursive Possessive Parsing in ASD Children and Its Cognitive Neuro Mechanisms

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Fu Chenxi, Wang Xiaoyi, Zhuang Ziman, Yang Caimei
- **URL**: <http://arxiv.org/abs/2605.03447v1>
- **Submitted**: 2026-05-05 07:31:22
- **Comment**: 20pages, 7 figures
- **Topic Keywords**: ctr
- **Reason**: This paper is unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. It focuses on an ERP study of recursive possessive parsing in children with autism spectrum disorder, which is outside your areas of expertise.
...
### 50. Cosmodoit: A Python Package for Adaptive, Efficient Pipelining of Feature Extraction from Performed Music

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Corentin Guichaoua, Daniel Bedoya, Elaine Chew
- **URL**: <http://arxiv.org/abs/2605.03541v1>
- **Submitted**: 2026-05-05 09:14:23
- **Comment**: 6 pages, 1 figure
- **Topic Keywords**: search
- **Reason**: This paper focuses on music performance analysis and feature extraction, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
