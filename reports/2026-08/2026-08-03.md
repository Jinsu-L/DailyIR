...
### 1. CeQe: Grounding Lexical Retrieval in Semantic Evidence

- **LLM Score**: 9
- **Keyword Score**: 25
- **Authors**: Adam Kahirov, Umesh Deshpande, Swaminathan Sundararaman
- **URL**: <http://arxiv.org/abs/2608.00452v1>
- **Submitted**: 2026-08-01 05:27:20
- **Topic Keywords**: retriever, semantic search, query, ranking, rerank, relevance, relevance feedback, retrieval, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically query understanding and ranking models. The authors propose a novel approach to query expansion using cross-encoder attributions, which aligns with your focus on deep semantic understanding and real-time relevance optimization.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Cross‑Encoder Query Expansion (CE‑QE) and Semantic‑Enhanced Search Fusion (SESF) for improving lexical retrieval recall and ranking
- **Aim**: To lift the recall ceiling of BM25 while keeping the index untouched and adding minimal latency, by expanding queries with semantically grounded tokens and fusing lexical and semantic signals
- **Rationale**: Lexical retrievers miss documents lacking surface term overlap (vocabulary‑gap). Classical PRF amplifies errors, generative LLM expansion risks hallucination and high cost. CE‑QE uses dense retrieval seeds and cross‑encoder attributions to select only truly relevant corpus tokens, avoiding drift and hallucination while preserving BM25’s discriminative power
- **Ground**: CE‑QE pipeline: 1) dense retriever seeds top‑k passages; 2) cross‑encoder computes token‑level relevance attributions; 3) select top content tokens (≤10 per passage, ≤10 passages); 4) append tokens to query and run BM25; 5) optionally fuse with semantic scores (SESF) or re‑rank with cross‑encoder
- **Experiment**: Evaluated on BEIR zero‑shot benchmark using RUMIR pipeline. Metrics: Recall@100 and nDCG@10. CE‑QE increased Recall@100 from 0.32 to 0.47 on vocabularily divergent queries; SESF achieved +5.3% nDCG@10 over SPLADEv2 and +4.6% over ColBERTv2. Latency added ≈557 ms to full SESF pipeline, negligible for production
- **Takeaway**: CE‑QE provides a lightweight, query‑time expansion that lifts recall without index changes or hallucination. SESF fuses lexical and semantic signals to achieve state‑of‑the‑art ranking. The approach is production‑ready, low‑latency, model‑agnostic, and preserves BM25’s IDF weighting.
...
- **Reason**: This paper is highly relevant to your interests in Information Retrieval, particularly in query understanding and ranking models. The proposed SPEAR system addresses a critical issue in e-commerce search, namely the misalignment between query reformulation and retrieval effectiveness, and presents a novel end-to-end adaptive rewriting and retrieval framework. While the focus is on community search, the techniques and concepts discussed are applicable to broader IR and NLP domains.
...
- **Submitted**: 2026-08-02 20:02:44
- **Topic Keywords**: query, queries, ranking, rerank, relevance, rag, retrieval, rank
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of biomedical question answering, with a focus on query expansion, reranking, and relevance scoring. Although it's not directly related to e-commerce, the techniques and concepts presented are applicable to broader IR domains. The use of neural reranking and semantic reranking models also aligns with the user's interest in ranking models.
...
### 4. Requirement--Evidence Alignment for Compositional E-Commerce Queries
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The focus on compositional e-commerce queries and requirement-evidence-aligned reranking framework aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific domain of e-commerce is not a primary focus of your research, which is why the score is not a perfect 10.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The study of long-horizon search agents and their failure modes aligns with your focus on deep semantic understanding and real-time relevance optimization. However, the paper's focus on search behavior and failure modes, rather than user behavior modeling, prevents it from being a perfect match.
...
### 6. Advancing Relevance Measurement with Vision-Language Models for Web-Scale Search
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and relevance measurement. The use of Vision-Language Models for automated relevance evaluation aligns with your focus on deep semantic understanding and real-time relevance optimization. The application of this approach in a web-scale search system like Pinterest Search also resonates with your e-commerce background.
...
- **Reason**: This paper presents a novel multimodal embedding model, Douyin Multimodal Embedding (DME), which combines the strengths of contrastive and CoT-based models for efficient and fine-grained multimodal representation learning. Although the focus is on a specific industrial platform (Douyin), the techniques and challenges addressed are relevant to the broader field of Information Retrieval, particularly in the context of multimodal search and recommendation. The paper's emphasis on real-time relevance optimization and semantic understanding aligns with your research interests in query understanding and ranking models.
...
### 8. RING: Retrieval-Internalized Generation for Continual Large-Scale Knowledge Injection
...
- **Submitted**: 2026-08-03 03:00:43
- **Comment**: 16 pages
- **Topic Keywords**: retriever, rag, retrieval, search
- **Reason**: This paper proposes a novel paradigm for injecting large-scale external knowledge into a model, which aligns with your interests in Information Retrieval and Search technologies. The focus on retrieval-internalized generation and parametric search is relevant to your work on query understanding and ranking models. However, the specific domain of knowledge injection and the use of reinforcement learning may not be a central match to your primary research focus.
...
- **Reason**: This paper introduces a novel multimodal embedding model, UEmbed, which unifies dense and sparse representations in one model. While primarily focused on multimodal settings, it has implications for information retrieval and search technologies, particularly in the area of query understanding and ranking models. The paper's emphasis on sparse retrieval and its extension to multimodal settings aligns with the user's research interests in IR and NLP.
...
### 10. CRISP: Critical Step Perception for Training Efficient Deep Search Agents
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed CRISP framework for training efficient deep search agents aligns with your focus on real-time relevance optimization and deep semantic understanding. While the paper's primary focus is on search agents, the techniques and concepts presented can be applied to broader IR and NLP topics.
...
### 11. Divergent large language model predictions from convergent representations in ambiguous word pairs
...
- **Reason**: This paper explores the internal workings of large language models, specifically how they resolve lexical ambiguity. While primarily focused on NLP, the findings have implications for information retrieval and search technologies, particularly in areas that rely on semantic understanding and embedding-based methods. The paper's focus on deep semantic understanding and real-time relevance optimization aligns with your research interests.
...
### 12. Hierarchical BM25: Lexical Search at Billion-Document Scale

- **LLM Score**: 6
- **Keyword Score**: 13
- **Authors**: Umesh Deshpande, Swaminathan Sundararaman
- **URL**: <http://arxiv.org/abs/2608.00229v1>
- **Submitted**: 2026-07-31 19:18:37
- **Topic Keywords**: query, queries, ranking, retrieval, rank, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the area of search technologies and ranking models. However, it focuses more on scalability and efficiency rather than query understanding or deep semantic understanding, which are your primary areas of interest.
...
### 13. V-Mem: Modality-Routed Retrieval for Long-Term Multimodal Agentic Memory

- **LLM Score**: 6
- **Keyword Score**: 9
- **Authors**: Dingyi Kang, Dongming Jiang, Yi Li, Guanpeng Li, Bingzhe Li
- **URL**: <http://arxiv.org/abs/2608.01543v1>
- **Submitted**: 2026-08-02 23:47:18
...
- **Reason**: The paper presents a multimodal agentic memory system that addresses the modality gap and similarity-relevance gap in multimodal conversations. While it touches on search and retrieval aspects, its primary focus is on memory systems and multimodal interaction, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the paper's emphasis on multimodal agentic memory and LLM-generated anchors is not a central match for your research themes.
...
### 14. GARDRec: Decision-Level Graph Grounding for Large Language Model Recommendation
...
- **Submitted**: 2026-08-01 13:44:04
- **Comment**: 18 pages, 2 figures
- **Topic Keywords**: ranking, retrieval, recommend, rank
- **Reason**: This paper explores a recommendation framework that leverages large language models and graph grounding, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the focus on recommendation systems and graph grounding is not a central match to your primary research themes, which are more focused on query understanding, ranking models, and user behavior modeling.
...
### 15. Disentangled Contrastive Learning for Zero-Shot Multilingual Dense Retrieval
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the area of multilingual dense retrieval. However, it focuses more on the representation learning aspect and does not directly address query understanding, ranking models, or user behavior modeling. The use of contrastive learning and disentangled optimization objectives is an interesting approach, but it is not directly applicable to your core research themes.
...
### 16. Do Static Embeddings Add Value to Hybrid Dutch Retrieval?
...
- **Reason**: This paper explores the value of static embeddings in hybrid retrieval, which is somewhat related to information retrieval and ranking models. However, the focus on Dutch language and specific retrieval tasks makes it less relevant to the user's broader interests in IR, query understanding, and real-time relevance optimization.
...
### 17. Real-Time Hybrid Retrieval in Hyperbolic Space for Retrieval-Augmented Generation on Edge Devices

- **LLM Score**: 4
- **Keyword Score**: 14
- **Authors**: Aradhya Chakrabarti
- **URL**: <http://arxiv.org/abs/2608.01450v1>
- **Submitted**: 2026-08-02 19:14:59
- **Topic Keywords**: retriever, query, rerank, rag, retrieval, rank
- **Reason**: This paper presents a novel approach to document retrieval in hyperbolic space, which is somewhat related to information retrieval and ranking models. However, the focus on retrieval-augmented generation and edge devices is not directly aligned with the user's core research themes. The use of hyperbolic geometry and Lorentz embeddings is an interesting aspect, but it does not strongly connect to the user's interests in query understanding, user behavior modeling, or deep semantic understanding.
...
### 18. ACE-GraphRAG: Agentic Context Engineering for Hierarchical GraphRAG

- **LLM Score**: 4
- **Keyword Score**: 13
- **Authors**: Yongfeng Huang, Yuren Lai, Ruiying Chen, Haoyu Huang, Mingming Zhao, James Cheng
- **URL**: <http://arxiv.org/abs/2608.01269v1>
- **Submitted**: 2026-08-02 14:22:31
- **Topic Keywords**: query, queries, ltr, rag, retrieval
- **Reason**: The paper ACE-GraphRAG explores Hierarchical Graph Retrieval-Augmented Generation, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on context engineering and multi-hop QA is not directly aligned with the user's primary research themes. The paper's relevance is limited to the broader context of NLP and data mining.
...
### 19. Token-Native Storage: Read and Write in your Agent's Language
...
- **Reason**: This paper discusses token-native storage, which is relevant to search technologies and NLP, but it doesn't directly relate to query understanding, ranking models, or user behavior modeling. While it touches on the efficiency of token-based representations, it doesn't explore deep semantic understanding or real-time relevance optimization, which are core aspects of your research interests.
...
### 20. Collaborative Memory Augmentation for Generative Recommendation

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Enze Liu, Zhen Tian, Wayne Xin Zhao
- **URL**: <http://arxiv.org/abs/2608.01315v1>
- **Submitted**: 2026-08-02 15:34:43
- **Comment**: Accepted by KDD 2026 Research Track
- **Topic Keywords**: query, rag, user behavior, retrieval, recommend
- **Reason**: The paper focuses on Generative Recommendation, which is somewhat related to Information Retrieval. However, the emphasis on collaborative memory augmentation and cross-user signals is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. While it touches on user behavior modeling, the context is different and the paper's primary contribution is in the recommender systems domain.
...
### 21. RAGOCR: Optical Compression of Retrieval-Augmented Text via Visual Representation

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Jiayang Yu, Jialun Zhong, Lei Zou
- **URL**: <http://arxiv.org/abs/2608.00765v1>
- **Submitted**: 2026-08-01 16:59:49
- **Comment**: Under reviewing
- **Topic Keywords**: query, relevance, rag, retrieval
- **Reason**: This paper explores a novel approach to compressing retrieved documents for knowledge-intensive question answering, leveraging visual representations conditioned on the input query. While it touches on information retrieval and retrieval-augmented generation, the focus is on compression and visual representation, which is somewhat related to your interests in query understanding and ranking models. However, the paper's emphasis on visual representation and compression does not directly align with your primary focus on deep semantic understanding and real-time relevance optimization.
...
### 22. Select-And-Extract: A Lightweight Plugin for Retrieval-Augmented Generation

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Chenming Tang, Jiawei Han
- **URL**: <http://arxiv.org/abs/2608.00658v1>
- **Submitted**: 2026-08-01 13:21:55
- **Comment**: Pre-print
- **Topic Keywords**: retriever, query, rag, retrieval
- **Reason**: The paper discusses Retrieval-Augmented Generation (RAG), a topic related to Information Retrieval, but its focus on improving the performance of language models through a plugin is not directly aligned with the user's interests in query understanding, ranking models, and user behavior modeling. While it touches on retrieval failure and reading failure, it does not explicitly address these areas in the context of e-commerce or real-time relevance optimization, which are key aspects of the user's research focus.
...
### 23. Verification Without Sufficiency: Per-Chunk Filtering Fails on Multi-Hop RAG, and Decomposition Repairs It

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Randhir Kumar
- **URL**: <http://arxiv.org/abs/2608.00585v1>
- **Submitted**: 2026-08-01 10:52:56
...
- **Topic Keywords**: retriever, query, rag, retrieval
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of retrieval-augmented generation and multi-hop question answering. However, the focus on verification and decomposition for sub-questions is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 24. CTRAG: An In-Context Retrieval-based Framework for Automated Compliance Checking using LLMs
...
- **Reason**: The paper presents a Retrieval-Augmented Generation (RAG) pipeline for automated compliance checking, which is somewhat related to information retrieval and search technologies. However, the focus on regulatory compliance and LLMs is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 25. X-KGRank: A Knowledge Graph RAG Framework for Explainable Recommendations via Pattern Mining and LLM Re-Ranking
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it primarily focuses on recommender systems and knowledge graph-based approaches. While it involves ranking models and user behavior modeling, the context is more aligned with recommender systems than your core research themes.
...
### 26. Floor, Ceiling, and the Fusion Gap: How Much of Crowd Reading Attention Can Machines Predict?

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Kazuki Nakayashiki, Keisuke Watanabe
- **URL**: <http://arxiv.org/abs/2608.01704v1>
- **Submitted**: 2026-08-03 05:09:49
...
- **Reason**: This paper explores a task related to natural language processing, specifically predicting crowd reading attention. While it touches on aspects of ranking models and user behavior modeling, its focus on a specific task and application (crowd reading attention) is somewhat tangential to the user's core research interests in information retrieval and search technologies.
...
### 27. HyperAgent4POI: Dynamic Semantic Message Passing on Multi-Agent Hypergraphs for Missing-Modality Recommendation
...
- **Reason**: The paper explores a specific problem in recommendation systems, using multi-agent hypergraphs and dynamic semantic message passing for modality completion. While it touches on aspects of information retrieval and ranking, its primary focus is on missing-modality recommendation, which is somewhat related to the user's interests in query understanding and ranking models. However, the paper's emphasis on recommender systems and its specific application to LBSN datasets makes it only loosely relevant to the user's core research themes.
...
### 28. Exponential Reward Weighting for Fine-Tuning Generative Recommenders under Sparse and Noisy Feedback

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Keertana Chidambaram, Sanath Kumar Krishnamurthy, Qiuling Xu, Ko-Jen Hsiao, Moumita Bhattacharya
- **URL**: <http://arxiv.org/abs/2608.00816v1>
- **Submitted**: 2026-08-01 18:48:39
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and recommender systems, but it focuses more on generative recommenders and reward optimization. While it touches on ranking performance, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 29. Unleashing the Potential of Large Language Models: A Blueprint for Real-Time, Enterprise-Ready Deployments

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Muhammad Faizan Raza, Shuo, Yang, Satish Mahadevan Srinivasan, Joanna F. DeFranco
- **URL**: <http://arxiv.org/abs/2608.00419v1>
- **Submitted**: 2026-08-01 03:40:22
...
- **Reason**: The paper discusses large language models and their deployment in real-time settings, which is somewhat related to information retrieval and search technologies. However, the focus is more on NLP and model deployment rather than query understanding, ranking models, or user behavior modeling. While it touches on real-time relevance optimization, it's not a central match for the user's core research themes.
...
### 30. Multimodal Embeddings for 3D Similarity Search in Semantic Web-of-Things Digital-Twin Platforms
...
- **Reason**: This paper explores similarity search in the context of Semantic Web of Things platforms, which is somewhat related to information retrieval and search technologies. However, the focus is on 3D similarity search and multimodal embeddings, which is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's use of knowledge graphs and ontology-typed entities is somewhat relevant to the user's background in the e-commerce domain and experience with data mining.
...
### 31. Can You Trust the Confidence? ConfBench for Vision-Language Models on Document Extraction
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, but it focuses on vision-language models for document extraction and calibration, which is not a central match to your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 32. PGMem: Tightly Coupled Persona-Memory Graph for Lifelong Personalized Agents

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Wonjun Choi, Yerim Kim, Yukyung Lee, Susik Yoon
- **URL**: <http://arxiv.org/abs/2608.01708v1>
- **Submitted**: 2026-08-03 05:14:59
- **Topic Keywords**: query, retrieval, rank
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval and Natural Language Processing, as it involves a graph-based approach for personalized dialogue agents. However, the focus on lifelong personalized dialogue agents and persona-memory graphs is not directly related to your core areas of interest in query understanding, ranking models, and user behavior modeling.
...
### 33. Style Wins, Substance Loses: A Diagnosis of LLM-as-Judge in Idea Generation
...
- **Submitted**: 2026-08-03 04:01:02
- **Comment**: First three authors are co-first authors
- **Topic Keywords**: ranking, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. However, the focus on LLM-based idea evaluation and stylistic bias in scientific content is not directly aligned with your primary research themes. The paper's use of a benchmark for diagnosing stylistic bias may be of interest in the context of NLP, but it does not strongly relate to your core areas of expertise.
...
### 34. Deep Agentic Search for Repository-Level Code Question Answering: An Empirical Study
...
- **Submitted**: 2026-08-02 21:36:59
- **Comment**: 41 pages, 21 figures, 6 tables. Under review at a journal
- **Topic Keywords**: semantic search, retrieval, search
- **Reason**: This paper is somewhat related to information retrieval, but its focus on code search and repository-level question answering is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. While it touches on retrieval and indexing, the context is specific to code search and does not explore deep semantic understanding or real-time relevance optimization.
...
### 35. HopRefusalBench: Diagnosing Refusal Failures in Search-Augmented Agents for Multi-Hop Reasoning

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Jianan Xie, Xin Sun, Zhongqi Chen, Xing Zheng, Qiang Liu, Bowen Song
- **URL**: <http://arxiv.org/abs/2608.01358v1>
- **Submitted**: 2026-08-02 16:20:55
- **Comment**: 20 pages
- **Topic Keywords**: queries, retrieval, search
- **Reason**: This paper introduces a benchmark for evaluating refusal failures in search-augmented agents for multi-hop reasoning, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on multi-hop reasoning and refusal failures in search-augmented agents is not directly aligned with the user's core research themes, but it does touch on related topics in NLP and search technologies.
...
### 36. UniHEAR: Unified Heterogeneous-Source Attentive Retrieval for Knowledge-Based Visual Question Answering

- **LLM Score**: 2
- **Keyword Score**: 12
- **Authors**: Ganzhong Luo, Yang Ren, Hanyong Wang, Shuyu Zheng, Menglong Yang
- **URL**: <http://arxiv.org/abs/2608.01147v1>
- **Submitted**: 2026-08-02 10:57:53
- **Comment**: Accepted by ACM MM 2026
- **Topic Keywords**: ranking, rerank, pointwise, retrieval, rank
- **Reason**: This paper focuses on Knowledge-Based Visual Question Answering and proposes a unified framework for heterogeneous-source entity retrieval and reranking. Although it involves retrieval and reranking, the context is visual question answering, which is not directly related to the user's primary research interests in Information Retrieval and Search technologies.
...
### 37. A Triple-Robustness Analysis of Retrieval-Augmented Generation for Multi-Hop Requirements Traceability

- **LLM Score**: 2
- **Keyword Score**: 11
- **Authors**: Meftun Akarsu, Burak Özdemir, Doğancan Büyükçolak, Recep Kaan Karaman
- **URL**: <http://arxiv.org/abs/2608.00705v1>
- **Submitted**: 2026-08-01 15:05:45
- **Comment**: 6 pages, 3 figures, 4 tables
- **Topic Keywords**: queries, ranking, rag, retrieval, rank
- **Reason**: This paper appears to be focused on the evaluation of Retrieval-Augmented Generation (RAG) models for multi-hop requirements traceability, which is a topic related to Information Retrieval. However, the specific context and application (requirements traceability) seem to be quite distant from the user's core research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 38. Practical Online KV Cache Compaction for LLM Agents: An Empirical Study

- **LLM Score**: 2
- **Keyword Score**: 10
- **Authors**: Yujian Liu, Jiabao Ji, Li An, Rohit Jain, Gungor Polatkan, Siyu Zhu, Shiyu Chang
- **URL**: <http://arxiv.org/abs/2608.00902v1>
- **Submitted**: 2026-08-02 00:08:44
- **Topic Keywords**: query, queries, relevance, search
- **Reason**: This paper focuses on optimizing the performance of Large Language Model (LLM) agents by reducing the cost of the Key-Value (KV) cache, which is a bottleneck in inference. While it touches on the topic of optimization, it does not directly relate to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing, and is more focused on the technical optimization of LLM agents.
...
### 39. Join Indices for Search Engines: a Prunable Parallel Semijoin over Lucene Segments

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Mikhail Khludnev
- **URL**: <http://arxiv.org/abs/2608.01173v1>
- **Submitted**: 2026-08-02 11:52:29
- **Topic Keywords**: query, queries, rag, search
- **Reason**: This paper focuses on improving search engine performance through join indices, but it does not directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 40. SmartGR: Hierarchy and Beam-Aware Knowledge Distillation for Generative Recommendation
...
- **Reason**: This paper is primarily focused on recommender systems, specifically generative recommendation, which is somewhat related to the user's interests in information retrieval. However, the paper's emphasis on knowledge distillation and recommendation performance does not align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 41. ET-Prune: Evidence-Aware Dynamic Budgeting for Visual Token Pruning in Text-Rich MLLMs
...
- **Reason**: This paper focuses on visual token pruning in multimodal large language models, which is not directly related to information retrieval, search technologies, or query understanding. While it involves text-rich inputs, the primary goal is to optimize inference cost, not to improve search relevance or ranking models.
...
### 42. Progressive Agent Skill Generation via Reinforcement Learning

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Junhao Shen, Zhanqiu Zhang, Yiwen Guo, Hong Cheng
- **URL**: <http://arxiv.org/abs/2608.01678v1>
- **Submitted**: 2026-08-03 04:14:59
- **Comment**: Code is available at https://github.com/ejhshen/skill-alpha
- **Topic Keywords**: query, relevance, rag
- **Reason**: This paper focuses on skill generation in reinforcement learning, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some form of learning and optimization, the context and application are significantly different from the user's areas of expertise.
...
### 43. Structured Memory for Edge Language Models: Persistent Context and Corpus Retrieval via O(1) SSM State Injection
...
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper focuses on improving the efficiency of language models, specifically by reducing prefill latency through a novel retrieval mechanism. However, it does not directly relate to information retrieval, query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 44. Verifier-Induced Support Reshaping in On-Policy Optimization

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Shaohang Wei, Zikun Su, Feifan Song, Wen Luo, Wei Li, Guangyue Peng, Houfeng Wang
- **URL**: <http://arxiv.org/abs/2608.00220v1>
- **Submitted**: 2026-07-31 19:05:43
- **Comment**: 36 pages, 12 figures, 15 tables
- **Topic Keywords**: rerank, rag, rank, search
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on reinforcement learning, verifier-induced support reshaping, and mathematical reasoning does not align with your core research themes.
...
### 45. GradCuit: Credit-Assigned Gradient Flow Enables Robust and Interpretable Test-Time Latent Reasoning
...
- **Reason**: This paper focuses on optimizing large language model outputs through latent reasoning, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves deep semantic understanding, the context is different from the user's primary research interests.
...
### 46. CompanionBench: A Theory-Anchored, Real-World-Grounded Benchmark for AI Emotional Companionship
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on AI Emotional Companionship, which is outside your primary areas of interest.
...
### 47. RestoreKV: Recovering Full-Cache Behavior Under Aggressive Query-Agnostic KV Cache Eviction

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Changwoo Baek, Seungjun Shin, Kyeongbo Kong
- **URL**: <http://arxiv.org/abs/2608.01247v1>
- **Submitted**: 2026-08-02 13:58:42
- **Comment**: 13 pages, 8 figures
- **Topic Keywords**: query, queries
- **Reason**: This paper focuses on a specific problem in caching and cache eviction, which is not directly related to information retrieval, query understanding, or ranking models. While it involves some form of optimization and compression, the context is more aligned with computer systems and caching techniques rather than the user's core research themes in IR and NLP.
...
### 48. Control Under Compression: Reliability Frontiers for Tool-Using Agents

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Yinghan Hou, Zongyou Yang
- **URL**: <http://arxiv.org/abs/2608.01056v1>
- **Submitted**: 2026-08-02 07:43:44
- **Comment**: 12 pages, 5 figures; includes an appendix
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper appears to be unrelated to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on tool-using language-model agents and control context compression does not align with your areas of expertise.
...
### 49. Mind the Gap: Zero-Query Jailbreaks via Filter-Generator Discrepancy in Text-to-Image Systems

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Wanguang Li, Zhaoxin Wang, Handing Wang
- **URL**: <http://arxiv.org/abs/2608.00973v1>
- **Submitted**: 2026-08-02 03:53:30
- **Topic Keywords**: query, rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The topic of text-to-image systems and zero-query jailbreaks is outside your areas of focus.
...
### 50. Tevatron Meets Megatron: Expert-Parallel LLM Reranker Training on an Academic Budget
...
- **Submitted**: 2026-08-02 00:55:47
- **Topic Keywords**: retriever, ranking, rerank, recommend, rank
- **Reason**: This paper appears to be focused on large-scale deep learning model training and optimization, specifically on the Megatron-Core training backend for reranking recipes. It does not align with the user's primary research interests in Information Retrieval, Search technologies, query understanding, ranking models, and user behavior modeling, nor does it relate to Natural Language Processing, data mining, or recommender systems.
