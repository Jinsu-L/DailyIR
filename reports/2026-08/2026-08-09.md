# Daily Papers Report - 2026-08-09

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. Factorized Hypothesis Search for Evidence-to-Taxonomy Retrieval
...
- **Submitted**: 2026-08-06 21:56:56
- **Comment**: 28 pages, 1 figure, 28 tables
- **Topic Keywords**: query, ranking, retrieval, rank, search, acl
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in query understanding and ranking models, as it proposes a novel approach to structured query rendering and multi-hypothesis retrieval. The focus on real-time relevance optimization and the use of semantic dimensions also aligns with the user's interests. However, the specific domain (taxonomy tagging and clinical coding) is somewhat niche, preventing a perfect match.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Large‑taxonomy retrieval systems face a retrieval readiness gap when queries contain indirect evidence rather than explicit target concepts.
- **Aim**: Introduce Factorized Hypothesis Search (FHS) to bridge the gap by generating partial interpretations over semantic dimensions and enabling structured, multi‑hypothesis retrieval.
- **Rationale**: Partial hypotheses over dimensions (row, column, datatype, context) allow the system to render queries structurally, verify candidates dimension‑wise, and avoid burying the target deep in the ranking.
- **Ground**: Analysis shows that explicit semantics yield reliable target retrieval, whereas raw evidence often places the correct target far down the list.
- **Experiment**: Evaluated FHS on financial taxonomy tagging and the CodiEsp clinical coding benchmark, comparing Recall@1, MRR, and accuracy against all non‑oracle baselines and a free‑text ensemble; also tested a sequential refinement strategy.
- **Takeaway**: FHS achieves the highest Recall@1, MRR, and overall accuracy among non‑oracle methods; the factorized hypothesis path is essential for head‑ranking performance, and parallel first‑round retrieval suffices without further refinement.
...
### 2. DocMemo: Dynamic Evidence Discovery via Probabilistic Memory-Guided Retrieval for Multi-Modal Document Understanding

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Hanshu Yao, Janfeng Zhong, Niu Lian, Jinpeng Wang
- **URL**: <http://arxiv.org/abs/2608.07067v1>
- **Submitted**: 2026-08-07 10:16:56
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed framework, DocMemo, focuses on dynamic evidence discovery and multi-modal document understanding, which aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific application domain (long-document understanding) is somewhat niche, preventing a perfect match.
...
- **Submitted**: 2026-08-07 17:51:49
- **Topic Keywords**: query, rag, retrieval
- **Reason**: The paper CoinRAG is highly relevant to Information Retrieval (IR) and Search technologies, specifically focusing on Retrieval-Augmented Generation (RAG) and optimizing query understanding and ranking models. Although it's not directly related to user behavior modeling or click models, its emphasis on contextualized information nugget reuse and semantic relevance aligns with the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 4. MISO: Model-Internal-State-Guided Optimization for Ranking Models
...
- **URL**: <http://arxiv.org/abs/2608.07035v1>
- **Submitted**: 2026-08-07 09:46:32
- **Comment**: Accepted at the OARS Workshop at ACM RecSys 2026
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically ranking models and optimization techniques. The focus on model internal state optimization and its application to ranking models aligns with your interests in Learning to Rank. However, the paper's scope is more narrow than your broader interests in query understanding and user behavior modeling.
...
### 5. GPTKB 2.0: Browsing, Querying, and Auditing a Disambiguated LLM-Derived Knowledge Base

- **LLM Score**: 7
- **Keyword Score**: 6
- **Authors**: Yujia Hu, Tuan-Phong Nguyen, Simon Razniewski
- **URL**: <http://arxiv.org/abs/2608.06992v1>
- **Submitted**: 2026-08-07 09:10:30
- **Comment**: 7 pages, 11 figures
- **Topic Keywords**: query, queries
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the area of query understanding and deep semantic understanding. The paper presents a disambiguated knowledge base and a web demo for exploring it, which aligns with the user's interest in query understanding and real-time relevance optimization. However, the focus on knowledge base construction and querying is not a central match to the user's primary focus on information retrieval in e-commerce and related domains.
...
### 6. Mind the Gap: A Dual Knowledge Graph Framework for Unified Multi-task User Intent Inference

- **LLM Score**: 6
- **Keyword Score**: 2
- **Authors**: Tzu-Cheng Peng, Chien Chin Chen, Chih-Hao Ku, Yung-Chun Chang
- **URL**: <http://arxiv.org/abs/2608.06752v1>
- **Submitted**: 2026-08-07 03:18:13
...
- **Reason**: This paper explores a novel framework for user intent inference in online travel reviews, leveraging knowledge graphs and large language models. While it touches on aspects of query understanding and ranking models, its primary focus is on intent inference rather than traditional IR tasks. The paper's emphasis on structure-aware knowledge alignment and explainable intent inference is somewhat related to user behavior modeling and click models, but it is not a central match for the user's core research themes.
...
### 7. Rhetorical-Role-Aware Retrieval-Augmented Generation for Legal Question Answering over Indian Supreme Court Judgments

- **LLM Score**: 4
- **Keyword Score**: 20
- **Authors**: Sayed Ayaan Ahmed Sha, Sangeetha Sivanesan, Anand Kumar Madasamy, Navya Binu
- **URL**: <http://arxiv.org/abs/2608.06828v1>
- **Submitted**: 2026-08-07 05:38:02
- **Topic Keywords**: query, queries, ranking, rerank, rag, retrieval augmented generation, retrieval, rank, search
- **Reason**: The paper focuses on Retrieval Augmented Generation for legal question answering, which is somewhat related to information retrieval and search technologies. However, the domain (legal question answering) and specific techniques (rhetorically based chunking, fusion-based retrieval) are not directly aligned with the user's core research themes in IR and NLP. While the paper does involve query understanding and relevance optimization, it is not a central match for the user's interests.
...
### 8. Exact Adaptive Hybrid Retrieval Without Fixed Top-L Cutoffs

- **LLM Score**: 4
- **Keyword Score**: 19
- **Authors**: Chunran Zhang
- **URL**: <http://arxiv.org/abs/2608.07152v1>
- **Submitted**: 2026-08-07 12:14:39
- **Comment**: 10 pages, 4 figures, 1 table
- **Topic Keywords**: retriever, query, queries, ranking, rag, retrieval, rank, trec
- **Reason**: The paper discusses retrieval-augmented generation systems, proposing a new method called Exact Adaptive Hybrid Retrieval (EAHR) to improve ranking and execution efficiency. While it touches on aspects of information retrieval, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on retrieval efficiency and system optimization is somewhat related to IR, but it does not align closely with the user's primary research themes.
...
- **Submitted**: 2026-08-07 06:18:18
- **Topic Keywords**: query, rag, ctr, retrieval, rank
- **Reason**: The paper discusses a novel method for sparse attention in long-context LLM inference, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on LLM inference and attention mechanisms is not directly aligned with the user's primary research themes, and the paper does not explicitly address query understanding, ranking models, or user behavior modeling.
...
### 10. HNR-DAC: Hard-Negative Reranking and Distribution-Aligned Classification for Scientific Claim Verification

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Zhenchao Wang, Xin Chen, Luoxi Zhang, Min Yang, Shiwen Ni
- **URL**: <http://arxiv.org/abs/2608.07204v1>
- **Submitted**: 2026-08-07 13:19:40
- **Comment**: 12 pages, 3 figures
- **Topic Keywords**: ranking, rerank, rag, rank
- **Reason**: The paper focuses on scientific claim verification, which involves a specific application of NLP. While it touches on retrieval and ranking aspects, the primary focus is on classification and evidence verification, which is somewhat related to the user's interests in IR and NLP. However, the domain and specific task are not directly aligned with the user's core research themes.
...
### 11. Progressive Alignment of Recommender Foundation Model through Multi-Phase Post-Training

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Oseong Choi, Hoeinn Kim, Jihoon Lee, Byungsoo Kang, Taeyeong Jang
- **URL**: <http://arxiv.org/abs/2608.06792v1>
- **Submitted**: 2026-08-07 04:30:34
- **Comment**: 9 pages, 3 figures. Accepted to the 20th ACM Conference on Recommender Systems (RecSys '26), Industry Track
- **Topic Keywords**: ranking, user behavior, click, recommend, rank
- **Reason**: The paper focuses on recommender systems and foundation models, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the emphasis on business-metric alignment and reward modeling in the context of recommender systems is not a central match for the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 12. Teacher Retains Full Tokens, Student Merges Efficiently: TM20K for E-Commerce Sequence Modeling in Ad Recommendation
...
- **URL**: <http://arxiv.org/abs/2608.07055v1>
- **Submitted**: 2026-08-07 10:04:44
- **Topic Keywords**: ltr, recommend, commerce, e-commerce, search
- **Reason**: This paper focuses on e-commerce sequence modeling for ad recommendation, using transformer modeling and knowledge distillation. While it touches on sequence modeling, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's emphasis on recommender systems and e-commerce also makes it somewhat tangential to the user's broader interests in information retrieval and natural language processing.
...
### 13. Does More Retrieved Evidence Help Visual Retrieval-Augmented Generation with Diffusion Language Models?

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Jiankun Wang, Yisen Gao, Ziwei Zhang, Xingcheng Fu, Jiaxin Bai, Chen Gao
- **URL**: <http://arxiv.org/abs/2608.07006v1>
- **Submitted**: 2026-08-07 09:20:40
- **Topic Keywords**: rag, retrieval, rank
- **Reason**: This paper explores the application of visual retrieval-augmented generation with diffusion language models, which is somewhat related to information retrieval and search technologies. However, the focus on multimodal DLMs and visual QA benchmarks is not directly aligned with the user's core research themes, particularly query understanding, ranking models, and user behavior modeling.
...
### 14. TA-RAG: Tone Awareness as a Design Imperative for Retrieval-Augmented Generation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Yong-Bin Kang, Anthony McCosker
- **URL**: <http://arxiv.org/abs/2608.06672v1>
- **Submitted**: 2026-08-07 00:37:16
- **Topic Keywords**: rag, retrieval, search
- **Reason**: The paper explores Retrieval-Augmented Generation (RAG) systems, which is related to your interests in Information Retrieval and Search technologies. However, the focus on tone awareness and communicative alignment is more aligned with NLP and user behavior modeling, but not directly related to your core research themes of query understanding, ranking models, or real-time relevance optimization.
...
### 15. LLMRouter: Unified Infrastructure for Developing, Evaluating, and Deploying LLM Routers
...
- **Submitted**: 2026-08-07 06:46:58
- **Topic Keywords**: queries, personalization
- **Reason**: The paper discusses LLM routing, which is related to query understanding and ranking models in Information Retrieval. However, the focus is on large language models and routing, which is not a central match to the user's core research themes. The paper's relevance is somewhat tangential to the user's interests in IR and NLP.
...
### 16. Confidence Estimation for Financial Vision-Language Models in Chart and Document Understanding
...
- **Submitted**: 2026-08-06 19:33:11
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves understanding and interpreting visual data (charts and documents). However, the focus on financial vision-language models and confidence estimation in a specific domain (finance) is not a central match to your interests in general IR and search technologies, query understanding, and ranking models.
...
### 17. LitTraceQA: A Benchmark for Multi-Stage Grounding and Verification in Scientific Question Answering
...
- **Submitted**: 2026-08-07 16:11:52
- **Comment**: Work in Progress
- **Topic Keywords**: retrieval, search
- **Reason**: This paper presents a benchmark for scientific question answering, focusing on literature-grounded question answering over scientific papers. While it touches on information retrieval and retrieval-augmented generation systems, its primary focus is on question answering and evidence grounding, which is somewhat related to your interests in query understanding and ranking models, but not a central match.
...
### 18. Why Knowing Both Hops Is Not Enough: Understanding Two-Hop Generalization in Language Models

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Zili Zhang, Yilin Wang, Heng Wang, Herun Wan, Minnan Luo
- **URL**: <http://arxiv.org/abs/2608.07261v1>
- **Submitted**: 2026-08-07 14:17:34
- **Comment**: 24 pages, 20 figures
- **Topic Keywords**: queries
- **Reason**: This paper explores the generalization behavior of large language models on two-hop queries, which is somewhat related to query understanding in Information Retrieval. However, the focus on language models and their internal mechanisms is not directly aligned with the user's primary research interests in IR and Search technologies. The paper's findings on generalization and the proposed training strategy may still be of interest, but it does not strongly connect to the user's core research themes.
...
### 19. Ask-E: An Environment for Calibrated Question Generation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Sarah Pratt, Jae Sung Park, Scott Geng, Ali Farhadi
- **URL**: <http://arxiv.org/abs/2608.06933v1>
- **Submitted**: 2026-08-07 08:06:38
- **Topic Keywords**: rag
- **Reason**: The paper, Ask-E, focuses on question generation and benchmarking, which is somewhat related to query understanding in Information Retrieval. However, the primary focus on language models and their capabilities, rather than user behavior or ranking models, limits its relevance to your core research themes.
...
### 20. Artificial Intelligence Can Match Domain Experts in Evidence Extraction and Critical Appraisal of Microbial Oncogenesis Research Publications
...
- **URL**: <http://arxiv.org/abs/2608.07250v1>
- **Submitted**: 2026-08-07 14:07:57
- **Comment**: Published in Frontiers in Cellular and Infection Microbiology, 45 pages, 14 figures
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves the evaluation of Large Language Models (LLMs) for evidence extraction and critical appraisal of research publications. However, the focus on biomedical research and evidence synthesis is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 21. From Classification to Recommendation: Empirical Analysis of Audio Embedding Models Application for Content-Based Music Recommendation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Qingrui Li, Haowei Lou, Chengkai Huang, Quan Z. Sheng, Lina Yao
- **URL**: <http://arxiv.org/abs/2608.06928v1>
- **Submitted**: 2026-08-07 08:03:29
- **Comment**: 9 pages, 4 tables, 2 figures
- **Topic Keywords**: recommend
- **Reason**: The paper explores the application of audio embedding models in music recommendation systems, which is somewhat related to information retrieval and search technologies. However, the focus on recommender systems and audio embeddings is not a central match to the user's core research themes, which are primarily on query understanding, ranking models, and user behavior modeling in the context of search technologies.
...
### 22. IB-RL: Isolated Bilateral Reinforcement Learning for Strategic Dialogue Agents
...
- **Submitted**: 2026-08-07 02:59:53
- **Topic Keywords**: rag
- **Reason**: The paper discusses a reinforcement learning approach for strategic dialogue agents, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on dialogue agents and strategic interactions is not a central match for the user's research interests in IR and Search technologies.
...
### 23. PsychoAgent: An Affect-Sensitive Cognitive Architecture for Conflict-Aware Memory in LLM Agents
...
- **Submitted**: 2026-08-07 17:22:29
- **Comment**: 12 pages main paper + 10 pages supplementary material; supplementary material included
- **Topic Keywords**: pairwise, relevance, rag, retrieval, rank
- **Reason**: This paper appears to be more relevant to the field of Artificial Intelligence and Cognitive Architectures than Information Retrieval or Search technologies. While it touches on the concept of memory retrieval, the focus is on affect-sensitive cognitive architectures for LLM agents, which is not directly related to the user's core research themes.
...
### 24. From Test-Time Scaling to Reusable Memory: Measuring Crystallization in Text-to-SQL

- **LLM Score**: 2
- **Keyword Score**: 10
- **Authors**: Jiaqian Wang, Yutao Qi, Wenjin Hou, Yuanxi Che, Muning Wen
- **URL**: <http://arxiv.org/abs/2608.07213v1>
- **Submitted**: 2026-08-07 13:28:27
...
- **Reason**: This paper focuses on text-to-SQL query systems, specifically measuring the value of retained memory in improving query accuracy. While it touches on retrieval and ranking, the context is narrow and doesn't align with the user's broader interests in information retrieval, search technologies, and natural language processing.
...
### 25. DAEP: Difficulty-Aware Evidence Planning for Medical Video Corpus Temporal Answer Grounding

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Tianjian He, Yujie Liu, Zhiping Huang, Changbo Xu
- **URL**: <http://arxiv.org/abs/2608.06869v1>
- **Submitted**: 2026-08-07 06:49:55
- **Comment**: 12 pages, 2 figures, 5 tables, accepted by NLPCC 2026 Shared Task Track 3
- **Topic Keywords**: ranking, rerank, rag, rank
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves ranking and evidence planning, the context is specific to medical video corpus temporal answer grounding, which is not a central match to the user's interests.
...
### 26. Conformal Coverage Guarantees for Any Video Temporal Grounder

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Aseel Mohamed, Rasul Khanbayov, Erchin Serpedin, Hasan Kurban
- **URL**: <http://arxiv.org/abs/2608.07434v1>
- **Submitted**: 2026-08-07 17:19:27
- **Comment**: Submitted to AAAI 2027
- **Topic Keywords**: query, relevance, rag
- **Reason**: This paper appears to be focused on video temporal grounding, which is a specific application of computer vision. While it involves some form of query understanding and ranking, it is not directly related to the user's core research themes in Information Retrieval and Search technologies. The paper's focus on conformal coverage guarantees and model-agnostic wrappers also seems to be more aligned with the NLP and data mining aspects, but it does not seem to be a central match for the user's interests.
...
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval and Search technologies. While it involves retrieval-augmented supervised fine-tuning and reinforcement learning, the context is focused on cyber threat intelligence and attack technique extraction, which is not a primary area of interest for you.
...
### 28. Invisible to the Machine: Auditing AI Restaurant, Cafe, and Bar Recommendation Against a Complete Market Census

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Vladimir Pitenin
- **URL**: <http://arxiv.org/abs/2608.07069v1>
- **Submitted**: 2026-08-07 10:23:45
- **Comment**: 31 pages, 10 figures
- **Topic Keywords**: queries, recommend, rank, search
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on AI systems and recommendation, the focus is on auditing AI venue recommendation in the food and drink domain, which is not a primary area of interest for you.
...
### 29. FutureBridge: Token Selection Beyond Local Preference in Collaborative Decoding
...
- **Submitted**: 2026-08-07 05:19:14
- **Topic Keywords**: rerank, rank
- **Reason**: This paper focuses on collaborative decoding in large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves token-level collaboration and ranking, the context is specific to language model decoding and does not align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 30. Modular TTT: Rethinking Test-Time Training as Composable Modules

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Bohao Tang, Zhen Qin, Yuqi Pan, Zheng Li, Pengfei Liu, Ya Zhang
- **URL**: <http://arxiv.org/abs/2608.07110v1>
- **Submitted**: 2026-08-07 11:11:43
- **Comment**: Code: https://github.com/ByteDance-Seed/Modular-TTT
- **Topic Keywords**: query
- **Reason**: This paper focuses on test-time training and sequence modeling, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some machine learning concepts, the topic is more aligned with deep learning and sequence modeling, and does not address query understanding, ranking models, or user behavior modeling.
...
### 31. Hierarchical Quantization with Domain-Adaptive Sparse Routing for Generative Cross-Domain Recommendation
...
- **URL**: <http://arxiv.org/abs/2608.06997v1>
- **Submitted**: 2026-08-07 09:15:19
- **Topic Keywords**: user behavior, recommend
- **Reason**: This paper focuses on Generative Cross-Domain Recommendation, which is not a core area of interest. While it involves some aspects of modeling user behavior, the primary focus is on recommendation systems rather than information retrieval. The paper's emphasis on deep semantic understanding and real-time relevance optimization is not directly relevant to the proposed method.
...
### 32. Can Language Models Imagine Without Seeing? Ekphrasis: Measuring Visual Creative Ideation in Text-Only LLMs
...
- **Submitted**: 2026-08-07 08:44:00
- **Comment**: 25 pages, 4 main figures, with appendices. Code and data: https://github.com/Imhongyu/Ekphrasis
- **Topic Keywords**: pairwise
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval and Search technologies. While it involves Natural Language Processing (NLP) and language models, its focus on visual creative ideation and text-only language models is not a central match to your interests in query understanding, ranking models, and user behavior modeling.
...
### 33. SkillProx: Self-Evolving Agent Skills via Proximal Textual Gradient Descent
...
- **Submitted**: 2026-08-07 17:40:33
- **Comment**: 23 pages, 4 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on skill learning and refinement for Large Language Model (LLM) agents, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves text processing, the context is more aligned with machine learning and agent systems, making it somewhat tangential to your research areas.
...
### 34. An Exploratory Evaluation of LLM-Assisted Rewriting of Moderate-Complexity Financial Sentences for DisCoCat-Based Sentiment Analysis

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Brian Llinas, Nikos Chrisochoides
- **URL**: <http://arxiv.org/abs/2608.07439v1>
- **Submitted**: 2026-08-07 17:23:01
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves NLP, its focus on Quantum NLP and DisCoCat-based Sentiment Analysis is quite specific and does not align with your core research themes.
...
### 35. SABRE: Scalable and Automated Benchmarking of VLMs under Stress

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zixuan Lan, Luzhe Sun, Matthew R. Walter, Jiawei Zhou
- **URL**: <http://arxiv.org/abs/2608.07435v1>
- **Submitted**: 2026-08-07 17:21:04
- **Comment**: 22 pages, 10 figures. Code and resources will be available at https://zesearch.github.io/vlm-SABRE/
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Vision-Language Models (VLMs) and their benchmarking, which is outside your primary research interests in Information Retrieval and Search technologies. While it touches on aspects of model evaluation, it does not directly relate to your areas of expertise in query understanding, ranking models, or user behavior modeling.
...
- **Submitted**: 2026-08-07 16:58:04
- **Comment**: Accepted at CIKM2026
- **Topic Keywords**: rag
- **Reason**: This paper focuses on evaluating Large Language Models (LLMs) on geo-related tasks, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is specific to geospatial and temporal understanding, and does not align with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 37. Trajectory-Relative Hindsight Distillation for Agentic Reinforcement Learning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Haoyu Zheng, Yun Zhu, Qing Wang, Wenqiao Zhang
- **URL**: <http://arxiv.org/abs/2608.07371v1>
- **Submitted**: 2026-08-07 16:12:58
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to the user's research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on agentic reinforcement learning and hindsight distillation in the context of reinforcement learning does not align with the user's primary focus on query understanding, ranking models, and user behavior modeling.
...
### 38. Zero Gap Is Not Restoration: Stratified Per-Question Probability Evaluation and Step-wise Mitigation of Benchmark Contamination

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Ruijie Hou, Yueyang Jiao, Zhao Wang, Yingming Li
- **URL**: <http://arxiv.org/abs/2608.07341v1>
- **Submitted**: 2026-08-07 15:37:03
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on evaluating and mitigating contamination in pretraining corpora for natural language processing models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and query understanding.
...
### 39. An Agentic Hybrid Top-Down and Bottom-Up Approach to Knowledge Graph Generation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Emma Jouffroy, Warren Jouanneau, Marc Palyart
- **URL**: <http://arxiv.org/abs/2608.07023v1>
- **Submitted**: 2026-08-07 09:32:25
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on knowledge graph generation for Human Resources platforms, which is not directly related to the user's core research interests in Information Retrieval and Search technologies. While it involves some NLP aspects, the context and application are quite different from the user's areas of focus.
...
### 40. Confirming Our Biases? Evaluating the Capabilities, Risks, and Societal Impact of Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mudar Adas, Polina Tsvilodub, Michael Franke, Martin V. Butz
- **URL**: <http://arxiv.org/abs/2608.06977v1>
- **Submitted**: 2026-08-07 08:54:27
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the evaluation of large language models, specifically their susceptibility to prompt manipulation and reinforcement of user biases. While it touches on the topic of model responses, it does not directly relate to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 41. Georeferencing Non-Gazetteered Place Names using Biological Specimen Records
...
- **Submitted**: 2026-08-07 07:15:38
- **Comment**: Accepted for publication in the proceedings of the Conference on Spatial Information Theory (COSIT) 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The paper focuses on georeferencing non-gazetteered place names using biological specimen records, which is a topic outside of your core research themes.
...
### 42. Online Monitoring and Corrective Steering of Programming Agents
...
- **Submitted**: 2026-08-07 01:54:52
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The paper focuses on programming agents and issue resolution in large-scale projects, which is outside your primary areas of interest.
...
### 43. StepJack: Benchmarking Computer-Use Agent Safety Against Multi-Step Indirect Prompt Injection

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhuoxin Zhan, Akbar Rafiey, Avery Ma, Leila Pishdad, Layla El Asri
- **URL**: <http://arxiv.org/abs/2608.06477v1>
- **Submitted**: 2026-08-06 18:14:30
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The topic of computer-use agent safety and indirect prompt injection is unrelated to your areas of focus.
...
### 44. Recipes for Creativity: Iterative Generation and Evaluation in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Rens Anderson, Tessa Verhoef, Amirhossein Zohrehvand
- **URL**: <http://arxiv.org/abs/2608.07243v1>
- **Submitted**: 2026-08-07 14:02:36
- **Comment**: 7 pages, 3 figures, 1 table. Short paper accepted at ICCC'26
- **Topic Keywords**: search
- **Reason**: This paper focuses on large language models and generative creativity, which is somewhat related to your interests in Natural Language Processing (NLP) and deep semantic understanding. However, the specific context of iterative generation and evaluation in large language models is not directly aligned with your core research themes in Information Retrieval and Search technologies.
...
### 45. PHASE-Tree: Modeling Character-State Evolution in Long-Horizon Role-Playing Dialogue
...
- **Submitted**: 2026-08-07 08:50:14
- **Topic Keywords**: rank
- **Reason**: This paper appears to be primarily focused on Natural Language Processing (NLP) and dialogue systems, with a specific emphasis on character-state evolution in role-playing dialogue. While it involves modeling and generation tasks, which are related to query understanding and ranking models in Information Retrieval, the paper's core themes and applications do not align closely with the user's research interests in IR and search technologies.
...
### 46. Calibrating WEAT Against Anisotropy: ZCA Whitening as a Geometric Pre-Processing Step for Embedding Association Tests

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Seitaro Ono, Senna Ross, Jun Saiki
- **URL**: <http://arxiv.org/abs/2608.06908v1>
- **Submitted**: 2026-08-07 07:42:26
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on improving the Word Embedding Association Test (WEAT) by applying ZCA whitening to address anisotropy in embedding spaces. While it touches on semantic understanding, its primary contribution is to AI fairness research and computational social science, which is somewhat related to information retrieval but not a central match to your research interests.
...
### 47. How Should I Pick a Foundation Model for My Robot? In Favor of a Community Evaluation Framework for Social Robots

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Eric Nichols, Alva Markelius, Hatice Gunes
- **URL**: <http://arxiv.org/abs/2608.06898v1>
- **Submitted**: 2026-08-07 07:33:25
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on foundation models for social robots, which does not align with your areas of expertise.
...
### 48. Simple-OPD: Demystifying Warm-up for On-policy Distillation
...
- **Submitted**: 2026-08-07 04:47:38
- **Topic Keywords**: rank
- **Reason**: This paper appears to be focused on on-policy distillation and its warm-up stage, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves some form of learning and adaptation, the context and methodology seem to be more aligned with deep learning and NLP, rather than the user's specific interests in query understanding, ranking models, and user behavior modeling.
...
### 49. LoRAScan: Detecting Backdoor Prompts in Low-Rank Adapters for Large Language Models via Down-Projection Activation Spikes

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Doniyorkhon Obidov, Honggang Yu, Xiaolong Guo, Kaichen Yang
- **URL**: <http://arxiv.org/abs/2608.06795v1>
- **Submitted**: 2026-08-07 04:36:24
- **Topic Keywords**: rank
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on detecting backdoor prompts in large language models, which is a topic more aligned with security and trustworthiness in AI systems.
...
### 50. Genotypic Triggers: Exposing Pharmacogenomic Blind Spots via Host-Specific Backdoors in Generative Antimicrobial Peptide Models

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Doniyorkhon Obidov, Xiaolong Guo, Yonghui Li, Kaichen Yang
- **URL**: <http://arxiv.org/abs/2608.06779v1>
- **Submitted**: 2026-08-07 03:54:54
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It appears to be focused on pharmacogenomics and the security of generative models in drug discovery, which is outside your areas of expertise.
