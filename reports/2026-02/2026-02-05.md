# Daily Papers Report - 2026-02-05

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. RexBERT: Context Specialized Bidirectional Encoders for E-commerce

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Rahul Bajaj, Anuj Garg
- **URL**: <http://arxiv.org/abs/2602.04605v1>
- **Submitted**: 2026-02-04 14:32:37
...
- **Topic Keywords**: ranking, rag, retrieval, shopping, commerce, e-commerce, rank
- **Reason**: This paper introduces RexBERT, a family of BERT-style encoders designed specifically for e-commerce semantics, which aligns with your interest in Information Retrieval and Search technologies, particularly in the e-commerce domain. The paper's focus on encoder-only transformers, pretraining recipes, and domain specialization also resonates with your background in e-commerce and interests in query understanding and ranking models.
...
### 2. AIANO: Enhancing Information Retrieval with AI-Augmented Annotation

- **LLM Score**: 8
- **Keyword Score**: 7
- **Authors**: Sameh Khattab, Marie Bauer, Lukas Heine, Till Rostalski, Jens Kleesiek, Julian Friedrich
- **URL**: <http://arxiv.org/abs/2602.04579v1>
- **Submitted**: 2026-02-04 14:05:12
- **Topic Keywords**: information retrieval, rag, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of dataset creation and annotation. The AI-augmented approach described in AIANO aligns with your interests in query understanding and ranking models, and the results demonstrate improved retrieval accuracy. While the focus is on dataset creation rather than user behavior modeling, the paper's emphasis on efficiency and accuracy makes it a useful contribution to the IR field.
...
- **Submitted**: 2026-02-04 16:36:00
- **Comment**: Preprint
- **Topic Keywords**: retriever, rag, retrieval
- **Reason**: The paper explores adapting general-purpose Large Language Models (LLMs) for biomedical retrieval, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLM adaptation and biomedical domain is not a central match to the user's primary research interests in IR, search technologies, and NLP.
...
### 4. Following the TRAIL: Predicting and Explaining Tomorrow's Hits with a Fine-Tuned LLM

- **LLM Score**: 6
- **Keyword Score**: 5
- **Authors**: Yinan Zhang, Zhixi Chen, Jiazheng Jing, Zhiqi Shen
- **URL**: <http://arxiv.org/abs/2602.04225v1>
- **Submitted**: 2026-02-04 05:22:52
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: The paper explores the application of Large Language Models (LLMs) in recommendation systems, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on recommender systems and the use of LLMs for predicting item popularity and generating explanations is not a central match for the user's primary research themes. The paper's emphasis on real-time relevance optimization and deep semantic understanding is somewhat aligned with the user's interests, but it is not a primary focus of the paper.
...
### 5. Pruning Minimal Reasoning Graphs for Efficient Retrieval-Augmented Generation
...
- **Submitted**: 2026-02-04 08:48:11
- **Topic Keywords**: retriever, query, rag, retrieval, rank
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of retrieval-augmented generation and knowledge-intensive tasks. However, it focuses more on the efficiency and scalability of retrieval systems, rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 6. SDR-CIR: Semantic Debias Retrieval Framework for Training-Free Zero-Shot Composed Image Retrieval

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Yi Sun, Jinyu Xu, Qing Xie, Jiachen Li, Yanchun Ma, Yongjian Liu
- **URL**: <http://arxiv.org/abs/2602.04451v2>
- **Submitted**: 2026-02-04 11:24:35
- **Comment**: Accepted by WWW 2026
- **Topic Keywords**: query, ranking, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. However, the focus on Composed Image Retrieval and Multimodal Large Language Models is not a central match to your primary research themes. The paper's emphasis on semantic debiasing and visual semantic contribution is an interesting aspect, but it does not directly align with your expertise in e-commerce or real-time relevance optimization.
...
### 7. LILaC: Late Interacting in Layered Component Graph for Open-domain Multimodal Multihop Retrieval

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Joohyung Yun, Doyup Lee, Wook-Shin Han
- **URL**: <http://arxiv.org/abs/2602.04263v1>
- **Submitted**: 2026-02-04 06:55:48
- **Comment**: Project page: https://lilac-emnlp2025.github.io/
- **Topic Keywords**: retriever, query, retrieval
- **Reason**: The paper focuses on multimodal multihop retrieval, which is somewhat related to information retrieval and search technologies. However, it does not explicitly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on multimodal retrieval and graph-based reasoning is an interesting application, but it does not directly align with the user's primary research themes.
...
### 8. Scaling Agentic Verifier for Competitive Coding
...
- **Submitted**: 2026-02-04 06:30:40
- **Topic Keywords**: ranking, rerank, rank, search
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval and Search technologies, as it involves a test-time scaling strategy for competitive coding problems. However, the focus on large language models and competitive programming is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. The paper's use of reinforcement learning and data synthesis is somewhat related to your background in data mining, but the connection is not strong enough to warrant a higher score.
...
### 9. Addressing Corpus Knowledge Poisoning Attacks on RAG Using Sparse Attention

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Sagie Dekel, Moshe Tennenholtz, Oren Kurland
- **URL**: <http://arxiv.org/abs/2602.04711v2>
- **Submitted**: 2026-02-04 16:22:20
- **Topic Keywords**: rag, retrieval augmented generation, retrieval
- **Reason**: The paper is somewhat related to Information Retrieval, specifically addressing a vulnerability in Retrieval Augmented Generation (RAG), but it does not directly focus on query understanding, ranking models, or user behavior modeling. The topic is more aligned with NLP and security, which are adjacent to the user's primary research interests.
...
### 10. Decomposed Prompting Does Not Fix Knowledge Gaps, But Helps Models Say "I Don't Know"

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Dhruv Madhwal, Lyuxin David Zhang, Dan Roth, Tomer Wolfson, Vivek Gupta
- **URL**: <http://arxiv.org/abs/2602.04853v1>
- **Submitted**: 2026-02-04 18:39:58
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores the reliability of large language models in closed-book question answering, using decomposed prompting to identify potential errors. While it touches on aspects of model behavior, it does not directly relate to query understanding, ranking models, or user behavior modeling in information retrieval. The focus on NLP and model reliability makes it somewhat relevant to your broader interests in NLP and data mining.
...
### 11. LinGO: A Linguistic Graph Optimization Framework with LLMs for Interpreting Intents of Online Uncivil Discourse

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Yuan Zhang, Thales Bertaglia
- **URL**: <http://arxiv.org/abs/2602.04693v1>
- **Submitted**: 2026-02-04 15:56:35
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores a linguistic graph optimization framework for large language models, which is somewhat related to the user's interests in Natural Language Processing (NLP) and query understanding. However, the focus on detecting uncivil language and optimizing LLMs for intent classification is not directly aligned with the user's primary focus on information retrieval and search technologies.
...
### 12. Tokenization and Morphological Fidelity in Uralic NLP: A Cross-Lingual Evaluation

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Nuo Xu, Ahrii Kim
- **URL**: <http://arxiv.org/abs/2602.04241v1>
- **Submitted**: 2026-02-04 05:59:25
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on subword tokenization in NLP, which is related to my interests in NLP and IR. However, the specific context of Uralic languages and the emphasis on morphological fidelity and cross-lingual transfer are somewhat narrow and not directly aligned with my core research themes.
...
### 13. MiniRec: Data-Efficient Reinforcement Learning for LLM-based Recommendation
...
- **Submitted**: 2026-02-04 07:15:49
- **Topic Keywords**: rag, recommend
- **Reason**: The paper focuses on recommender systems, specifically using reinforcement learning with large language models. While it touches on data efficiency and selection, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of interest. The connection to NLP is relevant, but not a primary focus of the paper.
...
### 14. Simulated Adoption: Decoupling Magnitude and Direction in LLM In-Context Conflict Resolution

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Long Zhang, Fangwei Lin
- **URL**: <http://arxiv.org/abs/2602.04918v1>
- **Submitted**: 2026-02-04 06:13:11
- **Topic Keywords**: queries
- **Reason**: This paper explores the behavior of Large Language Models (LLMs) in resolving knowledge conflicts, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and their internal mechanisms is not directly aligned with the user's primary research interests in IR and Search technologies. The paper's findings on geometric displacement and vectorial monitoring are interesting but not directly applicable to the user's core research themes.
...
### 15. Linear Model Merging Unlocks Simple and Scalable Multimodal Data Mixture Optimization

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Davide Berasi, Matteo Farina, Massimiliano Mancini, Elisa Ricci
- **URL**: <http://arxiv.org/abs/2602.04937v1>
- **Submitted**: 2026-02-04 16:06:39
- **Comment**: Preprint
- **Topic Keywords**: rank, search
- **Reason**: This paper explores a novel approach to data mixture optimization for multimodal large language models, which is somewhat related to information retrieval and search technologies. However, the focus on model merging and multimodal data mixture optimization does not directly align with the user's core research themes of query understanding, ranking models, and user behavior modeling. While it touches on related topics, the connection is not strong enough to warrant a higher score.
...
### 16. Outcome Accuracy is Not Enough: Aligning the Reasoning Process of Reward Models
...
- **Submitted**: 2026-02-04 15:24:52
- **Topic Keywords**: rag
- **Reason**: This paper explores the concept of 'deceptive alignment' in reward models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on reward models and their alignment with human judgment is not directly aligned with the user's core research themes. The paper's emphasis on natural language processing and reasoning processes is somewhat relevant, but the connection to the user's interests in search technologies and user behavior modeling is not strong.
...
### 17. PersoPilot: An Adaptive AI-Copilot for Transparent Contextualized Persona Classification and Personalized Response Generation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Saleh Afzoon, Amin Beheshti, Usman Naseem
- **URL**: <http://arxiv.org/abs/2602.04540v1>
- **Submitted**: 2026-02-04 13:31:24
...
- **Reason**: The paper explores persona classification and personalized response generation, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on persona classification and contextual analysis is not a central match to the user's primary research interests in IR and NLP. The paper's emphasis on natural language interaction and explainable AI is somewhat relevant to the user's background in e-commerce and NLP.
...
### 18. DeFrame: Debiasing Large Language Models Against Framing Effects

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Kahee Lim, Soyeon Kim, Steven Euijong Whang
- **URL**: <http://arxiv.org/abs/2602.04306v1>
- **Submitted**: 2026-02-04 08:15:51
- **Comment**: 40 pages, 12 figures
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and debiasing methods, but it does not directly address information retrieval, query understanding, or ranking models. The focus on large language models and framing effects is relevant to the user's broader interests, but not central to their core research themes.
...
### 19. Textual Planning with Explicit Latent Transitions

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Eliezer Shlomi, Ido Levy, Eilam Shapira, Michael Katz, Guy Uziel, Segev Shlomov, Nir Mashkif, Roi Reichart, Sarah Keren
- **URL**: <http://arxiv.org/abs/2602.04557v1>
- **Submitted**: 2026-02-04 13:46:15
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to Information Retrieval, but its focus on planning with LLMs and transition models is more aligned with NLP and AI planning. While it involves vector representations and retrieval, which are relevant to IR, the context is different and the paper's primary contributions are in the planning domain.
...
### 20. A Domain-Specific Curated Benchmark for Entity and Document-Level Relation Extraction
...
- **Submitted**: 2026-02-04 08:38:55
- **Comment**: Accepted to EACL 2026
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, particularly in the context of Information Extraction and Relation Extraction. However, it is more focused on the biomedical domain and benchmark development, which is not a central match to your primary research themes. The paper's emphasis on entity and document-level relation extraction may be of some interest, but it does not directly address your core areas of query understanding, ranking models, or user behavior modeling.
...
### 21. Deterministic Retrieval at Scale: Optimal-Space LCP Indexing and 308x Energy Reduction on Modern GPUs

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Stanislav Byriukov
- **URL**: <http://arxiv.org/abs/2602.04936v1>
- **Submitted**: 2026-02-04 15:40:42
- **Topic Keywords**: query, pairwise, retrieval
- **Reason**: This paper focuses on deterministic retrieval and indexing techniques, which, while related to information retrieval, does not directly address query understanding, ranking models, or user behavior modeling. Although it involves NLP in the context of LCP similarity, the paper's primary contribution is in optimizing energy efficiency and latency, which is not a central aspect of your research interests.
...
### 22. Unmasking Superspreaders: Data-Driven Approaches for Identifying and Comparing Key Influencers of Conspiracy Theories on X.com

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Florian Kramer, Henrich R. Greve, Moritz von Zahn, Hayagreeva Rao
- **URL**: <http://arxiv.org/abs/2602.04546v1>
- **Submitted**: 2026-02-04 13:36:18
- **Topic Keywords**: ltr, rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The study focuses on identifying key influencers of conspiracy theories on social media, which is outside your primary areas of interest.
...
- **URL**: <http://arxiv.org/abs/2602.04705v1>
- **Submitted**: 2026-02-04 16:18:15
- **Topic Keywords**: ltr, search
- **Reason**: This paper focuses on multimodal understanding and generation using a unified foundation model, ERNIE 5.0. While it involves natural language processing and deep semantic understanding, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 24. Beyond Static Cropping: Layer-Adaptive Visual Localization and Decoding Enhancement
...
- **Submitted**: 2026-02-04 08:13:01
- **Comment**: 9 pages, 5 figures
- **Topic Keywords**: query, search
- **Reason**: This paper focuses on visual grounding and attention mechanisms in Vision-Language Models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on visual localization and question answering in the context of VQA benchmarks does not align closely with the user's core research themes in IR and NLP.
...
### 25. Empirical-MCTS: Continuous Agent Evolution via Dual-Experience Monte Carlo Tree Search

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Hao Lu, Haoyuan Huang, Yulin Zhou, Chen Li, Ningxin Zhu
- **URL**: <http://arxiv.org/abs/2602.04248v1>
- **Submitted**: 2026-02-04 06:14:55
- **Comment**: 9 pages, 5 figures
- **Topic Keywords**: pairwise, search
- **Reason**: This paper focuses on improving Large Language Models (LLMs) through a novel framework called Empirical-MCTS, which is primarily concerned with continuous agent evolution and memory optimization. While it involves search and optimization, the context is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 26. Beyond Holistic Scores: Automatic Trait-Based Quality Scoring of Argumentative Essays

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Lucile Favero, Juan Antonio Pérez-Ortiz, Tanja Käser, Nuria Oliver
- **URL**: <http://arxiv.org/abs/2602.04604v1>
- **Submitted**: 2026-02-04 14:30:52
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on Automated Essay Scoring systems, which is outside the user's primary research interests in Information Retrieval and Search technologies. While it involves Natural Language Processing (NLP), the context is educational assessment, which is not directly related to the user's background in e-commerce or their focus on deep semantic understanding and real-time relevance optimization.
...
### 27. VK-LSVD: A Large-Scale Industrial Dataset for Short-Video Recommendation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Aleksandr Poslavsky, Alexander D'yakonov, Yuriy Dorn, Andrey Zimovnov
- **URL**: <http://arxiv.org/abs/2602.04567v1>
- **Submitted**: 2026-02-04 13:54:52
...
- **Reason**: This paper focuses on short-video recommendation, which is related to recommender systems, but it does not align with the user's primary interest in information retrieval, especially in areas requiring deep semantic understanding and real-time relevance optimization.
...
### 28. DOS: Dual-Flow Orthogonal Semantic IDs for Recommendation in Meituan
...
- **Submitted**: 2026-02-04 11:43:42
- **Comment**: Accepted by WWW2026 (short paper)
- **Topic Keywords**: rag, recommend
- **Reason**: The paper focuses on recommendation systems, which is a related but secondary interest of yours. Although it involves semantic understanding, it's primarily concerned with recommender systems rather than information retrieval. The context is also limited to the e-commerce domain, which is not a central focus of your research.
...
### 29. CoT is Not the Chain of Truth: An Empirical Internal Analysis of Reasoning LLMs for Fake News Generation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhao Tong, Chunlin Gong, Yiping Zhang, Qiang Liu, Xingcheng Xu, Shu Wu, Haichao Shi, Xiao-Yu Zhang
- **URL**: <http://arxiv.org/abs/2602.04856v2>
- **Submitted**: 2026-02-04 18:43:10
- **Comment**: 28 pages, 35 figures
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on the safety analysis of Large Language Models (LLMs) for fake news generation, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific topic of fake news generation and safety analysis does not align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 30. Horizon-LM: A RAM-Centric Architecture for LLM Training

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhengqing Yuan, Lichao Sun, Yanfang Ye
- **URL**: <http://arxiv.org/abs/2602.04816v2>
- **Submitted**: 2026-02-04 18:04:46
- **Topic Keywords**: rag
- **Reason**: This paper focuses on large language model training architecture, specifically addressing memory constraints. While it touches on GPU utilization, it doesn't relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 31. SE-Bench: Benchmarking Self-Evolution with Knowledge Internalization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jiarui Yuan, Tailin Jin, Weize Chen, Zeyuan Liu, Zhiyuan Liu, Maosong Sun
- **URL**: <http://arxiv.org/abs/2602.04811v1>
- **Submitted**: 2026-02-04 17:58:32
- **Comment**: Under review
- **Topic Keywords**: acl
- **Reason**: This paper focuses on self-evolution and knowledge internalization in agents, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of learning and modeling, the context and application are quite different from your areas of focus.
...
### 32. "Be My Cheese?": Cultural Nuance Benchmarking for Machine Translation in Multilingual LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Madison Van Doren, Casey Ford, Jennifer Barajas, Cory Holland
- **URL**: <http://arxiv.org/abs/2602.04729v1>
- **Submitted**: 2026-02-04 16:35:48
- **Comment**: under peer-review
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves machine translation and large language models, the focus is on cultural nuance and localisation, which is not a central theme in your research.
...
### 33. LiteToken: Removing Intermediate Merge Residues From BPE Tokenizers

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yike Sun, Haotong Yang, Zhouchen Lin, Muhan Zhang
- **URL**: <http://arxiv.org/abs/2602.04706v1>
- **Submitted**: 2026-02-04 16:19:05
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on tokenization and BPE tokenizers, which is a specific aspect of NLP, but does not align with your primary focus on information retrieval, query understanding, and ranking models.
...
### 34. Multi-Source Retrieval and Reasoning for Legal Sentencing Prediction
...
- **Submitted**: 2026-02-04 15:55:55
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on legal sentencing prediction using multi-source retrieval and reasoning, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the context is specific to the legal domain and does not align with the user's interests in e-commerce or real-time relevance optimization.
...
### 35. LycheeDecode: Accelerating Long-Context LLM Inference via Hybrid-Head Sparse Decoding

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Gang Lin, Dongfang Li, Zhuoen Chen, Yukun Shi, Xuhui Chen, Baotian Hu, Min Zhang
- **URL**: <http://arxiv.org/abs/2602.04541v1>
- **Submitted**: 2026-02-04 13:34:12
- **Comment**: ICLR 2026
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on accelerating long-context large language models (LLMs) via a novel decoding method, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves attention mechanisms, the context is more aligned with NLP and deep learning, but lacks a clear connection to the user's core research themes.
...
- **URL**: <http://arxiv.org/abs/2602.04442v1>
- **Submitted**: 2026-02-04 11:14:29
- **Comment**: Accepted to EACL 2026 (LoResMT workshop)
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on machine translation for Turkic languages, which is outside your primary research interests in Information Retrieval and Search technologies. Although it involves NLP, the specific application and techniques used are not directly related to your areas of focus.
...
### 37. History-Guided Iterative Visual Reasoning with Self-Correction

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Xinglong Yang, Zhilin Peng, Zhanzhan Liu, Haochen Shi, Sheng-Jun Huang
- **URL**: <http://arxiv.org/abs/2602.04413v1>
- **Submitted**: 2026-02-04 10:42:06
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multimodal large language models and visual reasoning, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of query understanding and ranking models, the context is more aligned with computer vision and multimodal tasks, making it somewhat tangential to your primary research areas.
...
### 38. Swordsman: Entropy-Driven Adaptive Block Partition for Efficient Diffusion Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yu Zhang, Xinchen Li, Jialei Zhou, Hongnan Ma, Zhongwei Wan, Yiwei Shi, Duoqian Miao, Qi Zhang, Longbing Cao
- **URL**: <http://arxiv.org/abs/2602.04399v1>
- **Submitted**: 2026-02-04 10:27:49
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving the efficiency of diffusion language models through adaptive block partitioning, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves NLP, the specific application and techniques used are not aligned with the user's core research themes.
...
### 39. Internalizing LLM Reasoning via Discovery and Replay of Latent Actions

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhenning Shi, Yijia Zhu, Junhan Shi, Xun Zhang, Lei Wang, Congcong Miao
- **URL**: <http://arxiv.org/abs/2602.04925v1>
- **Submitted**: 2026-02-04 08:44:57
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving Large Language Model (LLM) performance through dynamic latent trajectory control, which is not directly related to Information Retrieval, Search technologies, or user behavior modeling. While it involves some form of 'reasoning' and 'latent actions', the context is quite different from the user's core research themes.
...
### 40. From Assumptions to Actions: Turning LLM Reasoning into Uncertainty-Aware Planning for Embodied Agents

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: SeungWon Seo, SooBin Lim, SeongRae Noh, Haneul Kim, HyeongYeop Kang
- **URL**: <http://arxiv.org/abs/2602.04326v1>
- **Submitted**: 2026-02-04 08:43:39
- **Comment**: 31 pages, 10 figures, Accepted ICLR 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models (LLMs), the focus is on uncertainty-aware planning for embodied agents, which is outside the user's primary areas of interest.
...
### 41. Contextual Drag: How Errors in the Context Affect LLM Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yun Cheng, Xingyu Zhu, Haoyu Zhao, Sanjeev Arora
- **URL**: <http://arxiv.org/abs/2602.04288v1>
- **Submitted**: 2026-02-04 07:36:23
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on the limitations of Large Language Models (LLMs) in reasoning tasks. While it touches on the topic of model performance and self-refinement, it does not address query understanding, ranking models, or user behavior modeling, which are core areas of interest for your research. The paper's focus on NLP and model limitations makes it somewhat tangential to your research interests.
...
### 42. Inference-Time Reasoning Selectively Reduces Implicit Social Bias in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Molly Apsel, Michael N. Jones
- **URL**: <http://arxiv.org/abs/2602.04742v1>
- **Submitted**: 2026-02-04 16:44:23
- **Topic Keywords**: search
- **Reason**: This paper focuses on implicit social bias in large language models and the effect of inference-time reasoning on bias reduction. While it touches on AI evaluation research, it does not directly relate to the user's core research themes in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper's emphasis on cognitive science and psychology also diverges from the user's primary focus.
...
### 43. Audio ControlNet for Fine-Grained Audio Generation and Editing
...
- **Submitted**: 2026-02-04 15:52:38
- **Topic Keywords**: search
- **Reason**: This paper focuses on audio generation and editing, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves a text-to-audio generation task, the paper's emphasis on audio control and editing does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 44. VILLAIN at AVerImaTeC: Verifying Image-Text Claims via Multi-Agent Collaboration

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jaeyoon Jung, Yejun Yoon, Seunghyun Yoon, Kunwoo Park
- **URL**: <http://arxiv.org/abs/2602.04587v1>
- **Submitted**: 2026-02-04 14:12:55
- **Comment**: A system description paper for the AVerImaTeC shared task at the Ninth FEVER Workshop (co-located with EACL 2026)
- **Topic Keywords**: rank
- **Reason**: This paper focuses on multimodal fact-checking and image-text claim verification, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multimodal analysis and question-answer generation, it does not seem to address query understanding, ranking models, or user behavior modeling, making it somewhat off-topic for the user's interests.
...
### 45. PersoDPO: Scalable Preference Optimization for Instruction-Adherent, Persona-Grounded Dialogue via Multi-LLM Evaluation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Saleh Afzoon, MohammadHossein Ahmadi, Usman Naseem, Amin Beheshti
- **URL**: <http://arxiv.org/abs/2602.04493v1>
- **Submitted**: 2026-02-04 12:34:55
- **Comment**: Accepted at WISE 2025 Conference
- **Topic Keywords**: personalization
- **Reason**: This paper appears to be focused on dialogue systems and personalization, which is somewhat related to information retrieval and search technologies. However, the primary focus on dialogue systems and language models does not align with the user's core research themes in IR and search technologies.
...
### 46. How Few-shot Demonstrations Affect Prompt-based Defenses Against LLM Jailbreak Attacks

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yanshu Wang, Shuaishuai Yang, Jingjing He, Tong Yang
- **URL**: <http://arxiv.org/abs/2602.04294v1>
- **Submitted**: 2026-02-04 07:54:51
- **Comment**: 13 pages, 4 figures, 6 tables
- **Topic Keywords**: recommend
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models and prompt-based defenses, the focus is on safety alignment and jailbreak attacks, which is not a central theme in your research.
...
### 47. DementiaBank-Emotion: A Multi-Rater Emotion Annotation Corpus for Alzheimer's Disease Speech (Version 1.0)
...
- **URL**: <http://arxiv.org/abs/2602.04247v1>
- **Submitted**: 2026-02-04 06:13:48
- **Comment**: Accepted at HeaLING Workshop @ EACL 2026. 9 pages, 3 figures, 8 tables
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on emotion annotation in Alzheimer's disease speech, which is outside the scope of information retrieval, search technologies, and natural language processing. The paper's emphasis on clinical populations and emotion recognition is not aligned with your areas of interest.
...
- **Topic Keywords**: ctr
- **Reason**: This paper appears to be focused on optimization methods in deep learning, specifically the Muon optimizer, and its relationship to adaptive optimizers. It does not relate to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing.
...
### 49. Universal Robust Speech Adaptation for Cross-Domain Speech Recognition and Enhancement

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Chien-Chun Wang, Hung-Shin Lee, Hsin-Min Wang, Berlin Chen
- **URL**: <http://arxiv.org/abs/2602.04307v1>
- **Submitted**: 2026-02-04 08:16:22
- **Comment**: Accepted to IEEE Transactions on Audio, Speech and Language Processing (IEEE TASLP)
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech recognition and enhancement, which is outside the scope of your research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 50. ECG-R1: Protocol-Guided and Modality-Agnostic MLLM for Reliable ECG Interpretation
...
- **Submitted**: 2026-02-04 07:17:55
- **Topic Keywords**: ctr
- **Reason**: This paper appears to be focused on developing a multimodal large language model for reliable ECG interpretation, which is outside the scope of your research interests in Information Retrieval, Search technologies, and Natural Language Processing.
