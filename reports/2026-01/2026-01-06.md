# Daily Papers Report - 2026-01-06
...
- **Topic**: Diagnosing and Mitigating Context‑Dependent Biases in Large‑Language‑Model Relevance Assessors
- **Aim**: Develop a bias‑diagnostic framework that localizes and quantifies context‑dependent errors in LLM relevance judgments and enables a hybrid human‑LLM evaluation workflow.
- **Rationale**: Human relevance judgments are costly and inconsistent; LLMs can approximate them but exhibit systematic, context‑dependent biases that current metrics fail to pinpoint. A robust, cluster‑level agreement analysis is needed to identify where LLMs diverge from humans.
- **Ground**: The study builds on TREC DL 2019/20 datasets, uses human binary relevance labels, and evaluates four LLMs (Claude‑3‑haiku, Gemini‑1.5‑flash‑8b, GPT‑4o, Llama‑3.1). It employs instruction‑fine‑tuned INSTRUCTOR‑XL embeddings, HDBSCAN clustering, Gwet’s AC₁ agreement, ΔAC₁ instability metric, and a bias‑localization heuristic. Retrieval performance is measured via MAP/NDCG.
- **Experiment**: Joint query‑document embeddings are clustered with HDBSCAN; per‑cluster Gwet’s AC₁ is computed for each LLM‑human pair. ΔAC₁ identifies agreement variability across clusters. A heuristic flags queries with high ΔAC₁ or extreme AC₁ extremes. Bias‑severity scores (BSS) combine directional bias and ΔAC₁. Bland–Altman analysis compares LLM‑human vs. human‑human agreement. Retrieval experiments evaluate the impact of the hybrid pipeline on MAP/NDCG.
- **Takeaway**: The framework provides a fine‑grained, robust diagnostic pipeline that localizes LLM relevance biases, quantifies severity, and enables selective human review, dramatically reducing annotation cost while maintaining high evaluation quality. It demonstrates the effectiveness of Gwet’s AC₁, ΔAC₁, and HDBSCAN clustering, and offers a reusable, open‑source tool (UMBRELA) for bias‑aware IR evaluation.
...
### 4. Confidence Estimation for LLMs in Multi-turn Interactions
...
### 5. A Dynamic Retrieval-Augmented Generation System with Selective Memory and Remembrance
...
### 6. Tackling the Inherent Difficulty of Noise Filtering in RAG
...
### 7. pdfQA: Diverse, Challenging, and Realistic Question Answering over PDFs
...
### 8. Routing by Analogy: kNN-Augmented Expert Assignment for Mixture-of-Experts
...
### 9. SRAS: A Lightweight Reinforcement Learning-based Document Selector for Edge-Native RAG Pipelines
...
### 10. Beyond Homophily: Community Search on Heterophilic Graphs
...
- **Reason**: This paper focuses on community search on heterophilic graphs, proposing a unified framework called AdaptCS. While it involves graph neural networks and optimization techniques, its primary application is in recommendation and fraud detection, which is somewhat related to information retrieval. However, the paper's emphasis on community search and graph structures does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 11. Cost-Efficient Cross-Lingual Retrieval-Augmented Generation for Low-Resource Languages: A Case Study in Bengali Agricultural Advisory
...
### 12. Cold-Starting Podcast Ads and Promotions with Multi-Task Learning on Spotify
...
### 13. Not All Needles Are Found: How Fact Distribution and Don't Make It Up Prompts Shape Literal Extraction, Logical Inference, and Hallucination Risks in Long-Context LLMs
...
### 14. When Attention Becomes Exposure in Generative Search
...
### 15. EverMemOS: A Self-Organizing Memory Operating System for Structured Long-Horizon Reasoning
...
### 16. A Hybrid Architecture for Multi-Stage Claim Document Understanding: Combining Vision-Language Models and Machine Learning for Real-Time Processing
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of document understanding and field extraction. However, the focus on healthcare and insurance claims documents, as well as the use of specific technologies like PaddleOCR and Qwen 2.5-VL-7B, limits its relevance to your broader interests in query understanding, ranking models, and user behavior modeling.
...
### 17. DeCode: Decoupling Content and Delivery for Medical QA
...
### 18. Exploring Diversity, Novelty, and Popularity Bias in ChatGPT's Recommendations
...
### 19. Aspect Extraction from E-Commerce Product and Service Reviews
...
- **Reason**: The paper presents a multimodal model that supports text, audio, and vision inputs and outputs, which is somewhat related to information retrieval and NLP. However, the focus on multimodal understanding and generation is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling. The paper's relevance is mostly limited to the broader NLP domain.
...
### 21. MCGI: Manifold-Consistent Graph Indexing for Billion-Scale Disk-Resident Vector Search
...
- **Reason**: This paper focuses on vector search and graph indexing, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves data mining and scalability, the context is more aligned with computer vision and machine learning, rather than the user's primary interests.
...
### 22. ARIES: A Scalable Multi-Agent Orchestration Framework for Real-Time Epidemiological Surveillance and Outbreak Monitoring
...
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves querying and data synthesis, the context is epidemiological surveillance, which is not a primary focus of the user's interests.
...
### 23. Hidden State Poisoning Attacks against Mamba-based Language Models
...
- **Topic Keywords**: information retrieval, retrieval
- **Reason**: This paper focuses on the security aspect of language models, specifically the vulnerability of state space models to hidden state poisoning attacks. While it touches on information retrieval capabilities, the primary focus is on the robustness of language models, which is not a central match to your research interests in IR and related topics.
...
### 24. EHRSummarizer: A Privacy-Aware, FHIR-Native Architecture for Structured Clinical Summarization of Electronic Health Records
...
### 25. Exploring Approaches for Detecting Memorization of Recommender System Data in Large Language Models
...
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves Large Language Models and Natural Language Understanding, its focus on recommender systems and data leakage detection is outside your primary areas of interest.
...
### 26. MergeRec: Model Merging for Data-Isolated Cross-Domain Sequential Recommendation
...
- **Reason**: This paper focuses on recommender systems, specifically proposing a framework for cross-domain sequential recommendation. While it touches on model merging and optimization, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 27. Simulated Reasoning is Reasoning
...
- **Comment**: 21 pages
- **Topic Keywords**: relevance
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It discusses the concept of reasoning in the context of artificial intelligence and foundational models, which is unrelated to your areas of focus.
...
### 28. CSF: Contrastive Semantic Features for Direct Multilingual Sign Language Generation
...
### 29. The Invisible Hand of AI Libraries Shaping Open Source Projects and Communities
...
- **Topic Keywords**: relevance
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on AI, its focus is on the adoption and impact of AI libraries in Open Source Software projects, which is outside your primary areas of interest.
...
### 30. CD4LM: Consistency Distillation and aDaptive Decoding for Diffusion Language Models
...
### 31. Toward Global Large Language Models in Medicine
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on large language models in medicine, which is outside your primary research interests in Information Retrieval and Search technologies. While it touches on multilingual tasks, the context is medical and not directly related to your areas of expertise.
...
### 32. Deferred Commitment Decoding for Diffusion Language Models with Confidence-Aware Sliding Windows
...
### 33. DermoGPT: Open Weights and Open Data for Morphology-Grounded Dermatological Reasoning MLLMs
...
- **Topic Keywords**: rag
- **Reason**: The paper focuses on dermatology and multimodal large language models, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. Although it involves a form of reasoning, it's grounded in a specific medical domain and doesn't align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 34. CSCBench: A PVC Diagnostic Benchmark for Commodity Supply Chain Reasoning
...
### 35. BanglaIPA: Towards Robust Text-to-IPA Transcription with Contextual Rewriting in Bengali
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on text-to-IPA transcription in Bengali and does not address query understanding, ranking models, or user behavior modeling.
...
### 36. Multi-granularity Interactive Attention Framework for Residual Hierarchical Pronunciation Assessment
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on automatic pronunciation assessment and speech processing, which is outside your primary areas of interest.
...
- **Comment**: 29 pages
- **Topic Keywords**: search, korea
- **Reason**: This paper appears to be about a large-scale multilingual language model, which is related to Natural Language Processing (NLP), but it does not seem to focus on information retrieval, query understanding, or ranking models, which are the core areas of your research interests.
...
### 38. Lying with Truths: Open-Channel Multi-Agent Collusion for Belief Manipulation via Generative Montage
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on Generative Montage and cognitive collusion attacks in large language models does not align with your areas of expertise.
...
### 39. Classifying several dialectal Nawatl varieties
...
### 40. A Training-Free Large Reasoning Model-based Knowledge Tracing Framework for Unified Prediction and Prescription
...
- **Reason**: This paper focuses on Knowledge Tracing, a field not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves Large Language Models, the application is in a different domain and does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 41. A Defect is Being Born: How Close Are We? A Time Sensitive Forecasting Approach
...
- **Comment**: ACCEPTED REGISTERED REPORT AT SANER (CORE A*) 2026
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on defect prediction in software engineering, which is outside your primary areas of interest.
