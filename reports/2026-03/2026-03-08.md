...
### 1. Sensitivity-Aware Retrieval-Augmented Intent Clarification

- **LLM Score**: 8
- **Keyword Score**: 6
- **Authors**: Maik Larooij
- **URL**: <http://arxiv.org/abs/2603.06025v1>
- **Submitted**: 2026-03-06 08:21:02
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in conversational search systems and query understanding. The focus on retrieval-augmented intent clarification and sensitivity-aware defenses aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's specific domain focus on sensitive information protection may not be a central match to your e-commerce background.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Privacy‑preserving retrieval‑augmented intent clarification in conversational search over sensitive document collections
- **Aim**: Design and evaluate retrieval‑level defenses that enable LLMs to generate clarifying questions without leaking protected content, balancing privacy protection with retrieval effectiveness
- **Rationale**: LLMs are vulnerable to membership‑inference, jailbreaks, and stealthy attacks; in a conversational setting attackers can infer corpus membership from the system’s own clarifying questions, exposing sensitive data. Retrieval‑centric controls are needed to mitigate this indirect attack surface.
- **Ground**: Combines theories from conversational search (dynamic intent modeling), clarifying question generation, privacy‑aware retrieval (k‑anonymity, differential privacy, sensitivity labeling), and LLM security literature (MIAs, jailbreaks).
- **Experiment**: Use annotated sensitive datasets (Avocado, SARA) to benchmark defenses. Measure protection via MIA accuracy and privacy budgets, utility via precision/recall of retrieved documents after clarification, and analyze trade‑offs across protect‑then‑search, search‑then‑protect, k‑anonymity abstractions, and DP noise. Include active‑learning for sensitivity review.
- **Takeaway**: First systematic framing of privacy‑preserving intent clarification; a three‑step agenda (attack modeling, defense design, evaluation); novel retrieval‑level defenses; a joint protection‑utility evaluation framework; and a call for community effort to build sensitivity‑aware, retrieval‑augmented agents.
...
### 2. InfoGatherer: Principled Information Seeking via Evidence Retrieval and Strategic Questioning

- **LLM Score**: 8
- **Keyword Score**: 5
- **Authors**: Maksym Taranukhin, Shuyue Stella Li, Evangelos Milios, Geoff Pleiss, Yulia Tsvetkov, Vered Shwartz
- **URL**: <http://arxiv.org/abs/2603.05909v1>
- **Submitted**: 2026-03-06 04:55:03
- **Comment**: Under review
- **Topic Keywords**: queries, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of query understanding and real-time relevance optimization. The proposed framework, InfoGatherer, addresses the issue of underspecified user queries and models uncertainty using Dempster-Shafer belief assignments, which is a key aspect of query understanding. However, the focus on legal and medical domains is somewhat specific, but the underlying IR concepts are broadly applicable.
...
### 3. Learning Next Action Predictors from Human-Computer Interaction
...
- **URL**: <http://arxiv.org/abs/2603.05923v1>
- **Submitted**: 2026-03-06 05:31:04
- **Comment**: 32 pages, 10 figures, see https://generalusermodels.github.io/nap
- **Topic Keywords**: user behavior, click
- **Reason**: This paper explores next action prediction from human-computer interaction, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on multimodal interactions and vision-language models is not directly aligned with the user's primary research themes, but it does touch on related areas of NLP and data mining.
...
### 4. ChatShopBuddy: Towards Reliable Conversational Shopping Agents via Reinforcement Learning

- **LLM Score**: 6
- **Keyword Score**: 1
- **Authors**: Yiruo Cheng, Kelong Mao, Tianhao Li, Jiejun Tan, Ji-Rong Wen, Zhicheng Dou
- **URL**: <http://arxiv.org/abs/2603.06065v1>
- **Submitted**: 2026-03-06 09:18:51
- **Topic Keywords**: shopping
- **Reason**: This paper explores the application of reinforcement learning to conversational shopping agents, which is somewhat related to information retrieval, particularly in areas that require deep semantic understanding. However, the focus on conversational agents and large language models is not a central match to the user's primary research interests in query understanding, ranking models, and user behavior modeling. The connection to information retrieval is more indirect, making it somewhat relevant but not a key area of interest.
...
### 5. Efficient, Property-Aligned Fan-Out Retrieval via RL-Compiled Diffusion
...
- **Submitted**: 2026-03-06 15:42:33
- **Topic Keywords**: retriever, query, queries, rag, retrieval
- **Reason**: This paper explores fan-out retrieval, a set-valued retrieval problem, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on reinforcement learning and diffusion-based generative retrieval is not a central match for the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 6. Balancing Domestic and Global Perspectives: Evaluating Dual-Calibration and LLM-Generated Nudges for Diverse News Recommendation

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Ruixuan Sun, Matthew Zent, Minzhu Zhao, Thanmayee Boyapati, Xinyi Li, Joseph A. Konstan
- **URL**: <http://arxiv.org/abs/2603.05780v1>
- **Submitted**: 2026-03-06 00:21:43
- **Topic Keywords**: relevance, rag, click, recommend, personalization
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in the context of news recommendation systems. However, it focuses more on recommender systems and user behavior modeling in news consumption, rather than query understanding, ranking models, or deep semantic understanding. The use of large language models and personalized diversity nudges is an interesting aspect, but it doesn't directly align with your primary focus on information retrieval.
...
### 7. Beyond Rows to Reasoning: Agentic Retrieval for Multimodal Spreadsheet Understanding and Editing

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Anmol Gulati, Sahil Sen, Waqar Sarguroh, Kevin Paul
- **URL**: <http://arxiv.org/abs/2603.06503v1>
- **Submitted**: 2026-03-06 17:36:39
- **Topic Keywords**: retriever, rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of multimodal retrieval and understanding. However, the focus on spreadsheet understanding and editing, while innovative, is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. The connection to NLP and related topics is also present, but not strong enough to elevate the score.
...
- **URL**: <http://arxiv.org/abs/2603.06198v1>
- **Submitted**: 2026-03-06 12:10:50
- **Comment**: Published as a conference paper at LREC 2026
- **Topic Keywords**: retriever, rag, retrieval
- **Reason**: The paper introduces a benchmark for Retrieval-Augmented Generation (RAG), which is a related area to Information Retrieval. However, it focuses on the capabilities of Large Language Models rather than traditional IR techniques, and the relevance to user behavior modeling and ranking models is limited. While it touches on aspects of query understanding and deep semantic understanding, the primary focus is on evaluating the performance of LLMs in RAG.
...
### 9. Efficient Vector Search in the Wild: One Model for Multi-K Queries
...
- **URL**: <http://arxiv.org/abs/2603.06159v1>
- **Submitted**: 2026-03-06 11:09:32
- **Topic Keywords**: queries, rag, search
- **Reason**: This paper focuses on efficient vector search, specifically addressing the issue of multi-K queries. While it relates to search technologies and ranking models, it doesn't directly address query understanding, user behavior modeling, or deep semantic understanding, which are core aspects of your research interests.
...
### 10. From Prompting to Preference Optimization: A Comparative Study of LLM-based Automated Essay Scoring
...
- **Submitted**: 2026-03-06 15:59:32
- **Comment**: 19 pages, 10 figures, 7 tables
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores the application of Large Language Models (LLMs) in Automated Essay Scoring (AES), which is related to Information Retrieval and Natural Language Processing. However, the focus on essay scoring and writing tasks is somewhat narrow and not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 11. RouteGoT: Node-Adaptive Routing for Cost-Efficient Graph of Thoughts Reasoning

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Yuhang Liu, Ruijie Wang, Yunlong Chu, Bing Hao, Yumeng Lin, Shengzhong Liu, Minglai Shao
- **URL**: <http://arxiv.org/abs/2603.05818v1>
- **Submitted**: 2026-03-06 02:03:06
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper focuses on graph-structured reasoning and proposes a routing framework to optimize token usage and accuracy. While it touches on aspects related to information retrieval (retrieval benchmarks) and natural language processing (large language models), the primary focus is on improving the efficiency of reasoning pipelines, which is somewhat related to the user's interests in query understanding and ranking models, but not a central match.
...
### 12. Towards Robust Retrieval-Augmented Generation Based on Knowledge Graph: A Comparative Analysis

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Hazem Amamou, Stéphane Gagnon, Alan Davoust, Anderson R. Avila
- **URL**: <http://arxiv.org/abs/2603.05698v1>
- **Submitted**: 2026-03-05 21:43:53
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores Retrieval-Augmented Generation (RAG) systems, which is somewhat related to information retrieval and search technologies. However, the focus on knowledge graph-based retrieval and robustness evaluation is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2603.06485v1>
- **Submitted**: 2026-03-06 17:12:47
- **Comment**: 15 pages, 2 figures
- **Topic Keywords**: retrieval, personalization
- **Reason**: The paper focuses on Explainable Artificial Intelligence (XAI) and personalization of natural language explanations, which is somewhat related to the user's interests in Information Retrieval and Natural Language Processing. However, the primary focus on XAI and personalization in a human-in-the-loop framework does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 14. Wisdom of the AI Crowd (AI-CROWD) for Ground Truth Approximation in Content Analysis: A Research Protocol & Validation Using Eleven Large Language Models

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Luis de-Marcos, Manuel Goyanes, Adrián Domínguez-Díaz
- **URL**: <http://arxiv.org/abs/2603.06197v1>
- **Submitted**: 2026-03-06 12:10:02
- **Topic Keywords**: rag, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves large language models and content analysis. However, the focus on ground truth approximation and validation using ensemble models is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 15. CodeScout: Contextual Problem Statement Enhancement for Software Agents
...
- **Submitted**: 2026-03-05 23:10:09
- **Topic Keywords**: query
- **Reason**: The paper explores query refinement and contextual analysis for AI-powered code assistance tools, which is somewhat related to information retrieval and query understanding. However, the focus is on software engineering and code analysis, which is not a central match to your primary research interests in IR and NLP. The paper's emphasis on contextual analysis and query refinement is relevant, but the application domain is distinct from your e-commerce background and interests.
...
### 16. SPOT: Span-level Pause-of-Thought for Efficient and Interpretable Latent Reasoning in Large Language Models

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yunlong Chu, Minglai Shao, Yuhang Liu, Bing Hao, Yumeng Lin, Jialu Wang, Ruijie Wang
- **URL**: <http://arxiv.org/abs/2603.06222v1>
- **Submitted**: 2026-03-06 12:34:27
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding, but it does not directly align with the user's primary focus on Information Retrieval (IR), query understanding, or ranking models.
...
### 17. Building an Ensemble LLM Semantic Tagger for UN Security Council Resolutions

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Hussein Ghaly
- **URL**: <http://arxiv.org/abs/2603.05895v1>
- **Submitted**: 2026-03-06 04:26:53
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on a specific application (UN Security Council resolutions) and doesn't directly relate to your core areas of Information Retrieval, query understanding, or ranking models.
...
### 18. FreeTxt-Vi: A Benchmarked Vietnamese-English Toolkit for Segmentation, Sentiment, and Summarisation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Hung Nguyen Huy, Mo El-Haj, Dawn Knight, Paul Rayson
- **URL**: <http://arxiv.org/abs/2603.05690v1>
- **Submitted**: 2026-03-05 21:26:08
- **Comment**: 10 pages
- **Topic Keywords**: search
- **Reason**: The paper FreeTxt-Vi is somewhat related to your research interests in Natural Language Processing (NLP) and data mining, but it focuses more on corpus linguistics and text analysis, which is not a central match to your primary focus on information retrieval and query understanding. Although it involves sentiment analysis and summarization, it does not directly relate to your interests in ranking models or user behavior modeling.
...
### 19. MLLMRec-R1: Incentivizing Reasoning Capability in Large Language Models for Multimodal Sequential Recommendation

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Yu Wang, Yonghui Yang, Le Wu, Jiancan Wu, Hefei Xu, Hui Lin
- **URL**: <http://arxiv.org/abs/2603.06243v1>
- **Submitted**: 2026-03-06 13:05:06
- **Comment**: 14 pages, 10figures
- **Topic Keywords**: ranking, recommend, rank, acl
- **Reason**: This paper focuses on multimodal sequential recommendation using large language models, which is not directly related to your core research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. While it involves recommendation systems, the emphasis is on multimodal sequential recommendation, which is a specific application area rather than a fundamental concept in IR.
...
### 20. FlashPrefill: Instantaneous Pattern Discovery and Thresholding for Ultra-Fast Long-Context Prefilling

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Qihang Fan, Huaibo Huang, Zhiying Wu, Juqiu Wang, Bingning Wang, Ran He
- **URL**: <http://arxiv.org/abs/2603.06199v1>
- **Submitted**: 2026-03-06 12:12:46
- **Topic Keywords**: ltr, rag, search
- **Reason**: This paper focuses on improving the efficiency of Large Language Models through ultra-fast long-context prefilling, leveraging a framework called FlashPrefill. While it touches on the topic of attention mechanisms, which is related to ranking models, the primary focus is on improving model efficiency rather than query understanding or ranking models. The paper's relevance to information retrieval and search technologies is limited.
...
### 21. CRIMSON: A Clinically-Grounded LLM-Based Metric for Generative Radiology Report Evaluation
...
- **URL**: <http://arxiv.org/abs/2603.06183v1>
- **Submitted**: 2026-03-06 11:43:42
- **Topic Keywords**: pairwise, relevance
- **Reason**: This paper focuses on evaluating generative radiology reports using a clinically grounded framework, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves deep learning models, the context is medical imaging and report evaluation, which is not a central match to your research themes.
...
### 22. The EpisTwin: A Knowledge Graph-Grounded Neuro-Symbolic Architecture for Personal AI
...
- **Submitted**: 2026-03-06 13:48:23
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on Personal AI and Knowledge Graphs, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on Retrieval-Augmented Generation, it's more focused on Personal AI and Knowledge Graphs, making it only loosely relevant to the user's interests.
...
### 23. HART: Data-Driven Hallucination Attribution and Evidence-Based Tracing for Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Shize Liang, Hongzhi Wang
- **URL**: <http://arxiv.org/abs/2603.05828v1>
- **Submitted**: 2026-03-06 02:23:55
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models and text generation, the focus is on hallucination attribution and evidence-based tracing, which is more relevant to NLP and AI interpretability than your core research themes.
...
### 24. The DSA's Blind Spot: Algorithmic Audit of Advertising and Minor Profiling on TikTok
...
- **URL**: <http://arxiv.org/abs/2603.05653v1>
- **Submitted**: 2026-03-05 20:02:48
- **Topic Keywords**: relevance, recommend
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The study focuses on algorithmic auditing and regulatory compliance in the context of social media advertising, which is outside your primary areas of interest.
...
### 25. NOBLE: Accelerating Transformers with Nonlinear Low-Rank Branches

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ethan Smith
- **URL**: <http://arxiv.org/abs/2603.06492v1>
- **Submitted**: 2026-03-06 17:22:04
- **Comment**: 14 pages, 5 figures, 5 tables
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on accelerating transformers using a novel architectural augmentation, which is not directly related to information retrieval, query understanding, or user behavior modeling. While it involves deep learning and optimization techniques, its primary contribution is in the area of efficient transformer training, which is not a core interest of yours.
...
### 26. Do Compact SSL Backbones Matter for Audio Deepfake Detection? A Controlled Study with RAPTOR

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ajinkya Kulkarni, Sandipana Dowerah, Atharva Kulkarni, Tanel Alumäe, Mathew Magimai Doss
- **URL**: <http://arxiv.org/abs/2603.06164v1>
- **Submitted**: 2026-03-06 11:16:55
- **Comment**: Submitted to Interspeech 2026, 4 pages, 2 figures
- **Topic Keywords**: pairwise
- **Reason**: This paper is not relevant to your research interests as it focuses on audio deepfake detection, self-supervised learning, and representation learning in the audio domain, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 27. Imagine How To Change: Explicit Procedure Modeling for Change Captioning

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Jiayang Sun, Zixin Guo, Min Cao, Guibo Zhu, Jorma Laaksonen
- **URL**: <http://arxiv.org/abs/2603.05969v1>
- **Submitted**: 2026-03-06 07:05:39
- **Comment**: Accepted to ICLR 2026. Code and models are available at https://github.com/BlueberryOreo/ProCap
- **Topic Keywords**: queries
- **Reason**: This paper focuses on change captioning, which, although related to information retrieval, does not directly align with the user's core research themes in query understanding, ranking models, or user behavior modeling. While it involves NLP and captioning, the context is specific to image captioning and does not leverage deep semantic understanding or real-time relevance optimization, which are key areas of interest for the user.
...
### 28. VerChol -- Grammar-First Tokenization for Agglutinative Languages

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Prabhu Raja
- **URL**: <http://arxiv.org/abs/2603.05883v1>
- **Submitted**: 2026-03-06 04:07:15
- **Comment**: 13 pages. A Morphological Alternative to Statistical Subword Tokenization
- **Topic Keywords**: rag, korea
- **Reason**: This paper focuses on tokenization for agglutinative languages, which is a specific problem in Natural Language Processing (NLP). While it is related to the broader field of NLP, it does not directly align with the user's primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling.
...
### 29. Tutor Move Taxonomy: A Theory-Aligned Framework for Analyzing Instructional Moves in Tutoring

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Zhuqian Zhou, Kirk Vanacore, Tamisha Thompson, Jennifer St John, Rene Kizilcec
- **URL**: <http://arxiv.org/abs/2603.05778v1>
- **Submitted**: 2026-03-06 00:20:58
- **Topic Keywords**: ctr, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves computational modeling, its focus on tutoring dialogue and instructional moves in education is outside your primary areas of interest.
...
### 30. MAPO: Mixed Advantage Policy Optimization for Long-Horizon Multi-Turn Dialogue

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Naifan Zhang, Ruihan Sun, Jinwei Su, Hengjie Yang, Zhengyuan Pan, Zhaohan Chen, Xiaofan Zhang
- **URL**: <http://arxiv.org/abs/2603.06194v1>
- **Submitted**: 2026-03-06 12:06:57
- **Topic Keywords**: rag
- **Reason**: This paper focuses on reinforcement learning for multi-turn dialogue tasks, which is not directly related to your primary research interests in Information Retrieval and Search technologies. While it involves some aspects of user behavior modeling, the context and application are quite different from your usual areas of focus.
...
### 31. ViewFusion: Structured Spatial Thinking Chains for Multi-View Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Xingjian Tao, Yiwei Wang, Yujun Cai, Yifan Song, Jing Tang
- **URL**: <http://arxiv.org/abs/2603.06024v1>
- **Submitted**: 2026-03-06 08:19:42
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multi-view spatial reasoning in vision-language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves question answering, it's more aligned with computer vision and spatial reasoning, rather than query understanding, ranking models, or user behavior modeling.
...
### 32. Implicit Style Conditioning: A Structured Style-Rewrite Framework for Low-Resource Character Modeling

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Chanhui Zhu
- **URL**: <http://arxiv.org/abs/2603.05933v1>
- **Submitted**: 2026-03-06 06:04:47
- **Comment**: 26 pages, 4 figures. Preprint
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves language models and generation, the focus is on character modeling and style conditioning, which is not a central match to your primary research themes.
...
### 33. ROSE: Reordered SparseGPT for More Accurate One-Shot Large Language Models Pruning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Mingluo Su, Huan Wang
- **URL**: <http://arxiv.org/abs/2603.05878v1>
- **Submitted**: 2026-03-06 03:59:02
- **Comment**: CPAL 2026 oral
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on pruning large language models, which is outside the scope of information retrieval and search technologies. While it involves some optimization techniques, the context is not aligned with your primary areas of interest.
...
### 34. ReflexiCoder: Teaching Large Language Models to Self-Reflect on Generated Code and Self-Correct It via Reinforcement Learning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Juyong Jiang, Jiasi Shen, Sunghun Kim, Kang Min Yoo, Jeonghoon Kim, Sungju Kim
- **URL**: <http://arxiv.org/abs/2603.05863v1>
- **Submitted**: 2026-03-06 03:38:17
- **Topic Keywords**: acl
- **Reason**: This paper focuses on teaching Large Language Models to self-reflect and self-correct generated code using reinforcement learning. While it touches on the idea of 'structured reasoning trajectory', it doesn't directly relate to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 35. Let's Talk, Not Type: An Oral-First Multi-Agent Architecture for Guaraní

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Samantha Adorno, Akshata Kishore Moharir, Ratna Kandala
- **URL**: <http://arxiv.org/abs/2603.05743v1>
- **Submitted**: 2026-03-05 23:07:36
- **Topic Keywords**: rag
- **Reason**: This paper focuses on oral languages and indigenous communities, proposing an oral-first multi-agent architecture for the Guaraní language. While it touches on natural language understanding, it is not directly related to information retrieval, search technologies, or query understanding, which are the core areas of your research interests.
...
### 36. Structured Multidimensional Representation Learning for Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Alaa El Ichi, Khalide Jbilou, Mohamed El Guide, Franck Dufrenois
- **URL**: <http://arxiv.org/abs/2603.05727v1>
- **Submitted**: 2026-03-05 22:34:45
- **Comment**: 25 pages, 6 figures. Preprint of a journal submission
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on improving the efficiency of large language models through a novel spectral factorization technique, which is not directly related to information retrieval, query understanding, or ranking models. While it involves natural language processing, the primary goal is model compression and generalization, rather than deep semantic understanding or real-time relevance optimization.
...
### 37. Autonomous Algorithm Discovery for Ptychography via Evolutionary LLM Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Xiangyu Yin, Ming Du, Junjing Deng, Zhi Yang, Yimo Han, Yi Jiang
- **URL**: <http://arxiv.org/abs/2603.05696v1>
- **Submitted**: 2026-03-05 21:39:57
- **Topic Keywords**: ctr
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves the use of large language models, the focus is on algorithm discovery for computational imaging, which is outside your primary areas of interest.
...
### 38. The Fragility Of Moral Judgment In Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Tom van Nuenen, Pratik S. Sachdeva
- **URL**: <http://arxiv.org/abs/2603.05651v1>
- **Submitted**: 2026-03-05 20:01:43
- **Comment**: 22 pages, 7 figures, 10 tables, plus appendices
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the moral judgment capabilities of large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context and methodology are distinct from your areas of focus.
...
### 39. Abductive Reasoning with Syllogistic Forms in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Hirohiko Abe, Risako Ando, Takanobu Morishita Kentaro Ozeki, Koji Mineshima, Mitsuhiro Okada
- **URL**: <http://arxiv.org/abs/2603.06428v1>
- **Submitted**: 2026-03-06 16:06:25
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on abductive reasoning in Large Language Models, which is a topic related to NLP, but it does not directly relate to the user's core research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. While it touches on the idea of complex reasoning tasks, it does not specifically address real-time relevance optimization or deep semantic understanding, making it somewhat tangential to the user's primary focus.
...
### 40. Continual Adaptation for Pacific Indigenous Speech Recognition

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yang Xiao, Aso Mahmudi, Nick Thieberger, Eliathamby Ambikairajah, Eun-Jung Holden, Ting Dang
- **URL**: <http://arxiv.org/abs/2603.06310v1>
- **Submitted**: 2026-03-06 14:13:37
- **Comment**: Submitted to Interspeech
- **Topic Keywords**: rank
- **Reason**: This paper focuses on speech recognition for Pacific Indigenous languages, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves adaptation strategies, the context is specific to speech recognition and low-resource languages, making it only loosely relevant to your interests.
...
### 41. Lost in Stories: Consistency Bugs in Long Story Generation by LLMs

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Junjie Li, Xinrui Guo, Yuhao Wu, Roy Ka-Wei Lee, Hongzhi Li, Yutao Xie
- **URL**: <http://arxiv.org/abs/2603.05890v1>
- **Submitted**: 2026-03-06 04:16:46
- **Topic Keywords**: search
- **Reason**: This paper focuses on long-form story generation by Large Language Models (LLMs), which is not directly related to Information Retrieval, Search technologies, or user behavior modeling. While it involves Natural Language Processing (NLP), the topic is more specific to text generation and consistency in narratives, rather than the broader themes of query understanding, ranking models, or real-time relevance optimization.
...
### 42. PVminerLLM: Structured Extraction of Patient Voice from Patient-Generated Text using Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Samah Fodeh, Linhai Ma, Ganesh Puthiaraju, Srivani Talakokkul, Afshan Khan, Ashley Hagaman, Sarah Lowe, Aimee Roundtree
- **URL**: <http://arxiv.org/abs/2603.05776v1>
- **Submitted**: 2026-03-06 00:16:05
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on medical annotation and patient-generated text in a clinical context. While it involves large language models, the application is specific to the medical domain and does not align with your broader interests in e-commerce, real-time relevance optimization, or deep semantic understanding.
...
### 43. NERdME: a Named Entity Recognition Dataset for Indexing Research Artifacts in Code Repositories

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Genet Asefa Gesese, Zongxiong Chen, Shufan Jiang, Mary Ann Tan, Zhaotai Liu, Sonja Schimmler, Harald Sack
- **URL**: <http://arxiv.org/abs/2603.05750v1>
- **Submitted**: 2026-03-05 23:21:09
- **Comment**: To be published (Accepted at WWW'26)
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves entity recognition and language models, its focus on code repositories and README files is more aligned with software engineering and data science applications.
...
### 44. Cultural Perspectives and Expectations for Generative AI: A Global Survey Approach
...
- **URL**: <http://arxiv.org/abs/2603.05723v1>
- **Submitted**: 2026-03-05 22:25:31
- **Comment**: 21 pages, 5 figures, 6 tables
- **Topic Keywords**: recommend
- **Reason**: This paper appears to be off-topic as it focuses on cultural perspectives and expectations for Generative AI, which does not align with your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on AI, it does not relate to query understanding, ranking models, or user behavior modeling, which are core areas of your research.
