...
### 1. HIVE: Query, Hypothesize, Verify An LLM Framework for Multimodal Reasoning-Intensive Retrieval
...
- **URL**: <http://arxiv.org/abs/2604.07220v1>
- **Submitted**: 2026-04-08 15:41:42
- **Comment**: accepted at CVPR 2026 Workshop GRAIL-V
- **Topic Keywords**: retriever, query, queries, ranking, rerank, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of multimodal reasoning-intensive retrieval. The use of LLMs for visual-text reasoning and the framework's ability to close the multimodal reasoning gap in retrieval aligns well with your focus on query understanding, ranking models, and user behavior modeling.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: HIVE: Explicit Visual Reasoning for Multimodal Retrieval
- **Aim**: Enhance multimodal‑to‑text retrieval by letting an LLM explicitly hypothesize and verify visual evidence during inference, without extra training.
- **Rationale**: Current multimodal retrievers align image and text embeddings but cannot reason about how visual cues influence relevance, often hurting performance. HIVE closes this visual‑reasoning gap by generating compensatory queries and reranking based on multimodal intent.
- **Ground**: Benchmark: MM‑BRIGHT multimodal‑to‑text (2,803 queries, 29 domains). Baselines: best multimodal (Nomic‑Vision, 27.6 nDCG@10) vs best text‑only (DiVeR, 32.2 nDCG@10). Gap: joint embeddings degrade performance because they lack reasoning.
- **Experiment**: Four‑stage inference pipeline: 1) Initial retrieval (k₁=5) with base retriever; 2) Compensatory query synthesis via GPT‑4o; 3) Secondary retrieval (k₂=50) with refined query; 4) Verification & reranking (k_f=10) via GPT‑4o. Base retriever: dense, Qwen3‑Embedding‑4B fine‑tuned on synthetic hard negatives. Evaluation: HIVE achieves 41.7 nDCG@10, +9.5 over DiVeR, +14.1 over Nomic‑Vision, leading in 28/29 domains. Ablation: Stage 2 alone 35.3, Stage 4 alone 37.2, Stages 2+3 38.1, full pipeline 41.7. Hyper‑parameter study shows increasing k₁/k₂ improves performance.
- **Takeaway**: Explicit visual reasoning via LLM at inference time yields substantial gains in multimodal retrieval, outperforming both multimodal and text‑only baselines. The synergy of query synthesis and verification stages is essential; neither alone achieves the full benefit. HIVE demonstrates that reasoning can be integrated without retraining, offering a practical, high‑impact approach for multimodal search.
...
- **URL**: <http://arxiv.org/abs/2604.07079v1>
- **Submitted**: 2026-04-08 13:35:09
- **Topic Keywords**: retriever, query, queries, ranking, rerank, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding, ranking models, and user behavior modeling. The paper's focus on multimodal retrieval, reasoning-intensive multimodal retrieval benchmark, and the introduction of MARVEL, a unified pipeline that combines query expansion, reasoning-enhanced dense retriever, and chain-of-thought reranking, aligns closely with your research themes.
...
### 3. ReAlign: Optimizing the Visual Document Retriever with Reasoning-Guided Fine-Grained Alignment

- **LLM Score**: 8
- **Keyword Score**: 17
- **Authors**: Hao Yang, Yifan Ji, Zhipeng Xu, Zhenghao Liu, Yukun Yan, Zulong Chen, Shuo Wang, Yu Gu, Ge Yu
- **URL**: <http://arxiv.org/abs/2604.07419v1>
- **Submitted**: 2026-04-08 14:47:27
- **Topic Keywords**: retriever, query, queries, ranking, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of visual document retrieval and query understanding. The use of Vision-Language Models and fine-grained alignment for real-time relevance optimization aligns with your focus on deep semantic understanding and ranking models. However, the specific domain of visually rich document retrieval is somewhat niche, which prevents it from being a central match.
...
- **URL**: <http://arxiv.org/abs/2604.07201v1>
- **Submitted**: 2026-04-08 15:28:21
- **Comment**: Accepted at CVPR 2026 Workshop GRAIL-V
- **Topic Keywords**: retriever, query, queries, retrieval, search
- **Reason**: This paper presents a novel approach to multimodal-to-text retrieval, focusing on query alignment using reinforcement learning. Although primarily focused on multimodal retrieval, the paper's emphasis on query understanding and optimization aligns with your interests in Information Retrieval and Search technologies, particularly in areas requiring deep semantic understanding.
...
### 5. Multi-Faceted Self-Consistent Preference Alignment for Query Rewriting in Conversational Search

- **LLM Score**: 8
- **Keyword Score**: 12
- **Authors**: Zhiyu Cao, Peifeng Li, Qiaoming Zhu
- **URL**: <http://arxiv.org/abs/2604.06771v1>
- **Submitted**: 2026-04-08 07:38:45
- **Comment**: ACL 2026 Findings
- **Topic Keywords**: passage retrieval, query, queries, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in conversational search and query rewriting. The focus on multi-faceted preference alignment and direct preference optimization aligns with your interests in query understanding and ranking models. However, the specific domain of conversational search is somewhat distinct from your e-commerce background.
...
### 6. SubSearch: Intermediate Rewards for Unsupervised Guided Reasoning in Complex Retrieval

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Roxana Petcu, Evangelos Kanoulas, Maarten de Rijke
- **URL**: <http://arxiv.org/abs/2604.07415v1>
- **Submitted**: 2026-04-08 13:09:47
- **Topic Keywords**: query, queries, retrieval, search
- **Reason**: This paper introduces a framework for unsupervised guided reasoning in complex retrieval, leveraging large language models and intermediate reward signals. While it's not directly focused on query understanding or ranking models, it explores a related area of complex information retrieval and reasoning, which aligns with your interests in Information Retrieval and NLP. The paper's emphasis on autonomous information-intensive reasoning and its potential applications in search engines also make it relevant to your research.
...
### 7. Personalized RewardBench: Evaluating Reward Models with Human Aligned Personalization

- **LLM Score**: 6
- **Keyword Score**: 4
- **Authors**: Qiyao Ma, Dechen Gao, Rui Cai, Boqi Zhao, Hanchu Zhou, Junshan Zhang, Zhe Zhao
- **URL**: <http://arxiv.org/abs/2604.07343v1>
- **Submitted**: 2026-04-08 17:55:00
- **Topic Keywords**: relevance, personalization
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of reward models and personalized preference modeling. However, the focus on Large Language Models and human-aligned personalization in the e-commerce domain is not a central match with your primary research themes.
...
### 8. A Systematic Study of Retrieval Pipeline Design for Retrieval-Augmented Medical Question Answering
...
- **Submitted**: 2026-04-08 16:37:22
- **Topic Keywords**: dense retrieval, query, ranking, rerank, rag, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of Retrieval-Augmented Generation (RAG) for medical question answering. However, the focus on medical question answering and the specific application to medical knowledge retrieval limits its direct relevance to your core research themes in e-commerce and general information retrieval.
...
- **URL**: <http://arxiv.org/abs/2604.07420v1>
- **Submitted**: 2026-04-08 14:54:10
- **Topic Keywords**: queries, ranking, rerank, rank, search
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of search technologies and reranking models. However, its focus on Generative Reranking and sequential knowledge distillation in an industrial setting is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 10. DTCRS: Dynamic Tree Construction for Recursive Summarization

- **LLM Score**: 4
- **Keyword Score**: 11
- **Authors**: Guanran Luo, Zhongquan Jian, Wentao Qiu, Meihong Wang, Qingqiang Wu
- **URL**: <http://arxiv.org/abs/2604.07012v1>
- **Submitted**: 2026-04-08 12:33:42
- **Topic Keywords**: query, relevance, rag, retrieval, search
- **Reason**: This paper focuses on recursive summarization and Retrieval-Augmented Generation, which are related to Natural Language Processing and query understanding. However, it does not directly address ranking models, user behavior modeling, or real-time relevance optimization, which are core areas of interest. While it explores query semantics, the application is more focused on question answering rather than search technologies.
...
### 11. Leveraging LLMs and Heterogeneous Knowledge Graphs for Persona-Driven Session-Based Recommendation

- **LLM Score**: 4
- **Keyword Score**: 11
- **Authors**: Muskan Gupta, Suraj Thapa, Jyotsana Khatri
- **URL**: <http://arxiv.org/abs/2604.06928v1>
- **Submitted**: 2026-04-08 10:40:30
- **Topic Keywords**: ranking, rerank, rag, recommend, personalization, rank
- **Reason**: This paper is somewhat related to information retrieval, specifically session-based recommendation systems, but it focuses more on recommender systems and knowledge graph-based user modeling. While it touches on deep semantic understanding, the primary goal is to improve recommendation accuracy rather than real-time relevance optimization, which aligns less with your core research themes.
...
- **URL**: <http://arxiv.org/abs/2604.06845v1>
- **Submitted**: 2026-04-08 09:07:07
- **Comment**: Accepted by TheWebConf 2026
- **Topic Keywords**: query, rag, retrieval
- **Reason**: The paper discusses a novel approach to long-term memory for dialogue systems, which is somewhat related to information retrieval and query understanding. However, the focus is on dialogue systems and memory modeling, which is not a central match to the user's primary research interests in IR and search technologies. The paper's use of query-adaptive retrieval mechanisms is somewhat relevant, but the context is different from the user's usual domain of e-commerce and web applications.
...
- **URL**: <http://arxiv.org/abs/2604.07041v1>
- **Submitted**: 2026-04-08 12:56:13
- **Topic Keywords**: query, queries
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the area of query understanding and text-to-SQL tasks. However, it does not directly focus on your core themes of ranking models, user behavior modeling, or real-time relevance optimization, which limits its relevance to your primary research areas.
...
### 14. Flux Attention: Context-Aware Hybrid Attention for Efficient LLMs Inference

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Quantong Qiu, Zhiyi Hong, Yi Yang, Haitian Wang, Kebin Liu, Qingqing Dang, Juntao Li, Min Zhang
- **URL**: <http://arxiv.org/abs/2604.07394v1>
- **Submitted**: 2026-04-08 07:36:17
- **Topic Keywords**: information retrieval, retrieval
- **Reason**: The paper discusses a novel attention mechanism for efficient inference in Large Language Models (LLMs), which is a topic related to Natural Language Processing (NLP). However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest in Information Retrieval (IR). The paper's focus on LLMs and attention mechanisms makes it somewhat relevant but not a central match for the user's research interests.
...
### 15. CASE: Cadence-Aware Set Encoding for Large-Scale Next Basket Repurchase Recommendation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Yanan Cao, Ashish Ranjan, Sinduja Subramaniam, Evren Korpeoglu, Kaushiki Nag, Kannan Achan
- **URL**: <http://arxiv.org/abs/2604.06718v2>
- **Submitted**: 2026-04-08 06:31:34
- **Comment**: Accepted at SIGIR 2026 Industry Track
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper focuses on next basket repurchase recommendation, which is somewhat related to information retrieval, but it primarily deals with recommender systems. While it involves modeling user behavior and item dependencies, it does not directly address query understanding, ranking models, or deep semantic understanding, which are core areas of interest for the user.
...
### 16. ClickGuard: A Trustworthy Adaptive Fusion Framework for Clickbait Detection

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Chhavi Dhiman, Naman Chawla, Riya Dhami, Gaurav Kumar, Ganesh Naik
- **URL**: <http://arxiv.org/abs/2604.07272v1>
- **Submitted**: 2026-04-08 16:33:47
- **Topic Keywords**: rag, click
- **Reason**: The paper focuses on clickbait detection, which is related to user behavior modeling in information retrieval, but it does not directly address query understanding, ranking models, or deep semantic understanding. While it involves NLP techniques like BERT embeddings, the primary goal is not information retrieval but rather clickbait detection, making it somewhat relevant but not a central match for your research interests.
...
### 17. Select-then-Solve: Paradigm Routing as Inference-Time Optimization for LLM Agents
...
- **URL**: <http://arxiv.org/abs/2604.06753v1>
- **Submitted**: 2026-04-08 07:20:23
- **Topic Keywords**: rag, acl
- **Reason**: The paper explores inference-time optimization for Large Language Model (LLM) agents, which is somewhat related to ranking models and query understanding in Information Retrieval. However, the focus on LLMs and reasoning paradigms is not directly aligned with the user's primary research interests in IR and search technologies. The connection to deep semantic understanding and real-time relevance optimization is also not explicitly mentioned.
...
### 18. Leveraging Artist Catalogs for Cold-Start Music Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Yan-Martin Tamm, Gregor Meehan, Vojtěch Nekl, Vojtěch Vančura, Rodrigo Alves, Johan Pauwels, Anna Aljanaki
- **URL**: <http://arxiv.org/abs/2604.07090v1>
- **Submitted**: 2026-04-08 13:43:00
- **Comment**: Accepted at UMAP 2026
- **Topic Keywords**: rag, recommend
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval and Search technologies, but it primarily focuses on recommender systems, which is a secondary interest of yours. The paper's use of attention-based architecture and collaborative filtering is somewhat related to your work on ranking models and user behavior modeling, but the context is different and the paper's main contribution is in music recommendation, not information retrieval.
...
### 19. AGSC: Adaptive Granularity and Semantic Clustering for Uncertainty Quantification in Long-text Generation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Guanran Luo, Wentao Qiu, Wanru Zhao, Wenhan Lv, Zhongquan Jian, Meihong Wang, Qingqiang Wu
- **URL**: <http://arxiv.org/abs/2604.06812v1>
- **Submitted**: 2026-04-08 08:25:01
- **Topic Keywords**: relevance
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and long-text generation, but it does not directly align with the user's primary focus on Information Retrieval (IR), query understanding, and ranking models. The paper's focus on uncertainty quantification and long-form generation is not a central match for the user's research themes.
...
### 20. LaScA: Language-Conditioned Scalable Modelling of Affective Dynamics

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Kosmas Pinitas, Ilias Maglogiannis
- **URL**: <http://arxiv.org/abs/2604.07193v1>
- **Submitted**: 2026-04-08 15:18:39
- **Comment**: This paper has been accepted at the CVPR 2026 Workshop on Affective Behavior Analysis in-the-wild (ABAW)
- **Topic Keywords**: rag
- **Reason**: The paper explores affective dynamics modeling using language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on affective dynamics and affective modeling is not directly aligned with the user's primary research interests in IR and NLP. The use of language models is a common thread, but the application is distinct from the user's core themes.
...
### 21. Yale-DM-Lab at ArchEHR-QA 2026: Deterministic Grounding and Multi-Pass Evidence Alignment for EHR Question Answering

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Elyas Irankhah, Samah Fodeh
- **URL**: <http://arxiv.org/abs/2604.07116v1>
- **Submitted**: 2026-04-08 14:09:25
- **Comment**: 9 pages, 2 figures. System description for ArchEHR-QA 2026 shared task
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to information retrieval, but its focus on question answering in electronic health records (EHRs) and use of large language models (LLMs) like GPT-4 and GPT-5 is not directly aligned with the user's core research themes in IR and search technologies. While it touches on aspects of query understanding and ranking models, the context is quite different from typical IR applications.
...
### 22. iTAG: Inverse Design for Natural Text Generation with Accurate Causal Graph Annotations

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Wenshuo Wang, Boyu Cao, Nan Zhuang, Wei Li
- **URL**: <http://arxiv.org/abs/2604.06902v1>
- **Submitted**: 2026-04-08 09:59:45
- **Comment**: Accepted at ACL 2026
- **Topic Keywords**: acl
- **Reason**: The paper iTAG explores the generation of text with causal graph annotations, which is related to Natural Language Processing (NLP) and data mining. However, it does not directly address information retrieval, query understanding, or ranking models, which are core areas of interest. While it touches on the concept of real-time relevance optimization, its focus is on text generation rather than search technologies.
...
### 23. How Long Reasoning Chains Influence LLMs' Judgment of Answer Factuality

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Minzhu Tu, Shiyu Ni, Keping Bi
- **URL**: <http://arxiv.org/abs/2604.06756v1>
- **Submitted**: 2026-04-08 07:21:18
- **Comment**: ACL2026 Main
- **Topic Keywords**: rag
- **Reason**: This paper explores the limitations of large language models (LLMs) in evaluating answer factuality, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and their limitations in evaluating reasoning quality is not directly aligned with the user's core research themes. The paper's findings on the importance of distinguishing genuine reasoning quality from superficial fluency may have implications for NLP, but it is not a central match for the user's research interests.
...
### 24. Luwen Technical Report

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yiquan Wu, Yuhang Liu, Yifei Liu, Ang Li, Siying Zhou, Kun Kuang
- **URL**: <http://arxiv.org/abs/2604.06737v1>
- **Submitted**: 2026-04-08 06:59:07
- **Comment**: 10 pages, 4 figures
- **Topic Keywords**: retrieval
- **Reason**: The paper presents a language model for the legal domain, which is somewhat related to information retrieval and NLP, but does not directly focus on query understanding, ranking models, or user behavior modeling. While it involves retrieval-augmented generation, the context is specific to the legal domain and does not align with the user's primary research interests.
...
- **URL**: <http://arxiv.org/abs/2604.06997v1>
- **Submitted**: 2026-04-08 12:14:48
- **Comment**: 24 pages, 11 figures. To appear in Findings of ACL 2026
- **Topic Keywords**: relevance, rag, retrieval, search
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval, specifically in the area of temporal retrieval and time-aware models. However, the focus on Classical Chinese annals and the specific application to historical research makes it somewhat niche and not directly aligned with your core research themes in e-commerce or general query understanding and ranking models.
...
### 26. Agent-Driven Corpus Linguistics: A Framework for Autonomous Linguistic Discovery

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Jia Yu, Weiwei Yu, Pengfei Xiao, Fukun Xing
- **URL**: <http://arxiv.org/abs/2604.07189v1>
- **Submitted**: 2026-04-08 15:14:22
- **Topic Keywords**: query, queries, search
- **Reason**: This paper focuses on corpus linguistics and the application of large language models in a specific domain, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing, the context and methodology are distinct from the user's core research interests.
...
### 27. Specializing Large Models for Oracle Bone Script Interpretation via Component-Grounded Multimodal Knowledge Augmentation

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Jianing Zhang, Runan Li, Honglin Pang, Ding Xia, Zhou Zhu, Qian Zhang, Chuntao Li, Xi Yang
- **URL**: <http://arxiv.org/abs/2604.06711v1>
- **Submitted**: 2026-04-08 06:05:54
- **Topic Keywords**: rag, retrieval, acl
- **Reason**: This paper focuses on deciphering ancient Chinese Oracle Bone Script, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves multimodal knowledge augmentation and a Vision-Language Model, the context and application are distinct from the user's areas of focus.
...
### 28. OpenSpatial: A Principled Data Engine for Empowering Spatial Intelligence
...
- **URL**: <http://arxiv.org/abs/2604.07296v2>
- **Submitted**: 2026-04-08 17:03:02
- **Comment**: Code: https://github.com/VINHYU/OpenSpatial
- **Topic Keywords**: rag, ctr, search
- **Reason**: This paper focuses on spatial intelligence and data generation, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 29. Self-Preference Bias in Rubric-Based Evaluation of Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: José Pombal, Ricardo Rei, André F. T. Martins
- **URL**: <http://arxiv.org/abs/2604.06996v1>
- **Submitted**: 2026-04-08 12:13:53
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on the evaluation of Large Language Models, specifically the self-preference bias in rubric-based evaluation. While it touches on the concept of evaluation, it doesn't directly relate to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing, especially in the context of query understanding, ranking models, and user behavior modeling.
...
### 30. Video-guided Machine Translation with Global Video Context

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jian Chen, JinZe Lv, Zi Long, XiangHua Fu
- **URL**: <http://arxiv.org/abs/2604.06789v1>
- **Submitted**: 2026-04-08 07:57:05
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on video-guided machine translation, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multimodal translation and attention mechanisms, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's research.
...
### 31. StructKV: Preserving the Structural Skeleton for Scalable Long-Context Inference

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Zhirui Chen, Peiyang Liu, Ling Shao
- **URL**: <http://arxiv.org/abs/2604.06746v1>
- **Submitted**: 2026-04-08 07:10:35
- **Comment**: Accepted to ACL 2026 Findings, 14 pages
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on optimizing the efficiency of Large Language Models for long-context inference, proposing a structure-aware Key-Value cache compression framework. While it involves some aspects of information retrieval and retrieval robustness, the primary focus is on model efficiency and scalability, which is not directly aligned with your core research interests in query understanding, ranking models, and user behavior modeling.
...
### 32. Event-Centric World Modeling with Memory-Augmented Retrieval for Embodied Decision-Making

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Fan Zhaowen
- **URL**: <http://arxiv.org/abs/2604.07392v1>
- **Submitted**: 2026-04-08 06:14:46
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on embodied decision-making in autonomous agents, using event-centric world modeling and memory-augmented retrieval. While it involves retrieval and decision-making, the context is quite different from information retrieval and search technologies, and the emphasis on physical constraints and real-time control does not align with your primary research interests.
...
- **URL**: <http://arxiv.org/abs/2604.06834v1>
- **Submitted**: 2026-04-08 08:51:47
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models, the focus is on data selection and confounding issues in reasoning tasks, which is not a central match to your core research themes.
...
- **URL**: <http://arxiv.org/abs/2604.06832v1>
- **Submitted**: 2026-04-08 08:50:08
- **Topic Keywords**: rag, recommend
- **Reason**: This paper is about vision-language models and their optimization for inference acceleration, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 35. Discourse Coherence and Response-Guided Context Rewriting for Multi-Party Dialogue Generation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Zhiyu Cao, Peifeng Li, Qiaoming Zhu
- **URL**: <http://arxiv.org/abs/2604.06784v1>
- **Submitted**: 2026-04-08 07:52:28
- **Comment**: ACL 2026 Main Conference
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on multi-party dialogue generation, which is not directly related to your core research themes in Information Retrieval and Search technologies. While it involves Natural Language Processing, the context and methodology are quite different from your areas of interest.
...
### 36. SQLStructEval: Structural Evaluation of LLM Text-to-SQL Generation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yixi Zhou, Fan Zhang, Zhiqiao Guo, Yu Chen, Haipeng Zhang, Preslav Nakov, Zhuohan Xie
- **URL**: <http://arxiv.org/abs/2604.06736v1>
- **Submitted**: 2026-04-08 06:59:04
- **Comment**: 17 pages, including figures and tables
- **Topic Keywords**: queries
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves text analysis and generation, its focus on SQL-to-text generation and structural evaluation of LLMs is outside your primary areas of interest.
...
### 37. Appear2Meaning: A Cross-Cultural Benchmark for Structured Cultural Metadata Inference from Images
...
- **URL**: <http://arxiv.org/abs/2604.07338v1>
- **Submitted**: 2026-04-08 17:53:26
- **Topic Keywords**: rag
- **Reason**: This paper focuses on a specific task of inferring structured cultural metadata from images, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves vision-language models, the application domain and task are quite different from your areas of focus.
...
### 38. Why teaching resists automation in an AI-inundated era: Human judgment, non-modular work, and the limits of delegation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Songhee Han
- **URL**: <http://arxiv.org/abs/2604.07285v1>
- **Submitted**: 2026-04-08 16:49:24
- **Topic Keywords**: retrieval
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, ranking models, and user behavior modeling. While it touches on the role of AI in supporting educational tasks, its focus is on the limits of AI in automating teaching and learning, which is outside the scope of your research interests.
...
### 39. How Much LLM Does a Self-Revising Agent Actually Need?

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sungwoo Jung, Seonil Son
- **URL**: <http://arxiv.org/abs/2604.07236v2>
- **Submitted**: 2026-04-08 16:02:04
- **Comment**: WIP
- **Topic Keywords**: rag
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and deep learning, but it focuses on the role of large language models (LLMs) in self-revising agents, which is not directly relevant to Information Retrieval (IR) or Search technologies. The paper's emphasis on world modeling, planning, and reflection also suggests a focus on Artificial Intelligence (AI) and machine learning, rather than IR or Search.
...
### 40. Continuous Interpretive Steering for Scalar Diversity

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Ye-eun Cho
- **URL**: <http://arxiv.org/abs/2604.07006v1>
- **Submitted**: 2026-04-08 12:24:30
- **Topic Keywords**: rag
- **Reason**: This paper focuses on pragmatic inference and scalar diversity in large language models, which is not directly related to your core research themes in Information Retrieval and Search technologies. While it touches on NLP, the specific area of pragmatic inference in LLMs is not a central match to your interests.
...
### 41. Do We Need Distinct Representations for Every Speech Token? Unveiling and Exploiting Redundancy in Large Speech Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Bajian Xiang, Tingwei Guo, Xuan Chen, Yang Han
- **URL**: <http://arxiv.org/abs/2604.06871v1>
- **Submitted**: 2026-04-08 09:33:44
- **Comment**: Accepted to ACL 2026 (Findings)
- **Topic Keywords**: acl
- **Reason**: This paper focuses on optimizing efficiency in Large Speech Language Models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of semantic understanding, the context is specific to speech processing and does not align with your primary focus on real-time relevance optimization in IR.
...
### 42. Cognitive Loop of Thought: Reversible Hierarchical Markov Chain for Efficient Mathematical Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jia-Chen Zhang, Zheng Zhou, Yu-Jie Xiong
- **URL**: <http://arxiv.org/abs/2604.06805v1>
- **Submitted**: 2026-04-08 08:17:38
- **Topic Keywords**: rag
- **Reason**: This paper focuses on mathematical reasoning and Chain-of-Thought frameworks for Large Language Models (LLMs), which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the context and methodology are quite different from the user's core areas of focus.
...
### 43. ATANT: An Evaluation Framework for AI Continuity

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Samuel Sameer Tanguturi
- **URL**: <http://arxiv.org/abs/2604.06710v1>
- **Submitted**: 2026-04-08 06:04:51
- **Comment**: 7 pages, 8 tables. Framework and evaluation protocol available at https://github.com/Kenotic-Labs/ATANT
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on AI continuity and memory components, which is a different area of research.
...
### 44. The Impact of Steering Large Language Models with Persona Vectors in Educational Applications

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yongchao Wu, Aron Henriksson
- **URL**: <http://arxiv.org/abs/2604.07102v1>
- **Submitted**: 2026-04-08 13:55:32
- **Topic Keywords**: personalization
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models and persona vectors, the focus is on educational applications and the impact of persona steering on answer quality and scoring, which is not a central match to your research themes.
...
### 45. Is Biomedical Specialization Still Worth It? Insights from Domain-Adaptive Language Modelling with a New French Health Corpus
...
- **URL**: <http://arxiv.org/abs/2604.06903v1>
- **Submitted**: 2026-04-08 09:59:50
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language modeling, it focuses on domain adaptation in the biomedical domain, which is not a primary area of interest for you.
...
### 46. From Perception to Autonomous Computational Modeling: A Multi-Agent Approach

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Daniel N. Wilke
- **URL**: <http://arxiv.org/abs/2604.06788v1>
- **Submitted**: 2026-04-08 07:56:34
- **Comment**: 32 pages, 8 figures, 5 tables
- **Topic Keywords**: recommend
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies. It focuses on a multi-agent approach for autonomous computational modeling in engineering, which is outside the user's primary research interests.
...
### 47. Multilingual Cognitive Impairment Detection in the Era of Foundation Models
...
- **URL**: <http://arxiv.org/abs/2604.06758v1>
- **Submitted**: 2026-04-08 07:22:43
- **Comment**: Accepted as an oral at the RAPID workshop @ LREC 2026'
- **Topic Keywords**: korea
- **Reason**: This paper is not relevant to your research interests as it focuses on cognitive impairment detection using multilingual language models, which is outside the scope of information retrieval, search technologies, and natural language processing topics you're primarily interested in.
...
### 48. TEC: A Collection of Human Trial-and-error Trajectories for Problem Solving

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Xinkai Zhang, Jingtao Zhan, Yiqun Liu, Qingyao Ai
- **URL**: <http://arxiv.org/abs/2604.06734v2>
- **Submitted**: 2026-04-08 06:57:42
- **Topic Keywords**: search
- **Reason**: This paper focuses on trial-and-error strategies in problem-solving, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it touches on AI systems, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's interests.
...
### 49. Steering the Verifiability of Multimodal AI Hallucinations

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jianhong Pang, Ruoxi Cheng, Ziyi Ye, Xingjun Ma, Zuxuan Wu, Xuanjing Huang, Yu-Gang Jiang
- **URL**: <http://arxiv.org/abs/2604.06714v1>
- **Submitted**: 2026-04-08 06:13:16
- **Topic Keywords**: search
- **Reason**: This paper focuses on AI hallucinations in multimodal large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of model behavior, it does not address query understanding, ranking models, or user behavior modeling.
