...
### 1. RSRank: Learning Relevance from Representational Shifts

- **LLM Score**: 8
- **Keyword Score**: 22
- **Authors**: Archit Gupta, Sai Sundaresan, Debabrata Mahapatra
- **URL**: <http://arxiv.org/abs/2606.17468v1>
- **Submitted**: 2026-06-16 03:29:23
- **Comment**: Under Peer Review
- **Topic Keywords**: query, queries, ranking, rerank, relevance, rag, retrieval, rank, acl
- **Reason**: This paper aligns well with your research interests in Information Retrieval, particularly in query understanding and ranking models. The focus on representational shifts as a signal for relevance is a novel approach that could be useful in deep semantic understanding and real-time relevance optimization. The paper's emphasis on reranking and relevance scoring also resonates with your background in e-commerce and NLP.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Representational‑Shift Reranker (RSRank) for Retrieval‑Augmented Generation
- **Aim**: Deliver a lightweight, calibrated pointwise reranker that replaces heuristic thresholds, reduces latency and API costs, and improves document relevance selection in enterprise RAG pipelines
- **Rationale**: Existing rerankers repurpose LM next‑token signals that are poorly calibrated for absolute relevance, leading to fixed top‑k selection, global thresholds that vary across datasets and queries, and inflated error rates. A consistent decision boundary is needed to avoid per‑query tuning and to maintain out‑of‑the‑box performance
- **Ground**: Define Representational Shift (RS) as the finite‑difference change in a query’s internal representation when a document is conditioned versus a null prefix. RS vectors capture how a document updates the query representation; a small learnable projection maps RS to calibrated relevance scores, yielding a natural threshold τ that is stable across datasets and queries
- **Experiment**: Train on frozen Qwen‑3‑8B with a 2.3 M‑parameter projection layer, optimizing a loss that directly enforces the calibrated threshold. Evaluate on six datasets (2WikiMQA, Fever, FiQA, HotpotQA, MuSiQue, NFCorpus). Results: Recall@5 +2.0 pts, F1 (natural threshold) +7.2 pts over baselines; paired t‑tests show p < 10⁻⁹⁹. Calibration analysis shows τ = 0.5 overshoots true boundary; per‑query thresholds vary markedly. Sample efficiency: 400 training samples saturate performance on 2WikiMQA
- **Takeaway**: RSRank introduces a principled, calibrated relevance signal that eliminates heuristic thresholds, achieves consistent decision boundaries, and delivers significant empirical gains with minimal overhead. It is especially valuable for enterprise RAG systems where accuracy, latency, and cost are critical. Future work includes per‑query threshold selection without retraining and further integration with downstream components
...
- **Submitted**: 2026-06-16 13:32:54
- **Comment**: 19 pages, 4 figures
- **Topic Keywords**: information retrieval, dense retrieval, query, queries, rag, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically addressing the limitations of dense retrieval and proposing a new paradigm for leveraging dense embeddings. The focus on query understanding and real-time relevance optimization aligns with your interests, and the experimental results demonstrate significant performance gains. However, the paper's primary focus is on the technical aspects of information retrieval rather than user behavior modeling or deep semantic understanding.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Non‑Negative Elastic‑Net decoding for diverse dense retrieval and tool‑bank selection
- **Aim**: Jointly select a sparse, non‑negative set of documents or tools that reconstructs the query embedding, yielding diverse top‑k lists and unique, globally optimal tool subsets
- **Rationale**: Dense bi‑encoder scoring treats each document independently, producing redundant, semantically similar top‑k results and failing on multi‑hop or API‑programming tasks.  By formulating retrieval as a sparse‑coding problem with non‑negativity and elastic‑net regularisation, the method penalises highly correlated documents and guarantees a unique, optimal solution
- **Ground**: Theoretical results show NNN strictly generalises dense retrieval (Theorem 1), can recover queries missed by dense retrieval (Proposition 2), and its strong convexity (λ₂>0) ensures a unique global minimiser with support equal to the retrieved set.  Counter‑examples demonstrate that NNN can succeed where diversity‑ranking fails, motivating sparse coding for tool selection
- **Experiment**: Implemented with FISTA and an unrolled, differentiable version for end‑to‑end fine‑tuning.  Each iteration costs O(dN) and with T iterations the total cost is O(dNT), comparable to inner‑product scoring.  GPU‑friendly and operates on pre‑computed embeddings, enabling efficient query‑time retrieval while improving diversity and tool‑bank selection performance
- **Takeaway**: NNN decoding provides a principled, theoretically sound, and computationally efficient alternative to inner‑product scoring, delivering non‑redundant, diverse retrieval sets and uniquely optimal tool selections for downstream reasoning and API‑programming tasks
...
### 3. Temporal Preference Optimization for Unsupervised Retrieval

- **LLM Score**: 8
- **Keyword Score**: 16
- **Authors**: HyunJin Kim, Jaejun Shim, Young Jin Kim, JinYeong Bak
- **URL**: <http://arxiv.org/abs/2606.17664v1>
- **Submitted**: 2026-06-16 08:27:22
- **Comment**: Accepted to ICML 2026
- **Topic Keywords**: information retrieval, retriever, queries, relevance, rag, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The focus on temporal relevance optimization is a novel aspect that aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's specific application to temporal information retrieval is somewhat narrower than your broader interests in IR and NLP.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Temporal relevance in unsupervised dense retrieval
- **Aim**: Introduce TPOUR, an unsupervised method that optimizes retrieval for temporal alignment
- **Rationale**: Unsupervised retrievers excel at semantic similarity but often retrieve temporally misaligned documents; supervised timestamp-based solutions are impractical
- **Ground**: TPOUR employs a Temporal Retrieval Preference Optimization objective and a learned continuous time‑embedding to steer retrieval toward temporally aligned documents
- **Experiment**: On the T‑IR benchmark, a TPOUR‑based Contriever model (≈72.7× smaller than Qwen‑Embedding‑8B) achieved +4.04 (+12.15 %) nDCG@5 on explicit queries and +4.98 (+15.21 %) on implicit queries, outperforming both unsupervised and supervised baselines
- **Takeaway**: TPOUR provides a lightweight, unsupervised approach that substantially improves temporal relevance in dense retrieval, offering a practical alternative to timestamp‑dependent methods
...
### 4. Compositional Skill Routing for LLM Agents: Decompose, Retrieve, and Compose

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Xueping Gao
- **URL**: <http://arxiv.org/abs/2606.18051v1>
- **Submitted**: 2026-06-16 15:27:55
- **Topic Keywords**: retriever, query, queries, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The paper's focus on compositional skill routing and task decomposition aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on LLM agents and skill routing is somewhat outside your core e-commerce domain expertise.
...
### 5. EComAgentBench: Benchmarking Shopping Agents on Long-Horizon Tasks with Distributed Hidden Intent

- **LLM Score**: 8
- **Keyword Score**: 5
- **Authors**: Zeyao Du, Tong Li, Haibo Zhang
- **URL**: <http://arxiv.org/abs/2606.17698v1>
- **Submitted**: 2026-06-16 09:10:48
- **Topic Keywords**: query, shopping, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of e-commerce and query understanding. The focus on long-horizon tasks, hidden intent, and real-time relevance optimization aligns with your interests. However, the specific application to shopping agents and LLM-based systems is somewhat niche, preventing a perfect match.
...
### 6. Understanding and Debugging Failures in N-Gram-Based Generative Retrieval

- **LLM Score**: 6
- **Keyword Score**: 9
- **Authors**: Richard Takacs, Adrian Bracher, Svitlana Vakulenko
- **URL**: <http://arxiv.org/abs/2606.17721v1>
- **Submitted**: 2026-06-16 09:35:36
- **Comment**: Work in progress
- **Topic Keywords**: information retrieval, ranking, retrieval, rank
- **Reason**: The paper explores Generative Retrieval, a paradigm related to Information Retrieval, and its failure modes. While it touches on IR, it's not primarily focused on query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's emphasis on NLP and language models makes it somewhat relevant, but not a central match.
...
- **Submitted**: 2026-06-16 09:17:46
- **Topic Keywords**: recommend
- **Reason**: This paper explores the concept of information cocoons in recommender systems, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on generative recommenders and their impact on user exposure is not directly aligned with the user's core research themes, but still relevant to the broader field of IR and NLP.
...
### 8. Beyond Parallel Sampling: Diverse Query Initialization for Agentic Search
...
- **Submitted**: 2026-06-15 18:48:11
- **Comment**: 15 pages, 8 figures; under review at EMNLP 2026
- **Topic Keywords**: query, queries, rag, retrieval, search
- **Reason**: This paper explores a novel approach to improve agentic search through diverse query initialization. While it touches on search technologies, it doesn't directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of interest. The focus on agentic search and query initialization is somewhat related to information retrieval, but it's not a central match for your research interests.
...
- **Submitted**: 2026-06-16 03:06:35
- **Comment**: To be presented at ACL 2026
- **Topic Keywords**: queries, rag, retrieval, search
- **Reason**: The paper discusses multimodal retrieval-augmented generation, which is related to search technologies and query understanding. However, the focus is on mitigating hallucinations and logical fabrications, which is not directly aligned with the user's core research themes of ranking models and user behavior modeling. The paper's relevance to information retrieval and NLP is somewhat tangential.
...
- **Submitted**: 2026-06-16 17:34:53
- **Topic Keywords**: query, queries
- **Reason**: The paper discusses an evaluation framework for personal health agents, which is somewhat related to information retrieval and search technologies. However, the focus is on clinical evaluation and healthcare access, which is not a central match to the user's primary research themes. The use of LLMs and adaptive routing is relevant to the user's interests in NLP and ranking models, but the application is specific to healthcare and not broadly applicable to search technologies.
...
### 12. On the Memorization Behavior of LLMs in Generative Recommendation: Observations, Implications, and Training Strategies
...
- **Submitted**: 2026-06-15 20:34:49
- **Topic Keywords**: user behavior, recommend
- **Reason**: This paper explores the memorization behavior of Large Language Models (LLMs) in Generative Recommendation, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on recommender systems and LLMs' memorization behavior is not a central match to your primary research themes, which include query understanding, ranking models, and user behavior modeling.
...
- **Submitted**: 2026-06-16 17:59:03
- **Topic Keywords**: rag
- **Reason**: This paper proposes a novel transformer architecture with variable-width layers, which shows promising results in language modeling tasks. Although it's related to NLP and transformer models, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 14. Beyond Domains: Reusing Web Skills via Transferable Interaction Patterns
...
- **Submitted**: 2026-06-16 08:04:35
- **Topic Keywords**: rag
- **Reason**: This paper explores web skills and transferable interaction patterns for large language model web agents, which is somewhat related to information retrieval and search technologies. However, the focus is on web skills and layout structure matching, which is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's relevance is somewhat tangential to the user's interests in information retrieval and NLP.
...
### 15. AIPatient Arena: EHR-grounded evaluation of large language models in end-to-end clinical consultation workflows
...
- **Submitted**: 2026-06-16 03:35:17
- **Comment**: 49 pages, 12 figues, 11 tables
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), particularly in the context of clinical consultation workflows and large language models. However, the focus on clinical evaluation and medical applications is not a central match to your primary interests in e-commerce and real-time relevance optimization.
...
### 16. PARSE: Provenance-Aware Retrieval Sanitization for Professional Domain LLM Agents

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Aaditya Pai
- **URL**: <http://arxiv.org/abs/2606.17467v1>
- **Submitted**: 2026-06-16 03:29:23
- **Comment**: 7 pages, 3 figures, 2 tables. Under submission at EMNLP 2026 Industry Track
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the context of defending against prompt injection attacks on Large Language Model (LLM) agents. However, the focus on domain-aware sanitization and fact preservation is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. While it touches on related topics, it does not seem to be a central match for your research themes.
...
### 17. Incumbent Advantage: Brand Bias and Cognitive Manipulation Dynamics in LLM Recommendation Systems

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Xi Chu, Yupeng Hou
- **URL**: <http://arxiv.org/abs/2606.17443v1>
- **Submitted**: 2026-06-16 02:54:34
- **Comment**: 16 pages, 4 figures, 11 tables
- **Topic Keywords**: recommend, search
- **Reason**: This paper explores the dynamics of brand competition in Large Language Model (LLM) recommendation systems, which is somewhat related to information retrieval and search technologies. However, the focus on marketing practices and brand reputation is not a central match to the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance to recommender systems is also a secondary aspect of the user's research interests.
...
### 18. Visuals Lie, Consistency Speaks: Disentangling Spatial Attention from Reliability in Vision-Language Models
...
- **Topic Keywords**: rag
- **Reason**: This paper explores the reliability of Vision-Language Models, specifically the relationship between visual attention and accuracy. While it touches on aspects of deep semantic understanding, it is primarily focused on the reliability of these models, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the paper's focus on visual grounding and generation dynamics is not directly aligned with your core research themes.
...
### 19. PromptMN: Pseudo Prompting Language

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Enkhzol Dovdon
- **URL**: <http://arxiv.org/abs/2606.17164v1>
- **Submitted**: 2026-06-15 18:04:50
- **Comment**: 32 pages, 2 figures
- **Topic Keywords**: rag
- **Reason**: This paper introduces a pseudo-prompting language, PromptMN, which aims to improve human-AI interaction by providing a structured way to annotate natural language prompts. While it touches on aspects of query understanding and user behavior modeling, its primary focus is on improving the interface between humans and generative AI, which is somewhat related to information retrieval but not directly aligned with your core research themes.
...
- **URL**: <http://arxiv.org/abs/2606.17815v1>
- **Submitted**: 2026-06-16 11:41:53
- **Topic Keywords**: ranking, rerank, retrieval, rank
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on auditing deployment-interface exposure of CLIP backdoors in the context of computer vision and adversarial attacks does not align with your areas of expertise.
...
### 21. HistoRAG: Embedding Historical Methodology in Retrieval-Augmented Generation Through Critical Technical Practice

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Noah J. Kim-Baumann, Torsten Hiltmann
- **URL**: <http://arxiv.org/abs/2606.18103v1>
- **Submitted**: 2026-06-16 16:03:37
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it does involve Retrieval-Augmented Generation (RAG), the focus is on historical methodology and epistemological commitments, which is not a central match to your core research themes.
...
### 22. Security and Privacy Prompts in the Wild: What Users Ask LLMs and How LLMs Respond

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Hobin Kim, Xiaoyuan Wu, Omer Akgul, Lujo Bauer, Nicolas Christin
- **URL**: <http://arxiv.org/abs/2606.18062v1>
- **Submitted**: 2026-06-16 15:37:25
- **Topic Keywords**: queries, rag, recommend, search
- **Reason**: This paper focuses on security and privacy prompts in the context of Large Language Models (LLMs), which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on user behavior modeling, the specific application and scope of the study are quite different from your areas of focus.
...
### 23. Decoding Hidden Deception in Reasoning LLMs: Activation Explainers for Deception Auditing

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Kexin Chen, Yi Liu, Haonan Zhang, Yanhui Li, Xinyu Deng, Dongxia Wang
- **URL**: <http://arxiv.org/abs/2606.17478v1>
- **Submitted**: 2026-06-16 03:41:29
- **Comment**: Under review
- **Topic Keywords**: query, queries
- **Reason**: This paper focuses on deception auditing in LLMs, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves LLMs and NLP, the topic is more aligned with AI safety and interpretability, which is a tangential area of interest.
...
### 24. SuCo: Sufficiency-guided Continuous Adaptive Reasoning
...
- **Submitted**: 2026-06-16 08:52:15
- **Comment**: Accepted to ICML 2026. 18 pages
- **Topic Keywords**: queries, ctr
- **Reason**: This paper appears to be related to Large Reasoning Models (LRMs) and Chain-of-Thoughts (CoT), but its focus on sufficiency-guided continuous adaptive reasoning and autonomous reasoning control is not directly aligned with your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 25. Scaling Enterprise Agent Routing: Degradation, Diagnosis, and Recovery

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Kellen Gillespie, Robyn Perry
- **URL**: <http://arxiv.org/abs/2606.17519v1>
- **Submitted**: 2026-06-16 04:55:06
- **Comment**: 10 pages (6 main + 4 appendix), 4 figures, 6 tables
- **Topic Keywords**: retrieval, acl
- **Reason**: This paper appears to be more focused on routing and scaling of Large Language Models (LLMs) in an enterprise setting, rather than information retrieval or search technologies. While it touches on retrieval accuracy, the context is not directly related to query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 26. ReproRepo: Scaling Reproducibility Audits with GitHub Repository Issues
...
- **Submitted**: 2026-06-16 17:58:05
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on reproducibility audits and leveraging GitHub issues for supervision, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves machine learning models, the context is not aligned with your interests in query understanding, ranking models, and user behavior modeling.
...
### 27. IUU+DB: Tracking Illegal, Unreported, and Unregulated Fishing, Seafood Fraud, and Labor Abuse through LLM-driven Information Extraction
...
- **Submitted**: 2026-06-16 17:16:05
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves a large language model, its application is in a specific domain (IUU+ activity tracking) and does not align with your focus on query understanding, ranking models, or user behavior modeling.
...
### 28. ProvenanceGuard: Source-Aware Factuality Verification for MCP-Based LLM Agents

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ander Alvarez, Santhiya Rajan, Samuel Mugel, Román Orús
- **URL**: <http://arxiv.org/abs/2606.18037v1>
- **Submitted**: 2026-06-16 15:10:29
- **Comment**: 20 pages, 4 figures
- **Topic Keywords**: retrieval, search
- **Reason**: This paper focuses on factuality verification for large language models (LLMs) using the Model Context Protocol (MCP), which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing and data analysis, the primary topic is not aligned with the user's core research themes.
...
### 29. LLMs Infer Cultural Context but Fail to Apply It When Responding

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yisong Miao, Jian Zhu, Vered Shwartz
- **URL**: <http://arxiv.org/abs/2606.17688v1>
- **Submitted**: 2026-06-16 08:53:24
- **Comment**: 9 pages, 7 figures, 2 tables (24 pages, 12 figures, 8 tables including references and appendices)
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on the cultural context of language generation by Large Language Models (LLMs), which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, it's more focused on cultural adaptation and language generation, which doesn't align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 30. MLLP-VRAIN UPV system for the IWSLT 2026 Simultaneous Speech Translation task
...
- **Submitted**: 2026-06-15 19:57:05
- **Comment**: IWSLT 2026 System Description
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves natural language processing and translation, the focus is on simultaneous speech translation, which is not a primary area of interest for the user. The paper's emphasis on latency analysis and quality improvement in a specific translation task does not align with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 31. Darshana Graph: A Parallel Commentary Corpus for Comparative Indian Philosophy, with Stylometric and Exploratory Graph Analyses

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Joy Bose
- **URL**: <http://arxiv.org/abs/2606.18222v1>
- **Submitted**: 2026-06-16 17:49:15
...
- **Topic Keywords**: ctr
- **Reason**: This paper appears to be primarily focused on creating a corpus for comparative Indian philosophy, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve text analysis and stylometric comparison, the context and scope are quite different from your areas of focus.
...
### 32. ConSA: Controllable Sparsity in Hybrid Attention via Learnable Allocation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yao Chen, Yinqi Yang, Junyuan Shang, Xiangzhao Hao, Simeng Zhang, Yilong Chen, Tingwen Liu, Shuohuan Wang, Dianhai Yu
- **URL**: <http://arxiv.org/abs/2606.18056v1>
- **Submitted**: 2026-06-16 15:33:49
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on controllable sparsity in hybrid attention for efficient LLM inference, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves attention mechanisms, the context is more aligned with deep learning and model optimization rather than query understanding, ranking models, or user behavior modeling.
...
### 33. When English Isn't the Best Teacher: Source Language Effects in Cross-Lingual In-Context Learning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Fred Philippy, Siwen Guo, Jacques Klein, Tegawendé F. Bissyandé
- **URL**: <http://arxiv.org/abs/2606.18033v1>
- **Submitted**: 2026-06-16 15:09:42
...
- **Topic Keywords**: acl
- **Reason**: This paper is primarily focused on cross-lingual transfer in multilingual NLP, specifically in the context of In-Context Learning (ICL), which is not a core area of interest for you. While it touches on NLP, it does not directly relate to your main research themes in Information Retrieval, query understanding, ranking models, or user behavior modeling.
...
### 34. LegalHalluLens: Typed Hallucination Auditing and Calibrated Multi-Agent Debate for Trustworthy Legal AI

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Lalit Yadav, Akshaj Gurugubelli
- **URL**: <http://arxiv.org/abs/2606.18021v1>
- **Submitted**: 2026-06-16 15:02:37
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. While it involves AI and NLP, the focus is on auditing and trustworthiness in legal AI, which is outside your primary areas of interest.
...
### 35. Reading between the Lines: Leveraging Large Language Models for Global Dementia and Depression Assessment from Clinical Interviews
...
- **URL**: <http://arxiv.org/abs/2606.18019v1>
- **Submitted**: 2026-06-16 15:01:30
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on using Large Language Models for dementia and depression assessment from clinical interviews, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context and application are distinct from the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 36. VoidPadding: Let [VOID] Handle Padding in Masked Diffusion Language Models so that [EOS] Can Focus on Semantic Termination

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Chunyu Liu, Zhengyang Fan, Kaisen Yang, Alex Lamb
- **URL**: <http://arxiv.org/abs/2606.17999v1>
- **Submitted**: 2026-06-16 14:46:53
- **Topic Keywords**: rag
- **Reason**: This paper focuses on masked diffusion language models and introduces a new padding mechanism, which is not directly related to information retrieval, query understanding, ranking models, or user behavior modeling. While it involves natural language processing, the context is specific to language model architecture and optimization, making it less relevant to the user's core research interests.
...
### 37. Fine-tuning LLMs for Passive Depression Severity Estimation from AI Mental Health Dialogue

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Olivier Tieleman, Ziyi Zhu, Ting Su, Samuel J. Bell, Thomas D. Hull, Caitlin A. Stamatis
- **URL**: <http://arxiv.org/abs/2606.17973v1>
- **Submitted**: 2026-06-16 14:28:47
- **Comment**: 12 pages, 1 figure
- **Topic Keywords**: ctr
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves text analysis and fine-tuning a language model, the focus is on mental health and symptom estimation, which is not a primary area of interest for you.
...
### 38. Learning task-specific subspaces via interventional post-training of speech foundation models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jack Cox, Jon Barker
- **URL**: <http://arxiv.org/abs/2606.17967v1>
- **Submitted**: 2026-06-16 14:18:20
- **Comment**: Accepted to Interspeech 2026; 6 pages (4 main body), 2 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech foundation models and their post-training refinement for speaker verification and keyword spotting tasks. While it involves learning representations, it is not directly related to information retrieval, search technologies, or query understanding, which are the core areas of your research interests.
...
### 39. Bridging Functional Correctness and Runtime Efficiency Gaps in LLM-Based Code Translation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Longhui Zhang, Jiahao Wang, Chenhao Hu, Bingyu Liang, Jing Li, Min Zhang
- **URL**: <http://arxiv.org/abs/2606.17683v1>
- **Submitted**: 2026-06-16 08:49:56
- **Comment**: Accepted to ICML 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on code translation and runtime efficiency, which is outside your primary areas of interest.
...
### 40. EnvRL: Learn from Environment Dynamics in Agentic Reinforcement Learning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhitong Wang, Songze Li, Hao Peng, Shuzheng Si, Yi Wang, Maosong Sun, Juanzi Li
- **URL**: <http://arxiv.org/abs/2606.17680v1>
- **Submitted**: 2026-06-16 08:48:09
- **Topic Keywords**: rag
- **Reason**: This paper focuses on reinforcement learning and its application to large language models, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves learning and optimization, the context and objectives are distinct from the user's areas of focus.
...
### 41. Evaluating Large Language Models Abilities for Addressee, Turn-change, and Next Speaker Prediction in Meetings
...
- **URL**: <http://arxiv.org/abs/2606.17542v1>
- **Submitted**: 2026-06-16 05:46:44
- **Comment**: Accepted to INTERSPEECH 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the focus is on multimodal multi-party conversations and turn-taking prediction, which is not a central match for your core research themes.
...
### 42. Zone of Proximal Policy Optimization: Teacher in Prompts, Not Gradients
...
- **URL**: <http://arxiv.org/abs/2606.18216v1>
- **Submitted**: 2026-06-16 17:46:02
- **Comment**: Project page: https://byungkwanlee.github.io/ZPPO-page/
- **Topic Keywords**: ecir
- **Reason**: This paper focuses on knowledge distillation and reinforcement learning techniques in the context of vision-language models, which is outside the core research themes of Information Retrieval and Search technologies. While it involves optimization and policy gradient methods, the application and context are not directly related to query understanding, ranking models, or user behavior modeling.
...
### 43. Analyzing and Encoding the Al-Mawrid Arabic-English Dictionary with the ISO Language Markup Framework and TEI Lex-0

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Diaa Fayed, Laurent Romary
- **URL**: <http://arxiv.org/abs/2606.18205v1>
- **Submitted**: 2026-06-16 17:35:11
...
- **Reason**: This paper is primarily focused on digitizing and encoding an Arabic-English dictionary using markup frameworks, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP and digital humanities, the specific application and methodology are not aligned with your areas of focus.
...
### 44. A Red-Team Study of Anthropic Fable 5 & Opus 4.8 Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Nicola Franco
- **URL**: <http://arxiv.org/abs/2606.18193v1>
- **Submitted**: 2026-06-16 17:23:58
- **Comment**: White paper
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on the adversarial robustness of large language models, which is outside your primary area of interest in Information Retrieval and Search technologies. Although it involves Natural Language Processing, the context is not related to query understanding, ranking models, or user behavior modeling.
...
### 45. Structural Role Injection in Handlebars-Templated LLM Prompts: Triple-Brace Interpolation, Delimiter Family, and the Limits of HTML Auto-Escaping

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Mohammadreza Rashidi
- **URL**: <http://arxiv.org/abs/2606.18120v1>
- **Submitted**: 2026-06-16 16:21:43
- **Comment**: 7 pages, 6 figures
- **Topic Keywords**: ltr
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on a specific vulnerability in a templating engine for Large Language Models, which is outside the scope of the user's research interests.
...
### 46. MambaCount: Efficient Text-guided Open-vocabulary Object Counting with Spatial Sparse State Space Duality Block

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Hao-Yuan Ma, Li Zhang, Minjie Qiang, Jie Gao
- **URL**: <http://arxiv.org/abs/2606.17650v1>
- **Submitted**: 2026-06-16 08:11:58
- **Topic Keywords**: query
- **Reason**: This paper is not relevant to your research interests as it focuses on object counting in images using a novel framework called MambaCount, which is a deep learning approach for computer vision tasks. It does not relate to information retrieval, search technologies, query understanding, ranking models, or user behavior modeling, which are your core research themes.
...
### 47. The Measurement Gap in the Automation of EU Law: Benchmarking Doctrinal Legal Reasoning under the EU AI Act

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Michèle Finck
- **URL**: <http://arxiv.org/abs/2606.18158v1>
- **Submitted**: 2026-06-16 16:57:12
- **Topic Keywords**: ctr
- **Reason**: This paper is not related to Information Retrieval, Search technologies, or any of the specific areas you mentioned, such as query understanding, ranking models, or user behavior modeling. It appears to be focused on the evaluation of legal-AI systems and the EU AI Act, which is outside your primary research interests.
...
### 48. Perceptual compensation for tonal context in self-supervised speech models

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: James Kirby, Ioana Krehan, Michele Gubian
- **URL**: <http://arxiv.org/abs/2606.17835v1>
- **Submitted**: 2026-06-16 12:03:46
- **Comment**: Accepted for publication at Interspeech 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on speech models and phonological context in self-supervised learning, which is outside your areas of expertise.
...
### 49. Non-Autoregressive Minimum Bayes' Risk Decoding for Fast Speech Recognition

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Hiroyuki Deguchi, Takatomo Kano, Katsuki Chousa, Marc Delcroix
- **URL**: <http://arxiv.org/abs/2606.17537v1>
- **Submitted**: 2026-06-16 05:28:38
- **Comment**: Accepted at Interspeech2026
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech recognition and non-autoregressive decoding, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 50. PseudoBench: Measuring How Agentic Auto-Research Fuels Pseudoscience
...
- **Submitted**: 2026-06-16 15:37:02
- **Comment**: 26 pages, 21 figures
- **Topic Keywords**: search
- **Reason**: This paper is not related to Information Retrieval, Search technologies, or other areas of interest. It focuses on the evaluation of Large Language Model agents in resisting pseudoscience, which is outside the scope of your research.
