# Daily Papers Report - 2026-02-23

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. Diagnosing LLM Reranker Behavior Under Fixed Evidence Pools

- **LLM Score**: 8
- **Keyword Score**: 14
- **Authors**: Baris Arat, Emre Sefer
- **URL**: <http://arxiv.org/abs/2602.18613v1>
- **Submitted**: 2026-02-20 21:07:32
- **Topic Keywords**: retriever, ranking, rerank, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of ranking models. The study focuses on reranking behavior and its evaluation, which aligns with your interests in Learning to Rank. The use of LLMs and their comparison with traditional methods like BM25 and MMR also resonates with your background in NLP and data mining.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Controlled diagnostic for evaluating large‑language‑model rerankers in sparse‑relevance settings
- **Aim**: Isolate ranking policy from retrieval noise and compare LLM rerankers against lexical baselines (BM25, MMR, Random) using a fixed, topically coherent evidence pool
- **Rationale**: Fixing an 8‑snippet, 600‑char evidence set per query removes upstream retrieval variance, enabling a clean, reproducible comparison of ranking behaviors across open‑source and proprietary LLMs
- **Ground**: Multi‑News dataset re‑purposed into 345 clusters, each providing 8 snippets from a single event; queries are first sentences of editorial summaries (≤400 chars); deterministic shuffling controls position bias; all rankers receive identical inputs
- **Experiment**: Rankers: BM25, MMR (λ=0.7), Random, Llama 3.1 8B, Qwen2.5 7B, GPT‑5‑mini; prompt: query + 8 docs; output: JSON ranking; budgets K=3,5; metrics: Lexical Coverage, Lexical Redundancy, Summary Recall, Semantic Redundancy, Semantic Coverage, Kendall‑τ; paired bootstrap (10 k resamples) for 95 % CI; findings: LLMs beat Random but trail BM25/MMR in coverage; redundancy varies by model (Llama less redundant at K=5, GPT more redundant); coverage gap shrinks with larger K
- **Takeaway**: Zero‑shot LLM rerankers improve over random but incur a coverage cost relative to lexical baselines and exhibit model‑specific redundancy; the controlled diagnostic offers a reproducible, metric‑rich framework for systematic evaluation and highlights open questions around prompt design, order robustness, and human validation
...
### 2. ReAttn: Improving Attention-based Re-ranking via Attention Re-weighting
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically query understanding and ranking models. The proposed method, ReAttn, addresses limitations in attention-based re-ranking methods, which is a key area of focus for you. While the paper's focus on Large Language Models is not a primary interest, the method's application to re-ranking tasks makes it a useful contribution to the field.
...
### 3. Rethinking Retrieval-Augmented Generation as a Cooperative Decision-Making Problem

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Lichang Song, Ting Long, Yi Chang
- **URL**: <http://arxiv.org/abs/2602.18734v1>
- **Submitted**: 2026-02-21 06:32:36
- **Topic Keywords**: ranking, rerank, rag, retrieval, rank
- **Reason**: This paper explores Retrieval-Augmented Generation, which is a relevant topic in Information Retrieval. The focus on cooperative decision-making and multi-agent systems is also related to query understanding and ranking models, making it somewhat aligned with your research interests. However, the specific application and context are not directly related to e-commerce or user behavior modeling.
...
### 4. Give Users the Wheel: Towards Promptable Recommendation Paradigm
...
- **Submitted**: 2026-02-21 18:41:28
- **Topic Keywords**: ranking, rerank, retrieval, recommend, rank
- **Reason**: This paper proposes a novel framework for sequential recommendation that integrates natural language prompts with collaborative signals, which aligns with your interests in Information Retrieval and Search technologies, particularly query understanding and ranking models. The paper's focus on real-time relevance optimization and deep semantic understanding also resonates with your research themes. However, the recommender systems aspect is not your primary focus, which is why we score it 8 instead of 10.
...
### 5. Learning to Reason for Multi-Step Retrieval of Personal Context in Personalized Question Answering
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of personalized question answering and query understanding. The use of reinforcement learning for adaptive retrieval-reasoning policies aligns with your focus on ranking models and user behavior modeling. However, the specific domain of question answering is somewhat different from your primary focus on e-commerce, which prevents a higher score.
...
### 6. How Retrieved Context Shapes Internal Representations in RAG
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The focus on Retrieval-Augmented Generation (RAG) and its interaction with large language models (LLMs) aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on NLP and LLMs is slightly outside your core IR domain, which is why it doesn't score a perfect 10.
...
### 7. Contradiction to Consensus: Dual Perspective, Multi Source Retrieval Based Claim Verification with Source Level Disagreement using LLM

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Md Badsha Biswas, Ozlem Uzuner
- **URL**: <http://arxiv.org/abs/2602.18693v1>
- **Submitted**: 2026-02-21 02:21:31
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper aligns with your interests in Information Retrieval, particularly in the area of query understanding and ranking models. The paper's focus on claim verification and evidence retrieval from multiple sources using LLMs is relevant to your work in search technologies and user behavior modeling. However, the paper's primary focus on fact-checking and misinformation detection is somewhat tangential to your core research themes in IR and NLP.
...
### 8. How to Train Your Deep Research Agent? Prompt, Reward, and Policy Optimization in Search-R1
...
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of deep semantic understanding and real-time relevance optimization. The study focuses on reinforcement learning for knowledge-intensive tasks, which aligns with your interests in query understanding and ranking models. However, the specific domain of 'Deep Research agents' is not directly related to e-commerce, but the techniques and findings can be applied to various search technologies.
...
### 9. CaliCausalRank: Calibrated Multi-Objective Ad Ranking with Robust Counterfactual Utility Optimization

- **LLM Score**: 6
- **Keyword Score**: 14
- **Authors**: Xikai Yang, Sebastian Sun, Yilin Li, Yue Xing, Ming Wang, Yang Wang
- **URL**: <http://arxiv.org/abs/2602.18786v1>
- **Submitted**: 2026-02-21 10:35:12
- **Topic Keywords**: ranking, click, ctr, click-through rate, cvr, conversion rate, rank
- **Reason**: The paper addresses ad ranking systems, which is related to search technologies and information retrieval. However, the focus on ad ranking and counterfactual utility optimization is somewhat specific and doesn't directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling. The connection to search technologies is indirect, but the use of techniques like Lagrangian relaxation and variance-reduced counterfactual estimators may be of interest to the user.
...
### 10. Unlocking Multimodal Document Intelligence: From Current Triumphs to Future Frontiers of Visual Document Retrieval
...
- **Reason**: The paper explores Visual Document Retrieval (VDR), which is somewhat related to the user's interests in Information Retrieval and Search technologies. While it involves multimodal embedding models and reranker models, which are relevant to query understanding and ranking models, the focus on visual documents and multimodal information is not a central match for the user's core research themes.
...
### 11. Hyper-KGGen: A Skill-Driven Knowledge Extractor for High-Quality Knowledge Hypergraph Generation
...
- **Topic Keywords**: rag
- **Reason**: The paper discusses knowledge graph generation and extraction, which is somewhat related to information retrieval, particularly in areas that require deep semantic understanding. However, the focus on knowledge hypergraphs and extraction from documents is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The connection to NLP and data mining is more relevant, but the paper's scope is narrower than the user's broader interests.
...
### 12. KNIGHT: Knowledge Graph-Driven Multiple-Choice Question Generation with Adaptive Hardness Calibration
...
- **Reason**: The paper introduces a framework for generating multiple-choice question datasets using knowledge graphs, which is related to information retrieval and natural language processing. However, the focus on question generation and assessment datasets does not directly align with the user's primary interests in query understanding, ranking models, and user behavior modeling. The connection to large language models and knowledge graphs is somewhat relevant, but the application domain is quite different from the user's e-commerce background.
...
### 13. Towards Reliable Negative Sampling for Recommendation with Implicit Feedback via In-Community Popularity

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Chen Chen, Haobo Lin, Yuanbo Xu
- **URL**: <http://arxiv.org/abs/2602.18759v1>
- **Submitted**: 2026-02-21 08:53:10
- **Comment**: 12 pages, 9 figures
- **Topic Keywords**: ranking, rag, click, recommend, rank
- **Reason**: The paper is somewhat related to the user's research interests in Information Retrieval and recommender systems, but it focuses more on recommender systems and does not directly address query understanding, ranking models, or user behavior modeling. The use of community structure and in-community popularity for negative sampling is an interesting approach, but it is not directly applicable to the user's primary focus areas.
...
### 14. Pyramid MoA: A Probabilistic Framework for Cost-Optimized Anytime Inference
...
- **Reason**: The paper discusses a probabilistic framework for cost-optimized inference in Large Language Models, which is somewhat related to information retrieval and search technologies. However, the focus is on model optimization and inference cost reduction, rather than query understanding, ranking models, or user behavior modeling. While it touches on semantic understanding, it's not directly aligned with the user's core research themes.
...
### 15. Cross-lingual Matryoshka Representation Learning across Speech and Text
...
- **Reason**: The paper explores a novel application of Matryoshka representation learning for cross-lingual speech-text retrieval, which is somewhat related to information retrieval and NLP, but does not directly address query understanding, ranking models, or user behavior modeling. The focus on modality fusion and semantic representation learning is relevant, but the specific context of under-represented languages and speech-text retrieval is not a central match for the user's research interests.
...
### 16. PolyFrame at MWE-2026 AdMIRe 2: When Words Are Not Enough: Multimodal Idiom Disambiguation

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Nina Hosseini-Kivanani
- **URL**: <http://arxiv.org/abs/2602.18652v1>
- **Submitted**: 2026-02-20 23:07:55
...
- **Reason**: The paper focuses on multimodal idiom disambiguation, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the topic is more specific to Natural Language Processing and multimodal processing, which is not a central match to your primary research interests in IR and search technologies.
...
### 17. Retrieval Augmented Enhanced Dual Co-Attention Framework for Target Aware Multimodal Bengali Hateful Meme Detection

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Raihan Tanvir, Md. Golam Rabiul Alam
- **URL**: <http://arxiv.org/abs/2602.19212v1>
- **Submitted**: 2026-02-22 14:48:25
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores a specific application of multimodal information retrieval in the context of hate speech detection, which is somewhat related to the user's interests in IR and NLP. However, the focus on low-resource languages and hate speech detection is not a central match for the user's core research themes.
...
### 18. Facet-Level Persona Control by Trait-Activated Routing with Contrastive SAE for Role-Playing LLMs

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Wenqiu Tang, Zhen Wan, Takahiro Komamizu, Ichiro Ide
- **URL**: <http://arxiv.org/abs/2602.19157v1>
- **Submitted**: 2026-02-22 12:39:02
- **Comment**: Accepted in PAKDD 2026 special session on Data Science :Foundation and Applications
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores personality control in Role-Playing Agents, which is somewhat related to user behavior modeling in search technologies. However, the focus on personality control and role-playing language models is not directly aligned with the user's core research themes in Information Retrieval and Search technologies.
...
### 19. FairFS: Addressing Deep Feature Selection Biases for Recommender System
...
- **Reason**: The paper focuses on recommender systems and feature selection, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the emphasis on recommender systems and deep learning biases is not a central match for the user's primary focus on query understanding, ranking models, and user behavior modeling.
...
### 20. DReX: An Explainable Deep Learning-based Multimodal Recommendation Framework
...
- **Reason**: The paper proposes a multimodal recommendation framework, which is somewhat related to information retrieval and search technologies. However, the focus on recommendation systems and user behavior modeling is not a central match to the user's primary research interests in query understanding, ranking models, and deep semantic understanding. The paper's emphasis on explainability and multimodal data is not directly aligned with the user's research themes.
...
### 21. Temporal-Aware Heterogeneous Graph Reasoning with Multi-View Fusion for Temporal Question Answering
...
### 22. Astra: Activation-Space Tail-Eigenvector Low-Rank Adaptation of Large Language Models

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Kainan Liu, Yong Zhang, Ning Cheng, Yun Zhu, Yanmeng Wang, Shaojun Wang, Jing Xiao
- **URL**: <http://arxiv.org/abs/2602.19111v1>
- **Submitted**: 2026-02-22 09:54:40
- **Comment**: 22 pages, 10 figures
- **Topic Keywords**: rag, rank
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding, but it primarily focuses on adapting pre-trained language models for downstream tasks, which is not directly aligned with the user's core research themes in Information Retrieval (IR) and Search technologies.
...
### 23. SHIELD: Semantic Heterogeneity Integrated Embedding for Latent Discovery in Clinical Trial Safety Signals
...
- **Topic Keywords**: ctr
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the application of semantic clustering and embeddings. However, the focus on clinical trial safety signals and MedDRA term embeddings is not directly aligned with the user's core research themes in e-commerce or real-time relevance optimization.
...
### 24. NILE: Formalizing Natural-Language Descriptions of Formal Languages
...
- **Topic Keywords**: rag
- **Reason**: This paper explores natural-language descriptions of formal languages, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on educational scenarios and formal language representations is not directly aligned with the user's primary research interests in search technologies and user behavior modeling.
...
### 25. A Three-stage Neuro-symbolic Recommendation Pipeline for Cultural Heritage Knowledge Graphs
...
- **Reason**: The paper focuses on a recommendation pipeline for cultural heritage knowledge graphs, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the emphasis on knowledge graphs and semantic filtering is not directly aligned with the user's primary focus on query understanding, ranking models, and user behavior modeling. The paper's use of neuro-symbolic approaches and knowledge-graph embeddings is somewhat tangential to the user's interests in NLP and data mining.
...
### 26. KGHaluBench: A Knowledge Graph-Based Hallucination Benchmark for Evaluating the Breadth and Depth of LLM Knowledge
...
### 27. Beyond a Single Extractor: Re-thinking HTML-to-Text Extraction for LLM Pretraining
...
- **Topic Keywords**: rag
- **Reason**: The paper is somewhat related to Information Retrieval, specifically in the context of text extraction and pre-processing for Large Language Model (LLM) pretraining. However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The focus on HTML-to-text extraction and its impact on LLM pretraining is more tangentially related to the user's broader interests in NLP and data mining.
...
### 28. TriTopic: Tri-Modal Graph-Based Topic Modeling with Iterative Refinement and Archetypes

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Roman Egger
- **URL**: <http://arxiv.org/abs/2602.19079v1>
- **Submitted**: 2026-02-22 07:29:53
- **Comment**: 11 pages, 7 figures
- **Topic Keywords**: rag
- **Reason**: The paper presents a novel topic modeling framework, TriTopic, which addresses limitations of existing methods. While it's related to Natural Language Processing (NLP) and data mining, it doesn't directly focus on query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's emphasis on topic modeling and text analysis makes it somewhat relevant to the user's broader interests in Information Retrieval and NLP.

#### Abstract
> Topic modeling extracts latent themes from large text collections, but leading approaches like BERTopic face critical limitations: stochastic instability, loss of lexical precision ("Embedding Blur"), and reliance on a single data perspective.
...
### 29. Uncovering Context Reliance in Unstructured Knowledge Editing
...
- **Submitted**: 2026-02-22 04:44:34
- **Comment**: 21 pages, 14 figures
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of editing large language models. However, the focus on unstructured knowledge editing and its application to language models is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 30. AgenticRAGTracer: A Hop-Aware Benchmark for Diagnosing Multi-Step Retrieval Reasoning in Agentic RAG

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Qijie You, Wenkai Yu, Wentao Zhang
- **URL**: <http://arxiv.org/abs/2602.19127v1>
- **Submitted**: 2026-02-22 10:55:21
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and specifically focuses on Agentic RAG, a research direction that involves multi-step retrieval reasoning. However, the paper's focus on benchmark construction and evaluation does not align with the user's primary interest in Information Retrieval, particularly in areas requiring deep semantic understanding and real-time relevance optimization.
...
### 31. QUIETT: Query-Independent Table Transformation for Robust Reasoning
...
- **Reason**: This paper focuses on table transformation for robust reasoning, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing and question answering, the primary focus is on table transformation, making it somewhat tangential to the user's core research interests.
...
### 32. SplitLight: An Exploratory Toolkit for Recommender Systems Datasets and Splits
...
- **Reason**: This paper focuses on recommender systems, which is a related topic, but it does not align with your primary research interests in Information Retrieval, particularly query understanding, ranking models, and user behavior modeling. The toolkit introduced in the paper, SplitLight, is designed for recommender systems, and the abstract does not mention any deep semantic understanding or real-time relevance optimization, which are key aspects of your research.
...
### 33. Counterfactual Understanding via Retrieval-aware Multimodal Modeling for Time-to-Event Survival Prediction
...
- **Reason**: This paper focuses on time-to-event counterfactual survival prediction, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multimodal modeling and latent subgroup retrieval, the context is medical and survival analysis, making it off-topic for the user's primary research areas.
...
### 34. VIGiA: Instructional Video Guidance via Dialogue Reasoning and Retrieval

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Diogo Glória-Silva, David Semedo, João Maglhães
- **URL**: <http://arxiv.org/abs/2602.19146v1>
- **Submitted**: 2026-02-22 12:20:28
- **Comment**: Accepted at EACL 2026 Findings
- **Topic Keywords**: queries, retrieval
- **Reason**: This paper focuses on multimodal dialogue models for instructional video guidance, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves dialogue reasoning and retrieval, the context is instructional video guidance rather than search or e-commerce, making it somewhat tangential to your research areas.
...
### 35. SAMAS: A Spectrum-Guided Multi-Agent System for Achieving Style Fidelity in Literary Translation
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves deep semantic understanding and style preservation, its focus on literary translation and multi-agent systems for style fidelity does not align with your core research themes.
...
### 36. Yor-Sarc: A gold-standard dataset for sarcasm detection in a low-resource African language

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Toheeb Aduramomi Jimoh, Tabea De Wille, Nikola S. Nikolov
- **URL**: <http://arxiv.org/abs/2602.18964v1>
- **Submitted**: 2026-02-21 22:10:18
- **Topic Keywords**: pairwise, search
- **Reason**: This paper is not relevant to your research interests as it focuses on sarcasm detection in a low-resource African language, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and cultural context are not aligned with your research themes.
...
### 37. Watermarking LLM Agent Trajectories
...
- **Submitted**: 2026-02-21 03:12:29
- **Comment**: 20 pages, 9 figures
- **Topic Keywords**: rag, web search, search
- **Reason**: This paper is not relevant to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves machine learning and software engineering, its focus on watermarking LLM agent trajectories is unrelated to your core themes of query understanding, ranking models, user behavior modeling, and real-time relevance optimization.
...
### 38. GrIT: Group Informed Transformer for Sequential Recommendation
...
- **Reason**: This paper focuses on sequential recommendation, which is somewhat related to information retrieval, but it primarily deals with recommender systems, which is not a central match to your research interests. While it involves modeling user behavior, it doesn't specifically address query understanding, ranking models, or click models, which are key areas of interest for you.
...
### 39. PuppetChat: Fostering Intimate Communication through Bidirectional Actions and Micronarratives
...
- **Topic Keywords**: rag, recommend
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval and Search technologies, as it focuses on instant messaging and dyadic communication. While it involves a recommender system, its application is in a social context rather than information retrieval. The paper's emphasis on embodied interaction and micronarratives also diverges from your primary focus on deep semantic understanding and real-time relevance optimization.
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on predicting perceived message effectiveness in a health-related domain, which is not a central match to your research themes.
...
- **Topic Keywords**: rag, personalization
- **Reason**: This paper appears to be primarily focused on the evaluation and limitations of large language model (LLM) agents, specifically agentic memory systems. While it touches on the concept of long-horizon reasoning, which may be tangentially related to query understanding and ranking models, the paper's core themes and topics do not align closely with the user's research interests in Information Retrieval and Search technologies.
...
### 42. Think$^{2}$: Grounded Metacognitive Reasoning in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Abraham Paul Elenjical, Vivek Hruday Kavuri, Vasudeva Varma
- **URL**: <http://arxiv.org/abs/2602.18806v1>
- **Submitted**: 2026-02-21 11:45:12
- **Topic Keywords**: query
- **Reason**: This paper focuses on metacognitive reasoning in Large Language Models, which is not directly related to Information Retrieval, Search technologies, or query understanding. While it does involve language models, the context is more aligned with NLP and AI systems, but the specific application and goals are quite different from the user's core research interests.
...
### 43. Altar: Structuring Sharable Experimental Data from Early Exploration to Publication

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: William Gaultier, Andrea Lodetti, Ian Coghill, David Colliaux, Maximilian Fleck, Alienor Lahlou
- **URL**: <http://arxiv.org/abs/2602.18588v1>
- **Submitted**: 2026-02-20 19:54:39
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on data management and structuring experimental data, which is not directly related to Information Retrieval, Search technologies, or Natural Language Processing. While it touches on reproducibility and traceability, it doesn't address query understanding, ranking models, or user behavior modeling, making it off-topic for your research interests.
...
- **Topic Keywords**: recommend, search
- **Reason**: This paper focuses on sequential recommendation and latent reasoning, which is somewhat related to information retrieval, but it primarily deals with recommender systems and does not align with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 45. gencat: Generative computerized adaptive testing
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves a generative model and Large Language Models, its focus on computerized adaptive testing and educational applications is outside your primary areas of interest.
...
### 46. Denotational Semantics for ODRL: Knowledge-Based Constraint Conflict Detection
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the denotational semantics of ODRL, a policy language, and its conflict detection. While it involves knowledge representation and reasoning, it is primarily concerned with the logical and semantic aspects of policy languages, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 47. Enhancing Automatic Chord Recognition via Pseudo-Labeling and Knowledge Distillation
...
- **Reason**: This paper focuses on Visual Document Retrieval, which is not a core area of interest for you. While it involves retrieval, the context is visual and not text-based, and the methods discussed are not directly related to query understanding, ranking models, or user behavior modeling.
...
### 49. SenTSR-Bench: Thinking with Injected Knowledge for Time-Series Reasoning
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on time-series diagnostic reasoning and proposes a hybrid knowledge-injection framework, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 50. TurkicNLP: An NLP Toolkit for Turkic Languages

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sherzod Hakimov
- **URL**: <http://arxiv.org/abs/2602.19174v1>
- **Submitted**: 2026-02-22 13:08:21
- **Topic Keywords**: rag
- **Reason**: This paper is primarily focused on Natural Language Processing (NLP) for the Turkic language family, which is somewhat related to the user's interests in NLP. However, it does not align with the user's core research themes in Information Retrieval, query understanding, ranking models, or user behavior modeling, making it less relevant.
