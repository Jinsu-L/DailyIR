# Daily Papers Report - 2025-12-17

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. SPARQL-LLM: Real-Time SPARQL Query Generation from Natural Language Questions
...
- **Submitted**: 2025-12-16 10:39:46
- **Comment**: 17 pages, 8 figures, 1 table. Under Review
- **Topic Keywords**: query, queries, www
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The focus on generating structured queries from natural language questions aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific application domain of SPARQL queries and knowledge graphs is somewhat outside your primary focus in e-commerce, but the underlying techniques and challenges are still relevant to your broader interests in IR and NLP.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Integration of large language models (LLMs) with knowledge graphs (KGs) and semantic technologies for bioinformatics, metabolomics, and multilingual NLP applications.
- **Aim**: To advance methods for SPARQL query generation, federated knowledge graph navigation, and multilingual semantic parsing using LLMs, reducing hallucinations and improving domain-specific performance.
- **Rationale**: Complex biological and multilingual datasets require robust semantic technologies to enable efficient data integration, querying, and analysis, particularly in federated systems and FAIR-compliant environments.
- **Ground**: Foundational tools include Bgee, UniProt, MetaboT, SPARQL Assist, and SPINACH. Key frameworks involve FAIR principles, ReAct reasoning, and systems like C-Pack (Chinese embeddings) and fine-tuned LLMs for Wikidata.
- **Experiment**: Experiments span SPARQL query generation (ARUQULA, SPARQL Assist), federated KG navigation (Bolleman et al., 2025), multilingual NLP (C-Pack), and low-hallucination semantic parsing (Silei Xu et al., 2023).
- **Takeaway**: LLMs enhance KG navigation and NLP tasks by reducing hallucinations, enabling multilingual support, and improving performance in federated systems, with applications in bioinformatics and semantic technologies.
...
### 2. From Feature Interaction to Feature Generation: A Generative Paradigm of CTR Prediction Models
...
- **Submitted**: 2025-12-16 03:17:18
- **Topic Keywords**: click, ctr, click-through rate, recommend
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically in the area of click models and CTR prediction. The proposed Supervised Feature Generation framework is a novel approach to address limitations in existing models, and its application to recommendation systems aligns with your background in e-commerce. While it's not directly focused on query understanding or ranking models, the work has implications for real-time relevance optimization.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: CTR prediction in recommendation systems with focus on non-linear activation functions and generative paradigms
- **Aim**: Reduce redundancy, mitigate dimensional collapse, and enhance embedding robustness in CTR prediction models
- **Rationale**: Existing models struggle with feature redundancy, dimensional collapse, and suboptimal embedding separability, limiting recommendation accuracy and robustness
- **Ground**: Experiments on Avazu and Criteo datasets using Pearson correlation matrices, T-SNE visualizations, and singular value spectra analysis
- **Experiment**: Comparative evaluation of activation functions (Sigmoid, Tanh, ReLU, SiLU) and paradigms (generative vs discriminative) with DCN V2, FM, and feature refinement baselines
- **Takeaway**: Generative paradigms with SiLU activation outperform discriminative models, achieving stronger embedding separability, reduced redundancy, and improved CTR prediction metrics (AUC, Logloss)
...
- **URL**: <http://arxiv.org/abs/2512.14503v1>
- **Submitted**: 2025-12-16 15:40:44
- **Topic Keywords**: rag, ctr, recommend
- **Reason**: The paper explores the application of large language models in recommender systems, which is somewhat related to information retrieval and search technologies. However, the focus is on intent reasoning and user interest mining, which is more aligned with recommender systems. While it touches on user behavior modeling, it's not a central match for the user's core research themes.
...
### 4. Neurosymbolic Inference On Foundation Models For Remote Sensing Text-to-image Retrieval With Complex Queries

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Emanuele Mezzi, Gertjan Burghouts, Maarten Kruithof
- **URL**: <http://arxiv.org/abs/2512.14102v1>
- **Submitted**: 2025-12-16 05:33:44
- **Topic Keywords**: query, queries, rag, retrieval
- **Reason**: The paper explores text-to-image retrieval in remote sensing, leveraging large vision-language models and neurosymbolic AI for reasoning. While it touches on query understanding and model interpretability, the focus is on a specific domain (remote sensing) and application (text-to-image retrieval), which is somewhat related to your interests in Information Retrieval and Search technologies, but not a central match.
...
### 5. Dynamic Context Selection for Retrieval-Augmented Generation: Mitigating Distractors and Positional Bias

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Malika Iratni, Mohand Boughanem, Taoufiq Dkaki
- **URL**: <http://arxiv.org/abs/2512.14313v1>
- **Submitted**: 2025-12-16 11:30:40
- **Topic Keywords**: query, rag, retrieval augmented generation, retrieval
- **Reason**: The paper explores Retrieval-Augmented Generation, which is related to Information Retrieval and Search technologies. However, the focus is on NLP and generation, rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's relevance is somewhat tangential to the user's primary research themes.
...
### 6. From Context to EDUs: Faithful and Structured Context Compression via Elementary Discourse Unit Decomposition
...
- **Submitted**: 2025-12-16 09:52:58
- **Topic Keywords**: query, ranking, rank, search
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the context of Large Language Models and context compression. However, its focus on structural relation trees and Elementary Discourse Units is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 7. Pairwise Comparison for Bias Identification and Quantification

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Fabian Haak, Philipp Schaer
- **URL**: <http://arxiv.org/abs/2512.14565v1>
- **Submitted**: 2025-12-16 16:36:55
- **Topic Keywords**: pairwise, rag
- **Reason**: The paper focuses on bias identification and quantification in online news and social media, leveraging pairwise comparison for annotation. While it touches on natural language processing and large language models, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 8. Intent-Guided Reasoning for Sequential Recommendation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Yifan Shao, Peilin Zhou
- **URL**: <http://arxiv.org/abs/2512.14034v1>
- **Submitted**: 2025-12-16 03:00:32
- **Comment**: Under Review
- **Topic Keywords**: rag, click, recommend
- **Reason**: The paper explores sequential recommendation systems, which is somewhat related to information retrieval, but the focus is on recommender systems rather than search technologies. The use of intent-guided reasoning and latent intent distillation is an interesting approach, but it doesn't directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 9. A Comparative Analysis of Retrieval-Augmented Generation Techniques for Bengali Standard-to-Dialect Machine Translation Using LLMs

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: K. M. Jubair Sami, Dipto Sumit, Ariyan Hossain, Farig Sadeque
- **URL**: <http://arxiv.org/abs/2512.14179v1>
- **Submitted**: 2025-12-16 08:18:18
...
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and Machine Translation, but it does not directly align with the user's primary focus on Information Retrieval (IR), especially in areas requiring deep semantic understanding and real-time relevance optimization. The paper's focus on Bengali language and dialect translation is also not a central match to the user's interests in e-commerce or general IR applications.
...
### 10. Let's (not) just put things in Context: Test-Time Training for Long-Context LLMs
...
- **Submitted**: 2025-12-15 21:01:37
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, as it deals with Long-Context LLMs and inference-time strategies. However, the focus on LLMs and their limitations in handling long contexts is not directly aligned with your primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 11. TiME: Tiny Monolingual Encoders for Efficient NLP Pipelines

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: David Schulmeister, Valentin Hartmann, Lars Klein, Robert West
- **URL**: <http://arxiv.org/abs/2512.14645v1>
- **Submitted**: 2025-12-16 18:02:58
- **Topic Keywords**: search
- **Reason**: This paper focuses on efficient NLP pipelines and training small models using modern techniques like distillation. While it touches on NLP and model efficiency, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 12. What Affects the Effective Depth of Large Language Models?

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Yi Hu, Cai Zhou, Muhan Zhang
- **URL**: <http://arxiv.org/abs/2512.14064v1>
- **Submitted**: 2025-12-16 04:07:17
- **Topic Keywords**: search
- **Reason**: This paper explores the concept of 'effective depth' in large language models, which is somewhat related to our interests in Information Retrieval and Search technologies. However, the focus on language models and their scaling is not directly aligned with our core research themes, and the paper's findings on layer utilization and pruning do not directly relate to query understanding, ranking models, or user behavior modeling.
...
### 13. BiCoRec: Bias-Mitigated Context-Aware Sequential Recommendation Model

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Mufhumudzi Muthivhi, Terence L van Zyl, Hairong Wang
- **URL**: <http://arxiv.org/abs/2512.13848v1>
- **Submitted**: 2025-12-15 19:34:23
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: This paper focuses on sequential recommendation models, which is somewhat related to information retrieval, but it primarily deals with recommender systems, a secondary interest of yours. The paper's emphasis on mitigating popularity bias and improving niche item recommendations does not directly align with your core research themes in query understanding, ranking models, and user behavior modeling.
...
### 14. Hierarchical Multi-agent Large Language Model Reasoning for Autonomous Functional Materials Discovery
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on materials discovery and scientific reasoning, which is outside your primary areas of interest.
...
- **Submitted**: 2025-12-16 18:59:58
- **Comment**: Project Page: https://timelens-arc-lab.github.io/
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper focuses on video temporal grounding with multimodal large language models, which is outside the user's primary research interests in information retrieval and search technologies. While it involves NLP, the specific application and methodology are not directly related to the user's core themes.
...
### 16. DTRec: Learning Dynamic Reasoning Trajectories for Sequential Recommendation

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Yifan Shao, Peilin Zhou, Shoujin Wang, Weizhi Zhang, Xu Cai, Sunghun Kim
- **URL**: <http://arxiv.org/abs/2512.14036v1>
- **Submitted**: 2025-12-16 03:04:43
- **Comment**: Under Review
- **Topic Keywords**: user behavior, recommend, trec
- **Reason**: This paper focuses on sequential recommendation and introduces a novel framework called DTRec. While it involves reasoning and sequential decision-making, it is primarily concerned with recommender systems rather than information retrieval or search technologies. The paper's emphasis on sequential recommendation and user behavior modeling is somewhat related to your interests, but it does not directly align with your core research themes.
...
### 17. PushGen: Push Notifications Generation with LLM
...
- **URL**: <http://arxiv.org/abs/2512.14490v1>
- **Submitted**: 2025-12-16 15:23:28
- **Comment**: Accepted by WSDM 2026
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on push notifications generation using LLMs, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves LLMs, the context is limited to a specific application and does not explore query understanding, ranking models, or user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2512.14047v1>
- **Submitted**: 2025-12-16 03:29:11
- **Topic Keywords**: user behavior, recommend
- **Reason**: This paper focuses on sequential recommendation, which is somewhat related to information retrieval, but it primarily deals with recommender systems, which is not a central match to your research interests. The paper's emphasis on robustness and self-supervised learning is also not directly aligned with your focus on query understanding, ranking models, and user behavior modeling.
...
### 19. EvoLattice: Persistent Internal-Population Evolution through Multi-Alternative Quality-Diversity Graph Representations for LLM-Guided Program Discovery

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Kamer Ali Yuksel
- **URL**: <http://arxiv.org/abs/2512.13857v2>
- **Submitted**: 2025-12-15 19:43:06
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be primarily focused on Large Language Model (LLM) guided program discovery and evolution, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it touches upon combinatorial search spaces and optimization, the context and application are distinct from the user's areas of focus.
...
### 20. Incentives or Ontology? A Structural Rebuttal to OpenAI's Hallucination Thesis

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Richard Ackermann, Simeon Emanuilov
- **URL**: <http://arxiv.org/abs/2512.14801v1>
- **Submitted**: 2025-12-16 17:39:45
- **Comment**: 17 pages, references to prior work arXiv:2509.16297 and arXiv:2511.06073
- **Topic Keywords**: acl
- **Reason**: This paper is primarily focused on the structural properties of transformer models and their tendency to hallucinate, which is a topic in Natural Language Processing (NLP). While it touches on the concept of optimization and incentives, it does not directly relate to Information Retrieval (IR) or Search technologies, which are the user's core research interests.
...
### 21. JMMMU-Pro: Image-based Japanese Multi-discipline Multimodal Understanding Benchmark via Vibe Benchmark Construction

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Atsuyuki Miyai, Shota Onohara, Jeonghun Baek, Kiyoharu Aizawa
- **URL**: <http://arxiv.org/abs/2512.14620v1>
- **Submitted**: 2025-12-16 17:33:00
- **Comment**: Project page: https://mmmu-japanese-benchmark.github.io/JMMMU_Pro/
- **Topic Keywords**: rag
- **Reason**: This paper focuses on image-based multimodal understanding in the Japanese language, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves visual perception and text understanding, the context is specific to image-based question answering in Japanese, making it less relevant to the user's broader interests.
...
### 22. VLegal-Bench: Cognitively Grounded Benchmark for Vietnamese Legal Reasoning of Large Language Models
...
- **URL**: <http://arxiv.org/abs/2512.14554v2>
- **Submitted**: 2025-12-16 16:28:32
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on evaluating large language models in the legal domain for Vietnamese legislation, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of query understanding and ranking models, the context is specific to the legal domain and does not align with the user's broader interests in e-commerce, deep semantic understanding, and real-time relevance optimization.
...
### 23. C-ing Clearly: Enhanced Binary Code Explanations using C code

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Teodor Poncu, Ioana Pintilie, Marius Dragoi, Dragos Tantaru, Florin Brad
- **URL**: <http://arxiv.org/abs/2512.14500v1>
- **Submitted**: 2025-12-16 15:36:29
- **Comment**: 18 pages, 5 figures
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on improving Large Language Models' understanding of assembly code through a synthetic data generation method. While it involves NLP and deep learning, it does not align with the user's primary research interests in Information Retrieval, Search technologies, and query understanding, nor does it relate to the e-commerce domain.
...
### 24. Ladder Up, Memory Down: Low-Cost Fine-Tuning With Side Nets

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Estelle Zheng, Nathan Cerisara, Sébastien Warichet, Emmanuel Helbert, Christophe Cerisara
- **URL**: <http://arxiv.org/abs/2512.14237v1>
- **Submitted**: 2025-12-16 09:47:34
- **Topic Keywords**: rag
- **Reason**: This paper focuses on parameter-efficient fine-tuning of large language models, which is a topic related to NLP. However, it does not directly address any of the user's core research themes in Information Retrieval, query understanding, ranking models, or user behavior modeling.
...
### 25. Astraea: A State-Aware Scheduling Engine for LLM-Powered Agents
...
- **Submitted**: 2025-12-16 06:55:10
- **Comment**: 12 pages, 8 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on optimizing the execution of Large Language Models (LLMs) using a state-aware scheduling engine, which is not directly related to information retrieval, search technologies, or query understanding. While it involves deep learning models, the context is more aligned with model deployment and optimization rather than semantic understanding or real-time relevance optimization.
...
### 26. Multilingual and Continuous Backchannel Prediction: A Cross-lingual Study

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Koji Inoue, Mikey Elmers, Yahui Fu, Zi Haur Pang, Taiga Mori, Divesh Lala, Keiko Ochi, Tatsuya Kawahara
- **URL**: <http://arxiv.org/abs/2512.14085v1>
- **Submitted**: 2025-12-16 04:50:22
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on cross-lingual backchannel prediction, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves deep learning and real-time processing, the context is dialogue systems rather than search or e-commerce.
...
### 27. Scalable Frameworks for Real-World Audio-Visual Speech Recognition

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sungnyun Kim
- **URL**: <http://arxiv.org/abs/2512.14083v1>
- **Submitted**: 2025-12-16 04:50:13
- **Comment**: PhD Dissertation
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Audio-Visual Speech Recognition, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on scalability and robustness, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's interests.
...
### 28. Efficient-DLM: From Autoregressive to Diffusion Language Models, and Beyond in Speed
...
- **Submitted**: 2025-12-16 04:12:17
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving the efficiency of language models, specifically diffusion language models, through a novel conversion method from autoregressive to diffusion models. While it touches on the topic of model efficiency, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 29. Spoken DialogSum: An Emotion-Rich Conversational Dataset for Spoken Dialogue Summarization
...
- **Submitted**: 2025-12-16 18:54:20
- **Comment**: 12 pages, 2 figures
- **Topic Keywords**: search
- **Reason**: This paper focuses on spoken dialogue summarization and emotion-aware conversational datasets, which is somewhat related to information retrieval, but not directly aligned with your core research themes in query understanding, ranking models, and user behavior modeling.
...
### 30. Low-Resource, High-Impact: Building Corpora for Inclusive Language Technologies
...
- **Submitted**: 2025-12-16 16:44:17
- **Comment**: Tutorial is accepted to LREC2026
- **Topic Keywords**: search
- **Reason**: This paper appears to be primarily focused on NLP and corpus building for low-resource languages, which is somewhat related to the user's interests in NLP and data mining. However, it does not align with the user's core research themes in Information Retrieval, query understanding, and ranking models.
...
### 31. Agreement Between Large Language Models and Human Raters in Essay Scoring: A Research Synthesis

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Hongli Li, Che Han Chen, Kevin Fan, Chiho Young-Johnson, Soyoung Lim, Yali Feng
- **URL**: <http://arxiv.org/abs/2512.14561v1>
- **Submitted**: 2025-12-16 16:33:07
- **Comment**: This manuscript is under review as a book chapter
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on their agreement with human raters in essay scoring, which is not a core area of your research.
...
### 32. VersatileFFN: Achieving Parameter Efficiency in LLMs via Adaptive Wide-and-Deep Reuse
...
- **Submitted**: 2025-12-16 16:08:23
- **Topic Keywords**: search
- **Reason**: This paper focuses on parameter-efficient approaches for Large Language Models (LLMs), which is a topic related to NLP but not directly aligned with your core research interests in Information Retrieval and Search technologies. While it touches on the efficiency of models, it does not address query understanding, ranking models, or user behavior modeling, making it somewhat off-topic for your research.
...
### 33. Effect of Document Packing on the Latent Multi-Hop Reasoning Capabilities of Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Gabriele Prato, Shagun Sodhani, Alessandro Sordoni, Sarath Chandar
- **URL**: <http://arxiv.org/abs/2512.14427v1>
- **Submitted**: 2025-12-16 14:16:23
- **Topic Keywords**: search
- **Reason**: This paper focuses on the training dynamics of Large Language Models, specifically the effect of document packing on their multi-hop reasoning capabilities. While it touches on model performance, it does not directly relate to query understanding, ranking models, or user behavior modeling in the context of Information Retrieval, which are core areas of your research interests.
...
### 34. Grammar Search for Multi-Agent Systems
...
- **Submitted**: 2025-12-16 04:37:07
- **Topic Keywords**: search
- **Reason**: This paper appears to be primarily focused on Multi-Agent Systems and search in the context of agentic AI research, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it mentions LLMs, the application is different and the paper does not seem to address query understanding, ranking models, or user behavior modeling.
...
### 35. FiNERweb: Datasets and Artifacts for Scalable Multilingual Named Entity Recognition

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jonas Golde, Patrick Haller, Alan Akbik
- **URL**: <http://arxiv.org/abs/2512.13884v1>
- **Submitted**: 2025-12-15 20:36:39
- **Topic Keywords**: search
- **Reason**: This paper is about multilingual named entity recognition, which is a topic in Natural Language Processing (NLP), but it doesn't seem to have any direct connection to Information Retrieval (IR), Search technologies, or query understanding, which are the core areas of your research interests.
...
### 36. Two CFG Nahuatl for automatic corpora expansion
...
- **Submitted**: 2025-12-16 09:49:31
- **Comment**: 15 pages, 5 figures, 8 tables
- **Topic Keywords**: relevance
- **Reason**: This paper focuses on developing Context-Free Grammars for the Nahuatl language to expand its corpora, which is unrelated to Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing in the context of e-commerce or real-time relevance optimization.
