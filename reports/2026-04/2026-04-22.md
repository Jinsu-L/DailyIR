...
### 1. Dual-View Training for Instruction-Following Information Retrieval

- **LLM Score**: 9
- **Keyword Score**: 14
- **Authors**: Qingcheng Zeng, Puxuan Yu, Aman Mehta, Fuheng Zhao, Rajhans Samdani
- **URL**: <http://arxiv.org/abs/2604.18845v1>
- **Submitted**: 2026-04-20 21:10:29
- **Topic Keywords**: information retrieval, retriever, query, relevance, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The proposed dual-view training strategy for instruction-following information retrieval aligns with your focus on deep semantic understanding and real-time relevance optimization. The paper's use of large language models (LLMs) and its evaluation on a specific benchmark also resonate with your background in e-commerce and NLP.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Dual-View Training for Instruction-Following Information Retrieval
- **Aim**: Develop a dense retriever that is instruction-sensitive (high p-MRR) while preserving strong overall retrieval performance (high Score/nDCG).
- **Rationale**: Dense retrievers optimized for semantic relevance tend to ignore user-specified constraints; prior instruction-negative methods only partially address this, and each negative implicitly defines a complementary instruction. A method that explicitly trains on complementary instruction pairs is needed to force instruction-aware representations.
- **Ground**: Prior work (Weller et al., 2025a,b) showed reliance on superficial query-document similarity and limited mitigation by instruction-negatives. Datasets include Promptriever instruct samples (480k), synthetic Dual‑View (DV) samples (240k), and mixed instruct/non‑instruct sets (880k). Backbones used are gte‑multilingual‑mlm‑base (305M) and bge‑m3‑retromae. Training uses Arctic‑Embed, InfoNCE loss, 30 hard negatives per query, concatenated query+instruction encoding.
- **Experiment**: Dual‑View Contrastive Learning: For each query, pair a positive document under the original instruction and an instruction‑negative document. Generate a complementary instruction via Qwen3‑Next‑80B‑A3B‑Instruct that swaps relevance labels. Train on both views simultaneously, penalizing similarity to both pairs via InfoNCE. Data synthesis pipeline replaces half the training set with DV samples. Evaluation on FollowIR, InfoSearch, MAIR, IFEval, InstructIR benchmarks shows significant gains in instruction sensitivity (p‑MRR up to +45 %) with modest impact on overall retrieval quality.
- **Takeaway**: Polarity‑reversal dual‑view contrastive learning eliminates instruction‑agnostic representations, yielding a retriever that is highly instruction-sensitive and broadly effective across standard retrieval benchmarks, without extra annotation or architectural changes.
...
### 2. Semantic Needles in Document Haystacks: Sensitivity Testing of LLM-as-a-Judge Similarity Scoring

- **LLM Score**: 9
- **Keyword Score**: 3
- **Authors**: Sinan G. Aksoy, Alexandra A. Sabrio, Erik VonKaenel, Lee Burke
- **URL**: <http://arxiv.org/abs/2604.18835v1>
- **Submitted**: 2026-04-20 20:59:25
- **Comment**: 15 pages, 8 figures
- **Topic Keywords**: pairwise
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The study focuses on the sensitivity of Large Language Models (LLMs) to semantic changes in document comparison, which aligns with your interests in deep semantic understanding and real-time relevance optimization.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Scalable, Factorial Needle-in-a-Haystack Framework for Auditing LLM Semantic‑Similarity Judgments
- **Aim**: Automate a factorial pipeline to probe LLM sensitivity to single‑sentence perturbations across context, position, length, and model, enabling fine‑grained audit of semantic similarity judgments.
- **Rationale**: LLM‑as‑judge systems are increasingly used in safety‑critical domains; subtle semantic changes can lead to biased or unsafe outcomes. A systematic, reproducible framework is needed to uncover positional, contextual, and model‑specific biases.
- **Ground**: Using a large Wikipedia corpus (453k articles → 40k documents), five commercial LLMs, and four needle perturbations (none, negation, conjunction swap, named‑entity replacement), with two hay contexts (original vs random) and 75 position pairs, the study evaluates 3,000 settings, scoring similarity on a 0–100 scale until convergence.
- **Experiment**: The automated pipeline selects documents, inserts needles, places hay, queries each LLM with a similarity prompt, aggregates scores, and computes metrics: positionality bias, document‑length effect, bipolarization index, and fingerprint distributions. Statistical tests (Kolmogorov–Smirnov, Earth‑Mover‑Distance) confirm biases and hierarchies.
- **Takeaway**: LLMs exhibit strong early‑positional bias, context‑dependent polarization, and distinct fingerprints, with a consistent hierarchy of perturbation severity (negation > named‑entity > conjunction). The factorial framework provides a scalable, LLM‑agnostic tool for auditing and mitigating biases in semantic similarity judgments.
...
- **URL**: <http://arxiv.org/abs/2604.19664v1>
- **Submitted**: 2026-04-21 16:48:55
- **Topic Keywords**: dense retrieval, queries, ranking, ctr, retrieval, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding, ranking models, and user behavior modeling. The focus on semantic product search, dense retrieval, and hierarchical semantics aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific domain of electronic components is somewhat niche compared to your broader interests in e-commerce and NLP.
...
- **URL**: <http://arxiv.org/abs/2604.19550v1>
- **Submitted**: 2026-04-21 15:06:59
- **Topic Keywords**: rag, click, ctr, click-through rate, acl
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, specifically click-through rate prediction and ranking models. The proposed LoopCTR model and its architecture are closely related to your interests in deep semantic understanding and real-time relevance optimization. However, the focus on click-through rate prediction is slightly narrower than your broader interests in IR and NLP.
...
### 5. Personalized Benchmarking: Evaluating LLMs by Individual Preferences

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Cristina Garbacea, Heran Wang, Chenhao Tan
- **URL**: <http://arxiv.org/abs/2604.18943v1>
- **Submitted**: 2026-04-21 00:40:47
- **Comment**: Accepted to Findings of ACL 2026
- **Topic Keywords**: query, ranking, rag, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The focus on personalized benchmarks and individual user preferences aligns with your interests in user behavior modeling and deep semantic understanding. However, the specific application to large language models (LLMs) and chatbots is a slight departure from your primary focus on e-commerce and real-time relevance optimization.
...
### 6. An Answer is just the Start: Related Insight Generation for Open-Ended Document-Grounded QA

- **LLM Score**: 8
- **Keyword Score**: 3
- **Authors**: Saransh Sharma, Pritika Ramu, Aparna Garimella, Koyel Mukherjee
- **URL**: <http://arxiv.org/abs/2604.19685v1>
- **Submitted**: 2026-04-21 17:07:53
- **Comment**: Paper accepted at ACL Findings 2026
- **Topic Keywords**: retrieval, search
- **Reason**: This paper aligns with your interests in Information Retrieval, particularly in query understanding and ranking models, as it focuses on generating related insights to improve and extend initial answers to open-ended questions. The use of clustering and neighborhood selection from a thematic graph is also relevant to your interests in user behavior modeling and click models. However, the primary focus on Natural Language Processing and question answering might not be a central match to your core research themes.
...
- **URL**: <http://arxiv.org/abs/2604.19566v1>
- **Submitted**: 2026-04-21 15:19:03
- **Topic Keywords**: query, queries, ranking, pairwise, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. Although it focuses on biomedical and clinical retrieval, the proposed framework Diagnosable ColBERT, which aligns ColBERT token embeddings to a reference latent space, shares some similarities with your interests in deep semantic understanding and real-time relevance optimization. However, the specific domain and application of the paper are not directly aligned with your e-commerce background.
...
### 8. RARE: Redundancy-Aware Retrieval Evaluation Framework for High-Similarity Corpora

- **LLM Score**: 7
- **Keyword Score**: 8
- **Authors**: Hanjun Cho, Jay-Yoon Lee
- **URL**: <http://arxiv.org/abs/2604.19047v1>
- **Submitted**: 2026-04-21 03:54:09
- **Comment**: Accepted to ACL 2026 (Main Conference)
- **Topic Keywords**: retriever, rag, retrieval, rank
- **Reason**: This paper presents a framework for evaluating retrieval systems in high-similarity corpora, which is relevant to information retrieval and query understanding. Although it focuses on retrieval-augmented generation systems, it touches on the importance of real-time relevance optimization and deep semantic understanding, aligning with your interests. However, the paper's primary focus is on evaluation frameworks rather than ranking models or user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2604.18944v1>
- **Submitted**: 2026-04-21 00:46:48
- **Topic Keywords**: ctr, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. Although it focuses on Named Entity Recognition (NER) and Natural Language Processing (NLP), the study's emphasis on information density and its impact on model performance shares some commonalities with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on NLP and NER limits its direct relevance to your core research themes.
...
### 10. Enhancing Unsupervised Keyword Extraction in Academic Papers through Integrating Highlights with Abstract

- **LLM Score**: 6
- **Keyword Score**: 8
- **Authors**: Yi Xiang, Chengzhi Zhang
- **URL**: <http://arxiv.org/abs/2604.19505v1>
- **Submitted**: 2026-04-21 14:22:21
- **Comment**: Scientometrics
- **Topic Keywords**: information retrieval, rag, retrieval, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the area of keyword extraction. However, it focuses on academic papers and does not directly address query understanding, ranking models, or user behavior modeling, which are your core research themes.
...
### 11. SCURank: Ranking Multiple Candidate Summaries with Summary Content Units for Enhanced Summarization

- **LLM Score**: 6
- **Keyword Score**: 6
- **Authors**: Bo-Jyun Wang, Ying-Jia Lin, Hung-Yu Kao
- **URL**: <http://arxiv.org/abs/2604.19185v1>
- **Submitted**: 2026-04-21 07:51:05
- **Comment**: Accepted by ACL 2026 Findings
- **Topic Keywords**: ranking, rag, rank
- **Reason**: The paper SCURank is somewhat related to the user's interests in Information Retrieval, particularly in the area of ranking models. However, it focuses on summarization and summarization ranking, which is a related but distinct area. The use of deep semantic understanding and ranking is relevant, but the primary focus on summarization limits its alignment with the user's core research themes.
...
### 12. GraphRAG-IRL: Personalized Recommendation with Graph-Grounded Inverse Reinforcement Learning and LLM Re-ranking

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Siqi Liang, Xiawei Wang, Yudi Zhang, Jiaying Zhou
- **URL**: <http://arxiv.org/abs/2604.19128v1>
- **Submitted**: 2026-04-21 06:22:29
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: The paper focuses on personalized recommendation using graph-grounded inverse reinforcement learning and LLM re-ranking, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The use of LLMs and graph-based methods is relevant to NLP and data mining, but the primary focus on recommender systems limits its relevance to the user's core research themes.
...
### 13. CS3: Efficient Online Capability Synergy for Two-Tower Recommendation

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Lixiang Wang, Shaoyun Shi, Peng Wang, Wenjin Wu, Peng Jiang
- **URL**: <http://arxiv.org/abs/2604.19269v1>
- **Submitted**: 2026-04-21 09:35:30
- **Topic Keywords**: retriever, retrieval, recommend
- **Reason**: The paper focuses on recommender systems, specifically improving two-tower models, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the primary focus on recommender systems and the lack of emphasis on query understanding, ranking models, and user behavior modeling limit its relevance. The paper's contribution to real-time relevance optimization is also a positive aspect, but it does not strongly align with the user's core research themes.
...
### 14. LePREC: Reasoning as Classification over Structured Factors for Assessing Relevance of Legal Issues
...
- **URL**: <http://arxiv.org/abs/2604.19464v1>
- **Submitted**: 2026-04-21 13:42:24
- **Comment**: Accepted by ACL 2026 Main Conference
- **Topic Keywords**: relevance, rag
- **Reason**: This paper explores the application of reasoning and classification techniques in the legal domain, leveraging Large Language Models (LLMs) and structured statistical reasoning. While it touches on aspects of query understanding and ranking models, its primary focus is on legal issue identification and relevance assessment, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the paper's specific context and domain expertise required for legal issue identification and relevance assessment are not directly aligned with the user's core research themes.
...
- **Reason**: The paper explores domain adaptation and specialization of language models, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the focus on medical domain and model specialization is not directly aligned with your core research themes, and the paper's emphasis on model merging and fine-tuning is more specific to NLP and not directly applicable to your IR and search technology expertise.
...
### 16. Think Before Writing: Feature-Level Multi-Objective Optimization for Generative Citation Visibility

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Zikang Liu, Peilan Xu
- **URL**: <http://arxiv.org/abs/2604.19113v1>
- **Submitted**: 2026-04-21 05:47:04
- **Comment**: 14 pages, 5 figures
- **Topic Keywords**: retrieval, rank, search
- **Reason**: This paper explores generative answer engines and citation visibility optimization, which is somewhat related to information retrieval and search technologies. However, the focus on citation visibility and generative engines is not a central match to the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 17. Prioritizing the Best: Incentivizing Reliable Multimodal Reasoning by Rewarding Beyond Answer Correctness

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Mengzhao Jia, Zhihan Zhang, Meng Jiang
- **URL**: <http://arxiv.org/abs/2604.18892v1>
- **Submitted**: 2026-04-20 22:28:07
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of multimodal reasoning and trajectory supervision. However, the focus on multimodal reasoning and reinforcement learning is not directly aligned with your core research themes in query understanding, ranking models, and user behavior modeling. The paper's emphasis on real-time relevance optimization is also not explicitly mentioned.
...
### 18. Scripts Through Time: A Survey of the Evolving Role of Transliteration in NLP

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Thanmay Jayakumar, Deepon Halder, Raj Dabre
- **URL**: <http://arxiv.org/abs/2604.18722v1>
- **Submitted**: 2026-04-20 18:20:35
- **Comment**: 9 pages, ACL 2026 (Findings)
- **Topic Keywords**: rag, recommend, search
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and cross-lingual transfer, but it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of focus for the user. The paper's focus on transliteration and its applications in NLP is relevant, but it does not align with the user's primary research themes.
...
### 19. Micro Language Models Enable Instant Responses

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Wen Cheng, Tuochao Chen, Karim Helwani, Sriram Srinivasan, Luke Zettlemoyer, Shyamnath Gollakota
- **URL**: <http://arxiv.org/abs/2604.19642v1>
- **Submitted**: 2026-04-21 16:31:12
- **Topic Keywords**: ltr
- **Reason**: This paper introduces micro language models for instant responses on edge devices, which is somewhat related to information retrieval and search technologies. However, the focus on language models and on-device processing is more aligned with NLP and related topics. While the paper touches on real-time relevance optimization, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 20. Do LLMs Game Formalization? Evaluating Faithfulness in Logical Reasoning

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Kyuhee Kim, Auguste Poiroux, Antoine Bosselut
- **URL**: <http://arxiv.org/abs/2604.19459v1>
- **Submitted**: 2026-04-21 13:37:49
...
- **Reason**: This paper explores the faithfulness of Large Language Models (LLMs) in logical reasoning, which is related to query understanding and ranking models in Information Retrieval. However, the focus on formal verification and logical reasoning is somewhat tangential to the user's primary interests in IR and NLP, and the paper's relevance to user's research is limited.
...
### 21. Lost in Translation: Do LVLM Judges Generalize Across Languages?
...
- **URL**: <http://arxiv.org/abs/2604.19405v1>
- **Submitted**: 2026-04-21 12:29:10
- **Comment**: Accepted at ACL 2026 Findings
- **Topic Keywords**: pairwise
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it deals with the evaluation of vision-language models. However, its focus on multilingual and multimodal evaluation, while relevant to the broader field of IR, does not directly align with the user's primary interests in query understanding, ranking models, and user behavior modeling.
...
### 22. Location Not Found: Exposing Implicit Local and Global Biases in Multilingual LLMs
...
- **URL**: <http://arxiv.org/abs/2604.19292v1>
- **Submitted**: 2026-04-21 09:57:41
- **Comment**: ACL 2026 main conference
- **Topic Keywords**: query
- **Reason**: This paper explores biases in multilingual language models, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the focus on biases and locale-dependent facts is not directly aligned with your primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 23. Proposing Topic Models and Evaluation Frameworks for Analyzing Associations with External Outcomes: An Application to Leadership Analysis Using Large-Scale Corporate Review Data
...
- **URL**: <http://arxiv.org/abs/2604.18919v1>
- **Submitted**: 2026-04-20 23:52:20
- **Topic Keywords**: rag, search
- **Reason**: This paper is somewhat related to information retrieval and natural language processing, as it involves topic modeling and analysis of text data. However, its focus on leadership analysis and external outcomes is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling. While it touches on some relevant aspects, it does not strongly contribute to the user's core research themes.
...
### 24. Discovering a Shared Logical Subspace: Steering LLM Logical Reasoning via Alignment of Natural-Language and Symbolic Views

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Feihao Fang, My T. Thai, Yuanyuan Lei
- **URL**: <http://arxiv.org/abs/2604.19716v1>
- **Submitted**: 2026-04-21 17:42:54
- **Comment**: Accepted to ACL 2026
- **Topic Keywords**: rag
- **Reason**: The paper explores the alignment of natural-language and symbolic-language views of logical reasoning in Large Language Models (LLMs). While it touches on aspects of query understanding and deep semantic understanding, its primary focus is on leveraging symbolic reasoning to improve LLMs' logical reasoning capabilities, which is somewhat related to the user's interests in Information Retrieval and Natural Language Processing.
...
### 25. Pause or Fabricate? Training Language Models for Grounded Reasoning
...
- **URL**: <http://arxiv.org/abs/2604.19656v1>
- **Submitted**: 2026-04-21 16:45:29
- **Comment**: Code:https://github.com/ZJU-REAL/GRIL
- **Topic Keywords**: rag
- **Reason**: The paper explores a novel approach to grounded reasoning in language models, addressing ungrounded reasoning issues. While it touches on aspects of query understanding and model behavior, its primary focus is on improving language model performance rather than information retrieval or search technologies. The paper's relevance to your interests is somewhat related, but not central to your core research themes.
...
### 26. Are Large Language Models Economically Viable for Industry Deployment?
...
- **URL**: <http://arxiv.org/abs/2604.19342v1>
- **Submitted**: 2026-04-21 11:25:22
- **Comment**: Accepted at ACL 2026 (Industry Track)
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Search technologies, but it focuses on Large Language Models and their deployment in industry, which is not a central match. The paper's emphasis on economic viability and efficiency metrics is relevant to the user's background in e-commerce, but it does not directly address query understanding, ranking models, or user behavior modeling.
...
### 27. Beyond Semantic Similarity: A Component-Wise Evaluation Framework for Medical Question Answering Systems with Health Equity Implications

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Abu Noman Md Sakib, Md. Main Oddin Chisty, Zijie Zhang
- **URL**: <http://arxiv.org/abs/2604.19281v1>
- **Submitted**: 2026-04-21 09:50:08
- **Comment**: Accepted in the Ninth Annual ACM Conference on Fairness, Accountability, and Transparency (ACM FAccT) 2026
- **Topic Keywords**: rag
- **Reason**: The paper explores a specific application of Natural Language Processing (NLP) in medical question answering systems, which is somewhat related to the user's interests in NLP and IR. However, the focus on medical accuracy, health equity, and algorithmic discrimination is not directly aligned with the user's core research themes in IR, query understanding, and ranking models.
...
### 28. CulturALL: Benchmarking Multilingual and Multicultural Competence of LLMs on Grounded Tasks
...
- **URL**: <http://arxiv.org/abs/2604.19262v1>
- **Submitted**: 2026-04-21 09:21:46
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and related topics, but it does not directly align with your primary focus on Information Retrieval, especially in areas requiring deep semantic understanding and real-time relevance optimization. The paper presents a benchmark for evaluating the multilingual and multicultural abilities of Large Language Models (LLMs), which may be of interest to you, but it does not explicitly address query understanding, ranking models, or user behavior modeling.
...
### 29. Human-Guided Harm Recovery for Computer Use Agents

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Christy Li, Sky CH-Wang, Andi Peng, Andreea Bobu
- **URL**: <http://arxiv.org/abs/2604.18847v1>
- **Submitted**: 2026-04-20 21:12:40
- **Topic Keywords**: ranking, pairwise, rag, rank
- **Reason**: This paper appears to be off-topic as it focuses on agent safety methods for computer systems, which is unrelated to information retrieval, search technologies, and natural language processing. While it involves a form of 're-ranking' through a reward model, its context is distinct from the user's core research themes.
...
### 30. Mind the Unseen Mass: Unmasking LLM Hallucinations via Soft-Hybrid Alphabet Estimation

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Hongxing Pan, Yingying Guo, Wenqing Kuang, Jiashi Lu
- **URL**: <http://arxiv.org/abs/2604.19162v1>
- **Submitted**: 2026-04-21 07:16:05
- **Comment**: 7 pages, 1 figure, 3 tables
- **Topic Keywords**: query, rag, ctr
- **Reason**: This paper focuses on uncertainty quantification for large language models, which is a topic related to NLP, but it doesn't directly align with your primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. The paper's emphasis on semantic occupancy estimation and black-box access doesn't seem to be a central match for your research themes.
...
### 31. Characterizing AlphaEarth Embedding Geometry for Agentic Environmental Reasoning

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Mashrekur Rahman, Samuel J. Barrett, Christina Last
- **URL**: <http://arxiv.org/abs/2604.18715v1>
- **Submitted**: 2026-04-20 18:14:33
- **Topic Keywords**: queries, rag, retrieval
- **Reason**: This paper focuses on characterizing the geometric structure of Earth observation embedding vectors for environmental reasoning, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves retrieval, the context is environmental reasoning and Earth observation, which is quite different from your typical areas of focus.
...
### 32. CAST: Modeling Semantic-Level Transitions for Complementary-Aware Sequential Recommendation

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Qian Zhang, Lech Szymanski, Haibo Zhang, Jeremiah D. Deng
- **URL**: <http://arxiv.org/abs/2604.19414v1>
- **Submitted**: 2026-04-21 12:45:30
- **Comment**: 10 pages, 5 figures
- **Topic Keywords**: rag, recommend, commerce, e-commerce
- **Reason**: This paper focuses on sequential recommendation and complementary relations, which is somewhat related to information retrieval, but it primarily deals with recommender systems and does not align with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 33. DASH-KV: Accelerating Long-Context LLM Inference via Asymmetric KV Cache Hashing
...
- **URL**: <http://arxiv.org/abs/2604.19351v2>
- **Submitted**: 2026-04-21 11:33:24
- **Comment**: Accepted by ACL 2026 (Findings)
- **Topic Keywords**: queries, search
- **Reason**: This paper focuses on accelerating long-context LLM inference, which is not directly related to Information Retrieval, Search technologies, or query understanding. While it involves Natural Language Processing, the context is more aligned with model optimization and efficiency rather than semantic understanding or relevance optimization.
...
### 34. Beyond Indistinguishability: Measuring Extraction Risk in LLM APIs

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Ruixuan Liu, David Evans, Li Xiong
- **URL**: <http://arxiv.org/abs/2604.18697v1>
- **Submitted**: 2026-04-20 18:00:22
- **Comment**: Accepted by S&P 2026
- **Topic Keywords**: queries, rank
- **Reason**: This paper focuses on the privacy of Large Language Model (LLM) APIs and introduces a new concept of inextractability. While it touches on the idea of model memorization, which is related to user behavior modeling in IR, the paper's primary focus is on the privacy of LLM APIs, which is not a core area of interest for the user. The paper's relevance to the user's research interests is limited.
...
### 35. Emotion-Cause Pair Extraction in Conversations via Semantic Decoupling and Graph Alignment

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Tianxiang Ma, Weijie Feng, Xinyu Wang, Zhiyong Cheng
- **URL**: <http://arxiv.org/abs/2604.19547v1>
- **Submitted**: 2026-04-21 15:05:48
- **Topic Keywords**: pairwise
- **Reason**: This paper focuses on Emotion-Cause Pair Extraction in Conversations, which is a topic in Natural Language Processing (NLP). While it involves semantic understanding, it is not directly related to Information Retrieval (IR), Search technologies, or query understanding, which are the core areas of your research interests.
...
### 36. RDP LoRA: Geometry-Driven Identification for Parameter-Efficient Adaptation in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yusuf Çelebi, Yağız Asker, Özay Ezerceli, Mahmoud ElHussieni, Selva Taş, Reyhan Bayraktar, Fatma Betül Terzioğlu
- **URL**: <http://arxiv.org/abs/2604.19321v1>
- **Submitted**: 2026-04-21 10:29:42
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on Large Language Models and their adaptation, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on model adaptation, the context and methodology are quite different from your areas of expertise.
...
### 37. AlignCultura: Towards Culturally Aligned Large Language Models?

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Gautam Siddharth Kashyap, Mark Dras, Usman Naseem
- **URL**: <http://arxiv.org/abs/2604.19016v1>
- **Submitted**: 2026-04-21 03:06:50
- **Comment**: Accepted at ACL Mains 2026
- **Topic Keywords**: query
- **Reason**: This paper focuses on cultural alignment in Large Language Models, which is a topic related to Natural Language Processing (NLP), but it does not directly align with your primary research interests in Information Retrieval (IR), query understanding, ranking models, and user behavior modeling. While it touches on the concept of 'query construction', it's not a central theme in this paper.
...
### 38. Less Is More: Cognitive Load and the Single-Prompt Ceiling in LLM Mathematical Reasoning

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Manuel Israel Cazares
- **URL**: <http://arxiv.org/abs/2604.18897v1>
- **Submitted**: 2026-04-20 22:55:23
...
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on prompt engineering for formal mathematical reasoning in Large Language Models (LLMs), which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves LLMs, the context and task are specific to mathematical reasoning and do not align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 39. SafetyALFRED: Evaluating Safety-Conscious Planning of Multimodal Large Language Models
...
- **Submitted**: 2026-04-21 16:27:20
- **Comment**: Work accepted at ACL 2026 Findings
- **Topic Keywords**: rag
- **Reason**: This paper focuses on safety evaluations of multimodal large language models in embodied planning, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models, the context is safety-conscious planning in interactive environments, which is not aligned with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 40. Taming Actor-Observer Asymmetry in Agents via Dialectical Alignment

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Bobo Li, Rui Wu, Zibo Ji, Meishan Zhang, Hao Fei, Min Zhang, Mong-Li Lee, Wynne Hsu
- **URL**: <http://arxiv.org/abs/2604.19548v1>
- **Submitted**: 2026-04-21 15:05:58
- **Comment**: ACL 2026 Main Conference. Project page: https://unikcc.github.io/ReTAS/
- **Topic Keywords**: rag
- **Reason**: This paper focuses on addressing cognitive biases in large language models, specifically Actor-Observer Asymmetry, which is not directly related to information retrieval, query understanding, or ranking models. While it involves complex autonomous workflows and multi-agent frameworks, the primary goal is to improve fault resolution rates in ambiguous scenarios, which is not a core aspect of the user's research interests.
...
### 41. IndiaFinBench: An Evaluation Benchmark for Large Language Model Performance on Indian Financial Regulatory Text

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Rajveer Singh Pall
- **URL**: <http://arxiv.org/abs/2604.19298v1>
- **Submitted**: 2026-04-21 10:04:49
- **Comment**: 24 pages, 4 figures, 11 tables. Dataset and evaluation code at https://github.com/rajveerpall/IndiaFinBench
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on evaluating large language model performance on Indian financial regulatory text. While it involves NLP, the context is specific to financial regulatory text and does not align with your interests in query understanding, ranking models, or user behavior modeling.
...
### 42. Voice of India: A Large-Scale Benchmark for Real-World Speech Recognition in India
...
- **URL**: <http://arxiv.org/abs/2604.19151v1>
- **Submitted**: 2026-04-21 07:02:01
- **Comment**: 6 pages, 4 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech recognition in India, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific topic of speech recognition in India is not a central match for the user's interests.
...
### 43. Reducing the Offline-Streaming Gap for Unified ASR Transducer with Consistency Regularization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Andrei Andrusenko, Vladimir Bataev, Lilit Grigoryan, Nune Tadevosyan, Vitaly Lavrukhin, Boris Ginsburg
- **URL**: <http://arxiv.org/abs/2604.19079v1>
- **Submitted**: 2026-04-21 04:43:03
- **Topic Keywords**: rag
- **Reason**: This paper focuses on automatic speech recognition (ASR) and its unification for offline and streaming settings, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves deep learning and optimization, the context is specific to ASR and does not align with the user's core research themes.
...
- **URL**: <http://arxiv.org/abs/2604.19005v1>
- **Submitted**: 2026-04-21 02:46:10
- **Comment**: Accepted to ACL 2026
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on fact verification and omission detection, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves multi-agent reasoning and retrieval, the context is specific to fact verification and does not align with the user's primary focus on query understanding, ranking models, and user behavior modeling.
...
### 45. LogosKG: Hardware-Optimized Scalable and Interpretable Knowledge Graph Retrieval
...
- **Submitted**: 2026-04-20 23:32:13
- **Comment**: Accepted to the ACL 2026 Main Conference. 9 pages
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on knowledge graph retrieval, which is somewhat related to information retrieval, but it does not directly address query understanding, ranking models, or user behavior modeling. The paper's emphasis on hardware optimization and scalability also diverges from the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 46. Experiments or Outcomes? Probing Scientific Feasibility in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Seyedali Mohammadi, Manas Gaur, Francis Ferraro
- **URL**: <http://arxiv.org/abs/2604.18786v1>
- **Submitted**: 2026-04-20 19:48:33
- **Comment**: Accepted at ACL 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on scientific feasibility assessment, which is not a central theme in your research.
...
### 47. Mango: Multi-Agent Web Navigation via Global-View Optimization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Weixi Tong, Yifeng Di, Tianyi Zhang
- **URL**: <http://arxiv.org/abs/2604.18779v1>
- **Submitted**: 2026-04-20 19:42:47
- **Topic Keywords**: rag
- **Reason**: This paper focuses on web navigation and multi-agent methods, which is somewhat related to information retrieval, but it lacks direct relevance to query understanding, ranking models, and user behavior modeling, which are core areas of interest.
...
### 48. Investigating Counterfactual Unfairness in LLMs towards Identities through Humor

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Shubin Kim, Yejin Son, Junyeong Park, Keummin Ka, Seungbeen Lee, Jaeyoung Lee, Hyeju Jang, Alice Oh, Youngjae Yu
- **URL**: <http://arxiv.org/abs/2604.18729v1>
- **Submitted**: 2026-04-20 18:26:52
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves language models, the focus is on investigating bias and fairness in humor generation, which is a niche area that doesn't align with your primary research themes.
...
### 49. Superficial Success vs. Internal Breakdown: An Empirical Study of Generalization in Adaptive Multi-Agent Systems

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Namyoung So, Seokgyu Jang, Taeuk Kim
- **URL**: <http://arxiv.org/abs/2604.18951v2>
- **Submitted**: 2026-04-21 01:02:16
- **Comment**: 27 pages, 4 figures. Equal contribution for the first two authors
- **Topic Keywords**: rag
- **Reason**: This paper focuses on adaptive multi-agent systems, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. The topics of generalization and evaluation protocols in MAS do not align with the user's core themes of query understanding, ranking models, and user behavior modeling.
...
### 50. Comparison of sEMG Encoding Accuracy Across Speech Modes Using Articulatory and Phoneme Features
...
- **URL**: <http://arxiv.org/abs/2604.18920v1>
- **Submitted**: 2026-04-20 23:57:47
- **Topic Keywords**: ctr
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, or any of the user's core research themes. The study focuses on speech articulation and electromyography, which is outside the user's areas of interest.
