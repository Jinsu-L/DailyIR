...
- **Reason**: This paper is somewhat related to information retrieval, but its focus on on-policy distillation and agent-environment interactions is not directly aligned with your core research themes. While it does involve search environments, the context is more related to reinforcement learning and model distillation, rather than query understanding or ranking models.
...
- **Reason**: This paper is somewhat related to Information Retrieval, specifically in the context of vision-language retrieval. However, its focus on token merging and compression for efficient storage and scoring is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2607.05217v2>
- **Submitted**: 2026-07-06 15:32:46
- **Topic Keywords**: rag, retrieval, web search, search
- **Reason**: This paper explores the trade-off between curated and open web search in AI information services, focusing on source trustworthiness. While it touches on information retrieval and search technologies, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
- **Reason**: The paper discusses Retrieval-Augmented Generation (RAG) and its vulnerability to misinformation, proposing a defense mechanism called MIRAGE. While it touches on information retrieval and NLP, the focus is on factuality and robustness rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to search technologies is indirect, making it somewhat relevant but not a central match.
...
### 5. Evaluation and Explainability of Unsupervised Scholarly Collaboration Recommendations
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of content-based collaboration recommendations. However, it focuses on scholarly settings and collaboration recommendations, which is not a central match to your primary focus on query understanding, ranking models, and user behavior modeling in e-commerce and other domains. The paper's use of NLP techniques, such as BERTopic and SciBERT, is relevant but not a primary focus of your research.
...
### 6. Does It Fail to See or Fail to Know? Attributing Errors in Vision-Language Models

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Khang Nhat Hoang Vo, Artem Vazhentsev, Artem Shelmanov, Timothy Baldwin, Yova Kementchedjhieva
- **URL**: <http://arxiv.org/abs/2607.04683v1>
- **Submitted**: 2026-07-06 05:11:45
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to your interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, its focus on vision-language models and visual question answering is not directly aligned with your core research themes. The paper's emphasis on uncertainty quantification and failure-source prediction in VLMs is an interesting aspect, but it does not strongly connect to your primary areas of interest in IR and NLP.
...
### 7. Progressive Disclosure for LLM-Maintained Wiki Knowledge Bases: a Preregistered Ablation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Theodore O. Cochran
- **URL**: <http://arxiv.org/abs/2607.04576v1>
- **Submitted**: 2026-07-06 01:03:27
...
### 8. SalAngaBhava: A Sinhala Market Dataset for Aspect-based Sentiment Analysis

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Lakshani Galwatta, Nisansa de Silva, Sarangi Aththanayake, Adithya Galwatta
- **URL**: <http://arxiv.org/abs/2607.05259v1>
- **Submitted**: 2026-07-06 16:05:26
- **Comment**: 9 pages, 6 figures
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and sentiment analysis, but it focuses on a specific low-resource language (Sinhala) and does not directly address your core areas of interest in Information Retrieval (IR), query understanding, or ranking models.
...
### 9. Fidelity-Diversity Metrics for Text

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Amanda Wang, Tudor Manole, Florentina Bunea, John Thickstun
- **URL**: <http://arxiv.org/abs/2607.04563v1>
- **Submitted**: 2026-07-06 00:31:31
- **Topic Keywords**: search
- **Reason**: This paper explores metrics for text data quality, specifically fidelity and diversity, which is somewhat related to information retrieval and NLP. However, it focuses more on language model training and data augmentation, which, while relevant to the broader field, is not a central match for your research interests in query understanding, ranking models, and user behavior modeling.
...
### 10. MTEB-PT: A Text Embedding Benchmark for Brazilian Portuguese
...
- **Reason**: This paper focuses on text embeddings for Brazilian Portuguese and introduces a benchmark for evaluating these models. While it touches on retrieval and reranking tasks, the primary focus is on text embeddings and their evaluation, which is not directly related to your core research interests in Information Retrieval and Search technologies.
...
### 11. Prompt-to-Paper: Agentic AI System for Bioinformatics

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Ramsha Kamran, Maheera Amjad, Zartasha Mustansar, Arsalan Shaukat, Salma Sherbaz, Muhammad U. S. Khan
- **URL**: <http://arxiv.org/abs/2607.05456v1>
- **Submitted**: 2026-07-05 21:30:24
- **Comment**: NA
- **Topic Keywords**: relevance, rag, retrieval, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves text generation and retrieval, its focus is on bioinformatics and manuscript generation, which is not a central match to your areas of expertise.
...
- **Reason**: This paper focuses on a verification framework for Large Language Models (LLMs), which is not directly related to Information Retrieval or Search technologies. While it touches on ranking models, the context is verification rather than ranking, and the application is not in the e-commerce domain. The paper's emphasis on LLMs and verification does not align with the user's primary research interests in IR, query understanding, and user behavior modeling.
...
### 13. Multi-Large Language Model Orchestrated Severity Assessment of Clinical Records (MOSAIC)
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus on clinical records, disease severity assessment, and electronic healthcare records is outside your areas of expertise.
...
### 14. Transplanting, inverting, and preventing a misalignment persona: method-conditional emergent misalignment in Qwen2.5
...
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and specifically focuses on emergent misalignment in language models. However, it does not seem to be directly related to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 15. SPEARBench: A Benchmark for Naturalness Evaluation in Streaming Speech-to-Speech Language Models
...
- **Reason**: This paper focuses on evaluating the naturalness of speech-to-speech language models, which is a topic in Natural Language Processing (NLP). However, it does not directly relate to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 16. EdgeBench: Unveiling Scaling Laws of Learning from Real-World Environments
...
- **Topic Keywords**: ltr
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, or Natural Language Processing, which are the primary areas of interest. The focus on learning from real-world environments and agent interaction does not align with the user's research themes.
...
### 17. Localized LoRA-MoE: Block-wise Low-Rank Experts With Adaptive Routing
...
- **Reason**: This paper appears to be primarily focused on improving the efficiency and robustness of large language models and perception networks, using techniques such as parameter-efficient fine-tuning and adaptive routing. While it touches on the idea of adapting to diverse operational contexts, it does not seem to be directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 18. Semantic Homogenization in Italian Popular Music: A Diachronic Analysis
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on a diachronic analysis of semantic homogenization in Italian popular music lyrics, using NLP tools, but without any apparent connection to query understanding, ranking models, or user behavior modeling.
...
### 19. Wrong Before Right: Late Rescue and Interface Failure in Aligned Language Models
...
- **Topic Keywords**: rag, rank
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and aligned language models, but it does not align with your core research themes in Information Retrieval (IR) and Search technologies. The focus on language model correctness and compression risk does not directly relate to your interests in query understanding, ranking models, or user behavior modeling.
...
### 20. Characterizing the Temporal, Emotional, and Social Patterns of Adolescent Substance Use Discussions on Reddit
...
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on analyzing social media discussions about adolescent substance use, which is outside your primary areas of interest.
...
### 21. Weak-to-Strong Generalization via Direct On-Policy Distillation
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on reinforcement learning and language-model reasoning, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the primary topic is about improving language-model reasoning, which is not a central match to your research themes.
...
### 22. How Much is Left? LLMs Linearly Encode Their Remaining Output Length
...
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on the internal workings of Large Language Models (LLMs), specifically their ability to estimate remaining output length. While it touches on aspects of deep semantic understanding, it is primarily concerned with the internal mechanisms of LLMs, which is not a central match to your research interests in Information Retrieval and Search technologies.
...
### 23. CanniUplift: A Holistic Framework for Mitigating Seller and Incentive Cannibalization in E-commerce Uplift Modeling
...
- **Reason**: This paper focuses on e-commerce uplift modeling, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the specific topic of cannibalization in e-commerce uplift modeling is not directly aligned with your core research themes, and the paper does not appear to involve query understanding, ranking models, or user behavior modeling.
...
### 24. Progressive Refinement: An Iterative Pseudo-Labeling Approach for Mandarin-English Code-Switching ASR
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on code-switching ASR, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and techniques used are not aligned with the user's core themes of query understanding, ranking models, and user behavior modeling.
...
### 25. When Words Predict Workload
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on a specific problem in distributed learning and scheduling, using techniques from Natural Language Processing (NLP) to predict workload. However, it does not seem to be directly related to the user's core research interests in Information Retrieval, Search technologies, and query understanding, ranking models, or user behavior modeling.
...
### 26. Evaluating the Effect of Linguistic Relatedness on Cross-Lingual Transfer in Large Multilingual Automatic Speech Recognition
...
- **Submitted**: 2026-07-06 08:49:02
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on automatic speech recognition and cross-lingual transfer in low-resource languages, which does not align with your primary focus on information retrieval, search technologies, and natural language processing.
...
- **Submitted**: 2026-07-06 06:53:40
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The topic of chart-to-code generation and its supervision targets is unrelated to your areas of focus, including query understanding, ranking models, user behavior modeling, and recommender systems.
...
### 28. Retroactive Chain-of-Thought (RetroCoT): Forensic Reconstruction Prompts as a Safety Diagnostic Across Model Generations

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Samira Hajizadeh
- **URL**: <http://arxiv.org/abs/2607.04645v1>
- **Submitted**: 2026-07-06 03:59:06
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on safety alignment in large language models, specifically exploring how pragmatic framing affects model behavior. While it touches on the idea of reframing requests, it does not seem to be directly related to information retrieval, query understanding, or ranking models, which are core areas of interest for the user.
...
### 29. Faithfulness to Refusal: A Causal Audit of Neuron Selectors

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Ananth Eswar, Pratinav Seth, Utsav Avaiya, Vinay Kumar Sankarapu
- **URL**: <http://arxiv.org/abs/2607.05355v1>
- **Submitted**: 2026-07-06 17:33:36
- **Topic Keywords**: rank
- **Reason**: This paper focuses on auditing neuron selectors in language models, which is a topic in NLP. However, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 30. Unified Audio Intelligence Without Regressing on Text Intelligence
...
- **Submitted**: 2026-07-06 15:11:57
- **Comment**: We release the Audex models at https://huggingface.co/collections/nvidia/nemotron-labs-audex
- **Topic Keywords**: search
- **Reason**: This paper focuses on unified audio-text intelligence, introducing a model that combines audio and text inputs. While it involves multimodal generation and understanding, the primary focus is on text-audio fusion, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 31. Who's Behind It? Annotating and Extracting Conspiratorial Actors from German Telegram Posts

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Helena Mihaljević, Jolanda Beer, Mareike Lisker, Katharina Soemer
- **URL**: <http://arxiv.org/abs/2607.04962v1>
- **Submitted**: 2026-07-06 11:49:32
- **Topic Keywords**: search
- **Reason**: This paper focuses on annotating and extracting conspiratorial actors from German Telegram posts, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP techniques, the context and application are not aligned with the user's interests in query understanding, ranking models, user behavior modeling, or real-time relevance optimization.
...
### 32. PAST-TIDE: Prototype-Anchored Statement Tuning with Topic-Invariant Normalization for Stance Detection
...
- **Submitted**: 2026-07-06 05:33:27
- **Comment**: Published in The Fifteenth Language Resources and Evaluation Conference (LREC 2026)
- **Topic Keywords**: coling
- **Reason**: This paper focuses on stance detection, a task in Natural Language Processing (NLP), using a novel approach called PAST-TIDE. While it involves some form of language understanding, it is not directly related to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 33. Towards Digital Preservation of Efik: TTS for a Low-Resource African Language

- **LLM Score**: 1
- **Keyword Score**: 1
- **Authors**: Offiong Bassey Edet, Emmanuel Oyo-Ita, Archibong Okon Archibong, David Effanga Bassey, Mbuotidem Sunday Awak
- **URL**: <http://arxiv.org/abs/2607.04515v1>
- **Submitted**: 2026-07-05 21:37:15
- **Comment**: 6 pages, 2 figures. Accepted to Interspeech 2026
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on speech synthesis for a low-resource African language, which is outside your primary areas of interest.
...
### 34. EEG-SpikeAgent: Agentic Closed-Loop Program Synthesis for Automated EEG Spike Detection
...
- **Reason**: This paper focuses on EEG spike detection using a closed-loop program synthesis framework, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, and Natural Language Processing.
...
### 35. What Does a Discrete Diffusion Model Learn?
...
- **Topic Keywords**: acl
- **Reason**: This paper appears to be focused on discrete diffusion models and their optimization, which is not directly related to the user's research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 36. RABBiT: Rapidly adaptive BOLD foundation model via brain-tuning for accurate zero-shot and few-shot prediction of speech-elicited responses in the brain
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on brain activity and language-evoked responses, which is outside your primary areas of interest.
...
### 37. On the Complexity of Entrywise Power Matrix Factorization

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Nicolas Gillis, Subhayan Saha, Stefano Sicilia, Arnaud Vandaele
- **URL**: <http://arxiv.org/abs/2607.04875v1>
- **Submitted**: 2026-07-06 09:50:20
- **Comment**: 27 pages, code available from https://gitlab.com/ngillis/rank-r_signing/
- **Topic Keywords**: rank
- **Reason**: This paper is about the complexity analysis of a matrix factorization technique called entrywise power matrix factorization. It does not relate to information retrieval, search technologies, query understanding, ranking models, user behavior modeling, or natural language processing, which are the primary areas of your research interests.
