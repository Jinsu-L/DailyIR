# Daily Papers Report - 2026-09-20
...
- **URL**: <http://arxiv.org/abs/2609.21281v1>
- **Submitted**: 2026-09-18 03:47:18
- **Comment**: 10 pages, 5 figures, 9 tables. ACM sigconf format; submitted to the KDD 2027 Applied Data Science Track
- **Topic Keywords**: queries, ranking, ltr, relevance, rag, retrieval, personalization, rank, search
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Hybrid GPU–CPU Retrieval for Ultra‑Large‑Scale Personalized Search
- **Aim**: Deliver deep personalization and massive coverage by co‑serving GPU‑based interaction‑heavy retrieval and CPU‑based breadth‑wide retrieval in parallel.
- **Rationale**: GPUs excel at expressive interaction models but lack memory for a full index; CPUs can host billions of documents but cannot perform heavy scoring within real‑time budgets. Combining both overcomes the personalization–scale paradox.
- **Ground**: A heterogeneous co‑serving architecture runs two independent retrieval pathways: a GPU branch with a curated 1 B‑doc pool, two‑tower retrieval plus DeepFM‑style fused pre‑ranking; a CPU branch with a 10–20 B‑doc inventory, lightweight embedding index (IVF‑PQ, HNSW, DiskANN, etc.) and a two‑tower XLM‑V backbone. Inventories are refreshed daily, each with its own capacity/deadline controls, independent versioning, and source attribution. Joint training uses InfoNCE, Smooth‑L1, and BCE losses; fused pre‑ranking reduces downstream candidate volume. SIMD‑accelerated list‑scanning and eager term‑at‑a‑time scoring enable efficient CPU scans.
- **Experiment**: Production A/B tests versus a legacy CPU‑only baseline show higher relevance (DCG@20, GSRR) and engagement. Pathway‑level experiments confirm depth‑rich GPU candidates and breadth‑wide CPU candidates each add value. Latency metrics: GPU path meets <40 ms 99th‑percentile at 150–200 QPS; CPU path scales to tens of billions with negligible impact on lexical latency. Economic analysis demonstrates cost advantage of assigning deep modeling to GPUs and breadth to CPUs.
- **Takeaway**: Depth–breadth co‑serving architecture achieves both personalization and coverage, with fused pre‑ranking reducing candidate volume, independent inventories allowing evolution, modular ANN engines, robust failure isolation, and measurable performance and cost benefits.
...
### 2. ArenaFlow: From Trajectory Ranking to Hierarchical Credit Propagation for Open-Ended Agent RL
...
- **Submitted**: 2026-09-18 06:44:44
- **Topic Keywords**: ranking, pointwise, pairwise, rag, retrieval, rank
- **Reason**: LLM scoring failed.
...
- **URL**: <http://arxiv.org/abs/2609.22038v1>
- **Submitted**: 2026-09-18 17:30:27
...
### 5. How Many Humans Is a Judge Panel Worth?

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Chao Li, Yingying Yu, Yunfeng Li
- **URL**: <http://arxiv.org/abs/2609.21277v1>
- **Submitted**: 2026-09-18 03:43:45
...
- **URL**: <http://arxiv.org/abs/2609.22043v1>
- **Submitted**: 2026-09-18 17:34:13
...
- **URL**: <http://arxiv.org/abs/2609.21863v1>
- **Submitted**: 2026-09-18 14:54:44
- **Comment**: Accepted at the 20th ACM Conference on Recommender Systems (RecSys '26), Demo Track. 4 pages, 2 figures
- **Topic Keywords**: rag, retrieval, recommend, search, recsys
- **Reason**: LLM scoring failed.
...
### 8. MAGIC: Marginal-Guided Compression with Optimal Transport for Efficient Visual Document Retrieval

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Xu Yuan, Hua Liu, Wenqi Fan, Qing Li
- **URL**: <http://arxiv.org/abs/2609.21018v1>
- **Submitted**: 2026-09-17 19:14:06
...
### 9. CASCADE Against Jailbreaks: Combination Across Stages with Controlled Attack-Defense Evaluation

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Jiale Luo, Eric Han
- **URL**: <http://arxiv.org/abs/2609.21793v1>
- **Submitted**: 2026-09-18 14:06:00
...
### 10. Offline Multimodal Large Language Models for Decision Support in Air Operations

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Joao P. A. Dantas, Jelton A. Cunha, Gabriel Dietzsch
- **URL**: <http://arxiv.org/abs/2609.21390v1>
- **Submitted**: 2026-09-18 07:00:29
...
### 11. Evaluating In-Context Learning and Retrieval Strategies for Devanagari Post-OCR Correction

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Abhishek Bhandari, Gaurav Harit
- **URL**: <http://arxiv.org/abs/2609.21595v1>
- **Submitted**: 2026-09-18 10:26:08
...
- **URL**: <http://arxiv.org/abs/2609.21183v1>
- **Submitted**: 2026-09-18 01:04:53
...
### 13. Adaptive Preference Modeling via Explicit Indirect Relational Learning for Personalized Fashion Matching

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Shuiying Liao, Li Li, P. Y. Mok
- **URL**: <http://arxiv.org/abs/2609.21475v1>
- **Submitted**: 2026-09-18 08:23:55
...
### 14. Auto-Bidding with Disentangled Advertiser Profiles and Train-Free Adaptation

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Songyue Cai, Shan Gu, Wei Chen, Ziru Xu, Lianyu Wang, Jian Xu, Xiaofeng Zhu
- **URL**: <http://arxiv.org/abs/2609.21308v1>
- **Submitted**: 2026-09-18 04:35:38
- **Topic Keywords**: rag, recommend, personalization
- **Reason**: LLM scoring failed.
...
### 15. Beyond Reference-Based Evaluation: Reward Models for Meta-Evaluation of Grammatical Error Correction

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ruotian Wu, Bill E. Johnson, Gene Saunders, Osama Hamzeh, Ankit Vadehra, Pascal Poupart
- **URL**: <http://arxiv.org/abs/2609.21231v1>
- **Submitted**: 2026-09-18 02:24:28
- **Comment**: 5 pages
...
### 16. Aligning with Lived Experience: Heterogeneous Benefits of Fine Tuning in Mental Health Support Generation
...
### 17. Reusing Latent Speech Representations for Query-Conditioned Topic Localization in Transcripts

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Steffen Freisinger, Philipp Seeberger, Thomas Ranzenberger, Tobias Bocklet, Korbinian Riedhammer
- **URL**: <http://arxiv.org/abs/2609.21844v1>
- **Submitted**: 2026-09-18 14:41:30
...
### 18. CIBuzzBench: A Benchmark for Cross-Lingual Understanding of Chinese Internet Buzzwords

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Yifan Wang, Junyu Lu, Qifan Wang, Shun Zhang, Chaozhuo Li, Jiahao Liu, Zhijun Cao, Lingbin Bu, Fanliang Bu
- **URL**: <http://arxiv.org/abs/2609.21722v1>
- **Submitted**: 2026-09-18 12:57:10
...
### 19. Listen Before You Speak: Response Planning from Listener Facial Reactions for Conversational Speech Generation

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Yunji Chu
- **URL**: <http://arxiv.org/abs/2609.21683v1>
- **Submitted**: 2026-09-18 12:18:16
...
### 20. Do We Care About Personalization and Explainability? An Interview Study with News Recommendation Engineers

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Jasmin Kareem, Siddharth Mehrotra, Martijn C. Willemsen, Maarten de Rijke
- **URL**: <http://arxiv.org/abs/2609.21547v1>
- **Submitted**: 2026-09-18 09:38:14
...
### 21. Verify, Don't Trust: Agentic Model Development for Video Discovery Retrieval at Scale

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Hao Fu, Baiting Zhu, Minglei Chen, Yinjie Huang, Shuai Ding
- **URL**: <http://arxiv.org/abs/2609.21257v1>
- **Submitted**: 2026-09-18 03:04:28
...
### 22. Geometry of Values: Task Vector Composition for Ethical Preference Alignment in Language Models

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Utkarsh Agarwal, Monojit Choudhury
- **URL**: <http://arxiv.org/abs/2609.21094v1>
- **Submitted**: 2026-09-17 21:12:43
...
### 23. Cross-sector generalization of accident-process role classification in occupational accident narratives

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Aho Yapi, Pierre Latouche, Arnaud Guillin, Yan Bailly
- **URL**: <http://arxiv.org/abs/2609.22081v1>
- **Submitted**: 2026-09-18 17:59:10
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 25. RecreationWorld: Scalable and Verifiable Environments for Hybrid Computer-Use Agents
...
### 26. NemotronLabs VoiceChat: An Open Full-duplex Speech-to-Speech Model with Tool Calling Capabilities
...
### 28. TrialAtlas: Multi-Agent Research Organization for Clinical Trial Design and Optimization

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Jiacheng Lin, Zifeng Wang, Zheng Chen, Erick Scott, Ziwei Yang, Fanyang Yu, Sheng Zhong, Jimeng Sun
- **URL**: <http://arxiv.org/abs/2609.21859v1>
- **Submitted**: 2026-09-18 14:53:34
...
### 29. The Spoken Wikipedia Presentation Corpus

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Thomas Ranzenberger, Steffen Freisinger, Tobias Bocklet, Korbinian Riedhammer
- **URL**: <http://arxiv.org/abs/2609.21676v1>
- **Submitted**: 2026-09-18 12:13:06
...
### 30. Steering LLMs Responses Towards Moral Foundations on the Norwegian MFQ-30

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Hans Andersen, David Dichas
- **URL**: <http://arxiv.org/abs/2609.21636v1>
- **Submitted**: 2026-09-18 11:25:22
...
### 31. MIRAGE: Multi-Perspective Creative Language Model Reasoning with Reinforcement Learning Guidance

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Arash Lagzian, Srinivas Anumasa, Dianbo Liu
- **URL**: <http://arxiv.org/abs/2609.21554v1>
- **Submitted**: 2026-09-18 09:44:13
...
### 32. Conformal Privacy Auditing: Calibrated Re-identification Attacks with Statistical Guarantees

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Shuo Huang, Gholamreza Haffari, Xingliang Yuan, Ting Yu, Lizhen Qu
- **URL**: <http://arxiv.org/abs/2609.21340v1>
- **Submitted**: 2026-09-18 05:49:54
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 33. When Does Reasoning Help in Machine Translation? A Hierarchical Analysis of LRM Reasoning Traces

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yuxiang Liu, Jiaming Luo, Eleftheria Briakou, Colin Cherry
- **URL**: <http://arxiv.org/abs/2609.21247v1>
- **Submitted**: 2026-09-18 02:43:26
...
### 34. Not All Irregularity Is Equal: Causally Isolating a Rare Failure Mode in Japanese Morphological Inflection

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Wen Zhang
- **URL**: <http://arxiv.org/abs/2609.21179v1>
- **Submitted**: 2026-09-18 00:47:14
...
### 35. Detecting Hallucination in LLMs: Tracing the Topological Signatures of Impaired Context Sharing

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Amir Jalilifard, Anderson Rocha, Eric Wong, Marcos Medeiros Raimundo
- **URL**: <http://arxiv.org/abs/2609.21096v1>
- **Submitted**: 2026-09-17 21:15:34
...
### 36. Rethinking Human-Aligned Evaluation: An Analysis of Semantic Metrics Beyond WER

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Hritika Sharma, Thibault Bañeras-Roux, Alessandra Pinto, Petr Motlicek, Hyunggu Jung, Esaú Villatoro-Tello, Somang Nam
- **URL**: <http://arxiv.org/abs/2609.21663v1>
- **Submitted**: 2026-09-18 12:00:01
...
### 38. Scaling Forced Alignment to End-User Devices

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Lawry Sorenson, Michael Crandall, Eric K. Ringger, Stephen D. Richardson
- **URL**: <http://arxiv.org/abs/2609.21145v1>
- **Submitted**: 2026-09-17 23:22:28
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 39. Scaling Discovery through Test-Time Communication
...
### 40. Trustworthy FinAInce: Unpacking How AI-Mediated Financial Advice is Judged

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Aryan Ramchandra Kapadia, Eshwar Chandrasekharan, Koustuv Saha
- **URL**: <http://arxiv.org/abs/2609.20989v1>
- **Submitted**: 2026-09-17 18:42:41
- **Topic Keywords**: recommend
- **Reason**: LLM scoring failed.
