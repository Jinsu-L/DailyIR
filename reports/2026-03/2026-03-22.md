# Daily Papers Report - 2026-03-22
...
- **URL**: <http://arxiv.org/abs/2603.19665v1>
- **Submitted**: 2026-03-20 06:01:01
- **Topic Keywords**: information retrieval, query, queries, ranking, click, ctr, click-through rate, cvr, conversion rate, retrieval, commerce, e-commerce, rank, search
- **Reason**: This paper aligns well with your research interests in Information Retrieval, particularly query understanding and ranking models. The focus on faceted search and generative methods in e-commerce is relevant to your background and expertise. However, the specific application to e-commerce may limit its generalizability to other domains.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: GenFacet – End‑to‑End Generative Faceted Search for Large‑Scale E‑Commerce
- **Aim**: Unify facet generation and intent‑driven query rewriting within a single LLM to eliminate pipeline fragmentation, close the semantic gap between user intent and product catalog, and directly link user filtering actions to downstream search utility.
- **Rationale**: Conventional rule‑based facet extraction and separate ranking pipelines suffer from static lexicons, vocabulary gaps, disjoint personalization, and error propagation, leading to low recall on emerging queries and high latency.
- **Ground**: System architecture: a unified context‑aware inference stage generates ranked facet lists from query, user profile, behavior, knowledge graph, and external knowledge; an interaction phase rewrites the query conditioned on facet clicks; retrieval follows. Training pipeline: teacher‑student distillation from high‑capacity models, multi‑task supervised fine‑tuning (shared semantic space for facets and rewritten queries), Group Relative Policy Optimization (GRPO) RL to directly optimize search‑utility rewards, and model compression (INT8, speculative decoding) for low‑latency serving.
- **Experiment**: Offline evaluation on JD‑Facet dataset: Precision@10 0.920 (+7.8% vs rule‑based), Recall@10 0.847 (+26.3%), nDCG@10 0.783 (+15.1%). Online A/B (10% traffic, 2 weeks): Facet CTR ↑ 42 % (p<0.05), User Conversion Rate ↑ 2 % (p<0.05). Ablation studies show GRPO, multi‑task SFT, and query rewriting each contribute significantly to performance.
- **Takeaway**: GenFacet is the first end‑to‑end generative framework that integrates facet generation and query rewriting, achieving substantial industrial gains (42 % facet CTR, 2 % UCVR) while maintaining < 400 ms latency. Its RL‑based multi‑task alignment and scalable deployment set a new baseline for generative faceted search, with future work targeting multimodal facets and long‑term personalization.
...
### 2. CoverageBench: Evaluating Information Coverage across Tasks and Domains

- **LLM Score**: 8
- **Keyword Score**: 13
- **Authors**: Saron Samuel, Andrew Yates, Dawn Lawrie, Ian Soboroff, Trevor Adriaanse, Benjamin Van Durme, Eugene Yang
- **URL**: <http://arxiv.org/abs/2603.20034v1>
- **Submitted**: 2026-03-20 15:20:44
- **Comment**: 8
- **Topic Keywords**: ranking, relevance, rag, retrieval, web search, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of evaluating information coverage and its relation to existing metrics. The focus on retrieval-augmented generation (RAG) systems and the development of a unified testbed for evaluating information coverage aligns with your interests in query understanding and ranking models.
...
### 3. SaFRO: Satisfaction-Aware Fusion via Dual-Relative Policy Optimization for Short-Video Search

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Renzhe Zhou, Songyang Li, Feiran Zhu, Chenglei Dai, Yi Zhang, Yi Wang, Jingwei Zhuo
- **URL**: <http://arxiv.org/abs/2603.19585v1>
- **Submitted**: 2026-03-20 02:57:50
- **Comment**: 9 pages, 8 figures
- **Topic Keywords**: query, ranking, recommend, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The proposed framework, SaFRO, focuses on optimizing user satisfaction in short-video search, which aligns with your interest in real-time relevance optimization. Although the paper is specific to short-video search, its application of reinforcement learning and policy optimization is relevant to your broader interests in IR and NLP.
...
### 4. Overreliance on AI in Information-seeking from Video Content

- **LLM Score**: 8
- **Keyword Score**: 6
- **Authors**: Anders Giovanni Møller, Elisa Bassignana, Francesco Pierri, Luca Maria Aiello
- **URL**: <http://arxiv.org/abs/2603.19843v1>
- **Submitted**: 2026-03-20 10:38:47
- **Topic Keywords**: information retrieval, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The study explores the impact of AI on multimedia information-seeking tasks, which aligns with your focus on deep semantic understanding and real-time relevance optimization. While the paper's focus on video content is somewhat specific, its themes and methodologies are closely related to your core research themes.
...
### 5. AIGQ: An End-to-End Hybrid Generative Architecture for E-commerce Query Recommendation

- **LLM Score**: 7
- **Keyword Score**: 20
- **Authors**: Jingcao Xu, Jianyun Zou, Renkai Yang, Zili Geng, Qiang Liu, Haihong Tang
- **URL**: <http://arxiv.org/abs/2603.19710v1>
- **Submitted**: 2026-03-20 07:27:59
- **Topic Keywords**: query, ranking, relevance, click, ctr, click-through rate, recommend, commerce, e-commerce, rank, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in query understanding and ranking models. Although it focuses on e-commerce query recommendation, it explores novel techniques for intent capture and demand discovery, which aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on recommender systems and its specific application to Taobao's homepage limits its relevance to your broader interests in IR and NLP.
...
### 6. LLM-Enhanced Semantic Data Integration of Electronic Component Qualifications in the Aerospace Domain

- **LLM Score**: 7
- **Keyword Score**: 13
- **Authors**: Antonio De Santis, Marco Balduini, Matteo Belcao, Andrea Proia, Marco Brambilla, Emanuele Della Valle
- **URL**: <http://arxiv.org/abs/2603.20094v1>
- **Submitted**: 2026-03-20 16:22:06
- **Comment**: ESWC 2026
- **Topic Keywords**: information retrieval, queries, rag, ctr, retrieval, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of data integration and retrieval from heterogeneous data sources. Although it focuses on the aerospace domain and electronic component qualifications, the use of LLMs and Ontology-based Data Access approaches aligns with your interests in query understanding and ranking models. However, the specific application and domain are not directly related to your core research themes.
...
### 7. MetaCues: Enabling Critical Engagement with Generative AI for Information Seeking and Sensemaking

- **LLM Score**: 6
- **Keyword Score**: 3
- **Authors**: Anjali Singh, Karan Taneja, Zhitong Guan, Soo Young Rieh
- **URL**: <http://arxiv.org/abs/2603.19634v1>
- **Submitted**: 2026-03-20 04:34:19
- **Topic Keywords**: rag, search
- **Reason**: This paper is somewhat related to information retrieval, as it discusses search tools and user behavior. However, its focus on generative AI and metacognitive cues is more aligned with NLP and human-computer interaction, rather than the user's core research themes in query understanding, ranking models, and click models.
...
### 8. The End of Rented Discovery: How AI Search Redistributes Power Between Hotels and Intermediaries

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Peiying Zhu, Sidi Chang
- **URL**: <http://arxiv.org/abs/2603.20062v1>
- **Submitted**: 2026-03-20 15:44:00
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it focuses on a specific application (hotel search) and does not directly address your core areas of interest such as query understanding, ranking models, or user behavior modeling. While it touches on the impact of AI search on power dynamics between hotels and intermediaries, it does not delve into the deeper semantic understanding or real-time relevance optimization aspects that are central to your work.
...
### 9. ReViSQL: Achieving Human-Level Text-to-SQL

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Yuxuan Zhu, Tengjun Jin, Yoojin Choi, Daniel Kang
- **URL**: <http://arxiv.org/abs/2603.20004v1>
- **Submitted**: 2026-03-20 14:49:27
- **Topic Keywords**: query, rag, search
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and data mining, but it primarily focuses on Text-to-SQL tasks, which is a specific application of NLP. While it involves some aspects of query understanding, it is not directly related to the user's core research themes in Information Retrieval (IR) and Search technologies.
...
- **URL**: <http://arxiv.org/abs/2603.19595v1>
- **Submitted**: 2026-03-20 03:14:40
- **Topic Keywords**: query, retrieval, search
- **Reason**: The paper discusses a lifelong memory framework for interactive agents, which is somewhat related to information retrieval, particularly in the context of query understanding and user behavior modeling. However, the focus is on memory systems and retrieval in a lifelong learning setting, which is not directly aligned with the user's core research themes in IR and NLP. The paper's emphasis on memory topology evolution and LLM-based diagnostics is not a central match for the user's interests.
...
### 11. RouterKGQA: Specialized--General Model Routing for Constraint-Aware Knowledge Graph Question Answering

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Bo Yuan, Hexuan Deng, Xuebo Liu, Min Zhang
- **URL**: <http://arxiv.org/abs/2603.20017v1>
- **Submitted**: 2026-03-20 15:01:57
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper RouterKGQA is somewhat related to the user's interests in Information Retrieval, particularly in the context of Knowledge Graph Question Answering. However, it focuses more on the collaboration between specialized and general models, rather than query understanding, ranking models, or user behavior modeling. While it touches on aspects of real-time relevance optimization, it is not a central match for the user's primary research themes.
...
### 12. Scalable Prompt Routing via Fine-Grained Latent Task Discovery
...
- **URL**: <http://arxiv.org/abs/2603.19415v1>
- **Submitted**: 2026-03-19 19:15:51
- **Topic Keywords**: query
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it focuses on large language models and prompt routing, which is not a central match to your core themes. While it involves task discovery and quality estimation, it does not directly relate to query understanding, ranking models, or user behavior modeling. Nevertheless, the paper's emphasis on fine-grained task discovery and task-aware quality estimation might be of interest to you in the context of NLP and related topics.
...
### 13. Breaking the Capability Ceiling of LLM Post-Training by Reintroducing Markov States

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yurun Yuan, Tengyang Xie
- **URL**: <http://arxiv.org/abs/2603.19987v1>
- **Submitted**: 2026-03-20 14:35:49
- **Topic Keywords**: rag
- **Reason**: This paper explores the application of Markov states in post-training Large Language Models, which is somewhat related to ranking models and query understanding in Information Retrieval. However, the focus on Generative AI and logic puzzles is not directly aligned with the user's core research themes in e-commerce and real-time relevance optimization.
...
### 14. EvoTaxo: Building and Evolving Taxonomy from Social Media Streams

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yiyang Li, Tianyi Ma, Yanfang Ye
- **URL**: <http://arxiv.org/abs/2603.19711v1>
- **Submitted**: 2026-03-20 07:33:29
- **Topic Keywords**: rag
- **Reason**: The paper discusses taxonomy induction from social media streams, which is somewhat related to information retrieval and NLP. However, the focus on taxonomy construction and evolution is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's use of LLMs and clustering techniques is relevant to NLP, but the specific application to taxonomy induction is not a central match for the user's research themes.
...
### 15. CO-EVOLVE: Bidirectional Co-Evolution of Graph Structure and Semantics for Heterophilous Learning

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Jinming Xing, Muhammad Shahzad
- **URL**: <http://arxiv.org/abs/2603.19596v1>
- **Submitted**: 2026-03-20 03:15:17
- **Topic Keywords**: rag
- **Reason**: The paper explores the integration of Large Language Models and Graph Neural Networks, which is somewhat related to the user's interests in Information Retrieval and Natural Language Processing. However, the focus on graph structure and semantics, while interesting, does not directly align with the user's primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 16. FDARxBench: Benchmarking Regulatory and Clinical Reasoning on FDA Generic Drug Assessment

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Betty Xiong, Jillian Fisher, Benjamin Newman, Meng Hu, Shivangi Gupta, Yejin Choi, Lanyan Fang, Russ B Altman
- **URL**: <http://arxiv.org/abs/2603.19539v1>
- **Submitted**: 2026-03-20 00:33:58
- **Comment**: 4 pages, 2 figures
- **Topic Keywords**: retrieval
- **Reason**: This paper introduces a benchmark for evaluating question-answering on FDA drug label documents, which involves natural language processing and document-grounded reasoning. While it touches on aspects of information retrieval and question understanding, its primary focus is on regulatory and clinical reasoning, which is somewhat related to the user's interests in IR and NLP. However, the specific domain and application are not directly aligned with the user's core research themes.
...
### 17. An Empirical Study of SFT-DPO Interaction and Parameterization in Small Language Models

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Yuming Feng, Christy Yang
- **URL**: <http://arxiv.org/abs/2603.20100v1>
- **Submitted**: 2026-03-20 16:27:03
- **Topic Keywords**: rank
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on small language models and parameterization, which is not a central match to your primary focus on information retrieval and real-time relevance optimization.
...
### 18. DALI: LLM-Agent Enhanced Dual-Stream Adaptive Leadership Identification for Group Recommendations

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Boxun Song, Min Gao, Jiawei Cheng
- **URL**: <http://arxiv.org/abs/2603.19909v1>
- **Submitted**: 2026-03-20 12:47:17
- **Comment**: under review
- **Topic Keywords**: recommend
- **Reason**: The paper explores group recommendation systems, which is somewhat related to information retrieval, but it focuses on recommender systems and does not directly address query understanding, ranking models, or user behavior modeling. The use of Large Language Models (LLMs) and neural network-based representation learning is relevant to NLP, but the application is different from the user's primary interests in IR and real-time relevance optimization.
...
### 19. How Well Does Generative Recommendation Generalize?
...
- **URL**: <http://arxiv.org/abs/2603.19809v1>
- **Submitted**: 2026-03-20 09:48:57
- **Topic Keywords**: recommend
- **Reason**: This paper explores generative recommendation models, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on recommendation systems and memorization-aware indicators is not a central match to your primary research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 20. From Token to Item: Enhancing Large Language Models for Recommendation via Item-aware Attention Mechanism

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Xiaokun Zhang, Bowei He, Jiamin Chen, Ziqiang Cui, Chen Ma
- **URL**: <http://arxiv.org/abs/2603.19693v1>
- **Submitted**: 2026-03-20 06:56:59
- **Comment**: This work has been accepted by WWW 2026
- **Topic Keywords**: recommend
- **Reason**: The paper explores the application of Large Language Models in recommendation systems, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on recommender systems and the specific attention mechanism proposed in the paper do not directly align with your primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 21. Inducing Sustained Creativity and Diversity in Large Language Models

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Queenie Luo, Gary King, Michael Puett, Michael D. Smith
- **URL**: <http://arxiv.org/abs/2603.19519v1>
- **Submitted**: 2026-03-19 23:13:10
- **Topic Keywords**: search
- **Reason**: The paper explores a subset of exploratory search, which is related to information retrieval, but its focus on large language models and inducing creativity and diversity in search results is somewhat tangential to the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 22. Adaptive Greedy Frame Selection for Long Video Understanding

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Yuning Huang, Fengqing Zhu
- **URL**: <http://arxiv.org/abs/2603.20180v1>
- **Submitted**: 2026-03-20 17:55:32
- **Topic Keywords**: query, relevance, rag
- **Reason**: This paper focuses on long video understanding and proposes a method for adaptive frame selection, which is not directly related to information retrieval, query understanding, or ranking models. While it involves natural language processing through question relevance, it's primarily a computer vision problem and does not align with the user's core research themes.
...
### 23. Span-Level Machine Translation Meta-Evaluation

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Stefano Perrella, Eric Morales Agostinho, Hugo Zaragoza
- **URL**: <http://arxiv.org/abs/2603.19921v1>
- **Submitted**: 2026-03-20 13:08:19
- **Comment**: 18 pages, 4 figures
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper focuses on Machine Translation (MT) evaluation, which is not a core area of your research interests in Information Retrieval and Search technologies. While it touches on evaluation techniques, it does not relate to your specific interests in query understanding, ranking models, user behavior modeling, or deep semantic understanding in IR.
...
### 24. DataProphet: Demystifying Supervision Data Generalization in Multimodal LLMs

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Xuan Qi, Luxi He, Dan Roth, Xingyu Fu
- **URL**: <http://arxiv.org/abs/2603.19688v1>
- **Submitted**: 2026-03-20 06:42:26
- **Comment**: 14 pages
- **Topic Keywords**: ranking, rank, acl
- **Reason**: This paper appears to be focused on multimodal large language models and their supervision data generalization, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on related topics like deep semantic understanding, the context and methodology seem to be more aligned with NLP and deep learning, rather than IR and search technologies.
...
### 25. The Prosocial Ranking Challenge: Reducing Polarization on Social Media without Sacrificing Engagement
...
- **URL**: <http://arxiv.org/abs/2603.19626v1>
- **Submitted**: 2026-03-20 04:10:56
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper focuses on social media algorithms and their impact on societal outcomes, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on ranking models, the context is specific to social media and does not align with the user's interests in e-commerce or deep semantic understanding.
...
### 26. VideoSeek: Long-Horizon Video Agent with Tool-Guided Seeking

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Jingyang Lin, Jialian Wu, Jiang Liu, Ximeng Sun, Ze Wang, Xiaodong Yu, Jiebo Luo, Zicheng Liu, Emad Barsoum
- **URL**: <http://arxiv.org/abs/2603.20185v1>
- **Submitted**: 2026-03-20 17:58:47
- **Comment**: Accepted at CVPR 2026
- **Topic Keywords**: query, rag
- **Reason**: The paper focuses on video agentic models and video understanding, which is somewhat related to information retrieval and NLP, but it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 27. Measuring Faithfulness Depends on How You Measure: Classifier Sensitivity in LLM Chain-of-Thought Evaluation

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Richard J. Young
- **URL**: <http://arxiv.org/abs/2603.20172v1>
- **Submitted**: 2026-03-20 17:48:43
- **Comment**: 14 pages, 4 figures, 5 tables
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on evaluating the faithfulness of Large Language Models (LLMs) using different classifiers, which is a topic in NLP, but not directly related to your core research themes.
...
### 28. BEAVER: A Training-Free Hierarchical Prompt Compression Method via Structure-Aware Page Selection

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Zhengpei Hu, Kai Li, Dapeng Fu, Chang Zeng, Yue Li, Yuanhao Tang, Jianqiang Huang
- **URL**: <http://arxiv.org/abs/2603.19635v1>
- **Submitted**: 2026-03-20 04:35:04
- **Comment**: Technical Report
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on improving the efficiency of Large Language Models (LLMs) through a novel compression method called BEAVER. While it touches on the topic of information utilization, it does not directly relate to information retrieval, query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 29. A Super Fast K-means for Indexing Vector Embeddings

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Leonardo Kuffo, Sven Hepkema, Peter Boncz
- **URL**: <http://arxiv.org/abs/2603.20009v1>
- **Submitted**: 2026-03-20 14:52:38
- **Topic Keywords**: retrieval, search
- **Reason**: This paper focuses on clustering high-dimensional vector embeddings for vector similarity search tasks, which is somewhat related to information retrieval. However, the topic is more aligned with data mining and NLP, and the paper does not explicitly address query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 30. FedPDPO: Federated Personalized Direct Preference Optimization for Large Language Model Alignment

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Kewen Zhu, Liping Yi, Zhiming Zhao, Zhuang Qi, Han Yu, Qinghua Hu
- **URL**: <http://arxiv.org/abs/2603.19741v1>
- **Submitted**: 2026-03-20 08:24:49
- **Comment**: under review
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on large language model alignment in federated learning, which is not directly related to information retrieval or search technologies. While it involves optimization techniques, the context is more aligned with NLP and recommender systems, but the specific problem and solution do not match the user's core research themes.
...
### 31. Semantic Token Clustering for Efficient Uncertainty Quantification in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Qi Cao, Andrew Gambardella, Takeshi Kojima, Yutaka Matsuo, Yusuke Iwasawa
- **URL**: <http://arxiv.org/abs/2603.20161v1>
- **Submitted**: 2026-03-20 17:37:33
- **Comment**: EACL 2026
- **Topic Keywords**: rag
- **Reason**: This paper focuses on uncertainty quantification in Large Language Models, which is a topic related to NLP. However, it does not directly relate to information retrieval, query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 32. When Contextual Inference Fails: Cancelability in Interactive Instruction Following

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Natalia Bila, Kata Naszádi, Alexandra Mayn, Christof Monz
- **URL**: <http://arxiv.org/abs/2603.19997v1>
- **Submitted**: 2026-03-20 14:46:59
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on a psycholinguistic paradigm and the evaluation of Large Language Models (LLMs) in resolving ambiguity through contextual inference. While it touches on aspects of modeling user behavior, it is not directly related to information retrieval, search technologies, or query understanding, which are the core areas of your research interests.
...
### 33. LoopRPT: Reinforcement Pre-Training for Looped Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Guo Tang, Shixin Jiang, Heng Chang, Nuo Chen, Yuhan Li, Huiming Fan, Jia Li, Ming Liu, Bing Qin
- **URL**: <http://arxiv.org/abs/2603.19714v1>
- **Submitted**: 2026-03-20 07:35:38
- **Topic Keywords**: rag
- **Reason**: This paper focuses on looped language models and reinforcement pre-training, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it touches on deep semantic understanding, it's more aligned with NLP and related topics, but not a central match for your research interests.
...
### 34. Structured Prompting for Arabic Essay Proficiency: A Trait-Centric Evaluation Approach

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Salim Al Mandhari, Hieu Pham Dinh, Mo El-Haj, Paul Rayson
- **URL**: <http://arxiv.org/abs/2603.19668v1>
- **Submitted**: 2026-03-20 06:05:04
- **Comment**: 13 pages
- **Topic Keywords**: rag
- **Reason**: This paper is primarily focused on Automatic Essay Scoring (AES) in Arabic, which is not a core area of interest for you. While it involves Natural Language Processing (NLP) and large language models, the context and application are quite different from your research interests in Information Retrieval and Search technologies.
...
### 35. Vocabulary shapes cross-lingual variation of word-order learnability in language models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jonas Mayer Martins, Jaap Jumelet, Viola Priesemann, Lisa Beinborn
- **URL**: <http://arxiv.org/abs/2603.19427v1>
- **Submitted**: 2026-03-19 19:42:21
- **Comment**: Submitted to ACL 2026. 17 pages, 11 figures
- **Topic Keywords**: ctr
- **Reason**: This paper appears to be primarily focused on language models and their ability to learn word order in different languages, which is not directly related to your core research themes in Information Retrieval and Search technologies. While it touches on the concept of model surprisal, it does not seem to be relevant to your interests in query understanding, ranking models, or user behavior modeling.
...
### 36. Evaluating Evidence Grounding Under User Pressure in Instruction-Tuned Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Sai Koneru, Elphin Joe, Christine Kirchhoff, Jian Wu, Sarah Rajtmajer
- **URL**: <http://arxiv.org/abs/2603.20162v1>
- **Submitted**: 2026-03-20 17:38:23
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are core areas of your research interests. While it touches on Natural Language Processing, the focus is on instruction-tuned language models and their interaction with user pressure, which is not a central theme in your research.
...
### 37. An Agentic Approach to Generating XAI-Narratives

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yifan He, David Martens
- **URL**: <http://arxiv.org/abs/2603.20003v1>
- **Submitted**: 2026-03-20 14:49:23
- **Topic Keywords**: search
- **Reason**: This paper focuses on Explainable AI (XAI) and narrative generation, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on language models, the context is XAI and narrative generation, rather than query understanding, ranking models, or user behavior modeling.
...
### 38. SAGE: Sustainable Agent-Guided Expert-tuning for Culturally Attuned Translation in Low-Resource Southeast Asia

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Zhixiang Lu, Chong Zhang, Yulong Li, Angelos Stefanidis, Anh Nguyen, Imran Razzak, Jionglong Su, Zhengyong Jiang
- **URL**: <http://arxiv.org/abs/2603.19931v1>
- **Submitted**: 2026-03-20 13:18:08
- **Comment**: Accepted by WWW 2026
- **Topic Keywords**: rank
- **Reason**: This paper focuses on culturally attuned translation in low-resource Southeast Asia, using a novel framework called SAGE. While it involves natural language processing and optimization techniques, it is primarily concerned with translation and sustainability, which is not directly related to your core research interests in information retrieval, search technologies, and user behavior modeling.
...
### 39. Translation from the Information Bottleneck Perspective: an Efficiency Analysis of Spatial Prepositions in Bitexts

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Antoine Taroni, Ludovic Moncla, Frederique Laforest
- **URL**: <http://arxiv.org/abs/2603.19924v1>
- **Submitted**: 2026-03-20 13:09:33
- **Topic Keywords**: rank
- **Reason**: This paper explores the Information Bottleneck framework in the context of translation, which is somewhat related to information retrieval, but the focus on translation and linguistic stimuli is not central to your research interests.
...
### 40. TAB-AUDIT: Detecting AI-Fabricated Scientific Tables via Multi-View Likelihood Mismatch

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Shuo Huang, Yan Pen, Lizhen Qu
- **URL**: <http://arxiv.org/abs/2603.19712v1>
- **Submitted**: 2026-03-20 07:33:54
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on NLP, its focus is on detecting AI-generated scientific tables, which is not a primary area of interest for the user.
