...
### 1. R$^2$-Searcher: Calibrating Retrieval and Reasoning Boundaries for Agentic Search

- **LLM Score**: 9
- **Keyword Score**: 9
- **Authors**: Sheng Zhang, Junyi Li, Wenlin Zhang, Xiaowei Qian, Yichao Wang, Yingyi Zhang, Maolin Wang, Yong Liu, Xiangyu Zhao
- **URL**: <http://arxiv.org/abs/2606.28566v1>
- **Submitted**: 2026-06-26 19:44:34
- **Topic Keywords**: query, queries, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding, ranking models, and user behavior modeling. The proposed framework, R$^2$-Searcher, explicitly explores and calibrates the retrieval and reasoning boundaries, which is a key aspect of deep semantic understanding and real-time relevance optimization. The paper's focus on multi-hop reasoning and complex question answering also aligns with your interests in NLP and related topics.
...
### 2. SABER-Math: Automated Benchmark for Information Retrieval Evaluation in Mathematics
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of mathematical IR. The authors introduce a new benchmark, SABER-Math, which addresses the need for fine-grained mathematical relevance evaluation. While the focus is on mathematics, the techniques and challenges discussed are applicable to your broader interests in IR and NLP.
...
- **URL**: <http://arxiv.org/abs/2606.28737v1>
- **Submitted**: 2026-06-27 05:13:49
- **Topic Keywords**: retriever, dense retrieval, query, ranking, rerank, rag, retrieval augmented generation, retrieval, rank
- **Reason**: This paper is highly relevant to the field of Information Retrieval, particularly in the area of multi-turn Retrieval Augmented Generation (RAG) systems. The use of deep learning models, such as LLM-based reranking, aligns with the user's interests in query understanding and ranking models. However, the focus on SemEval-2026 Task 8 and the specific application to MTRAGEval may limit its generalizability to other domains.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The focus on large language models (LLMs) as rerankers and the introduction of a validation-trained learned hybrid fusion layer (LHF) as a retrieval-side realizability baseline aligns with your interests in deep semantic understanding and real-time relevance optimization.
...
### 5. Covering the Unseen: Information Demand Coverage Optimization for Retrieval-Augmented Generation

- **LLM Score**: 8
- **Keyword Score**: 17
- **Authors**: Bingxue Zhang, Jianying Jia, Feida Zhu
- **URL**: <http://arxiv.org/abs/2606.29328v1>
- **Submitted**: 2026-06-28 10:49:04
- **Comment**: 12 pages, 5 figures, 13 tables
- **Topic Keywords**: query, queries, ranking, rerank, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The proposed method, GeoRAG, addresses the limitations of traditional ranking-based selection and provides a novel approach to context selection, which is a key aspect of information retrieval. The paper's focus on unsupervised, training-free, and retrieval-agnostic methods also aligns with your interests in real-time relevance optimization.
...
### 6. Query-Aware Spreading Activation for Multi-Hop Retrieval over Knowledge Graphs
...
- **Reason**: This paper is highly relevant to Information Retrieval, specifically multi-hop retrieval over knowledge graphs, which aligns with your interests in query understanding and ranking models. The proposed method also leverages semantic understanding, a key aspect of your research focus.
...
### 7. Field Order Should Not Matter: Permutation-Invariant Embedding Model Fine-Tuning for Structured Metadata Retrieval
...
### 8. Know Before You Fetch: Calibrated Retrieval-Budget Allocation for Retrieval-Augmented Generation
...
- **Reason**: This paper is highly relevant to information retrieval and search technologies, specifically in the context of retrieval-augmented generation. The authors propose a novel approach to adaptive retrieval-budget allocation, which aligns with my research interests in query understanding and ranking models. However, the focus on natural language processing and generation aspects slightly reduces the score.
...
### 9. KbSD: Knowledge Boundary aware Self-Distillation for Behavioral Calibration in Agentic Search
...
- **Reason**: This paper explores agentic search, a topic related to search technologies, and proposes a framework (KbSD) for knowledge boundary calibration. While not directly focused on query understanding, ranking models, or user behavior modeling, it does involve dynamic retrieval abilities and calibrated decisions, which are relevant to information retrieval. The paper's use of reinforcement learning and dense token-level supervision also aligns with broader interests in NLP and data mining.
...
### 10. LC-ICL: Label-Guided Contrastive In-Context Learning for Robust Information Extraction

- **LLM Score**: 8
- **Keyword Score**: 5
- **Authors**: Xiao You, Tianwei Yan, Shan Zhao
- **URL**: <http://arxiv.org/abs/2606.29407v1>
- **Submitted**: 2026-06-28 14:01:52
- **Topic Keywords**: rag, ctr, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. Although it focuses on Information Extraction, it leverages large language models and in-context learning, which are related to your interests in query understanding and ranking models. The paper's emphasis on robustness and real-time relevance optimization also aligns with your research goals.
...
### 11. From Extraction to Navigation: Progressive Retrieval with Indirectly Infinite Depth
...
- **Reason**: This paper presents a novel framework for recommender retrieval, focusing on dynamic item space navigation and addressing issues like 'search drift' and 'interest tunnel'. While it's primarily focused on recommender systems, the concepts of stateful autonomous graph exploration and trajectory-aligned training are relevant to information retrieval and search technologies. However, the specific application domain and terminology differ from the user's core research themes.
...
### 12. Metadata, Structure, or Strategy? A Decomposition of RAG Context Enrichment
...
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of Retrieval-Augmented Generation (RAG) systems, which is a key area of interest. The study's focus on evaluating the impact of metadata, structure, and strategy on RAG performance aligns with your interests in query understanding and ranking models. However, the paper's specific focus on RAG systems and their design may not be a central match to your broader interests in IR and NLP.
...
### 13. AB-RAG: Adaptive Budgeted Retrieval-Augmented Generation for Reliable Question Answering

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Ansh Kamthan
- **URL**: <http://arxiv.org/abs/2606.29090v1>
- **Submitted**: 2026-06-27 21:08:14
- **Comment**: 16 pages, 9 figures, 12 tables
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper on Retrieval-Augmented Generation (RAG) for question answering aligns with your interests in Information Retrieval and Natural Language Processing, particularly in query understanding and ranking models. The adaptive budgeted framework presented in the paper shows promise in improving accuracy and real-time relevance optimization, which are core themes in your research.
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, the focus on telecom question answering and retrieval-augmented generation (RAG) is somewhat niche and not directly aligned with your primary interests in e-commerce and deep semantic understanding. Nevertheless, the use of adaptive retriever optimization and contrastive objectives is relevant to your interests in query-side adaptation and real-time relevance optimization.
...
- **Reason**: This paper explores a novel approach to information retrieval, 'local-first IR', which prioritizes user device-based indexing and inference. While it touches on search technologies and ranking models, its primary focus is on privacy and control, which is somewhat related to your interests in query understanding and user behavior modeling. However, the paper's emphasis on local device processing and its implications for search scope rather than quality may not be a central match for your research themes.
...
### 16. Hybrid Retriever Evolution for Multimodal Document Reasoning Agents
...
- **Reason**: This paper explores multimodal document understanding and retrieval orchestration, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on multimodal document reasoning and autonomous multi-agent coordination is not a central match to your primary research interests in IR and NLP. The paper's emphasis on adaptive routing and evidence composition is an interesting aspect, but it does not directly align with your core themes.
...
### 17. Anisotropy Decides Cosine vs. Rank Metrics for Text Embeddings
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of text embeddings and similarity metrics. However, the focus on geometric conditions and anisotropy in the embedding space is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores the concept of Neural Procedural Memory for empowering Large Language Model (LLM) agents with implicit activation steering. While it touches on the idea of task execution and memory management, it doesn't directly relate to information retrieval, search technologies, or query understanding, which are core areas of your research interests. However, the paper's focus on deep semantic understanding and real-time relevance optimization might be tangentially relevant to your work in NLP and related topics.
...
### 19. Efficient Retrieval-Augmented Generation via Token Co-occurrence Graphs
...
- **Reason**: The paper discusses Retrieval-Augmented Generation (RAG) and proposes an efficient framework called TIGRAG. While it touches on aspects of query understanding and ranking models, its primary focus is on improving the efficiency of RAG methods for multi-hop reasoning in Question Answering tasks. Although it's related to IR and NLP, it's not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.
...
### 20. POEM: Partial-Order Enhanced Real-Time Sequential Modeling for Recommendation
...
- **Reason**: The paper POEM is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in the context of real-time recommendation systems. However, it focuses more on recommender systems and sequential modeling, which is not your primary area of interest. While it involves ranking models and user behavior modeling, the application domain is different from your background in e-commerce.
...
### 21. mamabench and mamaretrieval: Benchmarks for Evaluating Medical Retrieval-Augmented Generation in Maternal, Neonatal, and Reproductive Health

- **LLM Score**: 4
- **Keyword Score**: 14
- **Authors**: Yi Ren
- **URL**: <http://arxiv.org/abs/2606.29467v1>
- **Submitted**: 2026-06-28 15:51:53
...
- **Reason**: The paper appears to be related to Information Retrieval, specifically in the medical domain, with a focus on evaluating retrieval-augmented generation. However, it does not directly align with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's focus on medical question-answering and benchmarking is somewhat relevant to the user's interests in NLP and data mining, but it is not a central match.
...
### 22. CMSL: Constructive Multi-Sequence Learning for Recommendation Systems
...
- **Submitted**: 2026-06-26 18:32:43
- **Topic Keywords**: ranking, rag, user behavior, retrieval, recommend, rank
- **Reason**: The paper focuses on recommendation systems, which is related to your research interests in Information Retrieval and Search technologies. However, it primarily deals with sequence learning and recommendation systems, which is somewhat tangential to your core interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on deep semantic understanding and real-time relevance optimization is not explicitly mentioned, but it does involve context engineering and attention mechanisms, which might be of some interest.
...
### 23. Mandol: An Agglomerative Agent Memory System for Long-Term Conversations
...
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper proposes a novel memory system for long-term conversations, which is somewhat related to information retrieval and NLP. However, the focus on conversational agents and memory systems is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling.
...
### 24. Reproducing FACTER: Fairness via Conformal Thresholding and Prompt Repair

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Oscar Miró López-Feliu, Daimy van Loo, Xanthos Kekkos, Mikel Blom, Clara Rus
- **URL**: <http://arxiv.org/abs/2606.28620v1>
- **Submitted**: 2026-06-26 21:37:01
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it deals with fairness and statistical coverage in LLM-based recommendation. However, the focus on recommender systems and the specific framework of FACTER, while interesting, does not align with the user's primary focus on query understanding, ranking models, and user behavior modeling. The paper's emphasis on fairness and evaluation metrics also diverges from the user's interest in real-time relevance optimization.
...
### 25. Regime-Aware Peer Specialization for Robust RAG under Heterogeneous Knowledge Conflicts
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it deals with retrieval-augmented generation and conflict resolution in knowledge retrieval. However, the focus on regime-aware peer specialization and conflict resolution in language models is not directly aligned with the user's primary research themes of query understanding, ranking models, and user behavior modeling.
...
### 26. Information Dynamics of Language Communication
...
- **Reason**: The paper explores information dynamics in language communication, leveraging large language models and information-theoretic frameworks. While it touches on aspects of semantic understanding, it is not directly focused on query understanding, ranking models, or user behavior modeling in the context of search technologies. The paper's relevance to IR and NLP is somewhat tangential, but it may be of interest for those exploring the broader applications of language models and information theory.
...
### 27. Memory-Managed Long-Context Attention: A Preliminary Study of Editable Request-Local Memory

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Junyi Zou, Avrova Donz
- **URL**: <http://arxiv.org/abs/2606.28876v1>
- **Submitted**: 2026-06-27 11:38:43
- **Comment**: 14 pages, 2 figures, 4 tables. Preliminary technical report
- **Topic Keywords**: query, search, acl
- **Reason**: This paper explores memory management for long-context attention in language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on memory management and language models is not directly aligned with the user's primary research interests in IR, search technologies, and user behavior modeling.
...
### 28. Little Brains, Big Feats: Exploring Compact Language Models
...
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper explores compact language models, which is related to NLP, but it doesn't directly address query understanding, ranking models, or user behavior modeling in IR, which are core areas of interest. The focus on small language models and their application in Retrieval-Augmented Generation (RAG) systems is somewhat relevant to IR, but it's not a central match.
...
### 29. How Far Do On-Prem Open LLMs Get on Text-to-SQL? A Cross-Family Size x Technique Frontier on BIRD
...
- **Reason**: This paper explores the performance of on-premises open Large Language Models (LLMs) on Text-to-SQL tasks, which is somewhat related to information retrieval and NLP. However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on LLMs and their applications is tangentially relevant to the user's research interests.
...
### 30. Evidence-Informed LLM Beliefs for Continual Scientific Discovery

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Dhruv Agarwal, Reece Adamson, Andrew McCallum, Peter Clark, Ashish Sabharwal, Bodhisattwa Prasad Majumder
- **URL**: <http://arxiv.org/abs/2606.29182v1>
- **Submitted**: 2026-06-28 04:06:12
- **Topic Keywords**: rag, retrieval, search
- **Reason**: The paper explores the application of large language models in scientific discovery, focusing on belief updating and search procedures. While it touches on aspects of query understanding and ranking models, its primary focus is on a specific domain (scientific discovery) and does not directly relate to the user's core research themes in Information Retrieval and Search technologies. However, the paper's use of evidence-informed LLM beliefs and non-stationary surprisal may be of interest to the user's broader interests in NLP and data mining.
...
### 31. Multi-Agent Routing as Set-Valued Prediction: A WildChat Benchmark and Cost-Aware Evaluation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Ananto Nayan Bala, Faisal Muhammad Shah
- **URL**: <http://arxiv.org/abs/2606.28925v1>
- **Submitted**: 2026-06-27 13:59:46
- **Comment**: 9 pages, 8 figures. Under review at ACM RecSys 2026
- **Topic Keywords**: query, rag
- **Reason**: This paper is somewhat related to information retrieval, but its focus on multi-agent routing and set-valued prediction is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. While it involves natural-language prompts and AI-assisted evaluation, the context is more geared towards routing and recommendation systems rather than deep semantic understanding and real-time relevance optimization.
...
### 32. Morphing into Hybrid Attention Models
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on improving the efficiency of Transformer models through hybrid attention mechanisms, which is somewhat related to the user's interests in information retrieval and ranking models. However, the specific application to natural language processing and the emphasis on scalability and efficiency in the e-commerce domain do not strongly align with the user's core research themes.
...
### 33. Multi-Agentic System Leveraging Open-Source LLMs to Mitigate Disinformation Threats
...
- **Reason**: The paper explores a multi-agent system for disinformation detection, leveraging open-source LLMs. While it touches on AI and NLP, it is not directly related to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 34. Do Recommendation Algorithms Work When Users Are LLM Agents? A Case Study on Moltbook
...
### 35. Fast Numbers, Slow Language: Bridging Quantitative and Qualitative Earnings Signals
...
- **Reason**: This paper appears somewhat related to the user's interests in Natural Language Processing (NLP) and its application in understanding and analyzing language-based signals. However, the focus on earnings announcements and financial news, rather than general search or information retrieval, limits its relevance to the user's core research themes.
...
### 36. Multimodal Graph RAG for Long-range Visually Rich Document Understanding

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Yi-Cheng Wang, Chu-Song Chen
- **URL**: <http://arxiv.org/abs/2606.28780v1>
- **Submitted**: 2026-06-27 07:14:31
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores multimodal graph-based approaches for visually rich document understanding, which is somewhat related to information retrieval and NLP. However, the focus on visual question answering and knowledge graph construction is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on multimodal large language models and visual document understanding is tangentially relevant to the user's background in e-commerce and NLP.
...
### 37. Research Entity Extraction and Topic Detection from UKRI Grant Proposals
...
- **Reason**: The paper is somewhat related to information retrieval, specifically entity extraction and topic detection, but it focuses on a specific domain (UKRI Grant Proposals) and application (LLM-based approaches) that is not directly aligned with the user's core research themes in IR and search technologies.
...
### 38. MemDelta: Controlled Baselines and Hidden Confounds in Agent Memory Evaluation
...
- **Reason**: This paper focuses on evaluating agent memory systems, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of model evaluation and comparison, the context and methodology are primarily from the field of artificial intelligence and machine learning, making it less relevant to your research.
...
### 39. MAM-AI: An On-Device Medical Retrieval-Augmented Generation System for Nurses and Midwives in Zanzibar
...
- **Reason**: This paper is not relevant to your research interests as it focuses on a medical retrieval system for nurses and midwives in Zanzibar, which is outside the scope of information retrieval, search technologies, and natural language processing in the e-commerce domain or other areas you're interested in.
...
### 40. Legal Domain Adaptation of Modern BERT Models

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Dominik Stammbach, Peter Henderson
- **URL**: <http://arxiv.org/abs/2606.28538v1>
- **Submitted**: 2026-06-26 18:44:11
- **Comment**: To appear in Proceedings of the 21st International Conference on Artificial Intelligence and Law (ICAIL 2026), June 9-12, 2026, Singapore
- **Topic Keywords**: query, rerank, rank, search
- **Reason**: This paper focuses on domain adaptation of BERT models in the legal domain, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves BERT, a relevant topic, the application is specific to the legal domain and does not address query understanding, ranking models, or user behavior modeling.
...
### 41. Deterministic Decisions for High-Stakes AI. A Zero-Egress Pipeline with the Deployability of RAG and the Accuracy of Machine Learning

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Craig Atkinson
- **URL**: <http://arxiv.org/abs/2606.29280v1>
- **Submitted**: 2026-06-28 08:58:17
...
- **Topic Keywords**: rag, retrieval, recommend, acl
- **Reason**: This paper focuses on high-stakes AI decision-making, specifically addressing intervention bias in zero-shot large-language-model educational advisory agents. While it involves machine learning and NLP, the context and topics discussed are not directly related to information retrieval, search technologies, or user behavior modeling, which are the primary areas of interest.
...
- **Reason**: This paper focuses on proactive routing for efficient visual reasoning, which is not directly related to information retrieval, search technologies, or query understanding. While it involves multimodal models and routing signals, the context is visual reasoning rather than text-based search or retrieval.
...
### 43. SurrogateShield: Beyond Redaction for High-Utility, Privacy-Preserving LLM Interactions
...
- **Topic Keywords**: query, queries
- **Reason**: This paper focuses on privacy-preserving LLM interactions, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is more about data protection and security rather than query understanding, ranking models, or user behavior modeling.
...
### 44. The Hidden Cost of Resampling: How Imbalance Correction Degrades Probability Calibration in Tree Ensembles
...
- **Reason**: This paper focuses on class-imbalanced classification and the impact of resampling methods on probability calibration in tree ensembles. While it touches on ensemble models, which are related to Learning to Rank, the primary topic is not directly relevant to Information Retrieval or Search technologies, nor does it involve query understanding, ranking models, or user behavior modeling.
...
### 45. UCOB: Learning to Utilize and Evolve Agentic Skills via Credit-Aware On-Policy Bidirectional Self-Distillation
...
- **Submitted**: 2026-06-28 17:02:18
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper appears to be focused on agentic reinforcement learning, skill memories, and self-distillation methods, which are not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves tasks like Search-QA, the context is not about query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's interests.
...
### 46. Understanding Evaluation Illusion in Diffusion Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Hengxiang Zhang, Jiaxi Ren, Hongxin Wei
- **URL**: <http://arxiv.org/abs/2606.29228v1>
- **Submitted**: 2026-06-28 06:31:36
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper focuses on the evaluation of decoding methods for diffusion large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on ranking models, the context is specific to language models and does not align with your primary focus on real-time relevance optimization and deep semantic understanding.
...
### 47. When Is a Draft Accepted? A Theory of Acceptance in Speculative Decoding
...
- **Reason**: This paper appears to be primarily focused on speculative decoding in language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on topics like ranking and acceptance criteria, the context is specific to language models and decoding, making it less relevant to your research.
...
### 48. AURORA: Asymmetry and Update-Induced Rotation for Robust Hallucination Detection in Large Language Models
...
- **Reason**: This paper focuses on hallucination detection in Large Language Models, which is a topic related to NLP but not directly relevant to Information Retrieval, Search technologies, or query understanding. While it involves deep semantic understanding, the context is not aligned with the user's primary research interests.
...
### 49. Preference-ASR: A Preference-Aware Test Set for Benchmarking ASR in the Era of Speech LLMs

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Nithin Rao Koluguri, Sasha Meister, Nikolay Karpov, Piotr Zelasko, Desh Raj, Jagadeesh Balam, Boris Ginsburg
- **URL**: <http://arxiv.org/abs/2606.29534v1>
- **Submitted**: 2026-06-28 17:57:41
- **Comment**: Accepted at Interspeech 2026
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on speech recognition and its evaluation, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves a Learning to Rank aspect, the context is specific to speech recognition and does not align with the user's primary interests in query understanding, user behavior modeling, or e-commerce domain.
...
### 50. Conversational Domain Adaptation of IndicTrans2 across 21 Indic Languages via Experience Replay and Model Soups

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Aditya Pratap Singh
- **URL**: <http://arxiv.org/abs/2606.29024v1>
- **Submitted**: 2026-06-27 17:43:01
...
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on conversational domain adaptation of a translation system, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and techniques used are not aligned with your areas of focus.
