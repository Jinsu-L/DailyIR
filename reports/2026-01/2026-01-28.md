# Daily Papers Report - 2026-01-28

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. LURE-RAG: Lightweight Utility-driven Reranking for Efficient RAG

- **LLM Score**: 8
- **Keyword Score**: 23
- **Authors**: Manish Chandra, Debasis Ganguly, Iadh Ounis
- **URL**: <http://arxiv.org/abs/2601.19535v1>
- **Submitted**: 2026-01-27 12:26:31
- **Topic Keywords**: retriever, query, ranking, rerank, listwise, relevance, rag, retrieval, rank
- **Reason**: This paper proposes a novel approach to Retrieval-Augmented Generation (RAG) that focuses on utility-driven reranking, which is closely related to query understanding and ranking models in Information Retrieval. Although it's not directly focused on e-commerce, the techniques and concepts presented can be applied to various domains. The use of LambdaMART-based reranker and listwise ranking loss is particularly relevant to Learning to Rank and ranking models.
...
### 2. Comparing how Large Language Models perform against keyword-based searches for social science research data discovery
...
- **Submitted**: 2026-01-27 12:51:45
- **Topic Keywords**: semantic search, queries, ranking, relevance, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The comparison of large language models with keyword-based searches for data discovery aligns with your focus on deep semantic understanding and real-time relevance optimization. The use of BERT embeddings and cosine similarity measures also relates to your interests in NLP.
...
### 3. When Iterative RAG Beats Ideal Evidence: A Diagnostic Study in Scientific Multi-hop Question Answering

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Mahdi Astaraki, Mohammad Arshi Saloot, Ali Shiraee Kasmaee, Hamidreza Mahyar, Soheila Samiee
- **URL**: <http://arxiv.org/abs/2601.19827v1>
- **Submitted**: 2026-01-27 17:35:05
- **Comment**: 27 pages, 15 figures
- **Topic Keywords**: query, rag, retrieval, acl
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The study focuses on Retrieval-Augmented Generation (RAG) and its application in scientific multi-hop question answering, which aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on NLP and question answering is slightly outside your core area of IR, but its relevance to your broader interests in search technologies and related topics is still significant.
...
### 4. RPO-RAG: Aligning Small LLMs with Relation-aware Preference Optimization for Knowledge Graph Question Answering

- **LLM Score**: 8
- **Keyword Score**: 7
- **Authors**: Kaehyun Um, KyuHwan Yeom, Haerim Yang, Minyoung Choi, Hyeongjun Yang, Kyong-Ho Lee
- **URL**: <http://arxiv.org/abs/2601.19225v2>
- **Submitted**: 2026-01-27 05:46:32
- **Comment**: Accepted at The Web Conference (WWW) 2026
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models, as it explores a novel approach to knowledge graph question answering using relation-aware preference optimization. Although it focuses on Natural Language Processing and Knowledge Graphs, the techniques and innovations presented can be applied to broader IR and search technologies. The paper's emphasis on leveraging external knowledge sources and optimizing retrieval processes aligns with your interests in deep semantic understanding and real-time relevance optimization.
...
### 5. Enhancing Academic Paper Recommendations Using Fine-Grained Knowledge Entities and Multifaceted Document Embeddings

- **LLM Score**: 7
- **Keyword Score**: 4
- **Authors**: Haixu Xi, Heng Zhang, Chengzhi Zhang
- **URL**: <http://arxiv.org/abs/2601.19513v1>
- **Submitted**: 2026-01-27 11:55:10
- **Topic Keywords**: rag, recommend, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of academic paper recommendations and fine-grained knowledge entities. While it focuses on academic papers, the techniques and methods proposed can be applied to other domains, including e-commerce. However, the specific focus on academic papers and citation data limits its direct relevance to your core research themes.
...
### 6. Cross-Examination Framework: A Task-Agnostic Diagnostic for Information Fidelity in Text-to-Text Generation
...
- **Submitted**: 2026-01-27 08:30:13
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The Cross-Examination Framework (CEF) proposed in the paper is a diagnostic tool for evaluating the semantic fidelity of text-to-text generation, which is relevant to your interests in deep semantic understanding. However, the paper's focus on text generation and evaluation metrics is not a central match to your primary research focus on IR and search technologies.
...
### 7. RobustExplain: Evaluating Robustness of LLM-Based Explanation Agents for Recommendation

- **LLM Score**: 6
- **Keyword Score**: 8
- **Authors**: Guilin Zhang, Kai Zhao, Jeffrey Friedman, Xu Chu
- **URL**: <http://arxiv.org/abs/2601.19120v1>
- **Submitted**: 2026-01-27 02:45:48
- **Comment**: 8 pages, 4 figures
- **Topic Keywords**: relevance, user behavior, click, recommend
- **Reason**: The paper explores the robustness of LLM-generated explanations in recommender systems, which is somewhat related to the user's interests in Information Retrieval and Natural Language Processing. However, the focus on recommender systems and explanation agents, while tangentially related to query understanding and ranking models, is not a central match for the user's primary research themes.
...
### 8. Ad Insertion in LLM-Generated Responses

- **LLM Score**: 6
- **Keyword Score**: 7
- **Authors**: Shengwei Xu, Zhaohua Chen, Xiaotie Deng, Zhiyi Huang, Grant Schoenebeck
- **URL**: <http://arxiv.org/abs/2601.19435v1>
- **Submitted**: 2026-01-27 10:16:03
- **Comment**: 31 pages, 8 figures
- **Topic Keywords**: query, queries, search
- **Reason**: This paper explores the challenges of advertising in conversational flows generated by Large Language Models (LLMs), which is somewhat related to information retrieval and search technologies. However, the focus on advertising and monetization is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's use of NLP and deep semantic understanding is relevant, but the context is more aligned with recommender systems and advertising rather than traditional information retrieval.
...
### 9. How Do Transformers Learn to Associate Tokens: Gradient Leading Terms Bring Mechanistic Interpretability

- **LLM Score**: 6
- **Keyword Score**: 2
- **Authors**: Shawn Im, Changdae Oh, Zhen Fang, Sharon Li
- **URL**: <http://arxiv.org/abs/2601.19208v1>
- **Submitted**: 2026-01-27 05:22:34
- **Comment**: ICLR 2026
- **Topic Keywords**: rag
- **Reason**: This paper explores the inner workings of transformer-based language models, focusing on how they learn semantic associations. While it touches on aspects of deep learning and NLP, it doesn't directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 10. XProvence: Zero-Cost Multilingual Context Pruning for Retrieval-Augmented Generation

- **LLM Score**: 4
- **Keyword Score**: 11
- **Authors**: Youssef Mohamed, Mohamed Elhoseiny, Thibault Formal, Nadezhda Chirkova
- **URL**: <http://arxiv.org/abs/2601.18886v1>
- **Submitted**: 2026-01-26 19:00:11
- **Comment**: Accepted to ECIR 2026
- **Topic Keywords**: ranking, rerank, rag, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the context of retrieval-augmented generation (RAG) and context pruning. However, it focuses more on multilingual support and cross-lingual transfer, which, while relevant to IR, is not a central match with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 11. Talos: Optimizing Top-$K$ Accuracy in Recommender Systems
...
- **Submitted**: 2026-01-27 07:04:09
- **Comment**: Accepted by WWW'26
- **Topic Keywords**: ranking, rag, recommend, rank, www
- **Reason**: The paper focuses on recommender systems, which is a related area to information retrieval, but it does not directly address query understanding, ranking models, or user behavior modeling. While it involves optimization and ranking, the context is specific to recommender systems and does not leverage deep semantic understanding or real-time relevance optimization, which are key aspects of your research interests.
...
### 12. LLMs as Orchestrators: Constraint-Compliant Multi-Agent Optimization for Recommendation Systems

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Guilin Zhang, Kai Zhao, Jeffrey Friedman, Xu Chu
- **URL**: <http://arxiv.org/abs/2601.19121v1>
- **Submitted**: 2026-01-27 02:46:13
- **Comment**: 8 pages, 5 figures
- **Topic Keywords**: rag, recommend, commerce, e-commerce, search
- **Reason**: The paper is somewhat related to your research interests in Information Retrieval and Recommendation Systems, but it focuses more on the orchestration of LLMs for constrained optimization in recommendation systems, which is not a central match to your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 13. An Interpretable Recommendation Model for Psychometric Data, With an Application to Gerontological Primary Care
...
- **Submitted**: 2026-01-27 17:29:21
- **Comment**: 81 pages, 19 figures, 3 annexes
- **Topic Keywords**: rag, recommend, search
- **Reason**: The paper is somewhat related to the user's interests in recommender systems, but it focuses on a specific application in healthcare, which is not the primary focus of the user's research. The paper's emphasis on interpretable models and visual explanations is also relevant, but it does not align with the user's interests in information retrieval, query understanding, and ranking models.
...
### 14. Differentiable Semantic ID for Generative Recommendation
...
- **Submitted**: 2026-01-27 15:34:11
- **Topic Keywords**: rag, recommend, search
- **Reason**: The paper explores differentiable semantic IDs for generative recommendation, which is somewhat related to information retrieval and search technologies. However, the focus on recommender systems and generative models is not a central match to the user's primary research interests in query understanding, ranking models, and user behavior modeling. The connection to NLP and data mining is also limited.
...
### 15. ReToP: Learning to Rewrite Electronic Health Records for Clinical Prediction

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Jesus Lovon-Melgarejo, Jose G. Moreno, Christine Damase-Michel, Lynda Tamine
- **URL**: <http://arxiv.org/abs/2601.19286v1>
- **Submitted**: 2026-01-27 07:20:46
- **Comment**: Accepted by WSDM 2026
- **Topic Keywords**: rag, ctr
- **Reason**: The paper explores the application of Large Language Models (LLMs) in Electronic Health Records (EHRs) for clinical prediction. While it involves query understanding and ranking models, the domain is primarily focused on healthcare and medical records, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the paper's emphasis on clinical prediction and EHR rewrites does not directly align with the user's core research themes.
...
### 16. Benchmarking Multimodal Large Language Models for Missing Modality Completion in Product Catalogues

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Junchen Fu, Wenhao Deng, Kaiwen Zheng, Ioannis Arapakis, Yu Ye, Yongxin Ni, Joemon M. Jose, Xuri Ge
- **URL**: <http://arxiv.org/abs/2601.19750v2>
- **Submitted**: 2026-01-27 16:13:26
- **Topic Keywords**: recommend, commerce, e-commerce
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in the e-commerce domain. However, its focus on multimodal large language models for missing modality completion in product catalogues is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 17. MetaGen: Self-Evolving Roles and Topologies for Multi-Agent LLM Reasoning
...
- **Submitted**: 2026-01-27 07:24:35
- **Topic Keywords**: query
- **Reason**: While the paper discusses multi-agent systems and large language models, it primarily focuses on the adaptation of role specifications and collaboration topologies. Although it mentions query-conditioned role specifications, the context is more aligned with task-oriented dialogue systems rather than information retrieval or search technologies. The paper's relevance to the user's interests is somewhat limited due to its focus on multi-agent systems and task-oriented dialogue.
...
### 18. Do Images Speak Louder than Words? Investigating the Effect of Textual Misinformation in VLMs

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Chi Zhang, Wenxuan Ding, Jiale Liu, Mingrui Wu, Qingyun Wu, Ray Mooney
- **URL**: <http://arxiv.org/abs/2601.19202v1>
- **Submitted**: 2026-01-27 05:04:38
- **Comment**: 24 pages, 10 figures. Accepted at EACL 2026 (main conference)
- **Topic Keywords**: rag, search
- **Reason**: The paper explores the robustness of Vision-Language Models (VLMs) against textual misinformation, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on multimodal reasoning and VQA benchmarks is not directly aligned with the user's primary research interests in IR and NLP. The paper's findings on the vulnerability of VLMs to misleading textual prompts are interesting but not central to the user's core research themes.
...
### 19. Propagating Similarity, Mitigating Uncertainty: Similarity Propagation-enhanced Uncertainty for Multimodal Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Xinzhuo Wu, Hongbo Wang, Yuan Lin, Kan Xu, Liang Yang, Hongfei Lin
- **URL**: <http://arxiv.org/abs/2601.19198v1>
- **Submitted**: 2026-01-27 04:53:59
- **Comment**: Accepted by ICASSP2026
- **Topic Keywords**: rag, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of multimodal recommendation systems. However, the focus on multimodal recommendation and uncertainty mitigation in recommender systems is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling in search technologies. While it touches on related topics, it does not align closely with your core research themes.
...
### 20. KG-CRAFT: Knowledge Graph-based Contrastive Reasoning with LLMs for Enhancing Automated Fact-checking

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Vítor N. Lourenço, Aline Paes, Tillman Weyde, Audrey Depeige, Mohnish Dubey
- **URL**: <http://arxiv.org/abs/2601.19447v1>
- **Submitted**: 2026-01-27 10:32:42
...
- **Topic Keywords**: rag
- **Reason**: The paper explores the application of knowledge graphs and large language models in automated fact-checking, which is somewhat related to information retrieval and search technologies. However, the focus on fact-checking and claim verification is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling. While the paper touches on the use of LLMs, it is not a central match for the user's research themes.
...
### 21. Formula-One Prompting: Adaptive Reasoning Through Equations For Applied Mathematics

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Natapong Nitarach, Pittawat Taveekitworachai, Kunat Pipatanakul
- **URL**: <http://arxiv.org/abs/2601.19302v1>
- **Submitted**: 2026-01-27 07:42:20
- **Topic Keywords**: rag
- **Reason**: The paper explores a novel approach to improving mathematical reasoning in Large Language Models (LLMs) through equation-based prompting. While it touches on aspects of query understanding and ranking models, its primary focus is on applied mathematics, which is somewhat related to the user's interests in Information Retrieval and NLP. However, the paper's relevance to the user's core research themes is limited.
...
- **Submitted**: 2026-01-27 07:10:41
- **Comment**: Keywords: Large Language Models, Reasoning Models, Reinforcement Learning, Distributionally Robust Optimization, GRPO
- **Topic Keywords**: rag
- **Reason**: The paper focuses on Large Language Model (LLM) reasoning and proposes a new framework for optimizing post-training loss functions. While it involves reinforcement learning and optimization techniques, its primary focus is on LLM reasoning, which is somewhat related to information retrieval, but not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 23. LLM-Enhanced Reinforcement Learning for Long-Term User Satisfaction in Interactive Recommendation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Chongjun Xia, Yanchun Peng, Xianzhi Wang
- **URL**: <http://arxiv.org/abs/2601.19585v1>
- **Submitted**: 2026-01-27 13:22:30
- **Topic Keywords**: recommend
- **Reason**: The paper explores a novel recommendation framework that integrates reinforcement learning and language models, which is somewhat related to your interests in information retrieval and NLP. However, the focus on recommender systems and user satisfaction is not a central match to your primary research themes, and the paper does not explicitly address query understanding, ranking models, or user behavior modeling.
...
### 24. ClaimPT: A Portuguese Dataset of Annotated Claims in News Articles
...
- **URL**: <http://arxiv.org/abs/2601.19490v1>
- **Submitted**: 2026-01-27 11:22:00
- **Topic Keywords**: search
- **Reason**: The paper introduces a dataset for fact-checking in Portuguese, which is relevant to the broader field of Information Retrieval and Natural Language Processing. However, it does not directly relate to the user's specific interests in query understanding, ranking models, and user behavior modeling. The focus on fact-checking and low-resource languages is somewhat related to the user's interests in deep semantic understanding and real-time relevance optimization, but it is not a central match.
...
### 25. UniRec: Unified Multimodal Encoding for LLM-Based Recommendations

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Zijie Lei, Tao Feng, Zhigang Hua, Yan Xie, Guanyu Lin, Shuang Yang, Ge Liu, Jiaxuan You
- **URL**: <http://arxiv.org/abs/2601.19423v1>
- **Submitted**: 2026-01-27 10:02:29
- **Topic Keywords**: recommend
- **Reason**: The paper, UniRec, is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the context of multimodal recommendation and large language models. However, it focuses more on recommender systems and does not directly address query understanding, ranking models, or user behavior modeling. While it explores deep semantic understanding, it is primarily concerned with real-time relevance optimization in the context of recommendation systems.
...
### 26. HELM: A Human-Centered Evaluation Framework for LLM-Powered Recommender Systems

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Sushant Mehta
- **URL**: <http://arxiv.org/abs/2601.19197v1>
- **Submitted**: 2026-01-27 04:53:48
- **Topic Keywords**: recommend
- **Reason**: The paper focuses on recommender systems, which is related to the user's interests in Information Retrieval and Search technologies. However, it specifically deals with LLM-powered recommender systems and human-centered evaluation, which is somewhat tangential to the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 27. FROST: Filtering Reasoning Outliers with Attention for Efficient Reasoning

- **LLM Score**: 3
- **Keyword Score**: 2
- **Authors**: Haozheng Luo, Zhuolin Jiang, Md Zahid Hasan, Yan Chen, Soumalya Sarkar
- **URL**: <http://arxiv.org/abs/2601.19001v1>
- **Submitted**: 2026-01-26 22:23:09
- **Topic Keywords**: rag
- **Reason**: The paper FROST focuses on efficient reasoning and attention-aware methods, which is somewhat related to the user's interest in query understanding and ranking models. However, the paper's primary focus on reasoning and attention mechanisms does not strongly align with the user's core research themes in Information Retrieval and Search technologies. The paper's relevance is mostly limited to its use of attention weights, which is a technique also used in some IR applications.
...
### 28. RATE: Reviewer Profiling and Annotation-free Training for Expertise Ranking in Peer Review Systems

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Weicong Liu, Zixuan Yang, Yibo Zhao, Xiang Li
- **URL**: <http://arxiv.org/abs/2601.19637v1>
- **Submitted**: 2026-01-27 14:13:46
- **Comment**: 18 pages
- **Topic Keywords**: ranking, retrieval, rank
- **Reason**: This paper focuses on reviewer profiling and expertise ranking in peer review systems, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves ranking models and embedding models, the context is specific to peer review systems and does not align with the user's primary focus on real-time relevance optimization and deep semantic understanding.
...
### 29. Evaluation of Oncotimia: An LLM based system for supporting tumour boards
...
- **Submitted**: 2026-01-27 18:59:38
- **Comment**: 9 pages, 2 figures
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not relevant to your research interests as it focuses on oncology decision-making and the application of LLMs in clinical workflows, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 30. Neural Neural Scaling Laws

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Michael Y. Hu, Jane Pan, Ayush Rajesh Jhaveri, Nicholas Lourie, Kyunghyun Cho
- **URL**: <http://arxiv.org/abs/2601.19831v1>
- **Submitted**: 2026-01-27 17:38:11
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on neural scaling laws for language models, which is outside your primary research interest in Information Retrieval and Search technologies. While it touches on deep semantic understanding, the context is limited to NLP and does not directly relate to your expertise in IR, query understanding, or user behavior modeling.
...
### 31. Reimagining Social Robots as Recommender Systems: Foundations, Framework, and Applications

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Jin Huang, Fethiye Irmak Doğan, Hatice Gunes
- **URL**: <http://arxiv.org/abs/2601.19761v1>
- **Submitted**: 2026-01-27 16:25:56
- **Comment**: HRI 2026
- **Topic Keywords**: recommend, personalization, rank
- **Reason**: This paper focuses on recommender systems and their integration into social robots, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the primary focus on recommender systems and social robots does not align with your core research themes, particularly in the e-commerce domain and deep semantic understanding.
...
### 32. SynCABEL: Synthetic Contextualized Augmentation for Biomedical Entity Linking

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Adam Remaki, Christel Gérardin, Eulàlia Farré-Maduell, Martin Krallinger, Xavier Tannier
- **URL**: <http://arxiv.org/abs/2601.19667v1>
- **Submitted**: 2026-01-27 14:47:17
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP and uses large language models, its focus on Biomedical Entity Linking and synthetic data generation for entity linking is not a central match for the user's interests.
...
### 33. Explicit Multi-head Attention for Inter-head Interaction in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Runyu Peng, Yunhua Zhou, Demin Song, Kai Lv, Bo Wang, Qipeng Guo, Xipeng Qiu
- **URL**: <http://arxiv.org/abs/2601.19611v1>
- **Submitted**: 2026-01-27 13:45:03
- **Topic Keywords**: rag, rank
- **Reason**: This paper focuses on improving the performance of large language models, specifically the Transformer architecture, through a novel attention variant called Multi-head Explicit Attention (MEA). While it explores techniques for enhancing model performance, it does not directly relate to the user's core research interests in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling.
...
### 34. Yunque DeepResearch Technical Report
...
- **Submitted**: 2026-01-27 13:10:00
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be unrelated to the user's research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on autonomous agents, Large Language Models, and deep research does not align with the user's core themes, and the context of the paper seems to be more related to AI and robotics.
...
### 35. Physics-Informed Neuro-Symbolic Recommender System: A Dual-Physics Approach for Personalized Nutrition

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Chayan Banerjee
- **URL**: <http://arxiv.org/abs/2601.19244v1>
- **Submitted**: 2026-01-27 06:28:24
- **Topic Keywords**: recommend, commerce, e-commerce
- **Reason**: This paper primarily focuses on recommender systems, specifically in the nutrition domain, which is not a central match to your research interests in Information Retrieval and Search technologies. While it does involve some NLP techniques, the application is limited to constructing a knowledge graph and the main contribution is in the recommender system architecture, which is not aligned with your core research themes.
...
### 36. Accelerating Generative Recommendation via Simple Categorical User Sequence Compression

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Qijiong Liu, Lu Fan, Zhongzhou Liu, Xiaoyu Dong, Yuankai Luo, Guoyuan An, Nuo Chen, Wei Guo, Yong Liu, Xiao-Ming Wu
- **URL**: <http://arxiv.org/abs/2601.19158v1>
- **Submitted**: 2026-01-27 03:45:37
- **Comment**: WSDM'26 Accepted Paper
- **Topic Keywords**: rag, recommend
- **Reason**: This paper focuses on recommender systems, specifically generative recommenders, and proposes a method for compressing user sequences to improve efficiency. While it touches on real-time deployment and computational costs, it doesn't align with the user's primary interests in Information Retrieval, query understanding, ranking models, or user behavior modeling. The paper's emphasis on recommender systems and categorical user sequence compression doesn't strongly relate to the user's core research themes.
...
### 37. Reflective Translation: Improving Low-Resource Machine Translation via Structured Self-Reflection

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Nicholas Cheng
- **URL**: <http://arxiv.org/abs/2601.19871v1>
- **Submitted**: 2026-01-27 18:37:09
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on machine translation and low-resource languages, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and methodology are not aligned with the user's areas of focus.
...
### 38. Strong Reasoning Isn't Enough: Evaluating Evidence Elicitation in Interactive Diagnosis

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhuohan Long, Zhijie Bao, Zhongyu Wei
- **URL**: <http://arxiv.org/abs/2601.19773v1>
- **Submitted**: 2026-01-27 16:36:35
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on interactive diagnosis and evidence elicitation in medical consultation, which is unrelated to your areas of expertise.
...
### 39. TokenSeek: Memory Efficient Fine Tuning via Instance-Aware Token Ditching

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Runjia Zeng, Qifan Wang, Qiang Guan, Ruixiang Tang, Lifu Huang, Zhenting Wang, Xueling Zhang, Cheng Han, Dongfang Liu
- **URL**: <http://arxiv.org/abs/2601.19739v1>
- **Submitted**: 2026-01-27 15:58:36
- **Comment**: ICLR 2026
- **Topic Keywords**: search, iclr
- **Reason**: This paper focuses on memory-efficient fine-tuning of large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on transformer-based models, the primary goal is optimization for downstream tasks, rather than query understanding, ranking models, or user behavior modeling.
...
### 40. DART: Diffusion-Inspired Speculative Decoding for Fast LLM Inference
...
- **Submitted**: 2026-01-27 07:04:24
- **Topic Keywords**: rag
- **Reason**: This paper focuses on accelerating Large Language Model (LLM) inference using speculative decoding, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and techniques presented are not aligned with your areas of focus.
...
### 41. Riddle Quest : The Enigma of Words

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Niharika Sri Parasa, Chaitali Diwan, Srinath Srinivasa
- **URL**: <http://arxiv.org/abs/2601.19273v1>
- **Submitted**: 2026-01-27 07:03:29
- **Comment**: This paper is submitted under 'Demo track' for WWW conference
- **Topic Keywords**: rag
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and linguistic puzzles, but it does not align with the user's primary focus on Information Retrieval, especially in areas that require deep semantic understanding and real-time relevance optimization.
...
### 42. Leveraging Sentence-oriented Augmentation and Transformer-Based Architecture for Vietnamese-Bahnaric Translation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Tan Sang Nguyen, Quoc Nguyen Pham, Tho Quan
- **URL**: <http://arxiv.org/abs/2601.19124v1>
- **Submitted**: 2026-01-27 02:49:52
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Vietnamese-Bahnaric translation using Neural Machine Translation (NMT) and augmentation strategies, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves NLP, the specific application and context are quite different from the user's areas of focus.
...
### 43. Is Finer Better? The Limits of Microscaling Formats in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Andrea Fasoli, Monodeep Kar, Chi-Chun Liu, Swagath Venkataramani, Viji Srinivasan, Leland Chang, Naigang Wang
- **URL**: <http://arxiv.org/abs/2601.19026v1>
- **Submitted**: 2026-01-26 23:21:24
- **Comment**: 31 pages, 17 figures, 3 tables; accepted to ICLR 2026
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on Large Language Models and their compression, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves some technical aspects that might be tangentially relevant, such as quantization and error mitigation, the paper's main contributions and implications do not align with the user's research interests.
...
### 44. LLMs versus the Halting Problem: Revisiting Program Termination Prediction

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Oren Sultan, Jordi Armengol-Estape, Pascal Kesseli, Julien Vanegue, Dafna Shahaf, Yossi Adi, Peter O'Hearn
- **URL**: <http://arxiv.org/abs/2601.18987v2>
- **Submitted**: 2026-01-26 21:44:12
- **Topic Keywords**: rank, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on program termination prediction using large language models, which is outside your primary areas of interest.
...
### 45. Intent2QoS: Language Model-Driven Automation of Traffic Shaping Configurations

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sudipta Acharya, Burak Kantarci
- **URL**: <http://arxiv.org/abs/2601.18974v1>
- **Submitted**: 2026-01-26 21:18:14
- **Comment**: 6 page, 4 figures, Accepted to IEEE International Conference on Communications (ICC) 2026
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language models and intent translation, the context is network traffic shaping and Quality of Service enforcement, which is not a primary focus of the user's research interests.
...
### 46. BabyReasoningBench: Generating Developmentally-Inspired Reasoning Tasks for Evaluating Baby Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Kaustubh D. Dhole
- **URL**: <http://arxiv.org/abs/2601.18933v1>
- **Submitted**: 2026-01-26 20:10:33
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on evaluating baby language models and their reasoning capabilities using a developmentally-inspired benchmark. The paper's emphasis on developmental psychology and language model evaluation does not align with your core research themes.
...
### 47. Zero-Shot Stance Detection in the Wild: Dynamic Target Generation and Multi-Target Adaptation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Aohua Li, Yuanshuo Zhang, Ge Gao, Bo Chen, Xiaobing Zhao
- **URL**: <http://arxiv.org/abs/2601.19802v2>
- **Submitted**: 2026-01-27 17:04:18
- **Topic Keywords**: search
- **Reason**: This paper focuses on stance detection in social media, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific task and application are not aligned with your areas of focus.
...
### 48. GradPruner: Gradient-Guided Layer Pruning Enabling Efficient Fine-Tuning and Inference for LLMs

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Wei Huang, Anda Cheng, Yinggui Wang
- **URL**: <http://arxiv.org/abs/2601.19503v1>
- **Submitted**: 2026-01-27 11:41:26
- **Comment**: Accepted by ICLR2026
- **Topic Keywords**: search
- **Reason**: This paper focuses on efficient fine-tuning and inference for Large Language Models using a gradient-guided layer pruning approach. While it touches on model efficiency, it doesn't directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 49. Masked Diffusion Generative Recommendation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Lingyu Mu, Hao Deng, Haibo Xing, Jinxin Hu, Yu Zhang, Xiaoyi Zeng, Jing Zhang
- **URL**: <http://arxiv.org/abs/2601.19501v1>
- **Submitted**: 2026-01-27 11:39:02
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on generative recommendation, which is related to information retrieval, but it primarily deals with recommender systems and does not address query understanding, ranking models, or user behavior modeling. The paper's emphasis on real-time optimization and efficiency is also not directly relevant to the user's core research themes in information retrieval.
...
### 50. DREAMSTATE: Diffusing States and Parameters for Recurrent Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Liu Xiao
- **URL**: <http://arxiv.org/abs/2601.19221v1>
- **Submitted**: 2026-01-27 05:42:25
- **Topic Keywords**: search
- **Reason**: This paper focuses on Recurrent Neural Networks (RNNs) and their internal state representation, which is not directly related to your core research interests in Information Retrieval and Search technologies. While it involves deep learning and NLP, the specific application and context are quite different from your areas of focus.
