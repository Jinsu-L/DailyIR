...
- **URL**: <http://arxiv.org/abs/2609.08887v1>
- **Submitted**: 2026-09-08 15:26:05
- **Topic Keywords**: retriever, query, queries, ranking, relevance, rag, retrieval, rank, search
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Q2D‑Web: a production‑scale agentic retrieval‑augmented generation benchmark
- **Aim**: Provide a realistic, large‑scale testbed for evaluating first‑stage retrievers in RAG systems that operate on machine‑generated queries
- **Rationale**: Existing IR benchmarks lack web‑scale corpus size, query volume, deep relevance depth, realistic agentic queries, and are costly to evaluate; Q2D‑Web closes these gaps to enable reproducible, deep‑recall evaluation
- **Ground**: 190 M deduplicated web documents (10 languages), ~70 k agent‑generated queries (primary + supporting), multi‑source relevance judgments (agent citations, production rankings, LLM‑augmented labels) yielding ~100 positives/query; two‑stage subsampling via reciprocal rank fusion retains top ~60 M docs (~32% of corpus) while preserving ranking fidelity
- **Experiment**: Built the benchmark, applied two‑stage subsampling, evaluated 13 retrievers (lexical, dense, late‑interaction) on Recall@1000, Recall@100, nDCG@10; analyzed performance across domains, languages, query types; demonstrated subsample preserves full‑corpus ranking with minimal recall loss; compared retriever diversity and coverage
- **Takeaway**: Q2D‑Web is the largest agentic RAG benchmark, enabling deep‑recall evaluation at web scale; efficient subsampling reduces cost by an order of magnitude; reveals significant retriever diversity (e.g., BM25 unique coverage, neural retrievers lower recall on supporting queries); benchmark and leaderboard are publicly available while keeping data private to prevent contamination
...
### 2. Bridging the Semantic-Utility Gap in Multimodal RAG via Generator-in-the-Loop Alignment
...
- **Submitted**: 2026-09-08 03:18:58
- **Comment**: Submitted to IEEE Transactions on Artificial Intelligence
- **Topic Keywords**: retriever, query, rerank, pairwise, relevance, rag, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
### 3. Cassette: Case-to-Case Structural Distillation for Efficient Legal Case Retrieval

- **LLM Score**: 0
- **Keyword Score**: 15
- **Authors**: Yanran Tang, Ruihong Qiu, Hongzhi Yin, Xue Li, Zi Huang
- **URL**: <http://arxiv.org/abs/2609.08185v1>
- **Submitted**: 2026-09-08 03:16:20
- **Topic Keywords**: retriever, query, ranking, pairwise, retrieval, rank
- **Reason**: LLM scoring failed.
...
### 4. SequenceO1: End-to-End Ultra-Long (100K) Sequence Modeling in Recommendation with Low-Rank Caching
...
- **Topic Keywords**: ranking, ltr, rag, user behavior, retrieval, recommend, rank
- **Reason**: LLM scoring failed.
...
### 5. Tool Retrievers Are Underestimated: Annotation Expansion Reveals True Capability
...
- **URL**: <http://arxiv.org/abs/2609.08327v1>
- **Submitted**: 2026-09-08 06:53:22
...
### 8. PDMR: Passage-Driven Multi-ID Document Retrieval

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Smail Oussaidene, Mohand Boughanem
- **URL**: <http://arxiv.org/abs/2609.08762v1>
- **Submitted**: 2026-09-08 13:58:59
...
### 9. Less Is Personal: Learning Minimal Sufficient User Profiles for Personalized Language Models

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Minghang Liu, Qiang Qiu, Yuanzhuo Wang, Huawei Shen, Xueqi Cheng
- **URL**: <http://arxiv.org/abs/2609.08180v1>
- **Submitted**: 2026-09-08 03:09:19
- **Comment**: 21 pages
- **Topic Keywords**: ranking, retrieval, personalization, rank, search
- **Reason**: LLM scoring failed.
...
### 10. Jacap: Robust KV Cache Eviction via Jacobian-Based Nonlinear Information Capacity Preservation

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Jiaming Yang, Chenwei Tang, Liangli Zhen, Chenyang Zhang, Jiancheng Lv
- **URL**: <http://arxiv.org/abs/2609.08131v1>
- **Submitted**: 2026-09-08 02:08:57
...
### 12. Combating Instruction Conflict via Energy-Driven Latent Conflict Detection

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Mingyu Ma, Yuxin Wu, Jingbo Wang, Tianxiao Huang, Leixin Sun, Xiaochuan Shi
- **URL**: <http://arxiv.org/abs/2609.08646v1>
- **Submitted**: 2026-09-08 12:14:43
...
### 13. In RAG We Trust? Measuring Robustness of Retrieval-Augmented Generation Under Document Poisoning

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Iliano Fasolino
- **URL**: <http://arxiv.org/abs/2609.09243v1>
- **Submitted**: 2026-09-08 08:31:57
...
- **URL**: <http://arxiv.org/abs/2609.08899v2>
- **Submitted**: 2026-09-08 15:38:57
...
### 16. A Three-Tier Persona Vector for Controllable User Simulation in Agentic Evaluation
...
### 17. Limitations of Automated Simulatability: LLM Simulators Can Bypass Explanations
...
### 18. SentryLine: Evidence-Grounded Question Answering over Evolving Documents in Oncology Care
...
- **URL**: <http://arxiv.org/abs/2609.08364v1>
- **Submitted**: 2026-09-08 07:33:01
...
### 19. MeRoTune: RoPE-Safe Merging with a Tunable Dial

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Salman Faroz
- **URL**: <http://arxiv.org/abs/2609.07971v1>
- **Submitted**: 2026-09-07 20:48:26
...
### 20. CausalVerify: An Execution-Grounded Benchmark for LLM Causal Inference Workflows

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Yonghong Zhang, Ricardo Correia, Isabel M. Parra, Yong Xie
- **URL**: <http://arxiv.org/abs/2609.07944v1>
- **Submitted**: 2026-09-07 19:56:29
...
### 21. The Audit Decides the Verdict: Instrument Effects Rival Demographic Bias in LLM Decision Audits

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Siddharth Vohra, Manikandan Ravikiran
- **URL**: <http://arxiv.org/abs/2609.09048v1>
- **Submitted**: 2026-09-08 17:08:53
...
### 22. A Closed-Form Estimator and Diagnostic Battery for Anchor-Judge Error Correlation, Under a Single-Common-Factor Model

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Veerendra Kumar Sunkavalli
- **URL**: <http://arxiv.org/abs/2609.08826v1>
- **Submitted**: 2026-09-08 14:49:13
...
### 23. Improving Term Evaluation in Machine Translation: Variation Matters

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Nicolas Dahan, Ziqian Peng, François Yvon, Rachel Bawden
- **URL**: <http://arxiv.org/abs/2609.08779v1>
- **Submitted**: 2026-09-08 14:12:22
- **Topic Keywords**: ranking, rank
- **Reason**: LLM scoring failed.
...
### 25. Navigating the digital spectrum: Assessing political bias, stability, and downstream fairness in Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Luka Debevc, Nishan Chatterjee, Antoine Doucet, Senja Pollak, Matej Martinc
- **URL**: <http://arxiv.org/abs/2609.08637v1>
- **Submitted**: 2026-09-08 12:07:30
...
### 26. Individual Text Corpora Predict User-Specific Knowledge: Benchmarks of Individualized Knowledge Simulation

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Christoph Wigbels, Ali Abusaleh, Markus T. Jansen, Alexander Mehler, Manuel Schaaf, Markus J. Hofmann
- **URL**: <http://arxiv.org/abs/2609.08532v1>
- **Submitted**: 2026-09-08 10:19:28
...
### 27. From Coordinates to Candidate Regions: Temporal Change Localization via Region Selection in Remote Sensing Multimodal LLMs

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Juwan Chung, Sungjune Park, Yeongyun Kim, Yong Man Ro
- **URL**: <http://arxiv.org/abs/2609.08391v1>
- **Submitted**: 2026-09-08 07:59:21
...
### 28. Reading a Legal Question Word by Word: Embedding Trajectories of 2,144 Vietnamese Legal Headlines

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Tran Minh Quan
- **URL**: <http://arxiv.org/abs/2609.08372v2>
- **Submitted**: 2026-09-08 07:37:21
- **Topic Keywords**: retriever, rank
- **Reason**: LLM scoring failed.
...
### 29. What Eviction Destroys: A Restore-Counterfactual Audit of Forgetting in Agent Memory

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Chen Shen
- **URL**: <http://arxiv.org/abs/2609.08279v1>
- **Submitted**: 2026-09-08 05:48:10
...
### 30. Evidence-Aligned Entity Verification for Hallucination Detection in Retrieval-Augmented Generation

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Runsong Jia, Zhen Fang, Mengjia Wu, Jie Lu, Yi Zhang
- **URL**: <http://arxiv.org/abs/2609.08267v1>
- **Submitted**: 2026-09-08 05:22:29
- **Comment**: ACL 2026
...
### 31. EviSI: An Evaluation Agent for Simultaneous Interpreting

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ben Yan, Zongyao Li, Daimeng Wei, Weidong Liu, Huan Zhao, Chong Li, Yaode Wang, Yuzhe Shang
- **URL**: <http://arxiv.org/abs/2609.08171v1>
- **Submitted**: 2026-09-08 03:00:11
- **Topic Keywords**: ranking, rank
- **Reason**: LLM scoring failed.
...
### 32. Measuring LLM Sycophancy under Sustained Multi-Turn Pressure

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Leyuan Tang, Kangda Wei, Tianyu Jiang, Ruihong Huang
- **URL**: <http://arxiv.org/abs/2609.09090v1>
- **Submitted**: 2026-09-08 17:35:04
...
### 33. ToolLoop: Closed-Loop Tool-Use Data Synthesis via Decomposed Generation and Dynamic Self-Feedback

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Min Zeng, Yuzhou Liu, Zhenyu Cao, Hanxiu Chen, Heng Li, Caiquan Liu, Yafei Wen, Xiaoxin Chen
- **URL**: <http://arxiv.org/abs/2609.09072v1>
- **Submitted**: 2026-09-08 17:26:35
...
### 34. REDSI: Addressing the Reproducibility and Evaluation Consistency of Differentiable Search Indexing for Document Retrieval

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Vivien Nicolas, Hicham Randrianarivo, Pascale Sébillot, Caio Corro
- **URL**: <http://arxiv.org/abs/2609.08860v1>
- **Submitted**: 2026-09-08 15:07:59
...
### 35. The Rater Ising-Potts Model with LLM-Derived Weights: An Application to Multi-Category Scoring Reliability

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Matthias von Davier
- **URL**: <http://arxiv.org/abs/2609.08797v1>
- **Submitted**: 2026-09-08 14:26:19
...
### 37. Difficulty-Adaptive Tree-Structured Policy Optimization for Expanding Reasoning Coverage in RLVR

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Youngjun Yu, Sanghwan Jang, Hwanjo Yu
- **URL**: <http://arxiv.org/abs/2609.08650v1>
- **Submitted**: 2026-09-08 12:21:22
...
### 39. Structural Jailbreaks Generalize but Do Not Compound: A cross-provider and multilingual study of Involuntary In-Context Learning

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Tejasvi C. Addagada
- **URL**: <http://arxiv.org/abs/2609.08373v1>
- **Submitted**: 2026-09-08 07:38:33
...
### 40. RepoNav: From Snippet Retrieval to File-Centered Repository Navigation for Code Agents

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Hongzheng Chai, Jiakun Li, Hongyue Yu, Yuan Yuan
- **URL**: <http://arxiv.org/abs/2609.08355v1>
- **Submitted**: 2026-09-08 07:25:15
...
### 41. Distillation as Probability Transport: Routed On-Policy Distillation
...
### 42. IGT @ FinMMEval 2026 Task 2: Question-Type Prompting with Targeted Extraction for Multilingual Financial QA

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Yuwen Chiu
- **URL**: <http://arxiv.org/abs/2609.08139v1>
- **Submitted**: 2026-09-08 02:23:31
...
### 43. Procedural Graphs: Self-Evolving Execution Structures for LLM Agents

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yuxing Lu, Yicheng Chen, Shanchan Wu, Sercan Ö. Arık
- **URL**: <http://arxiv.org/abs/2609.09153v1>
- **Submitted**: 2026-09-08 17:59:41
...
### 44. ExecCritic: Learn to Test, Test to Improve for Coding Agents
...
### 45. SAEScientist-Bench: Can AI Agents Conduct Autonomous SAE Interpretability Research?

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yuqiao Tan, Shizhu He, Jun Zhao, Kang Liu
- **URL**: <http://arxiv.org/abs/2609.09113v1>
- **Submitted**: 2026-09-08 17:45:09
...
### 46. ActReview: Rebuttal-Guided Training Data and Rubric Rewards for Actionable Peer Review Generation

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yiling Ma, Yilun Zhao, Sihong Wu, Ziyu Chen, Manasi Patwardhan, Arman Cohan
- **URL**: <http://arxiv.org/abs/2609.09076v1>
- **Submitted**: 2026-09-08 17:30:16
...
### 47. Evaluating and Improving Evidence-Grounded Fact-Checking in LLMs via Multi-Round Evidence Ablation

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Xingyu Deng, Mingzi Cao, Nikolaos Aletras, Xi Wang, Mark Stevenson
- **URL**: <http://arxiv.org/abs/2609.08943v1>
- **Submitted**: 2026-09-08 16:04:20
- **Comment**: CIKM'26
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 48. FINALLY: A Dataset Recommender System for Recommender-Systems Research

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Louis Owie
- **URL**: <http://arxiv.org/abs/2609.08941v1>
- **Submitted**: 2026-09-08 16:02:41
