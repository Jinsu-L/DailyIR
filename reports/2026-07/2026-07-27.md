...
### 1. Towards a Relevance Posterior in Neural Information Access

- **LLM Score**: 9
- **Keyword Score**: 19
- **Authors**: Andrew Parry, Emmanouil Georgios Lionis, Debasis Ganguly, Sean MacAvaney
- **URL**: <http://arxiv.org/abs/2607.23561v1>
- **Submitted**: 2026-07-26 09:24:20
- **Comment**: SIGIR 2026 Perspectives Track
- **Topic Keywords**: information retrieval, query, ranking, relevance, retrieval, recommend, rank, search, trec
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the areas of query understanding, ranking models, and user behavior modeling. The authors propose a novel approach to decomposing relevance into query-dependent likelihoods and query-independent priors, which aligns with your focus on deep semantic understanding and real-time relevance optimization.
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The introduction of Relevance-Aware RipGrep Search Agent (RARG) aligns with your focus on real-time relevance optimization and deep semantic understanding. However, the specific application domain of agentic search and corpus interaction is somewhat niche, which prevents a perfect match.
...
- **Topic Keywords**: queries, relevance, rag, conversion rate, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of e-commerce and dynamic product ads. The use of Large Language Models (LLMs) and semantic-aware retrieval approaches aligns with your interests in query understanding and ranking models. The focus on real-time relevance optimization and cost management also resonates with your research goals.
...
- **Submitted**: 2026-07-25 04:45:04
- **Comment**: Accepted to RecSys 2026
- **Topic Keywords**: dense retrieval, query, queries, retrieval, recommend
- **Reason**: This paper proposes a novel framework for generative retrieval, leveraging a shared LLM to learn item and user representations in a single embedding space. While primarily focused on recommendation and advertising, the use of deep semantic understanding and joint contrastive training aligns with your interests in Information Retrieval and query understanding. However, the specific application domain and emphasis on recommendation systems slightly detract from the score.
...
### 5. VecTree-RAG: An Agentic Retrieval-Augmented Generation Framework Combining Vector and Tree Retrieval for Efficiency and Accuracy

- **LLM Score**: 8
- **Keyword Score**: 11
- **Authors**: Xinyan Zhong, Yuwei Shi, Yuqi Wei, Chen Shen, Tianhang Zhou, Zhenghao Wu
- **URL**: <http://arxiv.org/abs/2607.23006v1>
- **Submitted**: 2026-07-25 02:50:05
- **Topic Keywords**: rerank, rag, ctr, retrieval, rank, search
- **Reason**: This paper presents a novel framework for scientific question answering that combines vector and tree retrieval, which is relevant to your interests in Information Retrieval and Search technologies. The focus on query understanding, ranking models, and user behavior modeling is also present in the evaluation of the framework's performance on various benchmarks. However, the specific domain of scientific literature question answering is somewhat outside your primary focus on e-commerce and general IR applications.
...
### 6. Unifying Generative Recall and Multi-Objective Ranking in a Single Decoder-Only Sequence

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Ruochen Yang, Shuang Wen, Pengbo Xu, Yusheng Huang, Jiangxia Cao, Shuang Yang, Zhaojie Liu, Jiawei Sheng, Tingwen Liu
- **URL**: <http://arxiv.org/abs/2607.24439v1>
- **Submitted**: 2026-07-27 13:47:38
- **Topic Keywords**: query, ranking, retrieval, recommend, rank
- **Reason**: This paper proposes a unified model for generative recall and multi-objective ranking, which is closely related to Learning to Rank and user behavior modeling. Although it's primarily focused on recommender systems, the use of deep semantic understanding and real-time relevance optimization aligns with your interests in Information Retrieval. However, the specific application domain (recommender systems) is not a core focus of your research.
...
### 7. CORE: A Unified Cascaded Ordinal Relevance Estimation Framework for E-commerce Search

- **LLM Score**: 8
- **Keyword Score**: 10
- **Authors**: Zhi Jin, Xi Wang, Yunfei Li, Guojun Liu, Qingsong Hua, Wei Lin
- **URL**: <http://arxiv.org/abs/2607.24417v1>
- **Submitted**: 2026-07-27 13:30:32
- **Comment**: 11 pages, 5 figures
- **Topic Keywords**: ranking, relevance, commerce, e-commerce, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in ranking models and relevance estimation. The proposed framework, CORE, addresses a key challenge in e-commerce search, which aligns with your background in the e-commerce domain. While the focus is on e-commerce search, the techniques and ideas presented can be applied to other areas of IR, making it a useful contribution to the field.
...
### 8. Breaking the Loop: An Empirical Comparison of Strategies for Novelty and Freshness in YouTube Music
...
- **Submitted**: 2026-07-26 16:50:34
- **Comment**: Accepted at 20th ACM Conference on Recommender Systems, September 27-October 02, 2026, Minneapolis, MN, USA. 8 pages
- **Topic Keywords**: ranking, ctr, recommend, rank, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically ranking models and user behavior modeling. Although it focuses on music recommenders and YouTube Music, the concepts of novelty, freshness, and ranking model optimization are relevant to your work. However, the specific domain and application are not directly aligned with your primary focus on e-commerce and deep semantic understanding.
...
- **URL**: <http://arxiv.org/abs/2607.24015v1>
- **Submitted**: 2026-07-27 05:25:50
...
- **Reason**: The paper discusses user representation and recommendation systems, which are related to information retrieval and search technologies. However, the focus on recommendation systems and user modeling is somewhat tangential to the user's primary interests in query understanding, ranking models, and user behavior modeling in the context of search technologies. The paper's emphasis on deep semantic understanding and real-time relevance optimization is not directly addressed.
...
- **Submitted**: 2026-07-27 04:27:58
- **Comment**: 6 pages, 2 figures
- **Topic Keywords**: ranking, ctr, recommend, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of recommender systems and user behavior modeling. However, the focus on recommendation and preference-drift spectrum is not a central match to your primary interest in query understanding, ranking models, and real-time relevance optimization.
...
### 11. Kalypso: Relational LLM Serving

- **LLM Score**: 6
- **Keyword Score**: 7
- **Authors**: Hojae Son, Md Ashraful Islam, Huy Gia Cao, Hui Guan, Marco Serafini
- **URL**: <http://arxiv.org/abs/2607.23815v1>
- **Submitted**: 2026-07-26 19:29:31
- **Comment**: 14 pages, 12 figures
- **Topic Keywords**: query, ranking, rank
- **Reason**: The paper discusses a system for efficient semantic query execution using large language models, which is related to information retrieval and query understanding. However, the focus is on query execution efficiency rather than ranking models or user behavior modeling, making it somewhat relevant but not a central match to the user's core research themes.
...
### 12. DSCH-Loss: A Dynamic Semantic Channel Objective for Deep Semantic Hashing

- **LLM Score**: 6
- **Keyword Score**: 5
- **Authors**: Tobias J. Bauer, Christian Riess, Daniel Loebenberger, Christian Bergler
- **URL**: <http://arxiv.org/abs/2607.24567v1>
- **Submitted**: 2026-07-27 15:35:52
- **Comment**: 12 pages, 3 figures, 9 tables
- **Topic Keywords**: rag, retrieval, search
- **Reason**: The paper is somewhat related to the user's research interests in Information Retrieval and Natural Language Processing, as it involves deep semantic understanding and hashing methods for efficient search. However, the focus on semantic hashing and hash codes is not directly aligned with the user's primary focus on query understanding, ranking models, and user behavior modeling.
...
### 13. A corrective agentic hybrid RAG and an operations-grounded evaluation for a scientific facility
...
- **Submitted**: 2026-07-27 17:01:30
- **Topic Keywords**: query, queries, rerank, relevance, rag, retrieval augmented generation, ctr, retrieval, rank, search
- **Reason**: This paper presents a retrieval platform for a scientific facility, leveraging natural language queries and a corrective agentic loop. While it involves search technologies and NLP, its focus on a specific domain (scientific facilities) and application (operations-grounded evaluation) is somewhat distant from your core research interests in IR, query understanding, and ranking models.
...
### 14. Do Current Retrievers Cover All the Evidence? A Controlled Study of Conjunctive Cross-Page Retrieval

- **LLM Score**: 4
- **Keyword Score**: 17
- **Authors**: Sungguk Cha, DongWook Kim, Mintae Kim, Youngsub Han, Byoung-Ki Jeon, Sangyeob Lee
- **URL**: <http://arxiv.org/abs/2607.24165v1>
- **Submitted**: 2026-07-27 08:46:27
- **Topic Keywords**: retriever, query, queries, rerank, rag, retrieval, rank
- **Reason**: This paper is somewhat related to information retrieval, but its focus on conjunctive cross-page retrieval and condition coverage is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling. While it touches on retrieval aspects, it's more focused on the specific challenge of finding evidence in documents, which is not a central match to your research interests.
...
### 15. Robust Interpretation of Historical Documents in Knowledge Graphs Through Query Inference and Execution

- **LLM Score**: 4
- **Keyword Score**: 11
- **Authors**: Sebastià Nicolau, Adrià Molina, Oriol Ramos Terrades, Josep Lladós
- **URL**: <http://arxiv.org/abs/2607.24475v1>
- **Submitted**: 2026-07-27 14:11:20
- **Comment**: Accepted at ICDAR2026
- **Topic Keywords**: query, queries, rag, retrieval, search
- **Reason**: This paper explores the application of Large Language Models in historical document analysis, focusing on robust interpretation and query inference. While it touches on retrieval and knowledge graphs, it is more closely related to NLP and historical document analysis, which aligns with your broader interests, but is not a central match for your primary focus on information retrieval and search technologies.
...
### 16. Choosing a Text Embedding Model: A Practical Benchmarking and Decision Framework

- **LLM Score**: 4
- **Keyword Score**: 11
- **Authors**: Madhav S Baidya
- **URL**: <http://arxiv.org/abs/2607.23507v1>
- **Submitted**: 2026-07-26 07:13:33
- **Comment**: 33 pages, 1 figure, 20 tables. Technical report
- **Topic Keywords**: ranking, rerank, retrieval, recommend, rank, search
- **Reason**: The paper discusses text embedding models, which is related to information retrieval and search technologies. However, the focus is on model selection and benchmarking rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. While the paper touches on retrieval tasks, it does not delve into the deep semantic understanding and real-time relevance optimization aspects that are crucial to the user's research interests.
...
- **Reason**: The paper discusses a problem in dual-encoder vision-language models, specifically the failure to handle compositional constraints in queries. While it touches on the concept of similarity and ranking, which are related to information retrieval, the focus is on the specific issue of factored inference and constraint execution in vision-language models, which is not a central match to your research interests in query understanding, ranking models, and user behavior modeling.
...
### 18. ClawRec: A Claw-Native Recommender System
...
- **URL**: <http://arxiv.org/abs/2607.23779v1>
- **Submitted**: 2026-07-26 17:56:49
- **Topic Keywords**: ranking, retrieval, recommend, rank, search
- **Reason**: The paper discusses recommender systems, which is related to your interests in Information Retrieval and Search technologies. However, the focus on recommender systems and the specific design of ClawRec is not a central match to your primary research themes, which include query understanding, ranking models, and user behavior modeling.
...
### 19. Co-Evolving Graph and Text Memory for Training-Free Multi-Hop Question Answering

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Hieu Man, Thien Huu Nguyen
- **URL**: <http://arxiv.org/abs/2607.23278v1>
- **Submitted**: 2026-07-25 16:29:38
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: This paper focuses on multi-hop question answering, which is related to information retrieval and query understanding. However, the primary emphasis is on question answering and knowledge graph-based systems, rather than search technologies or ranking models. While it touches on the integration of graph and text memory, it doesn't directly address user behavior modeling or real-time relevance optimization.
...
### 20. Language-Routed RAG and Direct Option Scoring for Multilingual Financial QA: DS@GT at FinMMEval

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Justice Ayela, Kabir Sahni
- **URL**: <http://arxiv.org/abs/2607.22841v1>
- **Submitted**: 2026-07-24 18:31:11
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of multilingual financial question answering. However, the focus on financial certification exams and the use of specific models and techniques (e.g., LangGraph, BGE-M3 embeddings, FAISS indexing) limits its direct relevance to your core research themes.
...
### 21. Integrating Factual and Normative Industrial Knowledge via Constraint-Aware Graph Attention for Process Plan Recommendation
...
- **Submitted**: 2026-07-27 09:45:05
- **Topic Keywords**: ranking, retrieval, recommend, rank
- **Reason**: The paper is somewhat related to information retrieval, but its focus on industrial knowledge integration, process plan recommendation, and knowledge graph enhanced collaborative filtering is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. However, the use of knowledge graphs and attention mechanisms shares some similarities with the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 22. SyRuP: Enhancing System-Prompt Following via Reward-Guided Prediction in LLM Decoding

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Seoyeon Kim, Minjae Kang, Jaehyung Kim
- **URL**: <http://arxiv.org/abs/2607.23991v1>
- **Submitted**: 2026-07-27 04:39:13
- **Comment**: under review, 23 pages
- **Topic Keywords**: ranking, rerank, rank
- **Reason**: This paper focuses on improving system-prompt adherence in Large Language Models (LLMs), which is related to query understanding and ranking models in Information Retrieval. However, the primary focus on LLMs and system-prompt following is not directly aligned with the user's core research themes, but it does involve some aspects of deep semantic understanding and real-time relevance optimization.
...
### 23. PIVOT: Efficient Query-Group Indexing for Token-Level Sparse Attention
...
- **Submitted**: 2026-07-27 15:58:07
- **Topic Keywords**: query, queries
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, specifically in query understanding and ranking models, but it focuses on efficient indexing techniques for sparse attention, which is a different aspect of IR. While it may be useful for improving search technologies, it does not directly address the user's core research themes.
...
### 24. From transcription to semantic corpus analysis: unsupervised learning of sentence representations for ancient languages

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Th{é}otime de la Selle
- **URL**: <http://arxiv.org/abs/2607.24542v1>
- **Submitted**: 2026-07-27 15:20:13
- **Topic Keywords**: semantic search, retrieval, search
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and data mining, but it focuses on ancient languages and digital humanities, which is not a central match for the user's research themes. The paper's emphasis on unsupervised learning of sentence representations and semantic search is somewhat relevant to the user's interests in deep semantic understanding and real-time relevance optimization, but the context and application are quite different.
...
### 25. One Graph, Multiple Gains: Single High-Quality Item-Item Graph for Multimodal Recommendation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Jinfeng Xu, Zheyu Chen, Ziyue Peng, Shuo Yang, Jinze Li, Zewei Liu, Shujie Li, Yipeng Du, Edith C. H. Ngai
- **URL**: <http://arxiv.org/abs/2607.24607v1>
- **Submitted**: 2026-07-27 16:09:28
- **Comment**: Accepted by ACM MM 2026
- **Topic Keywords**: rag, ctr, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it primarily focuses on recommendation systems, which is a related but distinct area. The use of item-item graphs and neighborhood consistency edge reweighting (NCER) is an interesting application of graph-based techniques, but it does not directly align with your core research themes in query understanding, ranking models, and user behavior modeling.
...
### 26. Beyond a Global Norm: Personalizing Toxicity Sensitivity in Language Models Without Retraining
...
- **Submitted**: 2026-07-25 12:09:43
- **Topic Keywords**: ranking, personalization, rank
- **Reason**: This paper explores personalizing language models for toxicity sensitivity, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language generation and toxicity reduction is not directly aligned with the user's primary research interests in IR and Search technologies. The connection to NLP is relevant, but the paper's emphasis on language quality and multi-objective optimization does not strongly resonate with the user's interests in real-time relevance optimization and deep semantic understanding.
...
### 27. When Does Few-Shot Prompting Help? A Systematic Empirical Study of Shot-Count Effects Across Model Scale, Architecture, and Output Parsing Robustness

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Ayush Dwivedi, Ashvi Soni
- **URL**: <http://arxiv.org/abs/2607.22969v1>
- **Submitted**: 2026-07-25 00:31:40
...
- **Reason**: This paper explores the effects of few-shot prompting on large language models, which is related to query understanding and ranking models in the context of NLP. However, the focus on model scale, architecture, and output parsing robustness is somewhat tangential to the user's primary interests in IR and search technologies. The paper's findings on few-shot prompting may have implications for user behavior modeling, but the connection is not immediately clear.
...
### 28. DeCoRAG: Cognitive Decoupling and Semantic-Aware Cropping for Complex Document Understanding

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Shuo Wang, Kai Zhang, Wenyuan Huang, Yizheng Yu, Xia Liao, Junming Su, Qing Wang, Fang Xi
- **URL**: <http://arxiv.org/abs/2607.24554v1>
- **Submitted**: 2026-07-27 15:28:02
- **Comment**: 11 pages, 4 figures, 8 tables
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores multimodal retrieval-augmented generation for complex document understanding, which is somewhat related to information retrieval and deep semantic understanding. However, the focus on graph RAG and multimodal pipelines is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 29. Retrieval-Augmented Large Language Models as Components of Cognitive Computing architecture for Regulatory Knowledge Management

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Dariusz Nowak-Nova
- **URL**: <http://arxiv.org/abs/2607.24352v1>
- **Submitted**: 2026-07-27 12:31:25
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores the application of Retrieval-Augmented Generation (RAG) architecture with large language models (LLMs) in a regulatory knowledge management context. While it touches on aspects of semantic understanding and knowledge retrieval, the primary focus is on augmenting LLMs for cognitive computing, which is somewhat related to information retrieval but not directly aligned with the user's core research themes.
...
### 30. Cross-Attention Calibrated Deduplication for Retrieval-Augmented Generation System

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Phuong Le Huy, Nam H. Nguyen, Quan V. Dang
- **URL**: <http://arxiv.org/abs/2607.24332v1>
- **Submitted**: 2026-07-27 12:09:03
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper discusses Retrieval-Augmented Generation (RAG) systems and proposes a new method for deduplication. While it touches on aspects of information retrieval, it is primarily focused on a specific application and does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. However, the use of cross-attention and semantic-level methods may be of some relevance to the broader field of information retrieval.
...
### 31. BioSentinel at EXIST 2026: Soft-Label Optimization with XLM-RoBERTa for Sexism Intent Classification in Memes

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Chandru Munisamy, Karthikeya Raguveer, Alapan Kuila
- **URL**: <http://arxiv.org/abs/2607.24137v1>
- **Submitted**: 2026-07-27 08:18:05
- **Comment**: 9 pages, 1 figure, 6 tables. Accepted for publication in the CLEF 2026 Working Notes (EXIST 2026), Jena, Germany
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Search technologies, but it is primarily focused on sexism intent classification in memes, which is not a central match to your core research themes. The use of Learning to Rank and soft-label optimization is relevant, but the context and application are quite different from your typical areas of interest.
...
### 32. SpecFormer: Mitigating Embedding and Attention Collapse via Spectral-Aware Transformer for Recommendation
...
- **Submitted**: 2026-07-27 05:53:00
- **Comment**: 12 pages,7 figures
- **Topic Keywords**: ctr, recommend, rank
- **Reason**: The paper focuses on recommendation systems, which is a related area to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The use of transformer architectures and attention mechanisms is relevant to search technologies, but the specific problem of embedding and attention collapse in recommendation systems is not a central match to the user's core research themes.
...
- **Submitted**: 2026-07-26 07:29:47
- **Comment**: Accepted at ACM Multimedia (ACM MM), 2026
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is somewhat related to information retrieval, but its focus on multimodal automated fact-checking and contamination risks in dynamic evaluation is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling. While it involves NLP and data mining, the context is more specific to fact-checking and may not be of primary interest to you.
...
### 34. OxygenREC-v2: Internalizing Discrimination into Generative Recommendation
...
- **Submitted**: 2026-07-27 10:45:48
- **Comment**: 16 pages, 8 figures
- **Topic Keywords**: ranking, click, cvr, conversion rate, retrieval, recommend, commerce, e-commerce, rank
- **Reason**: This paper focuses on generative recommendation and internalizing discrimination, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves e-commerce, it does not seem to address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's interests.
...
### 35. TriShieldRAG: A Three-Ring Defense-in-Depth Framework Against Knowledge Corruption in Retrieval-Augmented Generation
...
- **Submitted**: 2026-07-26 20:52:23
- **Topic Keywords**: retriever, query, queries, rag, retrieval, rank
- **Reason**: This paper focuses on Retrieval-Augmented Generation (RAG) and knowledge corruption, which is somewhat related to information retrieval and query understanding. However, the primary focus on defending against knowledge corruption and the use of language models does not align closely with the user's core research themes in IR and search technologies.
...
### 36. Energy Constrained Hierarchical Underwater Monitoring via Local Multi-Agent RAG

- **LLM Score**: 2
- **Keyword Score**: 11
- **Authors**: Mohamed Amine Janati, Laurent Gautier, Stéphane Barbot
- **URL**: <http://arxiv.org/abs/2607.24313v1>
- **Submitted**: 2026-07-27 11:57:55
- **Comment**: Contains 25 pages, 11 figures. To be submitted to Elsevier Ocean Engineering
- **Topic Keywords**: query, ltr, rag, retrieval, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on underwater monitoring and energy-constrained systems, which is unrelated to your areas of expertise.
...
### 37. LLM-based Source Code Compression via Thresholded Symbol Ranking

- **LLM Score**: 2
- **Keyword Score**: 10
- **Authors**: Angelo Nardone, Paolo Ferragina
- **URL**: <http://arxiv.org/abs/2607.24192v1>
- **Submitted**: 2026-07-27 09:12:00
- **Topic Keywords**: ranking, rag, ctr, rank, search, www
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The paper focuses on source code compression using Large Language Models, which is outside your primary areas of focus.
...
### 38. Keep It InMind: Benchmarking the Implicit-Association Blind Spot in Agent Memory

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Ruizhe Li, Mingxuan Du, Benfeng Xu, Zhendong Mao
- **URL**: <http://arxiv.org/abs/2607.24368v1>
- **Submitted**: 2026-07-27 12:42:12
- **Topic Keywords**: retriever, query, queries
- **Reason**: This paper appears to be focused on memory systems and their limitations in retrieving relevant information, particularly in the context of implicit associations. While it touches on the idea of information retrieval, it does not seem to be directly related to query understanding, ranking models, or user behavior modeling, which are core areas of interest for your research.
...
### 39. ConsistencyGate: Preventing Memory Contamination in LLM Agents via Self-Consistency Admission Control

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Yan Zhang, Shibo Li
- **URL**: <http://arxiv.org/abs/2607.22962v1>
- **Submitted**: 2026-07-25 00:08:09
- **Comment**: 24 pages, 2 figures, 6 tables, 1 algorithm; includes appendices
- **Topic Keywords**: queries, rag, retrieval, acl
- **Reason**: This paper focuses on preventing memory contamination in Large Language Model (LLM) agents, which is a topic in Natural Language Processing (NLP). Although it involves query understanding and model performance, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 40. CHiPS: Character Histograms and Positional Signals for Lightweight Authorship Attribution in Romanian Texts

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Sanda-Maria Avram, George C. Ţurcaş
- **URL**: <http://arxiv.org/abs/2607.22884v1>
- **Submitted**: 2026-07-24 19:48:32
- **Comment**: 17 pages, 12 tables
- **Topic Keywords**: rerank, listwise, ctr, rank
- **Reason**: This paper is not relevant to your research interests as it focuses on authorship attribution in Romanian texts using character-level features, which is outside the scope of information retrieval, search technologies, and natural language processing topics you are interested in.
...
### 41. Evaluating RAG for French immigration law: a benchmark and baseline study

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Annia Abtout, Julien Delaunay, Monika Ewa Rakoczy
- **URL**: <http://arxiv.org/abs/2607.24449v1>
- **Submitted**: 2026-07-27 13:55:35
- **Topic Keywords**: dense retrieval, rag, retrieval, recommend
- **Reason**: This paper appears to be focused on legal AI benchmarks and evaluation, which is somewhat related to information retrieval, but does not align with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's domain is also specific to French immigration law, which is not a primary focus of the user's research interests.
...
### 42. Who Gets Named: Citation Type Predicts Individual Naming by Grounded Language Models, and a Roster Instrument Captures 0.5% of It

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Dmitrij Żatuchin
- **URL**: <http://arxiv.org/abs/2607.23893v1>
- **Submitted**: 2026-07-26 23:37:34
- **Comment**: 28 pages, 5 figures. Data: https://doi.org/10.5281/zenodo.21612690
- **Topic Keywords**: query, recommend, search, acl
- **Reason**: This paper appears to be focused on the behavior of grounded language models in naming individuals in specific categories, which is somewhat related to user behavior modeling in search technologies. However, the paper's primary focus on citation types and individual naming in language models does not align closely with the user's core research themes in Information Retrieval and Search technologies.
...
### 43. Mwando: Leveraging AI to Preserve and Teach shiKomori

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Naira Abdou Mohamed, Haidar Nassur Said Ali, Mohamed Hazra, Naoufal Mohamed Soibira, Roushnaty Ali Yamani
- **URL**: <http://arxiv.org/abs/2607.23481v1>
- **Submitted**: 2026-07-26 06:11:11
- **Topic Keywords**: queries, rag, web search, search
- **Reason**: This paper appears to be unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves AI and NLP, the focus is on language preservation and education, rather than query understanding, ranking models, or real-time relevance optimization.
...
### 44. Speech Signals Complement LLMs for Predicting Interpersonal Attraction in Speed Dating

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Yuriko Kikuchi, Takato Hayashi, Ryusei Kimura, Naoya Inoue, Ryo Ishii, Shogo Okada
- **URL**: <http://arxiv.org/abs/2607.23037v1>
- **Submitted**: 2026-07-25 04:22:32
...
- **Reason**: This paper is not relevant to your research interests as it focuses on speech signals and large language models for predicting interpersonal attraction in speed dating, which is outside the scope of information retrieval, search technologies, and natural language processing.
...
### 45. D-Score: A Spectral Hidden-State Signal for Hallucination Detection in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Bianca Raimondi, Davide Evangelista, Maurizio Gabbrielli, Elena Loli Piccolomini
- **URL**: <http://arxiv.org/abs/2607.24586v1>
- **Submitted**: 2026-07-27 15:52:33
- **Comment**: Preprint. Under review
- **Topic Keywords**: rag, ctr, retrieval
- **Reason**: This paper focuses on hallucination detection in Large Language Models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific topic of hallucination detection is not a central match to your research themes.
...
### 46. Omni-Prune: Query-Aware Unified Token Pruning for Efficient Omnimodal Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Yiming Zhong, Chang Nie, Caifeng Shan
- **URL**: <http://arxiv.org/abs/2607.23445v1>
- **Submitted**: 2026-07-26 03:51:39
- **Comment**: 14 pages, 7 figures. Code: https://github.com/kimberlyii/Omni-Prune
- **Topic Keywords**: query, relevance
- **Reason**: This paper focuses on optimizing large language models for multimodal reasoning, specifically for audio and video inputs. While it involves query-aware processing, the context is not directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
- **Reason**: This paper appears to be focused on improving language models through a persistent memory of verified solutions, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it does involve some form of retrieval, it is more focused on memory-based retrieval rather than query understanding or ranking models.
...
### 48. A Novel Gravity-Quasi-Laplacian Approach to Identifying Influential Nodes in Complex Networks

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Shima Esfandiari, Seyed Mostafa Fakhrahmad
- **URL**: <http://arxiv.org/abs/2607.23419v1>
- **Submitted**: 2026-07-26 02:34:29
- **Comment**: 20 pages
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. It focuses on complex networks and identifying influential nodes, which is outside your primary areas of interest.
...
### 49. MS-GPT: Rethinking MS/MS De Novo Structure Elucidation as Spectrum-Induced Posterior Querying of a Molecule-Language Model
...
- **Topic Keywords**: query, queries, ctr, rank, acl
- **Reason**: This paper appears to be unrelated to the user's research interests in Information Retrieval, Search technologies, and Natural Language Processing. The paper focuses on molecular structure elucidation, a topic in analytical chemistry, and uses techniques from machine learning and molecular modeling, but does not address query understanding, ranking models, or user behavior modeling.
...
### 50. Harnessing X-ray Absorption Spectroscopy Data through Multimodal Mining of Battery Literature
...
- **Submitted**: 2026-07-26 23:12:06
- **Topic Keywords**: rag, ctr
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It appears to be focused on X-ray Absorption Spectroscopy and data mining in the materials science domain, which is unrelated to your areas of expertise.
