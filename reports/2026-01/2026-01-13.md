# Daily Papers Report - 2026-01-13

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. GAP-Net: Calibrating User Intent via Gated Adaptive Progressive Learning for CTR Prediction
...
- **Topic Keywords**: query, user behavior, click, ctr, click-through rate
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and user behavior modeling. The focus on Click-Through Rate (CTR) prediction and sequential user behavior modeling aligns closely with your interests in ranking models and click models. The proposed GAP-Net framework also demonstrates a deep semantic understanding, which is a key aspect of your research.
...
### 2. RLPO: Residual Listwise Preference Optimization for Long-Context Review Ranking
...
- **Topic Keywords**: ranking, listwise, pointwise, rag, commerce, e-commerce, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of review ranking and long-context settings. The proposed RLPO method leverages a strong pointwise LLM scorer and listwise representation-level residual correction, which aligns with your focus on query understanding and ranking models. The e-commerce domain is also a key area of interest for you, making this paper a strong match.
...
### 3. Is Agentic RAG worth it? An experimental comparison of RAG approaches
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The focus on Retrieval-Augmented Generation (RAG) systems and their comparison with Enhanced and Agentic RAG approaches aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on NLP and LLMs is slightly outside your core IR domain, which prevents a perfect score.
...
### 5. Lost in the Noise: How Reasoning Models Fail with Contextual Distractors

- **LLM Score**: 8
- **Keyword Score**: 2
- **Authors**: Seongyun Lee, Yongrae Jo, Minju Seo, Moontae Lee, Minjoon Seo
- **URL**: <http://arxiv.org/abs/2601.07226v1>
- **Submitted**: 2026-01-12 05:43:51
- **Comment**: Preprint
- **Topic Keywords**: rag
- **Reason**: This paper is highly relevant to information retrieval and search technologies, particularly in the context of query understanding and ranking models. The focus on model robustness and the impact of contextual distractors aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific domain of agentic AI systems and reasoning models is somewhat outside your primary focus on e-commerce and IR.
...
### 6. ReinPool: Reinforcement Learning Pooling Multi-Vector Embeddings for Retrieval System

- **LLM Score**: 8
- **Keyword Score**: 2
- **Authors**: Sungguk Cha, DongWook Kim, Mintae Kim, Youngsub Han, Byoung-Ki Jeon, Sangyeob Lee
- **URL**: <http://arxiv.org/abs/2601.07125v1>
- **Submitted**: 2026-01-12 01:37:21
- **Comment**: 5 pages
- **Topic Keywords**: retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the area of query understanding and ranking models. The use of reinforcement learning to optimize retrieval representations is also aligned with your interests in deep semantic understanding and real-time relevance optimization. However, the focus on vision-language embedding models and the Vidore V2 benchmark is somewhat specific and may not be directly applicable to your e-commerce background.
...
- **Reason**: The paper explores query planning and retrieval in a dynamic environment, which aligns with the user's interests in Information Retrieval and query understanding. However, the focus on tool retrieval and LLM agents is somewhat specific and doesn't directly relate to the user's primary focus on e-commerce or deep semantic understanding in IR. The use of Reinforcement Learning with Verifiable Rewards is also a notable aspect, but it's not a central theme in the user's research interests.
...
### 8. BayesRAG: Probabilistic Mutual Evidence Corroboration for Multimodal Retrieval-Augmented Generation
...
- **Reason**: This paper proposes a novel multimodal retrieval framework, BayesRAG, which models the consistency of retrieved candidates across text and image modalities using Bayesian inference and Dempster-Shafer evidence theory. While it's not directly focused on query understanding, ranking models, or user behavior modeling, it does address a related challenge in multimodal information retrieval, which is relevant to the broader field of Information Retrieval. However, its focus on multimodal retrieval and evidence fusion is somewhat tangential to the user's core research themes.
...
### 9. Reward Modeling from Natural Language Human Feedback
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. However, its focus on Generative Reward Models and natural language feedback is not a central match to your primary interests in IR and NLP. The paper's use of reinforcement learning and reward modeling is somewhat relevant, but it does not directly address your core research themes.
...
### 10. Learning to Trust the Crowd: A Multi-Model Consensus Reasoning Engine for Large Language Models
...
- **Topic Keywords**: query, ranking, listwise, pairwise, rag, rank
- **Reason**: This paper explores the reliability of large language models through multi-model consensus, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language models and their reliability does not directly align with the user's primary interests in IR and search technologies. The use of semantic embeddings and graph neural networks is relevant to NLP, but the application is not directly applicable to the user's research areas.
...
### 11. ActiShade: Activating Overshadowed Knowledge to Guide Multi-Hop Reasoning in Large Language Models
...
- **Topic Keywords**: query, queries, rag, retrieval
- **Reason**: The paper discusses a method for addressing knowledge overshadowing in multi-hop reasoning, which is a relevant topic in Information Retrieval. However, the focus is on large language models and multi-hop reasoning, which is somewhat related to the user's interests in query understanding and ranking models, but not a central match.
...
### 12. Order in the Evaluation Court: A Critical Analysis of NLG Evaluation Trends
...
- **Comment**: 8 pages
- **Topic Keywords**: recommend, acl, naacl, emnlp
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and evaluation metrics, but it does not directly align with the user's primary focus on Information Retrieval (IR) and query understanding. The paper's focus on NLG evaluation trends and metrics is relevant to the user's background in e-commerce and NLP, but it does not address the user's core research themes.
...
### 13. Conditional Memory via Scalable Lookup: A New Axis of Sparsity for Large Language Models
...
- **Reason**: This paper introduces a new sparsity axis for large language models, conditional memory, which enables efficient knowledge lookup. While it has implications for information retrieval, the focus is on improving the performance of language models, which is somewhat related to your interests in NLP and IR, but not directly aligned with your core research themes.
...
### 14. Towards Multi-Behavior Multi-Task Recommendation via Behavior-informed Graph Embedding Learning
...
- **Reason**: The paper discusses multi-behavior multi-task recommendation, which is somewhat related to user behavior modeling in information retrieval. However, the focus is on recommender systems rather than search technologies or query understanding, and the methods proposed are not directly applicable to the e-commerce domain.
...
### 15. Fine-Tuning vs. RAG for Multi-Hop Question Answering with Novel Knowledge
...
- **Reason**: This paper explores knowledge injection methods for multi-hop question answering, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on large language models and knowledge injection mechanisms is not directly aligned with the user's core research themes, despite some overlap with query understanding and user behavior modeling.
...
### 16. Structure First, Reason Next: Enhancing a Large Language Model using Knowledge Graph for Numerical Reasoning in Financial Documents
...
- **Reason**: The paper explores the application of Large Language Models (LLMs) in numerical reasoning for financial documents, which is somewhat related to information retrieval and search technologies. However, the focus on numerical reasoning and knowledge graphs is not a central match to the user's core research themes, which are primarily centered around query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and data mining, but it primarily focuses on relation extraction and zero-shot learning, which is not a central match to your core interests in Information Retrieval (IR), query understanding, and ranking models. The paper's use of entity side information is an interesting aspect, but it does not directly relate to your expertise in e-commerce or real-time relevance optimization.
...
### 18. Exploring the Meta-level Reasoning of Large Language Models via a Tool-based Multi-hop Tabular Question Answering Task

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Nick Ferguson, Alan Bundy, Kwabena Nuamah
- **URL**: <http://arxiv.org/abs/2601.07696v1>
- **Submitted**: 2026-01-12 16:29:21
- **Topic Keywords**: retrieval
- **Reason**: This paper explores the meta-level reasoning of Large Language Models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on question answering and reasoning ability in LLMs is not a central match to your primary research interests in IR and Search technologies. The paper's relevance is also limited by its focus on NLP and task understanding, which, while related, is not a primary area of interest.
...
### 19. Integrating Machine-Generated Short Descriptions into the Wikipedia Android App: A Pilot Deployment of Descartes
...
- **URL**: <http://arxiv.org/abs/2601.07631v1>
- **Submitted**: 2026-01-12 15:13:35
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat relevant to your research interests in Information Retrieval and Natural Language Processing, as it involves a machine-generated description model (Descartes) and its application in a real-world setting. However, the focus on Wikipedia and short descriptions is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance is also limited by its narrow scope and lack of connection to search technologies or e-commerce domain.
...
### 20. KALE: Enhancing Knowledge Manipulation in Large Language Models via Knowledge-aware Learning

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Qitan Lv, Tianyu Liu, Qiaosheng Zhang, Xingcheng Xu, Chaochao Lu
- **URL**: <http://arxiv.org/abs/2601.07430v1>
- **Submitted**: 2026-01-12 11:19:42
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on enhancing knowledge manipulation in large language models, which is not directly aligned with your primary focus on information retrieval and search technologies. The paper's emphasis on knowledge graphs and rationale-guided reasoning may be of interest, but it does not appear to be a central match for your research themes.
...
### 21. ReasonTabQA: A Comprehensive Benchmark for Table Question Answering from Real World Industrial Scenarios
...
- **Submitted**: 2026-01-12 07:36:06
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of table-based question answering. However, it focuses more on table reasoning and question answering rather than query understanding, ranking models, or user behavior modeling. The paper's emphasis on industrial scenarios and real-world applications is also somewhat tangential to your primary focus on e-commerce and deep semantic understanding.
...
### 22. The Confidence Dichotomy: Analyzing and Mitigating Miscalibration in Tool-Use Agents

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Weihao Xuan, Qingcheng Zeng, Heli Qi, Yunze Xiao, Junjue Wang, Naoto Yokoya
- **URL**: <http://arxiv.org/abs/2601.07264v1>
- **Submitted**: 2026-01-12 07:10:35
- **Topic Keywords**: web search, search
- **Reason**: The paper explores the concept of calibration in tool-use agents, which is related to information retrieval and natural language processing. However, the focus on tool-use agents and calibration in autonomous systems is not directly aligned with the user's core research themes in information retrieval and search technologies.
...
### 23. Emotional Support Evaluation Framework via Controllable and Diverse Seeker Simulator

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Chaewon Heo, Cheyon Jin, Yohan Jo
- **URL**: <http://arxiv.org/abs/2601.07698v1>
- **Submitted**: 2026-01-12 16:30:38
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of chatbots and seeker behavior modeling. However, the focus on emotional support evaluation and chatbot interaction is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling in e-commerce and search technologies.
...
### 24. RAIRS: Optimizing Redundant Assignment and List Layout for IVF-Based ANN Search
...
- **Reason**: This paper focuses on optimizing Approximate Nearest Neighbors Search (ANNS) methods, specifically IVF, which is not directly related to Information Retrieval or Search technologies. While it involves vector databases and distance computations, the context and techniques described are more aligned with data mining and database optimization rather than query understanding, ranking models, or user behavior modeling.
...
### 25. ES-Mem: Event Segmentation-Based Memory for Long-Term Dialogue Agents
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on dialogue agents and memory mechanisms, which is outside your primary research interests in Information Retrieval and Search technologies. While it involves some form of semantic understanding, the context is specific to dialogue systems and does not align with your core themes.
...
### 26. From RAG to Agentic RAG for Faithful Islamic Question Answering
...
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on Islamic question answering, which is not a core area of your research interests. While it involves some NLP and retrieval aspects, the specific context and application are quite different from your usual domains of e-commerce, IR, and search technologies.
...
### 27. OS-Symphony: A Holistic Framework for Robust and Generalist Computer-Using Agent
...
- **Reason**: This paper appears to be focused on Computer-Using Agents and Vision-Language Models, which, while related to search technologies, does not directly align with the user's core research themes in Information Retrieval, query understanding, ranking models, and user behavior modeling. Although it involves multimodal search, the context is not directly applicable to the user's interests in e-commerce or real-time relevance optimization.
...
### 28. AptaFind: A lightweight local interface for automated aptamer curation from scientific literature
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves text analysis and semantic understanding, its focus is on aptamer curation from scientific literature, which is a narrow domain unrelated to your core research themes.
...
### 29. Adaptive Layer Selection for Layer-Wise Token Pruning in LLM Inference
...
- **Reason**: This paper focuses on optimizing large language models for inference, specifically proposing a method for adaptive layer selection in KV cache reduction. While it involves NLP and deep semantic understanding, it is not directly related to information retrieval, search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 30. Loci Similes: A Benchmark for Extracting Intertextualities in Latin Literature
...
- **Topic Keywords**: retrieval, search
- **Reason**: This paper is not relevant to your core research themes in Information Retrieval and Search technologies, as it focuses on a specific domain (Latin Literature) and task (intertextuality detection), which does not align with your interests in query understanding, ranking models, and user behavior modeling.
...
### 31. DiffER: Diffusion Entity-Relation Modeling for Reversal Curse in Diffusion Large Language Models
...
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on addressing the 'reversal curse' in Diffusion Large Language Models, which is not directly related to Information Retrieval, query understanding, or ranking models. While it involves entity-aware training, it's primarily a NLP problem and does not seem to address real-time relevance optimization or deep semantic understanding in the context of search technologies.
...
### 32. Learning Through Dialogue: Unpacking the Dynamics of Human-LLM Conversations on Political Issues

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Shaz Furniturewala, Gerard Christopher Yeo, Kokil Jaidka
- **URL**: <http://arxiv.org/abs/2601.07796v1>
- **Submitted**: 2026-01-12 18:10:21
- **Topic Keywords**: rag
- **Reason**: This paper focuses on the dynamics of human-Large Language Model (LLM) conversations, analyzing the effects of LLM explanations on users' learning and confidence. While it touches on the interactional aspects of AI systems, it is primarily concerned with the educational implications of LLMs, which is not a central match to your research interests in Information Retrieval and Search technologies.
...
### 33. Reasoning Models Will Blatantly Lie About Their Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: William Walden
- **URL**: <http://arxiv.org/abs/2601.07663v2>
- **Submitted**: 2026-01-12 15:43:24
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus on Large Reasoning Models and their behavior in multiple choice questions does not align with your core themes of query understanding, ranking models, or user behavior modeling.
...
### 34. GRPO with State Mutations: Improving LLM-Based Hardware Test Plan Generation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Dimple Vijay Kochar, Nathaniel Pinckney, Guan-Ting Liu, Chia-Tung Ho, Chenhui Deng, Haoxing Ren, Brucek Khailany
- **URL**: <http://arxiv.org/abs/2601.07593v1>
- **Submitted**: 2026-01-12 14:42:42
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on applying large language models to hardware test plan generation, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 35. Controlling Multimodal Conversational Agents with Coverage-Enhanced Latent Actions

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yongqi Li, Hao Lang, Tieyun Qian, Yongbin Li
- **URL**: <http://arxiv.org/abs/2601.07516v1>
- **Submitted**: 2026-01-12 13:13:24
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multimodal conversational agents and reinforcement learning, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the context and application are quite different from the user's core themes.
...
### 36. SCALPEL: Selective Capability Ablation via Low-rank Parameter Editing for Large Language Model Interpretability Analysis

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zihao Fu, Xufeng Duan, Zhenguang G. Cai
- **URL**: <http://arxiv.org/abs/2601.07411v1>
- **Submitted**: 2026-01-12 10:54:18
- **Topic Keywords**: rank, search
- **Reason**: This paper focuses on large language model interpretability analysis, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific topic of model interpretability is not a central match for your research themes.
...
### 37. Controlled Self-Evolution for Algorithmic Code Optimization
...
- **URL**: <http://arxiv.org/abs/2601.07348v2>
- **Submitted**: 2026-01-12 09:23:13
- **Comment**: 27 pages
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on algorithmic code optimization and self-evolution methods in the context of code generation seems to be outside your primary areas of interest.
...
### 38. Towards Comprehensive Semantic Speech Embeddings for Chinese Dialects

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Kalvin Chang, Yiwen Shao, Jiahong Li, Dong Yu
- **URL**: <http://arxiv.org/abs/2601.07274v1>
- **Submitted**: 2026-01-12 07:30:51
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on speech embeddings for Chinese dialects, which is not directly related to Information Retrieval, Search technologies, or Natural Language Processing in the context of query understanding, ranking models, or user behavior modeling. While it involves language models, the topic is more specific to speech recognition and dialects, making it less relevant to the user's core research themes.
...
### 39. MI-PRUN: Optimize Large Language Model Pruning via Mutual Information

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Hao Zhang, Zhibin Zhang, Guangxin Wu, He Chen, Jiafeng Guo, Xueqi Cheng
- **URL**: <http://arxiv.org/abs/2601.07212v1>
- **Submitted**: 2026-01-12 05:06:01
- **Comment**: 10 pages
- **Topic Keywords**: rag
- **Reason**: This paper focuses on model pruning for Large Language Models, which is not directly related to Information Retrieval, Search technologies, or user behavior modeling. While it involves optimization techniques, the context is different from the user's core research themes.
...
### 40. MAESTRO: Meta-learning Adaptive Estimation of Scalarization Trade-offs for Reward Optimization
...
- **URL**: <http://arxiv.org/abs/2601.07208v1>
- **Submitted**: 2026-01-12 05:02:48
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on Large Language Models and reward optimization, which is somewhat related to information retrieval and search technologies. However, the specific context of language models and open-domain settings does not directly align with the user's core research themes in IR and search technologies.
...
### 41. Rewarding Creativity: A Human-Aligned Generative Reward Model for Reinforcement Learning in Storytelling

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhaoyan Li, Hang Lei, Yujia Wang, Lanbo Liu, Hao Liu, Liang Yu
- **URL**: <http://arxiv.org/abs/2601.07149v1>
- **Submitted**: 2026-01-12 02:39:47
- **Topic Keywords**: acl
- **Reason**: This paper focuses on Generative Reward Models for Reinforcement Learning in Storytelling, which is not directly related to Information Retrieval, Search technologies, or user behavior modeling. While it involves Natural Language Processing, the context is creative storytelling, which is not a primary area of interest for your research.
...
### 42. Measuring Iterative Temporal Reasoning with Time Puzzles

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Zhengxiang Wang, Zeyu Dong
- **URL**: <http://arxiv.org/abs/2601.07148v2>
- **Submitted**: 2026-01-12 02:39:26
- **Topic Keywords**: web search, search
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and specifically focuses on temporal reasoning, which is somewhat tangential to the user's primary research interests in Information Retrieval and Search technologies. While it involves a constraint-based date inference task, it does not directly relate to query understanding, ranking models, or user behavior modeling.
...
### 43. Task Arithmetic with Support Languages for Low-Resource ASR

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Emma Rafkin, Dan DeGenaro, Xiulin Yang
- **URL**: <http://arxiv.org/abs/2601.07038v1>
- **Submitted**: 2026-01-11 19:24:05
- **Comment**: 8 pages, 3 Figures, preprint after submitted for review for a *ACL conference
- **Topic Keywords**: rag
- **Reason**: This paper focuses on automatic speech recognition (ASR) for low-resource languages, using task arithmetic and leveraging related high-resource languages. While it involves natural language processing, it does not directly relate to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 44. The Confidence Trap: Gender Bias and Predictive Certainty in LLMs

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Ahmed Sabir, Markus Kängsepp, Rajesh Sharma
- **URL**: <http://arxiv.org/abs/2601.07806v1>
- **Submitted**: 2026-01-12 18:38:05
- **Comment**: AAAI 2026 (AISI Track), Oral. Project page: https://bit.ly/4p8OKQD
- **Topic Keywords**: search
- **Reason**: This paper focuses on Large Language Models (LLMs) and their confidence scores, which is not directly related to your core research interests in Information Retrieval, Search technologies, and user behavior modeling. Although it touches on fairness and bias, which are relevant to NLP, the specific context of LLMs and gender bias does not align closely with your primary focus on query understanding, ranking models, and real-time relevance optimization.
...
### 45. Proof of Time: A Benchmark for Evaluating Scientific Idea Judgments
...
- **Submitted**: 2026-01-12 14:55:37
- **Comment**: under review
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are the core areas of your research interests. Although it involves Natural Language Processing and agent-based research judgments, the focus is on evaluating scientific idea judgments, which is not a central match for your primary research themes.
...
### 46. High-Rank Structured Modulation for Parameter-Efficient Fine-Tuning
...
- **URL**: <http://arxiv.org/abs/2601.07507v1>
- **Submitted**: 2026-01-12 13:06:17
- **Comment**: under review
- **Topic Keywords**: rank
- **Reason**: This paper focuses on parameter-efficient fine-tuning of pre-trained language models, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves deep learning and NLP, the topic is more aligned with model optimization and adaptation, rather than semantic understanding or real-time relevance optimization.
...
### 47. SAD: A Large-Scale Strategic Argumentative Dialogue Dataset
...
- **Submitted**: 2026-01-12 11:11:37
- **Comment**: under review
- **Topic Keywords**: search
- **Reason**: This paper is about argumentative dialogue datasets and models, which is somewhat related to Natural Language Processing (NLP), but it does not directly align with the user's core research themes in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling.
...
### 48. On Narrative: The Rhetorical Mechanisms of Online Polarisation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jan Elfes, Marco Bastos, Luca Maria Aiello
- **URL**: <http://arxiv.org/abs/2601.07398v1>
- **Submitted**: 2026-01-12 10:34:57
- **Topic Keywords**: search
- **Reason**: This paper appears to be primarily focused on narrative polarisation and its effects on online discourse, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves the analysis of YouTube videos and comments, the paper's emphasis on narrative roles and polarisation does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 49. GROKE: Vision-Free Navigation Instruction Evaluation via Graph Reasoning on OpenStreetMap

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Farzad Shami, Subhrasankha Dey, Nico Van de Weghe, Henrikki Tenkanen
- **URL**: <http://arxiv.org/abs/2601.07375v1>
- **Submitted**: 2026-01-12 09:56:47
- **Comment**: Under Review for ACL 2026
- **Topic Keywords**: search
- **Reason**: This paper focuses on Vision-and-Language Navigation (VLN) and evaluation of navigation instructions, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves some aspects of data and graph reasoning, the context and application are quite different from your areas of focus.
...
### 50. Engineering of Hallucination in Generative AI: It's not a Bug, it's a Feature

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Tim Fingscheidt, Patrick Blumenberg, Björn Möller
- **URL**: <http://arxiv.org/abs/2601.07046v1>
- **Submitted**: 2026-01-11 19:43:38
- **Comment**: This is an article that has been written reflecting a talk of Tim Fingscheidt at the 2025 New Year gathering of Braunschweigische Wissenschaftliche Gesellschaft on January 25th, 2025
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The topic of hallucination in Generative AI is unrelated to your areas of focus.
