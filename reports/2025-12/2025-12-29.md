# Daily Papers Report - 2025-12-29
...
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of robustness and security of neural ranking models. The focus on certified robustness against adversarial attacks aligns with your interest in query understanding and ranking models. The application to real-world retrieval systems is also a good match.
...
### 2. DICE: Discrete Interpretable Comparative Evaluation with Probabilistic Scoring for Retrieval-Augmented Generation

- **LLM Score**: 7
- **Keyword Score**: 8
- **Authors**: Shiyan Liu, Jian Ma, Rui Qu
- **URL**: <http://arxiv.org/abs/2512.22629v1>
- **Submitted**: 2025-12-27 16:02:00
- **Comment**: Accepted at ResponsibleFM @ NeurIPS 2025
- **Topic Keywords**: ranking, rag, retrieval, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of Retrieval-Augmented Generation (RAG) systems. While it focuses on evaluation metrics rather than query understanding or ranking models, the work on explainability and robustness is relevant to your interests in deep semantic understanding and real-time relevance optimization.
...
### 3. Scoring, Reasoning, and Selecting the Best! Ensembling Large Language Models via a Peer-Review Process
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it involves ensemble methods for large language models. However, the focus on peer-review and ensemble methods for response selection is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling.
...
### 4. Semantic Tree Inference on Text Corpa using a Nested Density Approach together with Large Language Model Embeddings
...
- **Reason**: This paper proposes a novel approach to inferring hierarchical semantic relationships among texts using a nested density clustering method and large language model embeddings. While it primarily focuses on semantic text classification and clustering, it touches on topics related to information retrieval, such as text representation and retrieval by semantic similarity. However, its primary focus is not on query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 5. Eliciting Behaviors in Multi-Turn Conversations
...
- **Reason**: This paper explores behavior elicitation in multi-turn conversations, which is somewhat related to user behavior modeling in search technologies. However, the focus is on conversational settings and language models, rather than traditional search or IR. The work may have some indirect implications for query understanding or ranking models, but it is not a central match for the user's research interests.
...
### 6. Nested Browser-Use Learning for Agentic Information Seeking
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and real-time relevance optimization. However, its focus on browser-use learning and agentic information seeking is not a central match to your primary research themes. The paper's use of nested browser-use learning to improve information acquisition is an interesting approach, but it does not directly address your core interests in ranking models, user behavior modeling, or NLP.
...
### 7. OxygenREC: An Instruction-Following Generative Framework for E-commerce Recommendation
...
- **URL**: <http://arxiv.org/abs/2512.22386v1>
- **Submitted**: 2025-12-26 21:13:59
- **Comment**: 37 pages, 7 figures
- **Topic Keywords**: query, rag, retrieval, recommend, commerce, e-commerce
- **Reason**: The paper explores a recommendation system, leveraging deep reasoning capabilities, but its focus on e-commerce and scalability does not directly align with the user's primary interests in Information Retrieval, query understanding, and ranking models. While it touches on aspects related to user behavior modeling, the paper's emphasis on recommender systems and industrial applications makes it only loosely relevant to the user's research interests.
...
- **Submitted**: 2025-12-27 02:37:40
- **Comment**: A winning solution for the NeurIPS 2025 MMU-RAGent Competition (Closed-Source Text-to-Text Static Evaluation)
- **Topic Keywords**: query, rag, retrieval, neurips
- **Reason**: The paper discusses Retrieval-Augmented Generation (RAG) in open-domain settings, which is somewhat related to information retrieval. However, the focus on hierarchical content filtering and two-pass generation for RAG is not directly aligned with the user's interests in query understanding, ranking models, and user behavior modeling. While it touches on aspects of NLP, it is not a central match for the user's research themes.
...
### 9. Fine-Tuning LLMs with Fine-Grained Human Feedback on Text Spans
...
- **Reason**: The paper explores fine-tuning language models with human feedback, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on text spans and preference supervision is more aligned with Natural Language Processing and deep semantic understanding, but not directly related to the user's primary research interests in IR and search technologies.
...
- **Submitted**: 2025-12-28 14:53:24
- **Topic Keywords**: ranking, rank
- **Reason**: The paper explores reinforcement learning and its application to large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on next-token prediction and diversity/precision trade-off is not directly aligned with the user's core research themes. The connection to real-time relevance optimization is also not explicitly mentioned.
...
### 11. Not too long do read: Evaluating LLM-generated extreme scientific summaries
...
- **Reason**: This paper evaluates the performance of Large Language Models (LLMs) in generating scientific summaries, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on summarization and LLMs is not a central match to the user's core research themes, and the connection to real-time relevance optimization is not clear.
...
### 12. Multimodal Fact-Checking: An Agent-based Approach

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Danni Xu, Shaojing Fan, Xuanang Cheng, Mohan Kankanhalli
- **URL**: <http://arxiv.org/abs/2512.22933v1>
- **Submitted**: 2025-12-28 13:58:33
- **Comment**: Code and dataset will be released at https://github.com/xudanni0927/AgentFact
- **Topic Keywords**: retrieval, search
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, particularly in the context of fact-checking and multimodal information analysis. However, it does not directly align with your focus on query understanding, ranking models, or user behavior modeling, and is more focused on a specific application area rather than a core research theme.
...
### 13. Improving Generalization in LLM Structured Pruning via Function-Aware Neuron Grouping

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Tao Yu, Yongqi An, Kuan Zhu, Guibo Zhu, Ming Tang, Jinqiao Wang
- **URL**: <http://arxiv.org/abs/2512.23014v1>
- **Submitted**: 2025-12-28 17:26:56
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving the generalization of Large Language Models (LLMs) through structured pruning, which is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding. However, it does not directly align with the user's primary focus on Information Retrieval (IR) and Search technologies. The paper's emphasis on LLMs and pruning methods also does not strongly connect to the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 14. NepEMO: A Multi-Label Emotion and Sentiment Analysis on Nepali Reddit with Linguistic Insights and Temporal Trends

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Sameer Sitoula, Tej Bahadur Shahi, Laxmi Prasad Bhatt, Anisha Pokhrel, Arjun Neupane
- **URL**: <http://arxiv.org/abs/2512.22823v1>
- **Submitted**: 2025-12-28 07:27:51
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and data mining, particularly in the area of sentiment analysis and emotion classification. However, it focuses on a specific domain (Nepali Reddit) and task (multi-label emotion and sentiment classification), which is not directly aligned with your core research themes in Information Retrieval and Search technologies.
...
### 15. Conformal Prediction Sets for Next-Token Prediction in Large Language Models: Balancing Coverage Guarantees with Set Efficiency

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yoshith Roy Kotla, Varshith Roy Kotla
- **URL**: <http://arxiv.org/abs/2512.22682v1>
- **Submitted**: 2025-12-27 19:08:54
- **Comment**: 10 pages, 5 tables and 1 algorithm
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to information retrieval, specifically in the context of large language models and uncertainty quantification. However, its focus on next-token prediction and conformal prediction sets is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling. While it touches on related topics, it does not appear to be a central match for the user's research themes.
...
- **Submitted**: 2025-12-27 14:14:16
- **Topic Keywords**: rag
- **Reason**: The paper explores multimodal conversational aspect-based sentiment analysis, which is related to natural language processing and deep semantic understanding. However, it does not directly focus on information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 17. Hallucination Detection and Evaluation of Large Language Model

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Chenggong Zhang, Haopeng Wang
- **URL**: <http://arxiv.org/abs/2512.22416v1>
- **Submitted**: 2025-12-27 00:17:03
- **Topic Keywords**: retrieval
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Large Language Models, but it doesn't directly align with your primary focus on Information Retrieval (IR), query understanding, and ranking models. The paper's emphasis on hallucination detection and evaluation in LLMs is relevant to your broader interests in NLP, but it doesn't appear to have a significant impact on IR or search technologies.
...
### 18. Prompt engineering does not universally improve Large Language Model performance across clinical decision-making tasks

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Mengdi Chai, Ali R. Zomorrodi
- **URL**: <http://arxiv.org/abs/2512.22966v1>
- **Submitted**: 2025-12-28 15:15:51
- **Topic Keywords**: recommend
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and Large Language Models, but it does not directly align with their primary focus on Information Retrieval, especially in areas requiring deep semantic understanding and real-time relevance optimization. The paper's focus on clinical decision-making tasks and prompt engineering is not a central match for the user's research themes.
...
### 19. OrchANN: A Unified I/O Orchestration Framework for Skewed Out-of-Core Vector Search
...
- **URL**: <http://arxiv.org/abs/2512.22838v1>
- **Submitted**: 2025-12-28 08:42:38
- **Comment**: 13 pages, 30 figures
- **Topic Keywords**: query, queries, ranking, rerank, rank, search
- **Reason**: This paper focuses on out-of-core vector search, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves search, the context is more aligned with data storage and retrieval rather than query understanding, ranking models, or user behavior modeling.
...
### 20. VL-RouterBench: A Benchmark for Vision-Language Model Routing
...
- **Reason**: This paper focuses on vision-language models and routing systems, which is outside your primary area of interest in Information Retrieval and Search technologies. While it involves ranking models, the context is different from Learning to Rank and click models, and the paper's emphasis on vision-language models and multimodal routing does not align with your research themes.
...
### 21. A Real-Time System to Populate FRA Form 57 from News

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Chansong Lim, Haz Sameen Shahgir, Yue Dong, Jia Chen, Evangelos E. Papalexakis
- **URL**: <http://arxiv.org/abs/2512.22457v1>
- **Submitted**: 2025-12-27 04:22:08
- **Comment**: to be published in WSDM 2026 Demonstration
- **Topic Keywords**: information retrieval, rag, retrieval
- **Reason**: This paper appears to be focused on a specific domain (railway incidents) and utilizes techniques from Natural Language Processing (NLP) and Information Retrieval (IR), but it does not align with the user's core research themes of query understanding, ranking models, or user behavior modeling. The paper's emphasis on populating a specific form from news articles also seems to be a one-off application rather than a generalizable solution.
...
### 22. HalluMat: Detecting Hallucinations in LLM-Generated Materials Science Content Through Multi-Stage Verification

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Bhanu Prakash Vangala, Sajid Mahmud, Pawan Neupane, Joel Selvaraj, Jianlin Cheng
- **URL**: <http://arxiv.org/abs/2512.22396v1>
- **Submitted**: 2025-12-26 22:16:12
- **Topic Keywords**: queries, retrieval, search
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves Large Language Models and detection of hallucinations, the focus is on materials science content and AI-generated content, which is not a central match to your research themes.
...
### 23. Chinese Morph Resolution in E-commerce Live Streaming Scenarios
...
- **Reason**: This paper focuses on morph resolution in e-commerce live streaming, which is not a core area of interest. While it involves a form of search or information retrieval, the context is specific to e-commerce live streaming and does not align with the user's broader interests in query understanding, ranking models, and user behavior modeling.
...
### 24. TabiBERT: A Large-Scale ModernBERT Foundation Model and Unified Benchmarking Framework for Turkish
...
- **Reason**: This paper focuses on developing a Turkish language encoder using BERT architecture, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and domain (Turkish language) are not aligned with your background in e-commerce and broader interests in deep semantic understanding and real-time relevance optimization.
...
### 25. PROFASR-BENCH: A Benchmark for Context-Conditioned ASR in High-Stakes Professional Speech
...
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are core areas of your research interests. While it involves Natural Language Processing (NLP) and deep semantic understanding, the focus is on Automatic Speech Recognition (ASR) in professional settings, which is a distinct area of research.
...
### 26. CNSight: Evaluation of Clinical Note Segmentation Tools

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Risha Surana, Adrian Law, Sunwoo Kim, Rishab Sridhar, Angxiao Han, Peiyu Hong
- **URL**: <http://arxiv.org/abs/2512.22795v1>
- **Submitted**: 2025-12-28 05:40:15
- **Topic Keywords**: rag, ctr
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves text analysis and segmentation, the focus is on clinical notes and medical applications, which is outside the user's primary areas of interest.
...
### 27. Training AI Co-Scientists Using Rubric Rewards
...
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on training AI co-scientists for research goals, leveraging existing research papers and reinforcement learning. While it involves natural language processing and model training, it is not directly related to information retrieval, search technologies, or query understanding, which are the core areas of your research interests.
...
### 28. Interpretable Safety Alignment via SAE-Constructed Low-Rank Subspace Adaptation
...
- **Reason**: This paper focuses on low-rank adaptation methods for fine-tuning large language models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the concept of semantic understanding, the context is different and the paper's primary contribution is in the area of model interpretability and safety alignment, which is not a central match for your research interests.
...
### 29. Fragile Knowledge, Robust Instruction-Following: The Width Pruning Dichotomy in Llama-3.2

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Pere Martra
- **URL**: <http://arxiv.org/abs/2512.22671v1>
- **Submitted**: 2025-12-27 18:09:57
- **Comment**: 23 pages, 5 figures, 9 tables. Code available at https://github.com/peremartra/llama-glu-expansion-pruning
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on the effects of width pruning on a specific model (LLaMA-3.2) and its capabilities, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing, the context is more aligned with model architecture and efficiency rather than query understanding or ranking models.
...
### 30. Dream-VL & Dream-VLA: Open Vision-Language and Vision-Language-Action Models with Diffusion Language Model Backbone

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Jiacheng Ye, Shansan Gong, Jiahui Gao, Junming Fan, Shuang Wu, Wei Bi, Haoli Bai, Lifeng Shang, Lingpeng Kong
- **URL**: <http://arxiv.org/abs/2512.22615v1>
- **Submitted**: 2025-12-27 14:46:24
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on vision-language models and their applications in visual planning and robotic control, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 31. Close the Loop: Synthesizing Infinite Tool-Use Data via Multi-Agent Role-Playing
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on Large Language Models and tool invocation does not align with your areas of expertise.
...
### 32. Automatic Detection of Complex Quotation Patterns in Aggadic Literature
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on detecting complex quotation patterns in Aggadic literature, which is a specific application in the digital humanities and computational philology.
...
### 33. AI4Reading: Chinese Audiobook Interpretation System Based on Multi-Agent Collaboration
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language models and text generation, its focus on audiobook interpretation and multi-agent collaboration is not aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 34. Harnessing Large Language Models for Biomedical Named Entity Recognition

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jian Chen, Leilei Su, Cong Sun
- **URL**: <http://arxiv.org/abs/2512.22738v1>
- **Submitted**: 2025-12-28 01:34:23
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on Biomedical Named Entity Recognition and Large Language Models for a specific domain. While it involves fine-tuning and data curation, the context and application are distinct from the user's primary interests.
...
### 35. Mitigating Social Desirability Bias in Random Silicon Sampling

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sashank Chapala, Maksym Mironov, Songgaojun Deng
- **URL**: <http://arxiv.org/abs/2512.22725v1>
- **Submitted**: 2025-12-27 23:21:32
- **Comment**: 31 pages, 9 figures, and 24 tables
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. It focuses on mitigating Social Desirability Bias in Large Language Models, which is outside your primary areas of interest.
...
### 36. On the Role of Discreteness in Diffusion LLMs

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Ziqi Jin, Bin Wang, Xiang Lin, Lidong Bing, Aixin Sun
- **URL**: <http://arxiv.org/abs/2512.22630v1>
- **Submitted**: 2025-12-27 16:03:08
- **Topic Keywords**: rag
- **Reason**: This paper focuses on diffusion models for language generation, which is a topic in Natural Language Processing (NLP). However, it does not appear to be directly related to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
- **Submitted**: 2025-12-27 01:52:06
- **Comment**: Project Page: https://github.com/yifanzhang-pro/monadic-context-engineering
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Monadic Context Engineering for AI agent design, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on complex reasoning and tool use, it doesn't address query understanding, ranking models, or user behavior modeling.
...
### 38. Multilingual Hidden Prompt Injection Attacks on LLM-Based Academic Reviewing
...
- **Topic Keywords**: icml
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are the core areas of your research interests. While it involves LLMs and academic reviewing, the focus is on security attacks rather than deep semantic understanding or real-time relevance optimization.
...
### 39. Less is more: Probabilistic reduction is best explained by small-scale predictability measures
...
- **Topic Keywords**: search
- **Reason**: This paper appears to be more focused on cognitive phenomena and language model probabilities, which doesn't align closely with your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on probabilistic reduction, it doesn't seem to be directly related to your areas of expertise.
...
### 40. Anka: A Domain-Specific Language for Reliable LLM Code Generation
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on Large Language Models (LLMs) and code generation. While it explores the capabilities of LLMs, it does not address query understanding, ranking models, or user behavior modeling, which are core areas of interest for your research.
...
### 41. Fake News Classification in Urdu: A Domain Adaptation Approach for a Low-Resource Language

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Muhammad Zain Ali, Bernhard Pfahringer, Tony Smith
- **URL**: <http://arxiv.org/abs/2512.22778v1>
- **Submitted**: 2025-12-28 04:42:40
- **Topic Keywords**: search
- **Reason**: This paper focuses on fake news classification in Urdu, a low-resource language, using domain adaptation and multilingual models. While it involves NLP and classification, it does not align with the user's primary research interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. The paper's focus on a specific language and task makes it less relevant to the user's broader interests.
...
### 42. Data Augmentation for Classification of Negative Pregnancy Outcomes in Imbalanced Data

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Md Badsha Biswas
- **URL**: <http://arxiv.org/abs/2512.22732v1>
- **Submitted**: 2025-12-28 00:22:13
- **Topic Keywords**: search
- **Reason**: This paper focuses on using social media data for studying negative pregnancy outcomes, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves Natural Language Processing, the context and application are not aligned with the user's interests.
...
### 43. M2G-Eval: Enhancing and Evaluating Multi-granularity Multilingual Code Generation
...
- **Submitted**: 2025-12-27 16:00:46
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on code generation and evaluation in large language models, which is outside your primary focus on Information Retrieval, Search technologies, and Natural Language Processing. Although it involves deep semantic understanding, the context is different from your areas of interest.
...
### 44. Constituency Structure over Eojeol in Korean Treebanks

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jungyeul Park, Chulwoo Park
- **URL**: <http://arxiv.org/abs/2512.22487v1>
- **Submitted**: 2025-12-27 06:12:26
- **Topic Keywords**: korea
- **Reason**: This paper is about the design of Korean constituency treebanks and the choice of terminal units, which is a topic in Natural Language Processing (NLP). However, it does not appear to be related to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 45. AFA-LoRA: Enabling Non-Linear Adaptations in LoRA with Activation Function Annealing

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jiacheng Li, Jianchao Tan, Zhidong Yang, Feiye Huo, Yerui Sun, Yuchen Xie, Xunliang Cai
- **URL**: <http://arxiv.org/abs/2512.22455v1>
- **Submitted**: 2025-12-27 04:12:40
- **Topic Keywords**: rank
- **Reason**: This paper focuses on a novel training strategy for Low-Rank Adaptation (LoRA), which is a parameter-efficient fine-tuning method. While it touches on the concept of adaptation, it does not directly relate to query understanding, ranking models, user behavior modeling, or deep semantic understanding in information retrieval, which are the core areas of your research interests.
...
### 46. Exploring the Vertical-Domain Reasoning Capabilities of Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jie Zhou, Xin Chen, Jie Zhang, Zhe Li
- **URL**: <http://arxiv.org/abs/2512.22443v1>
- **Submitted**: 2025-12-27 02:39:34
- **Topic Keywords**: search
- **Reason**: This paper focuses on the application of Large Language Models in the accounting domain, exploring their vertical-domain reasoning capabilities. While it touches on the integration of LLMs with professional fields, it does not directly relate to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing.
...
### 47. LLM-Guided Exemplar Selection for Few-Shot Wearable-Sensor Human Activity Recognition

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Elsen Ronando, Sozo Inoue
- **URL**: <http://arxiv.org/abs/2512.22385v1>
- **Submitted**: 2025-12-26 21:03:15
...
- **Topic Keywords**: rank
- **Reason**: This paper focuses on Human Activity Recognition using wearable sensors and few-shot learning, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves some machine learning concepts, the application domain and methodology are quite different from the user's interests.
...
### 48. Scalable Residual Feature Aggregation Framework with Hybrid Metaheuristic Optimization for Robust Early Pancreatic Neoplasm Detection in Multimodal CT Imaging
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, Natural Language Processing, or data mining. The paper focuses on medical imaging and early detection of pancreatic neoplasm, which is outside your areas of expertise.
