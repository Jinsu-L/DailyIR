# Daily Papers Report - 2026-07-19
...
- **URL**: <http://arxiv.org/abs/2607.15555v1>
- **Submitted**: 2026-07-17 01:54:45
- **Topic Keywords**: information retrieval, query, ranking, relevance, retrieval, rank, acl, trec
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The study of how relevance is represented inside large language models (LLMs) and the use of layer-wise probing to diagnose where relevance emerges aligns with your focus on deep semantic understanding and real-time relevance optimization.
...
### 2. Scientific Claim-Source Retrieval Revisited: A Comparative Study of Style Transfer and Re-Ranking

- **LLM Score**: 8
- **Keyword Score**: 9
- **Authors**: Tobias Schreieder, Harsh Khandelwal, Yu-Ling Zhong, Michael Färber
- **URL**: <http://arxiv.org/abs/2607.15875v1>
- **Submitted**: 2026-07-17 11:43:37
- **Comment**: Accepted at CLEF 2026 (Best of Labs)
- **Topic Keywords**: dense retrieval, ranking, retrieval, rank
- **Reason**: This paper is highly relevant to Information Retrieval, specifically in the context of scientific claim-source retrieval, which involves identifying source publications for given claims. The study compares various retrieval models and style transfer approaches, which aligns with the user's interest in query understanding and ranking models. However, the focus on scientific claims and publications is somewhat niche compared to the user's broader interests in general IR and NLP.
...
### 3. RECAP: Feedback-Driven Streaming Semantic User Profiles for Short-Video Recommendation
...
- **Submitted**: 2026-07-17 08:10:37
- **Comment**: 9 pages, 5 figures, 2 tables. Accepted at RecSys 2026
- **Topic Keywords**: rag, user behavior, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of user behavior modeling and recommendation systems. Although it focuses on short-video recommendation and uses techniques from Natural Language Processing, it explores the use of semantic user profiles and feedback-driven optimization, which aligns with your interests in deep semantic understanding and real-time relevance optimization.
...
- **URL**: <http://arxiv.org/abs/2607.15766v1>
- **Submitted**: 2026-07-17 08:56:43
- **Topic Keywords**: ranking, pairwise, rag, rank
- **Reason**: This paper explores the ability of Large Language Models (LLMs) to construct grounded hypotheses from inconclusive evidence, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on hypothesis discovery and evaluation in scientific and analytical domains is not directly aligned with the user's primary research interests in e-commerce and real-time relevance optimization.
...
### 5. What Do Chinese-Language Generative Search Engines Cite and Surface? A Large-Scale Empirical Study

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Tao Zhen, Yue Liu, Gege Zhang, Yixuan Niu
- **URL**: <http://arxiv.org/abs/2607.15771v1>
- **Submitted**: 2026-07-17 09:03:12
...
- **Reason**: This paper explores the behavior of Chinese-language generative search engines, which is somewhat related to information retrieval and search technologies. However, the focus on citation behavior and source attribution is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. The paper's relevance is limited to the broader context of search technologies, but it does not address the user's specific interests in deep semantic understanding and real-time relevance optimization.
...
### 6. PCTD: Preference-Guided Counterfactual Task Decomposition for Agent Tool Retrieval
...
- **Submitted**: 2026-07-17 07:15:41
- **Topic Keywords**: ranking, rag, retrieval, rank
- **Reason**: The paper explores task decomposition for tool retrieval, which is somewhat related to information retrieval and search technologies. However, the focus on agent tool retrieval and preference-guided counterfactual task decomposition is not directly aligned with the user's core research themes, particularly query understanding, ranking models, and user behavior modeling.
...
### 7. SkillCorpus: Consolidating and Evaluating the Open Skill Ecosystem for Real-World LLM Agents

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Yanze Wang, Pengfei Yao, Tianyi Sun, Chuanrui Hu, Yan Xiao, Yunyun Han, Jun Sun, Yafeng Deng
- **URL**: <http://arxiv.org/abs/2607.15557v1>
- **Submitted**: 2026-07-17 01:55:17
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper discusses a framework for consolidating and evaluating the open skill ecosystem for LLM agents, which is somewhat related to information retrieval and search technologies. However, the focus on LLM agents and procedural knowledge is not a central match for the user's core research themes, which are more focused on query understanding, ranking models, and user behavior modeling.
...
### 8. BayesPO: Bayesian Prompt Optimization via Parallel-Tempered Gradient-Guided Discrete MCMC

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Junjie Zhou, Zhijian Ou
- **URL**: <http://arxiv.org/abs/2607.16001v1>
- **Submitted**: 2026-07-17 14:39:05
- **Topic Keywords**: rag, search
- **Reason**: This paper explores Bayesian prompt optimization for large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on prompt optimization and language models is not directly aligned with the user's core research themes, and the paper's emphasis on NLP and language model optimization is more tangential to the user's interests.
...
- **Submitted**: 2026-07-17 03:25:43
- **Comment**: Technique Report
- **Topic Keywords**: ctr, recommend
- **Reason**: The paper discusses a recommender system, RecGPT-V3, which uses natural language understanding and knowledge graph reasoning to improve user experience and commercial outcomes. While it touches on aspects of user behavior modeling and deep semantic understanding, its primary focus is on recommender systems, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the paper's emphasis on recommender systems and its application in the e-commerce domain, specifically Taobao, limits its relevance to the user's broader interests.
...
### 10. Candidate Attended Dialogue State Tracking Using BERT

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Junyuan Zheng, Onkar Salvi, John Chan
- **URL**: <http://arxiv.org/abs/2607.16021v1>
- **Submitted**: 2026-07-17 14:56:55
- **Comment**: 7 pages, 4 figures. Presented at the DSTC8 workshop, AAAI-20 (poster session)
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and dialogue systems, but it does not directly focus on Information Retrieval (IR) or search technologies. The use of BERT for dialogue state tracking is an interesting application, but it does not align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 11. CoWeaver: A Bi-directional, Learnable and Explainable Matching Engine for Mixed Human-Agent Science Collaboration
...
- **Submitted**: 2026-07-17 01:35:12
- **Topic Keywords**: information retrieval, ranking, retrieval, rank
- **Reason**: The paper focuses on a collaboration matching engine for human-agent science collaboration, which is not directly related to information retrieval, search technologies, or natural language processing. Although it mentions information retrieval as one of the tasks the LLM-based agents excel at, the context is not relevant to the user's core research themes.
...
### 12. VarRate: Training-Free Variable-Rate KV Cache Compression for Long-Context LLMs

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Shahrzad Esmat, Dhawal Shah, Ali Jannesari
- **URL**: <http://arxiv.org/abs/2607.15498v1>
- **Submitted**: 2026-07-16 23:03:14
...
- **Reason**: This paper focuses on optimizing the key-value cache for long-context large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some technical aspects that might be tangentially relevant, the paper's primary contribution is in the area of model compression, which is not a central theme in your research.
...
### 13. From Skill Extraction to Multistakeholder Recommendation: A Two-Stage Framework for Bias Governance in Skills-Based Job Matching

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Andrea Forster, Gregor Autischer, Dominik Kowald, Simone Kopeinik
- **URL**: <http://arxiv.org/abs/2607.15707v1>
- **Submitted**: 2026-07-17 07:37:17
- **Comment**: Accepted to BIAS Conference 2026 in Leiden, The Netherlands
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper focuses on bias governance in skills-based job matching, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves recommender systems, the context is more aligned with fairness and bias in AI applications rather than deep semantic understanding and real-time relevance optimization.
...
### 14. Contextual Semantic Relevance Tracks fMRI BOLD Responses During Naturalistic Speech Comprehension

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Kun Sun, Rong Wang
- **URL**: <http://arxiv.org/abs/2607.15856v1>
- **Submitted**: 2026-07-17 11:12:33
- **Topic Keywords**: relevance
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. It focuses on the neural basis of language comprehension and the relationship between semantic relevance and fMRI BOLD responses, which is outside your primary areas of interest.
...
### 15. An Exam for Active Observers

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jiarui Zhang, Muzi Tao, Shangshang Wang, Ollie Liu, Xuezhe Ma, Willie Neiswanger
- **URL**: <http://arxiv.org/abs/2607.16165v1>
- **Submitted**: 2026-07-17 17:46:23
- **Comment**: 17 pages, 8 figures, 4 tables. Project page: https://activevision.dev
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on the evaluation of multimodal large language models' active observation capabilities, which is outside the scope of Information Retrieval, Search technologies, and Natural Language Processing. The paper's emphasis on vision-language benchmarks and the limitations of current models in active visual observation does not align with your core research themes.
...
### 16. Frontier Language Models Struggle to Copy: Text Can Be Better Viewed in 2D

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Haodong Wen, Yiran Zhang, Yingfa Chen, Kaifeng Lyu
- **URL**: <http://arxiv.org/abs/2607.16072v1>
- **Submitted**: 2026-07-17 15:56:52
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving language models' ability to copy input strings by reorganizing text into a 2D grid. While it touches on Transformer architectures, it doesn't directly relate to query understanding, ranking models, or user behavior modeling in Information Retrieval, which are core areas of your research interests.
...
### 17. How Much Human Label Variation Does Formal Semantic Structure Explain?: Group-Level Effects and Item-Level Ceilings in NLI

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Haram Choi
- **URL**: <http://arxiv.org/abs/2607.15870v1>
- **Submitted**: 2026-07-17 11:34:30
...
- **Reason**: This paper focuses on natural language inference and the role of formal semantic structure in explaining human label variation, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, the specific topic and methodology are not aligned with your areas of focus.
...
### 18. Better Starts, Better Ends: Bootstrapped Iterative Self-Reasoning Distillation for Compressed Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Leichao Dong, Dongxu Zhang, Yiding Sun, Qirui Wang, Yuhan Wang, Lin Chen, Jihua Zhu
- **URL**: <http://arxiv.org/abs/2607.15736v1>
- **Submitted**: 2026-07-17 08:15:35
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving the efficiency of reasoning models through self-distillation, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves optimization and real-time relevance, the context is more aligned with natural language processing and reasoning, rather than search or retrieval.
...
### 19. EpiNarrate: Agentic Generation of Grounded Narratives from Epidemiological Scenario Projections
...
- **URL**: <http://arxiv.org/abs/2607.15544v1>
- **Submitted**: 2026-07-17 01:30:50
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on a specific application of natural language generation in the public health domain, using epidemiological scenario projections. While it involves some aspects of data processing and modeling, it does not seem to be directly related to information retrieval, search technologies, or query understanding, which are core areas of your research interests.
...
### 20. Large Language Models as Unified Multimodal Learners for Clinical Prediction
...
- **URL**: <http://arxiv.org/abs/2607.15380v1>
- **Submitted**: 2026-07-16 18:28:23
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on clinical prediction using large language models, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context and application are quite different from the user's interests.
...
### 21. DECODEM: Data Extraction from Corporate Organizational Documents via Enhanced Methods

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jens Frankenreiter
- **URL**: <http://arxiv.org/abs/2607.15879v1>
- **Submitted**: 2026-07-17 11:48:31
- **Topic Keywords**: search
- **Reason**: This paper focuses on data extraction from corporate documents, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP techniques, the context and application are quite different from your areas of focus.
...
### 22. On the Structure of Address in Multi-Party Dialogue: From Discrete Labels to Continuous Levels

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Taiga Mori, Koji Inoue, Divesh Lala, Tatsuya Kawahara
- **URL**: <http://arxiv.org/abs/2607.15648v1>
- **Submitted**: 2026-07-17 05:45:58
- **Topic Keywords**: search
- **Reason**: This paper focuses on multi-party dialogue and addressee detection, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the paper's primary focus on dialogue systems and turn-taking makes it less relevant to the user's interests.
...
### 23. Efficient and Effective In-place Graph-based Vector Index Updates

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Haotian Liu, Yujun He, Bo Tang
- **URL**: <http://arxiv.org/abs/2607.15576v1>
- **Submitted**: 2026-07-17 02:40:08
- **Topic Keywords**: search
- **Reason**: This paper focuses on efficient vector updates for Large Language Models, which is a specific area of research. While it touches on search result quality, it does not directly relate to query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 24. Looped Latent Attention: Cross-Loop KV Compression for Looped Transformers

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: James O' Neill, Fergal Reid
- **URL**: <http://arxiv.org/abs/2607.15456v1>
- **Submitted**: 2026-07-16 20:58:16
- **Topic Keywords**: rank
- **Reason**: This paper focuses on optimizing the cache usage in Transformers, which is a topic in the broader field of Deep Learning and NLP. However, it does not directly relate to Information Retrieval, query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
