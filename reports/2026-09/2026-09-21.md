...
### 1. Graded-Relevance Composed Multimodal Retrieval for E-commerce Visual Search at Scale
...
- **URL**: <http://arxiv.org/abs/2609.24152v1>
- **Submitted**: 2026-09-21 06:09:52
- **Topic Keywords**: retriever, query, queries, ranking, relevance, rag, ctr, retrieval, commerce, e-commerce, rank, search
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Grad‑CIR‑PG2: Production‑Ready, Graded‑Relevance Composed Image Retrieval for E‑Commerce
- **Aim**: Develop an end‑to‑end composed image retrieval system that replaces binary relevance with a fine‑grained, ordinal relevance model, enabling scalable, high‑quality ranking for e‑commerce visual search.
- **Rationale**: Binary relevance fails to capture partial matches in large product catalogs; late‑fusion CLIP encoders lack cross‑modal alignment and generative VLMs are inefficient as bi‑encoders. A graded relevance framework with a hierarchy‑aware loss can better reflect real‑world ranking needs.
- **Ground**: A VLM‑driven pipeline generates millions of query–candidate pairs: Gemini‑2.5‑pro performs object detection, crops products, creates similarity and modifier queries, and automatically labels relevance (Exact, Near‑Exact, Partial, Irrelevant). Hard negatives are mined during training, and an augmentation matrix diversifies data. The model is a PaliGemma 2 bi‑encoder with early‑fusion, matryoshka embeddings, and a hierarchy‑aware angular loss (AngleLoss). LoRA adapters (rank 64, α = 64) fine‑tune the backbone.
- **Experiment**: Trained for 2 epochs on 4 × H100 GPUs (512 batch, AdamW lr 1e‑5). Baselines (FashionCLIP, SigLIP2, GME‑Qwen, Qwen3‑VL‑Embedding) were evaluated off‑the‑shelf and fine‑tuned with the same data, loss, and LoRA. Ablations show a 4.9–5.9 % NDCG@10 lift when moving from single‑positive to 4‑level supervision. Cross‑model transfer boosts early‑fusion backbones by up to 8.5 % NDCG@10. Evaluation on Walmart’s WVST (similarity and modifier queries), Street2Shop, and FashionIQ demonstrates substantial gains in R@5, NDCG, and recall.
- **Takeaway**: A production‑ready CIR system that combines VLM‑generated data, graded relevance supervision, and a hierarchy‑aware angular loss achieves state‑of‑the‑art ranking quality, generalizes across multimodal backbones, and is deployable at scale for e‑commerce visual search.
...
### 2. Q-TIE: A Lightweight and Generalizable Re-ranking Framework for Temporal Information Retrieval

- **LLM Score**: 0
- **Keyword Score**: 20
- **Authors**: Soyeon Kim, Hyunjin Kim, JinYeong Bak, Steven Euijong Whang
- **URL**: <http://arxiv.org/abs/2609.23880v1>
- **Submitted**: 2026-09-20 21:30:31
- **Comment**: Accepted to EMNLP 2026 (Main Conference). Code: https://github.com/ssoy0701/Q-TIE
- **Topic Keywords**: information retrieval, retriever, query, ranking, relevance, rag, retrieval, rank
- **Reason**: LLM scoring failed.
...
### 3. Beyond Relevance: Structured Semantic Supervision for Product Search with LLM-Augmented Annotations

- **LLM Score**: 0
- **Keyword Score**: 19
- **Authors**: Girish A. Koushik, Swapnil Bhosale, Samarth Agrawal, Hadeel Sadany, Constantin Orasan, Xiatian Zhu, Diptesh Kanojia
- **URL**: <http://arxiv.org/abs/2609.23646v1>
- **Submitted**: 2026-09-20 13:49:02
- **Comment**: 16 pages, 2 figures
- **Topic Keywords**: retriever, query, queries, relevance, shopping, commerce, e-commerce, rank, search, acl
- **Reason**: LLM scoring failed.
...
### 4. Per-Query Gating of LLM Rerankers for Multi-Hop Retrieval

- **LLM Score**: 0
- **Keyword Score**: 16
- **Authors**: Andre Bacellar
- **URL**: <http://arxiv.org/abs/2609.22880v1>
- **Submitted**: 2026-09-19 08:35:24
...
- **Topic Keywords**: query, queries, rerank, rag, retrieval, rank, acl
- **Reason**: LLM scoring failed.
...
### 5. Efficient LLM Distillation for Bangladesh Legal Context: A Smartphone-Compatible Retrieval-Augmented Generation Model
...
- **URL**: <http://arxiv.org/abs/2609.24177v1>
- **Submitted**: 2026-09-21 06:48:27
- **Comment**: 10 pages, 6 figures, 8 tables
- **Topic Keywords**: semantic search, query, queries, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
### 6. Semantic Candidate-Job Matching: A Comparative Evaluation of Dense Embedding Models in Hybrid Retrieval

- **LLM Score**: 0
- **Keyword Score**: 13
- **Authors**: Sai Yashwant, Siddhartha Jain, Anurag Dubey, Samaroha Chatterjee, Gantala Thulsiram
- **URL**: <http://arxiv.org/abs/2609.23307v1>
- **Submitted**: 2026-09-20 02:50:12
- **Topic Keywords**: information retrieval, ranking, relevance, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
### 7. MuSeR: Scalable Long-sequence Recommendation with Multi-interest Modeling
...
- **URL**: <http://arxiv.org/abs/2609.23677v1>
- **Submitted**: 2026-09-20 14:36:07
- **Topic Keywords**: query, ltr, user behavior, retrieval, recommend, search
- **Reason**: LLM scoring failed.
...
### 8. ChemCLIR-Bench: Benchmarking Cross-Lingual Information Retrieval in Multilingual Chemical Patents
...
- **URL**: <http://arxiv.org/abs/2609.23231v1>
- **Submitted**: 2026-09-19 22:18:58
- **Comment**: Accepted to the EMNLP 2026 Industry Track. 22 pages including references and appendices; 7 pages of main text
- **Topic Keywords**: information retrieval, query, queries, retrieval, rank
- **Reason**: LLM scoring failed.
...
### 9. Parameterized Dense-Sparse Fusion for Hybrid Retrieval: Tuning a Rank-Score Mix on BEIR SciFact with Qdrant

- **LLM Score**: 0
- **Keyword Score**: 12
- **Authors**: Satyanarayan Pati, Srikanth Patil
- **URL**: <http://arxiv.org/abs/2609.22770v1>
- **Submitted**: 2026-09-19 05:05:14
...
### 10. Semantics Delivery Network: Rethinking Web Retrieval Infrastructure for LLM Agents

- **LLM Score**: 0
- **Keyword Score**: 12
- **Authors**: Peichun Hua, Yunming Xiao
- **URL**: <http://arxiv.org/abs/2609.22486v1>
- **Submitted**: 2026-09-18 18:49:38
- **Comment**: 12 pages, 3 figures
- **Topic Keywords**: query, relevance, rag, retrieval, rank, search
- **Reason**: LLM scoring failed.
...
### 11. UK-PRBENCH: A Paragraph-Level Precedent Retrieval Benchmark for United Kingdom Case Law

- **LLM Score**: 0
- **Keyword Score**: 10
- **Authors**: Damith Premasiri, Tharindu Ranasinghe
- **URL**: <http://arxiv.org/abs/2609.24613v1>
- **Submitted**: 2026-09-21 14:01:53
...
### 12. Analyzing Public Discourse on Urbanism: Topic Clustering, Sentiment Analysis and Retrieval-Augmented Generation using YouTube Comments

- **LLM Score**: 0
- **Keyword Score**: 10
- **Authors**: Jakob Morales, Monica Hegde, Fayeq Jeelani Syed
- **URL**: <http://arxiv.org/abs/2609.22705v1>
- **Submitted**: 2026-09-19 02:34:56
...
- **URL**: <http://arxiv.org/abs/2609.24122v1>
- **Submitted**: 2026-09-21 05:19:40
...
### 14. Machine-Interpretable Information: Compiling Documents into Searchable and Readable Protocol States

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Yifan Wang, Dejing Dou
- **URL**: <http://arxiv.org/abs/2609.23371v1>
- **Submitted**: 2026-09-20 05:43:16
...
### 15. AlexandriaX 2026: The First Shared Task on Dialectal Arabic Machine Translation
...
- **URL**: <http://arxiv.org/abs/2609.22796v1>
- **Submitted**: 2026-09-19 05:59:30
...
### 16. Propose, Verify, Commit: Evidence-Grounded Memory for Long-Horizon Multi-Actor Conversations

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Zihao Lu, Zhihang Yuan, Lei Shi
- **URL**: <http://arxiv.org/abs/2609.23465v1>
- **Submitted**: 2026-09-20 08:51:07
- **Topic Keywords**: query, relevance, rank, search
- **Reason**: LLM scoring failed.
...
### 17. MuLA-Bench: A Multilingual Long-Form Audio Understanding Benchmark via Multi-Tier Auditing

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Zeyu Yang, Xinyu Zhang, Zibo Bi, Pei Zhang, Xize Cheng, Jin Xu, Baosong Yang, Satoshi Nakamura
- **URL**: <http://arxiv.org/abs/2609.23416v1>
- **Submitted**: 2026-09-20 07:11:31
...
### 18. From Ranked Documents to Reliable Contexts: An Answer-Oriented Context Construct Framework for AI Search
...
- **URL**: <http://arxiv.org/abs/2609.23354v1>
- **Submitted**: 2026-09-20 04:41:42
- **Topic Keywords**: ranking, retrieval, web search, rank, search
- **Reason**: LLM scoring failed.
...
### 19. NLPCC 2026 Task 10: Citation-Level Faithfulness Verification with DeBERTa Ensembles and Class-Wise Calibration

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Yanling Li, Zirui Li, Mingyu Wan
- **URL**: <http://arxiv.org/abs/2609.22774v1>
- **Submitted**: 2026-09-19 05:18:19
...
### 20. Scoring With the Engine: Retrieval Exposure, Cross-Engine Divergence, and the Limits of Engine-Agnostic GEO Scores

- **LLM Score**: 0
- **Keyword Score**: 8
- **Authors**: Benjamin Tannenbaum
- **URL**: <http://arxiv.org/abs/2609.22655v1>
- **Submitted**: 2026-09-19 00:05:25
...
### 21. Auditing Source Exposure in Baidu and Google AI Search

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Yibo Li, Enci Guan, Yuedan Cai, Geng Liu, Francesco Pierri
- **URL**: <http://arxiv.org/abs/2609.24407v1>
- **Submitted**: 2026-09-21 10:57:24
...
### 22. URA-NER: A Unified Retrieval-Augmented Framework with Retrieval Alignment and Uncertainty Reduction for Low-Resource NER

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Jingyu Wang, Shijie Wu, Fusheng Jin
- **URL**: <http://arxiv.org/abs/2609.24372v1>
- **Submitted**: 2026-09-21 10:04:43
...
### 23. When Residualization Helps an Audit: Format Effects, Slice Gains, and Their Limits

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Daein Weon, Dongho Kang
- **URL**: <http://arxiv.org/abs/2609.24194v1>
- **Submitted**: 2026-09-21 07:06:37
...
### 24. FLARE: A Full-Lifecycle Dense Supervision Paradigm for Long-Horizon Coding Agents via Generative Reward Model
...
### 25. UNIQUE: A Unified Retrieval and Ranking System for Large-Scale Feed Recommendation

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Zhuang Liu, Yongkang Fu, Zuodong Yang, Guangxing Chen, Zonggang Wu, Yuqi Lu, Shouke Qin, Shantao Li, Maolin Wang
- **URL**: <http://arxiv.org/abs/2609.23718v1>
- **Submitted**: 2026-09-20 15:54:06
...
### 26. From Prompt to Recommendation: A Fitted Stage Model of Brand Visibility in AI Search

- **LLM Score**: 0
- **Keyword Score**: 7
- **Authors**: Benjamin Tannenbaum
- **URL**: <http://arxiv.org/abs/2609.23162v1>
- **Submitted**: 2026-09-19 18:20:08
...
### 27. When More Evidence Hurts: Publication-Bias Drift and Principled Stopping for Biomedical Causal Search

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Fred Sun, Shangqi Guo
- **URL**: <http://arxiv.org/abs/2609.24101v1>
- **Submitted**: 2026-09-21 04:37:40
...
### 28. RPMem: Learning Long-Term Recurrent Parametric Memory Across Sessions for LLM Agents
...
### 29. Bridging Static and Agentic RAG for Taiwanese Historical Question Answering

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Kai-Hsin Chen, Wei-Yu Chen, Xuanjun Chen, Jyh-Shing Roger Jang
- **URL**: <http://arxiv.org/abs/2609.23056v1>
- **Submitted**: 2026-09-19 14:43:26
...
### 30. Beyond Similarity: Coverage-Aware Prompt Selection for Time Series Forecasting with LLMs

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Daeun Ji, Minkyoung Kim, Dongkuk Kim, Yohan Lee, Beomsoo Kim, Beakcheol Jang
- **URL**: <http://arxiv.org/abs/2609.22977v1>
- **Submitted**: 2026-09-19 12:10:41
...
### 31. An Iterative LangGraph Agent for Text-to-SQL: Natural Language Access to the Chicago Crime Database

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Vigneshwar Ravi Rao, Rupesh Swarnakar, Fayeq Jeelani Syed†
- **URL**: <http://arxiv.org/abs/2609.22917v1>
- **Submitted**: 2026-09-19 09:54:16
...
### 32. Assessing Readability with LLMs: The Role of Reasoning and Few-Shot Prompting

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Raphaël Thieffry, Matej Martinc
- **URL**: <http://arxiv.org/abs/2609.24650v1>
- **Submitted**: 2026-09-21 14:22:39
...
### 33. Written as a Record, Read as an Address: What a Forward Pass Leaves in an Operation's KV Cache

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Lingfeng Wu, Behzad Shomali
- **URL**: <http://arxiv.org/abs/2609.24635v1>
- **Submitted**: 2026-09-21 14:16:19
...
### 34. A Redundancy Reduction Approach for Controllable Sequential Recommendations

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Veronika Ivanova, Marina Munkhoeva, Ivan Razvorotnev, Evgeny Frolov
- **URL**: <http://arxiv.org/abs/2609.23849v1>
- **Submitted**: 2026-09-20 20:05:14
...
### 35. Rethinking Pivot Programming Languages in Code Language Models

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Andor Diera, Lukas Galke Poech, Matthias Tichy
- **URL**: <http://arxiv.org/abs/2609.22988v1>
- **Submitted**: 2026-09-19 12:45:00
...
### 36. Automatic multimodal UX improvement recommendations from LLM agent user simulations

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Anu Chowdhury, Bin Wu, Hossein A. Rahmani, Emine Yilmaz
- **URL**: <http://arxiv.org/abs/2609.22971v1>
- **Submitted**: 2026-09-19 11:50:11
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: LLM scoring failed.
...
### 37. Pretrained Persona Mixture Models and Tandem Models for Human Simulation

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Minwoo Kang, Téa Wright, Seun Eisape, Ayush Raj, Suhong Moon, Joseph Suh, Alane Suhr, David M. Chan, John Canny
- **URL**: <http://arxiv.org/abs/2609.22607v1>
- **Submitted**: 2026-09-18 21:50:35
...
### 38. AdaMerge: Tuning-Free Patch Compression for Multi-Vector Visual Document Retrieval

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Jianxin You, Kun Ni
- **URL**: <http://arxiv.org/abs/2609.22562v1>
- **Submitted**: 2026-09-18 20:29:33
...
### 39. The Copy Ceiling: An Input-Exposure Control for Ontology-Grounded Generation over Curated Corpora

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: John J. O'Hare
- **URL**: <http://arxiv.org/abs/2609.24885v1>
- **Submitted**: 2026-09-21 16:53:00
...
- **URL**: <http://arxiv.org/abs/2609.24246v1>
- **Submitted**: 2026-09-21 08:11:43
...
### 41. Vimarsha: Faithful ASR Evaluation for Indian Languages with Demographic Diversity, In-the-Wild Audio and Spelling Variations

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Kaushal Santosh Bhogale, Srija Anand, Sadakopa Ramakrishnan Thothathiri, Tahir Javed, Sshubam Verma, Mitesh M. Khapra
- **URL**: <http://arxiv.org/abs/2609.24199v1>
- **Submitted**: 2026-09-21 07:14:46
...
### 42. UniK: Universal Knowledge Perception for Digital and Physical AI

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Nirmit Desai, Kunal Sawarkar, Aditya Mahakali, Dongkon Lee, Kevin Park, Eric Song
- **URL**: <http://arxiv.org/abs/2609.23971v1>
- **Submitted**: 2026-09-21 00:56:36
- **Comment**: 17 pages
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 43. Global Ranks Survive, Selected Heads Shift: BOS-Sink Topology under 4-bit Weight-Only Quantization

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Kuanlin Chen, Chen-Wei Kuo, Cheng-En Ou
- **URL**: <http://arxiv.org/abs/2609.23585v1>
- **Submitted**: 2026-09-20 12:07:41
...
### 44. Perplexity Predicts Protection: Choosing Pretrained Backbones for Worst-Client Fairness in Federated Parameter-Efficient Fine-Tuning

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Kiran Naseer, Samreen Azhar, Umar Shoaib, Haroon Mahmood, Muhammad Awais
- **URL**: <http://arxiv.org/abs/2609.23463v1>
- **Submitted**: 2026-09-20 08:46:03
...
### 45. PSD: Pseudo Self-Distillation of Memory Representation Capabilities for LLM Agents

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Pirzada Suhail, Menglin Xia, Xuchao Zhang, Mayukh Das, Chetan Bansal, Saravan Rajmohan
- **URL**: <http://arxiv.org/abs/2609.23449v1>
- **Submitted**: 2026-09-20 08:24:52
...
### 46. Low resource cross-modal alignment using HGNN to enhance speech representation

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Yannick Yomie Nzeuhang, Marie Tahon, Paulin Melatagia Yonta
- **URL**: <http://arxiv.org/abs/2609.23191v1>
- **Submitted**: 2026-09-19 19:31:01
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 47. Chronologic: Measuring Language Models' Ability to Represent the Past

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Ted Underwood, Ziliang Qiu, Sarah Griebel, Laura K. Nelson, Edwin Roland, Wenyi Shang, Matthew Wilkens
- **URL**: <http://arxiv.org/abs/2609.23178v1>
- **Submitted**: 2026-09-19 19:06:17
...
### 49. R-GEAN: Regimen-Guided Edit Action Network for Within-Admission Medication Change Prediction

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Regan Mahat, Mansu Kim
- **URL**: <http://arxiv.org/abs/2609.22959v1>
- **Submitted**: 2026-09-19 11:23:11
- **Topic Keywords**: ranking, rank
- **Reason**: LLM scoring failed.
...
### 50. AgentRouter: Heterogeneous Model Routing for Cost-Optimal Multi-Step Agentic Workflows

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Rudrendu Kumar Paul, Sourav Nandy
- **URL**: <http://arxiv.org/abs/2609.22951v1>
- **Submitted**: 2026-09-19 11:06:57
