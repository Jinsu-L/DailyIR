# Daily Papers Report - 2025-12-16

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. Reveal Hidden Pitfalls and Navigate Next Generation of Vector Similarity Search from Task-Centric Views
...
- **Comment**: SIGMOD2026
- **Topic Keywords**: information retrieval, ranking, relevance, retrieval, recommend, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of vector similarity search and its applications in semantic information retrieval and recommendation engines. The focus on task-centric evaluation and the identification of pitfalls in current benchmarks aligns with your interests in query understanding and real-time relevance optimization.
...
### 2. Learning to Retrieve with Weakened Labels: Robust Training under Label Noise
...
- **Reason**: This paper is highly relevant to Information Retrieval, specifically addressing challenges in training retrieval models under label noise. The use of neural encoders and dense retrieval tasks aligns with your interests in query understanding and ranking models. However, the focus on NLP and dense retrieval tasks is somewhat narrower than your broader interests in IR and search technologies.
...
### 3. Progressive Refinement of E-commerce Search Ranking Based on Short-Term Activities of the Buyer
...
- **Topic Keywords**: ranking, shopping, commerce, e-commerce, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of e-commerce search ranking and user behavior modeling. The focus on adapting search results to a buyer's immediate needs and preferences aligns with your interests in query understanding and ranking models. The use of contextual techniques and sequence models also resonates with your background in NLP and data mining.
...
### 4. An Open and Reproducible Deep Research Agent for Long-Form Question Answering
...
- **Topic Keywords**: rag, retrieval, web search, search, neurips
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of long-form question answering and real-time relevance optimization. The use of large language models and web search APIs aligns with your focus on query understanding and ranking models. However, the primary focus on question answering and NLP aspects slightly deviates from your core interest in search technologies and user behavior modeling.
...
### 5. Towards Effective Model Editing for LLM Personalization
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in query understanding and ranking models. Although it focuses on Large Language Models (LLMs) and personalization, it touches on topics like user behavior modeling and preference-aligned updates, which are relevant to your work. However, the paper's primary focus on NLP and model editing might not be a central match for your interests.
...
### 6. A Simple and Effective Framework for Symmetric Consistent Indexing in Large-Scale Dense Retrieval
...
- **Topic Keywords**: information retrieval, dense retrieval, queries, retrieval, recommend, commerce, e-commerce, search
- **Reason**: The paper focuses on dense retrieval and proposes a framework to address challenges in dual-tower encoding architecture, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on dense retrieval and large-scale deployment does not directly align with the user's core research themes of query understanding and user behavior modeling.
...
### 7. Uncovering the Role of Initial Saliency in U-Shaped Attention Bias: Scaling Initial Token Weight for Enhanced Long-Text Processing
...
- **Reason**: This paper is somewhat related to the user's research interests in Natural Language Processing (NLP) and deep semantic understanding. However, it focuses on a specific issue in large language models (LLMs) and proposes a solution to improve their performance on long-text sequences, which is not directly aligned with the user's core research themes in Information Retrieval and Search technologies.
...
### 8. Counting Clues: A Lightweight Probabilistic Baseline Can Match an LLM
...
- **Topic Keywords**: rank
- **Reason**: This paper explores probabilistic reasoning in large language models, specifically in a medical diagnosis context. While it touches on ranking models and user behavior modeling indirectly, its focus on probabilistic reasoning and explicit baselines is somewhat related to query understanding and ranking models, but not a central match for your research interests.
...
### 9. Unified Interactive Multimodal Moment Retrieval via Cascaded Embedding-Reranking and Temporal-Aware Score Fusion
...
- **Topic Keywords**: query, queries, ranking, rerank, retrieval, rank, search
- **Reason**: The paper focuses on multimodal moment retrieval in video content, which is somewhat related to information retrieval and search technologies. However, the specific application and techniques used (e.g., BEIT-3, SigLIP, BLIP-2, GPT-4o) are not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 10. No One Left Behind: How to Exploit the Incomplete and Skewed Multi-Label Data for Conversion Rate Prediction
...
- **Topic Keywords**: ranking, click, cvr, conversion rate, rank
- **Reason**: This paper focuses on conversion rate prediction using multi-task learning and proposes a framework to handle incomplete and skewed multi-label data. While it touches on aspects of data modeling and ranking, its primary focus is on a specific application (conversion rate prediction) and does not directly align with the user's core research themes in information retrieval and search technologies.
...
- **Topic Keywords**: queries, click, click-through rate, recommend, search
- **Reason**: This paper explores author labeling for text annotation, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on annotation quality and author involvement is more aligned with NLP and data mining, but not directly related to ranking models or real-time relevance optimization.
...
### 12. Automated Information Flow Selection for Multi-scenario Multi-task Recommendation
...
- **Topic Keywords**: click, click-through rate, conversion rate, recommend, rank
- **Reason**: The paper focuses on multi-scenario multi-task recommendation systems, which is somewhat related to information retrieval and search technologies. However, the primary focus is on recommender systems, and the paper's emphasis on information flow selection and pruning does not directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 13. Are Large Language Models Really Effective for Training-Free Cold-Start Recommendation?
...
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and recommender systems, but it focuses more on the application of large language models in training-free cold-start recommendation, which is a specific area that is not the user's primary focus. The paper also explores Natural Language Processing aspects, but the context is different from the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 14. SPAR: Session-based Pipeline for Adaptive Retrieval on Legacy File Systems
...
- **Reason**: The paper explores a novel approach to retrieval on legacy file systems using Large Language Models and Retrieval-Augmented Generation architecture. While it touches on information retrieval, the focus is more on the technical implementation and computational efficiency rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to information retrieval is somewhat relevant, but not central to the user's research themes.
...
### 15. Does Tone Change the Answer? Evaluating Prompt Politeness Effects on Modern LLMs: GPT, Gemini, LLaMA
...
- **Reason**: This paper explores the impact of linguistic tone and politeness on large language models, which is related to query understanding and user behavior modeling in Information Retrieval. However, the focus on prompt engineering and model performance in Natural Language Processing limits its direct relevance to your core research themes.
...
### 16. MAC: A Multi-Agent Framework for Interactive User Clarification in Multi-turn Conversations
...
- **Reason**: The paper focuses on conversational agents and multi-agent architectures, which is somewhat related to information retrieval and search technologies. However, the primary focus on user clarification in multi-turn conversations and ambiguity resolution in conversational scenarios is not directly aligned with the user's core research themes in IR and search technologies. While it touches on user behavior modeling, the context is different from the user's background in e-commerce and focus on deep semantic understanding and real-time relevance optimization.
...
### 17. Understanding Structured Financial Data with LLMs: A Case Study on Fraud Detection
...
- **Reason**: This paper explores the application of Large Language Models (LLMs) in fraud detection, which is somewhat related to information retrieval and NLP. However, the focus is on tabular data and fraud detection, which is not a central match to your research interests in query understanding, ranking models, and user behavior modeling. The paper does involve retrieval-augmented in-context learning, but it's not a primary focus of the study.
...
### 18. Hindsight is 20/20: Building Agent Memory that Retains, Recalls, and Reflects
...
- **Topic Keywords**: query, personalization
- **Reason**: This paper presents a memory architecture for agent-based applications, focusing on organizing and reasoning over conversational streams. While it touches on aspects of query understanding and ranking models, its primary focus is on memory management and reasoning, which is somewhat related to information retrieval but not a central match for your research interests.
...
### 19. Know Your Users! Estimating User Domain Knowledge in Conversational Recommenders
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of conversational recommenders and user behavior modeling. However, the focus on estimating user domain knowledge and conversational strategies is not directly aligned with your primary research themes of query understanding, ranking models, and real-time relevance optimization.
...
### 20. Towards Practical Large-scale Dynamical Heterogeneous Graph Embedding: Cold-start Resilient Recommendation
...
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and recommender systems, but it focuses more on graph embeddings and recommendation rather than query understanding, ranking models, or user behavior modeling. The use of graph transformers and incremental updates is an interesting aspect, but it doesn't directly align with the user's core research themes.
...
### 21. Do Reviews Matter for Recommendations in the Era of Large Language Models?
...
- **Topic Keywords**: rag, recommend
- **Reason**: The paper explores the role of user reviews in recommender systems, particularly in the context of large language models. While it touches on related topics, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on recommender systems and review-aware recommendation engines makes it somewhat relevant but not a central match for your research interests.
...
### 22. ERA-IT: Aligning Semantic Models with Revealed Economic Preference for Real-Time and Explainable Patent Valuation
...
- **Topic Keywords**: rag
- **Reason**: The paper explores the application of Large Language Models (LLMs) in patent valuation, which is somewhat related to your interests in Information Retrieval and Natural Language Processing. However, the focus on patent valuation and economic reasoning is not a central match to your primary research themes, and the paper's emphasis on explainability and transparency in AI decision-making is not a primary area of interest for you.
...
### 23. SkipCat: Rank-Maximized Low-Rank Compression of Large Language Models via Shared Projection and Block Skipping
...
- **Topic Keywords**: rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of large language models and low-rank compression. However, it focuses more on model compression and deployment on edge devices, which is not a central match to your primary research focus on query understanding, ranking models, and user behavior modeling.
...
### 24. Memory in the Age of AI Agents
...
- **Reason**: This paper focuses on memory in AI agents, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on related concepts like LLM memory and retrieval augmented generation, the primary focus is on memory systems rather than query understanding, ranking models, or user behavior modeling.
...
### 25. AutoTool: Dynamic Tool Selection and Integration for Agentic Reasoning
...
- **Reason**: This paper focuses on agentic reasoning and tool selection for large language models, which is somewhat related to information retrieval and search technologies. However, the primary focus on tool selection and integration for LLMs does not directly align with the user's core research themes in IR and search technologies, particularly query understanding and ranking models.
...
### 26. QwenLong-L1.5: Post-Training Recipe for Long-Context Reasoning and Memory Management
...
- **Reason**: This paper focuses on long-context reasoning and memory management, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve NLP, the specific application and techniques described are not aligned with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 27. Fine-tuned LLM-based Code Migration Framework
...
- **Reason**: This paper appears to be focused on code migration and database transformations using a fine-tuned Large Language Model, which is outside the user's primary research interests in Information Retrieval and Search technologies. While it involves some NLP aspects, the context and application are not directly related to the user's core themes.
...
### 28. Comparative Analysis of LLM Abliteration Methods: A Cross-Architecture Evaluation
...
- **Reason**: This paper is not directly related to the user's research interests in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. The focus on large language models, safety alignment mechanisms, and abliteration techniques is more aligned with NLP and related topics, but the specific context and methods used do not seem to overlap with the user's core research themes.
...
### 29. Advancing Bangla Machine Translation Through Informal Datasets
...
- **Reason**: This paper focuses on Bangla machine translation, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and scope are quite different from the user's core areas of focus.
...
### 30. On the Effectiveness of Membership Inference in Targeted Data Extraction from Large Language Models
...
- **Reason**: This paper focuses on the privacy risks of Large Language Models, specifically data extraction and membership inference attacks. While it touches on the concept of querying models, it does not directly relate to query understanding, ranking models, or user behavior modeling in the context of information retrieval. The paper's emphasis on NLP and data extraction is somewhat tangential to the user's core research interests.
...
### 31. AIR: Post-training Data Selection for Reasoning via Attention Head Influence
...
- **Comment**: 19 pages
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on post-training data selection for reasoning in Large Language Models (LLMs), using attention head influence. While it involves retrieval and ranking, it's more related to NLP and model optimization, and doesn't directly align with your core research interests in IR, query understanding, and user behavior modeling.
...
- **Reason**: This paper focuses on benchmarking finance and accounting tasks, which is somewhat related to your e-commerce background, but it does not align with your core research themes in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. The paper's emphasis on AI agents and multimodal artifacts is also not directly relevant to your interests in Natural Language Processing, data mining, or recommender systems.
...
### 33. SignRAG: A Retrieval-Augmented System for Scalable Zero-Shot Road Sign Recognition
...
- **Topic Keywords**: rag, retrieval
- **Reason**: While the paper explores a Retrieval-Augmented Generation (RAG) paradigm, it is primarily focused on road sign recognition, which is outside the user's core research themes in Information Retrieval and Search technologies. Although it involves a Vision Language Model and Large Language Model, the application is specific to computer vision and not directly related to query understanding, ranking models, or user behavior modeling.
...
### 34. BLADE: A Behavior-Level Data Augmentation Framework with Dual Fusion Modeling for Multi-Behavior Sequential Recommendation
...
- **Reason**: This paper focuses on recommender systems, specifically multi-behavior sequential recommendation, which is somewhat related to your interests in information retrieval and search technologies. However, the paper's primary focus on recommender systems and sequential recommendation is not a central match to your core research themes, which include query understanding, ranking models, and user behavior modeling in the context of search technologies.
...
### 35. What Matters in Evaluating Book-Length Stories? A Systematic Study of Long Story Evaluation
...
- **Reason**: This paper focuses on evaluating book-length stories, which is a specific application in Natural Language Processing (NLP). While it involves some aspects of user behavior modeling, it is not directly related to information retrieval, search technologies, or query understanding, which are the core areas of your research interests.
...
### 36. Large-Language Memorization During the Classification of United States Supreme Court Cases
...
- **Reason**: This paper focuses on large-language models and their memorization strategies, which is somewhat related to query understanding and ranking models in Information Retrieval. However, it does not directly address user behavior modeling, click models, or real-time relevance optimization, making it only loosely relevant to your core research interests.
...
### 37. ReFusion: A Diffusion Large Language Model with Parallel Autoregressive Decoding
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on a novel masked diffusion model for parallel decoding, which is not directly related to information retrieval, query understanding, ranking models, or user behavior modeling. While it involves deep learning and NLP, its primary contribution is in improving the efficiency of language models, which is not a central match to your research interests.
...
### 38. TARA: Simple and Efficient Time Aware Retrieval Adaptation of MLLMs for Video Understanding
...
- **Topic Keywords**: retrieval
- **Reason**: While the paper explores video-text embedding models, it does not appear to be directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. Although it mentions retrieval, the focus is on video understanding and multimodal LLMs, which is not a primary area of interest for the user.
...
### 39. Scaling Laws for Code: Every Programming Language Matters
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on scaling laws for code large language models, exploring the impact of different programming languages on model performance. While it touches on multilingual pre-training, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 40. MiniLingua: A Small Open-Source LLM for European Languages
...
- **Topic Keywords**: rag
- **Reason**: This paper is about a multilingual language model, which is related to Natural Language Processing (NLP), but it does not directly address query understanding, ranking models, or user behavior modeling in the context of Information Retrieval (IR). The focus on instruction-following capabilities and on-device use is also not directly relevant to the user's core research themes.
...
### 41. M-GRPO: Stabilizing Self-Supervised Reinforcement Learning for Large Language Models with Momentum-Anchored Policy Optimization
...
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on stabilizing self-supervised reinforcement learning for Large Language Models, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on topics like policy optimization, the context and application are quite different from the user's areas of focus.
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models (LLMs), the focus is on negotiation capabilities, which is a topic outside your primary areas of interest.
...
### 43. Scaling Bidirectional Spans and Span Violations in Attention Mechanism
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on optimizing the Transformer architecture for sequence modeling, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on attention mechanisms, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to your research.
...
- **Reason**: This paper focuses on sequential recommender systems, which is somewhat related to information retrieval, but it primarily deals with recommender systems and does not address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 45. Meta-GPT: Decoding the Metasurface Genome with Generative Artificial Intelligence
...
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on developing a generative AI model for photonics, using a symbolic language to represent nanostructures. It does not relate to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing.
