# Daily Papers Report - 2025-12-09

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. MUSE: A Simple Yet Effective Multimodal Search-Based Framework for Lifelong User Interest Modeling
...
- **Topic Keywords**: ltr, rag, user behavior, retrieval, recommend, search
- **Reason**: This paper presents a framework for lifelong user interest modeling, leveraging multimodal signals in a two-stage approach. While primarily focused on recommender systems, it explores query understanding and ranking models, aligning with your interests in Information Retrieval. However, the emphasis on recommender systems and industrial deployment practices limits its direct relevance to your core research themes.
...
### 2. FVA-RAG: Falsification-Verification Alignment for Mitigating Sycophantic Hallucinations
...
- **Reason**: This paper introduces a framework for mitigating sycophantic hallucinations in Retrieval-Augmented Generation systems, which is related to query understanding and ranking models in Information Retrieval. However, the focus on factual generation and 'Red Team' inference-time evaluation is somewhat tangential to your core research themes of real-time relevance optimization and deep semantic understanding.
...
### 3. SPAD: Seven-Source Token Probability Attribution with Syntactic Aggregation for Detecting Hallucinations in RAG
...
- **Reason**: The paper focuses on Retrieval-Augmented Generation (RAG) and hallucination detection, which is somewhat related to information retrieval and query understanding. However, the primary focus is on NLP and model evaluation, rather than search technologies or ranking models, limiting its relevance to your core research interests.
...
### 4. OnePiece: The Great Route to Generative Recommendation -- A Case Study from Tencent Algorithm Competition
...
- **Topic Keywords**: retrieval, recommend, search, recsys
- **Reason**: The paper discusses generative recommendation techniques in the context of recommender systems, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on neural language modeling and scaling laws is not directly aligned with the user's primary research themes of query understanding, ranking models, and user behavior modeling. The paper's relevance is also limited by its specific application in the recommender systems domain, which is not the user's primary focus.
...
### 5. Ensembling LLM-Induced Decision Trees for Explainable and Robust Error Detection
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves leveraging large language models for decision-making tasks. However, the focus on error detection in tabular data and the specific application of decision trees and graph neural networks is not a central match to your core research themes.
...
- **Reason**: The paper presents a novel attention mechanism, Block-Sparse FlashAttention, which accelerates long-context inference in large language models. While it's related to my interests in Search technologies and NLP, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are my core research themes.
...
### 7. Benchmarking Deep Neural Networks for Modern Recommendation Systems
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but its focus on recommendation systems and neural network architectures is not a central match. While it touches on the e-commerce domain, which is part of your background, the emphasis on recommendation systems and metrics like accuracy and diversity is not a primary focus of your research. The paper's discussion of neural network architectures and hybrid methods may be of some interest, but it does not align with your core research themes.
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to information retrieval, but its focus on large language models (LLMs) and reasoning stability is more aligned with natural language processing. While it touches on the idea of evaluating models' performance, it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 9. Mary, the Cheeseburger-Eating Vegetarian: Do LLMs Recognize Incoherence in Narratives?
...
- **Topic Keywords**: rag
- **Reason**: This paper explores the ability of Large Language Models (LLMs) to recognize incoherence in narratives, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on narrative coherence and LLMs' internal representations is not directly aligned with the user's core research themes, and the paper's relevance is limited to the broader context of Natural Language Processing.
...
### 10. A Simple Method to Enhance Pre-trained Language Models with Speech Tokens for Classification
...
- **Topic Keywords**: acl
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it primarily focuses on enhancing pre-trained language models with speech tokens for classification tasks, which is not directly aligned with your core interests in Information Retrieval (IR), query understanding, and ranking models.
...
### 11. SETUP: Sentence-level English-To-Uniform Meaning Representation Parser
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on developing a parser for Uniform Meaning Representation (UMR), a novel semantic representation. While it touches on natural language processing (NLP) and semantic understanding, it is primarily concerned with parsing and representation, rather than information retrieval or search technologies. The paper's emphasis on low-resource languages and language documentation also suggests a broader scope than the user's specific interests in e-commerce and real-time relevance optimization.
...
### 12. Exploring Test-time Scaling via Prediction Merging on Large-Scale Recommendation
...
- **Reason**: This paper explores test-time scaling for deep learning recommendation systems, leveraging ideas from language models. While it touches on scaling and optimization, which are related to IR, the focus is on recommendation systems rather than information retrieval. The paper's emphasis on real-time relevance optimization is somewhat relevant to IR, but the connection is not strong enough to warrant a higher score.
...
### 13. Complementary Learning Approach for Text Classification using Large Language Models
...
- **Reason**: This paper focuses on text classification using large language models, which is somewhat related to your interests in Natural Language Processing (NLP) and query understanding. However, the primary focus on text classification and human-machine collaboration does not directly align with your core research themes in Information Retrieval (IR) and search technologies.
...
### 14. Toward More Reliable Artificial Intelligence: Reducing Hallucinations in Vision-Language Models
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on reducing hallucinations in vision-language models, which is a specific problem in NLP. While it touches on multimodal systems, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 15. On the Impact of Graph Neural Networks in Recommender Systems: A Topological Perspective
...
- **Topic Keywords**: recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Recommender Systems, but it focuses more on Graph Neural Networks and their application in recommender systems, which is a related but distinct area. While it touches on the structural properties of user-item graphs, it does not directly address query understanding, ranking models, or user behavior modeling, which are core aspects of your research.
...
### 16. Investigating Training and Generalization in Faithful Self-Explanations of Large Language Models
...
- **Topic Keywords**: search
- **Reason**: The paper focuses on improving the faithfulness of self-explanations generated by large language models, which is related to query understanding and ranking models in Information Retrieval. However, the paper's primary focus on NLP and explanation styles does not directly align with the user's core research themes in IR and search technologies.
...
### 17. Performance of the SafeTerm AI-Based MedDRA Query System Against Standardised MedDRA Queries
...
- **Topic Keywords**: query, queries, ranking, relevance, retrieval, recommend, rank
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves query understanding and ranking models, the context is specific to medical terminology and drug safety review, which is not a primary focus of the user's interests.
...
### 18. Reformulate, Retrieve, Localize: Agents for Repository-Level Bug Localization
...
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves query reformulation and retrieval, the context is specific to bug localization in software repositories, which is not a primary focus of the user's interests.
...
### 19. Automated Generation of Custom MedDRA Queries Using SafeTerm Medical Map
...
- **Topic Keywords**: query, queries, ranking, relevance, recommend, rank
- **Reason**: This paper focuses on a specific application of medical terminology and query generation, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves ranking models and similarity measures, the context and domain are quite different from the user's interests.
...
### 20. Efficient ASR for Low-Resource Languages: Leveraging Cross-Lingual Unlabeled Data
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it does involve Natural Language Processing (NLP) in the context of Automatic Speech Recognition (ASR), it focuses on low-resource languages and cross-lingual pretraining, which is not a central match to your interests in query understanding, ranking models, and user behavior modeling.
...
### 21. Replicating TEMPEST at Scale: Multi-Turn Adversarial Attacks Against Trillion-Parameter Frontier Models
...
- **Reason**: This paper is not relevant to your research interests as it focuses on adversarial attacks against large language models, which is outside your primary focus on information retrieval, query understanding, and ranking models. Although it involves NLP, the context and methodology are not aligned with your areas of interest.
...
### 22. Pay Less Attention to Function Words for Free Robustness of Vision-Language Models
...
- **Reason**: This paper focuses on vision-language models and proposes a method to improve their robustness against cross-modal adversarial attacks. While it touches on attention mechanisms, which are related to ranking models, the paper's primary focus is on computer vision and natural language processing, rather than information retrieval or query understanding.
...
### 23. LUNE: Efficient LLM Unlearning via LoRA Fine-Tuning with Negative Examples
...
- **Reason**: This paper focuses on unlearning in large language models, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on deep semantic understanding, the context is different and not specifically aligned with the user's areas of focus.
...
### 24. PCMind-2.1-Kaiyuan-2B Technical Report
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models and their training efficiency, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on data and training recipes, it does not address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to the user's research.
...
### 25. MoCoRP: Modeling Consistent Relations between Persona and Response for Persona-based Dialogue
...
- **Comment**: 18 pages
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or query understanding. While it involves Natural Language Processing (NLP) and dialogue systems, the focus is on persona-based dialogue generation, which is not a central theme in your research background.
...
### 26. Enhancing Agentic RL with Progressive Reward Shaping and Value-based Sampling Policy Optimization
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Agentic Reinforcement Learning and Large Language Models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of optimization and policy learning, the context and application are quite different from your areas of interest.
...
### 27. Living the Novel: A System for Generating Self-Training Timeline-Aware Conversational Agents from Novels
...
- **Reason**: This paper appears to be unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. The focus on conversational agents, persona alignment, and narrative coherence is more aligned with NLP and AI-driven narrative systems, but does not directly relate to the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 28. Generating Storytelling Images with Rich Chains-of-Reasoning
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves generative AI models and Large Language Models, the focus is on image generation and storytelling, which is not a central match to your research themes.
...
### 29. MASim: Multilingual Agent-Based Simulation for Social Science
...
- **Reason**: This paper is primarily focused on multilingual agent-based simulation for social science, which is not directly related to Information Retrieval, Search technologies, or Natural Language Processing. While it involves language agents and user behavior modeling, the context and application are quite different from the user's core research themes.
...
### 30. Think-Reflect-Revise: A Policy-Guided Reflective Framework for Safety Alignment in Large Vision Language Models
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are core areas of your research interests. While it involves deep learning and safety alignment in Large Vision Language Models, the focus is on multimodal reasoning and safety-oriented reasoning, which is not a central match to your primary research themes.
...
### 31. GUMBridge: a Corpus for Varieties of Bridging Anaphora
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on bridging anaphora in NLP, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the topic is quite specific and not directly aligned with the user's core research themes.
...
### 32. DART: Leveraging Multi-Agent Disagreement for Tool Recruitment in Multimodal Reasoning
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on multimodal reasoning and tool recruitment using multi-agent disagreement, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of tool usage and decision-making, the context and methodology are quite different from the user's areas of interest.
...
### 33. Leveraging KV Similarity for Online Structured Pruning in LLMs
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on pruning large language models, which is not directly related to information retrieval or search technologies. While it involves deep semantic understanding, the context is specific to natural language processing and recommender systems are not mentioned.
...
### 34. Collaborative Causal Sensemaking: Closing the Complementarity Gap in Human-AI Decision Support
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on human-AI collaboration and decision support, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves AI and decision-making, the context and goals are quite different from the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 35. When Large Language Models Do Not Work: Online Incivility Prediction through Graph Neural Networks
...
- **Comment**: 10 pages
- **Topic Keywords**: search
- **Reason**: This paper focuses on online incivility prediction using Graph Neural Networks, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves text analysis, the context is specific to behavioral prediction and not aligned with the user's core themes of query understanding, ranking models, or user behavior modeling.
...
### 36. Recover-to-Forget: Gradient Reconstruction from LoRA for Efficient LLM Unlearning
...
- **Topic Keywords**: rank
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on deep semantic understanding, it's focused on unlearning in large language models, which doesn't align with your primary focus on real-time relevance optimization and query understanding.
...
### 37. TeluguST-46: A Benchmark Corpus and Comprehensive Evaluation for Telugu-English Speech Translation
...
- **Topic Keywords**: search
- **Reason**: This paper focuses on speech translation for the Telugu language, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and scope are quite different from the user's areas of focus.
...
### 38. Prompting-in-a-Series: Psychology-Informed Contents and Embeddings for Personality Recognition With Decoder-Only Models
...
- **Comment**: 16 pages
- **Topic Keywords**: search
- **Reason**: This paper is primarily focused on personality recognition using decoder-only models, which is not a central match to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP tasks, the specific application and methodology are not closely related to your core themes.
...
### 39. Beyond Real: Imaginary Extension of Rotary Position Embeddings for Long-Context LLMs
...
- **Reason**: This paper focuses on improving Rotary Position Embeddings for Large Language Models, which is a topic outside of the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. The paper's emphasis on long-context language modeling and complex-valued representations does not align with the user's focus on query understanding, ranking models, and user behavior modeling.
...
### 40. Group Representational Position Encoding
...
- **Reason**: This paper appears to be focused on positional encoding in the context of deep learning models, specifically for long-context models. It does not seem to be related to Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 41. PICKT: Practical Interlinked Concept Knowledge Tracing for Personalized Learning using Knowledge Map Concept Relations
...
### 42. Space efficient implementation of hypergraph dualization in the D-basis algorithm
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, Natural Language Processing, data mining, or related topics. The paper focuses on a space-efficient implementation of a hypergraph dualization algorithm, which is unrelated to your areas of interest.
