...
- **URL**: <http://arxiv.org/abs/2608.18752v2>
- **Submitted**: 2026-08-19 10:00:37
- **Comment**: Submitted to NLLP workshop 2026
- **Topic Keywords**: retriever, sparse retrieval, dense retrieval, query, relevance, relevance feedback, retrieval
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: GreekBarRetrieval – Unified Retrieval‑Only QA Benchmark for the Greek Bar Exam
- **Aim**: Isolate and evaluate the retrieval component of the GreekBarBench pipeline by providing a statutory‑only corpus, exam‑style queries, and a gold‑standard set of cited articles, enabling systematic comparison of sparse, dense, hybrid, and LLM‑enhanced retrieval methods.
- **Rationale**: Legal QA systems require accurate evidence retrieval; Greek legal texts lack large multilingual corpora and existing benchmarks. By creating a focused, language‑specific benchmark, researchers can study retrieval effectiveness, cross‑lingual transfer, and the impact of advanced techniques such as PRF, LLM reformulation, and iterative planning.
- **Ground**: • Corpus: 6,308 Greek statutory articles (Penal Code, Civil Code, etc.)
• Queries: 283 bar‑exam questions concatenated with case facts
• Gold set: 777 statutory articles cited in official solutions (~2.74 per query)
• English translation via openai/gpt-oss-120b for cross‑lingual baselines
• Annotation format: PREFIX::ARTICLE (e.g., CrimC::42,299,15,22)
• Scope limited to primary statutory text, no case law or secondary sources
- **Experiment**: Baseline methods: BM25 variants (GREEKSTEMMER, SPACY, GR‑NLP), 9 dense retrievers (Gemini‑001, Qwen3‑8B, etc.), hybrid RRF, English‑translation baseline. Enhancements: PRF (sparse & dense), LLM‑based query reformulation, iterative REACT‑BM25. Evaluation metrics: Recall@10/100, nDCG@10/100, MAP@100 via pytrec_eval. Key results: BM25‑GREEKSTEMMER R@100=0.36; Gemini‑001 R@100=0.77; Qwen3‑8B R@100=0.67; REACT‑BM25 (10 rounds) R@100=0.67 with superior nDCG and MAP. Statistical tests show significant gains for LLM reformulation and REACT over vanilla baselines.
- **Takeaway**: Dense retrieval dominates sparse models; Gemini‑001 and Qwen3‑8B provide the best single‑system performance. Iterative REACT‑BM25 yields the highest ranking quality, especially in nDCG and MAP, despite similar recall to the best dense models. LLM‑based query reformulation consistently improves both sparse and dense retrieval, while translation harms exact‑matching sparse systems. Hybrid RRF offers negligible benefit except for weak dense models. The benchmark supplies a valuable resource for future research on retrieval in Greek legal QA and cross‑lingual transfer.
...
### 2. Reducing Technician Search Burden: A Multimodal RAG for Cessna 172 Maintenance Manual

- **LLM Score**: 0
- **Keyword Score**: 16
- **Authors**: Seongjun Ha, Md Rashedul Islam, Gaurav Nanda, Damon Lercel
- **URL**: <http://arxiv.org/abs/2608.18465v1>
- **Submitted**: 2026-08-19 02:39:35
- **Topic Keywords**: retriever, query, queries, rag, retrieval augmented generation, retrieval, search
- **Reason**: LLM scoring failed.
...
- **URL**: <http://arxiv.org/abs/2608.18855v1>
- **Submitted**: 2026-08-19 12:28:20
- **Comment**: Accepted at CIKM 2026. 11 pages, 8 figures, and 9 tables
- **Topic Keywords**: dense retrieval, query, queries, retrieval, commerce, e-commerce, search
- **Reason**: LLM scoring failed.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Think-to-Personalize: Unified Reasoning–Retrieval for Open‑Text Personalized Dense Retrieval in E‑commerce
- **Aim**: Integrate LLM reasoning and dense retrieval into a single end‑to‑end system that optimizes the reasoning chain to maximize downstream retrieval utility.
- **Rationale**: Existing methods treat the LLM as an external re‑writer, leading to misalignment between reasoning and retrieval. RL approaches like PPO are heavy, while DPO lacks intermediate reasoning. The proposed GRPO replaces the value model with a group‑sampling baseline, reducing overhead and maintaining stability for complex reasoning.
- **Ground**: Open‑text personalized dense retrieval: users U, items I, user history H_u of purchased items with textual metadata, and a query q. The goal is to retrieve the most relevant target item i^+ from I.
- **Experiment**: Training involves Stage 1 supervised fine‑tuning with a joint loss to bootstrap cold‑start capabilities, followed by Stage 2 Group Relative Policy Optimization (GRPO) that uses a retrieval‑aware reward, dynamic positive selection, length penalty, format reward, and retrieval reward in a contrastive objective. The LLM receives an instruction prompt and outputs in the format <think>Rewrite Query</think><embed>. Evaluation is conducted on e‑commerce retrieval tasks to assess alignment and retrieval performance.
- **Takeaway**: The Think‑to‑Personalize framework demonstrates that end‑to‑end alignment of reasoning and retrieval, coupled with efficient RL training via GRPO, yields superior personalized retrieval performance while reducing computational overhead and improving stability compared to prior methods.
...
- **URL**: <http://arxiv.org/abs/2608.18606v2>
- **Submitted**: 2026-08-19 06:50:47
- **Topic Keywords**: ranking, rag, user behavior, ctr, recommend, rank
- **Reason**: LLM scoring failed.
...
### 5. AI in Search Reduces Publisher Referrals Without Improving User Experience: Experimental Evidence

- **LLM Score**: 0
- **Keyword Score**: 11
- **Authors**: Stephanie T. Wang, Jeffrey Gleason, Yakov Bart, Christo Wilson, Danaé Metaxa
- **URL**: <http://arxiv.org/abs/2608.18352v1>
- **Submitted**: 2026-08-18 22:08:10
- **Topic Keywords**: queries, user behavior, click, click-through rate, web search, search
- **Reason**: LLM scoring failed.
...
### 6. More Context, Same Budget: Dual-Bounded Relational Recall Beyond Top-K Retrieval

- **LLM Score**: 0
- **Keyword Score**: 9
- **Authors**: Thomson D. Nguy
- **URL**: <http://arxiv.org/abs/2608.18448v1>
- **Submitted**: 2026-08-19 02:23:50
...
### 8. Multimedia Asset Personalization via Multimodal Embeddings at Netflix
...
- **URL**: <http://arxiv.org/abs/2608.18322v1>
- **Submitted**: 2026-08-18 21:15:56
- **Topic Keywords**: query, recommend, personalization, rank, search
- **Reason**: LLM scoring failed.
...
### 9. SMTrap: Cost-Effective DoS Attacks Against Large Reasoning Models via SMT Conflict Guidance
...
### 10. GateDiffInt: Gate-Mediated Controllable Diffusion and Multi-Intent LLM Distillation for User Behavior Modeling

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Jialong Duan, Zichen Zhang, Zirui Tu, Zheng Zhang, Zepeng Li, Qingyao Cui, Qinwen Wang, Yudan Liu, Luo Yang, Yao Hu
- **URL**: <http://arxiv.org/abs/2608.18764v2>
- **Submitted**: 2026-08-19 10:14:49
- **Topic Keywords**: ranking, user behavior, rank
- **Reason**: LLM scoring failed.
...
### 11. DeepWeaver: Bridging the Evidence Synthesis Gap in Open-Ended Question Answering

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Xujia Wang, Yizhe Zhang, Bin Xu, Lei Hou, Juanzi Li
- **URL**: <http://arxiv.org/abs/2608.18988v1>
- **Submitted**: 2026-08-19 14:53:53
...
### 12. Learning Canonical Register Automata over Ordered Data Domains

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Yong Li, Qiyi Tang, Di-De Yen
- **URL**: <http://arxiv.org/abs/2608.18765v1>
- **Submitted**: 2026-08-19 10:16:45
...
### 13. Visual-Aware Representation of Web Pages for Machine Learning Applications

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Radek Burget, Radek Hranický
- **URL**: <http://arxiv.org/abs/2608.18727v1>
- **Submitted**: 2026-08-19 09:28:56
...
### 14. Budget-First Tariff Recommendation (BFTR): A Complete Algorithmic Framework for Telecom Plan Recommendation without Overcharging

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Ghislain Dorian Tchuente Mondjo
- **URL**: <http://arxiv.org/abs/2608.18723v1>
- **Submitted**: 2026-08-19 09:24:06
...
### 16. From Storage to Access: Verifiable Activation of Parametric Knowledge in LLMs via Explicit Priming and Implicit Reasoning
...
### 18. MissDiag: Diagnostic Evaluation of Incomplete-Knowledge Robustness in KGQA and KG-RAG

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Hang Wang, Hang Dong, Lu Liu, Chuanru Ren
- **URL**: <http://arxiv.org/abs/2608.18489v1>
- **Submitted**: 2026-08-19 03:28:11
- **Topic Keywords**: rag, retrieval
- **Reason**: LLM scoring failed.
...
### 21. Institutional Books - Enriched Text: A customizable multilingual open-source pipeline for denoising, deduplicating, and annotating OCR text at scale
...
### 22. Structure, Association, and Decision Value: Representation-Based Difficulty Estimation for Adaptive Inference in African-Language NLI

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Toheeb Ogunade
- **URL**: <http://arxiv.org/abs/2608.19003v1>
- **Submitted**: 2026-08-19 15:03:51
...
### 23. Training Chemical Plausibility-Aware Large Language Models for Single-Step Retrosynthesis
...
### 24. SIDScope: A Diagnostic Resource for Semantic-ID Interfaces in Generative Recommendation

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Jiandong Ding, Huijie Qin, Tiandeng Wu, Yi Cao
- **URL**: <http://arxiv.org/abs/2608.18779v1>
- **Submitted**: 2026-08-19 10:35:12
...
### 25. Gradient Mirage: Trainable yet Label-Unidentifiable Gradients in Large Language Model Split Learning
...
- **URL**: <http://arxiv.org/abs/2608.18637v2>
- **Submitted**: 2026-08-19 07:35:10
...
### 27. SPADE: Self-Play in Adaptive Synthetic Executable Environments
...
### 28. Beyond Teacher Likelihood: Group-Calibrated On-Policy Distillation for Long-Context Reasoning
...
### 29. Comment-level Topic Drift Analysis in the Reddit Corpus

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Steven Morse, Daniel Runfola, Trenton W. Ford
- **URL**: <http://arxiv.org/abs/2608.19133v1>
- **Submitted**: 2026-08-19 17:27:25
- **Topic Keywords**: rag
- **Reason**: LLM scoring failed.
...
### 30. Open-MOPD: Diagnosing and Fixing Capability Imbalance in Multi-Teacher On-Policy Distillation
...
### 31. Adaptive Memory and Reflection Multi-Agent System for Medical Question Answering

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Pradeep Murugesan, Luoxiao Yang, Xueli Chen, Xinqi Fan
- **URL**: <http://arxiv.org/abs/2608.19029v1>
- **Submitted**: 2026-08-19 15:24:18
...
### 32. MedUAG: Unified Understanding and Generation for Medical Multimodal Models
...
### 33. Do Large Language Models Hallucinate Electric Fata Morganas?

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Kristina Šekrst
- **URL**: <http://arxiv.org/abs/2608.18816v1>
- **Submitted**: 2026-08-19 11:14:06
- **Topic Keywords**: ctr
- **Reason**: LLM scoring failed.
...
### 34. Readable, Faithful, Used: Three Dissociable Properties of Demographic Identity in a Language Model

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Fathin Difa Robbani
- **URL**: <http://arxiv.org/abs/2608.18768v1>
- **Submitted**: 2026-08-19 10:25:11
...
- **URL**: <http://arxiv.org/abs/2608.18681v1>
- **Submitted**: 2026-08-19 08:31:15
- **Topic Keywords**: retrieval
- **Reason**: LLM scoring failed.
...
### 37. Compress and Forget: bitsandbytes Quantization Amplifies Proactive Interference in LLMs

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Shayan Shahrabi-Farahani, Dara Rahmati
- **URL**: <http://arxiv.org/abs/2608.18578v2>
- **Submitted**: 2026-08-19 06:17:13
...
### 39. DART-SD: Diamond-topology Aware Retrieval and Tuning for Self-Distillation of Multi-Turn Tool-Calling Agents
...
### 40. Building real-time digital twin instances with Function+Data Flow: user evaluation and extension for iterative pipelines

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Eduardo de Conto, Blaise Genest, Arvind Easwaran, Nicholas Ng, Shweta Menon
- **URL**: <http://arxiv.org/abs/2608.18480v1>
- **Submitted**: 2026-08-19 03:12:38
...
### 41. Pedagogical AI in Mental Health: A Tri-Stream Fine-Tuned LLM Framework for Automated Clinical Supervision and Risk Triage

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Shreeya Sharma, Ravish Gupta, Saket Kumar, Abhishek Aggarwal
- **URL**: <http://arxiv.org/abs/2608.18438v1>
- **Submitted**: 2026-08-19 02:10:15
...
### 42. Selection, Recombination, or a Fresh Solve? A Candidate-Free Control for Single-Pass Test-Time Aggregation

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Guiv Farmanfarmaian
- **URL**: <http://arxiv.org/abs/2608.18379v1>
- **Submitted**: 2026-08-18 23:17:16
...
### 43. From Inference to Adaptation: A Unified Optimal Transport View of Vision Language Model
...
### 44. What Makes Software Issue Resolution Tasks Difficult for Agents?

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Ebtesam Al-Haque, Brittany Johnson
- **URL**: <http://arxiv.org/abs/2608.18280v1>
- **Submitted**: 2026-08-18 19:59:16
...
### 45. When Readability and Source Retention Diverge: An Evaluability Gap in AI Translation

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Chenchen Mao, Hanjing Shi, Haiyan Jia, Emily Wegrzyn, Dominic DiFranzo
- **URL**: <http://arxiv.org/abs/2608.19083v1>
- **Submitted**: 2026-08-19 16:32:47
...
- **URL**: <http://arxiv.org/abs/2608.19006v1>
- **Submitted**: 2026-08-19 15:07:42
...
### 47. Test-Time Scaling in the Wild: Why Exploitation, Not Exploration, Is the Bottleneck

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Davide Romano, Kanak Raj, Jerrod Parker, Daniele Giofrè
- **URL**: <http://arxiv.org/abs/2608.18931v1>
- **Submitted**: 2026-08-19 13:59:53
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 48. Metrics That Write Themselves: Evolving an Evaluator from Its Own Blind Spots

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Xing Zhang, Yanwei Cui, Guanghui Wang, Zhihao Lin, Peiyang He
- **URL**: <http://arxiv.org/abs/2608.18744v1>
- **Submitted**: 2026-08-19 09:55:17
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 49. Artifact-centered Claim-aware Observability for Autonomous Scientific Agents

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Xiangyu Yin, Ming Du, Michael H. Prince, Mathew J. Cherukara
- **URL**: <http://arxiv.org/abs/2608.18312v1>
- **Submitted**: 2026-08-18 20:47:24
- **Topic Keywords**: search
- **Reason**: LLM scoring failed.
...
### 50. Global Crises and National Policies: A Large Scale Analysis of Political Content in German Language Online Media

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Yara Döring, Felix Bießmann
- **URL**: <http://arxiv.org/abs/2608.18268v1>
- **Submitted**: 2026-08-18 19:39:00
