# Daily Papers Report - 2026-08-16

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. How retriever redundancy and diversity impact RAG effectiveness

- **LLM Score**: 8
- **Keyword Score**: 14
- **Authors**: Jonathan J Ross, Bevan Koopman, Anton van der Vegt, Guido Zuccon
- **URL**: <http://arxiv.org/abs/2608.13956v1>
- **Submitted**: 2026-08-14 04:55:31
- **Topic Keywords**: retriever, query, relevance, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of Retrieval-Augmented Generation (RAG) models. The study investigates the impact of retriever redundancy and diversity on RAG effectiveness, which aligns with your focus on query understanding and ranking models. While the paper's specific domain is not e-commerce, the concepts and methods explored are applicable to your broader interests in IR and NLP.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Retrieval‑Augmented Generation (RAG) study on evidence type and quantity for open‑source LLMs
- **Aim**: To systematically assess how the type (duplicate, paraphrase, diverse) and number (k=1–5) of retrieved documents affect answer correctness in a controlled synthetic QA setting
- **Rationale**: Prior RAG work suggested redundancy or paraphrasing could boost performance; this study tests those claims using a synthetic corpus that eliminates close‑book correctness, thereby isolating the contribution of retrieved evidence
- **Ground**: Synthetic FictionalQA dataset; four open‑source LLMs (Llama‑3.2‑1B, Llama‑3.2‑3B, Llama‑3.1‑8B, Gemma‑3‑12B); evidence sets: duplicate copies, LLM‑generated paraphrases, and five genre‑diverse documents; evaluation via binary correctness with McNemar tests (p<0.01)
- **Experiment**: Retrieval scenarios: for each query retrieve k documents (k=1–5) of each evidence type; baseline single‑source (k=1); models evaluated on correctness; key findings: diverse evidence consistently outperforms duplicate and paraphrase across all models and k, with up to +24.7pp improvement over duplicate at k=5; duplicate yields modest gains over baseline; paraphrase shows negligible or negative gains; genre analysis shows encyclopedic sources yield highest correctness, social media lowest; statistical significance confirmed via chi‑square and McNemar tests
- **Takeaway**: Diversity of retrieved evidence, rather than redundancy or paraphrasing, is the primary driver of improved answer accuracy in RAG systems; future retrieval strategies should prioritize diverse, independent perspectives and consider genre effects to maximize performance
...
### 2. AdsWorldEngine: A Self-Evolving Conversational Advertising Agent through Orchestrator and Tool Coevolution

- **LLM Score**: 6
- **Keyword Score**: 8
- **Authors**: Simiao Zuo, Chenhui Xu, Yimeng Jia, Qiang Lou, Jian Jiao, Denis Charles
- **URL**: <http://arxiv.org/abs/2608.13833v1>
- **Submitted**: 2026-08-13 23:53:05
- **Topic Keywords**: query, relevance, rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in the area of query understanding and ranking models. However, the focus on conversational advertising and agentic frameworks is not a central match to your primary research themes, which are more geared towards e-commerce, natural language processing, and data mining.
...
### 3. Information Satisfaction: A Reader-Centered Axis for Summarization Evaluation

- **LLM Score**: 6
- **Keyword Score**: 7
- **Authors**: Isabel Cachola, William Walden, Reno Kriz, Mark Dredze
- **URL**: <http://arxiv.org/abs/2608.14457v1>
- **Submitted**: 2026-08-14 16:41:23
- **Topic Keywords**: query, queries, search
- **Reason**: This paper explores the concept of information satisfaction in summarization evaluation, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus is more on summarization evaluation and user persona, rather than search technologies or ranking models, limiting its direct relevance to your core research interests.
...
### 4. MACS: A Hybrid Multi-Agent Framework for Reliable Conversational E-Commerce Recommendation

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Juli Huang, Hannah Clay, Sajjad Beygi, Thomas Sarda, Negin Golrezaei, Amin Saberi
- **URL**: <http://arxiv.org/abs/2608.14068v1>
- **Submitted**: 2026-08-14 08:26:19
...
- **Topic Keywords**: query, retrieval, recommend, commerce, e-commerce, web search, search
- **Reason**: The paper presents a hybrid multi-agent framework for reliable conversational e-commerce recommendation, which is somewhat related to information retrieval and search technologies. However, the focus on conversational recommendation and fixed-catalog settings is not a central match to the user's core research themes, which include query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper explores a reliability problem in AI systems, proposing a trusted kernel with a generative shell to address it. While it touches on natural language interfaces and query understanding, its focus is more on system reliability and trustworthiness, which is somewhat related to your research interests in Information Retrieval and NLP, but not a central match.
...
- **Submitted**: 2026-08-13 18:59:41
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper presents a framework for claim-level verification and adaptive debate in cross-modal financial QA, which is somewhat related to information retrieval and query understanding. However, the focus on claim-level verification and multi-agent frameworks is not directly aligned with the user's primary research interests in ranking models and user behavior modeling. The paper's emphasis on financial QA and cross-modal verification also limits its relevance to the user's broader interests in e-commerce and deep semantic understanding.
...
### 7. HERMES: a multi-agent framework for structured knowledge extraction from ultra-long documents in geoscience
...
- **URL**: <http://arxiv.org/abs/2608.14055v1>
- **Submitted**: 2026-08-14 07:59:58
- **Comment**: 31-page main manuscript with 6 figures and 3 tables; supplementary information included
- **Topic Keywords**: ltr, rag
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it involves extracting structured data from unstructured text. However, the focus on geoscience and knowledge extraction from ultra-long documents is not directly aligned with the user's core research themes in e-commerce, query understanding, and ranking models.
...
### 8. S2Dialog: Multimodal Dialogue Retrieval with Semantic and Acoustic-Style Modeling

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Xueqi Wang, Zhigang Wang, Runqing Zhang, Zhenqi Jia, Junfeng Zhao
- **URL**: <http://arxiv.org/abs/2608.14029v1>
- **Submitted**: 2026-08-14 07:19:24
- **Topic Keywords**: retriever, retrieval
- **Reason**: This paper focuses on multimodal dialogue retrieval, which is somewhat related to information retrieval and search technologies. However, the specific application domain and the use of multimodal data (textual and acoustic) are not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 9. Predicting Custom-Feed Returns for New Bluesky Posts: A Prospective Study

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Yipeng Wang, Mohit Singhal
- **URL**: <http://arxiv.org/abs/2608.13874v1>
- **Submitted**: 2026-08-14 02:00:28
- **Comment**: To appear at The 20th ACM Recommender Systems Conference (RecSys 2026), please cite accordingly
- **Topic Keywords**: query, recommend, rank
- **Reason**: This paper is somewhat related to information retrieval and ranking models, as it involves a cold-start routing task and uses LambdaRank, a Learning to Rank algorithm. However, the specific context of Bluesky custom feeds and post return prediction is not directly aligned with the user's core research themes in e-commerce and deep semantic understanding.
...
### 10. Do AI chatbots find what experts would? Effects of model, user role, and sample size on study retrieval for medical questions

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Qingfang Liu, Qiao Jin, Joe D. Menke, Thorsten Kahnt, Zhiyong Lu
- **URL**: <http://arxiv.org/abs/2608.13786v1>
- **Submitted**: 2026-08-13 21:38:01
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, its focus on AI chatbots and medical questions is not directly aligned with your primary research themes. The paper's findings on the performance of LLM chatbots in retrieving studies are relevant to the broader field of IR, but not a central match for your research interests.
...
### 11. How Much Do Legal RAG Systems Still Hallucinate?

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Souvick Das, Sallam Abualhaija, Domenico Bianculli
- **URL**: <http://arxiv.org/abs/2608.14210v1>
- **Submitted**: 2026-08-14 11:39:17
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of retrieval-augmented generation systems. However, the focus on the legal domain and hallucination in RAG systems limits its relevance to your core research themes in e-commerce and deep semantic understanding. The paper's findings on hallucination rates and severity may be of interest, but it does not directly address your primary research areas.
...
### 12. HAM-RAG: Hierarchy-Aware Multimodal RAG for Structure-Faithful Interleaved Generation
...
- **Submitted**: 2026-08-14 07:20:42
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper proposes a novel framework for structure-faithful interleaved generation in multimodal RAG, leveraging document hierarchy as a grounding signal. While it touches on aspects of query understanding and ranking models, its primary focus is on multimodal generation and evidence selection, which is somewhat related to your research interests in Information Retrieval and Natural Language Processing.
...
- **Submitted**: 2026-08-14 12:03:03
- **Topic Keywords**: queries
- **Reason**: This paper is somewhat related to your interests in Information Retrieval and Natural Language Processing, as it deals with Large Language Models (LLMs) and their ability to 'forget' or unlearn information. However, the focus on LLM unlearning and its applications to language understanding is not directly aligned with your core research themes in query understanding, ranking models, and user behavior modeling.
...
### 14. Content Depth Matters in Short-Video Recommendation: Rethinking the Attention Economy

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Liwei Deng, Jing Jiang, Zhiwei Li, Yang Wang, Guodong Long
- **URL**: <http://arxiv.org/abs/2608.13990v1>
- **Submitted**: 2026-08-14 06:13:40
- **Comment**: 9 Pages
- **Topic Keywords**: rag, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Recommender Systems, but it focuses more on the content depth of short videos and its impact on user engagement. While it touches on the limitations of existing recommendation objectives, it doesn't directly address your core areas of interest in query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2608.14066v1>
- **Submitted**: 2026-08-14 08:24:30
- **Topic Keywords**: recommend, search
- **Reason**: The paper introduces a new dataset, TenderKG, for knowledge-aware recommendation in public procurement. While it touches on recommender systems, the focus is on the dataset and its applications rather than query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 16. Residual Dominance as a Structural Account of Last-Item Reliance in Causal Self-Attention Recommenders

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Keito Kozaki, Keigo Sakurai, Ren Togo, Takahiro Ogawa, Miki Haseyama
- **URL**: <http://arxiv.org/abs/2608.14021v1>
- **Submitted**: 2026-08-14 07:09:58
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Recommender Systems, but it focuses on a specific aspect of causal self-attention recommenders, which is not a central match to your primary focus on query understanding, ranking models, and user behavior modeling. The paper's emphasis on sequential recommenders and residual dominance is also somewhat tangential to your broader interests in NLP and data mining.
...
### 17. Whose Posts Get Ranked: Identical-Text Exposure Gaps in Bluesky Custom Feeds

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yipeng Wang, Mohit Singhal
- **URL**: <http://arxiv.org/abs/2608.13879v1>
- **Submitted**: 2026-08-14 02:08:44
- **Comment**: To appear at The 20th ACM Recommender Systems Conference (RecSys 2026), please cite accordingly
- **Topic Keywords**: recommend, rank
- **Reason**: This paper explores the ranking of identical-text posts in custom feeds, which is somewhat related to query understanding and ranking models in Information Retrieval. However, its focus on social media feeds and exposure gaps is not directly aligned with the user's core research themes in e-commerce, NLP, and real-time relevance optimization.
...
### 18. MINT: A Universal Zero-Shot Predictor for Transaction Data
...
- **Submitted**: 2026-08-14 11:17:01
- **Topic Keywords**: personalization
- **Reason**: The paper discusses a novel framework for transaction data analysis, leveraging multimodal instruction networks and zero-shot prediction. While it touches on aspects of data mining and NLP, it doesn't directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 19. TeachMateGPT: A Multi-Agent Knowledge-Grounded Framework for Pedagogical Assessment Generation from Science Curriculum Materials

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Fatema Tuj Johora Faria, Mukaffi Bin Moin, M. F. Mridha, Jubayer Al Mahmud
- **URL**: <http://arxiv.org/abs/2608.13708v1>
- **Submitted**: 2026-08-13 19:06:37
- **Topic Keywords**: relevance, rag, retrieval, search
- **Reason**: This paper focuses on a multi-agent system for generating science assessment items, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of data mining and knowledge grounding, the context and application are significantly different from the user's interests.
...
### 20. GALA: Generation-Aware Cross-Modal Alignment for Text-to-Time-Series Synthesis

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Haochen Zhang, Gengwei Zhang, Laura Yao, Nicholas Knoz, Tianlong Chen
- **URL**: <http://arxiv.org/abs/2608.13741v1>
- **Submitted**: 2026-08-13 19:57:07
- **Comment**: 21 pages, 6 figures
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper focuses on text-to-time-series synthesis, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves natural language processing, the context is different from query understanding, ranking models, and recommender systems.
...
### 21. PriCoRec: A Privacy-Aware Cloud-Device Collaborative Framework for Ad Recommendation under Feature Constraints
...
- **Submitted**: 2026-08-14 16:11:27
- **Comment**: 5 pages, 1 figure. Accepted to RecSys'26
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: This paper focuses on recommender systems, specifically addressing privacy concerns in cloud-based recommendation models. While it touches on personalization and ranking, the primary emphasis is on privacy-aware deployment and feature constraints, which is somewhat related to information retrieval but not a central match to your core research themes.
...
### 22. AnchorBench: A Multi-Pathway Benchmark for the Anchoring Effect in LLMs

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Yiderigun Borjigin, Alexander Hermann, Christian Cyron, Roland Aydin
- **URL**: <http://arxiv.org/abs/2608.14320v1>
- **Submitted**: 2026-08-14 14:04:42
- **Comment**: Published as a conference paper at COLM 2026
- **Topic Keywords**: relevance, rag
- **Reason**: This paper appears to be focused on the anchoring effect in Large Language Models (LLMs), which is a topic in Natural Language Processing (NLP). While it touches on the concept of 'judgment and decision-making', it doesn't seem to be directly related to Information Retrieval (IR), Search technologies, or user behavior modeling, which are the core areas of your research interests.
...
### 23. Scaling Creative Writing Beyond Story-Centric Data with Attribute-Guided Genre Expansion

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Hwan Chang, Yongil Kim, Heuiyeen Yeen, Yireun Kim, Jinsik Lee, Hwanhee Lee
- **URL**: <http://arxiv.org/abs/2608.13947v1>
- **Submitted**: 2026-08-14 04:38:29
- **Comment**: CIKM 2026
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on creative writing data and genre expansion for large language models, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is specific to creative writing and does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 24. ASSERT: A Measurement Pipeline for GenAI Audits
...
- **Submitted**: 2026-08-14 00:07:32
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The focus on GenAI audits and measurement pipelines does not align with your areas of expertise.
...
### 25. MathForm: Scaling Mathematical Autoformalization with Knowledge Retrieval and Verification-Guided Refinement
...
- **Submitted**: 2026-08-14 11:51:12
- **Comment**: 25 pages, 6 figures, 8 tables
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is about autoformalization and knowledge retrieval in the context of mathematical statements, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 26. Leading-Silence Augmentation and Multi-Stage Synthetic Supervision for the Second MLC-SLM Challenge

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Kexin Shi, Renhe Sun, Yuge Huang, Ximeng Wang, Jiayi Zhou, Jian Liu, Malu Zhang
- **URL**: <http://arxiv.org/abs/2608.14150v1>
- **Submitted**: 2026-08-14 10:00:42
- **Topic Keywords**: rag, acl
- **Reason**: This paper appears to be focused on speech language models and conversational speech understanding, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the context and methodology seem to be more aligned with speech processing and machine learning for conversational AI.
...
### 27. EchoRec: Multi-Item Prediction-Empowered Generative Recommendation via Cycle-Consistent Preference Alignment
...
- **Submitted**: 2026-08-14 06:59:12
- **Comment**: 10 pages, 9 figures, Under Review
- **Topic Keywords**: retrieval, recommend, rank
- **Reason**: This paper focuses on recommendation systems, specifically generative recommendation, which is somewhat related to information retrieval. However, the primary focus is on preference modeling and recommendation, rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 28. BM25-Augmented Many-Shot Translation for Low-Resource North-Eastern Indian Languages
...
- **Submitted**: 2026-08-13 19:31:56
- **Topic Keywords**: retrieval, search
- **Reason**: This paper is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves retrieval-augmented translation, the focus is on low-resource languages and translation, which is not a central match for the user's interests.
...
### 29. Grounding Without Corrective Control: Truth-Tracking Profiles for Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Brett Reynolds
- **URL**: <http://arxiv.org/abs/2608.14252v1>
- **Submitted**: 2026-08-14 12:30:19
...
- **Reason**: This paper appears to be focused on the concept of 'grounding' in large language models, which is not directly related to information retrieval or search technologies. While it touches on the idea of 'truth-tracking', the context is more aligned with NLP and model evaluation rather than query understanding or ranking models.
...
### 30. Batch-wise Adaptive Pruning: Periodic Neuron Activation-Aware Weight Pruning for Language Reasoning Model

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yongmin Kim, Shota Takashiro, Yusuke Iwasawa, Takeshi Kojima, Yutaka Matsuo
- **URL**: <http://arxiv.org/abs/2608.14003v1>
- **Submitted**: 2026-08-14 06:46:02
- **Comment**: Accepted at COLM 2026. 28 pages, 12 figures, 18 tables. Code: https://github.com/matsuolab/batch-wise-prune
- **Topic Keywords**: rag
- **Reason**: This paper focuses on pruning methods for large reasoning models, which is a specific area within NLP. While it involves deep semantic understanding, it is not directly related to information retrieval, search technologies, or user behavior modeling, which are the primary areas of interest.
...
### 31. Bootstrapping Niche Multilingual Code Translation via Reinforcement Learning with Execution-Based Verifiable Supervision
...
- **Submitted**: 2026-08-14 00:56:41
- **Comment**: 11 pages, 3 figures, 5 tables. Preprint under review
- **Topic Keywords**: rag
- **Reason**: This paper focuses on code translation and reinforcement learning, which is somewhat related to information retrieval and search technologies. However, the specific domain of code translation and the use of execution-based supervision do not directly align with the user's core research themes in IR, query understanding, and user behavior modeling.
...
### 32. From Passive Delegates to Strategic Negotiators: Reinforcing Social Reasoning in Small Language Models with SocialRL
...
- **Submitted**: 2026-08-13 21:39:12
- **Comment**: 25 pages, 3 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on social reasoning in AI agents, specifically training them to negotiate and interact with humans. While it involves a deep learning model, the primary topic is not information retrieval, search technologies, or related areas of interest. The paper's emphasis on social reasoning and negotiation strategies does not align with the user's core research themes.
...
### 33. You Only Pass Once: Answering and Abstaining Together in a Single Forward Pass of a Frozen Language Model
...
- **Submitted**: 2026-08-14 16:44:35
- **Comment**: 24 pages. Ziyang Luo and Zhongyao Chu contributed equally
- **Topic Keywords**: search
- **Reason**: This paper focuses on improving the performance of frozen language models on reasoning tasks, specifically addressing issues with evidence usage and input sufficiency. While it involves some aspects of deep semantic understanding, it is primarily concerned with model architecture and inference efficiency, which is not directly related to your core research interests in Information Retrieval and Search technologies.
...
### 34. Whose doctor does the AI recommend? An algorithm audit of reputation and demographic signals in large language model-assisted physician choice

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Syeda Anshrah Gillani, Mirza Samad Ahmed Baig
- **URL**: <http://arxiv.org/abs/2608.14399v1>
- **Submitted**: 2026-08-14 15:39:10
- **Comment**: 26 pages, 9 figures, 10 tables
- **Topic Keywords**: recommend
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on the fairness and transparency of large language model-assisted physician choice systems. While it involves NLP and recommender systems, the context is more aligned with healthcare and AI ethics, which is not a primary focus of your research interests.
...
### 35. Seeing Red, Thinking Bad: Color Bias in Vision Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Kohsuke Ide, Ryousuke Yamada, Yoshihiro Fukuhara, Hirokatsu Kataoka, Yutaka Satoh
- **URL**: <http://arxiv.org/abs/2608.14286v1>
- **Submitted**: 2026-08-14 13:14:58
- **Comment**: 15 pages. Accepted to ICPR 2026
- **Topic Keywords**: recommend
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves analysis of vision language models, its focus on visual styling biases and their impact on sentiment predictions is more aligned with computer vision and NLP applications, rather than your core research themes.
...
### 36. Agentic Transaction: Towards ACID-Compliant Agent Systems

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Zhaoyan Sun, Xiaoxiao Wang, Guoliang Li
- **URL**: <http://arxiv.org/abs/2608.13900v1>
- **Submitted**: 2026-08-14 03:13:54
- **Topic Keywords**: search
- **Reason**: This paper focuses on developing a framework for reliable agent systems, which is not directly related to information retrieval, search technologies, or natural language processing. While it involves AI and system architecture, the context and concepts presented are quite different from the user's core research interests.
...
### 37. Envs-FORGE: Frontier-Optimized Reward-Grounded Environment Synthesis for Agent RL
...
- **Submitted**: 2026-08-14 13:54:22
- **Comment**: 19 pages, 5 figures
- **Topic Keywords**: rag, acl
- **Reason**: This paper is about environment synthesis for reinforcement learning, which is not directly related to information retrieval, search technologies, or natural language processing. Although it involves optimization and modeling, the context is quite different from the user's core research themes.
...
### 38. QUASAR: Lowering the Loss Floor of Quantization-Aware Training with Loss-Aware Reconstruction

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Vincent Counathe, Ben Athiwaratkun, Christopher De Sa, Tianyi Zhang
- **URL**: <http://arxiv.org/abs/2608.13966v1>
- **Submitted**: 2026-08-14 05:29:58
- **Comment**: 39 pages
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on quantization-aware training for large language models, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 39. A Survey of Large Models in Sports

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Yichen Xu, Jianzhe Ma, Chuhan Wang, Zhonghao Cao, Liangyu Chen, Wenxuan Wang, Qin Jin
- **URL**: <http://arxiv.org/abs/2608.14377v1>
- **Submitted**: 2026-08-14 15:17:54
- **Comment**: 36 pages, 4 figures, 6 tables. Accepted to Findings of ACL 2026
- **Topic Keywords**: search
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on large models in sports, which does not align with your areas of expertise.
...
### 40. Repair, Not Improvement: Decomposing Constrained Decoding in Tool-Call Abstention

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Janghoon Lee
- **URL**: <http://arxiv.org/abs/2608.13959v1>
- **Submitted**: 2026-08-14 04:58:01
- **Comment**: 24 pages, 4 figures, 17 tables
- **Topic Keywords**: korea
- **Reason**: This paper appears to be focused on constrained decoding in tool-call abstention, which is a topic in Natural Language Processing (NLP). However, it does not seem to be related to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core research themes of interest.
