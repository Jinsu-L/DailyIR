...
- **Submitted**: 2026-06-15 07:22:36
- **Topic Keywords**: retriever, query, retrieval
- **Reason**: This paper aligns closely with your research interests in Information Retrieval, particularly in query understanding and ranking models. The proposed RL-Index framework utilizes reinforcement learning to optimize indexing decisions, which is a novel approach to real-time relevance optimization. The paper's focus on deep semantic understanding and its application to a real-world task also resonates with your interests.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: RL-Index: Offline, Reinforcement‑Learning‑Driven Document Augmentation for Retrieval‑Intensive Knowledge Search
- **Aim**: Shift the reasoning burden from query time to index time by learning an offline document augmentation policy that explicitly exposes latent query–document relationships, thereby enabling fast and effective retrieval without query rewriting.
- **Rationale**: Existing online query‑side reasoning incurs high latency and ignores corpus context, while offline index‑side methods rely on generic, expensive LLMs and are not tuned to retrieval objectives. RL‑Index reframes document augmentation as a reinforcement‑learning problem, training an LLM‑powered agent (RL‑Indexer) to generate rationales that maximize retrieval similarity, thus directly optimizing for downstream performance.
- **Ground**: The RL‑Indexer is a policy (pi_	heta) that samples augmented documents (eD) conditioned on a prompt (P). A reference policy (pi_{Theta_{	ext{old}}}) and group sampling of (K) candidates per query–document pair are used. The reward is the similarity‑gain (R_k=F_{Theta_{	ext{Retriever}}}(Q,eD_k)-F_{Theta_{	ext{Retriever}}}(Q,D)). Policy updates employ Group Relative Policy Optimization (GRPO), a PPO‑style clipped objective with a KL penalty to keep the policy close to the reference LLM. The process is fully offline: rationales are generated, rewards computed, and the policy iteratively refined until convergence.
- **Experiment**: On the BRIGHT benchmark, RL‑Index improves nDCG@10 by 14–15% across BM25, SBERT, BGE, and Qwen embeddings, achieving 0.48–0.56 versus baselines 0.42–0.49. Combining with query‑side reasoning yields further gains (up to +21%). Online latency drops from ~350 ms to ~120 ms. The learned RL‑Indexer generalizes across retrievers with negligible loss, and outperforms SPIKE*, TongSearch‑QR, and doc2query on all domains.
- **Takeaway**: RL‑Index demonstrates that offline, RL‑driven document augmentation can produce retrieval‑oriented rationales that substantially boost performance while keeping inference fast. The approach is general, plug‑and‑play across retrievers and LLMs, and can be combined with query‑side reasoning for additional gains.
...
- **URL**: <http://arxiv.org/abs/2606.16817v1>
- **Submitted**: 2026-06-15 15:02:52
- **Comment**: ACL 2026 Main
- **Topic Keywords**: information retrieval, retriever, query, queries, rag, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The focus on retrieval-augmented generation and the use of reinforcement learning to adapt query formulation strategies aligns with your interests. However, the paper's specific focus on environment-aware retrieval may not be directly applicable to your e-commerce background.
...
### 3. SCAR: Semantic Continuity-Aware Retrieval for Efficient Context Expansion in RAG

- **LLM Score**: 8
- **Keyword Score**: 13
- **Authors**: Nathanaël Langlois
- **URL**: <http://arxiv.org/abs/2606.16661v1>
- **Submitted**: 2026-06-15 12:55:49
- **Comment**: 5 pages, 1 figure
- **Topic Keywords**: query, queries, relevance, rag, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, specifically addressing a challenge in Retrieval-Augmented Generation (RAG). The proposed SCAR policy improves recall and reduces token overhead, aligning with your interests in query understanding and ranking models. While the focus is on a specific application, the techniques and concepts presented are applicable to broader IR and NLP research areas.
...
### 4. Entity Labels Are Not Entity Signals: A Framework for Observable Relevance in Document Re-Ranking

- **LLM Score**: 8
- **Keyword Score**: 12
- **Authors**: Utshab Kumar Ghosh, Shubham Chatterjee
- **URL**: <http://arxiv.org/abs/2606.15998v1>
- **Submitted**: 2026-06-14 19:52:51
- **Comment**: ICTIR '26
- **Topic Keywords**: query, ranking, relevance, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The authors propose a framework for observable relevance in document re-ranking, which aligns with your focus on real-time relevance optimization. While the paper's specific domain is entity-aware retrieval, the concepts and methods discussed are applicable to a broader range of IR problems.
...
### 5. PathRouter: Aligning Rewards with Retrieval Quality in Agentic Graph Retrieval-Augmented Generation
...
- **Submitted**: 2026-06-15 08:48:04
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: This paper is highly relevant to Information Retrieval, specifically in the area of query understanding and ranking models, as it presents a path-aware training framework for agentic graph retrieval-augmented generation. The focus on evaluating trajectory correctness and evidence-path overlap aligns with the user's interests in deep semantic understanding and real-time relevance optimization. However, the paper's primary focus on question-answering and graph retrieval-augmented generation is somewhat outside the user's core e-commerce domain expertise.
...
### 6. PIANO: Personalized Reranking via Information Aggregation Node for Music Search Optimization

- **LLM Score**: 7
- **Keyword Score**: 27
- **Authors**: Weisheng Li, Chuqiao Huang, Pengcheng Li, Zhengchao Peng, Qiang Xiao, Zhongqian Xie, Qiang Huang, Chuanjiang Luo
- **URL**: <http://arxiv.org/abs/2606.16641v1>
- **Submitted**: 2026-06-15 12:29:09
- **Comment**: Accepted at ECML PKDD 2026. 18 pages, 4 figures
- **Topic Keywords**: query, queries, ranking, rerank, listwise, click, ctr, click-through rate, cvr, conversion rate, rank, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. The focus on music search optimization and personalized reranking is relevant, but the specific domain and application (music search) is not a central match to your e-commerce background and interests.
...
### 7. A Theoretical Framework for Risk Analysis of Stochastic Rankers

- **LLM Score**: 7
- **Keyword Score**: 14
- **Authors**: Debasis Ganguly
- **URL**: <http://arxiv.org/abs/2606.16970v1>
- **Submitted**: 2026-06-15 17:06:26
- **Topic Keywords**: ranking, rerank, relevance, retrieval, rank, trec
- **Reason**: This paper is somewhat related to the user's research interests in Information Retrieval, specifically in the area of ranking models. The focus on stochastic rankers and reranking policies aligns with the user's interest in Learning to Rank, but the emphasis on risk analysis and fairness is a departure from the user's primary focus on relevance optimization. The connection to the e-commerce domain is also limited, but the theoretical framework presented may be applicable to various domains.
...
### 8. How Much Can We Trust LLM Search Agents? Measuring Endorsement Vulnerability to Web Content Manipulation

- **LLM Score**: 7
- **Keyword Score**: 2
- **Authors**: Yimeng Chen, Zhe Ren, Firas Laakom, Yu Li, Dandan Guo, Jürgen Schmidhuber
- **URL**: <http://arxiv.org/abs/2606.16821v1>
- **Submitted**: 2026-06-15 15:05:25
- **Comment**: 23 pages, 3 figures
- **Topic Keywords**: recommend, search
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of search technologies and query understanding. The focus on Large Language Model (LLM) search agents and their vulnerability to web content manipulation is relevant, but it does not directly align with the user's primary focus on deep semantic understanding and real-time relevance optimization. The paper's emphasis on recommendation reliability and backend safety evaluation is also somewhat relevant to the user's interests in recommender systems.
...
- **Submitted**: 2026-06-15 17:59:28
- **Comment**: 29 pages, 9 figures
- **Topic Keywords**: query, rag, search
- **Reason**: The paper explores context-aware reinforcement learning for large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on multimodal performance and long-horizon reasoning in a different domain (e.g., coding agents, visual question answering) limits its direct relevance to the user's core research themes.
...
### 10. Whose hotel does the AI recommend? An algorithm audit of reputation signals in LLM-assisted hotel selection

- **LLM Score**: 6
- **Keyword Score**: 3
- **Authors**: Mirza Samad Ahmed Baig, Syeda Anshrah Gillani, Asher Ali
- **URL**: <http://arxiv.org/abs/2606.16344v1>
- **Submitted**: 2026-06-15 07:47:31
- **Comment**: 32 Pages
- **Topic Keywords**: rag, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of search technologies and user behavior modeling. However, the focus on hotel selection and recommendation systems, while related to your background in e-commerce, is not a central match to your primary interests in query understanding, ranking models, and deep semantic understanding. The paper's findings on the importance of guest rating and price in hotel recommendations may be of some interest, but the topic is not directly aligned with your core research themes.
...
### 11. SAG: SQL-Retrieval Augmented Generation with Query-Time Dynamic Hyperedges

- **LLM Score**: 4
- **Keyword Score**: 12
- **Authors**: Yuchao Wu, Junqin Li, XingCheng Liang, Yongjie Chen, Yinghao Liang, Linyuan Mo, Guanxian Li
- **URL**: <http://arxiv.org/abs/2606.15971v1>
- **Submitted**: 2026-06-14 18:52:26
- **Topic Keywords**: query, queries, rag, retrieval augmented generation, retrieval
- **Reason**: The paper SAG introduces a structured architecture for retrieval and agent systems, leveraging SQL join queries to dynamically link events into local hyperedges. While it deals with query understanding and knowledge retrieval, its focus on structured constraints and multi-hop reasoning is somewhat related to the user's interests in Information Retrieval and query understanding. However, the paper's emphasis on database infrastructure and scalability is not directly aligned with the user's primary focus on deep semantic understanding and real-time relevance optimization.
...
- **Submitted**: 2026-06-15 09:57:48
- **Comment**: 15 pages, 9 figures. Under review at EMNLP 2026
- **Topic Keywords**: ranking, rerank, retrieval, rank, acl
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the context of multimodal retrieval-augmented question answering. However, the focus on visual question answering and the specific phenomenon of 'Lost at the End' primacy bias is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.
...
### 13. Benchmarking LLM Agents on Meta-Analysis Articles from Nature Portfolio

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Anzhe Xie, Weihang Su, Yujia Zhou, Yiqun Liu, Qingyao Ai
- **URL**: <http://arxiv.org/abs/2606.17041v2>
- **Submitted**: 2026-06-15 17:56:41
...
- **Reason**: The paper is somewhat related to information retrieval, as it discusses a dataset and benchmarking of LLM agents for meta-analysis articles. However, the focus is on the retrieval-screening-synthesis pipeline, which is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's emphasis on LLMs and meta-analysis also diverges from the user's primary focus on e-commerce and real-time relevance optimization.
...
### 14. OneRank: Unified Transformer-Native Ranking Architecture for Multi-Task Recommendation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Jiakai Tang, Sunhao Dai, Kun Wang, Zhiluohan Guo, Yu Zhao, Cong Fu, Kangle Wu, Yabo Ni, Anxiang Zeng, Xu Chen, Jun Xu
- **URL**: <http://arxiv.org/abs/2606.16838v1>
- **Submitted**: 2026-06-15 15:16:17
- **Comment**: KDD 2026 Accepted
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: The paper discusses a unified Transformer-native ranking architecture for multi-task recommendation, which is somewhat related to the user's interest in ranking models and user behavior modeling. However, the focus on recommender systems and multi-task learning is not a central match to the user's primary interest in information retrieval, especially in areas requiring deep semantic understanding and real-time relevance optimization.
...
### 15. Long-Context Modeling via GSS-Transformer Hybrid Architecture with Learnable Mixing

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Kuzey Torlak, Hüseyin Arda Arslan, Anıl Dervişoğlu, Beyza Nur Deniz, Onur Boyar
- **URL**: <http://arxiv.org/abs/2606.16093v1>
- **Submitted**: 2026-06-15 01:17:51
- **Comment**: 16 pages, 9 tables, 4 figures
- **Topic Keywords**: query, retrieval
- **Reason**: This paper proposes a novel architecture for long-context language modeling, leveraging the strengths of State Space Models and Transformer architectures. While it is related to Natural Language Processing and deep semantic understanding, it does not directly address information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
- **Submitted**: 2026-06-15 17:52:27
- **Topic Keywords**: query, search
- **Reason**: The paper discusses a method for constructing query-rubric pairs for deep research agents, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on reinforcement learning and rubric-based rewards is not directly aligned with the user's primary interests in IR and NLP.
...
### 17. The Value Axis: Language Models Encode Whether They're on the Right Track

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Nick Jiang, Isaac Kauvar, Jack Lindsey
- **URL**: <http://arxiv.org/abs/2606.17056v1>
- **Submitted**: 2026-06-15 17:59:58
- **Comment**: Code repository: https://github.com/nickjiang2378/value-axis
- **Topic Keywords**: queries
- **Reason**: This paper explores the internal workings of language models, specifically how they track their 'value' or likelihood of achieving goals. While it touches on aspects of query understanding and ranking models, its primary focus is on language models and their behavior, which is somewhat related to your interests in Information Retrieval and NLP. However, the paper's emphasis on language models and their internal workings makes it less directly relevant to your core research themes.
...
### 18. Can LLM Coding Agents Reason About Time Series?

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Filip Rechtorík, Ondřej Dušek, Zdeněk Kasner
- **URL**: <http://arxiv.org/abs/2606.16545v1>
- **Submitted**: 2026-06-15 10:49:28
- **Comment**: 17 pages, 7 figures
- **Topic Keywords**: queries
- **Reason**: This paper explores the application of Large Language Models (LLMs) in time series analysis, which is somewhat related to information retrieval, but not directly aligned with the user's core research themes. The paper's focus on LLMs and their ability to reason about time series data is more relevant to NLP and data mining, but the user's primary interest is in IR and search technologies. While the paper's findings on model performance and reasoning gaps may be of some interest, it does not directly contribute to the user's research interests.
...
### 19. Exploring Extrinsic and Intrinsic Properties for Effective Reasoning with Code Interpreter
...
- **Submitted**: 2026-06-15 16:34:00
- **Topic Keywords**: rag
- **Reason**: The paper explores reasoning capabilities of large language models through executable computation, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on code interpretation and cognitive behaviors is not directly aligned with the user's core research themes in IR and Search technologies. The connection to Natural Language Processing is more relevant, but still not a central match.
...
### 20. SING: Synthetic Intention Graph for Scalable Active Tool Discovery in LLM Agents
...
- **URL**: <http://arxiv.org/abs/2606.16591v2>
- **Submitted**: 2026-06-15 11:37:37
- **Topic Keywords**: retrieval
- **Reason**: This paper proposes a framework for active tool discovery in large language model agents, which involves building an intention-tool graph to link user intentions and tool capabilities. While it touches on retrieval-augmented tool selection, the primary focus is on tool discovery rather than information retrieval or ranking models. The paper's emphasis on large-scale agentic ecosystems and tool collaboration patterns is somewhat related to user behavior modeling, but it doesn't directly align with the user's core research themes in IR and NLP.
...
### 21. VisualClaw: A Real-Time, Personalized Agent for the Physical World
...
- **Submitted**: 2026-06-15 06:58:22
- **Comment**: H. T. and J. C. contribute to this project equally
- **Topic Keywords**: rag
- **Reason**: The paper discusses a real-time, personalized agent for the physical world, leveraging vision language models and multimodal tasks. While it touches on aspects of query understanding and ranking models, its primary focus is on agent design and deployment, which is somewhat related to information retrieval but not a central match for your research interests.
...
### 22. Weaving Multi-Source Evidence for Biomedical Reasoning: The BioMedHop Benchmark and BioWeave Framework

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Xingyu Tan, Shiyuan Liu, Xiaoyang Wang, Qing Liu, Xiwei Xu, Xin Yuan, Liming Zhu, Wenjie Zhang
- **URL**: <http://arxiv.org/abs/2606.16211v1>
- **Submitted**: 2026-06-15 04:38:24
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of biomedical question answering and evidence reasoning. However, the focus on biomedical knowledge graphs and literature comprehension is not directly aligned with your primary interests in e-commerce and real-time relevance optimization. The paper's use of deep learning models and graph reasoning is somewhat relevant, but the specific application and domain are not central to your research themes.
...
### 23. Leveraging Code-Mixed Product Metadata and User Feedback for Personalized Recommendation on Daraz Bangladesh

- **LLM Score**: 3
- **Keyword Score**: 7
- **Authors**: KM Fahim A Bari, Muhammad Abdullah Adnan, Nafis Sadeq
- **URL**: <http://arxiv.org/abs/2606.16387v1>
- **Submitted**: 2026-06-15 08:17:36
- **Topic Keywords**: rag, recommend, commerce, e-commerce, search, recsys
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it focuses on recommender systems in the e-commerce domain, which is a secondary interest. The paper explores code-mixed product metadata and user feedback, but it doesn't delve into query understanding, ranking models, or user behavior modeling, which are your primary areas of focus.
...
### 24. QK-Normed MLA: QK normalization without full key caching

- **LLM Score**: 3
- **Keyword Score**: 6
- **Authors**: Yizhou Han, Yao Zhao, Jun Zhou, Longfei Li, Ruoyu Sun
- **URL**: <http://arxiv.org/abs/2606.16310v1>
- **Submitted**: 2026-06-15 07:16:30
- **Comment**: 13 pages, 5 figures, conference-style manuscript
- **Topic Keywords**: query, queries
- **Reason**: This paper is loosely relevant to the user's research interests in Information Retrieval and Natural Language Processing, specifically in the area of attention mechanisms and model stabilization. However, the focus on query-key normalization and its application to Multi-head Latent Attention (MLA) models does not directly align with the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance is mostly in the broader context of NLP and attention mechanisms.
...
- **Submitted**: 2026-06-15 17:46:50
- **Comment**: LightMem Series: Work in Progress
- **Topic Keywords**: relevance
- **Reason**: This paper is loosely relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, it focuses on Large Language Model (LLM) agents and context management, which is not a central match to your primary research themes. The paper's emphasis on cache efficiency and context management in LLMs is somewhat related to your interests in real-time relevance optimization, but it does not directly address your core research areas.
...
### 26. Can LLM Agents Infer World Models? Evidence from Agentic Automata Learning

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Reef Menaged, Gili Lior, Shauli Ravfogel, Roee Aharoni, Gabriel Stanovsky
- **URL**: <http://arxiv.org/abs/2606.16576v1>
- **Submitted**: 2026-06-15 11:23:13
- **Topic Keywords**: query, queries, acl
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves LLM agents, the focus is on evaluating their ability to uncover hidden environments through interaction, which is not a core theme in your research.
...
### 27. Towards Pareto-Optimal Tool-Integrated Agents with Pareto Ranking Policy Optimization

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Junyi Li, Xiaowei Qian, Yingyi Zhang, Wenlin Zhang, Guojing Li, Sheng Zhang, Xiao Han, Yichao Wang, Xiangyu Zhao
- **URL**: <http://arxiv.org/abs/2606.16111v1>
- **Submitted**: 2026-06-15 01:58:07
- **Comment**: ICML 2026 Spotlight Paper
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper focuses on tool-integrated language agents and Pareto optimization, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the primary goal is to optimize tool-use efficiency, which is not a central match for the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 28. Your "Pro" LLM Subscription May Actually Be "Free": Exposing Fingerprint Spoofing Risks in LLM Inference Services

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Jiahao Zhang, Xiuyu Li, Suhang Wang
- **URL**: <http://arxiv.org/abs/2606.16100v1>
- **Submitted**: 2026-06-15 01:30:42
- **Topic Keywords**: query, rag, rank
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on Large Language Model (LLM) fingerprint spoofing risks. While it involves black-box methods, the context is not relevant to the user's core research themes of query understanding, ranking models, or user behavior modeling.
...
### 29. Focus When Necessary: Adaptive Routing and Collaborative Grounding for Training-Free Visual Grounding

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Yifan Wang, Peiming Li, Shiyu Li, Zhiyuan Hu, Xiaochen Yang, Wenming Yang, Yang Tang, Zheng Wei
- **URL**: <http://arxiv.org/abs/2606.16158v1>
- **Submitted**: 2026-06-15 03:17:44
- **Topic Keywords**: queries, rag
- **Reason**: This paper focuses on visual grounding and multimodal large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of query understanding and real-time relevance optimization, the context is primarily visual and not text-based, making it somewhat tangential to your main areas of focus.
...
### 30. Selection Without Signal, Recovery Through Expression: A Measurement Study of Post-Hoc Falsification Operators for Frozen Small Code Models

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Mehmet Iscan
- **URL**: <http://arxiv.org/abs/2606.16999v1>
- **Submitted**: 2026-06-15 17:36:23
- **Comment**: 33 pages, 4 figures, 8 tables
- **Topic Keywords**: rag, acl
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The paper focuses on post-hoc falsification operators for frozen small code models, which is outside your areas of expertise and interest.
...
### 31. LectūraAgents: A Multi-Agent Framework for Adaptive Personalized AI-Assisted Learning and Embodied Teaching

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jaward Sesay, Yue Yu, Siwei Dong, Yemin Shi, Guangyao Chen, Börje F. Karlsson
- **URL**: <http://arxiv.org/abs/2606.16428v1>
- **Submitted**: 2026-06-15 09:03:12
- **Topic Keywords**: rag, personalization, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves AI-assisted learning and adaptive systems, the focus is on educational agents and personalized learning, which is outside your primary areas of interest.
...
- **Submitted**: 2026-06-15 02:57:19
- **Topic Keywords**: rag, ctr
- **Reason**: This paper appears to be focused on verifiable reasoning in small language models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on model development and performance, the context and goals of the research are distinct from your areas of interest.
...
### 33. OpenClaw-Skill: Collective Skill Tree Search for Agentic Large Language Models
...
- **Submitted**: 2026-06-15 14:20:50
- **Comment**: 13 pages, 2 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on developing skills for Large Language Models, which is not directly related to Information Retrieval or Search technologies. While it involves complex tasks and real-world systems, the primary goal is to enhance LLMs, which is outside the user's core research themes.
...
### 34. Islamic Large Language Models: From Knowledge Acquisition to Trustworthy and Hallucination-Resistant AI

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Mohammed Amine Mouhoub
- **URL**: <http://arxiv.org/abs/2606.16629v1>
- **Submitted**: 2026-06-15 12:22:36
- **Topic Keywords**: retrieval, search
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on Arabic-centric LLMs and retrieval-augmented generation, its primary focus is on Islamic AI and trustworthy AI systems, which is not a central match for the user's interests.
...
### 35. HiMPO: Hindsight-Informed Memory Policy Optimization for Less-Entangled Credit in Long-Horizon Agents
...
- **Submitted**: 2026-06-15 06:49:18
- **Comment**: Preprint. 2 figures
- **Topic Keywords**: relevance
- **Reason**: This paper appears to be off-topic as it focuses on memory policy optimization for long-horizon agents in the context of reinforcement learning, which is unrelated to information retrieval, search technologies, and natural language processing, which are the primary areas of interest.
...
### 36. LESS Is More: Mutual-Stability Sampling for Diffusion Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Amr Mohamed, Guokan Shang, Michalis Vazirgiannis
- **URL**: <http://arxiv.org/abs/2606.16908v1>
- **Submitted**: 2026-06-15 16:15:45
- **Topic Keywords**: rag
...
### 37. Compositional Reasoning Depth Predicts Clinical AI Failure: Empirical Evidence Consistent with Transformer Compositionality Limits in Electronic Health Record Question Answering

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sanjay Basu
- **URL**: <http://arxiv.org/abs/2606.16890v1>
- **Submitted**: 2026-06-15 16:00:27
- **Comment**: 20 pages, 5 figures. Code: https://github.com/sanjaybasu/compositional-depth-clinical-ehr
- **Topic Keywords**: ctr
- **Reason**: This paper is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models and question answering, its focus is on clinical AI failure and compositional reasoning depth, which is not a central match for the user's research themes.
...
### 38. Understanding Scam Trends and Rail Paths from Reddit Self-Disclosure Narratives

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yangjun Zhang, Mirko Bottarelli, Mark Hooper, Carsten Maple
- **URL**: <http://arxiv.org/abs/2606.16874v1>
- **Submitted**: 2026-06-15 15:50:07
- **Comment**: 6 pages, International Conference on AI and the Digital Economy (CADE) 2026
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on analyzing scam trends and rail paths from Reddit self-disclosure narratives, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve text analysis, the context and application are quite different from your areas of expertise.
...
### 39. Follow the Latent Roadmap: Navigating Revocable Decoding for Diffusion LLMs with Anchor Tokens
...
- **Submitted**: 2026-06-15 15:23:47
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on improving the performance of Diffusion Large Language Models (dLLMs) through a novel decoding framework. While it touches on the concept of 'generation' which is related to query understanding in IR, the paper's primary focus is on NLP and deep learning techniques, making it only loosely relevant to your research interests.
...
### 40. Connecting Speech to Words through Images

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Gabriel Pirlogeanu, Dan Oneata, Horia Cucu, Herman Kamper
- **URL**: <http://arxiv.org/abs/2606.16807v1>
- **Submitted**: 2026-06-15 14:50:42
- **Comment**: Accepted at EUSIPCO 2026 - 5 pages, 3 figures, 2 tables
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on visually grounded methods for building a vocabulary of spoken words, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and approach are not aligned with your interests in query understanding, ranking models, and user behavior modeling.
...
### 41. Multi-Turn Reflective Masking Elicits Reasoning in Mask Diffusion Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yanming Zhang, Yihan Bian, Jingyuan Qi, Yuguang Yao, Lifu Huang, Tianyi Zhou
- **URL**: <http://arxiv.org/abs/2606.16700v1>
- **Submitted**: 2026-06-15 13:34:38
- **Comment**: 22 pages, 6 figures, 5 tables
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Mask Diffusion Models and proposes a method called Reflective Masking to elicit reasoning capabilities in these models. While it touches on the concept of iterative refinement, which is related to user behavior modeling, the paper's primary focus is on NLP and deep learning, making it only loosely relevant to your research interests in Information Retrieval and Search technologies.
...
### 42. FraudSMSWalker: Benchmarking Agentic Large Language Models for SMS-to-Webpage Fraud Detection
...
- **Submitted**: 2026-06-15 12:53:55
- **Topic Keywords**: user action
- **Reason**: This paper focuses on SMS-to-webpage fraud detection using large language models, which is unrelated to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some aspects of query understanding and ranking models, the context is specific to fraud detection and does not align with the user's primary interests.
...
- **URL**: <http://arxiv.org/abs/2606.16583v1>
- **Submitted**: 2026-06-15 11:27:11
- **Comment**: 17 pages, 4 figures
- **Topic Keywords**: rag
- **Reason**: This paper focuses on clinical vision-language models and uncertainty estimation in visual question-answering, which is outside the primary scope of information retrieval and search technologies. While it touches on model reliability and calibration, it doesn't directly relate to query understanding, ranking models, or user behavior modeling, making it less relevant to your research interests.
...
### 44. DoubtProbe: Black-Box Jailbreak Defense via Structural Verification and Semantic Auditing

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Xuanyu Yin, Yilin Jiang, Jun Zhou, Kai Chen, Zhengfu Cao, Xiaolei Dong
- **URL**: <http://arxiv.org/abs/2606.16527v1>
- **Submitted**: 2026-06-15 10:30:29
- **Comment**: 25 pages, 5 figures
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or user behavior modeling, which are core areas of your research interests. While it touches on Natural Language Processing (NLP) and deep semantic understanding, the focus is on black-box jailbreak defense in large language models, which is not a central match for your research themes.
...
### 45. From Awareness to Adherence: Bridging the Context Gap in Spoken Dialogue Systems via Context-Aware Decoding

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Che Hyun Lee, Heeseung Kim, Sungroh Yoon
- **URL**: <http://arxiv.org/abs/2606.16472v1>
- **Submitted**: 2026-06-15 09:37:11
- **Comment**: Interspeech 2026 Main Track
- **Topic Keywords**: rag
- **Reason**: This paper focuses on spoken dialogue systems and context-aware decoding, which is not directly related to your primary research interests in Information Retrieval and Search technologies. Although it involves some NLP aspects, the context is quite different from your usual areas of exploration.
...
### 46. Surpassing Scale by Efficiency: A Compact 135M Parameter Foundational LLM Natively Adapted for the Bangla Language

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Rabindra Nath Nandi
- **URL**: <http://arxiv.org/abs/2606.16383v1>
- **Submitted**: 2026-06-15 08:16:52
- **Comment**: Submitted to a Workshop
- **Topic Keywords**: rag
- **Reason**: This paper focuses on developing a foundational LLM for the Bangla language, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context is specific to language modeling and low-resource languages, which does not align with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 47. Who Should Lead Decoding Now? Tracking Reliable Trajectories for Ensembling Masked Diffusion Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Heecheol Yun, Joonhyung Park, Joowon Kim, Eunho Yang
- **URL**: <http://arxiv.org/abs/2606.16281v1>
- **Submitted**: 2026-06-15 06:39:31
- **Comment**: preprint
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on masked diffusion language models and their ensembling, which is outside your primary focus on information retrieval, especially in areas that require deep semantic understanding and real-time relevance optimization.
...
### 48. daVinci-kernel: Co-Evolving Skill Selection, Summarization, and Utilization via RL for GPU Kernel Optimization
...
- **Submitted**: 2026-06-15 09:58:21
- **Topic Keywords**: ranking, rerank, rank
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The topic of GPU kernel optimization and reinforcement learning is not aligned with your areas of focus.
...
### 49. Rapid Poison: Practical Poisoning Attacks Against the Rapid Response Framework

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: David Huang, Jaewon Chang, Avidan Shah, Prateek Mittal, Chawin Sitawarin
- **URL**: <http://arxiv.org/abs/2606.16242v1>
- **Submitted**: 2026-06-15 05:40:50
- **Comment**: Spotlight at ICML 2026
- **Topic Keywords**: ltr
- **Reason**: This paper focuses on a specific security threat model in the context of the Rapid Response framework, which is unrelated to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 50. Sycophancy as Material Failure under Pushback Loading: A Multi-Axis Characterization Across Three Loading Cases and up to Seventeen Material Charges

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Ferdinand M. Schessl
- **URL**: <http://arxiv.org/abs/2606.16617v1>
- **Submitted**: 2026-06-15 12:11:19
- **Comment**: 12 pages, 3 figures. Code, data, and pre-registrations: https://github.com/FerdinandSchessl/sycophancy-note-companion
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, or other areas of interest. It discusses a materials-science framing of conversation as test specimen under load, which is outside the scope of the user's research interests.
