...
- **Submitted**: 2026-07-08 15:46:48
- **Comment**: 21pages
- **Topic Keywords**: queries, retrieval, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The focus on hierarchical search agents and their capacity distribution aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific application to multi-hop QA benchmarks and large language models is somewhat outside your primary focus on e-commerce, but still clearly related.
...
### 2. Interpretable Uncertainty for Adaptive Retrieval and Reasoning in Question Answering

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Ritajit Dey, Iadh Ounis, Graham McDonald
- **URL**: <http://arxiv.org/abs/2607.07380v1>
- **Submitted**: 2026-07-08 13:12:39
- **Comment**: 2 pages, 1 figure
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper explores uncertainty-aware frameworks for question answering, which is related to query understanding and ranking models in Information Retrieval. Although the focus is on question answering and retrieval-augmented generation, the emphasis on transparency and interpretability aligns with the user's interests in deep semantic understanding and real-time relevance optimization.
...
- **Submitted**: 2026-07-08 14:43:00
- **Comment**: 16 pages, 2 figures, 7 tables
- **Topic Keywords**: query, rag, ctr
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), but it primarily focuses on improving transformer attention through spectral preprocessing, which is not directly related to your core themes of query understanding, ranking models, or user behavior modeling.
...
- **Submitted**: 2026-07-08 17:59:45
- **Comment**: preprint
- **Topic Keywords**: query, queries
- **Reason**: This paper introduces a novel approach to language models, focusing on knowledge retrieval and control. While it touches on aspects of query understanding and knowledge representation, its primary focus is on improving language model performance through knowledge externalization, rather than directly addressing ranking models or user behavior modeling. The paper's relevance to information retrieval is somewhat tangential, as it primarily deals with language model architecture and performance.
...
- **Submitted**: 2026-07-08 13:49:44
- **Comment**: Under Review at TKDE
- **Topic Keywords**: query, queries
- **Reason**: This paper focuses on query answering on Knowledge Graphs using a novel inductive embedding method, InductWave. While it touches on query understanding and reasoning, it's more aligned with Knowledge Graphs and NLP, rather than traditional Information Retrieval or Search technologies. The paper's emphasis on scalability and efficiency is also relevant, but not directly connected to the user's primary research interests.
...
### 6. Evaluating RAG Metrics in Applied Contexts: An Experiment, Its Findings and Its Limitations

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Quentin Brabant
- **URL**: <http://arxiv.org/abs/2607.07302v1>
- **Submitted**: 2026-07-08 11:44:28
- **Topic Keywords**: relevance, rag, search
- **Reason**: This paper evaluates RAG metrics in a question-answering dataset, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on RAG metrics and their evaluation is not directly aligned with the user's primary research themes, and the abstract does not mention any real-time relevance optimization or deep semantic understanding.
...
### 7. Seeing and Reflecting: Multimodal Memory-Enhanced Agent Collaboration for Recommendation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Hao Cong, Huizu Lin, Zihan Wang, Chengkai Huang, Quan Z. Sheng, Lina Yao
- **URL**: <http://arxiv.org/abs/2607.07108v1>
- **Submitted**: 2026-07-08 07:50:03
- **Topic Keywords**: ranking, recommend, rank
- **Reason**: The paper focuses on multimodal memory-enhanced agent collaboration for recommendation, which is somewhat related to information retrieval and search technologies. However, the primary focus on recommender systems and multimodal matching is not a central match to the user's core research themes in query understanding, ranking models, and user behavior modeling. The connection to natural language processing and data mining is also present, but not strong enough to elevate the score.
...
- **Submitted**: 2026-07-08 17:24:43
- **Comment**: 23 pages, 6 figures and 7 tables
- **Topic Keywords**: ctr
- **Reason**: This paper explores the activation patterns of large language models to understand entity familiarity and factual reliability, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on entity familiarity and factual reliability in NLP models is not directly aligned with the user's primary research interests in IR and search technologies. The paper's findings on model behavior and internal awareness are interesting but not directly applicable to the user's core research themes.
...
### 9. Unveiling Public Opinion: A Study of Sentiment Analysis Using LSTM and Traditional Models

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Atiq Ur Rehman
- **URL**: <http://arxiv.org/abs/2607.07772v1>
- **Submitted**: 2026-07-08 16:32:39
...
- **Topic Keywords**: rag
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and sentiment analysis, but it does not directly align with the user's primary focus on Information Retrieval, especially query understanding, ranking models, and user behavior modeling. The paper's focus on sentiment analysis and machine learning models is relevant, but it is not a central match for the user's research interests.
...
### 10. SynthAVE: Scalable Synthetic Labeling for E-Commerce with LLM-Arena Validation
...
- **Submitted**: 2026-07-08 14:32:28
- **Topic Keywords**: commerce, e-commerce
- **Reason**: The paper focuses on synthetic labeling for e-commerce attribute extraction using large language models, which is somewhat related to information retrieval and search technologies. However, the primary focus on e-commerce and attribute extraction is not a central match to the user's core research themes. The use of LLMs and validation mechanisms is somewhat relevant to the user's interests in NLP and data mining.
...
### 11. Comprehensive Evaluation of Large Language Model Responses: A Multi-Factor Scoring System

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yiming Gai, Junde Lu, Xuefei Huang
- **URL**: <http://arxiv.org/abs/2607.06940v1>
- **Submitted**: 2026-07-08 03:10:33
- **Topic Keywords**: ctr
- **Reason**: The paper discusses the evaluation of large language models, which is somewhat related to information retrieval, particularly in the context of query understanding and ranking models. However, the focus on language models and their evaluation metrics is not directly aligned with the user's primary research interests in IR and search technologies. The paper's relevance is somewhat enhanced by its mention of a multifactor scoring paradigm, which could be applicable to other areas of IR, but it does not directly address the user's core research themes.
...
### 12. Ad Headline Generation using Self-Critical Masked Language Model

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yashal Shakti Kanungo, Sumit Negi, Aruna Rajan
- **URL**: <http://arxiv.org/abs/2607.06818v1>
- **Submitted**: 2026-07-07 21:25:49
...
- **Topic Keywords**: commerce, e-commerce
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of e-commerce. However, it focuses on ad headline generation using NLP techniques, which is not directly aligned with your core interests in query understanding, ranking models, and user behavior modeling.
...
### 13. When and How to Ask: Dynamic Preference Elicitation Strategies for Conversational Recommendation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Feng Xia, Shuo Zhang, Xi Wang
- **URL**: <http://arxiv.org/abs/2607.06765v1>
- **Submitted**: 2026-07-07 19:54:00
- **Comment**: Accepted at SIGIR 2026
- **Topic Keywords**: recommend
- **Reason**: This paper explores conversational recommendation systems, which is related to information retrieval and search technologies. However, its focus on preference elicitation strategies and dialogue stages is more aligned with recommender systems, which is a secondary interest of yours. The paper's use of natural language processing and dialogue analysis is relevant, but it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of your research.
...
### 14. When Does In-Context Search Help? A Sampling-Complexity Theory of Reflection-Driven Reasoning

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Yotam Wolf, Noam Wies, Amnon Shashua
- **URL**: <http://arxiv.org/abs/2607.06720v1>
- **Submitted**: 2026-07-07 18:36:04
- **Topic Keywords**: search
- **Reason**: The paper explores in-context search, a concept related to information retrieval, but its focus on large language models and reasoning traces is somewhat tangential to the user's core interests in query understanding, ranking models, and user behavior modeling. While it touches on aspects of search and optimization, the paper's emphasis on theoretical analysis and sampling complexity theory makes it less directly relevant to the user's research themes.
...
- **Submitted**: 2026-07-08 03:51:37
- **Topic Keywords**: rerank, retrieval, rank
- **Reason**: This paper focuses on improving large language models (LLMs) through memory-based methods, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves learning and optimization, the context is not aligned with the user's core research themes.
...
- **Submitted**: 2026-07-08 13:19:52
- **Comment**: 13 pages, 2 figures
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on improving the performance of Large Language Models by integrating static phrase memory, which is not directly related to Information Retrieval, Search technologies, or user behavior modeling. While it involves NLP, the context is more about model optimization and scalability rather than query understanding, ranking models, or recommender systems.
...
- **Submitted**: 2026-07-08 17:59:59
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on a multimodal scientific foundation model for native structural reasoning in biology, chemistry, and materials science. While it involves AI and representation, the context and application are quite different from the user's core research themes.
...
### 18. Future Confidence Distillation in Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Sahil Kale
- **URL**: <http://arxiv.org/abs/2607.07626v1>
- **Submitted**: 2026-07-08 16:43:11
- **Comment**: 16 pages, 5 figures
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on confidence estimation in large language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the topic of retrieval, the context is not aligned with your focus on query understanding, ranking models, and user behavior modeling.
...
### 20. DeLS-Spec: Decoupled Long-Short Contexts for Parallel Speculative Drafting

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Hong-Kai Zheng, Piji Li
- **URL**: <http://arxiv.org/abs/2607.07409v1>
- **Submitted**: 2026-07-08 13:41:52
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on speculative decoding for LLM inference, which is not directly related to Information Retrieval, Search technologies, or Natural Language Processing. Although it involves deep learning models, the context is not aligned with your core research themes.
...
- **Submitted**: 2026-07-08 06:26:13
- **Comment**: 17 pages including appendix, 6 figures
- **Topic Keywords**: rag
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and language model training strategies, but it does not align with the user's primary focus on Information Retrieval (IR), query understanding, ranking models, or user behavior modeling. The paper's focus on tool-use and behavior shift in language models is somewhat tangential to the user's interests.
...
### 22. Large Language Models (LLMs) and Generative AI in Cybersecurity and Privacy: A Survey of Dual-Use Risks, AI-Generated Malware, Explainability, and Defensive Strategies

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Kiarash Ahi, Saeed Valizadeh
- **URL**: <http://arxiv.org/abs/2607.06963v1>
- **Submitted**: 2026-07-08 03:40:26
- **Comment**: Invited survey paper. 10 pages, 5 figures, 2 tables
- **Topic Keywords**: recommend, search
- **Reason**: This paper is primarily focused on the application of Large Language Models (LLMs) in cybersecurity, which is not a central match to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on AI-driven anomaly detection, the context is not related to your core themes of query understanding, ranking models, user behavior modeling, or real-time relevance optimization.
...
### 23. Geometric Self-Distillation for Reasoning Generalization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Josip Jukić, Ivan Titov
- **URL**: <http://arxiv.org/abs/2607.06855v1>
- **Submitted**: 2026-07-07 23:16:19
- **Topic Keywords**: rag
- **Reason**: This paper focuses on geometric self-distillation for large language models, which is not directly related to information retrieval, search technologies, or user behavior modeling. While it involves deep semantic understanding, the context is not aligned with the user's primary research interests in IR and NLP.
...
### 24. From Solvers to Research: Large Language Model-Driven Formal Mathematics at the Research Frontier
...
- **Submitted**: 2026-07-08 17:46:36
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on AI for Mathematics and formal proof generation, which is outside your primary areas of interest.
...
### 25. From Atomic Actions to Standard Operating Procedures: Iterative Tool Optimization for Self-Evolving LLM Agents

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Haipeng Ding, Yuexiang Xie, Zhewei Wei, Yaliang Li, Bolin Ding
- **URL**: <http://arxiv.org/abs/2607.07321v1>
- **Submitted**: 2026-07-08 12:09:49
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are the core areas of your research interests. While it touches on the concept of optimization, it is focused on Large Language Model agents and tool utilization, which is outside your primary focus.
...
### 26. Multimodal Voice Activity Projection for Turn-Taking in Social Robots with Voice-Activity-Related Pretrained Encoders

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Antonio Cano, Guillermo Pérez, Luis Merino, Randy Gomez
- **URL**: <http://arxiv.org/abs/2607.07294v1>
- **Submitted**: 2026-07-08 11:34:00
...
- **Topic Keywords**: rank
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves multimodal inputs and turn-taking prediction, the focus is on social robots and human-robot interaction, which is not a central theme in your research background.
...
- **URL**: <http://arxiv.org/abs/2607.07159v1>
- **Submitted**: 2026-07-08 08:51:27
- **Topic Keywords**: search
- **Reason**: This paper appears to be focused on factor analysis and model selection in the context of exploratory factor analysis, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 28. A Word-Level Digital Reader of the Prasthanatrayi with Sankara's Bhasya: Corpus, Method, and an Open, Offline Reading Aid for the Advaita Vedanta Canon

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Tamal Maharaj
- **URL**: <http://arxiv.org/abs/2607.07282v1>
- **Submitted**: 2026-07-08 11:19:59
- **Topic Keywords**: click, search
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on creating a digital reader for an ancient Indian text and its commentary, with a focus on morphological analysis and lemmatization.
...
### 29. Granularity in Action: Graphing sources for social history

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Sofus Landor Dam, Johan Heinsen
- **URL**: <http://arxiv.org/abs/2607.07183v1>
- **Submitted**: 2026-07-08 09:16:09
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on social history and historical sources does not align with your background in e-commerce or interests in query understanding, ranking models, and user behavior modeling.
