...
- **URL**: <http://arxiv.org/abs/2603.29247v1>
- **Submitted**: 2026-03-31 04:16:18
- **Topic Keywords**: query, ranking, rerank, relevance, personalization, shopping, commerce, e-commerce, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of e-commerce and personalized product reranking. The use of preference memory and reinforcement learning for reranking is a key aspect of the work, which aligns with your focus on query understanding and ranking models. However, the paper's primary focus on e-commerce and recommender systems is a slight deviation from your broader interests in IR and NLP.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Memory‑based two‑stage personalized product reranking
- **Aim**: Compress users’ long‑term shopping preferences into reusable, query‑independent memory blocks and use them to score candidate products, thereby improving reranking accuracy over raw history or naïve augmentation.
- **Rationale**: Raw purchase histories are noisy and high‑dimensional; extracting atomic preference facts (brand loyalty, price sensitivity, feature preferences) via prompt‑driven, RL‑fine‑tuned extraction yields a focused, stable signal that can be reused across queries and categories. Prompt design and explicit reasoning (“think” tags) further ground the model’s decisions.
- **Ground**: Stage 1: Memory Extraction – prompt processes each purchase item, extracts up to three JSON facts, consolidates into within‑category memory, optionally aggregates into cross‑category memory. Stage 2: Reranking – prompt receives query, candidate list, and memories; verifies relevance, scores candidates by alignment with within‑memory, uses cross‑memory to break ties, outputs best product with optional <think> explanation. Prompt hierarchy (A.1–A.5) supports each stage.
- **Experiment**: Empirical results on Electronics: 1‑in‑5 offline reranking. Findings: (1) Extracted memory outperforms raw history, raw product‑context, and external memory baselines. (2) RL‑trained extractor beats rule‑based and GPT‑5.2 extraction. (3) Semi‑structured, evidence‑grounded prompts outperform rigid or unconstrained prompts. (4) Adding <think> tags yields additional gains. (5) Strong rerankers (e.g., o4‑mini) benefit more from explicit memory; weaker rerankers (GPT‑4.1‑mini) are more sensitive to noise. Limitations: domain‑specific (Electronics only), only 1‑in‑5 reranking explored.
- **Takeaway**: A prompt‑driven, RL‑refined memory extraction pipeline, combined with explicit reasoning cues, substantially boosts personalized product reranking over raw history approaches. Key insights: prompt engineering, memory granularity, and reranker strength are critical; the framework is promising for broader domains and larger retrieval scales.
...
### 2. On Strengths and Limitations of Single-Vector Embeddings

- **LLM Score**: 8
- **Keyword Score**: 5
- **Authors**: Archish S, Mihir Agarwal, Ankit Garg, Neeraj Kayal, Kirankumar Shiragur
- **URL**: <http://arxiv.org/abs/2603.29519v1>
- **Submitted**: 2026-03-31 10:04:54
- **Topic Keywords**: relevance, retrieval
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. The authors investigate the limitations of single-vector embeddings, which is a crucial aspect of your work on Learning to Rank and real-time relevance optimization. While the focus is on NLP and embeddings, the implications for IR and search technologies are significant.
...
### 3. GISTBench: Evaluating LLM User Understanding via Evidence-Based Interest Verification
...
- **URL**: <http://arxiv.org/abs/2603.29112v1>
- **Submitted**: 2026-03-31 01:01:56
- **Comment**: 9 figures, 20 tables; code at https://github.com/facebookresearch/GISTBench
- **Topic Keywords**: rag, recommend, recsys
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of query understanding and user behavior modeling. The focus on Large Language Models' ability to understand users and their interests aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific domain of recommendation systems and LLMs is not a central match to your primary focus on IR, but it is still a clearly related area.
...
- **URL**: <http://arxiv.org/abs/2603.29259v1>
- **Submitted**: 2026-03-31 04:49:32
- **Topic Keywords**: ranking, pairwise, recommend, rank
- **Reason**: The paper focuses on recommender systems and multimodal sequential recommendations, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the emphasis on recommender systems and the use of sparse MoE encoder is not a central match for the user's primary focus on query understanding, ranking models, and user behavior modeling.
...
### 5. Calibrated Fusion for Heterogeneous Graph-Vector Retrieval in Multi-Hop QA

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Andre Bacellar
- **URL**: <http://arxiv.org/abs/2603.28886v1>
- **Submitted**: 2026-03-30 18:13:01
- **Comment**: 10 pages, 5 figures
- **Topic Keywords**: relevance, rag, retrieval, rank
- **Reason**: The paper focuses on multi-hop question answering and graph-vector retrieval, which is somewhat related to information retrieval and search technologies. However, the specific context of question answering and graph-based retrieval does not directly align with the user's core research themes of query understanding, ranking models, and user behavior modeling. The paper's emphasis on score calibration and fusion is also somewhat tangential to the user's interests in deep semantic understanding and real-time relevance optimization.
...
### 6. Zero-shot Cross-domain Knowledge Distillation: A Case study on YouTube Music
...
- **URL**: <http://arxiv.org/abs/2603.28994v1>
- **Submitted**: 2026-03-30 20:47:58
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: The paper explores knowledge distillation in recommender systems, which is somewhat related to the user's interests in information retrieval and search technologies. However, the focus on recommender systems and the specific case study on YouTube Music is not a central match to the user's primary research themes. The paper's emphasis on deep semantic understanding and real-time relevance optimization is not directly addressed.
...
### 7. Convergent Representations of Linguistic Constructions in Human and Artificial Neural Systems

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Pegah Ramezani, Thomas Kinfe, Andreas Maier, Achim Schilling, Patrick Krauss
- **URL**: <http://arxiv.org/abs/2603.29617v1>
- **Submitted**: 2026-03-31 11:37:50
- **Topic Keywords**: pairwise, ctr
- **Reason**: This paper explores the neural processing of linguistic constructions, which is related to query understanding and ranking models in Information Retrieval. However, the focus on cognitive neuroscience and linguistics is somewhat distant from the user's primary interests in IR and NLP. The connection to machine learning classification and neural signatures is a weak link to the user's background in e-commerce and recommender systems.
...
### 8. Structural Feature Engineering for Generative Engine Optimization: How Content Structure Shapes Citation Behavior

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Junwei Yu, Mufeng Yang, Yepeng Ding, Hiroyuki Sato
- **URL**: <http://arxiv.org/abs/2603.29979v1>
- **Submitted**: 2026-03-31 16:41:43
...
- **Reason**: While the paper touches on search technologies and information retrieval, its primary focus on generative engine optimization and citation behavior is somewhat related to the user's interests in query understanding and ranking models. However, the paper's emphasis on structural feature engineering and content structure is not a central match for the user's research themes. The paper's relevance is somewhat limited to the user's background in e-commerce and experience with recommender systems.
...
### 9. Agenda-based Narrative Extraction: Steering Pathfinding Algorithms with Large Language Models
...
- **URL**: <http://arxiv.org/abs/2603.29661v1>
- **Submitted**: 2026-03-31 12:22:41
- **Comment**: Text2Story Workshop 2026 at ECIR 2026
- **Topic Keywords**: rag, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it involves the use of large language models for ranking and narrative extraction. However, the focus on agenda-based narrative extraction and its applications in storytelling is not directly aligned with your primary research themes in query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2603.29557v1>
- **Submitted**: 2026-03-31 10:37:47
- **Comment**: 30 pages, 11 figures, 15 tables
- **Topic Keywords**: retrieval, search
- **Reason**: The paper explores a novel approach to scientific idea generation, leveraging literature exploration and idea generation as a co-evolving process. While it touches on retrieval and generation aspects, its primary focus is on idea generation and scientific research, which is somewhat related to information retrieval but not a central match to your interests. The use of flow-guided literature exploration and generative reward models is an interesting application of NLP and data mining techniques.
...
### 11. Impact of enriched meaning representations for language generation in dialogue tasks: A comprehensive exploration of the relevance of tasks, corpora and metrics

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Alain Vázquez, Maria Inés Torres
- **URL**: <http://arxiv.org/abs/2603.29518v1>
- **Submitted**: 2026-03-31 10:03:56
- **Topic Keywords**: relevance
- **Reason**: The paper explores Natural Language Generation (NLG) in dialogue tasks, which is related to your interests in NLP. However, the focus on NLG and dialogue systems is not directly aligned with your primary research themes in Information Retrieval and Search technologies. The paper's emphasis on semantic understanding and metrics is somewhat relevant, but it does not strongly connect to your interests in query understanding, ranking models, or user behavior modeling.
...
### 12. OptiMer: Optimal Distribution Vector Merging Is Better than Data Mixing for Continual Pre-Training

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Haiyue Song, Masao Utiyama
- **URL**: <http://arxiv.org/abs/2603.28858v1>
- **Submitted**: 2026-03-30 18:00:02
- **Comment**: Preprint, 20 pages, 10 tables, 12 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper proposes a method for continual pre-training of large language models, focusing on optimizing the distribution of training data. While it touches on aspects of model adaptation and optimization, it doesn't directly relate to query understanding, ranking models, or user behavior modeling in information retrieval, which are core areas of interest. The paper's relevance is somewhat tangential to the user's primary research themes.
...
### 13. ContextClaim: A Context-Driven Paradigm for Verifiable Claim Detection

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yufeng Li, Rrubaa Panchendrarajan, Arkaitz Zubiaga
- **URL**: <http://arxiv.org/abs/2603.30025v1>
- **Submitted**: 2026-03-31 17:20:46
- **Topic Keywords**: retrieval
- **Reason**: The paper discusses verifiable claim detection, a topic somewhat related to information retrieval, but it focuses on a specific aspect of fact-checking rather than query understanding, ranking models, or user behavior modeling. While it involves natural language processing and retrieval, its primary goal is not to improve search technologies or optimize relevance. The paper's emphasis on structured knowledge sources and large language models is relevant to NLP, but not directly applicable to the user's core research themes.
...
### 14. Training-Free Dynamic Upcycling of Expert Language Models

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Eros Fanì, Oğuzhan Ersoy
- **URL**: <http://arxiv.org/abs/2603.29765v1>
- **Submitted**: 2026-03-31 14:05:10
- **Comment**: Accepted at the ICLR 2026 Workshop on Scaling Post-training for LLMs
- **Topic Keywords**: rag
- **Reason**: This paper introduces a novel approach to combining the expertise of dense models within a Mixture of Experts (MoE) architecture, but its focus on language models and expertise finetuning doesn't directly align with your primary research interests in Information Retrieval and Search technologies. While it touches on related topics like query understanding and ranking models, the paper's primary contributions and applications are in the NLP domain, making it somewhat relevant but not a central match for your research interests.
...
### 15. Xuanwu: Evolving General Multimodal Models into an Industrial-Grade Foundation for Content Ecosystems

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Zhiqian Zhang, Xu Zhao, Xiaoqing Xu, Guangdong Liang, Weijia Wang, Xiaolei Lv, Bo Li, Jun Gao
- **URL**: <http://arxiv.org/abs/2603.29211v1>
- **Submitted**: 2026-03-31 03:27:49
- **Comment**: 41 pages, 10 figures
- **Topic Keywords**: rag
- **Reason**: The paper presents a multimodal model for content ecosystems, focusing on fine-grained visual perception and language-semantic alignment. While it touches on some aspects of information retrieval, such as multimodal metrics and business moderation tasks, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's focus on industrial-grade foundations for content ecosystems also diverges from the user's primary focus on information retrieval and real-time relevance optimization.
...
### 16. Drift-Aware Continual Tokenization for Generative Recommendation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Yuebo Feng, Jiahao Liu, Mingzhe Han, Dongsheng Li, Hansu Gu, Peng Zhang, Tun Lu, Ning Gu
- **URL**: <http://arxiv.org/abs/2603.29705v1>
- **Submitted**: 2026-03-31 13:02:47
- **Topic Keywords**: recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, particularly in the context of recommender systems. However, it focuses on Generative Recommendation and tokenization, which is not a central match to your primary focus on query understanding, ranking models, and user behavior modeling. The paper's emphasis on collaborative signals and drift-aware continual tokenization is also somewhat tangential to your interests.
...
- **URL**: <http://arxiv.org/abs/2603.29123v1>
- **Submitted**: 2026-03-31 01:20:03
- **Topic Keywords**: search
- **Reason**: This paper explores concept-level objectives for language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on language modeling and semantic alignment is not directly aligned with the user's primary research interests in IR and search technologies. The paper's relevance is limited to the user's secondary interest in NLP.
...
### 18. Known Intents, New Combinations: Clause-Factorized Decoding for Compositional Multi-Intent Detection

- **LLM Score**: 3
- **Keyword Score**: 1
- **Authors**: Abhilash Nandy
- **URL**: <http://arxiv.org/abs/2603.28929v1>
- **Submitted**: 2026-03-30 19:06:54
- **Comment**: 6 pages, 3 tables
- **Topic Keywords**: nips
- **Reason**: This paper focuses on multi-intent detection and compositional generalization in natural language processing, which is somewhat related to the user's interests in query understanding and ranking models. However, the paper's primary focus on multi-intent detection and its evaluation metrics do not directly align with the user's core research themes in information retrieval and search technologies.
...
### 19. APEX-EM: Non-Parametric Online Learning for Autonomous Agents via Structured Procedural-Episodic Experience Replay

- **LLM Score**: 2
- **Keyword Score**: 11
- **Authors**: Pratyay Banerjee, Masud Moshtaghi, Ankit Chadha
- **URL**: <http://arxiv.org/abs/2603.29093v1>
- **Submitted**: 2026-03-31 00:24:56
- **Comment**: 17 pages, 13 figures
- **Topic Keywords**: semantic search, queries, retrieval, search, acl
- **Reason**: This paper focuses on non-parametric online learning for autonomous agents, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves structured experience representation and retrieval, the context is more aligned with artificial intelligence and machine learning, rather than the user's specific interests in query understanding, ranking models, and user behavior modeling.
...
### 20. SiPaKosa: A Comprehensive Corpus of Canonical and Classical Buddhist Texts in Sinhala and Pali

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Ranidu Gurusinghe, Nevidu Jayatilleke
- **URL**: <http://arxiv.org/abs/2603.29221v1>
- **Submitted**: 2026-03-31 03:36:46
...
- **Reason**: This paper appears to be primarily focused on creating a Buddhist text corpus, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it mentions the development of information retrieval systems, the context is specific to Buddhist scholarship and cultural heritage, making it only loosely relevant to the user's interests.
...
### 21. Kwame 2.0: Human-in-the-Loop Generative AI Teaching Assistant for Large Scale Online Coding Education in Africa

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: George Boateng, Samuel Boateng, Victor Kumbol
- **URL**: <http://arxiv.org/abs/2603.29159v1>
- **Submitted**: 2026-03-31 02:19:28
...
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves retrieval-augmented generation, the context is focused on education and AI teaching assistants, which is not a primary area of interest for the user.
...
### 22. Towards Empowering Consumers through Sentence-level Readability Scoring in German ESG Reports

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Benjamin Josef Schüßler, Jakob Prange
- **URL**: <http://arxiv.org/abs/2603.29861v1>
- **Submitted**: 2026-03-31 15:19:02
- **Comment**: accepted to NLP4Ecology workshop at LREC 2026
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves readability scoring and transformer models, the context is specific to ESG reports and German language, which does not align with your primary focus on e-commerce or general IR applications.
...
- **URL**: <http://arxiv.org/abs/2603.29493v2>
- **Submitted**: 2026-03-31 09:38:21
- **Comment**: 10 pages, Code: https://github.com/Valsure/MemFactory
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on AI agents and memory-augmented models, the focus is on a unified framework for training and inference, which is not a central theme in your research areas.
...
### 24. Storing Less, Finding More: How Novelty Filtering Improves Cross-Modal Retrieval on Edge Cameras

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Sherif Abdelwahab
- **URL**: <http://arxiv.org/abs/2603.29631v1>
- **Submitted**: 2026-03-31 11:54:38
- **Comment**: 6 pages, 3 figures, 5 tables; supplementary video included as ancillary file
- **Topic Keywords**: retrieval, rank, search
- **Reason**: This paper focuses on cross-modal retrieval and edge cameras, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest.
...
### 25. Authorship Impersonation via LLM Prompting does not Evade Authorship Verification Methods

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Baoyi Zeng, Andrea Nini
- **URL**: <http://arxiv.org/abs/2603.29454v1>
- **Submitted**: 2026-03-31 08:59:09
- **Comment**: 11 pages, 3 figures
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on authorship verification and large language model prompting for impersonation. While it involves NLP, the topic is more related to forensic linguistics and security, rather than your core areas of interest.
...
### 26. FLEURS-Kobani: Extending the FLEURS Dataset for Northern Kurdish

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Daban Q. Jaff, Mohammad Mohammadamini
- **URL**: <http://arxiv.org/abs/2603.29892v1>
- **Submitted**: 2026-03-31 15:40:01
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing, as it focuses on speech recognition and translation for the Northern Kurdish language.
...
### 27. Trojan-Speak: Bypassing Constitutional Classifiers with No Jailbreak Tax via Adversarial Finetuning

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Bilgehan Sel, Xuanli He, Alwin Peng, Ming Jin, Jerry Wei
- **URL**: <http://arxiv.org/abs/2603.29038v1>
- **Submitted**: 2026-03-30 22:10:28
- **Topic Keywords**: queries
- **Reason**: This paper appears to be unrelated to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on adversarial fine-tuning and classifier evasion in the context of AI safety and content classification does not align with your areas of expertise.
...
### 28. CrossTrace: A Cross-Domain Dataset of Grounded Scientific Reasoning Traces for Hypothesis Generation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Andrew Bouras, OMS-II Research Fellow
- **URL**: <http://arxiv.org/abs/2603.28924v1>
- **Submitted**: 2026-03-30 18:55:55
- **Comment**: 14 pages, 1 figure, 8 tables. Dataset and code available at https://github.com/andrewbouras/crosstrace
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be unrelated to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the topic of understanding and generating scientific hypotheses, it does not seem to be directly applicable to your areas of focus.
...
### 29. From Consensus to Split Decisions: ABC-Stratified Sentiment in Holocaust Oral Histories

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Daban Q. Jaff
- **URL**: <http://arxiv.org/abs/2603.28913v1>
- **Submitted**: 2026-03-30 18:44:22
- **Topic Keywords**: pairwise
- **Reason**: This paper appears to be primarily focused on sentiment analysis in Holocaust oral histories, using transformer-based polarity classifiers and agreement-based stability taxonomy. While it involves NLP, it does not seem to be directly related to Information Retrieval, Search technologies, or query understanding, which are core areas of your research interests.
...
### 30. ENEIDE: A High Quality Silver Standard Dataset for Named Entity Recognition and Linking in Historical Italian

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Cristian Santini, Sebastian Barzaghi, Paolo Sernani, Emanuele Frontoni, Laura Melosi, Mehwish Alam
- **URL**: <http://arxiv.org/abs/2603.29801v1>
- **Submitted**: 2026-03-31 14:32:34
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Named Entity Recognition and Linking in historical Italian texts, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, it's more specific to entity recognition and linking, and doesn't align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 31. A Comprehensive Information-Decomposition Analysis of Large Vision-Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Lixin Xiu, Xufang Luo, Hideki Nakayama
- **URL**: <http://arxiv.org/abs/2603.29676v1>
- **Submitted**: 2026-03-31 12:32:29
- **Comment**: Accepted at ICLR 2026. Project page: https://riishin.github.io/pid-lvlm-iclr26/
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on vision-language models, which is a related but distinct area from information retrieval. While it involves analysis of model decision-making processes, it does not directly address query understanding, ranking models, or user behavior modeling, which are core aspects of your research interests.
...
### 32. Distilling Human-Aligned Privacy Sensitivity Assessment from Large Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Gabriel Loiseau, Damien Sileo, Damien Riquet, Maxime Meyer, Marc Tommasi
- **URL**: <http://arxiv.org/abs/2603.29497v1>
- **Submitted**: 2026-03-31 09:40:58
- **Comment**: Accepted to the LREC CALD-pseudo 2026 Workshop
- **Topic Keywords**: rag
- **Reason**: The paper focuses on natural language processing and privacy evaluation, which is somewhat related to the user's interests in NLP. However, it does not align with the user's primary focus on information retrieval, query understanding, and ranking models.
...
### 33. An Isotropic Approach to Efficient Uncertainty Quantification with Gradient Norms

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Nils Grünefeld, Jes Frellsen, Christian Hardmeier
- **URL**: <http://arxiv.org/abs/2603.29466v1>
- **Submitted**: 2026-03-31 09:13:09
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on uncertainty quantification in neural networks, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the topic is more aligned with machine learning and uncertainty estimation rather than query understanding, ranking models, or user behavior modeling.
...
### 34. CounselReflect: A Toolkit for Auditing Mental-Health Dialogues
...
- **URL**: <http://arxiv.org/abs/2603.29429v1>
- **Submitted**: 2026-03-31 08:35:43
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves conversational systems and LLM-based tools, its focus on auditing mental-health dialogues and providing structured reports is not a central match for your research themes.
...
### 35. CADEL: A Corpus of Administrative Web Documents for Japanese Entity Linking

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Shohei Higashiyama, Masao Ideuchi, Masao Utiyama
- **URL**: <http://arxiv.org/abs/2603.29336v1>
- **Submitted**: 2026-03-31 07:00:57
- **Topic Keywords**: rag
- **Reason**: This paper focuses on entity linking and Japanese language resources, which is somewhat related to information retrieval and natural language processing. However, it does not directly address query understanding, ranking models, or user behavior modeling, making it less relevant to the user's core research themes.
...
### 36. Sima AIunty: Caste Audit in LLM-Driven Matchmaking

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Atharva Naik, Shounok Kar, Varnika Sharma, Ashwin Rajadesingan, Koustuv Saha
- **URL**: <http://arxiv.org/abs/2603.29288v1>
- **Submitted**: 2026-03-31 05:44:55
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models (LLMs), the focus is on caste bias and social acceptance in matchmaking, which is not a central theme in your research areas.
...
### 37. Advancing LLM-based phoneme-to-grapheme for multilingual speech recognition

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Lukuang Dong, Ziwei Li, Saierdaer Yusuyin, Xianyu Zhao, Zhijian Ou
- **URL**: <http://arxiv.org/abs/2603.29217v1>
- **Submitted**: 2026-03-31 03:32:18
- **Comment**: Update after INTERSPEECH2026 submission
- **Topic Keywords**: rag
- **Reason**: This paper focuses on speech recognition and phoneme-to-grapheme conversion, which is outside your primary research interests in Information Retrieval and Search technologies. Although it involves a large language model, the context is not related to query understanding, ranking models, or user behavior modeling.
...
### 38. Designing FSMs Specifications from Requirements with GPT 4.0

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Omer Nguena Timo, Paul-Alexis Rodriguez, Florent Avellaneda
- **URL**: <http://arxiv.org/abs/2603.29140v1>
- **Submitted**: 2026-03-31 01:42:25
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves machine learning technology, its focus is on designing Finite State Machines from requirements, which is outside your primary areas of interest.
...
### 39. The Model Says Walk: How Surface Heuristics Override Implicit Constraints in LLM Reasoning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yubo Li, Lu Zhang, Tianchong Jiang, Ramayya Krishnan, Rema Padman
- **URL**: <http://arxiv.org/abs/2603.29025v1>
- **Submitted**: 2026-03-30 21:36:09
- **Topic Keywords**: rag
- **Reason**: This paper appears to be focused on the limitations of Large Language Models (LLMs) in reasoning tasks, specifically how surface heuristics override implicit constraints. While it touches on aspects of model behavior, it does not seem to directly relate to the user's core research interests in Information Retrieval, Search technologies, or Natural Language Processing, particularly in areas requiring deep semantic understanding and real-time relevance optimization.
...
### 40. Human-Like Lifelong Memory: A Neuroscience-Grounded Architecture for Infinite Interaction

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Diego C. Lerma-Torres
- **URL**: <http://arxiv.org/abs/2603.29023v1>
- **Submitted**: 2026-03-30 21:35:28
- **Comment**: 14 pages, 1 figure. Accepted at the MemAgents Workshop, ICLR 2026
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on developing a neuroscience-grounded architecture for lifelong memory, which is not directly related to information retrieval, search technologies, or natural language processing. While it touches on the concept of retrieval, it's primarily concerned with memory and cognitive processing, making it less relevant to your research interests.
...
### 41. Physiological and Semantic Patterns in Medical Teams Using an Intelligent Tutoring System

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Xiaoshan Huang, Conrad Borchers, Jiayi Zhang, Susanne P. Lajoie
- **URL**: <http://arxiv.org/abs/2603.29950v1>
- **Submitted**: 2026-03-31 16:18:57
- **Comment**: Accepted as short paper to the 27th International Conference on Artificial Intelligence in Education (AIED 2026)
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on physiological and semantic patterns in medical teams using an intelligent tutoring system, which is outside your primary areas of interest.
...
### 42. Cold-Starts in Generative Recommendation: A Reproducibility Study

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Zhen Zhang, Jujia Zhao, Xinyu Ma, Xin Xin, Maarten de Rijke, Zhaochun Ren
- **URL**: <http://arxiv.org/abs/2603.29845v1>
- **Submitted**: 2026-03-31 15:06:31
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on generative recommendation and cold-starts, which is somewhat related to information retrieval, but it primarily deals with recommender systems, a secondary interest of yours. The paper's focus on generative recommendation and pre-trained language models is not directly aligned with your core research themes in information retrieval and search technologies.
...
### 43. Calibrated Confidence Expression for Radiology Report Generation
...
- **URL**: <http://arxiv.org/abs/2603.29492v1>
- **Submitted**: 2026-03-31 09:37:33
- **Topic Keywords**: search
- **Reason**: This paper focuses on radiology report generation and confidence calibration in LVLMs, which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the context and application are quite different from your areas of focus.
...
### 44. M-MiniGPT4: Multilingual VLLM Alignment via Translated Data

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Seung Hun Han, Youssef Mohamed, Mohamed Elhoseiny
- **URL**: <http://arxiv.org/abs/2603.29467v1>
- **Submitted**: 2026-03-31 09:13:38
- **Comment**: 6 pages, ACL 2026, Proceedings of the 7th Workshop on African Natural Language Processing (AfricaNLP 2026)
- **Topic Keywords**: search
- **Reason**: This paper focuses on multilingual vision-language understanding and large language models, which is somewhat related to your interests in Natural Language Processing (NLP) and deep semantic understanding. However, it does not directly address your core research themes in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling.
...
### 45. L-ReLF: A Framework for Lexical Dataset Creation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Anass Sedrati, Mounir Afifi, Reda Benkhadra
- **URL**: <http://arxiv.org/abs/2603.29346v1>
- **Submitted**: 2026-03-31 07:19:00
- **Comment**: Accepted to the 2026 International Conference on Natural Language Processing (ICNLP). 6 pages, 1 figure
- **Topic Keywords**: search
- **Reason**: This paper focuses on lexical dataset creation for underserved languages, which is a topic in Natural Language Processing (NLP), but it does not directly relate to Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 46. Owl-AuraID 1.0: An Intelligent System for Autonomous Scientific Instrumentation and Scientific Data Analysis
...
- **URL**: <http://arxiv.org/abs/2603.29828v1>
- **Submitted**: 2026-03-31 14:49:23
- **Comment**: 17 pages
- **Topic Keywords**: rag, ctr
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, Natural Language Processing, or data mining. The paper focuses on autonomous scientific instrumentation and data analysis, which is outside your primary areas of interest.
...
### 47. Developing a Guideline for the Labovian-Structural Analysis of Oral Narratives in Japanese

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Amane Watahiki, Tomoki Doi, Akari Kikuchi, Hiroshi Ohata, Yuki I. Nakata, Takuya Niikawa, Taiga Shinozaki, Hitomi Yanaka
- **URL**: <http://arxiv.org/abs/2603.29347v1>
- **Submitted**: 2026-03-31 07:19:04
- **Comment**: Accepted at The Fifteenth biennial Language Resources and Evaluation Conference (LREC) 2026
- **Topic Keywords**: search
- **Reason**: This paper is unrelated to Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or recommender systems. It focuses on qualitative research and narrative analysis in the context of Japanese language, which does not align with your research interests.
