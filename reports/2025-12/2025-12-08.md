# Daily Papers Report - 2025-12-08

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. Sift or Get Off the PoC: Applying Information Retrieval to Vulnerability Research with SiftRank
...
- **Topic Keywords**: information retrieval, ranking, rerank, listwise, retrieval, rank, search
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of ranking models and real-time relevance optimization. The application of document ranking techniques with LLMs to vulnerability research is an interesting and novel area of study that aligns with the user's interests in deep semantic understanding and search technologies.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Graph-based clustering analysis of function call relationships in software systems
- **Aim**: To identify and categorize function call clusters using graph-based methods, highlighting 35 top-ranked clusters with color-coded functional relevance (orange: vulnerability fixes, yellow: authentication, gray: logging)
- **Rationale**: Understanding function call relationships aids in software security analysis, vulnerability detection, and system architecture optimization. Clustering reveals functional patterns and interdependencies.
- **Ground**: A graph-based clustering algorithm was applied to function call data, generating 119 clusters. Clusters were evaluated using seven metrics: rank, seed, diameter, size, mass, density, and score.
- **Experiment**: 27 distinct functions were identified across top clusters, with some functions appearing in multiple clusters (e.g., sub_2d5c920 in clusters 28 and 77). Metrics like density and mass were used to assess cluster cohesion and interactivity.
- **Takeaway**: The color-coded clustering system enables rapid identification of function groups tied to critical tasks (e.g., security fixes). Overlapping functions suggest multifunctional roles, while metrics provide quantitative insights into cluster properties.
...
### 2. Enhancing Information Retrieval in Digital Libraries through Unit Harmonisation in Scholarly Knowledge Graphs
...
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of digital libraries and scholarly knowledge graphs. The focus on faceted search and structured content for comparing and filtering measured data aligns with your interests in query understanding and ranking models. However, the specific domain of digital libraries and scholarly knowledge graphs is somewhat narrower than your broader interests in e-commerce and general information retrieval.
...
### 3. Modeling Contextual Passage Utility for Multihop Question Answering
...
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of query understanding and ranking models. The focus on contextual passage utility for Multihop Question Answering shares some similarities with the user's interest in deep semantic understanding and real-time relevance optimization. However, the specific application domain and task are not directly aligned with the user's primary focus on e-commerce or general search technologies.
...
### 4. An Index-based Approach for Efficient and Effective Web Content Extraction
...
- **Reason**: The paper explores web content extraction, which is somewhat related to information retrieval and search technologies. However, the focus on web agents, LLM context management, and index prediction is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 5. Beyond Existing Retrievals: Cross-Scenario Incremental Sample Learning Framework
...
- **Reason**: The paper proposes a novel retrieval framework for cross-scenario incremental sample learning, which is somewhat related to the user's interests in Information Retrieval and Search technologies. However, the focus on recommender systems and the specific application in e-commerce (Taobao homepage recommendation) limits its relevance to the user's broader interests in query understanding, ranking models, and user behavior modeling.
...
### 6. WisPaper: Your AI Scholar Search Engine
...
- **Reason**: The paper presents a search engine for academic literature, which aligns with the Information Retrieval theme. However, the focus is more on the platform's features and user experience rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The connection to NLP and data mining is also indirect, making it somewhat related but not a central match.
...
### 7. LOCUS: A System and Method for Low-Cost Customization for Universal Specialization
...
- **Reason**: The paper LOCUS is somewhat related to the user's research interests in Natural Language Processing (NLP) and related topics. However, it focuses on model customization and efficiency, which is not a central match to the user's primary focus on information retrieval, especially in areas requiring deep semantic understanding and real-time relevance optimization.
...
### 8. TopiCLEAR: Topic extraction by CLustering Embeddings with Adaptive dimensional Reduction
...
- **Topic Keywords**: rag
- **Reason**: The paper, TopiCLEAR, focuses on topic extraction from social media posts using a novel clustering approach. While it involves NLP techniques like Sentence-BERT and Gaussian Mixture Models, its primary goal is not query understanding, ranking models, or user behavior modeling, which are core areas of your research interests. However, the paper's use of deep semantic understanding and its application to social media data may be of some interest to you.
...
### 9. CMV-Fuse: Cross Modal-View Fusion of AMR, Syntax, and Knowledge Representations for Aspect Based Sentiment Analysis
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), particularly in the area of query understanding and deep semantic understanding. However, the focus on Aspect-Based Sentiment Analysis and linguistic perspectives is not directly aligned with your primary interests in search technologies and ranking models.
...
### 10. Enhanced Multimodal Video Retrieval System: Integrating Query Expansion and Cross-modal Temporal Event Retrieval
...
- **Reason**: The paper focuses on multimodal video retrieval, integrating query expansion and cross-modal temporal event retrieval. While it touches on query refinement and expansion, it's more centered on video retrieval and multimodal search, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the lack of emphasis on query understanding, ranking models, or user behavior modeling limits its relevance to your core research themes.
...
### 11. Foresight Prediction Enhanced Live-Streaming Recommendation
...
- **Reason**: The paper focuses on live-streaming recommendation, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The use of semantic quantization and foresight prediction is an interesting approach, but it's more aligned with recommender systems than traditional IR. While it touches on real-time relevance optimization, it's not a central match for the user's core research themes.
...
### 12. Towards Efficient Hypergraph and Multi-LLM Agent Recommender Systems
...
- **Reason**: The paper discusses recommender systems, which is related to your research interests in Information Retrieval and Search technologies. However, the focus on Large Language Models (LLMs) and hypergraph encoders is not a central match to your interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on recommender systems and computational efficiency also diverges from your primary focus on deep semantic understanding and real-time relevance optimization.
...
### 13. Structural and Disentangled Adaptation of Large Vision Language Models for Multimodal Recommendation
...
- **Reason**: This paper focuses on multimodal recommendation using Large Vision-Language Models, which is somewhat related to information retrieval and search technologies. However, the primary focus on recommendation systems and visual/textual signals is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Learning to Rank, but it focuses on reward models and Large Language Model alignment, which is not a central match to your primary focus on information retrieval and query understanding. The paper's analysis of representation distance bias in BT-loss is an interesting contribution, but it does not directly address your core research themes.
...
### 15. Becoming Experienced Judges: Selective Test-Time Learning for Evaluators
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of evaluating large language models. However, the focus on test-time learning for evaluators and the use of meta-prompts for sample-specific evaluation criteria is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.
...
### 16. Empathy by Design: Aligning Large Language Models for Healthcare Dialogue
...
- **Topic Keywords**: pairwise
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and related topics, particularly in the context of healthcare dialogue. However, it does not directly align with your primary focus on Information Retrieval (IR), query understanding, ranking models, or user behavior modeling. The paper's emphasis on empathy and human-centric qualities in AI assistants is an interesting aspect, but it does not seem to be a central match with your research themes.
...
### 17. MMDuet2: Enhancing Proactive Interaction of Video MLLMs with Multi-Turn Reinforcement Learning
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it primarily focuses on video multimodal large language models and proactive interaction, which is not a central match. While it involves real-time relevance optimization, it's more related to dialogue systems and video understanding than traditional IR and search technologies.
...
### 18. One Word Is Not Enough: Simple Prompts Improve Word Embeddings
...
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and text embedding models, but it does not directly align with your focus on Information Retrieval (IR) and query understanding. The paper's emphasis on improving word embeddings using simple prompts is an interesting contribution, but it does not seem to have a direct connection to your core research themes.
...
### 19. Cognitive Control Architecture (CCA): A Lifecycle Supervision Framework for Robustly Aligned AI Agents
...
- **Topic Keywords**: rag
- **Reason**: This paper proposes a framework for robustly aligned AI agents, addressing Indirect Prompt Injection attacks. While it touches on the topic of AI and security, it doesn't directly relate to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 20. Policy-based Sentence Simplification: Replacing Parallel Corpora with LLM-as-a-Judge
...
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and data mining, but it does not directly address your core focus on Information Retrieval (IR), query understanding, or ranking models. The paper's focus on sentence simplification and leveraging Large Language Models is tangentially related to your interests in deep semantic understanding and real-time relevance optimization, but it is not a central match.
...
### 21. Think-While-Generating: On-the-Fly Reasoning for Personalized Long-Form Generation
...
- **Reason**: The paper focuses on personalized long-form generation using a 'think-while-generating' framework, which is somewhat related to information retrieval and search technologies. However, the primary focus is on natural language processing and generation, rather than query understanding, ranking models, or user behavior modeling. While the paper explores personalization, which is a related concept, it does not directly address the user's core research themes.
...
### 22. PersonaMem-v2: Towards Personalized Intelligence via Learning Implicit User Personas and Agentic Memory
...
- **Topic Keywords**: personalization
- **Reason**: This paper explores the concept of personalized intelligence and user understanding through reinforcement fine-tuning and agentic memory systems. While it touches on aspects of user behavior modeling, it primarily focuses on natural language processing and large language model personalization, which aligns with your interests but is not a central match. The paper's emphasis on implicit personalization and long-context reasoning capabilities is somewhat related to your research themes.
...
### 23. Adapting AlignScore Mertic for Factual Consistency Evaluation of Text in Russian: A Student Abstract
...
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on factual consistency evaluation in Russian texts, which is not a central match to the user's primary focus on information retrieval and query understanding.
...
### 24. Automated PRO-CTCAE Symptom Selection based on Prior Adverse Event Profiles
...
- **Topic Keywords**: relevance, rag, ctr, rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. Although it involves ranking models (Learning to Rank) and user behavior modeling (spectral analysis), the context is in clinical trial safety and patient-reported outcomes, which is not aligned with your primary focus on e-commerce and real-time relevance optimization.
...
### 25. LLM4SFC: Sequential Function Chart Generation via Large Language Models
...
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models, the focus is on generating graphical languages for industrial programming, which is not a central match to your areas of interest.
...
### 26. NeuroABench: A Multimodal Evaluation Benchmark for Neurosurgical Anatomy Identification
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on surgical video understanding and anatomical comprehension in the neurosurgical domain, which is unrelated to your core research themes.
...
### 27. Less Is More, but Where? Dynamic Token Compression via LLM-Guided Keyframe Prior
...
- **Reason**: This paper is about video understanding and compression using Large Language Models (LLMs), which is not directly related to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some concepts like attention mechanisms, the context and application are quite different from your areas of focus.
...
### 28. Enhancing Medical Cross-Modal Hashing Retrieval using Dropout-Voting Mixture-of-Experts Fusion
...
- **Reason**: This paper focuses on medical cross-modal hashing retrieval, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves retrieval systems, the context and application are quite different from the user's interests in e-commerce and deep semantic understanding. The paper's emphasis on medical data and interoperability does not align with the user's research focus.
...
### 29. MATEX: A Multi-Agent Framework for Explaining Ethereum Transactions
...
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on explaining Ethereum transactions using a multi-agent framework, which is not directly related to information retrieval, search technologies, or natural language processing. While it involves understanding complex data, the context and application are quite different from the user's core research themes.
...
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on conversational Large Language Models, addressing issues of contextual decay in multi-turn conversations. While it involves attention mechanisms, which are related to ranking models, the primary topic is not information retrieval or search technologies, and the techniques described are not directly applicable to the user's core research themes.
...
### 31. AquaFusionNet: Lightweight VisionSensor Fusion Framework for Real-Time Pathogen Detection and Water Quality Anomaly Prediction on Edge Devices
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on a vision sensor fusion framework for real-time pathogen detection and water quality anomaly prediction, which is outside your areas of expertise.
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on generating discharge summaries in the medical domain, which is not a primary area of interest for you.
...
### 33. Arc Gradient Descent: A Mathematically Derived Reformulation of Gradient Descent with Phase-Aware, User-Controlled Step Dynamics
...
- **Topic Keywords**: rag
- **Reason**: This paper is primarily focused on optimization techniques in machine learning, which is a related but distinct field from information retrieval and search technologies. While it touches on deep learning and neural networks, it does not address query understanding, ranking models, or user behavior modeling, which are core areas of interest for the user.
...
### 34. LLM-Upgraded Graph Reinforcement Learning for Carbon-Aware Job Scheduling in Smart Manufacturing
...
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on job scheduling in smart manufacturing, incorporating large language models and graph reinforcement learning, which does not align with your primary focus on Information Retrieval, Search technologies, and Natural Language Processing.
...
### 35. Nanbeige4-3B Technical Report: Exploring the Frontier of Small Language Models
...
- **Topic Keywords**: rag
- **Reason**: This paper focuses on developing small-scale language models, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves some NLP aspects, the primary focus is on model development and scaling laws, which doesn't align with your interests in query understanding, ranking models, and user behavior modeling.
...
### 36. Large Language Models and Forensic Linguistics: Navigating Opportunities and Threats in the Age of Generative AI
...
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing, as it focuses on the intersection of Forensic Linguistics and Large Language Models. While it touches on topics like text analysis and authorship attribution, the context and implications are primarily within the legal and forensic domains, which do not align with your primary research themes.
...
### 37. Morphologically-Informed Tokenizers for Languages with Non-Concatenative Morphology: A case study of Yoloxóchtil Mixtec ASR
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on developing tokenizers for languages with non-concatenative morphology, specifically for Automatic Speech Recognition (ASR), which is outside your primary areas of interest in Information Retrieval and Search technologies.
