...
- **Submitted**: 2026-05-18 12:18:47
- **Topic Keywords**: retriever, query, queries, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of search-augmented reasoning and query understanding. The proposed SD-Search method, which derives step-level supervision from the policy itself, aligns with your focus on real-time relevance optimization and deep semantic understanding. While the paper's primary focus is on reinforcement learning, its connection to search technologies and query understanding makes it a useful contribution to your field.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: SD-Search: Self‑Distilled Search‑Augmented Reasoning
- **Aim**: Enable per‑query credit assignment for retrieval‑augmented LLM agents by using the policy itself as a teacher, eliminating the need for external teachers or costly annotations.
- **Rationale**: Trajectory‑level rewards credit only the final answer, obscuring which search queries were useful. Existing process‑supervision methods rely on external teachers or human labeling. SD‑Search supplies dense, in‑policy supervision by letting the policy learn from hindsight‑augmented sibling rollouts that indicate success or failure of each query.
- **Ground**: The method introduces an on‑policy hindsight self‑distillation framework: a single policy plays student and teacher roles. The teacher is conditioned on a hindsight block comprising masked search spans and binary outcome labels from sibling rollouts. The student learns to match the teacher’s token‑level distribution at each search‑query position via a Jensen–Shannon divergence loss, while policy gradients (GRPO) provide trajectory‑level advantage signals.
- **Experiment**: Training dynamics show that after a warm‑up phase, SD‑Search outperforms baseline AutoRefine in exact match and search quality while maintaining similar search frequency. Entropy‑gap analysis demonstrates rapid student‑teacher alignment and a plateau due to the teacher’s extra hindsight information. Teacher input construction uses a prompt prefix, deduplicated hindsight block, and focal future search spans.
- **Takeaway**: Self‑distillation with hindsight blocks equips retrieval‑augmented agents with rich, per‑query supervision, producing more precise, fact‑focused queries and higher retrieval success without external supervision or increased search calls.
...
### 2. TIGER-FG: Text-Guided Implicit Fine-Grained Grounding for E-commerce Retrieval

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Xinyu Sun, Huangyu Dai, Lingtao Mao, Zexin Zheng, Zihan Liang, Ben Chen, Chenyi Lei, Wenwu Ou
- **URL**: <http://arxiv.org/abs/2605.18434v1>
- **Submitted**: 2026-05-18 14:07:20
- **Topic Keywords**: query, retrieval, commerce, e-commerce, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of e-commerce image search. The proposed TIGER-FG framework addresses the modality and granularity disparities in image-to-multimodal retrieval, which is a key challenge in query understanding and ranking models. While the focus is on e-commerce, the techniques and ideas presented can be applied to other domains, making it a useful contribution to the broader field of IR.
...
### 3. From Volume to Value: Preference-Aligned Memory Construction for On-Device RAG

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Changmin Lee, Jaemin Kim, Taesik Gong
- **URL**: <http://arxiv.org/abs/2605.18271v1>
- **Submitted**: 2026-05-18 12:06:05
- **Comment**: Accepted to ICML 2026. Code and data are available at https://github.com/UbiquitousAILab/EPIC
- **Topic Keywords**: query, rag, retrieval, recommend
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval and Search technologies, particularly in the area of query understanding and ranking models. The focus on preference-aligned memory construction and retrieval optimization is also closely related to your interests in user behavior modeling and real-time relevance optimization. However, the paper's primary focus on Large Language Models and on-device implementation is somewhat outside your core research themes.
...
### 4. PQR: A Framework to Generate Diverse and Realistic User Queries that Elicit QA Agent Failures

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Yunan Lu, Luigi Liu, Omar Yahia, Arpit Sharma, Zhou Yu
- **URL**: <http://arxiv.org/abs/2605.16551v1>
- **Submitted**: 2026-05-15 18:50:43
- **Topic Keywords**: query, queries, commerce, e-commerce
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in query understanding and ranking models. The paper's focus on generating realistic user queries that elicit failures in QA agents aligns with your interests in deep semantic understanding and real-time relevance optimization. Although the paper's primary focus is on QA agents, its connection to information retrieval and query understanding makes it a valuable contribution to your field.
...
### 5. BELIEF: Structured Evidence Modeling and Uncertainty-Aware Fusion for Biomedical Question Answering

- **LLM Score**: 8
- **Keyword Score**: 5
- **Authors**: Chang Zong, Hao Ning, Siliang Tang, Jie Huang, Jian Wan
- **URL**: <http://arxiv.org/abs/2605.17435v1>
- **Submitted**: 2026-05-17 12:58:55
- **Comment**: 14 pages, 6 figures
- **Topic Keywords**: relevance, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of biomedical question answering, where it proposes a structured evidence modeling and uncertainty-aware fusion framework. While the focus is on biomedical question answering, the techniques and concepts, such as evidence objects and uncertainty-aware fusion, are applicable to other domains, including e-commerce, aligning with your research interests in query understanding and ranking models.
...
- **Submitted**: 2026-05-18 10:39:42
- **Comment**: 15 pages, 3 figures, accepted at DEXA'26
- **Topic Keywords**: dense retrieval, queries, retrieval, rank, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of content-based search and query understanding. Although it focuses on table search, it leverages Large Language Models (LLMs) and dense retrieval, which are relevant to your interests in query understanding and ranking models. However, the specific application to tabular datasets and dataset search is not a central match to your primary focus on information retrieval in e-commerce and real-time relevance optimization.
...
- **URL**: <http://arxiv.org/abs/2605.18490v1>
- **Submitted**: 2026-05-18 14:41:16
- **Topic Keywords**: query, queries, rag, search
- **Reason**: This paper explores the comparison of two systems for answering questions over a research corpus, using Vector RAG and LLM-compiled Wiki. While it touches on aspects of query understanding and ranking models, its primary focus is on question answering and research synthesis, which is somewhat related to information retrieval but not a central match for your research interests.
...
- **URL**: <http://arxiv.org/abs/2605.17301v1>
- **Submitted**: 2026-05-17 07:25:29
- **Comment**: 6 pages, 6 figures, submitted to IEEE SMC 2026
- **Topic Keywords**: rag, retrieval augmented generation, ctr, retrieval
- **Reason**: The paper explores Retrieval-Augmented Generation (RAG) systems, which is related to Search technologies and query understanding. However, the focus on conflict detection and resolution in RAG systems is somewhat tangential to the user's core research themes of ranking models and user behavior modeling.
...
- **Submitted**: 2026-05-18 17:59:52
- **Comment**: Preprint
- **Topic Keywords**: query, rag
- **Reason**: This paper proposes a novel attention mechanism, DashAttention, which is relevant to my research interests in Information Retrieval and Natural Language Processing. However, the focus on long-context modeling and sparse attention is somewhat related to my interests but not a central match. The paper's emphasis on efficiency and GPU-aware implementation is also noteworthy.
...
### 10. Text-Video Retrieval With Global-Local Contrastive Consistency Learning

- **LLM Score**: 6
- **Keyword Score**: 5
- **Authors**: Xiaolun Jing, Xinxing Yang, Genke Yang
- **URL**: <http://arxiv.org/abs/2605.17959v1>
- **Submitted**: 2026-05-18 07:17:14
- **Topic Keywords**: queries, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the area of query understanding and ranking models. However, the focus on text-video retrieval and contrastive consistency learning is not a central match to your primary research themes, which include e-commerce, user behavior modeling, and deep semantic understanding.
...
### 11. RAGA: Reading-And-Graph-building-Agent for Autonomous Knowledge Graph Construction and Retrieval-Augmented Generation

- **LLM Score**: 6
- **Keyword Score**: 5
- **Authors**: Chengrui Han, Zesheng Cheng
- **URL**: <http://arxiv.org/abs/2605.17072v1>
- **Submitted**: 2026-05-16 16:42:50
- **Topic Keywords**: rag, retrieval, search
- **Reason**: This paper explores knowledge graph construction and retrieval, which is somewhat related to information retrieval and search technologies. However, the focus on knowledge graphs and LLM-driven methods is not a central match to the user's interests in query understanding, ranking models, and user behavior modeling. The paper's relevance is somewhat diminished by its lack of direct connection to the user's primary research themes.
...
### 12. MARQUIS: A Three-Stage Pipeline for Video Retrieval-Augmented Generation
...
- **URL**: <http://arxiv.org/abs/2605.17640v1>
- **Submitted**: 2026-05-17 20:19:04
...
- **Reason**: The paper presents a three-stage pipeline for video retrieval-augmented generation, which is somewhat related to information retrieval and query understanding. However, the focus on video retrieval and generation from large corpora is not directly aligned with the user's core research themes in IR and search technologies. The use of query expansion, fusion, and reranking is relevant, but the overall context is more focused on multimedia information retrieval and generation.
...
### 13. Text-Guided Visual Representation Learning for Robust Multimodal E-Commerce Recommendation

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Yufei Guo, Jing Ma, Tianlu Zhang, Shijie Yang, Yanlong Zang, Weijie Ding, Pinghua Gong, Jungong Han
- **URL**: <http://arxiv.org/abs/2605.17366v1>
- **Submitted**: 2026-05-17 10:20:23
...
- **Topic Keywords**: query, rag, retrieval, recommend, commerce, e-commerce
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of e-commerce. However, its focus on multimodal item embeddings and visual representation learning for recommendation systems is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 14. Semantic Reranking at Inference Time for Hard Examples in Rhetorical Role Labeling

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Anas Belfathi, Nicolas Hernandez, Laura Monceaux, Warren Bonnard, Richard Dufour
- **URL**: <http://arxiv.org/abs/2605.18007v1>
- **Submitted**: 2026-05-18 08:03:02
- **Comment**: Accepted at ACL 2026 (Main Conference)
- **Topic Keywords**: ranking, rerank, rag, rank
- **Reason**: This paper is somewhat related to your interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, the focus on Rhetorical Role Labeling and label semantics is not directly aligned with your primary research themes. The use of language models and reranking framework may be of interest, but the application domain and specific problem addressed are not central to your research.
...
- **Submitted**: 2026-05-18 15:41:01
- **Comment**: 19 pages, 12 figures. Code and artifacts: https://github.com/santoshkumarradha/rarecode
- **Topic Keywords**: query, retrieval, search, acl
- **Reason**: This paper is somewhat related to Information Retrieval, specifically focusing on improving BM25 code retrieval. However, its primary focus on code retrieval and tokenization under fixed generic tokenization does not directly align with the user's interests in query understanding, ranking models, and user behavior modeling. While it touches on relevance optimization, it is not a central match for the user's research themes.
...
### 16. Infini-News: Efficiently Queryable Access to 1.3 Billion Processed Common Crawl News Articles

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Ruggero Marino Lazzaroni, Jana Lasser, Kirill Solovev
- **URL**: <http://arxiv.org/abs/2605.18337v1>
- **Submitted**: 2026-05-18 12:52:14
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, as it involves a large-scale news corpus and a retrieval toolkit. However, the focus is on efficient access to a news archive rather than query understanding, ranking models, or user behavior modeling. The paper's emphasis on NLP tasks like language detection and geographic attribution is also relevant, but not central to the user's primary research themes.
...
### 17. PPAI: Enabling Personalized LLM Agent Interoperability for Collaborative Edge Intelligence

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Zile Wang, Qianli Liu, Kaibin Guo, Haodong Wang, Jian Lin, Zicong Hong, Song Guo
- **URL**: <http://arxiv.org/abs/2605.18067v1>
- **Submitted**: 2026-05-18 08:49:33
- **Topic Keywords**: query, queries, rag
- **Reason**: The paper discusses personalized LLM agent interoperability, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on agent specialization and query-agent pair scoring is more aligned with recommender systems and NLP, rather than the user's core research themes in IR and search technologies.
...
- **Submitted**: 2026-05-18 17:59:45
- **Topic Keywords**: information retrieval, retrieval, recommend, search
- **Reason**: This paper is somewhat related to information retrieval, as it frames expert identification as an IR problem and evaluates various retrieval methodologies. However, the focus is on expert reviewer identification, which is not a central match to your primary research interests in query understanding, ranking models, and user behavior modeling. The paper's emphasis on traditional statistical representations and their superiority over generative AI is also not directly relevant to your interests in deep semantic understanding and real-time relevance optimization.
...
### 19. Towards Sustainable Growth: A Multi-Value-Aware Retrieval Framework for E-Commerce Search

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Yifan Wang, Yixuan Wang, YiDan Liang, Qiang Liu, Fei Xiao
- **URL**: <http://arxiv.org/abs/2605.17994v1>
- **Submitted**: 2026-05-18 07:50:15
- **Topic Keywords**: rag, retrieval, commerce, e-commerce, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of e-commerce search. However, its focus on sustainable growth and long-term item value prediction, while interesting, does not directly align with your core themes of query understanding, ranking models, and user behavior modeling.
...
- **URL**: <http://arxiv.org/abs/2605.17101v1>
- **Submitted**: 2026-05-16 18:09:47
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper proposes a novel framework for medical question answering, leveraging Retrieval-Augmented Generation (RAG) with a multi-agent approach. While it touches on aspects of query understanding and retrieval, its primary focus is on medical reasoning and question answering, which is somewhat related to your interests in Information Retrieval and NLP. However, the specific domain and application are not directly aligned with your core research themes.
...
### 22. OpenJarvis: Personal AI, On Personal Devices
...
- **URL**: <http://arxiv.org/abs/2605.17172v1>
- **Submitted**: 2026-05-16 22:00:10
- **Comment**: Code: https://github.com/openjarvis/openjarvis Website: https://open-jarvis.github.io/OpenJarvis/
- **Topic Keywords**: query, rag, search
- **Reason**: This paper presents a novel architecture for personal AI systems, OpenJarvis, which decomposes the stack into individual primitives. While it touches on aspects of query understanding and real-time relevance optimization, its primary focus is on optimizing local AI models for personal devices, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the paper's emphasis on AI stacks and local model optimization is not a central match for your research themes.
...
- **Submitted**: 2026-05-17 20:21:55
- **Comment**: 12 pages, 3 figures, 3 tables
- **Topic Keywords**: relevance, rag
- **Reason**: This paper explores memory selection techniques for long-horizon LLM agents, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on causal memory selection and its application to LLM agents is not directly aligned with the user's core research themes in IR and Search technologies. The paper's use of a causally annotated benchmark and its results on answer quality and robustness are interesting, but the connection to the user's research interests is not strong enough to warrant a higher score.
...
### 24. Learning Faster with Better Tokens: Parameter-Efficient Vocabulary Adaptation for Specialized Text Summarization

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Gunjan Balde, Soumyadeep Roy, Mainack Mondal, Niloy Ganguly
- **URL**: <http://arxiv.org/abs/2605.17379v1>
- **Submitted**: 2026-05-17 10:45:01
- **Comment**: 16 pages. Accepted in the 64th Annual Meeting of the Association for Computational Linguistics [ACL (Main) 2026] as a long paper
- **Topic Keywords**: relevance, rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and text summarization, but it focuses on vocabulary adaptation for specialized domains, which is a specific area that doesn't align with your primary focus on information retrieval and query understanding. While it involves large language models and tokenization, the context is more related to text summarization and domain adaptation rather than search technologies or user behavior modeling.
...
### 25. Can LLMs Think Like Consumers? Benchmarking Crowd-Level Reaction Reconstruction with ConsumerSimBench

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Tianyu Wang, Jiajun Li, Jianghao Lin
- **URL**: <http://arxiv.org/abs/2605.17079v1>
- **Submitted**: 2026-05-16 16:55:31
- **Topic Keywords**: pointwise, rag
- **Reason**: This paper is somewhat relevant to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of deep semantic understanding and real-time relevance optimization. However, its focus on consumer simulation and reaction reconstruction, while related to user behavior modeling, is not a central match to your primary research themes. The paper's emphasis on benchmarking and evaluation of LLMs also touches on related topics in data mining and recommender systems.
...
### 26. Full Attention Strikes Back: Transferring Full Attention into Sparse within Hundred Training Steps

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Yanke Zhou, Yiduo Li, Hanlin Tang, Maohua Li, Kan Liu, Lan Tao, Lin Qu, Yuan Yao, Xiaoxing Ma
- **URL**: <http://arxiv.org/abs/2605.16928v1>
- **Submitted**: 2026-05-16 10:51:58
- **Comment**: 20 pages, 9 figures
- **Topic Keywords**: query, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of large language models and attention mechanisms. However, the focus on sparse attention and efficiency gains in this work is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 27. JSPG: Dynamic Dictionary Filtering via Joint Semantic-Pinyin-Glyph Retrieval for Chinese Contextual ASR

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Shilin Zhou, Zhenghua Li
- **URL**: <http://arxiv.org/abs/2605.16896v1>
- **Submitted**: 2026-05-16 09:16:09
- **Topic Keywords**: retriever, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, its focus on Chinese Contextual ASR and dynamic dictionary filtering is not directly aligned with your primary areas of interest. While it does involve semantic understanding and retrieval, the specific application and techniques used are not central to your research themes.
...
### 28. Recall Isn't Enough: Bounding Commitments in Personalized Language Systems

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Rui Tang, Yichi Zhang, Xi Chen, Chen Dong, Youwei Yang, Yumeng Shen
- **URL**: <http://arxiv.org/abs/2605.16712v1>
- **Submitted**: 2026-05-15 23:50:15
- **Comment**: 14 pages, 3 figures, 22 tables; preprint version
- **Topic Keywords**: rag, personalization, acl
- **Reason**: The paper discusses personalization in language systems, introducing a new approach to bound commitments. While it touches on aspects of information retrieval, such as recall and evidence activation, the primary focus is on language systems and personalization, which is somewhat related to your interests in IR and NLP. However, the specific context and application are not directly aligned with your core research themes.
...
### 29. Generative AI Advertising as a Problem of Trustworthy Commercial Intervention

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Jingyi Qiu, Qiaozhu Mei
- **URL**: <http://arxiv.org/abs/2605.18673v1>
- **Submitted**: 2026-05-18 17:15:06
- **Topic Keywords**: retrieval, search
- **Reason**: This paper explores the intersection of advertising and generative AI, which touches on information retrieval and user behavior modeling. However, the focus is on the commercial aspect and the challenge of making it trustworthy, rather than the core IR and NLP themes of query understanding, ranking models, and deep semantic understanding.
...
### 30. Prompt2Fingerprint: Plug-and-Play LLM Fingerprinting via Text-to-Weight Generation
...
- **Submitted**: 2026-05-18 14:30:32
- **Topic Keywords**: rag, rank
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and related topics, particularly in the context of large language models (LLMs). However, it does not directly align with your primary focus on Information Retrieval, query understanding, ranking models, or user behavior modeling. The paper's focus on model provenance tracking and fingerprinting is an interesting application, but it does not seem to be a central match for your research interests.
...
### 31. DADF: A Distribution-Aware Debiasing Framework for Watch-Time Regression in Recommender Systems

- **LLM Score**: 2
- **Keyword Score**: 10
- **Authors**: Yiqing Yang, Xinlong Zhao, Zhao Liu, Xiao Lv, Ruiming Tang, Han Li, Kun Gai
- **URL**: <http://arxiv.org/abs/2605.17863v1>
- **Submitted**: 2026-05-18 05:14:50
- **Comment**: 12 pages, 7 figures, 3 tables
- **Topic Keywords**: ranking, pointwise, rag, recommend, rank
- **Reason**: This paper is primarily focused on recommender systems, specifically watch-time regression, which is not a core area of interest for you. While it does involve some aspects of ranking quality, the context is more aligned with recommender systems than information retrieval or search technologies.
...
### 32. Easier to Judge than to Find: Predicting In-Context Learning Success for Demonstration Selection

- **LLM Score**: 2
- **Keyword Score**: 9
- **Authors**: Haochun Wang, Chaofen Yang, Jiatong Liu, Jingbo Wang, Zewen Qiang, Sendong Zhao, Bing Qin, Ting Liu
- **URL**: <http://arxiv.org/abs/2605.18512v1>
- **Submitted**: 2026-05-18 15:03:59
- **Comment**: ICML 2026
- **Topic Keywords**: query, queries, rag, search
- **Reason**: This paper focuses on in-context learning and demonstration selection, which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it involves query understanding and ranking models, the context is specific to in-context learning and does not align with the user's broader interests in e-commerce, NLP, and data mining.
...
### 33. Unlocking Biological Workflows for Robust Protein-Text Question Answering: A Dual-Dimensional RAG Framework

- **LLM Score**: 2
- **Keyword Score**: 8
- **Authors**: Li Ding, Duanyu Feng, Chen Huang, Yangshuai Wang, Yang Li, Wenqiang Lei, See-Kiong Ng
- **URL**: <http://arxiv.org/abs/2605.17261v1>
- **Submitted**: 2026-05-17 05:03:24
- **Topic Keywords**: queries, rag, retrieval, search
- **Reason**: This paper is not relevant to your research interests as it focuses on biological workflows and protein-text question answering, which is outside your primary areas of interest in Information Retrieval and Search technologies, particularly query understanding, ranking models, and user behavior modeling.
...
### 34. RAG-based EEG-to-Text Translation Using Deep Learning and LLMs

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Enrico Collautti, Xiaopeng Mao, Luca Tonin, Stefano Tortora, Sadasivan Puthusserypady
- **URL**: <http://arxiv.org/abs/2605.17503v1>
- **Submitted**: 2026-05-17 15:31:30
- **Comment**: 6 pages, 2 figures. Submitted to the 2026 IEEE International Conference on Systems, Man, and Cybernetics
- **Topic Keywords**: rag, ctr, retrieval, search
- **Reason**: This paper is not relevant to your research interests as it focuses on EEG-to-text translation using deep learning and LLMs, which is outside the scope of information retrieval, search technologies, and natural language processing. The paper's application in brain-computer interface research is also unrelated to your background in e-commerce and interests in query understanding, ranking models, and user behavior modeling.
...
### 35. An Empirical Study of Privacy Leakage Chains via Prompt Injection in Black-Box Chatbot Environments

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Hongjang Yang, Hyunsik Na, Daeseon Choi
- **URL**: <http://arxiv.org/abs/2605.18133v1>
- **Submitted**: 2026-05-18 09:38:18
- **Comment**: 9 pages, 2 figures
- **Topic Keywords**: query, ltr
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus is on privacy leakage in chatbot environments, which is outside your primary areas of interest.
...
### 36. AMARIS: A Memory-Augmented Rubric Improvement System for Rubric-Based Reinforcement Learning

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Peilin Wu, Xinlu Zhang, Kun Wan, Wentian Zhao, Gang Wu, Xinya Du, Zhiyu Chen
- **URL**: <http://arxiv.org/abs/2605.18592v1>
- **Submitted**: 2026-05-18 16:06:27
- **Comment**: Preprint. Under review
- **Topic Keywords**: pairwise, retrieval
- **Reason**: This paper focuses on rubric-based reinforcement learning, which is not a core area of interest for you. While it does involve some elements of learning to rank and reward shaping, the context is not directly related to information retrieval or search technologies.
...
- **Submitted**: 2026-05-18 11:12:45
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on improving the performance of large language models through efficient long context generation, but it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 38. Leveraging Graph Structure in Seq2Seq Models for Knowledge Graph Link Prediction
...
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on knowledge graph link prediction using a novel framework that integrates graph structure with sequence-to-sequence models. While it involves NLP and graph-based techniques, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 39. Protection Is (Nearly) All You Need: Structural Protection Dominates Scoring in Globally Capped KV Eviction

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Gabriel Garcia
- **URL**: <http://arxiv.org/abs/2605.18053v1>
- **Submitted**: 2026-05-18 08:41:34
...
- **Topic Keywords**: pairwise, retrieval
- **Reason**: This paper appears to be focused on cache eviction in a specific context, using transformer models and attention mechanisms. While it involves ranking and optimization, the topics are not directly related to information retrieval, query understanding, or user behavior modeling, which are core areas of your research interests.
...
### 40. Firefly: Illuminating Large-Scale Verified Tool-Call Data Generation from Real APIs
...
- **URL**: <http://arxiv.org/abs/2605.17558v1>
- **Submitted**: 2026-05-17 17:38:17
- **Topic Keywords**: pairwise, retrieval
- **Reason**: This paper appears to be primarily focused on tool-call data generation and reinforcement learning (RL) in the context of MCP servers, which is not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While the paper mentions a retrieval-augmented simulator, it is used for RL, not for information retrieval or search. The user's background in e-commerce may be tangentially relevant, but the paper's focus on tool-call data generation and RL makes it a poor match for the user's research interests.
...
### 41. LongMINT: Evaluating Memory under Multi-Target Interference in Long-Horizon Agent Systems
...
- **Submitted**: 2026-05-18 15:43:35
- **Comment**: Equal contribution; order decided by a coin flip. Code and data: https://github.com/amy-hyunji/LongMINT
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus on memory-augmented agents and long-horizon systems is more aligned with Artificial Intelligence and Machine Learning, which is not a primary area of interest for you.
...
### 42. What is Holding Back Latent Visual Reasoning?

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: André G. Viveiros, Nuno Gonçalves, André F. T. Martins, Matthias Lindemann
- **URL**: <http://arxiv.org/abs/2605.18445v1>
- **Submitted**: 2026-05-18 14:14:49
- **Topic Keywords**: rag, acl
- **Reason**: This paper focuses on latent visual reasoning in Vision-Language Models, which is not a primary area of interest for you. While it touches on some related concepts, it does not align with your core research themes in Information Retrieval, Search technologies, or Natural Language Processing.
...
### 43. Learning Transferable Topology Priors for Multi-Agent LLM Collaboration Across Domains

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Taolin Zhang, Zijie Zhou, Jiuheng Wan, Tingyuan Hu, Chengyu Wang, Xiaofeng He, Richang Hong
- **URL**: <http://arxiv.org/abs/2605.17359v1>
- **Submitted**: 2026-05-17 09:55:18
- **Topic Keywords**: query, search
- **Reason**: This paper focuses on multi-agent large language model collaboration, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP aspects, the primary focus is on collaboration and transferable topology priors, making it somewhat tangential to the user's research areas.
...
### 44. ChemVA: Advancing Large Language Models on Chemical Reaction Diagrams Understanding

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Mingyang Rao, Kehua Feng, Zhihui Zhu, Jiangzhen Fu, Hao Yu, Keyan Ding, Huajun Chen
- **URL**: <http://arxiv.org/abs/2605.17214v1>
- **Submitted**: 2026-05-17 01:12:50
- **Topic Keywords**: rag, ctr
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Large Language Models, the focus is on chemical reaction diagrams understanding, which is outside your primary areas of interest.
...
### 45. How do Humans Process AI-generated Hallucination Contents: a Neuroimaging Study

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Shuqi Zhu, Yi Zhong, Ziyi Ye, Bangde Du, Yujia Zhou, Qingyao Ai, Yiqun Liu
- **URL**: <http://arxiv.org/abs/2605.16953v1>
- **Submitted**: 2026-05-16 12:08:22
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The focus on cognitive mechanisms and neuroimaging in humans processing AI-generated hallucinations is more aligned with AI safety and cognitive science, which is not a central theme in your research.
...
### 46. PaliBench: A Multi-Reference Blueprint for Classical Language Translation Benchmarks

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Máté Metzger, Nadnapang Phophichit
- **URL**: <http://arxiv.org/abs/2605.16881v1>
- **Submitted**: 2026-05-16 08:43:01
- **Comment**: Preprint. This manuscript has not yet been peer reviewed
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is about machine translation benchmarks for classical languages, which is somewhat related to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The focus on classical languages and translation benchmarks is not a central match for your research interests.
...
### 47. CompactAttention: Accelerating Chunked Prefill with Block-Union KV Selection

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Jiwon Song, Dongwon Jo, Beomseok Kang, Jae-Joon Kim
- **URL**: <http://arxiv.org/abs/2605.16839v1>
- **Submitted**: 2026-05-16 06:47:41
- **Topic Keywords**: query, search
- **Reason**: This paper focuses on accelerating attention computation for large language models, proposing a new mechanism called CompactAttention. While it is related to search technologies and NLP, it does not directly align with the user's core research themes in query understanding, ranking models, or user behavior modeling.
...
### 48. UniER: A Unified Benchmark for Item-level and Path-level Exercise Recommendation

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Xinghe Cheng, Guiyong Zhuang, Yusheng Xie, Jiapu Wang, Yixin Liu, Quanlong Guan, Liangda Fang, Shirui Pan
- **URL**: <http://arxiv.org/abs/2605.16750v1>
- **Submitted**: 2026-05-16 02:07:58
- **Topic Keywords**: rag, recommend, search
- **Reason**: This paper focuses on exercise recommendation in education, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves recommendation systems, it is not centered around deep semantic understanding or real-time relevance optimization, which are key areas of interest for the user.
...
### 49. EnvFactory: Scaling Tool-Use Agents via Executable Environments Synthesis and Robust RL
...
- **Submitted**: 2026-05-18 17:37:40
- **Comment**: 11 pages
- **Topic Keywords**: queries
- **Reason**: This paper appears to be unrelated to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on tool-use agents, executable environments synthesis, and Agentic Reinforcement Learning seems to be more aligned with Artificial Intelligence and Robotics, which is not a primary area of interest for the user.
...
### 50. IVF-TQ: Streaming-Robust Approximate Nearest Neighbor Search via a Codebook-Free Residual Layer

- **LLM Score**: 0
- **Keyword Score**: 5
- **Authors**: Tarun Sharma
- **URL**: <http://arxiv.org/abs/2605.17415v1>
- **Submitted**: 2026-05-17 12:22:49
- **Topic Keywords**: ranking, rank, search
- **Reason**: This paper focuses on Approximate Nearest Neighbor Search, a topic not directly related to the user's core research themes in Information Retrieval, Search technologies, and Natural Language Processing.
