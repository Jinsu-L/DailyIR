...
- **Submitted**: 2026-07-22 04:45:10
- **Comment**: Project Page: https://rubric4setwise.github.io/
- **Topic Keywords**: ranking, rerank, relevance, rag, retrieval, rank, search
- **Reason**: This paper is highly relevant to Information Retrieval, particularly in the context of large language models and AI agents. The authors propose a new framework for evaluating and optimizing document sets, which aligns with the user's interest in query understanding, ranking models, and real-time relevance optimization. While the focus is on document set quality rather than individual document ranking, the paper's emphasis on semantic understanding and evaluation metrics makes it a useful contribution to the field.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Setwise evaluation of large‑language‑model search pipelines
- **Aim**: Introduce an evaluate‑diagnose‑optimize framework, build SetwiseEvalKit benchmark, and develop Rubric4Setwise for training‑free set selection
- **Rationale**: Current metrics (e.g., nDCG) score documents independently, ignoring redundancy, conflict, and complementarity that explain set performance
- **Ground**: SetwiseEvalKit offers ~28K high‑quality rubrics across 3 hierarchical levels and 9 dimensions, covering short‑form and long‑form scenarios
- **Experiment**: Systematic evaluation of 12 rerankers shows ≤45% rubric coverage and weak cross‑document coordination; Rubric4Setwise transforms rubric signals into set‑selection cues, achieving best downstream generation with fewer documents and iterations, maintaining state‑of‑the‑art across both scenarios
- **Takeaway**: Directly linking evaluation to optimization via setwise metrics and Rubric4Setwise improves search pipeline performance and highlights the necessity of inter‑document interaction analysis
...
- **URL**: <http://arxiv.org/abs/2607.19987v2>
- **Submitted**: 2026-07-22 10:20:40
- **Comment**: 11 pages, 6 figures, and 7 tables. Code and data: https://github.com/salmon1802/UniRank
- **Topic Keywords**: ranking, pointwise, recommend, commerce, e-commerce, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in ranking models and user behavior modeling. The focus on unified sequential modeling and feature interaction aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the specific application to online advertising and recommender systems is somewhat outside your primary focus on e-commerce, but still within the broader scope of IR.
...
### 3. CIR at iKAT SCAI 2026: Exploring Clarification Need Prediction in Agentic Conversational Search

- **LLM Score**: 6
- **Keyword Score**: 16
- **Authors**: Nolwenn Bernard, Jüri Keller, Philipp Schaer
- **URL**: <http://arxiv.org/abs/2607.19801v1>
- **Submitted**: 2026-07-22 06:29:17
- **Topic Keywords**: information retrieval, query, ranking, rerank, retrieval, rank, search
- **Reason**: The paper explores conversational search, which is related to information retrieval and query understanding. However, the focus on clarification need prediction and clarification question generation is somewhat specific and not directly aligned with the user's primary interests in ranking models and user behavior modeling.
...
- **Submitted**: 2026-07-22 02:27:51
- **Topic Keywords**: search
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), particularly in the context of query understanding and ranking models. However, the focus on open-ended question answering and reasoning-based evaluation is not directly aligned with your primary interests in search technologies and user behavior modeling. The paper's emphasis on reference-free evaluation and LLM-generated outputs is also somewhat tangential to your core research themes.
...
### 5. TriAgent: Divergence-Aware Multi-Agent Committees for Cost-Efficient Financial Sentiment Analysis

- **LLM Score**: 4
- **Keyword Score**: 9
- **Authors**: Isabel Xu, Cynthia Xu, Rachel Ren, Cong Guo, Jiacheng Ding
- **URL**: <http://arxiv.org/abs/2607.19794v1>
- **Submitted**: 2026-07-22 06:20:32
- **Topic Keywords**: query, queries, pairwise
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), specifically in the context of financial sentiment analysis and LLM-based systems. However, the focus on cost-efficient financial sentiment analysis and multi-agent committees is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 6. Personalized Recommendation Tool Learning via Autonomous Language Agents

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Mingdai Yang, Zhiwei Liu, Weizhi Zhang, Yibo Wang, Hao Peng, Philip Yu
- **URL**: <http://arxiv.org/abs/2607.19739v1>
- **Submitted**: 2026-07-22 04:10:41
- **Comment**: 6 pages. Accepted by RecSys'26
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: The paper explores recommender systems using large language models, which is somewhat related to the user's interests in Information Retrieval and NLP. However, the focus on recommender systems and personalized recommendation tools is not the user's primary area of interest, and the paper does not directly address query understanding, ranking models, or user behavior modeling.
...
### 7. TalentCLEF at CLEF2026: Skill and Job Title Intelligence for Human Capital Management
...
- **URL**: <http://arxiv.org/abs/2607.20009v1>
- **Submitted**: 2026-07-22 10:51:28
- **Topic Keywords**: ranking, rank, search
- **Reason**: The paper is somewhat related to the user's interests in Natural Language Processing (NLP) and Information Retrieval (IR), particularly in the context of Human Capital Management. However, the focus on talent matching and job-skill classification is not directly aligned with the user's primary research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 8. Overview of FinMMEval 2026 Task 2: Multilingual Financial Short-Answer Question Answering
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, specifically in the context of question answering and retrieval-augmented generation. However, it focuses on a specific task (financial short-answer question answering) and domain (multilingual financial question answering), which is not directly aligned with your core research themes. While it touches on some relevant concepts, it does not appear to be a central match for your interests.
...
### 9. Notes to Self: Can LLMs Benefit from Experiential Abstractions?

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Chang Liu, Xinyu Li, Artur Dubrawski
- **URL**: <http://arxiv.org/abs/2607.20372v1>
- **Submitted**: 2026-07-22 17:02:34
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper explores the application of experiential abstractions to Large Language Models (LLMs), which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on LLMs and their performance on mathematical and logical reasoning benchmarks is not directly aligned with the user's core research themes in IR and Search technologies. The connection to NLP is relevant, but the paper's scope is relatively narrow and does not address user behavior modeling or real-time relevance optimization.
...
### 10. VizRAG: Enhancing Retrieval-Augmented Generation with Hypergraph Visualization

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Yanbin Wei, Yang Chen, Renling Gan, Ziru Liu, Xinyu Fu, Chun Kang, Ning Lu, Rui Liu, Yu Zhang, James Kwok
- **URL**: <http://arxiv.org/abs/2607.19830v1>
- **Submitted**: 2026-07-22 07:09:46
- **Topic Keywords**: rag, retrieval
- **Reason**: The paper discusses Retrieval-Augmented Generation (RAG) systems, which is related to Information Retrieval, but the focus on visual hypergraph structure awareness and multimodal large language models (MLLMs) with enhanced visual capabilities is not directly aligned with your core research themes of query understanding, ranking models, and user behavior modeling.
...
### 11. PoTRE: Test-Time Reasoning inspired by Cognitive Heterogeneity

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Anmol Kankariya, Sercan Ö. Arık
- **URL**: <http://arxiv.org/abs/2607.20268v1>
- **Submitted**: 2026-07-22 15:20:53
- **Comment**: Accepted at Transactions on Machine Learning Research (TMLR 2026)
- **Topic Keywords**: ctr, search
- **Reason**: This paper introduces a novel framework for improving large language model reasoning capabilities, but its focus on complex reasoning and heterogeneous architectures does not directly align with the user's primary research interests in information retrieval, query understanding, and ranking models. While it touches on aspects of deep semantic understanding, the paper's primary contributions are in the realm of natural language processing and cognitive heterogeneity, making it somewhat related but not a central match for the user's research interests.
...
### 12. emb-diversity: A Tool for Embedding-Based Measurement of Data Diversity

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Cantao Su, Menan Velayuthan, Esther Ploeger, Dong Nguyen, Anna Wegmann
- **URL**: <http://arxiv.org/abs/2607.19848v1>
- **Submitted**: 2026-07-22 07:33:55
- **Topic Keywords**: rag, search
- **Reason**: This paper is somewhat related to the user's interests in Natural Language Processing (NLP) and data diversity, but it does not directly address query understanding, ranking models, or user behavior modeling, which are core research themes. The paper's focus on embedding-based diversity measurement is also somewhat tangential to the user's primary focus on information retrieval and real-time relevance optimization.
...
### 13. Reinforcement Learning for Large Language Model Selective Evidence Adoption from Contaminated Retrieval Results

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Yanyu Chen, Yue Li, Yongyi Cui, Dongsheng Shi, Lichang Dai
- **URL**: <http://arxiv.org/abs/2607.20090v1>
- **Submitted**: 2026-07-22 12:45:04
- **Topic Keywords**: retrieval
- **Reason**: The paper explores selective evidence adoption in large language models, which is related to query understanding and ranking models in Information Retrieval. However, the focus on large language models and selective evidence adoption is somewhat tangential to the user's core research themes in IR and Search technologies. The connection to user behavior modeling is also indirect, as the paper primarily deals with model improvement rather than user behavior.
...
### 14. Using Hierarchical Controlled Vocabularies to Understand CLIP Retrieval Failures in Historical Photo Collections

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Ratan Sebastian, Anett Hoppe, Christoph Rippe, Ralph Ewerth
- **URL**: <http://arxiv.org/abs/2607.19836v1>
- **Submitted**: 2026-07-22 07:16:20
- **Topic Keywords**: retrieval
- **Reason**: This paper explores the use of controlled vocabularies in content-based image retrieval, specifically with vision-language models like CLIP. While it touches on query understanding and ranking models, the focus is more on the structural properties of vocabularies and their impact on retrieval performance. The paper's relevance to information retrieval and NLP is somewhat related, but it doesn't directly address user behavior modeling or deep semantic understanding.
...
- **Submitted**: 2026-07-22 06:57:55
- **Comment**: under review
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat relevant to your research interests in Information Retrieval and Natural Language Processing, as it deals with preference alignment and reinforcement learning for LLMs. However, the focus on preference alignment and LLMs is not directly related to your core areas of interest in query understanding, ranking models, and user behavior modeling. The paper's relevance is also limited by its focus on a specific application (LLM preference alignment) rather than a broader area like search technologies.
...
### 16. The Maskability Index: Predicting Task-Objective Alignment in Pretrained Language Models

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Ahmad Pouramini, Mahsa Afsharzadeh
- **URL**: <http://arxiv.org/abs/2607.20265v1>
- **Submitted**: 2026-07-22 15:19:23
- **Topic Keywords**: rank
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on a specific aspect of language model prompting strategies, which is not a central match to your primary focus on Information Retrieval, especially in areas that require real-time relevance optimization.
...
- **Submitted**: 2026-07-22 07:30:39
- **Topic Keywords**: search
- **Reason**: This paper introduces a self-supervised framework for uncovering latent factual structure in natural language sentences, which is somewhat related to information retrieval and NLP, but does not directly address query understanding, ranking models, or user behavior modeling. The focus on knowledge graph completion and commonsense question answering suggests some overlap with IR, but the paper's emphasis on symbolic knowledge and natural language generation is not a central match for the user's research interests.
...
### 19. PyroDash: Cost-Efficient Token-Level Small-Large Language Model Collaborative Inference

- **LLM Score**: 2
- **Keyword Score**: 5
- **Authors**: Niqi Lyu, Pengtao Shi, Wei Qiu, Jianlin Zhong, Sicong Xia, Jianyao Ma, Yicheng Ding
- **URL**: <http://arxiv.org/abs/2607.20327v1>
- **Submitted**: 2026-07-22 16:14:26
- **Comment**: 19 pages, 3 figures
- **Topic Keywords**: query, rag
- **Reason**: This paper focuses on a cost-aware framework for collaborative inference between small and large language models, which is not directly related to information retrieval, query understanding, ranking models, or user behavior modeling. While it involves language models, the primary goal is to optimize inference cost rather than improving search or retrieval performance.
...
### 20. Which Values Do LLMs Confuse? A Schwartz-Based Recognition Study
...
- **Submitted**: 2026-07-22 15:22:14
- **Comment**: 14 pages, 7 figures, 3 tables
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on the evaluation of Large Language Models (LLMs) through value recognition, which is not directly related to Information Retrieval, Search technologies, or query understanding. While it involves NLP, the specific topic of value recognition in LLMs is not a central match to your research interests.
...
### 21. Lightweight Person-Place Relation Extraction from Historical Newspapers with Dependency Graphs and Proximity Features

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Mlen-Too Wesley
- **URL**: <http://arxiv.org/abs/2607.19718v1>
- **Submitted**: 2026-07-22 03:35:56
- **Comment**: 19 pages, 4 figures. Accepted at CLEF 2026 HIPE Shared Task. To appear in CEUR Workshop Proceedings (CEUR-WS.org)
- **Topic Keywords**: ranking, rank
- **Reason**: This paper is not relevant to your research interests as it focuses on person-place relation extraction from historical newspapers, which is outside the scope of information retrieval, search technologies, and natural language processing. The paper's emphasis on relation extraction and document-level graph construction does not align with your primary focus on query understanding, ranking models, and user behavior modeling.
...
### 22. SLAI T-Rex: Full-Parameter Post-training of the DeepSeek-V4 Family on Ascend SuperPOD
...
- **Submitted**: 2026-07-22 13:49:17
- **Comment**: 73 pages, 22 figures, 20 tables
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be primarily focused on optimizing large-scale model training on a specific hardware platform (Ascend NPU SuperPOD), which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it mentions a deep learning model (DeepSeek-V4), the context is more aligned with Operations Research and complex reasoning, rather than query understanding, ranking models, or user behavior modeling.
...
### 23. ENTRAP-VL: A Taxonomic Probe for Dual Contextual Entrainment in Vision-Language Models

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Karan Goyal, Afreen Hossain, Debojyoti Das, Vishal Bhutani
- **URL**: <http://arxiv.org/abs/2607.20092v1>
- **Submitted**: 2026-07-22 12:47:29
- **Topic Keywords**: query
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are core areas of your research interests. While it involves vision-language models, the focus is on contextual entrainment and its assessment, which is more relevant to NLP and multimodal understanding, but not a central match for your research themes.
...
### 24. When Does Knowledge Distillation Hurt? Reliability-Aware Distillation for Low-Resource Language Summarization
...
- **Submitted**: 2026-07-22 09:32:28
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language summarization and model compression, the focus is on reliability-aware distillation methods for low-resource language summarization, which is a specific application area not central to your interests.
...
### 25. Overview of FinMMEval 2026 Task 1: Multilingual Financial Multiple-Choice Question Answering
...
- **Submitted**: 2026-07-22 07:43:44
- **Comment**: 9 pages. Task overview paper for CLEF 2026 Working Notes (CEUR Workshop Proceedings)
- **Topic Keywords**: retrieval, rank
- **Reason**: This paper appears to be related to Natural Language Processing (NLP) and question answering, but it does not align with the user's core research themes in Information Retrieval (IR), especially query understanding, ranking models, and user behavior modeling. The focus on multilingual financial multiple-choice question answering is also outside the user's primary domain of e-commerce. While it touches on some related topics, it is not a central match for the user's research interests.
...
### 26. D2VBench: Benchmarking Large Language Models with Value Dilemmas in Daily Scenarios

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Siyi Hao, Yidi Cao, Linhao Yu, Yuqi Ren, Deyi Xiong
- **URL**: <http://arxiv.org/abs/2607.19834v1>
- **Submitted**: 2026-07-22 07:15:42
- **Comment**: 22 pages,11 figures
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be primarily focused on evaluating the value alignment of large language models, which is not directly related to your core research themes in Information Retrieval and Search technologies. While it does involve language models, the focus on value dilemmas and alignment is more aligned with NLP and AI ethics, but not a central match for your interests.
...
### 27. Learning the Arabic Dialect Continuum as a Continuous Space: A Regression Approach to Speaker Origin Prediction
...
- **Submitted**: 2026-07-22 04:47:38
- **Comment**: Under review
- **Topic Keywords**: query
- **Reason**: This paper focuses on Arabic dialect geolocation using a regression-based approach, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some NLP components, the primary goal is speaker origin prediction, which is not a central theme in your research.
...
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on Large Language Models and their safety bounds. While it involves NLP, the topic is more aligned with model evaluation and certification rather than query understanding, ranking models, or user behavior modeling.
...
### 29. Self-supervision drives representational convergence in medical foundation models more than clinical supervision
...
- **Submitted**: 2026-07-22 15:25:05
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on medical image encoders and the convergence of representations in medical foundation models, which is outside your primary areas of interest.
...
### 30. OpenSkillRisk: Benchmarking Agent Safety When Using Real-World Risky Third-Party Skills

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Qiyuan Liu, Tingfeng Hui, Kun Zhan, Kaike Zhang, Ning Miao
- **URL**: <http://arxiv.org/abs/2607.20121v2>
- **Submitted**: 2026-07-22 13:24:09
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus is on agent safety and risk assessment in open-world scenarios, which is outside your primary areas of interest.
...
### 31. JANUS: Foreseeing Latent Risk for Long-Horizon Agent Safety

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yuan Xiong, Linji Hao, Shizhu He, Yequan Wang, Lijun Li
- **URL**: <http://arxiv.org/abs/2607.19913v1>
- **Submitted**: 2026-07-22 08:43:43
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval or Search technologies, but rather focuses on Agent Safety and Long-Horizon Risk Prevention. While it involves machine learning and optimization, the context and application are quite different from the user's core research themes.
...
### 32. Adaptive Capitulation: A Structural Failure Mode of LLM Responses in Vulnerability Contexts

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Eunna Lee
- **URL**: <http://arxiv.org/abs/2607.19629v1>
- **Submitted**: 2026-07-21 23:38:59
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on the limitations and potential biases of Large Language Models (LLMs) in emotionally sensitive contexts, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on aspects of user behavior and model responses, the context and proposed solutions are more aligned with NLP and AI ethics rather than your specific areas of focus.
...
### 33. Knowledge-Centric Self-Improvement
...
- **Submitted**: 2026-07-21 21:38:39
- **Topic Keywords**: rag
- **Reason**: This paper focuses on self-improving AI systems and knowledge-centric self-improvement, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it mentions LLM families, the context is not about query understanding, ranking models, or user behavior modeling, but rather about knowledge distillation and transferability.
...
### 34. Are Single-Token Sparse Autoencoder Features Causally Necessary? Layer-Depth and SAE-Family Effects
...
- **Submitted**: 2026-07-22 17:33:16
- **Topic Keywords**: rank
- **Reason**: This paper focuses on the causal role of sparse autoencoder features in large language models, which is a topic related to Natural Language Processing (NLP). However, it does not directly relate to the user's core research interests in Information Retrieval (IR), query understanding, ranking models, or user behavior modeling, making it only loosely relevant.
...
### 35. Generative AI floods and dilutes the market for books

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Tuhin Chakrabarty, Xinyue Liu, Jane C. Ginsburg, Paramveer Dhillon
- **URL**: <http://arxiv.org/abs/2607.20349v1>
- **Submitted**: 2026-07-22 16:33:20
- **Comment**: Working Paper Under Review
- **Topic Keywords**: rank
- **Reason**: This paper appears to be unrelated to your research interests in Information Retrieval, Search technologies, and Natural Language Processing. The focus on the impact of Generative AI on the book market does not align with your areas of expertise.
...
### 36. The Blessing of Dimensionality: How Near-Orthogonality in High-Dimensional Spaces Explains Temporal Portability
...
- **Submitted**: 2026-07-22 15:48:39
- **Topic Keywords**: rank
- **Reason**: This paper is not directly related to your core research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language models, the focus is on adapting large language models for domain-specific tasks, which is not a primary area of interest for you.
...
- **Submitted**: 2026-07-22 15:01:10
- **Topic Keywords**: search
- **Reason**: This paper focuses on machine translation and culturally loaded expressions, which is somewhat related to information retrieval and search technologies. However, the paper's primary focus on machine translation and cultural contexts does not align with the user's core research themes in IR and search technologies, particularly query understanding, ranking models, and user behavior modeling.
...
### 38. Evaluating the Effectiveness of Persona Simulation in Opinion Prediction with GPT-4.1

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Sarah Y. Li, Ziyu Yao
- **URL**: <http://arxiv.org/abs/2607.20589v1>
- **Submitted**: 2026-07-22 15:00:16
- **Comment**: ICDM 2025 Undergraduate and High School Symposium
- **Topic Keywords**: search
- **Reason**: This paper focuses on persona simulation using GPT-4.1 for opinion prediction, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves large language models, the application is more aligned with opinion analysis and reaction prediction rather than query understanding, ranking models, or user behavior modeling.
...
### 39. HalluTruthQA: A Fine-Grained Benchmark for Hallucination Detection, Localization, and Explanation in Arabic Question Answering
...
- **Submitted**: 2026-07-22 14:28:28
- **Topic Keywords**: search
- **Reason**: This paper appears to be primarily focused on Surprisal Theory in computational psycholinguistics, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on large language models, the discussion is centered on representational and algorithmic-level commitments, which does not align with your interests in query understanding, ranking models, and user behavior modeling.
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves Named Entity Recognition (NER), it is focused on a specific task in labor market research and does not address query understanding, ranking models, or user behavior modeling.
...
### 42. Zero-Observation User Reactivation with Gap-Driven Dimensional Gating

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Jiandong Ding, Tianying Liu, Fuyuan Liu, Huijie Qin, Tiandeng Wu
- **URL**: <http://arxiv.org/abs/2607.19802v1>
- **Submitted**: 2026-07-22 06:32:34
- **Comment**: Accepted at the 20th ACM Conference on Recommender Systems (RecSys 2026)
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on sequential recommendation models and proposes a method to handle zero-observation user reactivation. While it touches on user behavior modeling, it is primarily concerned with recommender systems, which is a related but secondary interest of yours. The paper does not directly address information retrieval, query understanding, or ranking models, which are your core research themes.
...
### 43. Near-Optimal Dimension Lower Bounds for Single-Vector Embeddings of Maximum Inner Product Similarity

- **LLM Score**: 0
- **Keyword Score**: 10
- **Authors**: Rajesh Jayaram, Honghao Lin, Vahab Mirrokni, David P. Woodruff
- **URL**: <http://arxiv.org/abs/2607.20393v1>
- **Submitted**: 2026-07-22 17:27:20
- **Topic Keywords**: query, queries, pairwise, rank
- **Reason**: This paper appears to be focused on dimension lower bounds for single-vector embeddings of maximum inner product similarity, which is a topic in theoretical computer science and not directly related to information retrieval, search technologies, or natural language processing. The concepts and methods discussed in the paper do not align with the user's research interests.
...
### 44. Solar Open 2 Technical Report
...
- **Submitted**: 2026-07-22 12:08:41
- **Topic Keywords**: rag, korea
- **Reason**: This paper appears to be focused on large-scale language modeling and agentic tasks, with no clear connection to information retrieval, search technologies, or user behavior modeling, which are the primary areas of interest for the user.
...
### 45. Reading and Steering Representations of Materials-Science Mechanisms in an Open-Weight Language Model

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Markus J. Buehler
- **URL**: <http://arxiv.org/abs/2607.20058v1>
- **Submitted**: 2026-07-22 12:02:49
- **Topic Keywords**: rank
- **Reason**: This paper appears to be focused on materials science and the representation of physical mechanisms in language models, which is unrelated to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 46. TINY_SCHILLER: A Drop-In German Drama Corpus for Small Language Models

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Mark Schutera
- **URL**: <http://arxiv.org/abs/2607.19992v1>
- **Submitted**: 2026-07-22 10:23:33
...
- **Topic Keywords**: search
- **Reason**: This paper appears to be focused on creating a German drama corpus for small language models, which is outside the user's primary research interests in Information Retrieval and Search technologies, particularly query understanding, ranking models, and user behavior modeling.
