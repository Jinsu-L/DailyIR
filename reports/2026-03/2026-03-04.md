...
### 1. Relevance Matters: A Multi-Task and Multi-Stage Large Language Model Approach for E-commerce Query Rewriting

- **LLM Score**: 8
- **Keyword Score**: 23
- **Authors**: Aijun Dai, Jixiang Zhang, Haiqing Hu, Guoyu Tang, Lin Liu, Ziguang Cheng
- **URL**: <http://arxiv.org/abs/2603.02555v1>
- **Submitted**: 2026-03-03 03:18:16
- **Comment**: Accepted for publication at ICDE 2026
- **Topic Keywords**: query, queries, relevance, rag, click, click-through rate, cvr, conversion rate, shopping, commerce, e-commerce, search
- **Reason**: This paper aligns well with your interests in Information Retrieval, particularly in query rewriting and relevance optimization. The focus on e-commerce search and user behavior modeling, such as click-through rate and conversion rate, also resonates with your background and research themes. However, the emphasis on large language models and query rewriting might not be a central match, hence the score of 8.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: End‑to‑End Query‑Rewriting for E‑commerce Search
- **Aim**: Generate fluent, semantically relevant rewrites that satisfy business rules and maximize clicks and conversions.
- **Rationale**: Existing systems either produce many diverse rewrites or optimize only for conversion, neglecting explicit semantic relevance, leading to misaligned results and revenue loss.
- **Ground**: Two‑stage framework: Stage 1 – Multi‑Task Supervised Fine‑Tuning (SFT) on Qwen3‑8B with relevance tagging; Stage 2 – Group Relative Policy Optimization (GRPO) that jointly optimizes relevance, productivity, increment, and rule compliance rewards. Data construction includes click‑filtering and relevance thresholding. Training uses AdamW, DeepSpeed ZeRO‑1, bfloat16 on 8 Ascend 910B NPUs (SFT) and 4 NVIDIA H800 GPUs (GRPO).
- **Experiment**: Datasets: 5.6 M SFT pairs, 36 k RL queries, 1 k offline test, 100 k recall set. Baselines: DPO, PPO, GRPO variants. Offline metrics: precision@k, recall, diversity, tag accuracy. Online A/B test on JD.com (deployed Aug 2025) shows latency compliance and improved relevance‑conversion metrics.
- **Takeaway**: Combining multi‑task supervised learning with a composite‑reward RL fine‑tuning (GRPO) yields rewrites that are fluent, relevant, rule‑compliant, and conversion‑driving, outperforming baselines both offline and online, and demonstrating the practicality of large LLMs in production e‑commerce search.
...
### 2. Reproducing and Comparing Distillation Techniques for Cross-Encoders

- **LLM Score**: 8
- **Keyword Score**: 19
- **Authors**: Victor Morand, Mathias Vast, Basile Van Cooten, Laure Soulier, Josiane Mothe, Benjamin Piwowarski
- **URL**: <http://arxiv.org/abs/2603.03010v1>
- **Submitted**: 2026-03-03 14:09:49
- **Topic Keywords**: information retrieval, listwise, pointwise, pairwise, ctr, retrieval, rank, trec
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the area of cross-encoders and ranking models. The study compares different distillation techniques for cross-encoders, which is a key aspect of query understanding and ranking models. While the focus is on transformer-based cross-encoders, the paper's emphasis on evaluation and comparison across various backbones and datasets is also relevant to your interests in user behavior modeling and real-time relevance optimization.
...
### 3. Farther the Shift, Sparser the Representation: Analyzing OOD Mechanisms in LLMs
...
- **Submitted**: 2026-03-03 18:48:15
- **Topic Keywords**: rag
- **Reason**: This paper is highly relevant to your interests in Natural Language Processing (NLP) and Large Language Models (LLMs), which is a key area of IR. The study's focus on understanding how LLMs adapt to out-of-distribution inputs and its proposed solution, Sparsity-Guided Curriculum In-Context Learning (SG-ICL), aligns with your interests in query understanding and ranking models. However, the paper's primary focus is on LLMs rather than traditional IR, which prevents it from receiving a perfect score.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Large Language Models adapt to increasing task difficulty by increasing sparsity in their last hidden representations
- **Aim**: To characterize the relationship between input difficulty (OOD shift) and internal sparsity, explain its mechanistic basis, and leverage it to improve in‑context learning via a sparsity‑guided curriculum
- **Rationale**: The authors observe a systematic, quantifiable sparsity–difficulty pattern across models and domains, suggesting an intentional adaptive mechanism that stabilizes reasoning under unfamiliar conditions
- **Ground**: Empirical evidence from multiple LLMs and domains, controlled experiments measuring sparsity versus difficulty, and a learning‑dynamic explanation that links sparsity to computation concentration in specialized subspaces
- **Experiment**: Controlled sparsity‑vs‑difficulty studies, learning‑dynamic modeling, and the design of Sparsity‑Guided Curriculum In‑Context Learning (SG‑ICL) which schedules few‑shot demonstrations based on representation sparsity; SG‑ICL is evaluated and shown to yield significant performance gains
- **Takeaway**: LLMs respond to OOD challenges by concentrating computation into sparse subspaces in the final hidden layer; this sparsity is an adaptive, intentional mechanism, and exploiting it via SG‑ICL can substantially improve in‑context learning performance
...
### 4. Model Editing for New Document Integration in Generative Information Retrieval
...
- **Submitted**: 2026-03-03 09:13:38
- **Comment**: Accepted to The Web Conference (WWW) 2026
- **Topic Keywords**: information retrieval, query, queries, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of Generative Retrieval. However, it focuses on model editing and adaptation for new document integration, which is a specific application rather than a core theme in your research. The paper's emphasis on deep semantic understanding and real-time relevance optimization is not directly addressed.
...
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of Large Language Models (LLMs) and memory retrieval. However, the focus on offloading memory retrieval to a proxy model and the use of reinforcement learning for optimization is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 6. FlashEvaluator: Expanding Search Space with Parallel Evaluation
...
- **URL**: <http://arxiv.org/abs/2603.02565v1>
- **Submitted**: 2026-03-03 03:35:34
- **Comment**: 23 pages, 2 figures
- **Topic Keywords**: recommend, rank, search, recsys
- **Reason**: The paper discusses a novel framework for improving the efficiency and accuracy of Recommender Systems and NLP tasks, which aligns with your interests in Search technologies and NLP. However, the focus on Recommender Systems and the lack of explicit mention of query understanding, ranking models, or user behavior modeling limit its relevance to your core research themes.
...
### 7. The Science Data Lake: A Unified Open Infrastructure Integrating 293 Million Papers Across Eight Scholarly Sources with Embedding-Based Ontology Alignment

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Jonas Wilinski
- **URL**: <http://arxiv.org/abs/2603.03126v1>
- **Submitted**: 2026-03-03 15:58:18
- **Comment**: 18 pages, 8 figures, 7 tables. Dataset DOI: 10.57967/hf/7850. Code: https://github.com/J0nasW/science-datalake
- **Topic Keywords**: query, pairwise, rag, recommend, search
- **Reason**: The paper presents a unified infrastructure for scholarly data, which is somewhat related to information retrieval and data mining. However, the focus on ontology alignment and embedding-based methods is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance to the e-commerce domain is also limited.
...
### 8. OneRanker: Unified Generation and Ranking with One Model in Industrial Advertising Recommendation

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Dekai Sun, Yiming Liu, Jiafan Zhou, Xun Liu, Chenchen Yu, Yi Li, Huan Yu, Jun Zhang
- **URL**: <http://arxiv.org/abs/2603.02999v2>
- **Submitted**: 2026-03-03 13:50:22
- **Topic Keywords**: ranking, rag, recommend, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but its focus on advertising recommendation systems and generative paradigms is not a central match. While it involves ranking models, the context is more aligned with recommender systems than traditional search technologies. The use of deep semantic understanding and real-time relevance optimization is also relevant, but not the primary focus of the paper.
...
### 9. Timehash: Hierarchical Time Indexing for Efficient Business Hours Search

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Jinoh Kim, Jaewon Son
- **URL**: <http://arxiv.org/abs/2603.02941v1>
- **Submitted**: 2026-03-03 12:49:41
- **Comment**: 12 pages, 2 figures, 8 tables. Submitted to VLDB 2026 Industry Track
- **Topic Keywords**: query, commerce, e-commerce, search
- **Reason**: This paper presents a novel hierarchical time indexing algorithm for efficient business hours search, which is somewhat related to information retrieval and search technologies. However, it focuses more on indexing and filtering techniques rather than query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's relevance to the e-commerce domain is also a plus, but it does not significantly contribute to the user's primary research themes.
...
### 10. SOLAR: SVD-Optimized Lifelong Attention for Recommendation
...
- **URL**: <http://arxiv.org/abs/2603.02561v1>
- **Submitted**: 2026-03-03 03:28:36
- **Comment**: 18 pages, 4 figures
- **Topic Keywords**: rag, user behavior, recommend, rank
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Search technologies, but it primarily focuses on recommender systems and attention mechanisms in sequence modeling. While it touches on the topic of real-time relevance optimization, it does not directly address query understanding, ranking models, or user behavior modeling in the context of e-commerce or deep semantic understanding.
...
### 11. Eval4Sim: An Evaluation Framework for Persona Simulation

- **LLM Score**: 4
- **Keyword Score**: 5
- **Authors**: Eliseo Bao, Anxo Perez, Xi Wang, Javier Parapar
- **URL**: <http://arxiv.org/abs/2603.02876v1>
- **Submitted**: 2026-03-03 11:30:50
- **Topic Keywords**: dense retrieval, retrieval
- **Reason**: The paper discusses an evaluation framework for persona simulation, which is related to user behavior modeling in Information Retrieval. However, the focus on conversational patterns and persona simulation is not directly aligned with the user's core research themes of query understanding, ranking models, and click models. The connection to Natural Language Processing is relevant, but not strong enough to warrant a higher score.
...
### 12. Proactive Guiding Strategy for Item-side Fairness in Interactive Recommendation

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Chongjun Xia, Xiaoyu Shi, Hong Xie, Xianzhi Wang, yun lu, Mingsheng Shang
- **URL**: <http://arxiv.org/abs/2603.03094v1>
- **Submitted**: 2026-03-03 15:32:42
- **Topic Keywords**: rag, recommend
- **Reason**: This paper focuses on recommender systems, which is a related area to information retrieval, but it doesn't directly address query understanding, ranking models, or user behavior modeling. The paper's emphasis on fairness and long-tail items in interactive recommendation environments is somewhat relevant to my interests, but it doesn't align with my primary focus on deep semantic understanding and real-time relevance optimization in information retrieval.
...
### 13. ExpGuard: LLM Content Moderation in Specialized Domains
...
- **Submitted**: 2026-03-03 04:09:49
- **Comment**: ICLR 2026
- **Topic Keywords**: rag, search
- **Reason**: The paper ExpGuard: LLM Content Moderation in Specialized Domains is somewhat related to your research interests in Information Retrieval and Natural Language Processing, as it deals with large language models and content moderation. However, the focus on safety guardrails and domain-specific contexts is not directly aligned with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 14. Learning to Generate and Extract: A Multi-Agent Collaboration Framework For Zero-shot Document-level Event Arguments Extraction

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Guangjun Zhang, Hu Zhang, Yazhou Han, Yue Fan, Yuhang Shao, Ru Li, Hongye Tan
- **URL**: <http://arxiv.org/abs/2603.02909v2>
- **Submitted**: 2026-03-03 12:03:35
- **Comment**: Accepted by AAAI 2026
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your interests in Natural Language Processing (NLP) and data mining, but it focuses on event argument extraction, which is not a central match for your primary research focus on Information Retrieval (IR) and query understanding. While it involves deep semantic understanding, the context is specific to event extraction and not directly applicable to your areas of interest.
...
### 15. OCR or Not? Rethinking Document Information Extraction in the MLLMs Era with Real-World Large-Scale Datasets

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Jiyuan Shen, Peiyue Yuan, Atin Ghosh, Yifan Mai, Daniel Dahlmeier
- **URL**: <http://arxiv.org/abs/2603.02789v1>
- **Submitted**: 2026-03-03 09:26:40
- **Topic Keywords**: rag
- **Reason**: The paper explores the application of Multimodal Large Language Models (MLLMs) in document information extraction, which is somewhat related to the user's interests in Information Retrieval and NLP. However, the focus on OCR and image processing is not a central match for the user's research themes, and the paper does not directly address query understanding, ranking models, or user behavior modeling.
...
### 16. A Directed Graph Model and Experimental Framework for Design and Study of Time-Dependent Text Visualisation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Songhai Fan, Simon Angus, Tim Dwyer, Ying Yang, Sarah Goodwin, Helen Purchase
- **URL**: <http://arxiv.org/abs/2603.02422v1>
- **Submitted**: 2026-03-02 22:06:31
- **Comment**: preprint version for TVCG submission
- **Topic Keywords**: rag
- **Reason**: The paper explores text visualization and user understanding, but its focus on directed graph models and synthetic text generation does not directly align with your interests in Information Retrieval, query understanding, ranking models, and user behavior modeling. While it touches on user behavior, it's more related to visualisation and discourse understanding rather than search or ranking.
...
### 17. Sensory-Aware Sequential Recommendation via Review-Distilled Representations

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Yeo Chan Yoon
- **URL**: <http://arxiv.org/abs/2603.02709v1>
- **Submitted**: 2026-03-03 08:00:34
- **Topic Keywords**: recommend
- **Reason**: The paper explores sensory-aware sequential recommendation, which is somewhat related to information retrieval, but it's more focused on recommender systems and NLP. The use of linguistically extracted sensory attributes and structured semantic representation learning is an interesting application of NLP, but it doesn't directly align with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
- **Submitted**: 2026-03-03 06:39:04
- **Comment**: Accepted at LREC2026
- **Topic Keywords**: search
- **Reason**: The paper explores real-time video commentary generation using multimodal LLMs, which involves query understanding and ranking models. However, it is not directly related to information retrieval, search technologies, or the e-commerce domain, which are the user's primary research interests. The paper's focus on NLP and multimodal processing is somewhat relevant, but it does not align with the user's core research themes.
...
### 19. AlphaFree: Recommendation Free from Users, IDs, and GNNs

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Minseo Jeon, Junwoo Jung, Daewon Gwak, Jinhong Jung
- **URL**: <http://arxiv.org/abs/2603.02653v1>
- **Submitted**: 2026-03-03 06:37:44
- **Comment**: 13 pages, The Web Conference (WWW) 2026
- **Topic Keywords**: recommend
- **Reason**: The paper discusses recommender systems, which is a related topic to information retrieval. However, it focuses on recommendation methods and does not directly address query understanding, ranking models, or user behavior modeling, which are core aspects of your research interests.
...
### 20. Graph-GRPO: Stabilizing Multi-Agent Topology Learning via Group Relative Policy Optimization

- **LLM Score**: 2
- **Keyword Score**: 6
- **Authors**: Yueyang Cang, Xiaoteng Zhang, Erlu Zhao, Zehua Ji, Yuhang Liu, Yuchen He, Zhiyuan Ning, Chen Yijun, Wenge Que, Li Shi
- **URL**: <http://arxiv.org/abs/2603.02701v1>
- **Submitted**: 2026-03-03 07:45:40
- **Topic Keywords**: query, queries
- **Reason**: This paper appears to be unrelated to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves optimization and learning, the context is Multi-Agent Systems and Large Language Models, which doesn't align with your focus on query understanding, ranking models, and user behavior modeling.
...
### 21. Type-Aware Retrieval-Augmented Generation with Dependency Closure for Solver-Executable Industrial Optimization Modeling

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Y. Zhong, R. Huang, M. Wang, Z. Guo, YC. Li, M. Yu, Z. Jin
- **URL**: <http://arxiv.org/abs/2603.03180v1>
- **Submitted**: 2026-03-03 17:41:34
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves NLP and retrieval-augmented generation, its focus on industrial optimization modeling and solver-executable code is not a central match for your core research themes.
...
### 22. Incremental Graph Construction Enables Robust Spectral Clustering of Texts

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Marko Pranjić, Boshko Koloski, Nada Lavrač, Senja Pollak, Marko Robnik-Šikonja
- **URL**: <http://arxiv.org/abs/2603.03056v1>
- **Submitted**: 2026-03-03 14:54:22
- **Comment**: MP and BK contributed equally
- **Topic Keywords**: rag, ctr
- **Reason**: This paper focuses on spectral clustering of text embeddings, which is a topic related to Information Retrieval, but it does not directly address query understanding, ranking models, or user behavior modeling. The paper's emphasis on graph construction and spectral clustering does not align with the user's primary research interests in deep semantic understanding and real-time relevance optimization.
...
### 23. ITLC at SemEval-2026 Task 11: Normalization and Deterministic Parsing for Formal Reasoning in LLMs
...
- **Submitted**: 2026-03-03 07:02:45
- **Topic Keywords**: ranking, rank
- **Reason**: This paper appears to be focused on Large Language Models (LLMs) and their limitations in reasoning tasks, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the topic of NLP, the specific focus on LLMs and formal reasoning does not align with the user's interests in query understanding, ranking models, and user behavior modeling.
...
### 24. Evaluating Cross-Modal Reasoning Ability and Problem Characteristics with Multimodal Item Response Theory
...
- **Submitted**: 2026-03-03 06:51:08
- **Comment**: 24pages, 20 figures, accepted to ICLR2026
- **Topic Keywords**: ranking, rank
- **Reason**: This paper focuses on multimodal reasoning and item response theory, which is somewhat related to information retrieval and NLP. However, it does not directly address query understanding, ranking models, or user behavior modeling, making it less relevant to your core research interests.
...
### 25. Density-Guided Response Optimization: Community-Grounded Alignment via Implicit Acceptance Signals

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Patrick Gerard, Svitlana Volkova
- **URL**: <http://arxiv.org/abs/2603.03242v1>
- **Submitted**: 2026-03-03 18:36:25
- **Comment**: 27 Pages
- **Topic Keywords**: pairwise
- **Reason**: This paper focuses on community-grounded alignment in online communities, using implicit acceptance signals to optimize language models. While it touches on the idea of understanding user behavior, it is primarily concerned with community norms and preference elicitation, which is not directly related to the user's core research themes in Information Retrieval and Search technologies.
...
### 26. Learning When to Act or Refuse: Guarding Agentic Reasoning Models for Safe Multi-Step Tool Use

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Aradhye Agarwal, Gurdit Siyan, Yash Pandya, Joykirat Singh, Akshay Nambi, Ahmed Awadallah
- **URL**: <http://arxiv.org/abs/2603.03205v1>
- **Submitted**: 2026-03-03 17:59:35
- **Comment**: 24 pages, 5 figures
- **Topic Keywords**: pairwise
- **Reason**: This paper focuses on aligning language models for safe multi-step tool use, which is outside the scope of information retrieval and search technologies. While it involves deep semantic understanding, the context is not related to IR or search, and the methods are not applicable to the user's areas of interest.
...
### 27. UniSkill: A Dataset for Matching University Curricula to Professional Competencies

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Nurlan Musazade, Joszef Mezei, Mike Zhang
- **URL**: <http://arxiv.org/abs/2603.03134v1>
- **Submitted**: 2026-03-03 16:05:57
- **Comment**: LREC 2026
- **Topic Keywords**: retrieval, recommend
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are core areas of your research interests. While it involves Natural Language Processing and data mining, the focus is on skill extraction and recommendation systems, which is somewhat tangential to your primary interests.
...
### 28. TikZilla: Scaling Text-to-TikZ with High-Quality Data and Reinforcement Learning

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Christian Greisinger, Steffen Eger
- **URL**: <http://arxiv.org/abs/2603.03072v1>
- **Submitted**: 2026-03-03 15:17:56
- **Topic Keywords**: rag, search
- **Reason**: This paper focuses on Text-to-TikZ, a task that involves generating high-quality figures from textual descriptions, which is not directly related to Information Retrieval or Search technologies. Although it involves Natural Language Processing, the application domain is not relevant to the user's interests in e-commerce or real-time relevance optimization.
...
### 29. APAO: Adaptive Prefix-Aware Optimization for Generative Recommendation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yuanqing Yu, Yifan Wang, Weizhi Ma, Zhiqiang Guo, Min Zhang
- **URL**: <http://arxiv.org/abs/2603.02730v1>
- **Submitted**: 2026-03-03 08:29:15
- **Topic Keywords**: recommend, rank, search
- **Reason**: This paper focuses on generative recommendation, which is a topic related to recommender systems, but it does not align with the user's primary interest in Information Retrieval, especially in areas that require deep semantic understanding and real-time relevance optimization.
...
### 30. HateMirage: An Explainable Multi-Dimensional Dataset for Decoding Faux Hate and Subtle Online Abuse

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Sai Kartheek Reddy Kasu, Shankar Biradar, Sunil Saumya, Md. Shad Akhtar
- **URL**: <http://arxiv.org/abs/2603.02684v1>
- **Submitted**: 2026-03-03 07:26:53
- **Comment**: Accepted at LREC 2026
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves language models and NLP, its focus on hate speech detection and explainability is not a central match to your interests in query understanding, ranking models, and user behavior modeling.
...
### 31. GLoRIA: Gated Low-Rank Interpretable Adaptation for Dialectal ASR
...
- **Submitted**: 2026-03-02 23:10:09
- **Comment**: Accepted to ICASSP 2026. 5 pages
- **Topic Keywords**: rag, rank
- **Reason**: This paper is not relevant to your research interests as it focuses on Automatic Speech Recognition (ASR) and dialectal adaptation, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 32. MoD-DPO: Towards Mitigating Cross-modal Hallucinations in Omni LLMs using Modality Decoupled Preference Optimization

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Ashutosh Chaubey, Jiacheng Pang, Mohammad Soleymani
- **URL**: <http://arxiv.org/abs/2603.03192v1>
- **Submitted**: 2026-03-03 17:50:24
- **Comment**: CVPR 2026. Project Page: https://mod-dpo.github.io/
- **Topic Keywords**: rag
- **Reason**: This paper focuses on mitigating cross-modal hallucinations in large language models, which is a topic related to NLP and multimodal understanding. However, it does not directly relate to information retrieval, query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 33. APRES: An Agentic Paper Revision and Evaluation System
...
- **Submitted**: 2026-03-03 16:29:13
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to Information Retrieval, Search technologies, or query understanding, which are the core areas of your research interests. Although it touches on Natural Language Processing (NLP) through the use of Large Language Models (LLMs), the primary focus of the paper is on scientific paper revision and evaluation, which is not a central match to your research themes.
...
### 34. Interpreting Speaker Characteristics in the Dimensions of Self-Supervised Speech Features

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Kyle Janse van Rensburg, Benjamin van Niekerk, Herman Kamper
- **URL**: <http://arxiv.org/abs/2603.03096v1>
- **Submitted**: 2026-03-03 15:33:39
- **Comment**: 5 pages, 7 figures, submitted to IEEE Signal Processing Letters
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. The focus on self-supervised speech features and speaker characteristics in speech synthesis is outside the user's primary areas of interest.
...
### 35. MaBERT:A Padding Safe Interleaved Transformer Mamba Hybrid Encoder for Efficient Extended Context Masked Language Modeling

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jinwoong Kim, Sangjin Park
- **URL**: <http://arxiv.org/abs/2603.03001v1>
- **Submitted**: 2026-03-03 13:52:33
- **Comment**: 8 pages
- **Topic Keywords**: rag
- **Reason**: This paper focuses on improving the efficiency of masked language modeling using a hybrid encoder, which is not directly related to information retrieval, query understanding, ranking models, or user behavior modeling. While it involves transformer layers, the primary goal is to enhance contextual understanding in NLP, rather than addressing real-time relevance optimization or deep semantic understanding in IR.
...
### 36. ACE-Merging: Data-Free Model Merging with Adaptive Covariance Estimation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Bo Xu, Haotian Wu, Hehai Lin, Weiquan Huang, Beier Zhu, Yao Shu, Chengwei Qin
- **URL**: <http://arxiv.org/abs/2603.02945v1>
- **Submitted**: 2026-03-03 12:53:04
- **Comment**: Accepted to CVPR 2026 (Main Track)
- **Topic Keywords**: rag
- **Reason**: This paper focuses on model merging and interference resolution in a data-free setting, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some theoretical analysis, the context and application domains are quite different from your areas of expertise.
...
### 37. Guideline-Grounded Evidence Accumulation for High-Stakes Agent Verification

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Yichi Zhang, Nabeel Seedat, Yinpeng Dong, Peng Cui, Jun Zhu, Mihaela van de Schaar
- **URL**: <http://arxiv.org/abs/2603.02798v1>
- **Submitted**: 2026-03-03 09:36:43
- **Topic Keywords**: rag
- **Reason**: This paper focuses on agent verification for high-stakes decision-making, using LLM-powered agents in clinical diagnosis. While it involves some aspects of deep semantic understanding, it is primarily concerned with verification and trustworthiness, which is not directly related to information retrieval or search technologies. The paper's use of Bayesian logistic regression and uncertainty estimation is somewhat related to data mining, but the connection is tenuous.
...
### 38. From Solver to Tutor: Evaluating the Pedagogical Intelligence of LLMs with KMP-Bench
...
- **Submitted**: 2026-03-03 09:14:57
- **Topic Keywords**: rag
- **Reason**: This paper is off-topic as it focuses on the pedagogical intelligence of Large Language Models in AI mathematical tutoring, which is unrelated to Information Retrieval, Search technologies, and query understanding. While it involves Natural Language Processing, the context and application are distinct from the user's research interests.
...
- **Submitted**: 2026-03-03 08:58:20
- **Topic Keywords**: rag
- **Reason**: This paper focuses on diffusion language models and self-evaluation methods, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. Although it involves sequence regeneration and quality assessment, the context is more aligned with language model evaluation rather than query understanding, ranking models, or user behavior modeling.
...
### 40. Think, But Don't Overthink: Reproducing Recursive Language Models

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Daren Wang
- **URL**: <http://arxiv.org/abs/2603.02615v1>
- **Submitted**: 2026-03-03 05:36:44
- **Topic Keywords**: retrieval
- **Reason**: This paper focuses on reproducing and extending a Recursive Language Model framework, which is primarily related to Natural Language Processing (NLP) and Large Language Models. While it touches on the idea of processing 'near-infinite contexts', it does not explicitly address query understanding, ranking models, or user behavior modeling, making it only loosely relevant to your research interests.
...
### 41. Through the Lens of Contrast: Self-Improving Visual Reasoning in VLMs
...
- **Submitted**: 2026-03-03 03:18:31
- **Comment**: 19 pages, 9 figures, accepted to ICLR 2026 (oral)
- **Topic Keywords**: rag
- **Reason**: This paper focuses on visual language models and visual reasoning, which is not directly related to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it explores a self-improving framework for visual reasoning, it does not address query understanding, ranking models, or user behavior modeling, making it somewhat tangential to the user's core research themes.
...
### 42. No Memorization, No Detection: Output Distribution-Based Contamination Detection in Small Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Omer Sela
- **URL**: <http://arxiv.org/abs/2603.03203v1>
- **Submitted**: 2026-03-03 17:55:24
...
- **Topic Keywords**: rank
- **Reason**: This paper focuses on contamination detection in small language models, which is not directly related to information retrieval, search technologies, or query understanding. While it involves NLP, the topic is more aligned with model robustness and fine-tuning, rather than deep semantic understanding or real-time relevance optimization.
...
### 43. BeyondSWE: Can Current Code Agent Survive Beyond Single-Repo Bug Fixing?
...
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests as it focuses on code agents and their evaluation in the context of software development, which is outside your primary areas of interest in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 44. Compact Prompting in Instruction-tuned LLMs for Joint Argumentative Component Detection

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Sofiane Elguendouze, Erwan Hain, Elena Cabrio, Serena Villata
- **URL**: <http://arxiv.org/abs/2603.03095v1>
- **Submitted**: 2026-03-03 15:32:58
- **Comment**: Under Review (COLM 2026)
- **Topic Keywords**: search
- **Reason**: This paper focuses on Argumentative Component Detection, a task in Argument Mining, and uses instruction-tuned Large Language Models. While it involves NLP, it is not directly related to Information Retrieval, Search technologies, or query understanding, which are the core areas of your research interests.
...
### 45. S2CDR: Smoothing-Sharpening Process Model for Cross-Domain Recommendation
...
- **Submitted**: 2026-03-03 08:21:42
- **Comment**: This paper is accepted by WWW'2026
- **Topic Keywords**: recommend
- **Reason**: This paper focuses on cross-domain recommendation, which is somewhat related to information retrieval, but it primarily deals with recommender systems rather than search technologies or query understanding. The use of diffusion models and graph signal processing is interesting, but it's not directly applicable to the user's core research themes.
...
### 46. How Controllable Are Large Language Models? A Unified Evaluation across Behavioral Granularities
...
- **Submitted**: 2026-03-03 03:50:13
- **Comment**: Work in progress
- **Topic Keywords**: search
- **Reason**: This paper focuses on the controllability of Large Language Models, which is a topic in NLP. However, it does not directly relate to Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling, which are the core areas of your research interests.
...
### 48. Using Learning Progressions to Guide AI Feedback for Science Learning

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Xin Xia, Nejla Yuruk, Yun Wang, Xiaoming Zhai
- **URL**: <http://arxiv.org/abs/2603.03249v1>
- **Submitted**: 2026-03-03 18:39:58
- **Comment**: 15pages, 4 figures
- **Topic Keywords**: relevance
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on AI feedback for science learning and learning progressions, which is outside your core research themes.
...
### 49. TAO-Attack: Toward Advanced Optimization-Based Jailbreak Attacks for Large Language Models

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Zhi Xu, Jiaqi Li, Xiaotong Zhang, Hong Yu, Han Liu
- **URL**: <http://arxiv.org/abs/2603.03081v1>
- **Submitted**: 2026-03-03 15:25:53
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on attacks against Large Language Models, which is a topic in NLP, but it does not align with your primary focus on information retrieval and deep semantic understanding.
...
### 50. The Distribution of Phoneme Frequencies across the World's Languages: Macroscopic and Microscopic Information-Theoretic Models

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Fermín Moscoso del Prado Martín, Suchir Salhan
- **URL**: <http://arxiv.org/abs/2603.02860v1>
- **Submitted**: 2026-03-03 11:09:17
- **Topic Keywords**: rank
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on phoneme frequencies in languages, which is a topic in linguistics and phonetics, and does not appear to be related to your areas of expertise.
