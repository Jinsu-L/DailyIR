# Daily Papers Report - 2025-12-02

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. TempPerturb-Eval: On the Joint Effects of Internal Temperature and External Perturbations in RAG Robustness

- **LLM Score**: 8
- **Keyword Score**: 4
- **Authors**: Yongxin Zhou, Philippe Mulhem, Didier Schwab
- **URL**: <http://arxiv.org/abs/2512.01183v1>
- **Submitted**: 2025-12-01 01:46:36
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper is highly relevant to Information Retrieval, specifically in the context of Retrieval-Augmented Generation (RAG) systems, which aligns with your interest in query understanding and ranking models. The paper's focus on robustness and perturbation-temperature interactions also touches on user behavior modeling and real-time relevance optimization. While the e-commerce domain is not explicitly mentioned, the work's generalizability to various applications makes it a useful contribution to the field.
...
### 2. How Far Are We from Genuinely Useful Deep Research Agents?
...
- **Submitted**: 2025-12-01 17:58:59
- **Comment**: 34 pages
- **Topic Keywords**: information retrieval, retrieval, search
- **Reason**: This paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of deep semantic understanding and report synthesis. However, the focus on Deep Research Agents and report generation is not directly aligned with the user's primary interests in query understanding, ranking models, and user behavior modeling. The paper's relevance to the e-commerce domain is also unclear.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Improving Deep Research Agents (DRAs) through benchmarking and failure analysis
- **Aim**: Address limitations in DRAs by introducing standardized evaluation frameworks and failure mode analysis
- **Rationale**: Current DRAs lack standardized benchmarks for complex research tasks and lack systematic analysis of failure modes, leading to inconsistent evaluation metrics and unclear improvement pathways
- **Ground**: Existing benchmarks exhibit subjective metrics and insufficient task complexity, while failure analysis remains coarse-grained and unvalidated
- **Experiment**: Evaluated DRAs using FINDER (100 tasks, 419 checklist items) and DEFT (14 failure modes) to identify specific weaknesses in evidence integration, verification, and planning resilience
- **Takeaway**: DRAs require targeted improvements in evidence handling, verification processes, and planning robustness rather than general task comprehension enhancements
...
### 3. EmoRAG: Evaluating RAG Robustness to Symbolic Perturbations
...
- **Reason**: This paper is somewhat related to information retrieval, specifically focusing on the robustness of Retrieval-Augmented Generation (RAG) systems to symbolic perturbations. While it touches on query understanding and model vulnerability, it is not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 4. MMAG: Mixed Memory-Augmented Generation for Large Language Models Applications

- **LLM Score**: 4
- **Keyword Score**: 8
- **Authors**: Stefano Zeppieri
- **URL**: <http://arxiv.org/abs/2512.01710v1>
- **Submitted**: 2025-12-01 14:16:57
- **Topic Keywords**: relevance, rag, retrieval, personalization
- **Reason**: The paper explores the concept of memory in language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on conversational agents and language generation is not directly aligned with the user's primary research interests in IR and search technologies.
...
### 5. Conversion rate prediction in online advertising: modeling techniques, performance evaluation and future directions

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Tao Xue, Yanwu Yang, Panyu Zhai
- **URL**: <http://arxiv.org/abs/2512.01171v1>
- **Submitted**: 2025-12-01 01:02:35
- **Comment**: 99 pages, 15 figures, 7 tables
- **Topic Keywords**: ctr, cvr, conversion rate, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of online advertising and conversion rate prediction. However, it primarily focuses on conversion rate prediction, which is more closely related to recommender systems and advertising than your core areas of query understanding, ranking models, and user behavior modeling.

#### T.A.R.G.E.T. Summary (from Abstract)
- **Topic**: Conversion Rate Prediction (CVR) in Online Advertising
- **Aim**: To categorize and analyze state-of-the-art CVR prediction models, evaluate their performance, and identify research trends and challenges in the field.
- **Rationale**: CVR prediction is critical for advertising decision-making, yet existing models' relationships and comparative effectiveness remain underexplored, necessitating a systematic review to guide future research and applications.
- **Ground**: A comprehensive literature review categorizing models into six technical frameworks, with detailed analysis of their architectures, advantages, limitations, and applications in CVR prediction.
- **Experiment**: Performance evaluation of CVR models on public and proprietary datasets, alongside synthesis of trends in semantics-enriched, attribution-enhanced, debiased approaches, and joint CTR-CVR modeling.
- **Takeaway**: Key challenges include bias mitigation and joint modeling of CTR and CVR. Future directions emphasize semantics integration, attribution-aware methods, and addressing data sparsity, with implications for improving advertising efficiency and personalization.
...
- **Submitted**: 2025-12-01 04:54:03
- **Topic Keywords**: relevance, rag, personalization
- **Reason**: This paper focuses on conversational agents and emotional reasoning, which is somewhat related to user behavior modeling in search technologies. However, the primary focus on emotional support and empathy is not directly aligned with the user's core research themes in Information Retrieval and Search technologies.
...
### 7. Structured Spectral Reasoning for Frequency-Adaptive Multimodal Recommendation

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Wei Yang, Rui Zhong, Yiqun Chen, Chi Lu, Peng Jiang
- **URL**: <http://arxiv.org/abs/2512.01372v1>
- **Submitted**: 2025-12-01 07:39:28
- **Topic Keywords**: ctr, recommend, rank
- **Reason**: The paper focuses on multimodal recommendation, which is somewhat related to information retrieval and search technologies. However, the emphasis on frequency-adaptive multimodal recommendation and spectral reasoning is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling. While the paper explores data mining and related topics, it does not demonstrate a deep semantic understanding or real-time relevance optimization, which are key areas of interest for the user.
...
### 8. Exploring Human Perceptions of AI Responses: Insights from a Mixed-Methods Study on Risk Mitigation in Generative Models
...
- **Submitted**: 2025-12-01 17:12:28
- **Comment**: 16 pages, 2 figures, 6 tables. Under review for publication
- **Topic Keywords**: relevance
- **Reason**: This paper explores human perceptions of AI responses, specifically in the context of generative models. While it touches on aspects of natural language processing and evaluation, its focus on human perception and risk mitigation in AI responses is somewhat related to information retrieval, but not directly aligned with the user's core research themes of query understanding, ranking models, and user behavior modeling.
...
### 9. MARSAD: A Multi-Functional Tool for Real-Time Social Media Analysis

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Md. Rafiul Biswas, Firoj Alam, Wajdi Zaghouani
- **URL**: <http://arxiv.org/abs/2512.01369v1>
- **Submitted**: 2025-12-01 07:31:37
- **Comment**: 6 pages, 4 figures
- **Topic Keywords**: rag, search
- **Reason**: While the paper discusses natural language processing and social media analysis, it does not directly relate to information retrieval, query understanding, or ranking models. However, it does involve deep semantic understanding and real-time analysis, which are tangentially relevant to the user's interests.
...
### 10. Toward a benchmark for CTR prediction in online advertising: datasets, evaluation protocols and perspectives

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Shan Gao, Yanwu Yang
- **URL**: <http://arxiv.org/abs/2512.01179v1>
- **Submitted**: 2025-12-01 01:36:55
- **Comment**: 64 pages, 8 figures, 11 tables
- **Topic Keywords**: ctr, search
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of click-through rate (CTR) prediction, which is a crucial aspect of search technologies. However, the focus on online advertising and CTR prediction models, rather than query understanding, ranking models, or user behavior modeling, limits its relevance to your core research themes.
...
### 11. Agentic Policy Optimization via Instruction-Policy Co-Evolution

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Han Zhou, Xingchen Wan, Ivan Vulić, Anna Korhonen
- **URL**: <http://arxiv.org/abs/2512.01945v1>
- **Submitted**: 2025-12-01 17:56:29
- **Comment**: 10 pages, 3 figures, 2 tables (18 pages including references and appendices)
- **Topic Keywords**: retrieval
- **Reason**: This paper explores reinforcement learning with verifiable rewards and instruction-policy co-evolution, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on large language models and instruction optimization is more aligned with Natural Language Processing, and the paper's emphasis on multi-turn retrieval and reasoning tasks suggests a connection to recommender systems. While the paper's relevance to your core research themes is limited, it may still offer insights into real-time relevance optimization and deep semantic understanding.
...
### 12. Reasoning About the Unsaid: Misinformation Detection with Omission-Aware Graph Inference

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Zhengjia Wang, Danding Wang, Qiang Sheng, Jiaying Wu, Juan Cao
- **URL**: <http://arxiv.org/abs/2512.01728v1>
- **Submitted**: 2025-12-01 14:37:00
- **Comment**: AAAI 2026
- **Topic Keywords**: rag
- **Reason**: The paper explores misinformation detection, which is somewhat related to information retrieval, but it focuses on a specific aspect (omission-based deception) rather than query understanding, ranking models, or user behavior modeling. While it involves graph inference and relation modeling, these are not the primary areas of interest for the user. The paper's relevance is somewhat tangential to the user's core research themes.
...
### 13. LEC: Linear Expectation Constraints for False-Discovery Control in Selective Prediction and Routing Systems
...
- **Submitted**: 2025-12-01 11:27:09
- **Topic Keywords**: rag
- **Reason**: The paper focuses on selective prediction and routing systems, addressing issues in large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the primary focus on false discovery rate control and uncertainty methods in NLP does not directly align with the user's core research themes.
...
### 14. Enhancing BERT Fine-Tuning for Sentiment Analysis in Lower-Resourced Languages

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Jozef Kubík, Marek Šuppa, Martin Takáč
- **URL**: <http://arxiv.org/abs/2512.01460v1>
- **Submitted**: 2025-12-01 09:45:47
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and deep semantic understanding, but it focuses on fine-tuning BERT for sentiment analysis in low-resource languages, which is not directly aligned with your primary focus on information retrieval and search technologies.
...
### 15. The Necessity of Imperfection:Reversing Model Collapse via Simulating Cognitive Boundedness

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Zhongjie Jiang
- **URL**: <http://arxiv.org/abs/2512.01354v2>
- **Submitted**: 2025-12-01 07:09:38
...
- **Topic Keywords**: acl
- **Reason**: This paper explores a novel approach to generating synthetic data by simulating human cognitive processes, which is somewhat related to query understanding and user behavior modeling in Information Retrieval. However, the focus on cognitive limitations and synthetic data generation is not directly aligned with the user's primary interests in ranking models, click models, and real-time relevance optimization.
...
### 16. When Safety Blocks Sense: Measuring Semantic Confusion in LLM Refusals
...
- **Topic Keywords**: rag
- **Reason**: The paper discusses a specific issue in language models, namely semantic confusion, which is related to query understanding and ranking models. However, the focus is on safety-aligned language models and their evaluation, rather than information retrieval or search technologies. While the paper touches on the idea of understanding and optimizing model behavior, it is not directly aligned with the user's core research themes.
...
### 17. LLM CHESS: Benchmarking Reasoning and Instruction-Following in LLMs through Chess
...
- **Submitted**: 2025-12-01 18:51:08
- **Topic Keywords**: rank
- **Reason**: The paper explores the generalization of reasoning and instruction-following abilities in large language models (LLMs) through a chess-based evaluation framework. While it touches on aspects of model behavior, it does not directly relate to information retrieval, search technologies, or user behavior modeling, which are core areas of your research interests.
...
### 18. OPOR-Bench: Evaluating Large Language Models on Online Public Opinion Report Generation

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: Jinzheng Yu, Yang Xu, Haozhen Li, Junqi Li, Yifan Feng, Ligu Zhu, Hao Shen, Lei Shi
- **URL**: <http://arxiv.org/abs/2512.01896v1>
- **Submitted**: 2025-12-01 17:18:02
- **Comment**: 27 pages, accepted by CMC-Computers, Materials & Continua, 2025
- **Topic Keywords**: search
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval and Natural Language Processing, particularly in the context of automated report generation and large language models. However, the focus on online public opinion report generation and crisis management is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 19. HalluGraph: Auditable Hallucination Detection for Legal RAG Systems via Knowledge Graph Alignment

- **LLM Score**: 2
- **Keyword Score**: 7
- **Authors**: Valentin Noël, Elimane Yassine Seidou, Charly Ken Capo-Chichi, Ghanem Amari
- **URL**: <http://arxiv.org/abs/2512.01659v1>
- **Submitted**: 2025-12-01 13:31:06
- **Comment**: 8 pages, 4 figures, under review
- **Topic Keywords**: query, rag, retrieval
- **Reason**: This paper focuses on hallucination detection in Legal RAG systems, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves knowledge graph alignment, the context is specific to legal applications and does not align with your background in e-commerce or interests in deep semantic understanding and real-time relevance optimization.
...
- **URL**: <http://arxiv.org/abs/2512.01316v1>
- **Submitted**: 2025-12-01 06:16:47
- **Comment**: IJCNLP-AACL 2025 Main
- **Topic Keywords**: pairwise, rag
- **Reason**: This paper focuses on machine translation and decoding methods, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves probabilistic modeling and optimization, the context is specific to translation quality and computational cost, rather than query understanding, ranking models, or user behavior modeling.
...
### 21. StreamGaze: Gaze-Guided Temporal Reasoning and Proactive Understanding in Streaming Videos
...
- **Submitted**: 2025-12-01 14:15:44
- **Comment**: Project page: https://streamgaze.github.io/
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves understanding user behavior, it focuses on gaze signals in streaming videos, which is outside your primary areas of interest.
...
### 22. MCAT: Scaling Many-to-Many Speech-to-Text Translation with MLLMs to 70 Languages
...
- **Submitted**: 2025-12-01 10:39:12
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests as it focuses on Speech-to-Text Translation and Large Language Models, which are outside your primary areas of interest in Information Retrieval and Natural Language Processing.
...
### 23. ZIP-RC: Zero-overhead Inference-time Prediction of Reward and Cost for Adaptive and Interpretable Generation

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Rohin Manvi, Joey Hong, Tim Seyde, Maxime Labonne, Mathias Lechner, Sergey Levine
- **URL**: <http://arxiv.org/abs/2512.01457v1>
- **Submitted**: 2025-12-01 09:44:31
- **Comment**: Code coming soon
- **Topic Keywords**: rag
- **Reason**: This paper focuses on adaptive inference methods for large language models, which is a related but distinct area from information retrieval and search technologies. While it touches on aspects of real-time optimization, its primary contribution is in the realm of meta-cognition and efficient reasoning, which is not a central match to the user's research interests.
...
### 24. Securing Large Language Models (LLMs) from Prompt Injection Attacks

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Omar Farooq Khan Suri, John McCrae
- **URL**: <http://arxiv.org/abs/2512.01326v1>
- **Submitted**: 2025-12-01 06:34:20
- **Comment**: 10 pages, 1 figure, 1 table
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. It focuses on securing Large Language Models from prompt injection attacks, which is a topic in Natural Language Processing, but not aligned with your core research themes.
...
### 25. Pay Attention Later: From Vector Space Diffusion to Linearithmic Spectral Phase-Locking

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Alper Yıldırım, İbrahim Yücedağ
- **URL**: <http://arxiv.org/abs/2512.01208v1>
- **Submitted**: 2025-12-01 02:46:15
- **Comment**: 12 pages, 5 figures
- **Topic Keywords**: ctr
- **Reason**: This paper focuses on improving the Transformer architecture, specifically addressing the 'Semantic Alignment Tax' and 'Catastrophic Rigidity' issues. While it explores a novel approach to semantic understanding, it does not directly relate to information retrieval, query understanding, or ranking models, which are core areas of your research interests.
...
### 26. DrawingBench: Evaluating Spatial Reasoning and UI Interaction Capabilities of Large Language Models through Mouse-Based Drawing Tasks

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Hyunjun Kim, Sooyoung Ryu
- **URL**: <http://arxiv.org/abs/2512.01174v1>
- **Submitted**: 2025-12-01 01:18:21
- **Comment**: AAAI 2026 TrustAgent Workshop
- **Topic Keywords**: rag
- **Reason**: This paper focuses on evaluating the trustworthiness of large language models through spatial reasoning tasks, which is not directly related to information retrieval, search technologies, or query understanding. While it involves natural language processing, the context is more aligned with AI trust and reliability, making it less relevant to your core research interests.
...
### 27. BHRAM-IL: A Benchmark for Hallucination Recognition and Assessment in Multiple Indian Languages

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Hrishikesh Terdalkar, Kirtan Bhojani, Aryan Dongare, Omm Aditya Behera
- **URL**: <http://arxiv.org/abs/2512.01852v1>
- **Submitted**: 2025-12-01 16:37:34
- **Comment**: Accepted at BHASHA Workshop @ IJCNLP/AACL 2025
- **Topic Keywords**: search
- **Reason**: This paper focuses on hallucination detection in multilingual applications, which is outside your primary research interests in Information Retrieval and Search technologies. While it involves Natural Language Processing, the specific topic of hallucination detection in under-resourced languages is not directly related to your core research themes.
...
### 28. Self-Supervised Borrowing Detection on Multilingual Wordlists

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Tim Wientzek
- **URL**: <http://arxiv.org/abs/2512.01713v1>
- **Submitted**: 2025-12-01 14:20:03
- **Comment**: 29 pages, 3 figures, 12 tables
- **Topic Keywords**: search
- **Reason**: This paper focuses on borrowing detection in multilingual wordlists, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves NLP, the specific application and methodology are not aligned with your areas of focus.
...
### 29. BackportBench: A Multilingual Benchmark for Automated Backporting of Patches

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Zhiqing Zhong, Jiaming Huang, Pinjia He
- **URL**: <http://arxiv.org/abs/2512.01396v1>
- **Submitted**: 2025-12-01 08:16:43
- **Comment**: Under review
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, or user behavior modeling. While it involves software development and patch backporting, the focus is on automated backporting techniques and their evaluation, which does not align with your primary research themes.
...
### 30. Stabilizing Reinforcement Learning with LLMs: Formulation and Practices
...
- **URL**: <http://arxiv.org/abs/2512.01374v2>
- **Submitted**: 2025-12-01 07:45:39
- **Topic Keywords**: search
- **Reason**: This paper focuses on reinforcement learning with large language models, which is not directly related to information retrieval or search technologies. While it touches on optimization techniques, it does not address query understanding, ranking models, or user behavior modeling, making it less relevant to your research interests.
...
### 31. Mode-Conditioning Unlocks Superior Test-Time Scaling

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Chen Henry Wu, Sachin Goyal, Aditi Raghunathan
- **URL**: <http://arxiv.org/abs/2512.01127v1>
- **Submitted**: 2025-11-30 22:36:20
- **Topic Keywords**: search
- **Reason**: This paper focuses on improving test-time scaling in machine learning models, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on model efficiency and diversity, the context is more aligned with deep learning and model optimization rather than query understanding, ranking models, or user behavior modeling.
...
### 32. How do we measure privacy in text? A survey of text anonymization metrics

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Yaxuan Ren, Krithika Ramesh, Yaxing Yao, Anjalie Field
- **URL**: <http://arxiv.org/abs/2512.01109v1>
- **Submitted**: 2025-11-30 22:12:30
- **Comment**: 13 pages, 1 figure, 1 table. To be published in Findings of the Association for Computational Linguistics (AACL-IJCNLP 2025). Related resources at: https://github.com/ryxGuo/privacy-metrics-survey
- **Topic Keywords**: search
- **Reason**: This paper focuses on text anonymization metrics, which is a related but distinct area from information retrieval and search technologies. While it touches on NLP, it does not directly address query understanding, ranking models, or user behavior modeling, making it less relevant to your core research interests.
...
### 33. MEGConformer: Conformer-Based MEG Decoder for Robust Speech and Phoneme Classification

- **LLM Score**: 0
- **Keyword Score**: 6
- **Authors**: Xabier de Zuazo, Ibon Saratxaga, Eva Navas
- **URL**: <http://arxiv.org/abs/2512.01443v1>
- **Submitted**: 2025-12-01 09:25:22
- **Comment**: 10 pages, 5 figures, 4 tables, LibriBrain Workshop, NeurIPS 2025
- **Topic Keywords**: ranking, rag, rank
- **Reason**: This paper is not relevant to your research interests as it focuses on speech and phoneme classification using MEG signals, which is outside the scope of information retrieval, search technologies, and natural language processing.
...
### 34. Do Large Language Models Walk Their Talk? Measuring the Gap Between Implicit Associations, Self-Report, and Behavioral Altruism

- **LLM Score**: 0
- **Keyword Score**: 4
- **Authors**: Sandro Andric
- **URL**: <http://arxiv.org/abs/2512.01568v1>
- **Submitted**: 2025-12-01 11:43:02
...
- **Reason**: The paper focuses on measuring altruistic behavior in large language models, a topic unrelated to information retrieval, ranking, query understanding, or user behavior modeling in search contexts. It does not address IR or NLP techniques relevant to your research interests.
...
### 35. Large Language Models Cannot Reliably Detect Vulnerabilities in JavaScript: The First Systematic Benchmark and Evaluation

- **LLM Score**: 0
- **Keyword Score**: 3
- **Authors**: Qingyuan Fei, Xin Liu, Song Li, Shujiang Wu, Jianwei Hou, Ping Chen, Zifeng Kang
- **URL**: <http://arxiv.org/abs/2512.01255v1>
- **Submitted**: 2025-12-01 04:00:06
- **Topic Keywords**: rag, search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The paper focuses on vulnerability detection in JavaScript using Large Language Models, which is outside your area of expertise.
...
### 36. Associative Syntax and Maximal Repetitions reveal context-dependent complexity in fruit bat communication
...
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. The study focuses on analyzing fruit bat communication patterns using unsupervised methods, which is outside your areas of expertise.
...
### 37. Generative Adversarial Gumbel MCTS for Abstract Visual Composition Generation

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Zirui Zhao, Boye Niu, David Hsu, Wee Sun Lee
- **URL**: <http://arxiv.org/abs/2512.01242v1>
- **Submitted**: 2025-12-01 03:38:44
- **Topic Keywords**: search
- **Reason**: This paper focuses on abstract visual composition generation using Generative Adversarial Networks and Monte-Carlo Tree Search, which is unrelated to the user's primary research interests in Information Retrieval, Search technologies, and Natural Language Processing.
...
### 38. Testing the Machine Consciousness Hypothesis
...
- **Topic Keywords**: search
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The topic of machine consciousness and its emergence in distributed systems is outside the scope of the user's research interests.
