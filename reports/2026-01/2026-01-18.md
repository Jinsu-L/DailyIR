# Daily Papers Report - 2026-01-18

## 🌟 Top 5 Papers with Summaries

선정된 Top 5개 논문에 대한 상세 요약입니다.

### 1. LLM-Assisted Pseudo-Relevance Feedback

- **LLM Score**: 8
- **Keyword Score**: 20
- **Authors**: David Otero, Javier Parapar
- **URL**: <http://arxiv.org/abs/2601.11238v1>
- **Submitted**: 2026-01-16 12:31:43
- **Comment**: Accepted ECIR 2026
- **Topic Keywords**: information retrieval, query, ranking, relevance, relevance feedback, rag, retrieval, rank
- **Reason**: This paper is highly relevant to Information Retrieval, specifically query expansion and pseudo-relevance feedback, which aligns with your research interests. The use of Large Language Models (LLMs) for semantic judgement also touches on your interest in deep semantic understanding and ranking models. However, it does not explicitly focus on query understanding, ranking models, or user behavior modeling, which are core areas of your research.

#### T.A.R.G.E.T. Summary (from Full Text)
- **Topic**: Hybrid LLM‑Filtered Pseudo‑Relevance Feedback for Ad‑Hoc Retrieval
- **Aim**: Enhance lexical ad‑hoc retrieval recall by denoising the pseudo‑relevant set with an LLM semantic filter while preserving RM3 interpretability.
- **Rationale**: RM3 expands queries using top‑k documents, but noisy initial retrieval causes topic drift. LLMs can judge relevance but may hallucinate; a hybrid approach uses the LLM only for binary or probability relevance judgments, filtering the PRF set before RM3 to reduce drift and maintain grounded expansion terms.
- **Ground**: RM3 estimates a relevance model from top‑k docs and interpolates with the original query. The paper introduces two variants: (1) binary LLM filtering (LLMF) followed by standard RM3; (2) probability‑weighted RM3 where the LLM’s next‑token “true” probability replaces the query‑likelihood factor. Experiments use AP88‑89, ROBUST04, MSMARCO, WT10G datasets, comparing QLD, RM3, MonoT5 rerank, MonoT5F, LLMF, and oracle baselines. Metrics: AP@1000, NDCG@100; significance via Wilcoxon + Benjamini‑Hochberg. Hyper‑parameters tuned per dataset: PRF depth k, expansion terms e, interpolation λ.
- **Experiment**: Results show RM3 outperforms QLD; MonoT5 rerank excels on DL‑20. LLMF + RM3 and LLMF + RM3 w/prob outperform plain RM3, with probability‑weighted variant yielding the best AP/NDCG. Generic LLM filtering improves over RM3 but lags behind task‑specific MonoT5F. Prompt ablation adding TREC narrative boosts both LLMF variants, especially on WT10G. Oracle upper bound indicates significant headroom. Statistical tests confirm all gains are significant.
- **Takeaway**: LLM‑filtered PRF is a lightweight, effective strategy to reduce topic drift while keeping RM3’s interpretability. Probability‑weighted RM3 after LLM filtering delivers the strongest gains. Task‑specific relevance models outperform generic LLMs, yet the generic LLM remains a useful low‑cost baseline. Prompt engineering (adding narrative) further enhances performance. Future work should explore stronger LLMs, richer prompts, and deeper PRF hyper‑parameter analysis to unlock remaining gains.
...
### 2. Can Instructed Retrieval Models Really Support Exploration?

- **LLM Score**: 8
- **Keyword Score**: 19
- **Authors**: Piyush Maheshwari, Sheshera Mysore, Hamed Zamani
- **URL**: <http://arxiv.org/abs/2601.10936v1>
- **Submitted**: 2026-01-16 01:45:29
- **Topic Keywords**: retriever, query, ranking, pairwise, relevance, retrieval, rank, search
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly query understanding and ranking models. The focus on instructed retrieval models and their application in exploratory searches aligns with your interests in deep semantic understanding and real-time relevance optimization. However, the paper's specific focus on instructed retrievers and their limitations may not be a central match for your primary research theme.
...
### 3. Rank4Gen: RAG-Preference-Aligned Document Set Selection and Ranking
...
- **Submitted**: 2026-01-16 13:19:17
- **Topic Keywords**: information retrieval, query, ranking, relevance, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval, particularly in the context of Ranking Models and user behavior modeling. The focus on generator-aware ranking and preference modeling aligns with your interests in query understanding and real-time relevance optimization. However, the specific application to RAG (Regressive Attention Generators) is a specialized area that may not be a central match for your broader research themes.
...
### 4. Validating Search Query Simulations: A Taxonomy of Measures

- **LLM Score**: 8
- **Keyword Score**: 13
- **Authors**: Andreas Konstantin Kruff, Nolwenn Bernard, Philipp Schaer
- **URL**: <http://arxiv.org/abs/2601.11412v1>
- **Submitted**: 2026-01-16 16:33:25
- **Topic Keywords**: information retrieval, query, queries, retrieval, recommend, search
- **Reason**: This paper is highly relevant to Information Retrieval, specifically focusing on the validation of user simulators and query simulations, which is closely related to query understanding and ranking models. The paper's emphasis on empirical analysis and taxonomy development aligns with the user's interests in IR and NLP. However, the paper's scope is more focused on evaluation methods rather than deep semantic understanding or real-time relevance optimization.
...
### 5. PruneRAG: Confidence-Guided Query Decomposition Trees for Efficient Retrieval-Augmented Generation
...
- **Submitted**: 2026-01-16 06:38:17
- **Topic Keywords**: query, rag, retrieval, search
- **Reason**: This paper is highly relevant to information retrieval, particularly in the context of retrieval-augmented generation, which aligns with your interests in query understanding and ranking models. The proposed framework, PruneRAG, addresses issues in current RAG architectures, such as evidence forgetting and inefficiency, which are critical areas of study in IR. While the focus is on NLP, the techniques and concepts presented have implications for IR and search technologies.
...
### 6. From Interpretability to Performance: Optimizing Retrieval Heads for Long-Context Language Models

- **LLM Score**: 8
- **Keyword Score**: 8
- **Authors**: Youmi Ma, Naoaki Okazaki
- **URL**: <http://arxiv.org/abs/2601.11020v1>
- **Submitted**: 2026-01-16 06:31:08
- **Comment**: 13 pages
- **Topic Keywords**: ranking, rag, retrieval, rank
- **Reason**: This paper is highly relevant to your research interests in Information Retrieval and Search technologies, particularly in the context of query understanding and ranking models. The focus on long-context language models and the proposed method, RetMask, aligns with your interests in deep semantic understanding and real-time relevance optimization. The connection to attention heads and their role in retrieval is also a strong match.
...
### 7. NAACL: Noise-AwAre Verbal Confidence Calibration for LLMs in RAG Systems
...
- **URL**: <http://arxiv.org/abs/2601.11004v1>
- **Submitted**: 2026-01-16 05:38:25
- **Topic Keywords**: rag, retrieval, acl, naacl
- **Reason**: This paper is highly relevant to your research interests in Natural Language Processing (NLP) and Information Retrieval (IR), particularly in the context of large language models (LLMs) and retrieval-augmented generation (RAG) systems. The focus on confidence calibration and noise awareness aligns with your interests in query understanding and ranking models. However, the specific domain of LLMs and RAG systems is somewhat outside your primary focus on e-commerce and real-time relevance optimization.
...
### 8. Unlocking the Potentials of Retrieval-Augmented Generation for Diffusion Language Models
...
- **Submitted**: 2026-01-16 14:45:46
- **Comment**: Preprints
- **Topic Keywords**: query, relevance, rag, retrieval
- **Reason**: This paper explores the application of Retrieval-Augmented Generation in Diffusion Language Models, which is somewhat related to my research interests in Information Retrieval and Natural Language Processing. Although it's not directly focused on query understanding, ranking models, or user behavior modeling, it does involve deep semantic understanding and real-time relevance optimization, making it somewhat relevant to my core themes.
...
### 9. Deep GraphRAG: A Balanced Approach to Hierarchical Retrieval and Adaptive Integration

- **LLM Score**: 6
- **Keyword Score**: 12
- **Authors**: Yuejie Li, Ke Yang, Tao Wang, Bolin Chen, Bowen Li, Chengjun Mao
- **URL**: <http://arxiv.org/abs/2601.11144v1>
- **Submitted**: 2026-01-16 10:02:31
- **Topic Keywords**: ranking, relevance, rag, retrieval, rank, search
- **Reason**: The paper Deep GraphRAG explores graph-based retrieval and adaptive integration, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on hierarchical retrieval and graph-based methods is not a central match to your primary research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 10. Seek and You Shall Find: Design & Evaluation of a Context-Aware Interactive Search Companion

- **LLM Score**: 6
- **Keyword Score**: 9
- **Authors**: Markus Bink, Marten Risius, Udo Kruschwitz, David Elsweiler
- **URL**: <http://arxiv.org/abs/2601.11287v1>
- **Submitted**: 2026-01-16 13:39:33
- **Comment**: Pre-Print accepted at CHIIR 2026
- **Topic Keywords**: query, queries, rag, search
- **Reason**: The paper explores search technologies and user behavior modeling, which aligns with your interests in Information Retrieval and Search technologies. However, the focus on expert search strategies and contextual guidance, while related, is somewhat tangential to your core research themes of query understanding, ranking models, and deep semantic understanding.
...
### 11. Predict the Retrieval! Test time adaptation for Retrieval Augmented Generation
...
- **Submitted**: 2026-01-16 17:07:01
- **Topic Keywords**: rag, retrieval augmented generation, retrieval
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval, particularly in the context of Retrieval-Augmented Generation. However, the focus on test-time adaptation for specialized domains is not a central match to your primary interests in query understanding, ranking models, and user behavior modeling. The connection to NLP and deep semantic understanding is also relevant, but not a strong enough link to elevate the score to 8 or above.
...
### 12. When Personalization Misleads: Understanding and Mitigating Hallucinations in Personalized LLMs

- **LLM Score**: 6
- **Keyword Score**: 4
- **Authors**: Zhongxiang Sun, Yi Zhan, Chenglei Shen, Weijie Yu, Xiao Zhang, Ming He, Jun Xu
- **URL**: <http://arxiv.org/abs/2601.11000v1>
- **Submitted**: 2026-01-16 05:20:10
- **Comment**: 20 pages, 15 figures
- **Topic Keywords**: queries, personalization
- **Reason**: This paper explores the concept of 'hallucinations' in personalized large language models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on personalized LLMs and factual accuracy is not a central match to the user's primary research interests in IR and search technologies. The connection to NLP and data mining is more relevant, but the paper's specific topic is not a primary area of interest.
...
### 14. Reasoning in Trees: Improving Retrieval-Augmented Generation for Multi-Hop Question Answering

- **LLM Score**: 4
- **Keyword Score**: 10
- **Authors**: Yuling Shi, Maolin Sun, Zijun Liu, Mo Yang, Yixiong Fang, Tianran Sun, Xiaodong Gu
- **URL**: <http://arxiv.org/abs/2601.11255v1>
- **Submitted**: 2026-01-16 13:02:25
...
- **Reason**: The paper introduces a novel framework for complex multi-hop question answering, which is related to information retrieval and natural language processing. However, it does not directly focus on query understanding, ranking models, or user behavior modeling, which are core areas of interest. The paper's emphasis on reasoning trees and retrieval-augmented generation is somewhat relevant to information retrieval, but it does not align with the user's primary research themes.
...
### 15. Isotropy-Optimized Contrastive Learning for Semantic Course Recommendation

- **LLM Score**: 4
- **Keyword Score**: 7
- **Authors**: Ali Khreis, Anthony Nasr, Yusuf Hilal
- **URL**: <http://arxiv.org/abs/2601.11427v1>
- **Submitted**: 2026-01-16 16:47:29
- **Comment**: 7 pages, 7 figures
- **Topic Keywords**: queries, relevance, recommend
- **Reason**: The paper focuses on semantic course recommendation using contrastive learning, which is somewhat related to information retrieval and NLP. However, the specific application domain (course recommendation) and the use of BERT embeddings are not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 16. A Concise Agent is Less Expert: Revealing Side Effects of Using Style Features on Conversational Agents

- **LLM Score**: 4
- **Keyword Score**: 6
- **Authors**: Young-Min Cho, Yuan Yuan, Sharath Chandra Guntuku, Lyle Ungar
- **URL**: <http://arxiv.org/abs/2601.10809v1>
- **Submitted**: 2026-01-15 19:18:18
- **Topic Keywords**: pairwise, search, acl
- **Reason**: This paper is somewhat related to your research interests in Natural Language Processing (NLP) and conversational agents, but it doesn't directly align with your primary focus on Information Retrieval (IR), query understanding, ranking models, or user behavior modeling. The paper explores the unintended side effects of style features in conversational agents, which is an interesting topic, but it doesn't seem to have a direct connection to your core research themes.
...
### 17. FactCorrector: A Graph-Inspired Approach to Long-Form Factuality Correction of Large Language Models
...
- **Submitted**: 2026-01-16 12:23:58
- **Topic Keywords**: relevance, rag
- **Reason**: The paper is somewhat related to the user's interests in Information Retrieval, particularly in the context of improving the factuality of large language models. However, it does not directly address query understanding, ranking models, or user behavior modeling, which are core areas of interest. The focus on factuality correction and post-hoc correction methods is tangentially related to the user's background in e-commerce and interests in NLP and data mining.
...
### 18. Do explanations generalize across large reasoning models?

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Koyena Pal, David Bau, Chandan Singh
- **URL**: <http://arxiv.org/abs/2601.11517v1>
- **Submitted**: 2026-01-16 18:55:29
- **Topic Keywords**: ranking, rank
- **Reason**: The paper explores the generalizability of explanations generated by large reasoning models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on AI for science and explanation generalization across different models is not directly aligned with the user's core research themes in IR and NLP. While the paper touches on aspects of model behavior and consistency, it does not directly address user behavior modeling or real-time relevance optimization.
...
### 19. One LLM to Train Them All: Multi-Task Learning Framework for Fact-Checking

- **LLM Score**: 4
- **Keyword Score**: 4
- **Authors**: Malin Astrid Larsson, Harald Fosen Grunnaleite, Vinay Setty
- **URL**: <http://arxiv.org/abs/2601.11293v1>
- **Submitted**: 2026-01-16 13:44:25
- **Comment**: Accepted version in ECIR 2026
- **Topic Keywords**: ranking, rank
- **Reason**: This paper explores the application of multi-task learning for fact-checking, which is a specific area within Natural Language Processing. While it touches on deep semantic understanding, the focus is on a particular task rather than a broader information retrieval problem. The paper's relevance to information retrieval and search technologies is limited, but it may be of interest for those working in NLP and related areas.
...
### 20. "Can You Tell Me?": Designing Copilots to Support Human Judgement in Online Information Seeking

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Markus Bink, Marten Risius, Udo Kruschwitz, David Elsweiler
- **URL**: <http://arxiv.org/abs/2601.11284v1>
- **Submitted**: 2026-01-16 13:33:54
- **Comment**: Pre-Print accepted at CHIIR 2026
- **Topic Keywords**: rag, search
- **Reason**: This paper explores the design of conversational copilots to support human judgement in online information seeking, which is somewhat related to your interests in Information Retrieval and Search technologies. However, the focus on pedagogical copilots and digital literacy skills is not directly aligned with your core research themes, such as query understanding, ranking models, and user behavior modeling.
...
### 21. CoG: Controllable Graph Reasoning via Relational Blueprints and Failure-Aware Refinement over Knowledge Graphs
...
- **Submitted**: 2026-01-16 07:27:40
- **Topic Keywords**: rag, search
- **Reason**: The paper explores a novel framework for knowledge graph reasoning, leveraging relational blueprints and failure-aware refinement. While it touches on aspects of deep semantic understanding, its primary focus is on knowledge graph reasoning and not directly related to information retrieval or search technologies. The paper's relevance to the user's interests is somewhat limited, but it may offer insights into real-time relevance optimization through its efficient reasoning approach.
...
### 22. Finding the Translation Switch: Discovering and Exploiting the Task-Initiation Features in LLMs
...
- **Submitted**: 2026-01-16 06:29:07
- **Comment**: Accepted by AAAI 2026
- **Topic Keywords**: rag, aaai
- **Reason**: The paper discusses the internal mechanisms of Large Language Models (LLMs) in translation tasks, which is related to my interests in deep semantic understanding and real-time relevance optimization. However, the focus on translation and LLMs is somewhat off-topic from my primary research areas in Information Retrieval and Search technologies. The paper's use of Sparse Autoencoders and PCA-based consistency metric is an interesting application of data mining techniques, but it doesn't directly align with my core research themes.
...
### 23. PRISM: Personalized Recommendation via Information Synergy Module

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Xinyi Zhang, Yutong Li, Peijie Sun, Letian Sha, Zhongxuan Han
- **URL**: <http://arxiv.org/abs/2601.10944v1>
- **Submitted**: 2026-01-16 02:17:54
- **Comment**: Accepted as a Full Paper at WWW 2026
- **Topic Keywords**: rag, recommend
- **Reason**: The paper PRISM focuses on multimodal sequential recommendation, which is somewhat related to information retrieval and search technologies. However, it primarily deals with recommendation systems, which is not the core focus of the user's research interests. The use of information synergy and adaptive fusion is somewhat relevant to query understanding and ranking models, but the context is different.
...
### 24. Streaming Stochastic Submodular Maximization with On-Demand User Requests

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Honglian Wang, Sijing Tu, Lutz Oettershagen, Aristides Gionis
- **URL**: <http://arxiv.org/abs/2601.10901v1>
- **Submitted**: 2026-01-15 23:00:10
- **Comment**: NeurIPS'25
- **Topic Keywords**: rag, recommend
- **Reason**: This paper explores a novel problem in streaming submodular maximization, which is somewhat related to information retrieval and ranking models. However, the focus on news-recommendation platforms and submodular maximization subject to a matroid constraint is not directly aligned with the user's core research themes in query understanding, ranking models, and user behavior modeling.
...
### 25. EncodeRec: An Embedding Backbone for Recommendation Systems

- **LLM Score**: 4
- **Keyword Score**: 3
- **Authors**: Guy Hadad, Neomi Rabaev, Bracha Shapira
- **URL**: <http://arxiv.org/abs/2601.10837v1>
- **Submitted**: 2026-01-15 20:15:01
- **Topic Keywords**: rag, recommend
- **Reason**: This paper is somewhat related to your research interests in Information Retrieval and Natural Language Processing, particularly in the context of recommender systems and embedding models. However, the focus on recommendation systems and the use of pre-trained language models for this purpose is not a central match with your primary interests in query understanding, ranking models, and user behavior modeling.
...
### 26. Evaluating LLM Behavior in Hiring: Implicit Weights, Fairness Across Groups, and Alignment with Human Preferences

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Morgane Hoffmann, Emma Jouffroy, Warren Jouanneau, Marc Palyart, Charles Pebereau
- **URL**: <http://arxiv.org/abs/2601.11379v1>
- **Submitted**: 2026-01-16 15:38:03
- **Topic Keywords**: rag
- **Reason**: This paper is somewhat related to your interests in Information Retrieval, particularly in the context of query understanding and ranking models. However, the focus on Large Language Models (LLMs) in recruitment applications and their decision logic is not a central match to your primary research themes. While it touches on aspects of data analysis and modeling, it is not directly related to your expertise in e-commerce, search technologies, or recommender systems.
...
### 27. Reward Modeling for Scientific Writing Evaluation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Furkan Şahinuç, Subhabrata Dutta, Iryna Gurevych
- **URL**: <http://arxiv.org/abs/2601.11374v1>
- **Submitted**: 2026-01-16 15:32:58
- **Comment**: arXiv admin note: text overlap with arXiv:2508.07955
- **Topic Keywords**: rag
- **Reason**: The paper focuses on scientific writing evaluation, which is related to information retrieval and NLP, but it doesn't directly address query understanding, ranking models, or user behavior modeling. While it involves deep semantic understanding and real-time relevance optimization, the context is specific to scientific writing evaluation, making it somewhat relevant but not a central match for your research interests.
...
### 28. How Much Would a Clinician Edit This Draft? Evaluating LLM Alignment for Patient Message Response Drafting
...
- **Submitted**: 2026-01-16 14:48:00
- **Topic Keywords**: retrieval
- **Reason**: This paper explores the application of Large Language Models (LLMs) in drafting patient responses, which is related to query understanding and ranking models in Information Retrieval. However, the focus on clinical workflows and patient-clinician communication is somewhat off-topic from your core research themes in e-commerce and real-time relevance optimization. The paper does involve NLP and adaptation techniques, but the context is not directly aligned with your primary interests.
...
### 29. Knowledge is Not Enough: Injecting RL Skills for Continual Adaptation

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Pingzhi Tang, Yiding Wang, Muhan Zhang
- **URL**: <http://arxiv.org/abs/2601.11258v1>
- **Submitted**: 2026-01-16 13:08:16
- **Topic Keywords**: rag
- **Reason**: The paper discusses a framework for efficient knowledge adaptation in large language models, which is somewhat related to information retrieval and search technologies. However, the focus on knowledge adaptation and skill transfer in language models is not directly aligned with the user's primary research interests in query understanding, ranking models, and user behavior modeling.
...
### 30. Language of Thought Shapes Output Diversity in Large Language Models

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Shaoyang Xu, Wenxuan Zhang
- **URL**: <http://arxiv.org/abs/2601.11227v1>
- **Submitted**: 2026-01-16 12:14:16
- **Topic Keywords**: rag
- **Reason**: The paper explores the concept of 'language of thought' in Large Language Models, which is somewhat related to query understanding and ranking models in Information Retrieval. However, the focus on output diversity and language manipulation is not directly aligned with the user's primary research interests in IR and NLP. The connection to user behavior modeling and real-time relevance optimization is also tenuous.
...
### 31. Redefining Machine Simultaneous Interpretation: From Incremental Translation to Human-Like Strategies

- **LLM Score**: 4
- **Keyword Score**: 2
- **Authors**: Qianen Zhang, Zeyu Yang, Satoshi Nakamura
- **URL**: <http://arxiv.org/abs/2601.11002v1>
- **Submitted**: 2026-01-16 05:26:16
- **Comment**: arXiv admin note: substantial text overlap with arXiv:2509.21801
- **Topic Keywords**: acl
- **Reason**: This paper explores Simultaneous Machine Translation, which is related to Information Retrieval, but its focus on machine interpretation and translation is somewhat tangential to the user's core research themes. While it involves deep semantic understanding, the context is not directly applicable to search technologies or query understanding. The paper's relevance is somewhat limited to the user's broader interests in NLP and related topics.
...
### 32. Building Production-Ready Probes For Gemini

- **LLM Score**: 4
- **Keyword Score**: 1
- **Authors**: János Kramár, Joshua Engels, Zheng Wang, Bilal Chughtai, Rohin Shah, Neel Nanda, Arthur Conmy
- **URL**: <http://arxiv.org/abs/2601.11516v1>
- **Submitted**: 2026-01-16 18:54:29
- **Topic Keywords**: search
- **Reason**: While this paper touches on the topic of language model misuse mitigation, which is related to information retrieval and search technologies, its primary focus is on the development of probes for Gemini, a frontier language model. The paper's emphasis on architecture design and deployment in a specific domain (cyber-offensive) and its use of techniques like AlphaEvolve for automation, makes it somewhat relevant but not directly aligned with the user's core research themes in IR and NLP.
...
### 33. PatientVLM Meets DocVLM: Pre-Consultation Dialogue Between Vision-Language Models for Efficient Diagnosis
...
- **Submitted**: 2026-01-16 02:18:29
- **Comment**: Accepted at AAAI 2026 Main Track
- **Topic Keywords**: query, relevance, rag, search
- **Reason**: This paper primarily focuses on medical diagnosis and the application of vision-language models, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves dialogue and query understanding, the context is medical diagnosis rather than general search or e-commerce, making it somewhat tangential to the user's research areas.
...
### 34. Integrity Shield A System for Ethical AI Use & Authorship Transparency in Assessments
...
- **Submitted**: 2026-01-16 08:44:58
- **Topic Keywords**: query, retrieval
- **Reason**: This paper focuses on watermarking techniques to prevent cheating in assessments using Large Language Models, which is not directly related to Information Retrieval, Search technologies, or Natural Language Processing. While it touches on the topic of AI, it's more focused on academic integrity and authorship transparency rather than query understanding, ranking models, or user behavior modeling.
...
### 35. Scalable Music Cover Retrieval Using Lyrics-Aligned Audio Embeddings

- **LLM Score**: 2
- **Keyword Score**: 4
- **Authors**: Joanne Affolter, Benjamin Martin, Elena V. Epure, Gabriel Meseguer-Brocal, Frédéric Kaplan
- **URL**: <http://arxiv.org/abs/2601.11262v1>
- **Submitted**: 2026-01-16 13:11:38
- **Comment**: Published at ECIR 2026 (European Conference of Information Retrieval)
- **Topic Keywords**: rag, retrieval
- **Reason**: This paper focuses on music cover retrieval using lyrics-aligned audio embeddings, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it involves text embeddings, the context is music retrieval and not general IR or NLP. The paper's emphasis on computational efficiency and multimodal architectures is somewhat relevant to your interests in real-time relevance optimization, but the connection is loose.
...
### 36. Towards Reliable ML Feature Engineering via Planning in Constrained-Topology of LLM Agents
...
- **Submitted**: 2026-01-15 19:33:42
- **Topic Keywords**: rag, recommend, personalization
- **Reason**: This paper focuses on feature engineering via planning in LLM agents, which is not directly related to your primary research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it does involve code generation and automation, the context is more aligned with software engineering and ML teams, rather than your core areas of focus.
...
### 37. Relational Linearity is a Predictor of Hallucinations

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Yuetian Lu, Yihong Liu, Hinrich Schütze
- **URL**: <http://arxiv.org/abs/2601.11429v1>
- **Submitted**: 2026-01-16 16:47:49
- **Comment**: 11 pages, 4 figures, 8 tables
- **Topic Keywords**: rag, search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it touches on large language models, the focus is on hallucinations and knowledge representation, which is not a central match to your core research themes.
...
### 38. PubMed-OCR: PMC Open Access OCR Annotations

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Hunter Heidenreich, Yosheb Getachew, Olivia Dinica, Ben Elliott
- **URL**: <http://arxiv.org/abs/2601.11425v1>
- **Submitted**: 2026-01-16 16:44:50
- **Topic Keywords**: rag, search
- **Reason**: This paper appears to be focused on OCR (Optical Character Recognition) and its applications in scientific articles, which is not directly related to your core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on the topic of text analysis, it does not seem to involve query understanding, ranking models, or user behavior modeling, making it only loosely relevant to your research.
...
### 39. Cross-Modal Attention Network with Dual Graph Learning in Multimodal Recommendation

- **LLM Score**: 2
- **Keyword Score**: 3
- **Authors**: Ji Dai, Quan Fang, Jun Hu, Desheng Cai, Yang Yang, Can Zhao
- **URL**: <http://arxiv.org/abs/2601.11151v1>
- **Submitted**: 2026-01-16 10:09:39
- **Comment**: Accepted to ACM Transactions on Multimedia Computing, Communications, and Applications (TOMM)
- **Topic Keywords**: rag, recommend
- **Reason**: This paper focuses on multimodal recommendation systems, which is a related but distinct area from information retrieval and search technologies. While it involves some aspects of user behavior modeling, its primary focus is on recommender systems rather than search or ranking models. The paper's emphasis on deep semantic understanding and real-time relevance optimization is not directly relevant to the user's core research themes.
...
- **Submitted**: 2026-01-16 16:53:08
- **Topic Keywords**: rag
- **Reason**: This paper appears to be primarily focused on the capabilities of large language models, specifically their ability to recover meaning from structural patterns. While it touches on the idea of language understanding, it does not seem to be directly related to information retrieval, query understanding, ranking models, or user behavior modeling, which are core areas of your research interests.
...
### 41. Membership Inference on LLMs in the Wild

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Jiatong Yi, Yanyang Li
- **URL**: <http://arxiv.org/abs/2601.11314v1>
- **Submitted**: 2026-01-16 14:10:46
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Membership Inference Attacks on Large Language Models, which is not directly related to your core research themes in Information Retrieval, Search technologies, and Natural Language Processing. While it touches on NLP, the context is more aligned with model security and auditing rather than query understanding, ranking models, or user behavior modeling.
...
### 42. FlashLabs Chroma 1.0: A Real-Time End-to-End Spoken Dialogue Model with Personalized Voice Cloning

- **LLM Score**: 2
- **Keyword Score**: 2
- **Authors**: Tanyu Chen, Tairan Chen, Kai Shen, Zhenghua Bao, Zhihui Zhang, Man Yuan, Yi Shi
- **URL**: <http://arxiv.org/abs/2601.11141v1>
- **Submitted**: 2026-01-16 10:00:03
- **Topic Keywords**: rag
- **Reason**: This paper is not directly related to the user's core research themes in Information Retrieval, Search technologies, or Natural Language Processing. While it involves deep learning models, the focus is on spoken dialogue systems and voice cloning, which is not a central match to the user's interests.
...
### 43. Spurious Rewards Paradox: Mechanistically Understanding How RLVR Activates Memorization Shortcuts in LLMs
...
- **Submitted**: 2026-01-16 07:55:38
- **Comment**: Work in process
- **Topic Keywords**: retrieval
- **Reason**: This paper appears to be primarily focused on Reinforcement Learning with Verifiable Rewards (RLVR) and its interactions with Large Language Models (LLMs), which is not directly related to the user's core research themes in Information Retrieval and Search technologies. While it touches on the concept of memorization shortcuts, it does not align with the user's interests in query understanding, ranking models, or user behavior modeling.
...
### 44. Spectral Characterization and Mitigation of Sequential Knowledge Editing Collapse
...
- **Submitted**: 2026-01-16 07:18:14
- **Comment**: 22 pages, 18 figures
- **Topic Keywords**: ctr
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves large language models, the focus is on spectral analysis and mitigation of knowledge editing collapse, which is not a central theme in your research.
...
### 45. SonicBench: Dissecting the Physical Perception Bottleneck in Large Audio Language Models
...
- **Submitted**: 2026-01-16 07:10:57
- **Topic Keywords**: rag
- **Reason**: This paper is not relevant to your research interests as it focuses on Audio Language Models and their ability to perceive physical attributes of audio, which is outside the scope of Information Retrieval, Search technologies, and Natural Language Processing.
...
### 46. BYOL: Bring Your Own Language Into LLMs
...
- **Submitted**: 2026-01-15 19:15:13
- **Topic Keywords**: rag
- **Reason**: This paper focuses on Large Language Models (LLMs) and language-aware development, which is somewhat related to your interests in Natural Language Processing (NLP). However, the primary topic of LLMs and language resources does not align closely with your core research themes in Information Retrieval (IR) and Search technologies.
...
### 47. CTest-Metric: A Unified Framework to Assess Clinical Validity of Metrics for CT Report Generation

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Vanshali Sharma, Andrea Mia Bejar, Gorkem Durak, Ulas Bagci
- **URL**: <http://arxiv.org/abs/2601.11488v1>
- **Submitted**: 2026-01-16 18:09:19
- **Comment**: Accepted at ISBI 2026
- **Topic Keywords**: search
- **Reason**: This paper is not directly related to your research interests in Information Retrieval, Search technologies, or Natural Language Processing. While it involves NLP techniques, its focus is on clinical validity assessment for CT report generation, which is outside your primary areas of interest.
...
### 48. MHA2MLA-VLM: Enabling DeepSeek's Economical Multi-Head Latent Attention across Vision-Language Models

- **LLM Score**: 2
- **Keyword Score**: 1
- **Authors**: Xiaoran Fan, Zhichao Sun, Tao Ji, Lixing Shen, Tao Gui
- **URL**: <http://arxiv.org/abs/2601.11464v1>
- **Submitted**: 2026-01-16 17:45:34
- **Topic Keywords**: rank
- **Reason**: This paper focuses on vision-language models and their optimization for inference, which is not directly related to the user's core research interests in Information Retrieval, Search technologies, and Natural Language Processing. While it involves some form of model adaptation and optimization, the context and techniques used are specific to vision-language models and do not align with the user's primary focus on deep semantic understanding and real-time relevance optimization in IR.
...
### 49. AJAR: Adaptive Jailbreak Architecture for Red-teaming

- **LLM Score**: 0
- **Keyword Score**: 2
- **Authors**: Yipu Dou, Wang Yang
- **URL**: <http://arxiv.org/abs/2601.10971v1>
- **Submitted**: 2026-01-16 03:30:40
- **Topic Keywords**: rag
- **Reason**: This paper appears to be unrelated to Information Retrieval, Search technologies, or Natural Language Processing. It focuses on AI safety and red-teaming, which is outside the user's primary research interests.
...
### 50. AstroReason-Bench: Evaluating Unified Agentic Planning across Heterogeneous Space Planning Problems

- **LLM Score**: 0
- **Keyword Score**: 1
- **Authors**: Weiyi Wang, Xinchi Chen, Jingjing Gong, Xuanjing Huang, Xipeng Qiu
- **URL**: <http://arxiv.org/abs/2601.11354v1>
- **Submitted**: 2026-01-16 15:02:41
- **Topic Keywords**: search
- **Reason**: This paper is not relevant to your research interests in Information Retrieval, Search technologies, query understanding, ranking models, user behavior modeling, or Natural Language Processing. The focus is on agentic planning in Space Planning Problems, which is outside your areas of interest.
